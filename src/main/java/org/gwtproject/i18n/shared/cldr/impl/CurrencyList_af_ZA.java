...
public class CurrencyList_af_ZA extends CurrencyList_af {
  ...
  protected HashMap<String, String> loadNamesMap() {
    ...
    result.put("AED","Verenigde Arabiese Emirate dirham");
    result.put("AFN","Afgaanse afgani");
    result.put("ALL","Albanese lek");
    result.put("AMD","Armeense dram");
    result.put("ANG","Nederlands-Antilliaanse gulde");
    result.put("AOA","Angolese kwanza");
    result.put("ARS","Argentynse peso");
    result.put("AUD","Australiese dollar");
    result.put("AWG","Arubaanse floryn");
    result.put("AZN","Azerbeidjaanse manat");
    result.put("BAM","Bosnies-Herzegowiniese omskakelbare marka");
    result.put("BBD","Barbados-dollar");
    result.put("BDT","Bangladesjiese taka");
    result.put("BGN","Bulgaarse lev");
    result.put("BHD","Bahreinse dinar");
    result.put("BIF","Burundiese frank");
    result.put("BMD","Bermuda-dollar");
    result.put("BND","Broeneise dollar");
    result.put("BOB","Boliviaanse boliviano");
    result.put("BRL","Brasilliaanse reaal");
    result.put("BSD","Bahamiaanse dollar");
    result.put("BTN","Bhoetanese ngoeltroem");
    result.put("BWP","Botswana pula");
    result.put("BYN","Belo-Russiese roebel");
    result.put("BYR","Belo-Russiese roebel (2000–2016)");
    result.put("BZD","Beliziese dollar");
    result.put("CAD","Kanadese dollar");
    result.put("CDF","Kongolese frank");
    result.put("CHF","Switserse frank");
    result.put("CLP","Chileense peso");
    result.put("CNH","Chinese joean");
    result.put("CNY","Sjinese joean renminbi");
    result.put("COP","Colombiaanse peso");
    result.put("CRC","Costa Ricaanse colón");
    result.put("CUC","Kubaanse omskakelbare peso");
    result.put("CUP","Kubaanse peso");
    result.put("CVE","Kaap Verdiese escudo");
    result.put("CZK","Tsjeggiese kroon");
    result.put("DJF","Djiboeti frank");
    result.put("DKK","Deense kroon");
    result.put("DOP","Dominikaanse peso");
    result.put("DZD","Algeriese dinar");
    result.put("EGP","Egiptiese pond");
    result.put("ERN","Eritrese nakfa");
    result.put("ETB","Etiopiese birr");
    result.put("EUR","euro");
    result.put("FJD","Fidjiaanse dollar");
    result.put("FKP","Falkland-eilande pond");
    result.put("GBP","Britse pond");
    result.put("GEL","Georgiese lari");
    result.put("GHC","Ghanese cedi (1979–2007)");
    result.put("GHS","Ghanese cedi");
    result.put("GIP","Gibraltarese pond");
    result.put("GMD","Gambiese dalasi");
    result.put("GNF","Guinese frank");
    result.put("GNS","Guinese syli");
    result.put("GTQ","Guatemalaanse quetzal");
    result.put("GYD","Guyanese dollar");
    result.put("HKD","Hong Kong dollar");
    result.put("HNL","Hondurese lempira");
    result.put("HRK","Kroatiese kuna");
    result.put("HTG","Haïtiaanse gourde");
    result.put("HUF","Hongaarse florint");
    result.put("IDR","Indonesiese roepia");
    result.put("ILS","Israeliese nuwe sikkel");
    result.put("INR","Indiese roepee");
    result.put("IQD","Irakse dinar");
    result.put("IRR","Iranse rial");
    result.put("ISK","Yslandse kroon");
    result.put("ITL","Italiaanse lier");
    result.put("JMD","Jamaikaanse dollar");
    result.put("JOD","Jordaniese dinar");
    result.put("JPY","Japannese jen");
    result.put("KES","Keniaanse sjieling");
    result.put("KGS","Kirgisiese som");
    result.put("KHR","Kambodjaanse riel");
    result.put("KMF","Comoraanse frank");
    result.put("KPW","Noord-Koreaanse won");
    result.put("KRW","Suid-Koreaanse won");
    result.put("KWD","Koeweitse dinar");
    result.put("KYD","Cayman-eilande dollar");
    result.put("KZT","Kazakse tenge");
    result.put("LAK","Laosiaanse kip");
    result.put("LBP","Lebanese pond");
    result.put("LKR","Sri Lankaanse roepee");
    result.put("LRD","Liberiese dollar");
    result.put("LSL","Lesotho loti");
    result.put("LTL","Litause litas");
    result.put("LVL","Lettiese lats");
    result.put("LYD","Libiese dinar");
    result.put("MAD","Marokkaanse dirham");
    result.put("MDL","Moldowiese leu");
    result.put("MGA","Malgassiese ariary");
    result.put("MKD","Macedoniese denar");
    result.put("MMK","Mianmese kyat");
    result.put("MNT","Mongoolse toegrik");
    result.put("MOP","Macaose pataca");
    result.put("MRO","Mauritaniese ouguiya (1973–2017)");
    result.put("MRU","Mauritaniese ouguiya");
    result.put("MUR","Mauritiaanse rupee");
    result.put("MVR","Malediviese rufia");
    result.put("MWK","Malawiese kwacha");
    result.put("MXN","Meksikaanse peso");
    result.put("MYR","Maleisiese ringgit");
    result.put("MZM","Mosambiekse metical (1980–2006)");
    result.put("MZN","Mosambiekse metical");
    result.put("NAD","Namibiese dollar");
    result.put("NGN","Nigeriese naira");
    result.put("NIO","Nicaraguaanse córdoba");
    result.put("NOK","Noorse kroon");
    result.put("NPR","Nepalese roepee");
    result.put("NZD","Nieu-Seeland dollar");
    result.put("OMR","Omaanse rial");
    result.put("PAB","Panamese balboa");
    result.put("PEN","Peruaanse sol");
    result.put("PGK","Papoea-Nieu-Guinese kina");
    result.put("PHP","Filippynse peso");
    result.put("PKR","Pakistanse roepee");
    result.put("PLN","Poolse zloty");
    result.put("PYG","Paraguaanse guarani");
    result.put("QAR","Katarrese rial");
    result.put("RON","Roemeense leu");
    result.put("RSD","Serbiese dinar");
    result.put("RUB","Russiese roebel");
    result.put("RWF","Rwandiese frank");
    result.put("SAR","Saoedi-Arabiese riyal");
    result.put("SBD","Salomonseilande dollar");
    result.put("SCR","Seychellese rupee");
    result.put("SDG","Soedannese pond");
    result.put("SDP","Soedannese pond (1957–1998)");
    result.put("SEK","Sweedse kroon");
    result.put("SGD","Singapoer dollar");
    result.put("SHP","Sint Helena pond");
    result.put("SLL","Sierra Leoniese leone");
    result.put("SOS","Somaliese sjieling");
    result.put("SRD","Surinaamse dollar");
    result.put("SSP","Suid-Soedanese pond");
    result.put("STD","São Tomé en Príncipe dobra (1977–2017)");
    result.put("STN","São Tomé en Príncipe dobra");
    result.put("SYP","Siriese pond");
    result.put("SZL","Swazilandse lilangeni");
    result.put("THB","Thaise baht");
    result.put("TJS","Tadjikse roebel");
    result.put("TMT","Turkmeense manat");
    result.put("TND","Tunisiese dinar");
    result.put("TOP","Tongaanse pa’anga");
    result.put("TRL","Turkse lier (1922–2005)");
    result.put("TRY","Turkse lier");
    result.put("TTD","Trinidad en Tobago dollar");
    result.put("TWD","Nuwe Taiwanese dollar");
    result.put("TZS","Tanzaniese sjieling");
    result.put("UAH","Oekraïnse hriwna");
    result.put("UGX","Ugandese sjieling");
    result.put("USD","Amerikaanse dollar");
    result.put("UYU","Uruguaanse peso");
    result.put("UZS","Oezbekiese som");
    result.put("VEF","Venezolaanse bolivar");
    result.put("VES","Venezolaanse Bolívar");
    result.put("VND","Viëtnamese dong");
    result.put("VUV","Vanuatuse vatu");
    result.put("WST","Samoaanse tala");
    result.put("XAF","CFA frank BEAC");
    result.put("XCD","Oos-Karibbiese dollar");
    result.put("XOF","CFA frank BCEAO");
    result.put("XPF","CFP-frank");
    result.put("XXX","onbekende geldeenheid");
    result.put("YER","Jemenitiese rial");
    result.put("ZAR","Suid-Afrikaanse rand");
    result.put("ZMK","Zambiese kwacha (1968–2012)");
    result.put("ZMW","Zambiese kwacha");
    result.put("ZWD","Zimbabwiese dollar");
    return result;
  }
}
