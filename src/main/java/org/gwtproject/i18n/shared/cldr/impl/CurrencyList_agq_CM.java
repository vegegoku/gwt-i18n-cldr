...
public class CurrencyList_agq_CM extends CurrencyList_agq {
  ...
  protected HashMap<String, String> loadNamesMap() {
    ...
    result.put("BHD","Dinà è Balae");
    result.put("BIF","Fàlâŋ è Bùlundì");
    result.put("BWP","Kpuwlà è Botɨshǔanà");
    result.put("CAD","Dɔlà è Kanadà");
    result.put("CDF","Fàlâŋ è Kuŋgùlê");
    result.put("CHF","Fàlâŋ è Sues");
    result.put("CNY","Yùwân Lèmembi è Chaenî");
    result.put("CVE","Kàbòvàdianù è Èsùkudò");
    result.put("DJF","Fàlâŋ è Dzìbutì");
    result.put("DZD","Dinà è Àdzɛlìa");
    result.put("EGP","Bɔ̀ŋ è Edzì");
    result.put("ERN","Nakafa è Èletɨ̀làe");
    result.put("ETB","Bîi è Etyǒkpìa");
    result.put("EUR","Yulù");
    result.put("GBP","Bɔ̀ŋ è Bèletì");
    result.put("GHC","Sɛ̀di è Gaanà");
    result.put("GMD","Dàlasì è Gambìa");
    result.put("GNS","Fàlâŋ è Ginè");
    result.put("INR","Lukpì è Endìa");
    result.put("JPY","Ghɨ̂n Dzàkpànê");
    result.put("KES","Shwɨlà tɨ Kenyà");
    result.put("KMF","Fàlâŋ è Komolìa");
    result.put("LRD","Dɔlà Làebɛlìa");
    result.put("LSL","Lɔtì Lèsutù");
    result.put("LYD","Dinà è Lebìa");
    result.put("MAD","Dilàm è Mòlokò");
    result.put("MGA","Àlǐalè è Màlàgasì");
    result.put("MRO","Ùgueya è Mùlètenyìa (1973–2017)");
    result.put("MRU","Ùgueya è Mùlètenyìa");
    result.put("MUR","Lukpìi è Mùleshòs");
    result.put("MWK","Kwachà è Màlawè");
    result.put("MZM","Mètikà è Mùzàmbî");
    result.put("NAD","Dɔlà è Nàmibìa");
    result.put("NGN","Naelà è Gɨ̀anyɨ");
    result.put("RWF","Fàlâŋ è Lùwandà");
    result.put("SAR","Leyà è Sàwudì");
    result.put("SCR","Lukpìi è Sɛchɛ̀lɛ̀");
    result.put("SDG","Bɔ̀ŋ è Sùdànê");
    result.put("SHP","Bɔ̀ŋ è Sɛ̀n Èlenà");
    result.put("SLL","Lyɔ̂ŋ");
    result.put("SOS","Shwɨlà è Sùmalìa");
    result.put("STD","Dɔbàlà è Sàwu Tɔ̀me à Pèlènsipè (1977–2017)");
    result.put("STN","Dɔbàlà è Sàwu Tɔ̀me à Pèlènsipè");
    result.put("SZL","Lèlàŋgenè");
    result.put("TND","Dinà è Tùwneshìa");
    result.put("TZS","Shwɨlà è Tàanzanyìa");
    result.put("UGX","Shwɨlà è Yùgandà");
    result.put("USD","Dɔlà è US");
    result.put("XAF","CFA Fàlâŋ BEAC");
    result.put("XOF","CFA Fàlâŋ BCEAO");
    result.put("ZAR","Lân è Afɨlekà ghɨ Emàm ghò");
    result.put("ZMK","Kwachà è Zambìa (1968–2012)");
    result.put("ZMW","Kwachà è Zambìa");
    result.put("ZWD","Dɔlà è Zìmbagbɛ̀");
    return result;
  }
}
