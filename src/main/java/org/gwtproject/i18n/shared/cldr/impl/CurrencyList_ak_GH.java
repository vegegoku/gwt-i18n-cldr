...
public class CurrencyList_ak_GH extends CurrencyList_ak {
  ...
  protected HashMap<String, String> loadNamesMap() {
    ...
    result.put("AED","Ɛmirete Arab Nkabɔmu Deram");
    result.put("AOA","Angola Kwanza");
    result.put("AUD","Ɔstrelia Dɔla");
    result.put("BHD","Baren Dina");
    result.put("BIF","Burundi Frank");
    result.put("BWP","Botswana Pula");
    result.put("CAD","Kanada Dɔla");
    result.put("CDF","Kongo Frank");
    result.put("CNY","Yuan");
    result.put("CVE","Ɛskudo");
    result.put("DJF","Gyebuti Frank");
    result.put("DZD","Ɔlgyeria Dina");
    result.put("EGP","Egypt Pɔn");
    result.put("ERN","Ɛretereya Nakfa");
    result.put("ETB","Itiopia Bir");
    result.put("EUR","Iro");
    result.put("GBP","Breten Pɔn");
    result.put("GHC","Ghana Sidi (1979–2007)");
    result.put("GHS","Ghana Sidi");
    result.put("GMD","Gambia Dalasi");
    result.put("GNS","Gini Frank");
    result.put("INR","India Rupi");
    result.put("JPY","Gyapan Yɛn");
    result.put("KES","Kenya Hyelen");
    result.put("KMF","Komoro Frank");
    result.put("LRD","Laeberia Dɔla");
    result.put("LSL","Lesoto Loti");
    result.put("LYD","Libya Dina");
    result.put("MAD","Moroko Diram");
    result.put("MGA","Madagasi Frank");
    result.put("MRO","Mɔretenia Ouguiya (1973–2017)");
    result.put("MRU","Mɔretenia Ouguiya");
    result.put("MUR","Mɔrehyeɔs Rupi");
    result.put("MWK","Malawi Kwacha");
    result.put("MZM","Mozambik Metical");
    result.put("NAD","Namibia Dɔla");
    result.put("NGN","Naegyeria Naira");
    result.put("RWF","Rewanda Frank");
    result.put("SAR","Saudi Riyal");
    result.put("SCR","Seyhyɛls Rupi");
    result.put("SDG","Sudan Dina");
    result.put("SDP","Sudan Pɔn");
    result.put("SHP","St Helena Pɔn");
    result.put("SLL","Leone");
    result.put("SOS","Somailia Hyelen");
    result.put("STD","Sao Tome ne Principe Dobra (1977–2017)");
    result.put("STN","Sao Tome ne Principe Dobra");
    result.put("SZL","Lilangeni");
    result.put("TND","Tunisia Dina");
    result.put("TZS","Tanzania Hyelen");
    result.put("UGX","Uganda Hyelen");
    result.put("USD","Amɛrika Dɔla");
    result.put("XAF","Sefa");
    result.put("ZAR","Afrika Anaafo Rand");
    result.put("ZMK","Zambia Kwacha (1968–2012)");
    result.put("ZMW","Zambia Kwacha");
    result.put("ZWD","Zimbabwe Dɔla");
    return result;
  }
}
