...
public class CurrencyList_ar_ER extends CurrencyList_ar_001 {
  public CurrencyData getDefault() {
    return new CurrencyDataImpl("ERN","Nfk",2,"Nfk","Nfk");
  }
  ...
  protected HashMap<String, CurrencyData> loadCurrencyMap() {
    ...
    // ناكفا أريتري
    result.put("ERN", new CurrencyDataImpl("ERN","Nfk",2,"Nfk","Nfk"));
    // ESA
