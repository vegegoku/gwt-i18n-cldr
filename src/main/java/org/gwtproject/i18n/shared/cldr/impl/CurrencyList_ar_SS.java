...
public class CurrencyList_ar_SS extends CurrencyList_ar {
  public CurrencyData getDefault() {
    return new CurrencyDataImpl("SSP","£",2,"£","£");
  }
  ...
  protected HashMap<String, CurrencyData> loadCurrencyMap() {
    ...
    // درهم إماراتي
    result.put("AED", new CurrencyDataImpl("AED","د.إ.‏",2,"د.إ.‏","د.إ.‏"));
    // أفغاني - 1927-2002
    ...
    // دينار بحريني
    result.put("BHD", new CurrencyDataImpl("BHD","د.ب.‏",3,"د.ب.‏","د.ب.‏"));
    // فرنك بروندي
    ...
    // دينار جزائري
    result.put("DZD", new CurrencyDataImpl("DZD","د.ج.‏",2,"د.ج.‏","د.ج.‏"));
    // ECS
    ...
    // جنيه مصري
    result.put("EGP", new CurrencyDataImpl("EGP","ج.م.‏",2,"ج.م.‏","ج.م.‏"));
    // ناكفا أريتري
    ...
    // دينار عراقي
    result.put("IQD", new CurrencyDataImpl("IQD","د.ع.‏",0,"د.ع.‏","د.ع.‏"));
    // ريال إيراني
    result.put("IRR", new CurrencyDataImpl("IRR","ر.إ.",0,"ر.إ.","ر.إ."));
    // ISJ
    ...
    // دينار أردني
    result.put("JOD", new CurrencyDataImpl("JOD","د.أ.‏",3,"د.أ.‏","د.أ.‏"));
    // ين ياباني
    ...
    // دينار كويتي
    result.put("KWD", new CurrencyDataImpl("KWD","د.ك.‏",3,"د.ك.‏","د.ك.‏"));
    // دولار جزر كيمن
    ...
    // جنيه لبناني
    result.put("LBP", new CurrencyDataImpl("LBP","ل.ل.‏",0,"ل.ل.‏","ل.ل.‏"));
    // روبية سريلانكية
    ...
    // دينار ليبي
    result.put("LYD", new CurrencyDataImpl("LYD","د.ل.‏",3,"د.ل.‏","د.ل.‏"));
    // درهم مغربي
    ...
    // ريال عماني
    result.put("OMR", new CurrencyDataImpl("OMR","ر.ع.‏",3,"ر.ع.‏","ر.ع.‏"));
    // بالبوا بنمي
    ...
    // ريال قطري
    result.put("QAR", new CurrencyDataImpl("QAR","ر.ق.‏",2,"ر.ق.‏","ر.ق.‏"));
    // دولار روديسي
    ...
    // ريال سعودي
    result.put("SAR", new CurrencyDataImpl("SAR","ر.س.‏",2,"ر.س.‏","ر.س.‏"));
    // دولار جزر سليمان
    ...
    // جنيه سوداني
    result.put("SDG", new CurrencyDataImpl("SDG","ج.س.",2,"ج.س.","ج.س."));
    // جنيه سوداني قديم
    ...
    // جنيه جنوب السودان
    result.put("SSP", new CurrencyDataImpl("SSP","£",2,"£","£"));
    ...
    // ليرة سورية
    result.put("SYP", new CurrencyDataImpl("SYP","ل.س.‏",0,"ل.س.‏","ل.س.‏"));
    // ليلانجيني سوازيلندي
    ...
    // دينار تونسي
    result.put("TND", new CurrencyDataImpl("TND","د.ت.‏",3,"د.ت.‏","د.ت.‏"));
    // بانغا تونغا
    ...
    // ريال يمني
    result.put("YER", new CurrencyDataImpl("YER","ر.ي.‏",0,"ر.ي.‏","ر.ي.‏"));
    // دينار يوغسلافي
