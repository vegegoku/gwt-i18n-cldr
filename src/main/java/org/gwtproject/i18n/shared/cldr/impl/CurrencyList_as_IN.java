...
public class CurrencyList_as_IN extends CurrencyList_as {
  ...
  protected HashMap<String, String> loadNamesMap() {
    ...
    result.put("AED","সংযুক্ত আৰব আমিৰাত ডিৰহেম");
    result.put("AFN","আফগান আফগানী");
    result.put("ALL","আলবেনীয় লেক");
    result.put("AMD","আৰ্মেনিয়ান ড্ৰাম");
    result.put("ANG","নেডাৰলেণ্ডছ এণ্টিলিয়েন গিল্ডাৰ");
    result.put("AOA","এংগোলান কোৱাঞ্জা");
    result.put("ARS","আৰ্জেণ্টাইন পেছো");
    result.put("AUD","অষ্ট্ৰেলিয়ান ডলাৰ");
    result.put("AWG","আৰুবান ফ্ল’ৰিন");
    result.put("AZN","আজেৰবাইজানী মানাত");
    result.put("BAM","ব’ছনিয়া আৰু হাৰ্জেগ’ভিনা কনভাৰ্টিব্‌ল মাৰ্ক");
    result.put("BBD","বাৰ্বাডিয়ান ডলাৰ");
    result.put("BDT","বাংলাদেশী টাকা");
    result.put("BGN","বুলগেৰীয় লেভ");
    result.put("BHD","বাহৰেইনী ডিনাৰ");
    result.put("BIF","বুৰুণ্ডিয়ান ফ্ৰেংক");
    result.put("BMD","বাৰ্মুডান ডলাৰ");
    result.put("BND","ব্ৰুনেই ডলাৰ");
    result.put("BOB","বলিভিয়ান বলিভিয়ানো");
    result.put("BRL","ব্ৰাজিলিয়ান ৰিয়েল");
    result.put("BSD","বাহামিয়ান ডলাৰ");
    result.put("BTN","ভুটানী নংগলট্ৰাম");
    result.put("BWP","ব’টচোৱানান পুলা");
    result.put("BYN","বেলাৰুছীয় ৰুবেল");
    result.put("BZD","বেলিজ ডলাৰ");
    result.put("CAD","কানাডিয়ান ডলাৰ");
    result.put("CDF","কংগো ফ্ৰেংক");
    result.put("CHF","চুইছ ফ্ৰেংক");
    result.put("CLP","চিলিয়ান পেছো");
    result.put("CNH","চীনা ইউৱান (অফশ্ব’ৰ)");
    result.put("CNY","চীনা ইউৱান");
    result.put("COP","কলম্বিয়ান পেছো");
    result.put("CRC","কোষ্টা ৰিকান কোলন");
    result.put("CUC","কিউবান ৰূপান্তৰযোগ্য পেছো");
    result.put("CUP","কিউবান পেছো");
    result.put("CVE","কেপ ভাৰ্দে এছকুডো");
    result.put("CZK","চেক কোৰুনা");
    result.put("DJF","জিবুটি ফ্ৰেংক");
    result.put("DKK","ডেনিচ ক্ৰোন");
    result.put("DOP","ড’মিনিকান পেছো");
    result.put("DZD","আলজেৰীয় ডিনাৰ");
    result.put("EGP","ইজিপ্তৰ পাউণ্ড");
    result.put("ERN","এৰিট্ৰিয়ন নাক্‌ফা");
    result.put("ETB","ইথিঅ’পিয়ান বিৰ");
    result.put("EUR","ইউৰো");
    result.put("FJD","ফিজিয়ান ডলাৰ");
    result.put("FKP","ফকলেণ্ড দ্বীপপুঞ্জৰ পাউণ্ড");
    result.put("GBP","ব্ৰিটিছ পাউণ্ড");
    result.put("GEL","জৰ্জিয়ান লাৰি");
    result.put("GHS","ঘানাৰ চেডি");
    result.put("GIP","জিব্ৰাল্টৰ পাউণ্ড");
    result.put("GMD","গাম্বিয়া ডালাছি");
    result.put("GNF","গিনি ফ্ৰেংক");
    result.put("GTQ","গুৱাটেমালা কুৱেৎজাল");
    result.put("GYD","গায়ানিজ ডলাৰ");
    result.put("HKD","হং কং ডলাৰ");
    result.put("HNL","হোন্দুৰান লেম্পিৰা");
    result.put("HRK","ক্ৰোৱেছিয়ান কুনা");
    result.put("HTG","হাইটিয়ান গৌৰ্ড");
    result.put("HUF","হাংগেৰীয়ান ফ’ৰিণ্ট");
    result.put("IDR","ইণ্ডোনেচিয়ান ৰুপিয়াহ");
    result.put("ILS","ইজৰাইলী নিউ শ্বেকেল");
    result.put("INR","ভাৰতীয় ৰুপী");
    result.put("IQD","ইৰাকী ডিনাৰ");
    result.put("IRR","ইৰানীয়ান ৰিয়েল");
    result.put("ISK","আইচলেণ্ডিক ক্ৰোনা");
    result.put("JMD","জামাইকান ডলাৰ");
    result.put("JOD","জৰ্ডানিয়ান ডিনাৰ");
    result.put("JPY","জাপানী য়েন");
    result.put("KES","কেনিয়ান শ্বিলিং");
    result.put("KGS","কিৰ্গিস্তানী ছোম");
    result.put("KHR","কেম্ব’ডিয়ান ৰিয়েল");
    result.put("KMF","ক’মোৰিয়ান ফ্ৰেংক");
    result.put("KPW","উত্তৰ কোৰিয়াৰ ওৱান");
    result.put("KRW","দক্ষিণ কোৰিয়াৰ ওৱান");
    result.put("KWD","কুৱেইটি ডিনাৰ");
    result.put("KYD","কেইমেন দ্বীপপুঞ্জৰ ডলাৰ");
    result.put("KZT","কাজাখস্তানী তেঞ্জ");
    result.put("LAK","লাওচিয়ান কিপ");
    result.put("LBP","লেবানীজ পাউণ্ড");
    result.put("LKR","শ্ৰীলংকান ৰুপী");
    result.put("LRD","লাইবেৰিয়ান ডলাৰ");
    result.put("LYD","লিবিয়ান ডিনাৰ");
    result.put("MAD","মৰোক্কান ডিৰহাম");
    result.put("MDL","মোলডোভান লেউ");
    result.put("MGA","মালাগাছী এৰিয়াৰী");
    result.put("MKD","মেচিডোনীয় ডেনাৰ");
    result.put("MMK","ম্যানমাৰ কিয়াট");
    result.put("MNT","মঙ্গোলিয়ান টুৰ্গিক");
    result.put("MOP","মেকানীজ পাটাকা");
    result.put("MRO","ম’ৰিটেনিয়ান ঔগুইয়া (1973–2017)");
    result.put("MRU","ম’ৰিটেনিয়ান ঔগুইয়া");
    result.put("MUR","মৰিচিয়ান ৰুপী");
    result.put("MVR","মালডিভিয়ান ৰুফিয়া");
    result.put("MWK","মালাউইয়ান কোৱাচা");
    result.put("MXN","মেক্সিকান পেছো");
    result.put("MYR","মালায়েচিয়ান ৰিংগিট");
    result.put("MZN","মোজাম্বিকান মেটিকল");
    result.put("NAD","নামিবিয়ান ডলাৰ");
    result.put("NGN","নাইজেৰিয়ান নাইৰা");
    result.put("NIO","নিকাৰাগুৱান কোৰ্ডোবা");
    result.put("NOK","নৰৱেজিয়ান ক্ৰোন");
    result.put("NPR","নেপালী ৰুপী");
    result.put("NZD","নিউজিলেণ্ড ডলাৰ");
    result.put("OMR","ওমানি ৰিয়েল");
    result.put("PAB","পানামেনিয়ান বাল্বোৱা");
    result.put("PEN","পেৰুভিয়ান ছ’ল");
    result.put("PGK","পাপুৱা নিউ গিনি কিনা");
    result.put("PHP","ফিলিপিন পেইছ’");
    result.put("PKR","পাকিস্তানী ৰুপী");
    result.put("PLN","প’লিচ জোল্টী");
    result.put("PYG","পাৰাগুয়ান গুৱাৰানি");
    result.put("QAR","কাটাৰি ৰিয়েল");
    result.put("RON","ৰোমানীয় লেউ");
    result.put("RSD","চাৰ্বিয়ান ডিনাৰ");
    result.put("RUB","ৰাছিয়ান ৰুব্‌ল");
    result.put("RWF","ৰোৱান্দান ফ্ৰেংক");
    result.put("SAR","চৌডি ৰিয়েল");
    result.put("SBD","চোলোমোন দ্বীপপুঞ্জৰ ডলাৰ");
    result.put("SCR","ছেচেলৱা ৰুপী");
    result.put("SDG","চুডানী পাউণ্ড");
    result.put("SEK","চুইডিছ ক্ৰোনা");
    result.put("SGD","ছিংগাপুৰ ডলাৰ");
    result.put("SHP","ছেইণ্ট হেলেনা পাউণ্ড");
    result.put("SLL","চিয়েৰা লিঅ’নৰ লিঅ’ন");
    result.put("SOS","চোমালি শ্বিলিং");
    result.put("SRD","ছুৰিনামী ডলাৰ");
    result.put("SSP","দক্ষিণ চুডানীজ পাউণ্ড");
    result.put("STD","চাও টোমে আৰু প্ৰিনচিপে ডোব্‌ৰা (1977–2017)");
    result.put("STN","চাও টোমে আৰু প্ৰিনচিপে ডোব্‌ৰা");
    result.put("SYP","চিৰিয়ান পাউণ্ড");
    result.put("SZL","স্বাজি লিলেংগেনি");
    result.put("THB","থাই বাত");
    result.put("TJS","তাজিকিস্তানী ছোমনি");
    result.put("TMT","তুৰ্কমেনিস্তানী মানাত");
    result.put("TND","টুনিচিয়ান ডিনাৰ");
    result.put("TOP","টংগান পাআংগা");
    result.put("TRY","তুৰ্কীৰ লিৰা");
    result.put("TTD","ট্ৰিনিডাড আৰু টোবাগো ডলাৰ");
    result.put("TWD","নিউ টাইৱান ডলাৰ");
    result.put("TZS","টানজানিয়ান শ্বিলিং");
    result.put("UAH","ইউক্ৰেইনীয় হৃভনিয়া");
    result.put("UGX","উগাণ্ডান শ্বিলিং");
    result.put("USD","ইউ. এছ. ডলাৰ");
    result.put("UYU","উৰুগুৱেয়ান পেছো");
    result.put("UZS","উজবেকিস্তানী ছোম");
    result.put("VEB","ভেনিজুৱেলান বলিভাৰ (1871–2008)");
    result.put("VEF","ভেনিজুৱেলান বলিভাৰ (2008–2018)");
    result.put("VES","ভেনিজুৱেলান বলিভাৰ");
    result.put("VND","ভিয়েটনামীজ ডং");
    result.put("VUV","ভানাটুৰ ভাটু");
    result.put("WST","ছামোৱান টালা");
    result.put("XAF","মধ্য আফ্ৰিকান CFA ফ্ৰেংক");
    result.put("XCD","ইষ্ট কেৰিবিয়ান ডলাৰ");
    result.put("XOF","পশ্চিম আফ্ৰিকান CFA ফ্ৰেংক");
    result.put("XPF","CFP ফ্ৰেংক");
    result.put("XXX","অজ্ঞাত মুদ্ৰা");
    result.put("YER","য়েমেনী ৰিয়েল");
    result.put("ZAR","দক্ষিণ আফ্ৰিকাৰ ৰাণ্ড");
    result.put("ZMW","জাম্বিয়ান কোৱাচা");
    return result;
  }
}
