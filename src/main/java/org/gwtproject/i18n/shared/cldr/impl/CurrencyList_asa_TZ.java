...
public class CurrencyList_asa_TZ extends CurrencyList_asa {
  ...
  protected HashMap<String, String> loadNamesMap() {
    ...
    result.put("AED","dirham ya Falme dha Kiarabu");
    result.put("AOA","kwandha ya Angola");
    result.put("AUD","dola ya Authtralia");
    result.put("BHD","dinari ya Bahareni");
    result.put("BIF","faranga ya Burundi");
    result.put("BWP","pula ya Botthwana");
    result.put("CAD","dola ya Kanada");
    result.put("CDF","faranga ya Kongo");
    result.put("CHF","faranga ya Uthwithi");
    result.put("CNY","yuan renminbi ya China");
    result.put("CVE","ethkudo ya Kepuvede");
    result.put("DJF","faranga ya Jibuti");
    result.put("DZD","dinari ya Aljeria");
    result.put("EGP","pauni ya Mithri");
    result.put("ERN","nakfa ya Eritrea");
    result.put("ETB","bir ya Uhabeshi");
    result.put("EUR","yuro");
    result.put("GBP","pauni ya Uingeredha");
    result.put("GHC","thedi ya Ghana");
    result.put("GMD","dalathi ya Gambia");
    result.put("GNS","faranga ya Gine");
    result.put("INR","rupia ya India");
    result.put("JPY","tharafu ya Kijapani");
    result.put("KES","shilingi ya Kenya");
    result.put("KMF","faranga ya Komoro");
    result.put("LRD","dola ya Liberia");
    result.put("LSL","loti ya Lethoto");
    result.put("LYD","dinari ya Libya");
    result.put("MAD","dirham ya Moroko");
    result.put("MGA","faranga ya Bukini");
    result.put("MRO","ugwiya ya Moritania (1973–2017)");
    result.put("MRU","ugwiya ya Moritania");
    result.put("MUR","rupia ya Morithi");
    result.put("MWK","kwacha ya Malawi");
    result.put("MZM","metikali ya Mthumbiji");
    result.put("NAD","dola ya Namibia");
    result.put("NGN","naira ya Nijeria");
    result.put("RWF","faranga ya Rwanda");
    result.put("SAR","riyal ya Thaudia");
    result.put("SCR","rupia ya Shelisheli");
    result.put("SDG","dinari ya Thudani");
    result.put("SDP","pauni ya Thudani");
    result.put("SHP","pauni ya Thantahelena");
    result.put("SLL","leoni");
    result.put("SOS","shilingi ya Thomalia");
    result.put("STD","dobra ya Thao Tome na Principe (1977–2017)");
    result.put("STN","dobra ya Thao Tome na Principe");
    result.put("SZL","lilangeni");
    result.put("TND","dinari ya Tunithia");
    result.put("TZS","shilingi ya Tandhania");
    ...
    result.put("ZAR","randi ya Afrika Kuthini");
    result.put("ZMK","kwacha ya Dhambia (1968–2012)");
    result.put("ZMW","kwacha ya Dhambia");
    result.put("ZWD","dola ya Dhimbabwe");
    return result;
  }
}
