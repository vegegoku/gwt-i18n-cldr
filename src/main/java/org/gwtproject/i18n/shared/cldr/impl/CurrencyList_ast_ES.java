...
public class CurrencyList_ast_ES extends CurrencyList_ast {
  ...
  protected HashMap<String, String> loadNamesMap() {
    ...
    result.put("AED","Dirḥam de los Emiratos Árabes Xuníos");
    result.put("AFA","Afganí afganistanu (1927–2002)");
    result.put("AFN","Afganí afganistanu");
    result.put("ALK","Lek albanés (1946–1965)");
    result.put("ALL","Lek albanés");
    result.put("AMD","Dram armeniu");
    result.put("ANG","Guílder de les Antilles Neerlandeses");
    result.put("AOA","Kwanza angolanu");
    result.put("AOK","Kwanza angolanu (1977–1991)");
    result.put("AON","Kwanza nuevu angolanu (1990–2000)");
    result.put("AOR","Kwanza angolanu reaxustáu (1995–1999)");
    result.put("ARA","Austral arxentín");
    result.put("ARL","Pesu Ley arxentín (1970–1983)");
    result.put("ARM","Pesu arxentín (1881–1970)");
    result.put("ARP","Pesu arxentín (1983–1985)");
    result.put("ARS","pesu arxentín");
    result.put("ATS","Chelín austriacu");
    result.put("AUD","Dólar australianu");
    result.put("AWG","Florín arubanu");
    result.put("AZM","Manat azerbaixanu (1993–2006)");
    result.put("AZN","Manat azerbaixanu");
    result.put("BAD","Dinar de Bosnia-Herzegovina (1992–1994)");
    result.put("BAM","marcu convertible de Bosnia-Herzegovina");
    result.put("BAN","Dinar nuevu de Bosnia-Herzegovina (1994–1997)");
    result.put("BBD","Dólar barbadianu");
    result.put("BDT","Taka bangladexí");
    result.put("BEC","Francu belga (convertible)");
    result.put("BEF","Francu belga");
    result.put("BEL","Francu belga (financieru)");
    result.put("BGL","Lev fuerte búlgaru");
    result.put("BGM","Lev socialista búlgaru");
    result.put("BGN","Lev búlgaru");
    result.put("BGO","Lev búlgaru (1879–1952)");
    result.put("BHD","Dinar baḥreiní");
    result.put("BIF","Francu burundianu");
    result.put("BMD","Dólar bermudianu");
    result.put("BND","dólar bruneyanu");
    result.put("BOB","Bolivianu de Bolivia");
    result.put("BOL","Boliviano de Bolivia (1863–1963)");
    result.put("BOP","Pesu bolivianu");
    result.put("BOV","Bolivianos mvdol");
    result.put("BRB","Cruzeiro nuevu brasilanu (1967–1986)");
    result.put("BRC","Cruzado brasilanu (1986–1989)");
    result.put("BRE","Cruzeiro brasilanu (1990–1993)");
    result.put("BRL","real brasilanu");
    result.put("BRN","Cruzado nuevu brasilanu (1989–1990)");
    result.put("BRR","Cruzeiro brasilanu (1993–1994)");
    result.put("BRZ","Cruzeiru brasilanu (1942–1967)");
    result.put("BSD","Dólar bahamés");
    result.put("BTN","Ngultrum butanés");
    result.put("BUK","Kyat birmanu");
    result.put("BWP","Pula botsuaniana");
    result.put("BYB","Rublu nuevu bielorrusu (1994–1999)");
    result.put("BYN","Rublu bielorrusu");
    result.put("BYR","Rublu bielorrusu (2000–2016)");
    result.put("BZD","Dólar belizianu");
    result.put("CAD","Dólar canadiense");
    result.put("CDF","francu congolés");
    result.put("CHE","Euru WIR");
    result.put("CHF","francu suizu");
    result.put("CHW","Francu WIR");
    result.put("CLE","Escudu chilenu");
    result.put("CLF","Unidá de cuenta chilena (UF)");
    result.put("CLP","pesu chilenu");
    result.put("CNX","Dólar del Bancu Popular Chinu");
    result.put("CNY","Yuan chinu");
    result.put("COP","pesu colombianu");
    result.put("COU","Unidá de valor real colombiana");
    result.put("CRC","Colón costarricanu");
    result.put("CSD","Dinar serbiu (2002–2006)");
    result.put("CSK","Corona fuerte checoslovaca");
    result.put("CUC","Pesu cubanu convertible");
    result.put("CUP","Pesu cubanu");
    result.put("CVE","escudu cabuverdianu");
    result.put("CYP","Llibra xipriota");
    result.put("CZK","Corona checa");
    result.put("DDM","Marcu d’Alemaña Oriental");
    result.put("DEM","Marcu alemán");
    result.put("DJF","Francu xibutianu");
    result.put("DKK","corona danesa");
    result.put("DOP","Pesu dominicanu");
    result.put("DZD","dinar arxelín");
    result.put("ECS","Sucre ecuatorianu");
    result.put("ECV","Unidá ecuatoriana de valor constante");
    result.put("EEK","Corona estonia");
    result.put("EGP","llibra exipciana");
    result.put("ERN","Nakfa eritréu");
    ...
    result.put("EUR","euro");
    result.put("FIM","Marcu finlandés");
    result.put("FJD","dólar fixanu");
    result.put("FKP","llibra malviniana");
    result.put("FRF","Francu francés");
    result.put("GBP","llibra esterlina");
    result.put("GEK","Kupon larit xeorxanu");
    result.put("GEL","Lari xeorxanu");
    result.put("GHC","Cedi ghanianu (1979–2007)");
    result.put("GHS","cedi ghanianu");
    result.put("GIP","llibra de Xibraltar");
    result.put("GMD","dalasi gambianu");
    result.put("GNF","francu guineanu");
    result.put("GNS","syli guineanu");
    result.put("GQE","Ekwele de Guinea Ecuatorial");
    result.put("GRD","Dracma griegu");
    result.put("GTQ","Quetzal guatemalianu");
    result.put("GWE","Escudo de Guinea portuguesa");
    result.put("GWP","Pesu de Guinea-Bisáu");
    result.put("GYD","dólar guyanés");
    result.put("HKD","Dólar hongkonés");
    result.put("HNL","Lempira hondurana");
    result.put("HRD","Dinar croata");
    result.put("HRK","Kuna croata");
    result.put("HTG","Gourde haitianu");
    result.put("HUF","Forint húngaru");
    result.put("IDR","rupiah indonesia");
    result.put("IEP","Llibra irlandesa");
    result.put("ILP","Llibra israelina");
    result.put("ILR","Xequel israelín (1980–1985)");
    result.put("ILS","Xequel nuevu israelín");
    result.put("INR","Rupia india");
    result.put("IQD","Dinar iraquín");
    result.put("IRR","Rial iranín");
    result.put("ISJ","Corona islandesa (1918–1981)");
    result.put("ISK","corona islandesa");
    result.put("ITL","Llira italiana");
    result.put("JMD","Dólar xamaicanu");
    result.put("JOD","Dinar xordanu");
    result.put("JPY","Yen xaponés");
    result.put("KES","Shilling kenianu");
    result.put("KGS","Som kirguistanín");
    result.put("KHR","riel camboyanu");
    result.put("KMF","Francu comoranu");
    result.put("KPW","Won norcoreanu");
    result.put("KRH","Hwan surcoreanu (1953–1962)");
    result.put("KRO","Won surcoreanu (1945–1953)");
    result.put("KRW","Won surcoreanu");
    result.put("KWD","Dinar kuwaitianu");
    result.put("KYD","dólar caimanés");
    result.put("KZT","Tenge kazaquistanín");
    result.put("LAK","kip laosianu");
    result.put("LBP","Llibra libanesa");
    result.put("LKR","Rupia de Sri Lanka");
    result.put("LRD","dólar liberianu");
    result.put("LSL","Loti de Lesothu");
    result.put("LTL","Litas lituanu");
    result.put("LTT","Talonas lituanu");
    result.put("LUC","Francu convertible luxemburgués");
    result.put("LUF","Francu luxemburgués");
    result.put("LUL","Francu financieru luxemburgués");
    result.put("LVL","Lats letón");
    result.put("LVR","Rublu letón");
    result.put("LYD","dinar libiu");
    result.put("MAD","dirḥam marroquín");
    result.put("MAF","francu marroquín");
    result.put("MCF","Francu monegascu");
    result.put("MDC","Cupón moldavu");
    result.put("MDL","Leu moldavu");
    result.put("MGA","Ariary malgaxe");
    result.put("MGF","Francu malgaxe");
    result.put("MKD","Denar macedoniu");
    result.put("MKN","Denar macedoniu (1992–1993)");
    result.put("MLF","Francu malianu");
    result.put("MMK","kyat de Myanmar");
    result.put("MNT","Tugrik mongol");
    result.put("MOP","Pataca de Macáu");
    result.put("MRO","ouguiya mauritanu (1973–2017)");
    result.put("MRU","ouguiya mauritanu");
    result.put("MTL","Llira maltesa");
    result.put("MTP","Llibra maltesa");
    result.put("MUR","Rupia mauriciana");
    result.put("MVP","Rupia maldiviana (1947–1981)");
    result.put("MVR","Rufiyaa maldiviana");
    result.put("MWK","Kwacha malauianu");
    result.put("MXN","Pesu mexicanu");
    result.put("MXP","Pesu de plata mexicanu (1861–1992)");
    result.put("MXV","Unidá d’inversión mexicana");
    result.put("MYR","ringgit malasiu");
    result.put("MZE","Escudu mozambicanu");
    result.put("MZM","Metical mozambicanu (1980–2006)");
    result.put("MZN","Metical mozambicanu");
    result.put("NAD","Dólar namibianu");
    result.put("NGN","naira nixeriana");
    result.put("NIC","Córdoba nicaraguanu (1988–1991)");
    result.put("NIO","Córdoba nicaraguanu");
    ...
    result.put("OMR","Rial omanianu");
    result.put("PAB","Balboa panamiegu");
    result.put("PEI","Inti peruanu");
    result.put("PEN","Sol peruanu");
    result.put("PES","Sol peruanu (1863–1965)");
    result.put("PGK","kina papuana");
    result.put("PHP","pesu filipín");
    result.put("PKR","Rupia paquistanina");
    result.put("PLN","Zloty polacu");
    result.put("PLZ","Zloty polacu (1950–1995)");
    result.put("PTE","Escudu portugués");
    result.put("PYG","guaraní paraguayu");
    result.put("QAR","Rial qatarín");
    result.put("RHD","Dólar rodesianu");
    result.put("ROL","Leu rumanu (1952–2006)");
    result.put("RON","Leu rumanu");
    result.put("RSD","dinar serbiu");
    result.put("RUB","Rublu rusu");
    result.put("RUR","Rublu rusu (1991–1998)");
    result.put("RWF","Francu ruandés");
    result.put("SAR","Riyal saudita");
    result.put("SBD","dólar salomonés");
    result.put("SCR","Rupia seixelesa");
    result.put("SDD","dinar sudanés (1992–2007)");
    result.put("SDG","llibra sudanesa");
    result.put("SDP","llibra sudanesa (1957–1998)");
    result.put("SEK","corona sueca");
    result.put("SGD","dólar singapuranu");
    result.put("SHP","llibra de Santa Lena");
    result.put("SIT","Tolar eslovenu");
    result.put("SKK","Corona eslovaca");
    result.put("SLL","leone sierralleonés");
    result.put("SOS","Shilling somalín");
    result.put("SRD","dólar surinamés");
    result.put("SRG","Florín surinamés");
    result.put("SSP","llibra sursudanesa");
    result.put("STD","dobra de Santu Tomé y Príncipe (1977–2017)");
    result.put("STN","dobra de Santu Tomé y Príncipe");
    result.put("SUR","Rublu soviéticu");
    result.put("SVC","Colón salvadorianu");
    result.put("SYP","Llibra siria");
    result.put("SZL","Lilangeni suazilandés");
    result.put("THB","baht tailandés");
    result.put("TJR","Rublu taxiquistanín");
    result.put("TJS","Somoni taxiquistanín");
    result.put("TMM","Manat turcomanu (1993–2009)");
    result.put("TMT","Manat turcomanu");
    result.put("TND","dinar tunecín");
    result.put("TOP","paʻanga tonganu");
    result.put("TPE","Escudu timorés");
    result.put("TRL","Llira turca (1922–2005)");
    result.put("TRY","Llira turca");
    result.put("TTD","dólar de Trinidá y Tobagu");
    result.put("TWD","Dólar nuevu taiwanés");
    result.put("TZS","Shilling tanzanianu");
    result.put("UAH","Grivna ucraína");
    result.put("UAK","Karbovanets ucraína");
    result.put("UGS","Shilling ugandés (1966–1987)");
    result.put("UGX","Shilling ugandés");
    result.put("USD","Dólar estaunidense");
    result.put("USN","Dólar d’EE.XX. (día siguiente)");
    result.put("USS","Dólar d’EE.XX. (mesmu día)");
    result.put("UYI","Pesu uruguayu (Unidaes indexaes)");
    result.put("UYP","Pesu uruguayu (1975–1993)");
    result.put("UYU","pesu uruguayu");
    result.put("UZS","Som uzbequistanín");
    result.put("VEB","Bolívar venezolanu (1871–2008)");
    result.put("VEF","bolívar venezolanu (2008–2018)");
    result.put("VES","bolívar venezolanu");
    result.put("VND","dong vietnamín");
    result.put("VNN","Dong vietnamín (1978–1985)");
    result.put("VUV","vatu vanuatuanu");
    result.put("WST","tala samoanu");
    result.put("XAF","Francu CFA centroafricanu");
    result.put("XAG","Plata");
    result.put("XAU","Oru");
    result.put("XBA","Unidá Compuesta Europea");
    result.put("XBB","Unidá monetaria europea");
    result.put("XBC","Unidá de cuenta europea (XBC)");
    result.put("XBD","Unidá de cuenta europea (XBD)");
    result.put("XCD","dólar del Caribe Oriental");
    result.put("XDR","Drechos especiales de xiru");
    result.put("XEU","Unidá de divisa europea");
    result.put("XFO","Francu oru francés");
    result.put("XFU","Francu UIC francés");
    result.put("XOF","francu CFA BCEAO");
    result.put("XPD","Paladiu");
    result.put("XPF","francu CFP");
    result.put("XPT","Platín");
    result.put("XRE","Fondos RINET");
    result.put("XSU","Sucre");
    result.put("XTS","Códigu monetariu de prueba");
    result.put("XUA","unidá de cuenta ADB");
    result.put("XXX","Divisa desconocida");
    result.put("YDD","Dinar yemenín");
    result.put("YER","Rial yemenín");
    result.put("YUD","Dinar fuerte yugoslavu (1966–1990)");
    result.put("YUM","Dinar nuevu yugoslavu (1994–2002)");
    result.put("YUN","Dinar convertible yugoslavu (1990–1992)");
    result.put("YUR","Dinar reformáu yugoslavu (1992–1993)");
    result.put("ZAL","Rand sudafricanu (financieru)");
    result.put("ZAR","Rand sudafricanu");
    result.put("ZMK","Kwacha zambianu (1968–2012)");
    result.put("ZMW","Kwacha zambianu");
    result.put("ZRN","Zaire nuevu zairiegu (1993–1998)");
    result.put("ZRZ","Zaire zairiegu (1971–1993)");
    result.put("ZWD","Dólar zimbabuanu (1980–2008)");
    result.put("ZWL","Dólar zimbabuanu (2009)");
    result.put("ZWR","Dólar zimbabuanu (2008)");
    return result;
  }
}
