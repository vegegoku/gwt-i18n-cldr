...
public class CurrencyList_az_Cyrl_AZ extends CurrencyList_az_Cyrl {
  public CurrencyData getDefault() {
    return new CurrencyDataImpl("AZN","ман.",2,"ман.","ман.");
  }
  ...
  protected HashMap<String, CurrencyData> loadCurrencyMap() {
    ...
    // манат
    result.put("AZN", new CurrencyDataImpl("AZN","ман.",2,"ман.","ман."));
    // BAD
