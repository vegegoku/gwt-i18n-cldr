...
public class CurrencyList_az_Latn_AZ extends CurrencyList_az_Latn {
  public CurrencyData getDefault() {
    return new CurrencyDataImpl("AZN","₼",2,"₼","₼");
  }
  ...
  protected HashMap<String, CurrencyData> loadCurrencyMap() {
    ...
    // Azərbaycan Manatı
    result.put("AZN", new CurrencyDataImpl("AZN","₼",2,"₼","₼"));
  ...
  protected HashMap<String, String> loadNamesMap() {
    ...
    result.put("AFN","Əfqanıstan Əfqanisi");
    result.put("ALK","Albaniya Leki (1946–1965)");
    result.put("ALL","Albaniya Leki");
    result.put("AMD","Ermənistan Dramı");
    result.put("ANG","Niderland Antilyası Gilderi");
    ...
    result.put("ATS","Avstriya Şillinqi");
    result.put("AUD","Avstraliya Dolları");
    result.put("AWG","Aruba Florini");
    result.put("AZM","Azərbaycan Manatı (1993–2006)");
    result.put("AZN","Azərbaycan Manatı");
    result.put("BAD","Bosniya-Herseqovina Dinarı");
    result.put("BAM","Bosniya-Herseqovina Markası");
    ...
    result.put("BGL","Bolqarıstan Levası");
    result.put("BGN","Bolqarıstan Levi");
    result.put("BHD","Bəhreyn Dinarı");
    result.put("BIF","Burundi Frankı");
    result.put("BMD","Bermuda Dolları");
    result.put("BND","Bruney Dolları");
    result.put("BOB","Boliviya Bolivianosu");
    ...
    result.put("BTN","Butan Nqultrumu");
    result.put("BUK","Burmis Kyatı");
    result.put("BWP","Botsvana Pulası");
    result.put("BYB","Belarus Yeni Rublu (1994–1999)");
    result.put("BYN","Belarus Rublu");
    result.put("BYR","Belarus Rublu (2000–2016)");
    result.put("BZD","Beliz Dolları");
    result.put("CAD","Kanada Dolları");
    result.put("CDF","Konqo Frankı");
    result.put("CHE","WIR Avro");
    result.put("CHF","İsveçrə Frankı");
    result.put("CHW","WIR Frankası");
    result.put("CLP","Çili Pesosu");
    result.put("CNH","Çin Yuanı (ofşor)");
    result.put("CNY","Çin Yuanı");
    result.put("COP","Kolumbiya Pesosu");
    result.put("CRC","Kosta Rika Kolonu");
    result.put("CSD","Serbiya Dinarı (2002–2006)");
    result.put("CSK","Çexoslavakiya Korunası");
    result.put("CUC","Kuba Çevrilən Pesosu");
    result.put("CUP","Kuba Pesosu");
    result.put("CVE","Kape Verde Eskudosu");
    result.put("CYP","Kipr Paundu");
    result.put("CZK","Çexiya Korunası");
    result.put("DDM","Şərq Almaniya Ostmarkı");
    result.put("DEM","Alman Markası");
    result.put("DJF","Cibuti Frankı");
    result.put("DKK","Danimarka Kronu");
    result.put("DOP","Dominika Pesosu");
    result.put("DZD","Əlcəzair Dinarı");
    result.put("ECS","Ekvador Sukresi");
    result.put("EEK","Estoniya Krunu");
    result.put("EGP","Misir Funtu");
    result.put("ERN","Eritreya Nakfası");
    result.put("ESA","İspan Pesetası (A account)");
    result.put("ESB","İspan Pesetası (dəyşirik)");
    result.put("ESP","İspan Pesetası");
    result.put("ETB","Efiopiya Bırrı");
    result.put("EUR","Avro");
    result.put("FIM","Fin Markası");
    result.put("FJD","Fici Dolları");
    result.put("FKP","Folklend Adaları Funtu");
    result.put("FRF","Fransız Markası");
    result.put("GBP","Britaniya Funt");
    ...
    result.put("GIP","Gibraltar Funtu");
    result.put("GMD","Qambiya Dalasisi");
    result.put("GNF","Qvineya Frankı");
    ...
    result.put("GYD","Qayana Dolları");
    result.put("HKD","Honq Konq Dolları");
    result.put("HNL","Honduras Lempirası");
    result.put("HRD","Xorvatiya Dinarı");
    result.put("HRK","Xorvatiya Kunası");
    ...
    result.put("ILR","İsrail Şekeli (1980–1985)");
    result.put("ILS","İsrail Yeni Şekeli");
    result.put("INR","Hindistan Rupisi");
    result.put("IQD","İraq Dinarı");
    result.put("IRR","İran Rialı");
    result.put("ISJ","İslandiya Kronu (1918–1981)");
    result.put("ISK","İslandiya Kronu");
    result.put("ITL","İtaliya Lirası");
    result.put("JMD","Yamayka Dolları");
    result.put("JOD","İordaniya Dinarı");
    result.put("JPY","Yaponiya Yeni");
    result.put("KES","Keniya Şillinqi");
    result.put("KGS","Kırğızıstan Somu");
    result.put("KHR","Kamboca Rieli");
    result.put("KMF","Komor Frankı");
    result.put("KPW","Şimali Koreya Vonu");
    result.put("KRW","Cənubi Koreya Vonu");
    result.put("KWD","Küveyt Dinarı");
    result.put("KYD","Kayman Adaları Dolları");
    result.put("KZT","Qazaxıstan Tengesi");
    result.put("LAK","Laos Kipi");
    result.put("LBP","Livan Funtu");
    ...
    result.put("OMR","Oman Rialı");
    result.put("PAB","Panama Balboası");
    result.put("PEI","Peru Inti");
    result.put("PEN","Peru Solu");
    result.put("PES","Peru Solu (1863–1965)");
    result.put("PGK","Papua Yeni Qvineya Kinası");
    result.put("PHP","Filippin Pesosu");
    result.put("PKR","Pakistan Rupisi");
    result.put("PLN","Polşa Zlotısı");
    result.put("PLZ","Polşa Zlotısı (1950–1995)");
    result.put("PTE","Portuqal Eskudosu");
    result.put("PYG","Paraqvay Quaranisi");
    result.put("QAR","Qatar Rialı");
    result.put("RHD","Rodezian Dolları");
    result.put("ROL","Rumıniya Leyi (1952–2006)");
    result.put("RON","Rumıniya Leyi");
    result.put("RSD","Serbiya Dinarı");
    result.put("RUB","Rusiya Rublu");
    result.put("RUR","Rusiya Rublu (1991–1998)");
    result.put("RWF","Ruanda Frankı");
    result.put("SAR","Səudiyyə Riyalı");
    result.put("SBD","Solomon Adaları Dolları");
    result.put("SCR","Seyşel Rupisi");
    result.put("SDG","Sudan Funtu");
    result.put("SEK","İsveç Kronu");
    result.put("SGD","Sinqapur Dolları");
    result.put("SHP","Müqəddəs Yelena Funtu");
    result.put("SIT","Sloveniya Toları");
    result.put("SKK","Slovak Korunası");
    result.put("SLL","Sierra Leon Leonu");
    result.put("SOS","Somali Şillinqi");
    result.put("SRD","Surinam Dolları");
    result.put("SSP","Cənubi Sudan Funtu");
    result.put("STD","San Tom və Prinsip Dobrası (1977–2017)");
    result.put("STN","San Tom və Prinsip Dobrası");
    result.put("SUR","Sovet Rublu");
    result.put("SVC","El Salvador kolonu");
    result.put("SYP","Suriya Funtu");
    result.put("SZL","Svazilend Lilangenini");
    result.put("THB","Tayland Batı");
    result.put("TJR","Tacikistan Rublu");
    result.put("TJS","Tacikistan Somonisi");
    result.put("TMM","Türkmənistan Manatı (1993–2009)");
    result.put("TMT","Türkmənistan Manatı");
    result.put("TND","Tunis Dinarı");
    result.put("TOP","Tonqa Panqası");
    result.put("TPE","Timor Eskudu");
    result.put("TRL","Türkiyə Lirəsi (1922–2005)");
    result.put("TRY","Türkiyə Lirəsi");
    result.put("TTD","Trinidad və Tobaqo Dolları");
    result.put("TWD","Tayvan Yeni Dolları");
    result.put("TZS","Tanzaniya Şillinqi");
    result.put("UAH","Ukrayna Qrivnası");
    result.put("UAK","Ukrayna Karbovenesası");
    result.put("UGS","Uqanda Şillinqi (1966–1987)");
    result.put("UGX","Uqanda Şillinqi");
    ...
    result.put("UZS","Özbəkistan Somu");
    result.put("VEB","Venesuela Bolivarı (1871–2008)");
    result.put("VEF","Venesuela Bolivarı (2008–2018)");
    result.put("VES","Venesuela Bolivarı");
    result.put("VND","Vyetnam Donqu");
    result.put("VNN","Vyetnam Donqu (1978–1985)");
    result.put("VUV","Vanuatu Vatusu");
    result.put("WST","Samoa Talası");
    result.put("XAF","Kamerun Frankı");
    result.put("XAG","gümüş");
    result.put("XAU","qızıl");
    result.put("XCD","Şərqi Karib Dolları");
    result.put("XFO","Fransız Gızıl Frankı");
    result.put("XFU","Fransız UİC Frankı");
    result.put("XOF","Fil Dişi Sahili Frankı");
    result.put("XPD","Palladium");
    result.put("XPF","Fransız Polineziyası Frankı");
    result.put("XPT","Platinum");
    result.put("XXX","Naməlum Valyuta");
    result.put("YDD","Yəmən Dinarı");
    result.put("YER","Yəmən Rialı");
    result.put("YUD","Yuqoslaviya Dinarı (1966–1990)");
    result.put("YUM","Yuqoslaviya Yeni Dinarı (1994–2002)");
    result.put("YUN","Yuqoslaviya Dinarı (1990–1992)");
    result.put("ZAL","Cənubi Afrika Randı (finans)");
    result.put("ZAR","Cənubi Afrika Randı");
    result.put("ZMK","Zambiya Kvaçası (1968–2012)");
    result.put("ZMW","Zambiya Kvaçası");
    result.put("ZRN","Zair Yeni Zairi (1993–1998)");
    result.put("ZRZ","Zair Zairi (1971–1993)");
    result.put("ZWD","Zimbabve Dolları (1980–2008)");
    result.put("ZWL","Zimbabve Dolları (2009)");
    result.put("ZWR","Zimbabve Dolları (2008)");
    return result;
  }
}
