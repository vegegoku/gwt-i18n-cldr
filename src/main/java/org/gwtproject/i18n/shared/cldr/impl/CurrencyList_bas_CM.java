...
public class CurrencyList_bas_CM extends CurrencyList_bas {
  ...
  protected HashMap<String, String> loadNamesMap() {
    ...
    result.put("AED","Dirhàm èmìrâ");
    result.put("AOA","Kwànza àŋgolà");
    result.put("AUD","Dɔ̀lâr òstralìà");
    result.put("BHD","Dinâr Bàraìn");
    result.put("BIF","Frǎŋ bùrundì");
    result.put("BWP","Pùla Bòtswanà");
    result.put("CAD","Dɔ̀lâr kànadà");
    result.put("CDF","Frǎŋ kòŋgo");
    result.put("CHF","Frǎŋ sùwîs");
    result.put("CNY","Yùan kinà");
    result.put("CVE","Èskudò kabwe᷆r");
    result.put("DJF","Frǎŋ jìbutì");
    result.put("DZD","Dìnâr àlgerìà");
    result.put("EGP","Paùnd ègîptò");
    result.put("ERN","Nafkà èrìtrěà");
    result.put("ETB","Bîr ètìopìà");
    result.put("EUR","Èrô");
    result.put("GBP","Stɛrlìŋ ŋgìsì");
    result.put("GHC","Sèdi gānà");
    result.put("GMD","Dalasì gambìà");
    result.put("GNS","Frǎŋ gìnê");
    result.put("INR","Rùpi īndìà");
    result.put("JPY","Yɛ̂n yàpân");
    result.put("KES","Silîŋ kenìà");
    result.put("KMF","Frǎŋ kòmorà");
    result.put("LRD","Dɔ̀lâr lìberìà");
    result.put("LSL","Lotì lèsòtò");
    result.put("LYD","Dìnâr libìà");
    result.put("MAD","Dìrham màrôk");
    result.put("MGA","Frǎŋ màlàgasì");
    result.put("MRO","Ùgwiya mòrìtanìa (1973–2017)");
    result.put("MRU","Ùgwiya mòrìtanìa");
    result.put("MUR","Rupìɛ̀ mòrîs");
    result.put("MWK","Kwaca màlawì");
    result.put("MZM","Mètìkal mòsàmbîk");
    result.put("NAD","Dɔ̀lâr nàmibìà");
    result.put("NGN","Nayrà nìgerìà");
    result.put("RWF","Frǎŋ Rùandà");
    result.put("SAR","Rìal sàudì");
    result.put("SCR","Rùpiɛ̀ sèsɛ̂l");
    result.put("SDG","Dìnâr sùdân");
    result.put("SDP","Paùnd sùdân");
    result.put("SHP","Paùnd hèlenà");
    result.put("SLL","Lèonɛ̀");
    result.put("SOS","Silîŋ sòmàli");
    result.put("STD","Dobrà sàotòme (1977–2017)");
    result.put("STN","Dobrà sàotòme");
    result.put("SZL","Lìlàŋgeni swàzì");
    result.put("TND","Dìnâr tùnîs");
    result.put("TZS","Silîŋ tànzànià");
    result.put("UGX","Silîŋ ùgàndà");
    result.put("USD","Dɔla àmerkà");
    result.put("XAF","Frǎŋ CFA (BEAC)");
    result.put("XOF","Frǎŋ CFA (BCEAO)");
    result.put("ZAR","Rân àfrǐkàsɔ̀");
    result.put("ZMK","Kwàca sàmbià (1968–2012)");
    result.put("ZMW","Kwàca sàmbià");
    result.put("ZWD","Dɔ̀lâr sìmbàbwê");
    return result;
  }
}
