...
public class CurrencyList_bez_TZ extends CurrencyList_bez {
  ...
  protected HashMap<String, String> loadNamesMap() {
    ...
    result.put("AED","Lupila lwa Hufalme dza Huhihalabu");
    result.put("AOA","Lupila lwa Huangola");
    result.put("AUD","Lupila lwa Huaustlalia");
    result.put("BHD","Lupila lwa Hubahareni");
    result.put("BIF","Lupila lwa Huburundi");
    result.put("BWP","Lupila lwa Hubotswana");
    result.put("CAD","Lupila lwa Hukanada");
    result.put("CDF","Lupila lwa Hukongo");
    result.put("CHF","Lupila lwa Huuswisi");
    result.put("CNY","Lupila lwa Huchina");
    result.put("CVE","Lupila lwa Hukepuvede");
    result.put("DJF","Lupila lwa Hujibuti");
    result.put("DZD","Lupila lwa Hualjelia");
    result.put("EGP","Lupila lwa Humisri");
    result.put("ERN","Lupila lwa Hueritrea");
    result.put("ETB","Lupila lwa Huuhabeshi");
    result.put("EUR","Lupila lwa Yulo");
    result.put("GBP","Lupila lwa Huuingereza");
    result.put("GHC","Lupila lwa Hughana");
    result.put("GMD","Lupila lwa Hugambia");
    result.put("GNS","Lupila lwa Hujine");
    result.put("INR","Lupila lwa Huindia");
    result.put("JPY","Lupila lwa Hijapani");
    result.put("KES","Shilingi ya Hukenya");
    result.put("KMF","Lupila lwa Hukomoro");
    result.put("LRD","Lupila lwa Hulibelia");
    result.put("LSL","Lupila lwa Hulesoto");
    result.put("LYD","Lupila lwa Hulibya");
    result.put("MAD","Lupila lwa Humoloko");
    result.put("MGA","Lupila lwa Hubukini");
    result.put("MRO","Lupila lwa Humolitania (1973–2017)");
    result.put("MRU","Lupila lwa Humolitania");
    result.put("MUR","Lupila lwa Humolisi");
    result.put("MWK","Lupila lwa Humalawi");
    result.put("MZM","Lupila lwa Humsumbiji");
    result.put("NAD","Lupila lwa Hunamibia");
    result.put("NGN","Lupila lwa Hunijelia");
    result.put("RWF","Lupila lwa Hurwanda");
    result.put("SAR","Lupila lwa Husaudi");
    result.put("SCR","Lupila lwa Hushelisheli");
    result.put("SDG","Lupila lwa Husudani");
    result.put("SHP","Lupila lwa Husantahelena");
    result.put("SLL","Lupila lwa Lioni");
    result.put("SOS","Lupila lwa Husomalia");
    result.put("STD","Lupila lwa Husaotome na Huprinisipe (1977–2017)");
    result.put("STN","Lupila lwa Husaotome na Huprinisipe");
    result.put("SZL","Lupila lwa Lilangeni");
    result.put("TND","Lupila lwa Hutunisia");
    result.put("TZS","Shilingi ya Hutanzania");
    result.put("UGX","Shilingi ya Huuganda");
    result.put("USD","Lupila lwa Humalekani");
    result.put("XAF","Lupila lwa CFA BEAC");
    result.put("XOF","Lupila lwa CFA BCEAO");
    result.put("ZAR","Lupila lwa Huafriaka ya Hukusini");
    result.put("ZMK","Lupila lwa Huzambia (1968–2012)");
    result.put("ZMW","Lupila lwa Huzambia");
    result.put("ZWD","Lupila lwa Huzimbabwe");
    return result;
  }
}
