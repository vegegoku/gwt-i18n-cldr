...
public class CurrencyList_bg_BG extends CurrencyList_bg {
  public CurrencyData getDefault() {
    return new CurrencyDataImpl("BGN","лв.",2,"лв.","лв.");
  }
  ...
  protected HashMap<String, CurrencyData> loadCurrencyMap() {
    ...
    // Български лев
    result.put("BGN", new CurrencyDataImpl("BGN","лв.",2,"лв.","лв."));
    // BGO
    ...
    // Щатски долар
    result.put("USD", new CurrencyDataImpl("USD","щ.д.",2,"щ.д.","щ.д."));
    // USN
  ...
  protected HashMap<String, String> loadNamesMap() {
    ...
    result.put("AFN","Афганистански афган");
    result.put("ALL","Албански лек");
    result.put("AMD","Арменски драм");
    result.put("ANG","Антилски гулден");
    result.put("AOA","Анголска кванза");
    result.put("AOK","Анголска кванца (1977–1990)");
    result.put("AON","Анголска нова кванца (1990–2000)");
    result.put("AOR","Анголска нова кванца (1995–1999)");
    result.put("ARA","Аржентински австрал");
    result.put("ARP","Аржентинско песо (1983–1985)");
    result.put("ARS","Аржентинско песо");
    result.put("ATS","Австрийски шилинг");
    result.put("AUD","Австралийски долар");
    result.put("AWG","Арубски флорин");
    result.put("AZM","Азербайджански манат (1993–2006)");
    result.put("AZN","Азербайджански манат");
    result.put("BAD","Босна и Херцеговина-динар");
    result.put("BAM","Босненска конвертируема марка");
    result.put("BBD","Барбадоски долар");
    result.put("BDT","Бангладешка така");
    result.put("BEC","Белгийски франк (конвертируем)");
    result.put("BEF","Белгийски франк");
    result.put("BEL","Белгийски франк (финансов)");
    result.put("BGL","Български конвертируем лев (1962–1999)");
    result.put("BGN","Български лев");
    result.put("BHD","Бахрейнски динар");
    result.put("BIF","Бурундийски франк");
    result.put("BMD","Бермудски долар");
    result.put("BND","Брунейски долар");
    result.put("BOB","Боливийско боливиано");
    result.put("BOP","Боливийско песо");
    result.put("BOV","Боливийски мвдол");
    result.put("BRB","Бразилско ново крузейро (1967–1986)");
    result.put("BRC","Бразилско крозадо");
    result.put("BRE","Бразилско крузейро (1990–1993)");
    result.put("BRL","Бразилски реал");
    result.put("BRN","Бразилско ново крозадо");
    result.put("BRR","Бразилско крузейро");
    result.put("BSD","Бахамски долар");
    result.put("BTN","Бутански нгултрум");
    result.put("BUK","Бирмански киат");
    result.put("BWP","Ботсванска пула");
    result.put("BYB","Беларуска нова рубла (1994–1999)");
    result.put("BYN","Беларуска рубла");
    result.put("BYR","Беларуска рубла (2000–2016)");
    result.put("BZD","Белизийски долар");
    result.put("CAD","Канадски долар");
    result.put("CDF","Конгоански франк");
    result.put("CHE","WIR евро");
    result.put("CHF","Швейцарски франк");
    result.put("CHW","WIR франк");
    result.put("CLF","Условна разчетна единица на Чили");
    result.put("CLP","Чилийско песо");
    result.put("CNH","Китайски ренминби юан (offshore)");
    result.put("CNY","Китайски юан");
    result.put("COP","Колумбийско песо");
    result.put("COU","Колумбийска единица на реалната стойност");
    result.put("CRC","Костарикански колон");
    result.put("CSD","Стар сръбски динар");
    result.put("CSK","Чехословашка конвертируема крона");
    result.put("CUC","Кубинско конвертируемо песо");
    result.put("CUP","Кубинско песо");
    result.put("CVE","Ескудо на Кабо Верде");
    result.put("CYP","Кипърска лира");
    result.put("CZK","Чешка крона");
    result.put("DDM","Източногерманска марка");
    result.put("DEM","Германска марка");
    result.put("DJF","Джибутски франк");
    result.put("DKK","Датска крона");
    result.put("DOP","Доминиканско песо");
    result.put("DZD","Алжирски динар");
    result.put("ECS","Еквадорско сукре");
    result.put("ECV","Еквадорска банкова единица");
    result.put("EEK","Естонска крона");
    result.put("EGP","Египетска лира");
    result.put("ERN","Еритрейска накфа");
    result.put("ESP","Испанска песета");
    result.put("ETB","Етиопски бир");
    result.put("EUR","Евро");
    result.put("FIM","Финландска марка");
    result.put("FJD","Фиджийски долар");
    result.put("FKP","Фолклендска лира");
    result.put("FRF","Френски франк");
    result.put("GBP","Британска лира");
    result.put("GEK","Грузински купон");
    result.put("GEL","Грузински лари");
    result.put("GHC","Ганайско седи (1979–2007)");
    result.put("GHS","Ганайско седи");
    result.put("GIP","Гибралтарска лира");
    result.put("GMD","Гамбийско даласи");
    result.put("GNF","Гвинейски франк");
    result.put("GNS","Гвинейска сили");
    result.put("GQE","Екваториално гвинейско еквеле");
    result.put("GRD","Гръцка драхма");
    result.put("GTQ","Гватемалски кетцал");
    result.put("GWE","Ескудо от Португалска Гвинея");
    result.put("GWP","Гвинея-Бисау песо");
    result.put("GYD","Гаянски долар");
    result.put("HKD","Хонконгски долар");
    result.put("HNL","Хондураска лемпира");
    result.put("HRD","Хърватски динар");
    result.put("HRK","Хърватска куна");
    result.put("HTG","Хаитски гурд");
    result.put("HUF","Унгарски форинт");
    result.put("IDR","Индонезийска рупия");
    result.put("IEP","Ирландска лира");
    result.put("ILP","Израелска лира");
    result.put("ILS","Израелски нов шекел");
    result.put("INR","Индийска рупия");
    result.put("IQD","Иракски динар");
    result.put("IRR","Ирански риал");
    result.put("ISK","Исландска крона");
    result.put("ITL","Италианска лира");
    result.put("JMD","Ямайски долар");
    result.put("JOD","Йордански динар");
    result.put("JPY","Японска йена");
    result.put("KES","Кенийски шилинг");
    result.put("KGS","Киргизстански сом");
    result.put("KHR","Камбоджански риел");
    result.put("KMF","Коморски франк");
    result.put("KPW","Севернокорейски вон");
    result.put("KRW","Южнокорейски вон");
    result.put("KWD","Кувейтски динар");
    result.put("KYD","Кайманов долар");
    result.put("KZT","Казахстанско тенге");
    result.put("LAK","Лаоски кип");
    result.put("LBP","Ливанска лира");
    result.put("LKR","Шриланкска рупия");
    result.put("LRD","Либерийски долар");
    result.put("LSL","Лесотско лоти");
    result.put("LTL","Литовски литас");
    result.put("LTT","Литовски талон");
    result.put("LUF","Люксембургски франк");
    result.put("LVL","Латвийски лат");
    result.put("LVR","Латвийска рубла");
    result.put("LYD","Либийски динар");
    result.put("MAD","Марокански дирхам");
    result.put("MAF","Марокански франк");
    result.put("MDL","Молдовско леу");
    result.put("MGA","Малгашко ариари");
    result.put("MGF","Малгашки франк - Мадагаскар");
    result.put("MKD","Македонски денар");
    result.put("MLF","Малийски франк");
    result.put("MMK","Мианмарски кият");
    result.put("MNT","Монголски тугрик");
    result.put("MOP","Патака на Макао");
    result.put("MRO","Мавританска угия (1973–2017)");
    result.put("MRU","Мавританска угия");
    result.put("MTL","Малтийска лира");
    result.put("MUR","Маврицийска рупия");
    result.put("MVR","Малдивска руфия");
    result.put("MWK","Малавийска квача");
    result.put("MXN","Мексиканско песо");
    result.put("MXP","Мексиканско сребърно песо (1861–1992)");
    result.put("MXV","Мексиканска конвертируема единица (UDI)");
    result.put("MYR","Малайзийски рингит");
    result.put("MZE","Мозамбикско ескудо");
    result.put("MZM","Мозамбикски метикал (1980–2006)");
    result.put("MZN","Мозамбикски метикал");
    result.put("NAD","Намибийски долар");
    result.put("NGN","Нигерийска найра");
    result.put("NIC","Никарагуанска кордоба (1988–1991)");
    result.put("NIO","Никарагуанска кордоба");
    result.put("NLG","Холандски гулден");
    result.put("NOK","Норвежка крона");
    result.put("NPR","Непалска рупия");
    result.put("NZD","Новозеландски долар");
    result.put("OMR","Омански риал");
    result.put("PAB","Панамска балбоа");
    result.put("PEI","Перуанско инти");
    result.put("PEN","Перуански сол");
    result.put("PES","Перуански сол (1863–1965)");
    result.put("PGK","Папуа-новогвинейска кина");
    result.put("PHP","Филипинско песо");
    result.put("PKR","Пакистанска рупия");
    result.put("PLN","Полска злота");
    result.put("PLZ","Полска злота (1950–1995)");
    result.put("PTE","Португалско ескудо");
    result.put("PYG","Парагвайско гуарани");
    result.put("QAR","Катарски риал");
    result.put("RHD","Родезийски долар");
    result.put("ROL","Стара румънска лея");
    result.put("RON","Румънска лея");
    result.put("RSD","Сръбски динар");
    result.put("RUB","Руска рубла");
    result.put("RUR","Руска рубла (1991–1998)");
    result.put("RWF","Руандски франк");
    result.put("SAR","Саудитскоарабски риал");
    result.put("SBD","Долар на Соломоновите острови");
    result.put("SCR","Сейшелска рупия");
    result.put("SDD","Судански динар");
    result.put("SDG","Суданска лира");
    result.put("SEK","Шведска крона");
    result.put("SGD","Сингапурски долар");
    result.put("SHP","Лира на Света Елена");
    result.put("SIT","Словенски толар");
    result.put("SKK","Словашка крона");
    result.put("SLL","Сиералеонско леоне");
    result.put("SOS","Сомалийски шилинг");
    result.put("SRD","Суринамски долар");
    result.put("SRG","Суринамски гилдер");
    result.put("SSP","Южносуданска лира");
    result.put("STD","Добра на Сао Томе и Принсипи (1977–2017)");
    result.put("STN","Добра на Сао Томе и Принсипи");
    result.put("SUR","Съветска рубла");
    result.put("SVC","Салвадорски колон");
    result.put("SYP","Сирийска лира");
    result.put("SZL","Свазилендски лилангени");
    result.put("THB","Тайландски бат");
    result.put("TJR","Таджикистанска рубла");
    result.put("TJS","Таджикистански сомони");
    result.put("TMM","Туркменистански манат");
    result.put("TMT","Туркменски манат");
    result.put("TND","Тунизийски динар");
    result.put("TOP","Тонганска паанга");
    result.put("TPE","Тиморско ескудо");
    result.put("TRL","Турска лира (1922–2005)");
    result.put("TRY","Турска лира");
    result.put("TTD","Долар на Тринидад и Тобаго");
    result.put("TWD","Тайвански долар");
    result.put("TZS","Танзанийски шилинг");
    result.put("UAH","Украинска хривня");
    result.put("UAK","Украински карбованец");
    result.put("UGS","Угандийски шилинг (1966–1987)");
    result.put("UGX","Угандски шилинг");
    result.put("USD","Щатски долар");
    result.put("UYI","Уругвайско песо (индекс на инфлацията)");
    result.put("UYP","Уругвайско песо (1975–1993)");
    result.put("UYU","Уругвайско песо");
    result.put("UZS","Узбекски сум");
    result.put("VEB","Венецуелски боливар (1871–2008)");
    result.put("VEF","Венецуелски боливар");
    result.put("VES","Венецуелски боливар (VES)");
    result.put("VND","Виетнамски донг");
    result.put("VUV","Вануатско вату");
    result.put("WST","Самоанска тала");
    result.put("XAF","Централноафрикански франк");
    result.put("XAG","Сребро");
    result.put("XAU","Злато");
    result.put("XBA","Европейска съставна единица");
    result.put("XBB","Европейска валутна единица");
    result.put("XBC","Европейска единица по сметка (XBC)");
    result.put("XBD","Европейска единица по сметка (XBD)");
    result.put("XCD","Източнокарибски долар");
    result.put("XDR","Специални права на тираж");
    result.put("XEU","Еку на ЕИО");
    result.put("XFO","Френски златен франк");
    result.put("XOF","Западноафрикански франк");
    result.put("XPD","Паладий");
    result.put("XPF","Френскополинезийски франк");
    result.put("XPT","Платина");
    result.put("XTS","Код резервиран за целите на тестване");
    result.put("XXX","Непозната валута");
    result.put("YDD","Йеменски динар");
    result.put("YER","Йеменски риал");
    result.put("YUD","Югославски твърд динар");
    result.put("YUM","Югославски динар");
    result.put("YUN","Югославски конвертируем динар");
    result.put("ZAL","Южноафрикански ранд (финансов)");
    result.put("ZAR","Южноафрикански ранд");
    result.put("ZMK","Замбийска квача (1968–2012)");
    result.put("ZMW","Замбийска куача");
    result.put("ZRN","Заирско ново зайре");
    result.put("ZRZ","Заирско зайре");
    result.put("ZWD","Зимбабвийски долар");
    result.put("ZWL","Зимбабвийски долар (2009)");
    return result;
  }
}
