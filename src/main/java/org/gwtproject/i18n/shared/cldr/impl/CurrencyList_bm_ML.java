...
public class CurrencyList_bm_ML extends CurrencyList_bm {
  ...
  protected HashMap<String, String> loadNamesMap() {
    ...
    result.put("AED","arabu mara kafoli Diram");
    result.put("AOA","angola Kwanza");
    result.put("AUD","ositirali Dolar");
    result.put("BHD","bareyini Dinar");
    result.put("BIF","burundi Fraŋ");
    result.put("BWP","bɔtisiwana Pula");
    result.put("CAD","kanada Dolar");
    result.put("CDF","kongole Fraŋ");
    result.put("CHF","suwisi Fraŋ");
    result.put("CNY","siniwa Yuwan");
    result.put("CVE","capivɛrdi Esekudo");
    result.put("DJF","jibuti Fraŋ");
    result.put("DZD","alizeri Dinar");
    result.put("EGP","eziputi Livri");
    result.put("ERN","eritere Nafika");
    result.put("ETB","etiopi Bir");
    result.put("EUR","ero");
    result.put("GBP","angilɛ Livri");
    result.put("GHC","gana Sedi");
    result.put("GMD","gambi Dalasi");
    result.put("GNS","gine Fraŋ");
    result.put("INR","Ɛndu Rupi");
    result.put("JPY","zapɔne Yɛn");
    result.put("KES","keniya Siling");
    result.put("KMF","komɔri Fraŋ");
    result.put("LRD","liberiya Dolar");
    result.put("LSL","lesoto Loti");
    result.put("LYD","libi Dinar");
    result.put("MAD","marɔku Diram");
    result.put("MGA","madagasikari Fraŋ");
    result.put("MRO","mɔritani Uguwiya (1973–2017)");
    result.put("MRU","mɔritani Uguwiya");
    result.put("MUR","morisi Rupi");
    result.put("MWK","malawi Kwaca");
    result.put("MZM","mozanbiki Metikali");
    result.put("NAD","namibi Dolar");
    result.put("NGN","nizeriya Nɛra");
    result.put("RWF","ruwanda Fraŋ");
    result.put("SAR","sawudiya Riyal");
    result.put("SCR","sesɛli Rupi");
    result.put("SDG","sudani Dinar");
    result.put("SDP","sudani Livri");
    result.put("SHP","Ɛlɛni-Senu Livri");
    result.put("SLL","siyeralewɔni Lewɔni");
    result.put("SOS","somali Siling");
    result.put("STD","sawotome Dobra (1977–2017)");
    result.put("STN","sawotome Dobra");
    result.put("SZL","swazilandi Lilangeni");
    result.put("TND","tunizi Dinar");
    result.put("TZS","tanzani Siling");
    result.put("UGX","uganda Siling");
    result.put("USD","ameriki Dolar");
    result.put("XAF","sefa Fraŋ (BEAC)");
    result.put("XOF","sefa Fraŋ (BCEAO)");
    result.put("ZAR","sudafriki Randi");
    result.put("ZMK","zambi Kwaca (1968–2012)");
    result.put("ZMW","zambi Kwaca");
    result.put("ZWD","zimbabuwe Dolar");
    return result;
  }
}
