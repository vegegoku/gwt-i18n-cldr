...
public class CurrencyList_bn_IN extends CurrencyList_bn {
  ...
  protected HashMap<String, String> loadNamesMap() {
    ...
    result.put("BAM","বসনিয়া এবং হার্জেগোভিনা বিনিমেয় মার্ক");
    ...
    result.put("BYN","বেলারুশিয়ান রুবেল");
    result.put("BYR","বেলারুশিয়ান রুবেল (2000–2016)");
    result.put("BZD","বেলিজ ডলার");
    result.put("CAD","কানাডিয়ান ডলার");
    result.put("CDF","কঙ্গোলিস ফ্র্যাঙ্ক");
    result.put("CHE","সুইজারল্যান্ড ইউরো");
    result.put("CHF","সুইস ফ্রাঁ");
    result.put("CHW","সুইজারল্যান্ড ফ্রাঙ্ক");
    result.put("CLF","চিলিয়ান উনিদাদেস দি ফোমেন্তো");
    result.put("CLP","চিলি পেসো");
    result.put("CNH","চাইনিজ ইউয়ান (অফশোর)");
    result.put("CNY","চীনা য়ুয়ান");
    ...
    result.put("ISK","আইসল্যান্ডীয় ক্রোনা");
    result.put("ITL","ইতালীয় লিরা");
    result.put("JMD","জামাইকান ডলার");
    result.put("JOD","জর্ডানিয়ান দিনার");
    result.put("JPY","জাপানি ইয়েন");
    ...
    result.put("MRO","মৌরিতানিয়ান ওউগুইয়া (১৯৭৩–২০১৭)");
    result.put("MRU","মৌরিতানিয়ান ওউগুইয়া");
    ...
    result.put("NOK","নরওয়েজিয়ান ক্রোন");
    ...
    result.put("PEN","পেরুভিয়ান সোল");
    result.put("PES","পেরুভিয়ান সোল (1863–1965)");
    result.put("PGK","পাপুয়া নিউ গিনিয়ান কিনা");
    ...
    result.put("PYG","প্যারাগুয়ান গুয়ারানি");
    result.put("QAR","কাতার রিয়াল");
    ...
    result.put("SSP","দক্ষিণ সুদানি পাউন্ড");
    result.put("STD","সাও টোমে এবং প্রিন্সিপে ডোবরা (১৯৭৭–২০১৭)");
    result.put("STN","সাও টোমে এবং প্রিন্সিপে ডোবরা");
    ...
    result.put("TMT","তুর্কমেনিস্তান মানত");
    ...
    result.put("TWD","নতুন তাইওয়ান ডলার");
    ...
    result.put("UYU","উরুগুয়ে পেসো");
    result.put("UZS","উজবেকিস্তানি সোম");
    result.put("VEB","ভেনিজুয়েলান বলিভার (১৮৭১–২০০৮)");
    result.put("VEF","ভেনিজুয়েলীয় বলিভার (২০০৮–২০১৮)");
    result.put("VES","ভেনিজুয়েলীয় বলিভার");
    result.put("VND","ভিয়েতনামি ডঙ্গ");
    result.put("VUV","ভানুয়াতু ভাতু");
    result.put("WST","সামোয়ান টালা");
    result.put("XAF","মধ্য আফ্রিকান [CFA] ফ্র্যাঙ্ক");
    ...
    result.put("ZMK","জাম্বিয়ান কওয়াচা (১৯৬৮–২০১২)");
    result.put("ZMW","জাম্বিয়ান কওয়াচা");
