...
public class CurrencyList_bo_IN extends CurrencyList_bo {
  ...
  protected HashMap<String, String> loadNamesMap() {
    ...
    result.put("CNY","ཡུ་ཨན་");
    result.put("INR","རྒྱ་གར་སྒོར་");
    result.put("USD","ཨ་རིའི་སྒོར་");
    result.put("XXX","མ་རྟོགས་པའི་ནུས་མེད་དངུལ་ལོར");
    return result;
  }
}
