...
public class CurrencyList_br_FR extends CurrencyList_br {
  ...
  protected HashMap<String, CurrencyData> loadCurrencyMap() {
    ...
    // lur Breizh-Veur
    result.put("GBP", new CurrencyDataImpl("GBP","£ RU",2,"£ RU","£ RU"));
    // GEK
    ...
    // dollar Zeland-Nevez
    result.put("NZD", new CurrencyDataImpl("NZD","$ ZN",2,"$ ZN","$ ZN"));
    // rial Oman
    ...
    // dollar SU
    result.put("USD", new CurrencyDataImpl("USD","$ SU",2,"$ SU","$ SU"));
    // USN
  ...
  protected HashMap<String, String> loadNamesMap() {
    ...
    result.put("ALK","lek Albania (1946–1965)");
    ...
    result.put("AON","kwanza nevez Angola (1990–2000)");
    result.put("ARM","peso Arcʼhantina (1881–1970)");
    result.put("ARP","peso Arcʼhantina (1983–1985)");
    result.put("ARS","peso Arcʼhantina");
    result.put("ATS","schilling Aostria");
    ...
    result.put("BAD","dinar Bosnia ha Herzegovina (1992–1994)");
    result.put("BAM","mark kemmadus Bosnia ha Herzegovina");
    result.put("BAN","dinar nevez Bosnia ha Herzegovina (1994–1997)");
    result.put("BBD","dollar Barbados");
    result.put("BDT","taka Bangladesh");
    result.put("BEC","lur Belgia (kemmadus)");
    result.put("BEF","lur Belgia");
    result.put("BGM","lev sokialour Bulgaria");
    ...
    result.put("BUK","kyat Birmania");
    result.put("BWP","pula Botswana");
    result.put("BYB","roubl nevez Belarus (1994–1999)");
    result.put("BYN","roubl Belarus");
    result.put("BYR","roubl Belarus (2000–2016)");
    ...
    result.put("CHW","lur WIR");
    result.put("CLE","escudo Chile");
    result.put("CLF","unanenn jediñ Chile");
    result.put("CLP","peso Chile");
    result.put("CNX","dollar Bank poblel Sina");
    result.put("CNY","yuan Sina");
    ...
    result.put("CYP","lur Kiprenez");
    result.put("CZK","kurunenn Tchek");
    result.put("DDM","mark Alamagn ar Reter");
    result.put("DEM","mark Alamagn");
    ...
    result.put("ESB","peseta gemmadus Spagn");
    result.put("ESP","peseta Spagn");
    result.put("ETB","birr Etiopia");
    result.put("EUR","euro");
    result.put("FIM","mark Finland");
    result.put("FJD","dollar Fidji");
    result.put("FKP","lur Inizi Falkland");
    result.put("FRF","lur gall");
    result.put("GBP","lur Breizh-Veur");
    ...
    result.put("KRH","hwan Korea ar Su (1953–1962)");
    result.put("KRO","won Korea ar Su (1945–1953)");
    ...
    result.put("NIC","cordoba Nicaragua (1988–1991)");
    result.put("NIO","cordoba Nicaragua");
    result.put("NLG","florin an Izelvroioù");
    ...
    result.put("PEN","sol Perou");
    result.put("PES","sol Perou (1863–1965)");
    ...
    result.put("PLZ","zloty Polonia (1950–1995)");
    result.put("PTE","escudo Portugal");
    result.put("PYG","guarani Paraguay");
    result.put("QAR","rial Qatar");
    result.put("RHD","dollar Rodezia");
    result.put("ROL","leu Roumania (1952–2006)");
    result.put("RON","leu Roumania");
    result.put("RSD","dinar Serbia");
    result.put("RUB","roubl Rusia");
    result.put("RUR","roubl Rusia (1991–1998)");
    ...
    result.put("SDD","dinar Soudan (1992–2007)");
    result.put("SDG","lur Soudan");
    result.put("SDP","lur Soudan (1957–1998)");
    ...
    result.put("SRG","florin Surinam");
    result.put("SSP","lur Susoudan");
    result.put("STD","dobra São Tomé ha Príncipe (1977–2017)");
    result.put("STN","dobra São Tomé ha Príncipe");
    result.put("SUR","roubl soviedel");
    result.put("SVC","colón Salvador");
    result.put("SYP","lur Siria");
    result.put("SZL","lilangeni Swaziland");
    result.put("THB","baht Thailand");
    result.put("TJR","roubl Tadjikistan");
    ...
    result.put("TRL","lur Turkia (1922–2005)");
    ...
    result.put("UGS","shilling Ouganda (1966–1987)");
    ...
    result.put("VNN","dong Viêt Nam (1978–1985)");
    result.put("VUV","vatu Vanuatu");
    result.put("WST","tala Samoa");
    result.put("XAF","lur CFA Kreizafrika");
    result.put("XAG","arcʼhant");
    result.put("XAU","aour");
    result.put("XBA","unanenn genaoz europat");
    ...
    result.put("YUM","dinar nevez Yougoslavia (1994–2002)");
    result.put("YUN","dinar kemmadus Yougoslavia (1990–1992)");
    result.put("YUR","dinar adreizhet Yougoslavia (1992–1993)");
    result.put("ZAR","rand Suafrika");
    result.put("ZMK","kwacha Zambia (1968–2012)");
    result.put("ZMW","kwacha Zambia");
    result.put("ZWD","dollar Zimbabwe (1980–2008)");
    result.put("ZWL","dollar Zimbabwe (2009)");
    result.put("ZWR","dollar Zimbabwe (2008)");
    return result;
  }
}
