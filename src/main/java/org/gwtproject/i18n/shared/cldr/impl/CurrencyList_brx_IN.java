...
public class CurrencyList_brx_IN extends CurrencyList_brx {
  ...
  protected HashMap<String, String> loadNamesMap() {
    ...
    result.put("BYN","बेलारुसी रूबल");
    result.put("BYR","बेलारुसी रूबल (2000–2016)");
    ...
    result.put("MRO","मौरिटानी ऊगुया (1973–2017)");
    result.put("MRU","मौरिटानी ऊगुया");
    ...
    result.put("PEN","पेरुवाई सोल");
    result.put("PES","पेरुवाई सोल (1863–1965)");
    ...
    result.put("STD","साँव तोमे एवं प्रीन्सीपे का डोब्रा (1977–2017)");
    result.put("STN","साँव तोमे एवं प्रीन्सीपे का डोब्रा");
    ...
    result.put("VEB","वेनेज़ुएलाई बोलिवार (1871–2008)");
    result.put("VEF","वेनेज़ुएलाई बोलिवार (2008–2018)");
    result.put("VES","वेनेज़ुएलाई बोलिवार");
    ...
    result.put("ZMK","ज़ाम्बियाई क्वाचा (1968–2012)");
    result.put("ZMW","ज़ाम्बियाई क्वाचा");
