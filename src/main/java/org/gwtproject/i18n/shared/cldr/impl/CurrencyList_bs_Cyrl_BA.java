...
public class CurrencyList_bs_Cyrl_BA extends CurrencyList_bs_Cyrl {
  ...
  protected HashMap<String, CurrencyData> loadCurrencyMap() {
    ...
    // Чешка круна
    result.put("CZK", new CurrencyDataImpl("CZK","Кч",2,"Кч","Кч"));
    ...
    // Пољски злот
    result.put("PLN", new CurrencyDataImpl("PLN","зл",2,"зл","зл"));
    ...
    // Српски динар
    result.put("RSD", new CurrencyDataImpl("RSD","дин.",0,"дин.","дин."));
    // Руска рубља
  ...
  protected HashMap<String, String> loadNamesMap() {
    ...
    result.put("MRO","Мауританијска угвија (1973–2017)");
    result.put("MRU","Мауританијска угвија");
    ...
    result.put("STD","Сао Томе и Принципе добра (1977–2017)");
    result.put("STN","Сао Томе и Принципе добра");
