...
public class CurrencyList_ca_ES_VALENCIA extends CurrencyList_ca_ES {
  ...
  protected HashMap<String, String> loadNamesMap() {
    ...
    result.put("ARM","peso argentí (1981–1970)");
    ...
    result.put("AZM","manat azerbaidjanés (1993–2006)");
    result.put("AZN","manat azerbaidjanés");
    ...
    result.put("BYN","ruble bielorús");
    result.put("BYR","ruble bielorús (2000–2016)");
    ...
    result.put("CLE","escut xilé");
    result.put("CLF","unidad de fomento xilena");
    result.put("CLP","peso xilé");
    result.put("CNH","iuan xinès extracontinental");
    result.put("CNX","dòlar del Banc Popular Xinés");
    result.put("CNY","iuan xinés");
    result.put("COP","peso colombià");
    result.put("COU","unidad de valor real colombiana");
    result.put("CRC","colon costa-riqueny");
    ...
    result.put("HUF","fòrint hongarés");
    ...
    result.put("KRH","hwan sud-coreà (1953–1962)");
    ...
    result.put("LUC","franc convertible luxemburgués");
    result.put("LUF","franc luxemburgués");
    result.put("LUL","franc financer luxemburgués");
    ...
    result.put("MRO","ouguiya maurità (1973–2017)");
    result.put("MRU","ouguiya maurità");
    ...
    result.put("SSP","lliura del Sudan del Sud");
    result.put("STD","dobra de São Tomé i Príncipe (1977–2017)");
    result.put("STN","dobra de São Tomé i Príncipe");
    result.put("SUR","ruble soviètic");
    result.put("SVC","colon salvadorenc");
    ...
    result.put("UAK","karbóvanets ucraïnés");
    result.put("UGS","xíling ugandés (1966–1987)");
    result.put("UGX","xíling ugandés");
    ...
    result.put("VEB","bolívar veneçolà (1871–2008)");
    result.put("VEF","bolívar veneçolà (2008–2018)");
    result.put("VES","bolívar veneçolà");
    ...
    result.put("XFO","franc or francés");
    result.put("XFU","franc UIC francés");
    ...
    result.put("XXX","moneda desconeguda");
    ...
    result.put("YUR","dinar iugoslau reformat (1992–1993)");
    result.put("ZAL","rand sud-africà (financer)");
    result.put("ZAR","rand sud-africà");
    result.put("ZMK","kwacha zambià (1968–2012)");
    result.put("ZMW","kwacha zambià");
    result.put("ZRN","nou zaire zairès");
    result.put("ZRZ","zaire zairès");
    result.put("ZWD","dòlar zimbabués (1980–2008)");
    result.put("ZWL","dòlar zimbabués (2009)");
    result.put("ZWR","dòlar zimbabués (2008)");
    return result;
  }
}
