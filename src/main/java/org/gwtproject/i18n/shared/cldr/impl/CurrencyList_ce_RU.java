...
public class CurrencyList_ce_RU extends CurrencyList_ce {
  public CurrencyData getDefault() {
    return new CurrencyDataImpl("RUB","₽",2,"₽","₽");
  }
  ...
  protected HashMap<String, String> loadNamesMap() {
    ...
    result.put("AED","Дирхам ӀЦЭ");
    result.put("AFN","ОвхӀан-пачхьалкхан афгани");
    result.put("ALL","Албанин лек");
    result.put("AMD","Эрмалойчоьнан драм");
    result.put("ANG","Нидерландин Антилин гульден");
    result.put("AOA","Анголан кванза");
    result.put("ARS","Аргентинан песо");
    result.put("AUD","Австралин доллар");
    result.put("AWG","Арубан флорин");
    result.put("AZN","Азербайджанан манат");
    result.put("BAM","Боснин а, Герцеговинан а хийцалун марка");
    result.put("BBD","Барбадосан доллар");
    result.put("BDT","Бангладешан така");
    result.put("BGN","Болгарин лев");
    result.put("BHD","Бахрейнан динар");
    result.put("BIF","Бурундин франк");
    result.put("BMD","Бермудан доллар");
    result.put("BND","Брунейн доллар");
    result.put("BOB","Боливин боливиано");
    result.put("BRL","Бразилин реал");
    result.put("BSD","Багаман доллар");
    result.put("BTN","Бутанан нгултрум");
    result.put("BWP","Ботсванан пула");
    result.put("BYN","Белоруссин сом");
    result.put("BYR","Белоруссин сом (2000–2016)");
    result.put("BZD","Белизин доллар");
    result.put("CAD","Канадан доллар");
    result.put("CDF","Конголезин франк");
    result.put("CHF","Швейцарин франк");
    result.put("CLP","Чилин песо");
    result.put("CNY","Китайн юань");
    result.put("COP","Колумбин песо");
    result.put("CRC","Костарикан колон");
    result.put("CUC","Кубан хийцалун песо");
    result.put("CUP","Кубан песо");
    result.put("CVE","Кабо-Верден эскудо");
    result.put("CZK","Чехин крона");
    result.put("DJF","Джибутин франк");
    result.put("DKK","Данин крона");
    result.put("DOP","Доминикан песо");
    result.put("DZD","Алжиран динар");
    result.put("EGP","Мисаран фунт");
    result.put("ERN","Эритрейн накфа");
    result.put("ETB","Эфиопин быр");
    result.put("EUR","Евро");
    result.put("FJD","Фиджин доллар");
    result.put("FKP","Фолклендан гӀайренийн фунт");
    result.put("GBP","Англин фунт");
    result.put("GEL","Гуьржийчоьнан лари");
    result.put("GHS","Ганан седи");
    result.put("GIP","Гибралтаран фунт");
    result.put("GMD","Гамбин даласи");
    result.put("GNF","Гвинейн франк");
    result.put("GTQ","Гватемалан кетсаль");
    result.put("GYD","Гайанан доллар");
    result.put("HKD","Гонконган доллар");
    result.put("HNL","Гондурасан лемпира");
    result.put("HRK","Хорватин куна");
    result.put("HTG","Гаитин гурд");
    result.put("HUF","Венгрин форинт");
    result.put("IDR","Индонезин рупи");
    result.put("ILS","Израилан керла шекель");
    result.put("INR","Индин рупи");
    result.put("IQD","Ӏиракъан динар");
    result.put("IRR","ГӀажарийчоьнан риал");
    result.put("ISK","Исландин крона");
    result.put("JMD","Ямайн доллар");
    result.put("JOD","Урданан динар");
    result.put("JPY","Японин иена");
    result.put("KES","Кенин шиллинг");
    result.put("KGS","Киргизин сом");
    result.put("KHR","Камбоджан риель");
    result.put("KMF","Коморийн гӀайренийн франк");
    result.put("KPW","Къилбаседа Корейн вона");
    result.put("KRW","Къилба Корейн вона");
    result.put("KWD","Кувейтан динар");
    result.put("KYD","Кайманийн гӀайренийн доллар");
    result.put("KZT","Кхазакхстанан тенге");
    result.put("LAK","Лаосан кип");
    result.put("LBP","Ливанан фунт");
    result.put("LKR","Шри-Ланкан рупи");
    result.put("LRD","Либерин доллар");
    result.put("LYD","Ливин динар");
    result.put("MAD","Мароккон дирхам");
    result.put("MDL","Молдавин лей");
    result.put("MGA","Малагасийн ариари");
    result.put("MKD","Македонин динар");
    result.put("MMK","Мьянман кьят");
    result.put("MNT","Монголин тугрик");
    result.put("MOP","Макаон патака");
    result.put("MRO","Мавританин уги (1973–2017)");
    result.put("MRU","Мавританин уги");
    result.put("MUR","Маврикин рупи");
    result.put("MVR","Мальдивийн руфи");
    result.put("MWK","Малавин квача");
    result.put("MXN","Мексикан песо");
    result.put("MYR","Малайзин ринггит");
    result.put("MZN","Мозамбикан метикал");
    result.put("NAD","Намибин доллар");
    result.put("NGN","Нигерин найра");
    result.put("NIO","Никарагуан кордоба");
    result.put("NOK","Норвегин крона");
    result.put("NPR","Непалан рупи");
    result.put("NZD","Керла Зеландин доллар");
    result.put("OMR","Оманан риал");
    result.put("PAB","Панаман бальбоа");
    result.put("PEN","Перун соль");
    result.put("PGK","Папуа — Керла Гвинейн кина");
    result.put("PHP","Филиппинийн песо");
    result.put("PKR","Пакистанан рупи");
    result.put("PLN","Польшан злотый");
    result.put("PYG","Парагвайн гуарани");
    result.put("QAR","Катаран риал");
    result.put("RON","Румынин лей");
    result.put("RSD","Сербин динар");
    result.put("RUB","Российн сом");
    result.put("RWF","Руандан франк");
    result.put("SAR","СаӀудийн Ӏаьрбийчоьнан риал");
    result.put("SBD","Соломонан гӀайренийн доллар");
    result.put("SCR","Сейшелан рупи");
    result.put("SDG","Суданан фунт");
    result.put("SEK","Швецин крона");
    result.put("SGD","Сингапуран доллар");
    result.put("SHP","Сийлахьчу Еленин гӀайрен фунт");
    result.put("SLL","Леоне");
    result.put("SOS","Сомалин шиллинг");
    result.put("SRD","Суринаман доллар");
    result.put("SSP","Къилба Суданан фунт");
    result.put("STD","Сан-Томен а, Принсипин а добра (1977–2017)");
    result.put("STN","Сан-Томен а, Принсипин а добра");
    result.put("SYP","Шеман фунт");
    result.put("SZL","Свазилендан лилангени");
    result.put("THB","Таиландан бат");
    result.put("TJS","Таджикистанан сомони");
    result.put("TMT","Туркменин керла манат");
    result.put("TND","Тунисан динар");
    result.put("TOP","Тонганан паанга");
    result.put("TRY","Туркойчоьнан лира");
    result.put("TTD","Тринидадан а, Тобагон а доллар");
    result.put("TWD","Тайванан керла доллар");
    result.put("TZS","Танзанин шиллинг");
    result.put("UAH","Украинан гривна");
    result.put("UGX","Угандан шиллинг");
    result.put("USD","АЦШн доллар");
    result.put("UYU","Уругвайн песо");
    result.put("UZS","Узбекистанан сом");
    result.put("VEF","Венесуэлан боливар (2008–2018)");
    result.put("VES","Венесуэлан боливар");
    result.put("VND","Вьетнаман донг");
    result.put("VUV","Вануатун вату");
    result.put("WST","Самоанан тала");
    result.put("XAF","Юккъерчу Африкан КФА франк");
    result.put("XCD","Малхбален Карибийн доллар");
    result.put("XOF","Малхбузен Африкан КФА франк");
    result.put("XPF","Французийн Тийна океанан франк");
    result.put("XXX","девзаш доцу я лелаш доцу ахча");
    result.put("YER","Йеменан риал");
    result.put("ZAR","Къилба-Африкин рэнд");
    result.put("ZMW","Замбин квача");
    return result;
  }
}
