...
public class CurrencyList_cgg_UG extends CurrencyList_cgg {
  ...
  protected HashMap<String, String> loadNamesMap() {
    ...
    result.put("BWP","Pura ya Botswana");
    result.put("CAD","Doora ya Kanada");
    result.put("CDF","Faranga ya Kongo");
    result.put("CHF","Faranga ya Swisi");
    result.put("CNY","Yuan Renminbi ya China");
    result.put("CVE","Eskudo ya Kepuvede");
    result.put("DJF","Faranga ya Gyibuti");
    result.put("DZD","Dinari ya Arigyeriya");
    result.put("EGP","Paundi ya Misiri");
    result.put("ERN","Nakfa ya Eritireya");
    result.put("ETB","Birr ya Ethiopiya");
    result.put("EUR","Yuro");
    result.put("GBP","Paundi ya Bungyereza");
    result.put("GHC","Cedi ya Ghana");
    result.put("GMD","Dalasi ya Gambia");
    result.put("GNS","Faranga ya Guinea");
    result.put("INR","Rupiya ya India");
    result.put("JPY","Yeni ya Japaani");
    result.put("KES","Shiringi ya Kenya");
    result.put("KMF","Faranga ya Komoro");
    result.put("LRD","Doora ya Liberia");
    result.put("LSL","Loti ya Lesoto");
    result.put("LYD","Dinari ya Libya");
    result.put("MAD","Dirram ya Moroko");
    result.put("MGA","Ariari ya Maragariita");
    result.put("MRO","Ougwiya ya Mouriteeniya (1973–2017)");
    result.put("MRU","Ougwiya ya Mouriteeniya");
    result.put("MUR","Rupiiha ya Mauritiasi");
    result.put("MWK","Kwaca ya Malawi");
    result.put("MZM","Metikari ya Mozambikwi");
    result.put("NAD","Doora ya Namibiya");
    result.put("NGN","Naira ya Naigyeriya");
    result.put("RWF","Faranga ya Rwanda");
    result.put("SAR","Riya ya Saudi");
    result.put("SCR","Rupiiha ya Sherisheri");
    result.put("SDG","Dinari ya Sudani");
    result.put("SDP","Paundi ya Sudan");
    result.put("SHP","Paundi ya Senti Herena");
    result.put("SLL","Leone");
    result.put("SOS","Eshiringi ya Somalia");
    result.put("STD","Dobra ya Sao Tome na Purinsipo (1977–2017)");
    result.put("STN","Dobra ya Sao Tome na Purinsipo");
    result.put("TND","Dinari ya Tunisia");
    result.put("TZS","Eshiringi ya Tanzania");
    result.put("UGX","Eshiringi ya Uganda");
    result.put("USD","Doora ya America");
    result.put("XAF","Faranga ya CFA BEAC");
    result.put("XOF","Faranga ya CFA BCEAO");
    result.put("ZAR","Randi ya Sausi Afirika");
    result.put("ZMK","Kwacha ya Zambia (1968–2012)");
    result.put("ZMW","Kwacha ya Zambia");
    result.put("ZWD","Doora ya Zimbabwe");
    return result;
  }
}
