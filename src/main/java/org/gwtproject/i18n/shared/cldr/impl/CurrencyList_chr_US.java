...
public class CurrencyList_chr_US extends CurrencyList_chr {
  public CurrencyData getDefault() {
    return new CurrencyDataImpl("USD","$",2,"$","$");
  }
  ...
  protected HashMap<String, String> loadNamesMap() {
    ...
    result.put("AMD","ᎠᎵᎻᏂᎠ ᎠᏕᎳ");
    result.put("ANG","ᎾᏍᎩᏁᏛᎳᏂ ᎠᏂᏘᎵᏏ ᎠᏕᎳ");
    result.put("AOA","ᎠᏂᎪᎳ ᎠᏕᎳ");
    result.put("ARS","ᎠᏥᏂᏘᏂᎠ ᎠᏕᎳ");
    result.put("AUD","ᎡᎳᏗᏜ ᎠᏕᎳ");
    result.put("AWG","ᎠᎷᏆ ᎠᏕᎳ");
    result.put("AZN","ᎠᏏᎵᏆᏌᏂ ᎠᏕᎳ");
    result.put("BAM","ᏉᏏᏂᎠ-ᎲᏤᎪᏫ ᎦᏁᏟᏴᏍᏔᏅ ᎠᏕᎳ");
    result.put("BBD","ᏆᏇᏙᏍ ᎠᏕᎳ");
    result.put("BDT","ᏆᏂᎦᎵᏕᏍ ᎠᏕᎳ");
    result.put("BGN","ᏊᎵᎨᎵᎠ ᎠᏕᎳ");
    result.put("BHD","ᏆᎭᎴᎢᏂ ᎠᏕᎳ");
    result.put("BIF","ᏋᎷᏂᏗ ᎠᏕᎳ");
    result.put("BMD","ᏆᏊᏓ ᎠᏕᎳ");
    result.put("BND","ᏊᎾᎢ ᎠᏕᎳ");
    result.put("BOB","ᏉᎵᏫᎠ ᎠᏕᎳ");
    result.put("BRL","ᏆᏏᎵᎢ ᎠᏕᎳ");
    result.put("BSD","ᏆᎭᎹ ᎠᏕᎳ");
    result.put("BTN","ᏊᏔᏂ ᎠᏕᎳ");
    result.put("BWP","ᏆᏣᏩᎾ ᎠᏕᎳ");
    result.put("BYN","ᏇᎳᎷᏍ ᎠᏕᎳ");
    result.put("BYR","ᏇᎳᎷᏍ ᎠᏕᎳ (2000–2016)");
    result.put("BZD","ᏇᎵᏍ ᎠᏕᎳ");
    result.put("CAD","ᎨᎾᏓ ᎠᏕᎳ");
    result.put("CDF","ᎧᏂᎪ ᎠᏕᎳ");
    result.put("CHF","ᏍᏫᏏ ᎠᏕᎳ");
    result.put("CLP","ᏥᎵ ᎠᏕᎳ");
    result.put("CNH","ᏣᏂᏏ ᎠᏕᎳ (ᏓᎹᏳᏟᏗ)");
    result.put("CNY","ᏓᎶᏂᎨ ᎠᏕᎳ");
    result.put("COP","ᎪᎸᎻᏈᎢᎠ ᎠᏕᎳ");
    result.put("CRC","ᎪᏍᏓᎵᎧ ᎠᏕᎳ");
    result.put("CUC","ᎫᏆ ᎦᏁᏟᏴᏍᏔᏅ ᎠᏕᎳ");
    result.put("CUP","ᎫᏆ ᎠᏕᎳ");
    result.put("CVE","ᎢᎬᎾᏕᎾ ᎢᏤᏳᏍᏗ ᎠᏕᎳ");
    result.put("CZK","ᏤᎩ ᎠᏕᎳ");
    result.put("DJF","ᏥᏊᏗ ᎠᏕᎳ");
    result.put("DKK","ᏕᏂᏍ ᎠᏕᎳ");
    result.put("DOP","ᏙᎻᏂᎧᏂ ᎠᏕᎳ");
    result.put("DZD","ᎠᎵᏥᎵᏯ ᎠᏕᎳ");
    result.put("EGP","ᎢᏥᏈᎢ ᎠᏕᎳ");
    result.put("ERN","ᎡᎵᏟᏯ ᎠᏕᎳ");
    result.put("ETB","ᎢᏗᎣᏈᎠ ᎠᏕᎳ");
    result.put("EUR","ᏳᎳᏛ ᎠᏕᎳ");
    result.put("FJD","ᏫᎩ ᎠᏕᎳ");
    result.put("FKP","ᏩᎩᎤ ᏚᎦᏚᏛᎢ ᎠᏕᎳ");
    result.put("GBP","ᎩᎵᏏᏲ ᎠᏕᎳ");
    result.put("GEL","ᏣᎠᏥᎢ ᎠᏕᎳ");
    result.put("GHS","ᎦᎠᎾ ᎠᏕᎳ");
    result.put("GIP","ᏥᏆᎵᏓ ᎠᏕᎳ");
    result.put("GMD","ᎦᎹᏈᎢᎠ ᎠᏕᎳ");
    result.put("GNF","ᎩᎢᏂ ᎠᏕᎳ");
    result.put("GTQ","ᏆᏖᎹᎳ ᎠᏕᎳ");
    result.put("GYD","ᎦᏯᎾ ᎠᏕᎳ");
    result.put("HKD","ᎰᏂᎩ ᎪᏂᎩ ᎠᏕᎳ");
    result.put("HNL","ᎭᏂᏚᎳᏍ ᎠᏕᎳ");
    result.put("HRK","ᎧᎶᎡᏏᎠ ᎠᏕᎳ");
    result.put("HTG","ᎮᏘ ᎠᏕᎳ");
    result.put("HUF","ᎲᏂᎦᎵ ᎠᏕᎳ");
    result.put("IDR","ᎢᏂᏙᏂᏍᏯ ᎠᏕᎳ");
    result.put("ILS","ᎢᏏᎵᏱ ᎢᏤ ᎠᏕᎳ");
    result.put("INR","ᎢᏂᏗᎢᎠ ᎠᏕᎳ");
    result.put("IQD","ᎢᎳᎩ ᎠᏕᎳ");
    result.put("IRR","ᎢᎴᏂ ᎠᏕᎳ");
    result.put("ISK","ᏧᏁᏍᏓᎸᎯ ᎠᏕᎳ");
    result.put("JMD","ᏣᎺᎢᎧ ᎠᏕᎳ");
    result.put("JOD","ᏦᏓᏂ ᎠᏕᎳ");
    result.put("JPY","ᏣᏩᏂᏏ ᎠᏕᎳ");
    result.put("KES","ᎨᏂᏯ ᎠᏕᎳ");
    result.put("KGS","ᎩᎵᏣᎢᏍ ᎠᏕᎳ");
    result.put("KHR","ᎧᎹᏉᏗᎠᏂ ᎠᏕᎳ");
    result.put("KMF","ᎪᎼᎳᏍ ᎠᏕᎳ");
    result.put("KPW","ᏧᏴᏢ ᎪᎵᎠ ᎠᏕᎳ");
    result.put("KRW","ᏧᎦᎾᏮ ᎪᎵᎠ ᎠᏕᎳ");
    result.put("KWD","ᎫᏪᎢᏘ ᎠᏕᎳ");
    result.put("KYD","ᎨᎢᎹᏂ ᏚᎦᏚᏛᎢ ᎠᏕᎳ");
    result.put("KZT","ᎧᏎᎧᏍᏕᏂ ᎠᏕᎳ");
    result.put("LAK","ᎳᎣ ᎠᏕᎳ");
    result.put("LBP","ᎴᏆᎾᏂ ᎠᏕᎳ");
    result.put("LKR","ᏍᎵ ᎳᏂᎧ ᎠᏕᎳ");
    result.put("LRD","ᎳᏈᎵᏯ ᎠᏕᎳ");
    result.put("LYD","ᎵᏈᏯ ᎠᏕᎳ");
    result.put("MAD","ᎼᎶᎪ ᎠᏕᎳ");
    result.put("MDL","ᎹᎵᏙᏫᎠ ᎠᏕᎳ");
    result.put("MGA","ᎹᎳᎦᏏ ᎠᏕᎳ");
    result.put("MKD","ᎹᏎᏙᏂᎠ ᎠᏕᎳ");
    result.put("MMK","ᎹᏯᎹᎵ ᎠᏕᎳ");
    result.put("MNT","ᎹᏂᎪᎵᎠ ᎠᏕᎳ");
    result.put("MOP","ᎹᎧᎣ ᎠᏕᎳ");
    result.put("MRO","ᎹᏈᏔᏂᎠ ᎠᏕᎳ (1973–2017)");
    result.put("MRU","ᎹᏈᏔᏂᎠ ᎠᏕᎳ");
    result.put("MUR","ᎹᏘᎢᏯ ᎠᏕᎳ");
    result.put("MVR","ᎹᎵᏗᏫᏍ ᎠᏕᎳ");
    result.put("MWK","ᎹᎳᏫ ᎠᏕᎳ");
    result.put("MXN","ᏍᏆᏂ ᎠᏕᎳ");
    result.put("MYR","ᎹᎴᏏᎢᎠ ᎠᏕᎳ");
    result.put("MZN","ᎼᏎᎻᏇᎩ ᎠᏕᎳ");
    result.put("NAD","ᎾᎻᏈᎢᏯ ᎠᏕᎳ");
    result.put("NGN","ᏂᏥᎵᏯ ᎠᏕᎳ");
    result.put("NIO","ᏂᎧᎳᏆ ᎠᏕᎳ");
    result.put("NOK","ᏃᏪ ᎠᏕᎳ");
    result.put("NPR","ᏁᏆᎵ ᎠᏕᎳ");
    result.put("NZD","ᎢᏤ ᏏᎢᎴᏂᏗ ᎠᏕᎳ");
    result.put("OMR","ᎣᎺᏂ ᎠᏕᎳ");
    result.put("PAB","ᏆᎾᎹ ᎠᏕᎳ");
    result.put("PEN","ᏇᎷ ᎠᏕᎳ");
    result.put("PGK","ᏆᏇ ᎢᏤ ᎩᎢᏂ ᎠᏕᎳ");
    result.put("PHP","ᎠᏂᏈᎵᎩᏃ ᎠᏕᎳ");
    result.put("PKR","ᏆᎩᏍᏖᏂ ᎠᏕᎳ");
    result.put("PLN","ᏉᎳᏂ ᎠᏕᎳ");
    result.put("PYG","ᏆᎳᏇᎢᏯ ᎠᏕᎳ");
    result.put("QAR","ᎧᏔᎵ ᎠᏕᎳ");
    result.put("RON","ᎶᎹᏂᏯ ᎠᏕᎳ");
    result.put("RSD","ᏒᏈᏯ ᎠᏕᎳ");
    result.put("RUB","ᏲᏂᎢ ᎠᏕᎳ");
    result.put("RWF","ᎶᏩᏂᏓ ᎠᏕᎳ");
    result.put("SAR","ᏌᎤᏗ ᎠᏕᎳ");
    result.put("SBD","ᏐᎶᎹᏂ ᏚᎦᏚᏛᎢ ᎠᏕᎳ");
    result.put("SCR","ᏏᎡᏥᎵᏍ ᎠᏕᎳ");
    result.put("SDG","ᏑᏕᏂ ᎠᏕᎳ");
    result.put("SEK","ᏍᏫᏕᏂ ᎠᏕᎳ");
    result.put("SGD","ᏏᏂᎦᏉᎵ ᎠᏕᎳ");
    result.put("SHP","ᎤᏓᏅᏘ ᎮᎵᎾ ᎠᏕᎳ");
    result.put("SLL","ᏏᎡᎳᎴᎣᏂ ᎠᏕᎳ");
    result.put("SOS","ᏐᎹᎵ ᎠᏕᎳ");
    result.put("SRD","ᏒᎵᎾᎻ ᎠᏕᎳ");
    result.put("SSP","ᏧᎦᎾᏮ ᏑᏕᏂ ᎠᏕᎳ");
    result.put("STD","ᏌᎣᏙᎺ ᎠᎴ ᏈᏂᏏᏇ ᎠᏕᎳ (1977–2017)");
    result.put("STN","ᏌᎣᏙᎺ & ᏈᏂᏏᏇ ᎠᏕᎳ");
    result.put("SYP","ᏏᎵᎠ ᎠᏕᎳ");
    result.put("SZL","ᏍᏩᏏ ᎠᏕᎳ");
    result.put("THB","ᏔᏯᎴᏂ ᎠᏕᎳ");
    result.put("TJS","ᏔᏥᎩᏍᏕᏂ ᎠᏕᎳ");
    result.put("TMT","ᏛᎵᎩᎺᏂᏍᏔᏂ ᎠᏕᎳ");
    result.put("TND","ᏚᏂᏏᏍᎠ ᎠᏕᎳ");
    result.put("TOP","ᏔᏂᎪ ᎠᏕᎳ");
    result.put("TRY","ᎬᏃ ᎠᏕᎳ");
    result.put("TTD","ᏟᏂᏕᏗ & ᏙᏆᎪ ᎠᏕᎳ");
    result.put("TWD","ᎢᏤ ᏔᎢᏩᏂ ᎠᏕᎳ");
    result.put("TZS","ᏖᏂᏏᏂᏯ ᎠᏕᎳ");
    result.put("UAH","ᏳᎧᎴᏂ ᎠᏕᎳ");
    result.put("UGX","ᏳᎦᏂᏓ ᎠᏕᎳ");
    result.put("USD","US ᎠᏕᎳ");
    result.put("UYU","ᏳᎷᏇ ᎠᏕᎳ");
    result.put("UZS","ᎤᏍᏇᎩᏍᏖᏂ ᎠᏕᎳ");
    result.put("VEF","ᏪᏁᏑᏪ ᎠᏕᎳ (2008–2018)");
    result.put("VES","ᏪᏁᏑᏪ ᎠᏕᎳ");
    result.put("VND","ᏫᎡᏘᎾᎻᏍ ᎠᏕᎳ");
    result.put("VUV","ᏩᏂᎤᏩᏚ ᎠᏕᎳ");
    result.put("WST","ᏌᎼᎠ ᎠᏕᎳ");
    result.put("XAF","ᎠᏰᏟ ᎬᎿᎨᏍᏛ CFA ᎠᏕᎳ");
    result.put("XCD","ᏗᎧᎸᎬ ᎨᏆᏙᏯ ᎠᏕᎳ");
    result.put("XOF","ᏭᏕᎵᎬ ᎬᎿᎨᏍᏛ CFA ᎠᏕᎳ");
    result.put("XPF","CFP ᎠᏕᎳ");
    result.put("XXX","ᏄᏬᎵᏍᏛᎾ ᎠᏕᎳ");
    result.put("YER","ᏰᎺᏂ ᎠᏕᎳ");
    result.put("ZAR","ᏧᎦᎾᏮ ᎬᎿᎨᏍᏛ ᎠᏕᎳ");
    result.put("ZMW","ᏏᎻᏆᏇ ᎠᏕᎳ");
    return result;
  }
}
