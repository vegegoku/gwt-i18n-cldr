...
public class CurrencyList_ckb_IQ extends CurrencyList_ckb {
  ...
  protected HashMap<String, String> loadNamesMap() {
    ...
    result.put("AFN","ئەفغانیی ئەفغانستان");
    result.put("BHD","دیناری بەحرەینی");
    result.put("BZD","دۆلاری بەلیزی");
    result.put("DZD","دیناری جەزائیری");
    result.put("EUR","یورۆ");
    result.put("IQD","دیناری عێراقی");
    result.put("IRR","ڕیاڵی ئێرانی");
    result.put("JOD","دیناری ئوردنی");
    result.put("KWD","دیناری کووەیتی");
    result.put("OMR","ڕیاڵی عومانی");
    result.put("QAR","ڕیاڵی قەتەری");
    result.put("SAR","ڕیاڵی سەعوودی");
    result.put("TND","دیناری توونس");
    result.put("TRY","لیرەی تورکیا");
    result.put("TTD","دۆلاری ترینیداد و تۆباگۆ");
    result.put("XAU","زێڕ");
    return result;
  }
}
