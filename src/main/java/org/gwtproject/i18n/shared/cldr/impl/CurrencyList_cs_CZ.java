...
public class CurrencyList_cs_CZ extends CurrencyList_cs {
  ...
  protected HashMap<String, CurrencyData> loadCurrencyMap() {
    ...
    result.put("CSK", new CurrencyDataImpl("CSK","Kčs",130,"Kčs","Kčs"));
    ...
    result.put("XEU", new CurrencyDataImpl("XEU","ECU",130,"ECU","ECU"));
  ...
  protected HashMap<String, String> loadNamesMap() {
    ...
    result.put("ALK","albánský lek (1946–1965)");
    result.put("ALL","albánský lek");
    result.put("AMD","arménský dram");
    result.put("ANG","nizozemskoantilský gulden");
    ...
    result.put("ARL","argentinské peso ley (1970–1983)");
    result.put("ARM","argentinské peso (1881–1970)");
    ...
    result.put("AZN","ázerbájdžánský manat");
    ...
    result.put("BGL","bulharský tvrdý leva");
    result.put("BGM","bulharský socialistický leva");
    result.put("BGN","bulharský leva");
    ...
    result.put("BRB","brazilské nové cruzeiro (1967–1986)");
    result.put("BRC","brazilské cruzado (1986–1989)");
    result.put("BRE","brazilské cruzeiro (1990–1993)");
    result.put("BRL","brazilský real");
    result.put("BRN","brazilské nové cruzado (1989–1990)");
    result.put("BRR","brazilské cruzeiro (1993–1994)");
    result.put("BRZ","brazilské cruzeiro (1942–1967)");
    ...
    result.put("BYN","běloruský rubl");
    result.put("BYR","běloruský rubl (2000–2016)");
    result.put("BZD","belizský dolar");
    result.put("CAD","kanadský dolar");
    result.put("CDF","konžský frank");
    result.put("CHE","švýcarské WIR-euro");
    result.put("CHF","švýcarský frank");
    result.put("CHW","švýcarský WIR-frank");
    result.put("CLE","chilské escudo");
    result.put("CLF","chilská účetní jednotka (UF)");
    result.put("CLP","chilské peso");
    result.put("CNH","čínský jüan (offshore)");
    result.put("CNX","čínský dolar ČLB");
    result.put("CNY","čínský jüan");
    result.put("COP","kolumbijské peso");
    result.put("COU","kolumbijská jednotka reálné hodnoty");
    ...
    result.put("ECV","ekvádorská jednotka konstantní hodnoty");
    ...
    result.put("GEK","gruzínské kuponové lari");
    ...
    result.put("GWE","portugalskoguinejské escudo");
    ...
    result.put("KRH","jihokorejský hwan (1953–1962)");
    result.put("KRO","jihokorejský won (1945–1953)");
    ...
    result.put("MDC","moldavský kupon");
    ...
    result.put("MRO","mauritánská ouguiya (1973–2017)");
    result.put("MRU","mauritánská ouguiya");
    result.put("MTL","maltská lira");
    result.put("MTP","maltská libra");
    result.put("MUR","mauricijská rupie");
    result.put("MVP","maledivská rupie (1947–1981)");
    ...
    result.put("MXV","mexická investiční jednotka");
    ...
    result.put("NLG","nizozemský gulden");
    ...
    result.put("SSP","jihosúdánská libra");
    result.put("STD","svatotomášská dobra (1977–2017)");
    result.put("STN","svatotomášská dobra");
    ...
    result.put("TWD","tchajwanský dolar");
    ...
    result.put("UYI","uruguayské peso (v indexovaných jednotkách)");
    ...
    result.put("YUR","jugoslávský reformovaný dinár (1992–1993)");
