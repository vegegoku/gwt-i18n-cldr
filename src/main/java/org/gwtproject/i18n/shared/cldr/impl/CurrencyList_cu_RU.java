...
public class CurrencyList_cu_RU extends CurrencyList_cu {
  ...
  protected HashMap<String, String> loadNamesMap() {
    ...
    result.put("CNY","хи́нскїй ю҆а́нь");
    result.put("EUR","є҆́ѵрѡ");
    result.put("GBP","а҆нглі́йскїй фꙋ́нтъ сте́рлингѡвъ");
    result.put("INR","і҆нді́йскаѧ рꙋ́пїѧ");
    result.put("JPY","ꙗ҆пѡ́нскаѧ і҆е́на");
    result.put("KGS","кирги́зскїй сꙋ́мъ");
    result.put("KZT","каза́хскаѧ деньга̀");
    result.put("RUB","рѡссі́йскїй рꙋ́бль");
    result.put("UAH","ᲂу҆краи́нскаѧ гри́вна");
    result.put("USD","а҆мерїка́нскїй до́лларъ");
    result.put("XXX","невѣ́домое пла́тное сре́дство");
    return result;
  }
}
