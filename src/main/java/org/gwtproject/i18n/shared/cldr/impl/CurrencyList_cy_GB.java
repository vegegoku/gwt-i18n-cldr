...
public class CurrencyList_cy_GB extends CurrencyList_cy {
  ...
  protected HashMap<String, String> loadNamesMap() {
    ...
    result.put("ANG","Guilder Antilles yr Iseldiroedd");
    result.put("AOA","Kwanza Angola");
    result.put("AOK","Kwanza Angola (1977–1991)");
    result.put("AON","Kwanza Newydd Angola (1990–2000)");
    result.put("AOR","Kwanza Ailgymhwysedig Angola (1995–1999)");
    result.put("ARA","Austral yr Ariannin");
    result.put("ARL","Peso Ley yr Ariannin (1970–1983)");
    result.put("ARM","Peso yr Ariannin (1881–1970)");
    result.put("ARP","Peso yr Ariannin (1983–1985)");
    result.put("ARS","Peso yr Ariannin");
    result.put("ATS","Swllt Awstria");
    result.put("AUD","Doler Awstralia");
    result.put("AWG","Fflorin Aruba");
    result.put("AZM","Manat Azerbaijan (1993–2006)");
    result.put("AZN","Manat Azerbaijan");
    result.put("BAM","Marc Trosadwy Bosnia a Hercegovina");
    result.put("BBD","Doler Barbados");
    result.put("BDT","Taka Bangladesh");
    result.put("BEC","Ffranc Gwlad Belg (arnewidiol)");
    result.put("BEF","Ffranc Gwlad Belg");
    result.put("BEL","Ffranc Gwlad Belg (ariannol)");
    result.put("BGM","Lev Sosialaidd Bwlgaria");
    result.put("BGN","Lev Bwlgaria");
    result.put("BGO","Lev Bwlgaria (1879–1952)");
    result.put("BHD","Dinar Bahrain");
    result.put("BIF","Ffranc Burundi");
    result.put("BMD","Doler Bermuda");
    result.put("BND","Doler Brunei");
    result.put("BOB","Boliviano Bolifia");
    result.put("BOL","Boliviano Bolifia (1863–1963)");
    result.put("BOP","Peso Bolifia");
    result.put("BOV","Mvdol Bolifia");
    result.put("BRB","Cruzeiro Newydd Brasil (1967–1986)");
    result.put("BRC","Cruzado Brasil (1986–1989)");
    result.put("BRE","Cruzeiro Brasil (1990–1993)");
    result.put("BRL","Real Brasil");
    result.put("BRN","Cruzado Newydd Brasil (1989–1990)");
    ...
    result.put("BUK","Kyat Byrma");
    result.put("BWP","Pula Botswana");
    result.put("BYN","Rwbl Belarws");
    result.put("BYR","Rwbl Belarws (2000–2016)");
    result.put("BZD","Doler Belize");
    result.put("CAD","Doler Canada");
    result.put("CDF","Ffranc Congo");
    result.put("CHE","Ewro WIR");
    result.put("CHF","Ffranc y Swistir");
    result.put("CHW","Ffranc WIR");
    result.put("CLE","Escudo Chile");
    result.put("CLF","Uned Cyfrifo Chile (UF)");
    result.put("CLP","Peso Chile");
    result.put("CNH","Yuan Tsieina (ar y môr)");
    result.put("CNX","Doler Banc Pobl Tsieina");
    result.put("CNY","Yuan Tsieina");
    result.put("COP","Peso Colombia");
    result.put("COU","Uned Gwir Werth Colombia");
    result.put("CRC","Colón Costa Rica");
    result.put("CUC","Peso Trosadwy Ciwba");
    result.put("CUP","Peso Ciwba");
    result.put("CVE","Esgwdo Cabo Verde");
    result.put("CYP","Punt Cyprus");
    result.put("CZK","Koruna’r Weriniaeth Tsiec");
    result.put("DDM","Marc Dwyrain yr Almaen");
    result.put("DEM","Marc yr Almaen");
    result.put("DJF","Ffranc Djibouti");
    result.put("DKK","Krone Denmarc");
    result.put("DOP","Peso Gweriniaeth Dominica");
    result.put("DZD","Dinar Algeria");
    result.put("ECS","Sucre Ecuador");
    result.put("ECV","Uned Gwerth Gyson Ecuador");
    result.put("EEK","Kroon Estonia");
    result.put("EGP","Punt Yr Aifft");
    result.put("ERN","Nakfa Eritrea");
    result.put("ETB","Birr Ethiopia");
    result.put("EUR","Ewro");
    result.put("FIM","Markka’r Ffindir");
    result.put("FJD","Doler Ffiji");
    result.put("FKP","Punt Ynysoedd Falkland/Malvinas");
    result.put("FRF","Ffranc Ffrainc");
    result.put("GBP","Punt Prydain");
    ...
    result.put("GIP","Punt Gibraltar");
    result.put("GMD","Dalasi Gambia");
    result.put("GNF","Ffranc Guinée");
    result.put("GNS","Syli Guinée");
    result.put("GQE","Ekwele Guinea Gyhydeddol");
    result.put("GTQ","Quetzal Guatemala");
    result.put("GWP","Peso Guiné-Bissau");
    result.put("GYD","Doler Guyana");
    result.put("HKD","Doler Hong Kong");
    result.put("HNL","Lempira Honduras");
    result.put("HRK","Kuna Croatia");
    result.put("HTG","Gourde Haiti");
    result.put("HUF","Fforint Hwngari");
    result.put("IDR","Rupiah Indonesia");
    result.put("IEP","Punt Iwerddon");
    result.put("ILP","Punt Israel");
    result.put("ILR","Shegel Israel (1980–1985)");
    result.put("ILS","Shegel Newydd Israel");
    result.put("INR","Rwpî India");
    result.put("IQD","Dinar Irac");
    result.put("IRR","Rial Iran");
    result.put("ISJ","Króna Gwlad yr Iâ (1918 – 1981)");
    result.put("ISK","Króna Gwlad yr Iâ");
    result.put("JMD","Doler Jamaica");
    result.put("JOD","Dinar Gwlad yr Iorddonen");
    result.put("JPY","Yen Japan");
    result.put("KES","Swllt Kenya");
    result.put("KGS","Som Kyrgyzstan");
    result.put("KHR","Riel Cambodia");
    result.put("KMF","Ffranc Comoros");
    result.put("KPW","Won Gogledd Corea");
    result.put("KRH","Hwan De Corea (1953–1962)");
    result.put("KRO","Won De Corea (1945–1953)");
    result.put("KRW","Won De Corea");
    result.put("KWD","Dinar Kuwait");
    result.put("KYD","Doler Ynysoedd Cayman");
    result.put("KZT","Tenge Kazakstan");
    result.put("LAK","Kip Laos");
    result.put("LBP","Punt Libanus");
    result.put("LKR","Rwpî Sri Lanka");
    result.put("LRD","Doler Liberia");
    result.put("LSL","Loti Lesotho");
    result.put("LTL","Litas Lithwania");
    result.put("LTT","Talonas Lithwania");
    result.put("LUF","Ffranc Lwcsembwrg");
    result.put("LVL","Lats Latfia");
    result.put("LVR","Rwbl Latfia");
    result.put("LYD","Dinar Libya");
    result.put("MAD","Dirham Moroco");
    result.put("MAF","Ffranc Moroco");
    result.put("MCF","Ffranc Monaco");
    result.put("MDL","Leu Moldofa");
    result.put("MGA","Ariary Madagascar");
    result.put("MGF","Ffranc Madagascar");
    result.put("MKD","Denar Macedonia");
    result.put("MLF","Ffranc Mali");
    ...
    result.put("MUR","Rwpî Mauritius");
    result.put("MVP","Rwpî’r Maldives (1947–1981)");
    result.put("MVR","Rufiyaa’r Maldives");
    result.put("MWK","Kwacha Malawi");
    result.put("MXN","Peso Mecsico");
    result.put("MXP","Peso Arian México (1861–1992)");
    result.put("MXV","Uned Fuddsoddi México");
    result.put("MYR","Ringgit Malaysia");
    result.put("MZE","Escudo Mozambique");
    result.put("MZM","Metical Mozambique (1980–2006)");
    result.put("MZN","Metical Mozambique");
    result.put("NAD","Doler Namibia");
    result.put("NGN","Naira Nigeria");
    result.put("NIC","Córdoba Nicaragua (1988–1991)");
    result.put("NIO","Cordoba Nicaragwa");
    result.put("NLG","Guilder yr Iseldiroedd");
    result.put("NOK","Krone Norwy");
    result.put("NPR","Rwpî Nepal");
    result.put("NZD","Doler Seland Newydd");
    result.put("OMR","Rial Oman");
    result.put("PAB","Balboa Panama");
    result.put("PEI","Inti Periw");
    result.put("PEN","Sol Periw");
    result.put("PES","Sol Periw (1863–1965)");
    result.put("PGK","Kina Papua Guinea Newydd");
    result.put("PHP","Peso’r Philipinau");
    result.put("PKR","Rwpî Pacistan");
    result.put("PLN","Zloty Gwlad Pwyl");
    result.put("PYG","Guarani Paraguay");
    result.put("QAR","Rial Qatar");
    result.put("RHD","Doler Rhodesia");
    result.put("RON","Leu Rwmania");
    result.put("RSD","Dinar Serbia");
    result.put("RUB","Rwbl Rwsia");
    result.put("RWF","Ffranc Rwanda");
    result.put("SAR","Riyal Saudi Arabia");
    result.put("SBD","Doler Ynysoedd Solomon");
    result.put("SCR","Rwpî Seychelles");
    result.put("SDD","Dinar Sudan (1992–2007)");
    result.put("SDG","Punt Sudan");
    result.put("SDP","Punt Sudan (1957–1998)");
    result.put("SEK","Krona Sweden");
    result.put("SGD","Doler Singapore");
    result.put("SHP","Punt St Helena");
    result.put("SLL","Leone Sierra Leone");
    result.put("SOS","Swllt Somalia");
    result.put("SRD","Doler Surinam");
    result.put("SRG","Guilder Surinam");
    result.put("SSP","Punt De Sudan");
    result.put("STD","Dobra São Tomé a Príncipe (1977–2017)");
    result.put("STN","Dobra São Tomé a Príncipe");
    result.put("SVC","Colón El Salvador");
    result.put("SYP","Punt Syria");
    result.put("SZL","Lilangeni Gwlad Swazi");
    result.put("THB","Baht Gwlad Thai");
    result.put("TJR","Rwbl Tajikistan");
    ...
    result.put("TRL","Lira Twrci (1922–2005)");
    result.put("TRY","Lira Twrci");
    result.put("TTD","Doler Trinidad a Tobago");
    result.put("TWD","Doler Newydd Taiwan");
    result.put("TZS","Swllt Tanzania");
    result.put("UAH","Hryvnia Wcráin");
    result.put("UGS","Swllt Uganda (1966–1987)");
    result.put("UGX","Swllt Uganda");
    result.put("USD","Doler UDA");
    result.put("USN","Doler UDA (y diwrnod nesaf)");
    result.put("USS","Doler UDA (yr un diwrnod)");
    result.put("UYP","Peso Uruguay (1975–1993)");
    result.put("UYU","Peso Uruguay");
    result.put("UZS","Som Uzbekistan");
    result.put("VEB","Bolívar Venezuela (1871–2008)");
    result.put("VEF","Bolívar Venezuela (2008–2018)");
    result.put("VES","Bolívar Venezuela");
    result.put("VND","Dong Fietnam");
    result.put("VNN","Dong Fietnam (1978–1985)");
    result.put("VUV","Vatu Vanuatu");
    result.put("WST","Tala Samoa");
    result.put("XAF","Ffranc CFA Canol Affrica");
    result.put("XAG","Arian");
    result.put("XAU","Aur");
    result.put("XBA","Uned Cyfansawdd Ewropeaidd");
    result.put("XBB","Uned Ariannol Ewropeaidd");
    result.put("XCD","Doler Dwyrain y Caribî");
    result.put("XEU","Uned Arian Cyfred Ewropeaidd");
    result.put("XOF","Ffranc CFA Gorllewin Affrica");
    result.put("XPD","Paladiwm");
    result.put("XPF","Ffranc CFP");
    result.put("XPT","Platinwm");
    result.put("XSU","Sucre");
    result.put("XXX","Arian Cyfred Anhysbys");
    result.put("YDD","Dinar Yemen");
    result.put("YER","Rial Yemen");
    result.put("ZAL","Rand (ariannol) De Affrica");
    result.put("ZAR","Rand De Affrica");
    result.put("ZMK","Kwacha Zambia (1968–2012)");
    result.put("ZMW","Kwacha Zambia");
    result.put("ZRN","Zaire Newydd Zaire (1993–1998)");
    result.put("ZRZ","Zaire Zaire (1971–1993)");
    result.put("ZWD","Doler Zimbabwe (1980–2008)");
    result.put("ZWL","Doler Zimbabwe (2009)");
    result.put("ZWR","Doler Zimbabwe (2008)");
    return result;
  }
}
