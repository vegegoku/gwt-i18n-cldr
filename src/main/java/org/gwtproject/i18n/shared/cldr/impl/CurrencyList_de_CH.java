...
public class CurrencyList_de_CH extends CurrencyList_de {
  ...
  protected HashMap<String, String> loadNamesMap() {
    ...
    result.put("BYN","Weissrussischer Rubel");
    result.put("BYR","Weissrussischer Rubel (2000–2016)");
    ...
    result.put("STN","São-toméischer Dobra (2018)");
