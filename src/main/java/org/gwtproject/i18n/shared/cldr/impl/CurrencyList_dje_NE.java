...
public class CurrencyList_dje_NE extends CurrencyList_dje {
  ...
  protected HashMap<String, String> loadNamesMap() {
    ...
    result.put("BHD","Bahareen Dinar");
    result.put("BIF","Burundi Fraŋ");
    result.put("BWP","Botswaana Pund");
    result.put("CAD","Kanaada Dollar");
    result.put("CDF","Kongo Fraŋ");
    result.put("CHF","Swisu Fraŋ");
    result.put("CNY","Sinwa Yuan Renminbi");
    result.put("CVE","Kapuver Escudo");
    result.put("DJF","Jibuuti Fraŋ");
    result.put("DZD","Alžeeri Dinar");
    result.put("EGP","Misra Pund");
    result.put("ERN","Eritree Nafka");
    result.put("ETB","Ecioopi Birr");
    result.put("EUR","Eero");
    result.put("GBP","Britin Pund");
    result.put("GHC","Gaana Šiidi");
    result.put("GMD","Gambi Dalasi");
    result.put("GNS","Ginee Fraŋ");
    result.put("INR","Indu Rupii");
    result.put("JPY","Jaapoŋ Yen");
    result.put("KES","Keeniya Šiiliŋ");
    result.put("KMF","Komoor Fraŋ");
    result.put("LRD","Liberia Dollar");
    result.put("LSL","Leezoto Loti");
    result.put("LYD","Liibi Dinar");
    result.put("MAD","Maarok Dirham");
    result.put("MGA","Malgaaši Fraŋ");
    result.put("MRO","Mooritaani Ugiya (1973–2017)");
    result.put("MRU","Mooritaani Ugiya");
    result.put("MUR","Mooris Rupii");
    result.put("MWK","Malaawi Kwaca");
    result.put("MZM","Mozambik Metikal");
    result.put("NAD","Naamibi Dollar");
    result.put("NGN","Naajiriya Neera");
    result.put("RWF","Rwanda Fraŋ");
    result.put("SAR","Saudiya Riyal");
    result.put("SCR","Seešel Rupii");
    result.put("SDG","Suudaŋ Dinar");
    result.put("SDP","Suudaŋ Pund");
    result.put("SHP","Seŋ Helena Fraŋ");
    result.put("SLL","Leeon");
    result.put("SOS","Somaali Šiiliŋ");
    result.put("STD","Sao Tome nda Prinsipe Dobra (1977–2017)");
    result.put("STN","Sao Tome nda Prinsipe Dobra");
    result.put("SZL","Lilangeni");
    result.put("TND","Tunizi Dinar");
    result.put("TZS","Tanzaani Šiiliŋ");
    result.put("UGX","Uganda Šiiliŋ");
    result.put("USD","Ameriki Dollar");
    result.put("XAF","CFA Fraŋ (BEAC)");
    result.put("XOF","CFA Fraŋ (BCEAO)");
    result.put("ZAR","Hawasa Afriki Rand");
