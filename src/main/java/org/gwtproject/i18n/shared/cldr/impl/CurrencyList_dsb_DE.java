...
public class CurrencyList_dsb_DE extends CurrencyList_dsb {
  ...
  protected HashMap<String, String> loadNamesMap() {
    ...
    result.put("ADP","andorraska peseta");
    result.put("AED","ZAE dirham");
    result.put("AFN","afghaniski afgani");
    result.put("ALL","albański lek");
    result.put("AMD","armeński dram");
    result.put("ANG","nižozemsko-antilski gulden");
    result.put("AOA","angolska kwanza");
    result.put("AOK","angolska kwanza (1977–1990)");
    result.put("AON","angolska nowa kwanza (1990–2000)");
    result.put("AOR","angolska kwanza reajustado (1995–1999)");
    result.put("ARA","argentinski austral");
    result.put("ARP","argentinski peso (1983–1985)");
    result.put("ARS","argentinski peso");
    result.put("ATS","rakuski šiling");
    result.put("AUD","awstralski dolar");
    result.put("AWG","aruba-florin");
    result.put("AZM","azerbajdžaniski manat (1993–2006)");
    result.put("AZN","azerbajdžaniski manat");
    result.put("BAD","bosniski dinar");
    result.put("BAM","bosniska konwertibelna marka");
    result.put("BBD","barbadoski dolar");
    result.put("BDT","bangladešska taka");
    result.put("BEC","belgiski frank (konwertibelny)");
    result.put("BEF","belgiski frank");
    result.put("BEL","belgiski financny frank");
    result.put("BGL","bulgarski lew (1962–1999)");
    result.put("BGN","bulgarski lew");
    result.put("BHD","bahrainski dinar");
    result.put("BIF","burundiski frank");
    result.put("BMD","bermudaski dolar");
    result.put("BND","bruneiski dolar");
    result.put("BOB","boliwiski boliviano");
    result.put("BOP","boliwiski peso");
    result.put("BOV","boliwiski mvdol");
    result.put("BRB","brazilski nowy cruzeiro (1967–1986)");
    result.put("BRC","brazilski cruzado (1986–1989)");
    result.put("BRE","brazilski cruzeiro (1990–1993)");
    result.put("BRL","brazilski real");
    result.put("BRN","brazilski nowy cruzado (1989–1990)");
    result.put("BRR","brazilski cruzeiro (1993–1994)");
    result.put("BSD","bahamaski dolar");
    result.put("BTN","bhutański ngultrum");
    result.put("BUK","burmaski kyat");
    result.put("BWP","botswaniska pula");
    result.put("BYB","běłoruski rubl (1994–1999)");
    result.put("BYN","běłoruski rubl");
    result.put("BYR","běłoruski rubl (2000–2016)");
    result.put("BZD","belizeski dolar");
    result.put("CAD","kanadiski dolar");
    result.put("CDF","kongoski frank");
    result.put("CHF","šwicarski frank");
    result.put("CLP","chilski peso");
    result.put("CNY","chinski yuan");
    result.put("COP","kolumbiski peso");
    result.put("CRC","kosta-rikański colón");
    result.put("CUC","kubański konwertibelny peso");
    result.put("CUP","kubański peso");
    result.put("CVE","kapverdski escudo");
    result.put("CZK","česka krona");
    result.put("DJF","dźibutiski frank");
    result.put("DKK","dańska krona");
    result.put("DOP","dominikański peso");
    result.put("DZD","algeriski dinar");
    result.put("EGP","egyptojski punt");
    result.put("ERN","eritrejska nakfa");
    result.put("ETB","etiopiski birr");
    result.put("EUR","euro");
    result.put("FJD","fidźiski dolar");
    result.put("FKP","falklandski punt");
    result.put("GBP","britiski punt");
    result.put("GEL","georgiski lari");
    result.put("GHS","ghanaski cedi");
    result.put("GIP","gibraltiski punt");
    result.put("GMD","gambiski dalasi");
    result.put("GNF","guineski frank");
    result.put("GTQ","guatemalski quetzal");
    result.put("GWP","Guinea-Bissau peso");
    result.put("GYD","guyański dolar");
    result.put("HKD","hongkongski dolar");
    result.put("HNL","honduraska lempira");
    result.put("HRK","chorwatska kuna");
    result.put("HTG","haitiska gourda");
    result.put("HUF","madźarski forint");
    result.put("IDR","indoneska rupija");
    result.put("ILS","israelski nowy šekel");
    result.put("INR","indiska rupija");
    result.put("IQD","irakski dinar");
    result.put("IRR","irański rial");
    result.put("ISK","islandska krona");
    result.put("JMD","jamaiski dolar");
    result.put("JOD","jordaniski dinar");
    result.put("JPY","japański yen");
    result.put("KES","keniaski šiling");
    result.put("KGS","kirgiski som");
    result.put("KHR","kambodžaski riel");
    result.put("KMF","komorski frank");
    result.put("KPW","pódpołnocnokorejski won");
    result.put("KRW","pódpołdnjowokorejski won");
    result.put("KWD","kuwaitski dinar");
    result.put("KYD","kajmaniski dolar");
    result.put("KZT","kazachski tenge");
    result.put("LAK","laoski kip");
    result.put("LBP","libanoński punt");
    result.put("LKR","sri-lankaska rupija");
    result.put("LRD","liberiski dolar");
    result.put("LTL","litawski litas");
    result.put("LVL","letiski lat");
    result.put("LYD","libyski dinar");
    result.put("MAD","marokkoski dirham");
    result.put("MDL","moldawiski leu");
    result.put("MGA","madagaskarski ariary");
    result.put("MKD","makedoński denar");
    result.put("MMK","myanmarski kyat");
    result.put("MNT","mongolski tugrik");
    result.put("MOP","macaoska pataca");
    result.put("MRO","mauretański ouguiya (1973–2017)");
    result.put("MRU","mauretański ouguiya");
    result.put("MUR","mauriciska rupija");
    result.put("MVR","malediwiska rupija");
    result.put("MWK","malawiski kwacha");
    result.put("MXN","mexiski peso");
    result.put("MYR","malajziski ringgit");
    result.put("MZE","Mozabicke escudo");
    result.put("MZM","mosambikski metical (1980–2006)");
    result.put("MZN","mosambikski metical");
    result.put("NAD","namibiski dolar");
    result.put("NGN","nigeriska naira");
    result.put("NIO","nikaraguaska cordoba");
    result.put("NOK","norwegska krona");
    result.put("NPR","nepalska rupija");
    result.put("NZD","nowoseelandski dolar");
    result.put("OMR","omański rial");
    result.put("PAB","panamaski balboa");
    result.put("PEN","peruski sol");
    result.put("PGK","papua-neuguinejska kina");
    result.put("PHP","filipinski peso");
    result.put("PKR","pakistańska rupija");
    result.put("PLN","pólski złoty");
    result.put("PYG","paraguayski guarani");
    result.put("QAR","katarski rial");
    result.put("RON","rumuński leu");
    result.put("RSD","serbiski dinar");
    result.put("RUB","ruski rubl");
    result.put("RWF","ruandiski frank");
    result.put("SAR","saudi-arabiski rial");
    result.put("SBD","salomoński dolar");
    result.put("SCR","seychelska rupija");
    result.put("SDG","sudański punt");
    result.put("SEK","šwedska krona");
    result.put("SGD","singapurski dolar");
    result.put("SHP","St. Helena punt");
    result.put("SLL","sierra-leoneski leone");
    result.put("SOS","somaliski šiling");
    result.put("SRD","surinamski dolar");
    result.put("SSP","pódpołdnjowosudański punt");
    result.put("STD","são-tomeska dobra (1977–2017)");
    result.put("STN","são-tomeska dobra");
    result.put("SVC","el-salvadorski colón");
    result.put("SYP","syriski punt");
    result.put("SZL","swasiski lilangeni");
    result.put("THB","thaiski baht");
    result.put("TJS","tadźikiski somoni");
    result.put("TMT","turkmeniski manat");
    result.put("TND","tuneziski dinar");
    result.put("TOP","tongaski paʻanga");
    result.put("TRY","turkojska lira");
    result.put("TTD","trinidad-tobagoski dolar");
    result.put("TWD","nowy taiwański dolar");
    result.put("TZS","tansaniski šiling");
    result.put("UAH","ukrainska griwna");
    result.put("UGX","ugandaski šiling");
    result.put("USD","ameriski dolar");
    result.put("UYU","uruguayski peso");
    result.put("UZS","usbekiski sum");
    result.put("VEF","venezuelski bolívar (2008–2018)");
    result.put("VES","venezuelski bolívar");
    result.put("VND","vietnamski dong");
    result.put("VUV","vanuatski vatu");
    result.put("WST","samoaska tala");
    result.put("XAF","CFA-frank (BEAC)");
    result.put("XCD","pódzajtšnokaribiski dolar");
    result.put("XOF","CFA-frank (BCEAO)");
    result.put("XPF","CFP-frank");
    result.put("XXX","njeznate pjenjeze");
    result.put("YER","jemeński rial");
    result.put("ZAR","pódpołdnjowoafriski rand");
    result.put("ZMW","sambiska kwacha");
    return result;
  }
}
