...
public class CurrencyList_dz_BT extends CurrencyList_dz {
  public CurrencyData getDefault() {
    return new CurrencyDataImpl("BTN","Nu.",2,"Nu.","Nu.");
  }
  ...
  protected HashMap<String, CurrencyData> loadCurrencyMap() {
    ...
    // དངུལ་ཀྲམ
    result.put("BTN", new CurrencyDataImpl("BTN","Nu.",2,"Nu.","Nu."));
    // BUK
    ...
    result.put("KRW", new CurrencyDataImpl("KRW","KR₩",0,"KR₩","KR₩"));
    // ཀུ་ཝེཊ་གི་དངུལ་ ཌི་ན
    ...
    result.put("THB", new CurrencyDataImpl("THB","TH฿",2,"TH฿","TH฿"));
    // TJR
  ...
  protected HashMap<String, String> loadNamesMap() {
    ...
    result.put("BDT","བྷང་ལ་དེཤ་གི་དངུལ་ ཏ་ཀ");
    result.put("BMD","བར་མུ་ཌ་གི་དངུལ་ ཌོ་ལར");
    result.put("BRL","བྲ་ཛིལ་གྱི་དངུལ་ རེ་ཡལ");
    result.put("BTN","དངུལ་ཀྲམ");
    result.put("CAD","ཀེ་ན་ཌ་གི་དངུལ་ ཌོ་ལར");
    result.put("CHF","སུ་ཡིས་ཀྱི་དངུལ་ ཕྲངཀ");
    result.put("CLP","ཅི་ལི་གི་དངུལ་ པེ་སོ");
    result.put("CNY","རྒྱ་ནག་གི་དངུལ་ ཡུ་ཝཱན");
    result.put("COP","ཀོ་ལོམ་བྷི་ཡ་གི་དངུལ་ པེ་སོ");
    result.put("CUP","ཀིའུ་བྷ་གི་དངུལ་ པེ་སོ");
    result.put("DKK","ཌེན་མཱཀ་གི་དངུལ་ ཀྲོན");
    result.put("DZD","ཨཱལ་ཇི་རི་ཡ་གི་དངུལ་ ཌའི་ནར");
    result.put("EGP","ཨི་ཇིབཊ་གི་དངུལ་ པ་འུནཌ");
    result.put("EUR","ཡུ་རོ༌དངུལ་");
    result.put("GBP","བྲི་ཊིཤ་ པ་འུནཌ་ ཨིས་ཊར་ལིང");
    result.put("HKD","ཧོང་ཀོང་གི་དངུལ་ ཌོ་ལར");
    result.put("IDR","ཨིན་ཌོ་ནེ་ཤི་ཡ་གི་དངུལ་ རུ་པི་ཡ");
    result.put("ILS","ཨིས་རེལ་གྱི་དངུལ་གསརཔ་ ཤེ་ཀེལ");
    result.put("INR","རྒྱ་གར་གྱི་དངུལ་ རུ་པི");
    result.put("IQD","ཨི་རཱཀ་གི་དངུལ་ ཌི་ན");
    result.put("IRR","ཨི་རཱན་གྱི་དངུལ་ རི་ཨཱལ");
    result.put("ISK","ཨཱཡིས་ལེནཌ་གི་དངུལ་ ཀྲོ་ན");
    result.put("JMD","ཇཱ་མཻ་ཀ་གི་དངུལ་ ཌོ་ལར");
    result.put("JOD","ཇོར་ཌན་གྱི་དངུལ་ ཌི་ན");
    result.put("JPY","ཇཱ་པཱན་གྱི་དངུལ་ ཡེན");
    result.put("KES","ཀེན་ཡ་གི་དངུལ་ ཤི་ལིང");
    result.put("KHR","ཀེམ་བྷོ་ཌི་ཡ་གི་དངུལ་ རི་ཨཱལ");
    result.put("KPW","ནོརཐ་ ཀོ་རི་ཡ་གི་དངུལ་ ཝོན");
    result.put("KRW","སཱའུཐ་ ཀོ་རི་ཡ་གི་དངུལ་ ཝོན");
    result.put("KWD","ཀུ་ཝེཊ་གི་དངུལ་ ཌི་ན");
    result.put("KZT","ཀ་ཛགས་ཏཱན་གྱི་དངུལ་ ཏེང་གེ");
    result.put("LAK","ལཱ་ཝོས་ཀྱི་དངུལ་ ཀིཔ");
    result.put("LBP","ལེ་བ་ནོན་གྱི་དངུལ་ པ་འུནཌ");
    result.put("LKR","ཤྲི་ ལང་ཀ་གི་དངུལ་ རུ་པི");
    result.put("LRD","ལཱའི་བེ་རི་ཡ་གི་དངུལ་ ཌོ་ལར");
    result.put("LYD","ལི་བི་ཡ་གི་དངུལ་ ཌི་ན");
    result.put("MAD","མོ་རོ་ཀོ་གི་དངུལ་ ཌིར་ཧཱམ");
    result.put("MMK","མི་ཡཱན་མར་གྱི་དངུལ་ ཅཱཏ");
    result.put("MNT","སོག་པོའི་དངུལ་ ཏུ་གྲིཀ");
    result.put("MVR","མཱལ་དིབས་ཀྱི་དངུལ་ རུ་ཕི་ཡ");
    result.put("MXN","མེཀ་སི་ཀོ་གི་དངུལ་ པེ་སོ");
    result.put("MYR","མ་ལེ་ཤི་ཡ་གི་དངུལ་ རིང་གིཊ");
    result.put("NOK","ནོར་ཝེ་གི་དངུལ་ ཀྲོ་ན");
    result.put("NPR","བལ་པོའི་དངུལ་ རུ་པི");
    result.put("NZD","ནིའུ་ཛི་ལེནཌ་གི་དངུལ་ ཌོ་ལར");
    result.put("OMR","ཨོ་མཱན་གྱི་དངུལ་ རི་ཨཱལ");
    result.put("PAB","པ་ན་མ་གི་དངུལ་ བཱལ་བོ་ཝ");
    result.put("PEN","པ་རུ་གི་དངུལ་ ནུ་བོ་ སཱོལ");
    result.put("PHP","ཕི་ལི་པིནས་གྱི་དངུལ་ པེ་སོ");
    result.put("PKR","པ་ཀིས་ཏཱན་གྱི་དངུལ་ རུ་པི");
    result.put("PLN","པོ་ལེནཌ་ཀྱི་དངུལ ཛ྄ལོ་ཊི");
    result.put("QAR","ཀ་ཊར་གྱི་དངུལ་ རི་ཨཱལ");
    result.put("RUB","ཨུ་རུ་སུ་གི་དངུལ་ རུ་བཱལ");
    result.put("SAR","སཱཝ་དིའི་དངུལ་ རི་ཡཱལ");
    result.put("SCR","སེ་ཤཱལས་ཀྱི་དངུལ་ རུ་པི");
    result.put("SEK","སུའི་ཌེན་གྱི་དངུལ་ ཀྲོ་ན");
    result.put("SGD","སིང་ག་པོར་གྱི་དངུལ་ ཌོ་ལར");
    result.put("SYP","སི་རི་ཡ་གི་དངུལ་ པ་འུནཌ");
    result.put("THB","ཐཱའི་ལེནཌ་གི་དངུལ་ བཱཏ");
    result.put("TJS","ཏ་ཇི་ཀིས་ཏཱན་གྱི་དངུལ་ སོ་མོ་ནི");
    result.put("TRY","ཊཱར་ཀི་གི་དངུལ་ ལི་ར");
    result.put("TWD","ཊཱའི་ཝཱན་གི་དངུལ ཌོ་ལར");
    result.put("TZS","ཊཱན་ཛཱ་ནི་ཡ་གི་དངུལ་ ཤི་ལིང");
    result.put("UGX","ཡུ་གྷེན་ཌ་གི་དངུལ་ ཤི་ལིང");
    result.put("USD","ཡུ་ཨེས་ ཌོ་ལར");
    result.put("UYU","ཡུ་རུ་གུ་ཝའི་གི་དངུལ་ པེ་སོ");
    result.put("UZS","ཨུས་བེ་ཀིས་ཏཱན་གྱི་དངུལ་ སོམ");
    result.put("VEF","བེ་ནི་ཛུ་ཝེ་ལ་གི་དངུལ་ བོ་ལི་བར (2008–2018)");
    result.put("VES","བེ་ནི་ཛུ་ཝེ་ལ་གི་དངུལ་ བོ་ལི་བར");
    result.put("VND","བེཊ་ནཱམ་གྱི་དངུལ་ ཌོང");
    result.put("XXX","མ་ཤེས་པའི་དངུལ");
    result.put("ZAR","སཱའུཐ་ ཨཕ་རི་ཀ་གི་དངུལ་ རཱནད");
    return result;
  }
}
