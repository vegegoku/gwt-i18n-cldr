...
public class CurrencyList_ee_GH extends CurrencyList_ee {
  public CurrencyData getDefault() {
    return new CurrencyDataImpl("GHS","GH₵",2,"GH₵","GH₵");
  }
  ...
  protected HashMap<String, CurrencyData> loadCurrencyMap() {
    ...
    // ghana siɖi
    result.put("GHS", new CurrencyDataImpl("GHS","GH₵",2,"GH₵","GH₵"));
    // gilbratarga pound
  ...
  protected HashMap<String, String> loadNamesMap() {
    ...
    result.put("ANG","netherlands antilleaga guilder");
    ...
    result.put("BBD","barbadosga dollar");
    ...
    result.put("BRL","braziliaga real");
    ...
    result.put("BSD","bahamasga dollar");
    ...
    result.put("GBP","britainga pound");
    ...
    result.put("GIP","gilbratarga pound");
    ...
    result.put("HRK","croatiaga kuna");
    result.put("HTG","haitiga gourde");
    result.put("HUF","hungariaga forint");
    result.put("IDR","Indonesiaga rupiah");
    ...
    result.put("ISK","icelandga króna");
    result.put("ITL","italiaga lira");
    result.put("JMD","jamaicaga dollar");
    result.put("JOD","yɔdanga dinar");
    result.put("JPY","Japanesega yen");
    ...
    result.put("KRW","South Koreaga won");
    result.put("KWD","kuwaitga dinar");
    result.put("KYD","cayman islandsga dollar");
    ...
    result.put("MKD","marcedoniaga denar");
    ...
    result.put("MRO","mɔritaniaga ouguiya (1973–2017)");
    result.put("MRU","mɔritaniaga ouguiya");
    result.put("MTL","maltaga lira");
    result.put("MTP","maltaga pound");
    result.put("MUR","mɔritiusga rupee");
    result.put("MVR","maldiviaga rufiyaa");
    result.put("MWK","malawiga kwacha");
    result.put("MXN","mexicoga peso");
    result.put("MYR","malaysiaga ringit");
    result.put("MZN","mozambikga metikal");
    result.put("NAD","namibiaga dollar");
    result.put("NGN","naidzeriaga naira");
    result.put("NIC","nikaraguaga córdoba (1988–1991)");
    result.put("NIO","nicaraguaga córdoba");
    ...
    result.put("SSP","anyiehe sudanga pound");
    result.put("STD","são tomé kple príncipega dobra (1977–2017)");
    result.put("STN","são tomé kple príncipega dobra");
    result.put("SUR","sovietga rouble");
    result.put("SVC","salvadɔga colón");
    result.put("SYP","syriaga pound");
    result.put("SZL","swaziga lilangeni");
    result.put("THB","Thailandga baht");
    ...
    result.put("TRY","Turkishga lira");
    result.put("TTD","trinidad & tobagoga dollar");
    result.put("TWD","Taiwanga dollar");
    ...
    result.put("VEF","venezuelaga bolívar (2008–2018)");
    result.put("VES","venezuelaga bolívar");
    ...
    result.put("XCD","east caribbeanga dollar");
    ...
    result.put("ZAR","South Africaga rand");
    result.put("ZMK","zambiaga kwacha (1968–2012)");
    result.put("ZMW","zambiaga kwacha");
