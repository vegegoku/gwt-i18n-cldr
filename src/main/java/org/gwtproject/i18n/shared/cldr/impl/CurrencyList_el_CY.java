...
public class CurrencyList_el_CY extends CurrencyList_el {
  ...
  protected HashMap<String, String> loadNamesMap() {
    ...
    result.put("AFN","Αφγάνι Αφγανιστάν");
    ...
    result.put("AWG","Φλορίνι Αρούμπας");
    ...
    result.put("BBD","Δολάριο Μπαρμπέιντος");
    ...
    result.put("BSD","Δολάριο Μπαχαμών");
    ...
    result.put("BYN","Ρούβλι Λευκορωσίας");
    result.put("BYR","Ρούβλι Λευκορωσίας (2000–2016)");
    ...
    result.put("CNH","Γουάν Κίνας (υπεράκτιο)");
    result.put("CNY","Γουάν Κίνας");
    ...
    result.put("DOP","Πέσο Δομινικανής Δημοκρατίας");
    ...
    result.put("FKP","Λίρα Νήσων Φόκλαντ");
    ...
    result.put("KMF","Φράγκο Κομορών");
    result.put("KPW","Γουόν Βόρειας Κορέας");
    result.put("KRW","Γουόν Νότιας Κορέας");
    result.put("KWD","Δηνάριο Κουβέιτ");
    result.put("KYD","Δολάριο Νήσων Κέιμαν");
    result.put("KZT","Τένγκε Καζακστάν");
    result.put("LAK","Κιπ Λάος");
    result.put("LBP","Λίρα Λιβάνου");
    result.put("LKR","Ρουπία Σρι Λάνκα");
    ...
    result.put("MDL","Λέου Μολδαβίας");
    result.put("MGA","Αριάρι Μαδαγασκάρης");
    result.put("MGF","Φράγκο Μαδαγασκάρης");
    result.put("MKD","Δηνάριο ΠΓΔΜ");
    result.put("MLF","Φράγκο Μαλί");
    result.put("MMK","Κιάτ Μιανμάρ");
    result.put("MNT","Τουγκρίκ Μογγολίας");
    result.put("MOP","Πατάκα Μακάο");
    result.put("MRO","Ουγκίγια Μαυριτανίας (1973–2017)");
    result.put("MRU","Ουγκίγια Μαυριτανίας");
    result.put("MTL","Λιρέτα Μάλτας");
    result.put("MTP","Λίρα Μάλτας");
    result.put("MUR","Ρουπία Μαυρικίου");
    result.put("MVR","Ρουφίγια Μαλδίβων");
    ...
    result.put("NAD","Δολάριο Ναμίμπιας");
    ...
    result.put("NPR","Ρουπία Νεπάλ");
    result.put("NZD","Δολάριο Νέας Ζηλανδίας");
    result.put("OMR","Ριάλ Ομάν");
    result.put("PAB","Μπαλμπόα Παναμά");
    result.put("PEI","Ίντι Περού");
    result.put("PEN","Σολ Περού");
    result.put("PES","Σολ Περού (1863–1965)");
    result.put("PGK","Κίνα Παπούας Νέας Γουινέας");
    result.put("PHP","Πέσο Φιλιππίνων");
    result.put("PKR","Ρουπία Πακιστάν");
    result.put("PLN","Ζλότι Πολωνίας");
    ...
    result.put("SCR","Ρουπία Σεϋχελλών");
    ...
    result.put("VEB","Μπολιβάρ Βενεζουέλας (1871–2008)");
    result.put("VEF","Μπολιβάρ Βενεζουέλας (2008–2018)");
    result.put("VES","Μπολιβάρ Βενεζουέλας");
    result.put("VND","Ντονγκ Βιετνάμ");
    result.put("VUV","Βατού Βανουάτου");
    result.put("WST","Τάλα Σαμόα");
    result.put("XAF","Φράγκο CFA Κεντρικής Αφρικής");
    ...
    result.put("XOF","Φράγκο CFA Δυτικής Αφρικής");
    result.put("XPF","Φράγκο CFP");
    result.put("XXX","Άγνωστο νόμισμα");
    ...
    result.put("ZMK","Κουάνζα Ζαΐρ (1968–2012)");
    result.put("ZMW","Κουάτσα Ζάμπιας");
