...
public class CurrencyList_en_AU extends CurrencyList_en_001 {
  public CurrencyData getDefault() {
    return new CurrencyDataImpl("AUD","$",2,"$","$");
  }
  ...
  protected HashMap<String, CurrencyData> loadCurrencyMap() {
    ...
    // Australian Dollar
    result.put("AUD", new CurrencyDataImpl("AUD","$",2,"$","$"));
    // Aruban Florin
    ...
    // Seychellois Rupee
    result.put("SCR", new CurrencyDataImpl("SCR","Rs",2,"Rs","Rs"));
    ...
    // CFP Franc
    result.put("XPF", new CurrencyDataImpl("XPF","CFP",0,"CFP","CFP"));
    // Platinum
