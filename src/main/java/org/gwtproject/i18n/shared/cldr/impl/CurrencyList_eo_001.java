...
public class CurrencyList_eo_001 extends CurrencyList_eo {
  public CurrencyData getDefault() {
    return new CurrencyDataImpl("MXN","MX$",2,"MX$","MX$");
  }
  ...
  protected HashMap<String, String> loadNamesMap() {
    ...
    result.put("CHF","Svisa franko");
    result.put("CNY","Ĉina juano");
    result.put("DKK","Dana krono");
    result.put("EUR","Eŭro");
    result.put("GBP","Brita pundo");
    result.put("HKD","Honkonga dolaro");
    result.put("IDR","Indonezia rupio");
    result.put("INR","Barata rupio");
    result.put("JPY","Japana eno");
    result.put("KRW","Sud-korea ŭono");
    result.put("MXN","Meksika peso");
    result.put("NOK","Norvega krono");
    result.put("PLN","Pola zloto");
    result.put("RUB","Rusa rublo");
    result.put("SAR","Sauda rialo");
    result.put("SEK","Sveda krono");
    result.put("THB","Taja bahto");
    result.put("TRY","Turka liro");
    result.put("TWD","Nova tajvana dolaro");
    ...
    result.put("XXX","Nekonata valuto");
    result.put("ZAR","Sud-afrika rando");
    return result;
  }
}
