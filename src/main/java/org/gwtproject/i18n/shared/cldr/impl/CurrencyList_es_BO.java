...
public class CurrencyList_es_BO extends CurrencyList_es_419 {
  public CurrencyData getDefault() {
    return new CurrencyDataImpl("BOB","Bs",2,"Bs","Bs");
  }
  ...
  protected HashMap<String, CurrencyData> loadCurrencyMap() {
    ...
    // boliviano
    result.put("BOB", new CurrencyDataImpl("BOB","Bs",2,"Bs","Bs"));
    // BOL
