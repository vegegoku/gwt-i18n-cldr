...
public class CurrencyList_es_DO extends CurrencyList_es_419 {
  public CurrencyData getDefault() {
    return new CurrencyDataImpl("DOP","RD$",2,"RD$","RD$");
  }
  ...
  protected HashMap<String, CurrencyData> loadCurrencyMap() {
    ...
    // peso dominicano
    result.put("DOP", new CurrencyDataImpl("DOP","RD$",2,"RD$","RD$"));
    // dinar argelino
