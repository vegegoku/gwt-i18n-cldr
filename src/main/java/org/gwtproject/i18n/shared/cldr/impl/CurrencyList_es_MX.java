...
public class CurrencyList_es_MX extends CurrencyList_es_419 {
  public CurrencyData getDefault() {
    return new CurrencyDataImpl("MXN","$",2,"$","$");
  }
  ...
  protected HashMap<String, CurrencyData> loadCurrencyMap() {
    ...
    // uguiya (1973–2017)
    result.put("MRO", new CurrencyDataImpl("MRO","MRU",128,"MRU","MRU"));
    // uguiya
    ...
    // peso mexicano
    result.put("MXN", new CurrencyDataImpl("MXN","$",2,"$","$"));
  ...
  protected HashMap<String, String> loadNamesMap() {
    ...
    result.put("BDT","taka bangladesí");
    ...
    result.put("MVR","rupia de Maldivas");
    ...
    result.put("STN","dobra santotomense");
