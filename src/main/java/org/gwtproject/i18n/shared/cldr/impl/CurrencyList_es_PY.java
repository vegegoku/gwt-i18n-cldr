...
public class CurrencyList_es_PY extends CurrencyList_es_419 {
  public CurrencyData getDefault() {
    return new CurrencyDataImpl("PYG","Gs.",0,"Gs.","Gs.");
  }
  ...
  protected HashMap<String, CurrencyData> loadCurrencyMap() {
    ...
    // guaraní paraguayo
    result.put("PYG", new CurrencyDataImpl("PYG","Gs.",0,"Gs.","Gs."));
    // rial catarí
