...
public class CurrencyList_es_UY extends CurrencyList_es_419 {
  public CurrencyData getDefault() {
    return new CurrencyDataImpl("UYU","$",2,"$","$");
  }
  ...
  protected HashMap<String, CurrencyData> loadCurrencyMap() {
    ...
    // peso uruguayo
    result.put("UYU", new CurrencyDataImpl("UYU","$",2,"$","$"));
    // unidad previsional uruguayo
    result.put("UYW", new CurrencyDataImpl("UYW","UP",132,"UP","UP"));
    // som uzbeko
