...
public class CurrencyList_es_VE extends CurrencyList_es_419 {
  public CurrencyData getDefault() {
    return new CurrencyDataImpl("VES","Bs.S",2,"Bs.S","Bs.S");
  }
  ...
  protected HashMap<String, CurrencyData> loadCurrencyMap() {
    ...
    // bolívar venezolano
    result.put("VEF", new CurrencyDataImpl("VEF","Bs.",130,"Bs.","Bs."));
    // bolívar soberano
    result.put("VES", new CurrencyDataImpl("VES","Bs.S",2,"Bs.S","Bs.S"));
    // dong
  ...
  protected HashMap<String, String> loadNamesMap() {
    ...
    result.put("ZMW","kuacha zambiano");
