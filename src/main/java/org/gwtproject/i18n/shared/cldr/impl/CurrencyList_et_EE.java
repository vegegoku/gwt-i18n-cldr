...
public class CurrencyList_et_EE extends CurrencyList_et {
  ...
  protected HashMap<String, CurrencyData> loadCurrencyMap() {
    ...
    // Eesti kroon
    result.put("EEK", new CurrencyDataImpl("EEK","kr",130,"kr","kr"));
    // Egiptuse nael
  ...
  protected HashMap<String, String> loadNamesMap() {
    ...
    result.put("ADP","Andorra peseeta");
    result.put("AED","Araabia Ühendemiraatide dirhem");
    result.put("AFA","Afganistani afgaani (1927–2002)");
    result.put("AFN","Afganistani afgaani");
    result.put("ALK","Albaania lekk (1946–1965)");
    result.put("ALL","Albaania lekk");
    result.put("AMD","Armeenia dramm");
    result.put("ANG","Hollandi Antillide kulden");
    result.put("AOA","Angola kvanza");
    result.put("AOK","Angola kvanza (1977–1990)");
    result.put("AON","Angola kvanza (1990–2000)");
    result.put("AOR","Angola reformitud kvanza, 1995–1999");
    result.put("ARA","Argentina austral");
    result.put("ARM","Argentina peeso (1881–1970)");
    result.put("ARP","Argentina peeso (1983–1985)");
    result.put("ARS","Argentina peeso");
    result.put("ATS","Austria šilling");
    result.put("AUD","Austraalia dollar");
    result.put("AWG","Aruba kulden");
    result.put("AZM","Aserbaidžaani manat (1993–2006)");
    result.put("AZN","Aserbaidžaani manat");
    result.put("BAD","Bosnia ja Hertsegoviina dinaar (1992–1994)");
    result.put("BAM","Bosnia ja Hertsegoviina konverteeritav mark");
    result.put("BAN","Bosnia ja Hertsegoviina uus dinaar (1994–1997)");
    result.put("BBD","Barbadose dollar");
    result.put("BDT","Bangladeshi taka");
    result.put("BEC","Belgia konverteeritav frank");
    result.put("BEF","Belgia frank");
    result.put("BEL","Belgia arveldusfrank");
    result.put("BGL","Bulgaaria püsiv leev");
    result.put("BGN","Bulgaaria leev");
    result.put("BGO","Bulgaaria leev (1879–1952)");
    result.put("BHD","Bahreini dinaar");
    result.put("BIF","Burundi frank");
    result.put("BMD","Bermuda dollar");
    result.put("BND","Brunei dollar");
    result.put("BOB","Boliivia boliviaano");
    result.put("BOL","Boliivia boliviaano (1863–1963)");
    result.put("BOP","Boliivia peeso");
    result.put("BRB","Brasiilia uus kruseiro (1967–1986)");
    result.put("BRC","Brasiilia krusado");
    result.put("BRE","Brasiilia kruseiro (1990–1993)");
    result.put("BRL","Brasiilia reaal");
    result.put("BRR","Brasiilia kruseiro (1993–1994)");
    result.put("BRZ","Brasiilia kruseiro (1942–1967)");
    result.put("BSD","Bahama dollar");
    result.put("BTN","Bhutani ngultrum");
    result.put("BUK","Birma kjatt");
    result.put("BWP","Botswana pula");
    result.put("BYB","Valgevene uus rubla (1994–1999)");
    result.put("BYN","Valgevene rubla");
    result.put("BYR","Valgevene rubla (2000–2016)");
    result.put("BZD","Belize’i dollar");
    result.put("CAD","Kanada dollar");
    result.put("CDF","Kongo frank");
    result.put("CHF","Šveitsi frank");
    result.put("CLE","Tšiili eskuudo");
    result.put("CLP","Tšiili peeso");
    result.put("CNH","Hiina jüaan (välismaine turg)");
    result.put("CNY","Hiina jüaan");
    result.put("COP","Colombia peeso");
    result.put("CRC","Costa Rica koloon");
    result.put("CSD","Serbia dinaar (2002–2006)");
    result.put("CUC","Kuuba konverteeritav peeso");
    result.put("CUP","Kuuba peeso");
    result.put("CVE","Cabo Verde eskuudo");
    result.put("CYP","Küprose nael");
    result.put("CZK","Tšehhi kroon");
    result.put("DDM","Ida-Saksa mark");
    result.put("DEM","Saksa mark");
    result.put("DJF","Djibouti frank");
    result.put("DKK","Taani kroon");
    result.put("DOP","Dominikaani peeso");
    result.put("DZD","Alžeeria dinaar");
    result.put("ECS","Ecuadori sukre");
    result.put("EEK","Eesti kroon");
    result.put("EGP","Egiptuse nael");
    result.put("ERN","Eritrea nakfa");
    result.put("ESP","Hispaania peseeta");
    result.put("ETB","Etioopia birr");
    result.put("EUR","euro");
    result.put("FIM","Soome mark");
    result.put("FJD","Fidži dollar");
    result.put("FKP","Falklandi saarte nael");
    result.put("FRF","Prantsuse frank");
    result.put("GBP","Suurbritannia naelsterling");
    result.put("GEL","Gruusia lari");
    result.put("GHC","Ghana sedi (1979–2007)");
    result.put("GHS","Ghana sedi");
    result.put("GIP","Gibraltari nael");
    result.put("GMD","Gambia dalasi");
    result.put("GNF","Guinea frank");
    result.put("GNS","Guinea syli");
    result.put("GRD","Kreeka drahm");
    result.put("GTQ","Guatemala ketsaal");
    result.put("GWE","Portugali Guinea eskuudo");
    result.put("GWP","Guinea-Bissau peeso");
    result.put("GYD","Guyana dollar");
    result.put("HKD","Hongkongi dollar");
    result.put("HNL","Hondurase lempiira");
    result.put("HRD","Horvaatia dinaar");
    result.put("HRK","Horvaatia kuna");
    result.put("HTG","Haiti gurd");
    result.put("HUF","Ungari forint");
    result.put("IDR","Indoneesia ruupia");
    result.put("IEP","Iiri nael");
    result.put("ILP","Iisraeli nael");
    result.put("ILR","Iisraeli seekel (1980–1985)");
    result.put("ILS","Iisraeli uus seekel");
    result.put("INR","India ruupia");
    result.put("IQD","Iraagi dinaar");
    result.put("IRR","Iraani riaal");
    result.put("ISJ","Islandi kroon (1918–1981)");
    result.put("ISK","Islandi kroon");
    result.put("ITL","Itaalia liir");
    result.put("JMD","Jamaica dollar");
    result.put("JOD","Jordaania dinaar");
    result.put("JPY","Jaapani jeen");
    result.put("KES","Keenia šilling");
    result.put("KGS","Kõrgõzstani somm");
    result.put("KHR","Kambodža riaal");
    result.put("KMF","Komoori frank");
    result.put("KPW","Põhja-Korea vonn");
    result.put("KRO","Lõuna-Korea vonn (1945–1953)");
    result.put("KRW","Lõuna-Korea vonn");
    result.put("KWD","Kuveidi dinaar");
    result.put("KYD","Kaimanisaarte dollar");
    result.put("KZT","Kasahstani tenge");
    result.put("LAK","Laose kiip");
    result.put("LBP","Liibanoni nael");
    result.put("LKR","Sri Lanka ruupia");
    result.put("LRD","Libeeria dollar");
    result.put("LSL","Lesotho loti");
    result.put("LTL","Leedu litt");
    result.put("LUC","Luksemburgi konverteeritav frank");
    result.put("LUF","Luksemburgi frank");
    result.put("LVL","Läti latt");
    result.put("LVR","Läti rubla");
    result.put("LYD","Liibüa dinaar");
    result.put("MAD","Maroko dirhem");
    result.put("MAF","Maroko frank");
    result.put("MCF","Monaco frank");
    result.put("MDL","Moldova leu");
    result.put("MGA","Madagaskari ariari");
    result.put("MGF","Madagaskar frank");
    result.put("MKD","Makedoonia dinaar");
    result.put("MKN","Makedoonia dinaar (1992–1993)");
    result.put("MLF","Mali frank");
    result.put("MMK","Myanmari kjatt");
    result.put("MNT","Mongoolia tugrik");
    result.put("MOP","Macau pataaka");
    result.put("MRO","Mauritaania ugia (1973–2017)");
    result.put("MRU","Mauritaania ugia");
    result.put("MTL","Malta liir");
    result.put("MTP","Malta nael");
    result.put("MUR","Mauritiuse ruupia");
    result.put("MVP","Maldiivi ruupia (1947–1981)");
    result.put("MVR","Maldiivi ruupia");
    result.put("MWK","Malawi kvatša");
    result.put("MXN","Mehhiko peeso");
    result.put("MXP","Mehhiko peeso (1861–1992)");
    result.put("MYR","Malaisia ringgit");
    result.put("MZE","Mosambiigi eskuudo");
    result.put("MZM","Mosambiigi metikal (1980–2006)");
    result.put("MZN","Mosambiigi metikal");
    result.put("NAD","Namiibia dollar");
    result.put("NGN","Nigeeria naira");
    result.put("NIC","Nicaragua kordoba (1988–1991)");
    result.put("NIO","Nicaragua kordoba");
    result.put("NLG","Hollandi kulden");
    result.put("NOK","Norra kroon");
    result.put("NPR","Nepali ruupia");
    result.put("NZD","Uus-Meremaa dollar");
    result.put("OMR","Omaani riaal");
    result.put("PAB","Panama balboa");
    result.put("PEI","Peruu inti");
    result.put("PEN","Peruu soll");
    result.put("PES","Peruu soll (1863–1965)");
    result.put("PGK","Paapua Uus-Guinea kina");
    result.put("PHP","Filipiini peeso");
    result.put("PKR","Pakistani ruupia");
    result.put("PLN","Poola zlott");
    result.put("PLZ","Poola zlott (1950–1995)");
    result.put("PTE","Portugali eskuudo");
    result.put("PYG","Paraguay guaranii");
    result.put("QAR","Katari riaal");
    result.put("RHD","Rodeesia dollar");
    result.put("ROL","Rumeenia leu (1952–2006)");
    result.put("RON","Rumeenia leu");
    result.put("RSD","Serbia dinaar");
    result.put("RUB","Venemaa rubla");
    result.put("RUR","Venemaa rubla (1991–1998)");
    result.put("RWF","Rwanda frank");
    result.put("SAR","Saudi Araabia riaal");
    result.put("SBD","Saalomoni Saarte dollar");
    result.put("SCR","Seišelli ruupia");
    result.put("SDD","Sudaani dinaar (1992–2007)");
    result.put("SDG","Sudaani nael");
    result.put("SDP","Sudaani nael (1957–1998)");
    result.put("SEK","Rootsi kroon");
    result.put("SGD","Singapuri dollar");
    result.put("SHP","Saint Helena nael");
    result.put("SIT","Sloveenia tolar");
    result.put("SKK","Slovaki kroon");
    result.put("SLL","Sierra Leone leoone");
    result.put("SOS","Somaalia šilling");
    result.put("SRD","Suriname dollar");
    result.put("SRG","Suriname kulden");
    result.put("SSP","Lõuna-Sudaani nael");
    result.put("STD","São Tomé ja Príncipe dobra (1977–2017)");
    result.put("STN","São Tomé ja Príncipe dobra");
    result.put("SUR","NSVL-i rubla");
    result.put("SVC","El Salvadori koloon");
    result.put("SYP","Süüria nael");
    result.put("SZL","Svaasimaa lilangeni");
    result.put("THB","Tai baat");
    result.put("TJR","Tadžikistani rubla");
    result.put("TJS","Tadžikistani somoni");
    result.put("TMM","Türkmenistani manat (1993–2009)");
    result.put("TMT","Türkmenistani manat");
    result.put("TND","Tuneesia dinaar");
    result.put("TOP","Tonga pa’anga");
    result.put("TPE","Timori eskuudo");
    result.put("TRL","Türgi liir (1922–2005)");
    result.put("TRY","Türgi liir");
    result.put("TTD","Trinidadi ja Tobago dollar");
    result.put("TWD","uus Taiwani dollar");
    result.put("TZS","Tansaania šilling");
    result.put("UAH","Ukraina grivna");
    result.put("UAK","Ukraina karbovanets");
    result.put("UGS","Uganda šilling (1966–1987)");
    result.put("UGX","Uganda šilling");
    result.put("USD","USA dollar");
    result.put("USN","USA järgmise päeva dollar");
    result.put("USS","USA sama päeva dollar");
    result.put("UYP","Uruguay peeso (1975–1993)");
    result.put("UYU","Uruguay peeso");
    result.put("UZS","Usbekistani somm");
    result.put("VEB","Venezuela boliivar (1871–2008)");
    result.put("VEF","Venezuela boliivar (2008–2018)");
    result.put("VES","Venezuela boliivar");
    result.put("VND","Vietnami dong");
    result.put("VNN","Vietnami dong (1978–1985)");
    result.put("VUV","Vanuatu vatu");
    result.put("WST","Samoa taala");
    result.put("XAF","Kesk-Aafrika CFA frank");
    result.put("XAG","hõbe");
    result.put("XAU","kuld");
    result.put("XBA","EURCO");
    result.put("XBB","Euroopa rahaühik");
    result.put("XBC","Euroopa rahaline arvestusühik (XBC)");
    result.put("XBD","Euroopa rahaline arvestusühik (XBD)");
    result.put("XCD","Ida-Kariibi dollar");
    result.put("XDR","Rahvusvahelise Valuutafondi arvestusühik");
    result.put("XEU","eküü");
    result.put("XFO","Prantsuse kuldfrank");
    result.put("XFU","Prantsuse UIC-frank");
    result.put("XOF","Lääne-Aafrika CFA frank");
    result.put("XPD","pallaadium");
    result.put("XPF","CFP frank");
    result.put("XPT","plaatina");
    result.put("XTS","vääringute testkood");
    result.put("XXX","määramata rahaühik");
    result.put("YDD","Jeemeni dinaar");
    result.put("YER","Jeemeni riaal");
    result.put("YUM","Jugoslaavia uus dinaar (1994–2002)");
    result.put("YUN","Jugoslaavia konverteeritav dinaar (1990–1992)");
    result.put("ZAR","Lõuna-Aafrika rand");
    result.put("ZMK","Sambia kvatša (1968–2012)");
    result.put("ZMW","Sambia kvatša");
    result.put("ZRZ","Sairi zaire");
    result.put("ZWD","Zimbabwe dollar (1980–2008)");
