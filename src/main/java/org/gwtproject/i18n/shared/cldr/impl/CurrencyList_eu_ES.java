...
public class CurrencyList_eu_ES extends CurrencyList_eu {
  ...
  protected HashMap<String, String> loadNamesMap() {
    ...
    result.put("AED","Arabiar Emirerri Batuetako dirhama");
    result.put("AFN","Afganistango afghania");
    result.put("ALL","Albaniako leka");
    result.put("AMD","Armeniako drama");
    result.put("ANG","Holandarren Antilletako guilderra");
    result.put("AOA","Angolako kwanza");
    result.put("ARS","Argentinako pesoa");
    result.put("AUD","Australiako dolarra");
    result.put("AWG","Arubako florina");
    result.put("AZN","Azerbaijango manata");
    result.put("BAM","Bosnia-Herzegovinako marko trukakorra");
    result.put("BBD","Barbadosetako dolarra");
    result.put("BDT","Bangladesheko taka");
    result.put("BGN","Bulgariako leva");
    result.put("BHD","Bahraingo dinarra");
    result.put("BIF","Burundiko frankoa");
    result.put("BMD","Bermudetako dolarra");
    result.put("BND","Bruneiko dolarra");
    result.put("BOB","Boliviako bolivianoa");
    result.put("BRL","Brasilgo erreala");
    result.put("BSD","Bahametako dolarra");
    result.put("BTN","Bhutango ngultruma");
    result.put("BWP","Bosniako pula");
    result.put("BYN","Bielorrusiako errubloa");
    result.put("BYR","Bielorrusiako errubloa (2000–2016)");
    result.put("BZD","Belizeko dolarra");
    result.put("CAD","Kanadako dolarra");
    result.put("CDF","Kongoko frankoa");
    result.put("CHF","Suitzako frankoa");
    result.put("CLP","Txileko pesoa");
    result.put("CNH","yuan txinatar (itsasoz haraindikoa)");
    result.put("CNY","Txinako yuana");
    result.put("COP","Kolonbiako pesoa");
    result.put("CRC","Costa Ricako colona");
    result.put("CUC","Kubako peso trukakorra");
    result.put("CUP","Kubako pesoa");
    result.put("CVE","Cabo Verdeko ezkutua");
    result.put("CZK","Txekiar Errepublikako koroa");
    result.put("DJF","Djibutiko frankoa");
    result.put("DKK","Danimarkako koroa");
    result.put("DOP","Dominikar Errepublikako pesoa");
    result.put("DZD","Aljeriako dinarra");
    result.put("EGP","Egiptoko libera");
    result.put("ERN","Eritreako nakfa");
    result.put("ETB","Etiopiako birra");
    result.put("EUR","euroa");
    result.put("FJD","Fijiko dolarra");
    result.put("FKP","Falkland uharteetako libera");
    result.put("GBP","Libera esterlina");
    result.put("GEL","Georgiako laria");
    result.put("GHS","Ghanako cedia");
    result.put("GIP","Gibraltarreko libera");
    result.put("GMD","Ganbiako dalasia");
    result.put("GNF","Gineako frankoa");
    result.put("GTQ","Guatemalako quetzala");
    result.put("GYD","Guyanako dolarra");
    result.put("HKD","Hong Kongeko dolarra");
    result.put("HNL","Hondurasko lempira");
    result.put("HRK","Kroaziako kuna");
    result.put("HTG","Haitiko gourdea");
    result.put("HUF","Hungariako florina");
    result.put("IDR","Indonesiako errupia");
    result.put("ILS","Israelgo shekel berria");
    result.put("INR","Indiako errupia");
    result.put("IQD","Irakeko dinarra");
    result.put("IRR","Irango riala");
    result.put("ISK","Islandiako koroa");
    result.put("JMD","Jamaikako dolarra");
    result.put("JOD","Jordaniako dinarra");
    result.put("JPY","Japoniako yena");
    result.put("KES","Kenyako txelina");
    result.put("KGS","Kirgizistango soma");
    result.put("KHR","Kanbodiako riela");
    result.put("KMF","Komoreetako frankoa");
    result.put("KPW","Ipar Koreako wona");
    result.put("KRW","Hego Koreako wona");
    result.put("KWD","Kuwaiteko dinarra");
    result.put("KYD","Kaiman uharteetako dolarra");
    result.put("KZT","Kazakhstango tengea");
    result.put("LAK","Laoseko kipa");
    result.put("LBP","Libanoko libera");
    result.put("LKR","Sri Lankako errupia");
    result.put("LRD","Liberiako dolarra");
    result.put("LSL","Lesothoko lotia");
    result.put("LTL","Lituaniako litasa");
    result.put("LVL","Letoniako latsa");
    result.put("LYD","Libiako dinarra");
    result.put("MAD","Marokoko dirhama");
    result.put("MDL","Moldaviako leua");
    result.put("MGA","Madagaskarreko ariarya");
    result.put("MKD","Mazedoniako dinarra");
    result.put("MMK","Myanmarreko kyata");
    result.put("MNT","Mongoliako tugrika");
    result.put("MOP","Macanako pataca");
    result.put("MRO","Mauritaniako ouguiya (1973–2017)");
    result.put("MRU","Mauritaniako ouguiya");
    result.put("MUR","Maurizio uharteetako errupia");
    result.put("MVR","Maldivetako rufiyaa");
    result.put("MWK","Malawiko kwacha");
    result.put("MXN","Mexikoko pesoa");
    result.put("MYR","Malaysiako ringgita");
    result.put("MZN","Mozambikeko metikala");
    result.put("NAD","Namibiako dolarra");
    result.put("NGN","Nigeriako naira");
    result.put("NIO","Nikaraguako cordoba");
    result.put("NOK","Norvegiako koroa");
    result.put("NPR","Nepalgo errupia");
    result.put("NZD","Zeelanda Berriko dolarra");
    result.put("OMR","Omango riala");
    result.put("PAB","Panamako balboa");
    result.put("PEN","Peruko sol");
    result.put("PGK","Papua Ginea Berriko kina");
    result.put("PHP","Filipinetako pesoa");
    result.put("PKR","Pakistango errupia");
    result.put("PLN","Poloniako zlotya");
    result.put("PYG","Paraguaiko guarania");
    result.put("QAR","Qatarreko riala");
    result.put("RON","Errumaniako leua");
    result.put("RSD","Serbiako dinarra");
    result.put("RUB","Errusiako errubloa");
    result.put("RWF","Ruandako frankoa");
    result.put("SAR","Arabia Saudiko riala");
    result.put("SBD","Salomon uharteetako dolarra");
    result.put("SCR","Seychelleetako errupia");
    result.put("SDG","Sudango libera");
    result.put("SEK","Suediako koroa");
    result.put("SGD","Singapurreko dolarra");
    result.put("SHP","Santa Helenako libera");
    result.put("SLL","Sierra Leonako leona");
    result.put("SOS","Somaliako txelina");
    result.put("SRD","Surinameko dolarra");
    result.put("SSP","Hego Sudango libera");
    result.put("STD","Sao Tomeko eta Principeko dobra (1977–2017)");
    result.put("STN","Sao Tome eta Principeko dobra");
    result.put("SYP","Siriako libera");
    result.put("SZL","Swazilandiako lilangenia");
    result.put("THB","Thailandiako bahta");
    result.put("TJS","Tajikistango somonia");
    result.put("TMT","Turkmenistango manata");
    result.put("TND","Tunisiako dinarra");
    result.put("TOP","Tongako Paʻanga");
    result.put("TRY","Turkiako lira");
    result.put("TTD","Trinidad eta Tobagoko dolarra");
    result.put("TWD","Taiwango dolar berria");
    result.put("TZS","Tanzaniako txelina");
    result.put("UAH","Ukrainako hryvnia");
    result.put("UGX","Ugandako txelina");
    result.put("USD","AEBko dolarra");
    result.put("UYU","Uruguaiko pesoa");
    result.put("UZS","Uzbekistango soma");
    result.put("VEF","Venezuelako bolivarra (2008–2018)");
    result.put("VES","Venezuelako bolivarra");
    result.put("VND","Vietnameko donga");
    result.put("VUV","Vanuatuko vatua");
    result.put("WST","Samoko tala");
    result.put("XAF","Afrika erdialdeko CFA frankoa");
    result.put("XCD","Karibe ekialdeko dolarra");
    result.put("XOF","Afrika mendebaldeko CFA frankoa");
    result.put("XPF","CFP frankoa");
    result.put("XXX","Moneta ezezaguna");
    result.put("YER","Yemengo riala");
    result.put("ZAR","Hegoafrikako randa");
    result.put("ZMK","Zambiako kwacha (1968–2012)");
    result.put("ZMW","Zambiako kwacha");
    return result;
  }
}
