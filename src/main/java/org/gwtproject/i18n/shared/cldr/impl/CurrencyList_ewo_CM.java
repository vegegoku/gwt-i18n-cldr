...
public class CurrencyList_ewo_CM extends CurrencyList_ewo {
  ...
  protected HashMap<String, String> loadNamesMap() {
    ...
    result.put("BHD","Dinár yá Bahərɛ́n");
    result.put("BIF","Fəláŋ yá Burundí");
    result.put("BWP","Púlá yá Botswána");
    result.put("CAD","Dolár yá Kanáda");
    result.put("CDF","Fəláŋ yá Kongo");
    result.put("CHF","Fəláŋ yá Suís");
    result.put("CNY","Yuán Renəminəbí yá Tsainís");
    result.put("CVE","Esəkúdo yá Kápə́vɛ́rə");
    result.put("DJF","Fəláŋ yá dzibutí");
    result.put("DZD","Dinár yá Alehérí");
    result.put("EGP","Lívə́lə yá Ehíbətía");
    result.put("ERN","Náfəka yá Eritelé");
    result.put("ETB","Bír yá Etsiópia");
    result.put("EUR","əró");
    result.put("GBP","Lívə́lə Sətərəlíŋ");
    result.put("GHC","Tzedí yá Ganá");
    result.put("GMD","Dalasí yá Gámbía");
    result.put("GNS","Síli yá Giné");
    result.put("INR","Rupí yá ɛ́ndía");
    result.put("JPY","Yɛ́n yá Hapɔ́n");
    result.put("KES","Silíŋ yá Keniá");
    result.put("KMF","Fəláŋ yá Komória");
    result.put("LRD","Dolár yá Libéria");
    result.put("LSL","Lotí yá Lesotó");
    result.put("LYD","Dinár yá Libí");
    result.put("MAD","Dirám yá Maróg");
    result.put("MGA","Ariari yá Maləgás");
    result.put("MRO","Ugiya yá Moritaní (1973–2017)");
    result.put("MRU","Ugiya yá Moritaní");
    result.put("MUR","Rupí yá Morís");
    result.put("MWK","Kwatsa yá Malawí");
    result.put("MZM","Metikal yá Mozambíg");
    result.put("NAD","Dolár yá Namibí");
    result.put("NGN","Náíra yá Nihéria");
    result.put("RWF","Fəláŋ yá Ruwandá");
    result.put("SAR","Riál yá Arabí Saudí");
    result.put("SCR","Rupí yá Sɛsɛ́l");
    result.put("SDG","Lívələ yá Sudán");
    result.put("SDP","Lívələ yá Sudán (1956–2007)");
    result.put("SHP","Lívələ yá Ǹfúfúb Elɛ́n");
    result.put("SLL","Leóne yá Sierá-leónə");
    result.put("SOS","Silíŋ yá Somalí");
    result.put("STD","Dóbə́ra yá Saó Tomé ai Pəlinəsípe (1977–2017)");
    result.put("STN","Dóbə́ra yá Saó Tomé ai Pəlinəsípe");
    result.put("SZL","Lilangeni yá Swazí");
    result.put("TND","Dinár yá Tunisí");
    result.put("TZS","Silíŋ yá Tanazaní");
    result.put("UGX","Silíŋ yá Ugandá (1966–1987)");
    result.put("USD","Dolár yá amɛ́rəkə");
    result.put("XAF","Fəláŋ CFA (BEAC)");
    result.put("XOF","Fəláŋ CFA (BCEAO)");
    result.put("ZAR","Ránədə yá Afiríka");
    result.put("ZMK","Kwatsa yá Zambí (1968–2012)");
    result.put("ZMW","Kwatsa yá Zambí");
    result.put("ZWD","Dolár yá Zimbabwé");
    return result;
  }
}
