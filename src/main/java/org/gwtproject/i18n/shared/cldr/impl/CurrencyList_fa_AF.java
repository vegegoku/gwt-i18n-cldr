...
public class CurrencyList_fa_AF extends CurrencyList_fa {
  public CurrencyData getDefault() {
    return new CurrencyDataImpl("AFN","؋",0,"؋","؋");
  }
  ...
  protected HashMap<String, String> loadNamesMap() {
    ...
    result.put("BYN","روبل روسیهٔ سفید");
    result.put("BYR","روبل روسیهٔ سفید (۲۰۰۰–۲۰۱۶)");
