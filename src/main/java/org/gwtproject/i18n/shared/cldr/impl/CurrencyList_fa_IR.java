...
public class CurrencyList_fa_IR extends CurrencyList_fa {
  public CurrencyData getDefault() {
    return new CurrencyDataImpl("IRR","ریال",0,"ریال","ریال");
  }
  ...
  protected HashMap<String, CurrencyData> loadCurrencyMap() {
    ...
    // افغانی افغانستان
    result.put("AFN", new CurrencyDataImpl("AFN","؋",0,"؋","؋"));
    // ALK
    ...
    // ریال ایران
    result.put("IRR", new CurrencyDataImpl("IRR","ریال",0,"ریال","ریال"));
    // ISJ
  ...
  protected HashMap<String, String> loadNamesMap() {
    ...
    result.put("BAD","دینار بوسنی و هرزگوین (۱۹۹۲ تا ۱۹۹۴)");
    ...
    result.put("BYN","روبل بلاروسی");
    result.put("BYR","روبل بلاروسی (۲۰۱۶–۲۰۰۰)");
    ...
    result.put("MRO","اوگوئیای موریتانی (۱۹۷۳ تا ۲۰۱۷)");
    result.put("MRU","اوگوئیای موریتانی");
    ...
    result.put("MZN","متیکال موزامبیک");
    ...
    result.put("SDD","دینار سودان (۱۹۹۲ تا ۲۰۰۷)");
    result.put("SDG","پوند سودان");
    ...
    result.put("SSP","پوند سودان جنوبی");
    result.put("STD","دوبرای سائوتومه و پرنسیپ (۱۹۷۷ تا ۲۰۱۷)");
    result.put("STN","دوبرای سائوتومه و پرنسیپ");
    ...
    result.put("TRL","لیرهٔ ترکیه (۱۹۲۲ تا ۲۰۰۵)");
    ...
    result.put("VEB","بولیوار ونزوئلا (۱۸۷۱ تا ۲۰۰۸)");
    result.put("VEF","بولیوار ونزوئلا (۲۰۰۸ تا ۲۰۱۸)");
    result.put("VES","بولیوار ونزوئلا");
    result.put("VND","دانگ ویتنام");
    result.put("VUV","واتوی وانوواتو");
    result.put("WST","تالای ساموا");
    result.put("XAF","فرانک CFA مرکز افریقا");
    result.put("XAG","نقره");
    result.put("XAU","طلا");
    result.put("XCD","دلار شرق کارائیب");
    result.put("XFO","فرانک طلای فرانسه");
    result.put("XOF","فرانک CFA غرب افریقا");
    result.put("XPD","پالادیم");
    result.put("XPF","فرانک اقیانوسیه");
    ...
    result.put("ZMK","کواچای زامبیا (۱۹۶۸ تا ۲۰۱۲)");
    result.put("ZMW","کواچای زامبیا");
    result.put("ZWD","دلار زیمبابوه (۱۹۸۰ تا ۲۰۰۸)");
