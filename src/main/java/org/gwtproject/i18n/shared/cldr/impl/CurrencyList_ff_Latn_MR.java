...
public class CurrencyList_ff_Latn_MR extends CurrencyList_ff_Latn {
  ...
  protected HashMap<String, String> loadNamesMap() {
    ...
    result.put("BHD","Dinaar Bahrayn");
    result.put("BIF","Mbuuɗu Burunndi");
    result.put("BWP","Pulaa Botwanaa");
    result.put("CAD","Dolaar Kandaaa");
    result.put("CDF","Faraa Konngo");
    result.put("CHF","Faraa Suwiis");
    result.put("CNY","Yuam Siin");
    result.put("CVE","Eskudoo Kap Weer");
    result.put("DJF","Faraa Jibutii");
    result.put("DZD","Dinaar Alaseri");
    result.put("EGP","Liibar Ejipt");
    result.put("ERN","Nafka Eriteree");
    result.put("ETB","Biir Ecoppi");
    result.put("EUR","Oroo");
    result.put("GBP","Liibar Sterling");
    result.put("GHC","Sedi Ganaa");
    result.put("GMD","Dalasi Gammbi");
    result.put("GNS","Faraa Gine");
    result.put("INR","Rupii Enndo");
    result.put("JPY","Yen Sapoo");
    result.put("KES","Siling Keñaa");
    result.put("KMF","Faraa Komoor");
    result.put("LRD","Dolaar Liberiyaa");
    result.put("LSL","Loti Lesotoo");
    result.put("LYD","Dinaar Libi");
    result.put("MAD","Diraham Maruk");
    result.put("MGA","Ariyari Madagaskaar");
    result.put("MRO","Ugiyya Muritani (1973–2017)");
    result.put("MRU","Ugiyya Muritani");
    result.put("MUR","Rupii Moriis");
    result.put("MWK","Kuwacca Malaawi");
    result.put("MZM","Metikal Mosammbik");
    result.put("NAD","Dolaar Namibii");
    result.put("NGN","Nayraa Nijeriyaa");
    result.put("RWF","Faraa Ruwanndaa");
    result.put("SAR","Riyaal Arabi Sawdit");
    result.put("SCR","Rupii Seysel");
    result.put("SDG","Liibar Sudaan");
    result.put("SHP","Liibar Sent Helen");
    result.put("SLL","Lewoon Seraa Liyon");
    result.put("SOS","Siling Soomali");
    result.put("STD","Dobra Sawo Tome e Prensipe (1977–2017)");
    result.put("STN","Dobra Sawo Tome e Prensipe");
    result.put("SZL","Lilangeni Swaasilannda");
    result.put("TND","Dinaar Tunisii");
    result.put("TZS","Siling Tansanii");
    result.put("UGX","Siling Uganndaa");
    result.put("USD","Dolaar Dowlaaji Dentuɗi");
    result.put("XAF","Mbuuɗi Seefaa BEAC");
    result.put("XOF","Mbuuɗu Seefaa BCEAO");
    result.put("ZAR","Rannda Afrik Bŋ Worgo");
    result.put("ZMK","Kuwacca Sammbi (1968–2012)");
    result.put("ZMW","Kuwacca Sammbi");
    result.put("ZWD","Dolaar Simbaabuwe");
    return result;
  }
}
