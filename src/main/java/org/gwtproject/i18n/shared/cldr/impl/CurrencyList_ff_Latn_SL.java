...
public class CurrencyList_ff_Latn_SL extends CurrencyList_ff_Latn {
  public CurrencyData getDefault() {
    return new CurrencyDataImpl("SLL","Le",0,"Le","Le");
  }
  ...
  protected HashMap<String, CurrencyData> loadCurrencyMap() {
    ...
    // Lewoon Seraa Liyon
    result.put("SLL", new CurrencyDataImpl("SLL","Le",0,"Le","Le"));
    // Siling Soomali
