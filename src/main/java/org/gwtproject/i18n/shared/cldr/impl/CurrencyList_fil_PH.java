...
public class CurrencyList_fil_PH extends CurrencyList_fil {
  public CurrencyData getDefault() {
    return new CurrencyDataImpl("PHP","₱",2,"₱","₱");
  }
  ...
  protected HashMap<String, CurrencyData> loadCurrencyMap() {
    ...
    // Piso ng Pilipinas
    result.put("PHP", new CurrencyDataImpl("PHP","₱",2,"₱","₱"));
    // Pakistani Rupee
  ...
  protected HashMap<String, String> loadNamesMap() {
    ...
    result.put("ANG","Antillean Guilder ng Netherlands");
    result.put("AOA","Angolan Kwanza");
    result.put("ARS","Piso ng Argentina");
    result.put("AUD","Dolyar ng Australya");
    result.put("AWG","Florin ng Aruba");
    result.put("AZN","Azerbaijani Manat");
    result.put("BAM","Bosnia-Herzegovina Convertible Mark");
    result.put("BBD","Dolyar ng Barbados");
    result.put("BDT","Bangladeshi Taka");
    result.put("BGN","Bulgarian Lev");
    result.put("BHD","Bahraini Dinar");
    result.put("BIF","Burundian Franc");
    result.put("BMD","Dolyar ng Bermuda");
    result.put("BND","Dolyar ng Brunei");
    result.put("BOB","Boliviano ng Bolivia");
    result.put("BRL","Real ng Barzil");
    result.put("BSD","Dolyar ng Bahamas");
    ...
    result.put("BZD","Dolyar ng Belize");
    result.put("CAD","Dolyar ng Canada");
    result.put("CDF","Congolese Franc");
    result.put("CHF","Swiss Franc");
    result.put("CLP","Piso ng Chile");
    result.put("CNY","Chinese Yuan");
    result.put("COP","Piso ng Colombia");
    result.put("CRC","Colón ng Costa Rica");
    result.put("CUC","Convertible na Piso ng Cuba");
    result.put("CUP","Piso ng Cuba");
    result.put("CVE","Cape Verdean Escudo");
    result.put("CZK","Czech Republic Koruna");
    result.put("DEM","Deutsche Marks");
    result.put("DJF","Djiboutian Franc");
    result.put("DKK","Danish Krone");
    result.put("DOP","Piso ng Dominican");
    ...
    result.put("EUR","Euro");
    result.put("FJD","Dolyar ng Fiji");
    result.put("FKP","Pound ng Falkland Islands");
    ...
    result.put("GTQ","Quetzal ng Guatemala");
    result.put("GYD","Dolyar ng Guyanese");
    result.put("HKD","Dolyar ng Hong Kong");
    result.put("HNL","Lempira ng Honduras");
    result.put("HRK","Croatian Kuna");
    result.put("HTG","Gourde ng Haiti");
    ...
    result.put("JMD","Dolyar ng Jamaica");
    ...
    result.put("KPW","Won ng Hilagang Korea");
    result.put("KRW","Won ng Timog Korea");
    result.put("KWD","Kuwaiti Dinar");
    result.put("KYD","Dolyar ng Cayman Islands");
    result.put("KZT","Kazakhstani Tenge");
    result.put("LAK","Laotian Kip");
    result.put("LBP","Pound ng Lebanon");
    result.put("LKR","Sri Lankan Rupee");
    result.put("LRD","Dolyar ng Liberia");
    ...
    result.put("SBD","Dolyar ng Solomon Islands");
    result.put("SCR","Seychellois Rupee");
    result.put("SDG","Pound ng Sudan");
    result.put("SEK","Swedish Krona");
    result.put("SGD","Dolyar ng Singapore");
    ...
    result.put("SRD","Dolyar ng Suriname");
    result.put("SSP","Pound ng Timog Sudan");
    result.put("STD","São Tomé & Príncipe Dobra (1977–2017)");
    result.put("STN","São Tomé & Príncipe Dobra (2018)");
    ...
    result.put("TTD","Dolyar ng Trinidad and Tobago");
    result.put("TWD","Dolyar ng New Taiwan");
    result.put("TZS","Tanzanian Shilling");
    result.put("UAH","Ukrainian Hryvnia");
    result.put("UGX","Ugandan Shilling");
    result.put("USD","Dolyar ng US");
    result.put("UYU","Piso ng Uruguay");
    result.put("UZS","Uzbekistan Som");
    result.put("VEB","Venezuelan Bolívar (1871–2008)");
    result.put("VEF","Bolívar ng Venezuela (2008–2018)");
    result.put("VES","Bolívar ng Venezuela");
    result.put("VND","Vietnamese Dong");
    result.put("VUV","Vanuatu Vatu");
    result.put("WST","Samoan Tala");
    result.put("XAF","CFA Franc BEAC");
    result.put("XCD","Dolyar ng Silangang Caribbean");
    result.put("XOF","CFA Franc ng Kanlurang Africa");
    result.put("XPF","CFP Franc");
    result.put("XXX","Hindi Kilalang Pera");
    result.put("YER","Yemeni Rial");
    result.put("ZAR","Rand ng Timog Africa");
