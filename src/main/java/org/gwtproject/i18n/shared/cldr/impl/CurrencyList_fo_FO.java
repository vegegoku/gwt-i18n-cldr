...
public class CurrencyList_fo_FO extends CurrencyList_fo {
  ...
  protected HashMap<String, String> loadNamesMap() {
    ...
    result.put("AED","Sameindu Emirríkini dirham");
    result.put("AFN","Afganistan afghani");
    result.put("ALL","Albania lek");
    result.put("AMD","Armenia dram");
    result.put("ANG","Niðurlonds Karibia gyllin");
    result.put("AOA","Angola kwanza");
    result.put("ARS","Argentina peso");
    result.put("AUD","Avstralskur dollari");
    result.put("AWG","Aruba florin");
    result.put("AZN","Aserbadjan manat");
    result.put("BAM","Bosnia-Hersegovina mark (kann vekslast)");
    result.put("BBD","Barbados dollari");
    result.put("BDT","Bangladesj taka");
    result.put("BGN","Bulgaria lev");
    result.put("BHD","Barein dinar");
    result.put("BIF","Burundi frankur");
    result.put("BMD","Bermuda dollari");
    result.put("BND","Brunei dollari");
    result.put("BOB","Bolivia boliviano");
    result.put("BRL","Brasilianskur real");
    result.put("BSD","Bahamaoyggjar dollari");
    result.put("BTN","Butan ngultrum");
    result.put("BWP","Botsvana pula");
    result.put("BYN","Hvítarussland ruble");
    result.put("BYR","Hvítarussland ruble (2000–2016)");
    result.put("BZD","Belis dollari");
    result.put("CAD","Kanada dollari");
    result.put("CDF","Kongo frankur");
    result.put("CHF","sveisiskur frankur");
    result.put("CLP","Kili peso");
    result.put("CNH","kinesiskur yuan (úr landi)");
    result.put("CNY","kinesiskur yuan");
    result.put("COP","Kolombia peso");
    result.put("CRC","Kosta Rika colón");
    result.put("CUC","Kuba peso (sum kann vekslast)");
    result.put("CUP","Kuba peso");
    result.put("CVE","Grønhøvdaoyggjar escudo");
    result.put("CZK","Kekkia koruna");
    result.put("DJF","Djibuti frankur");
    result.put("DKK","donsk króna");
    result.put("DOP","Dominika peso");
    result.put("DZD","Algeria dinar");
    result.put("EGP","Egyptaland pund");
    result.put("ERN","Eritrea nakfa");
    result.put("ETB","Etiopia birr");
    result.put("EUR","Evra");
    result.put("FJD","Fiji dollari");
    result.put("FKP","Falklandsoyggjar pund");
    result.put("GBP","bretsk pund");
    result.put("GEL","Georgia lari");
    result.put("GHS","Gana cedi");
    result.put("GIP","Gibraltar pund");
    result.put("GMD","Gambia dalasi");
    result.put("GNF","Guinea frankur");
    result.put("GTQ","Guatemala quetzal");
    result.put("GYD","Gujana dollari");
    result.put("HKD","Hong Kong dollari");
    result.put("HNL","Honduras lempira");
    result.put("HRK","Kroatia kuna");
    result.put("HTG","Haiti gourde");
    result.put("HUF","Ungarn forint");
    result.put("IDR","Indonesia rupiah");
    result.put("ILS","Ísrael new shekel");
    result.put("INR","indiskir rupis");
    result.put("IQD","Irak dinar");
    result.put("IRR","iranskir rials");
    result.put("ISK","íslendsk króna");
    result.put("JMD","Jamaika dollari");
    result.put("JOD","Jordan dinar");
    result.put("JPY","japanskur yen");
    result.put("KES","kenjanskur skillingur");
    result.put("KGS","Kirgisia som");
    result.put("KHR","Kambodja riel");
    result.put("KMF","Komoroyggjar frankur");
    result.put("KPW","Norðurkorea won");
    result.put("KRW","Suðurkorea won");
    result.put("KWD","Kuvait dinar");
    result.put("KYD","Caymanoyggjar dollari");
    result.put("KZT","Kasakstan tenge");
    result.put("LAK","Laos kip");
    result.put("LBP","Libanon pund");
    result.put("LKR","Sri Lanka rupi");
    result.put("LRD","Liberia dollari");
    result.put("LYD","Libya dinar");
    result.put("MAD","Marokko dirham");
    result.put("MDL","Moldova leu");
    result.put("MGA","Madagaskar ariary");
    result.put("MKD","Makedónia denar");
    result.put("MMK","Myanmar (Burma) kyat");
    result.put("MNT","Mongolia tugrik");
    result.put("MOP","Makao pataca");
    result.put("MRO","Móritania ouguiya (1973–2017)");
    result.put("MRU","Móritania ouguiya");
    result.put("MUR","Móritius rupi");
    result.put("MVR","Maldivoyggjar rufiyaa");
    result.put("MWK","Malavi kwacha");
    result.put("MXN","Meksiko peso");
    result.put("MYR","Malaisia ringgit");
    result.put("MZN","Mosambik metical");
    result.put("NAD","Namibia dollari");
    result.put("NGN","Nigeria naira");
    result.put("NIO","Nikaragua córdoba");
    result.put("NOK","norsk króna");
    result.put("NPR","Nepal rupi");
    result.put("NZD","Nýsæland dollari");
    result.put("OMR","Oman rial");
    result.put("PAB","Panama balboa");
    result.put("PEN","Peru sol");
    result.put("PGK","Papua Nýguinea kina");
    result.put("PHP","Filipsoyggjar peso");
    result.put("PKR","Pakistan rupi");
    result.put("PLN","Pólland zloty");
    result.put("PYG","Paraguai guarani");
    result.put("QAR","Katar rial");
    result.put("RON","Rumenia leu");
    result.put("RSD","Serbia dinar");
    result.put("RUB","Russland ruble");
    result.put("RWF","Ruanda frankur");
    result.put("SAR","Saudiarabia riyal");
    result.put("SBD","Salomonoyggjar dollari");
    result.put("SCR","Seyskelloyggjar rupi");
    result.put("SDG","Sudan pund");
    result.put("SEK","svensk króna");
    result.put("SGD","Singapor dollari");
    result.put("SHP","St. Helena pund");
    result.put("SLL","Sierra Leona leone");
    result.put("SOS","Somalia skillingur");
    result.put("SRD","Surinam dollari");
    result.put("SSP","Suðursudan pund");
    result.put("STD","Sao Tome & Prinsipi dobra (1977–2017)");
    result.put("STN","Sao Tome & Prinsipi dobra");
    result.put("SYP","Sýria pund");
    result.put("SZL","Svasiland lilangeni");
    result.put("THB","Tailand baht");
    result.put("TJS","Tadsjikistan somoni");
    result.put("TMT","Turkmenistan manat");
    result.put("TND","Tunesia dinar");
    result.put("TOP","Tonga paʻanga");
    result.put("TRY","Turkaland liri");
    result.put("TTD","Trinidad & Tobago dollari");
    result.put("TWD","Taivan new dollari");
    result.put("TZS","Tansania skillingur");
    result.put("UAH","Ukraina hryvnia");
    result.put("UGX","Uganda skillingur");
    result.put("USD","US dollari");
    result.put("UYU","Uruguai peso");
    result.put("UZS","Usbekistan som");
    result.put("VEF","Venesuela bolívar (2008–2018)");
    result.put("VES","Venesuela bolívar");
    result.put("VND","Vjetnam dong");
    result.put("VUV","Vanuatu vatu");
    result.put("WST","Samoa tala");
    result.put("XAF","Miðafrika CFA frankur");
    result.put("XAG","unse sølv");
    result.put("XAU","unse guld");
    result.put("XCD","Eystur Karibia dollari");
    result.put("XOF","Vesturafrika CFA frankur");
    result.put("XPD","unse palladium");
    result.put("XPF","CFP frankur");
    result.put("XPT","unse platin");
    result.put("XXX","ókent gjaldoyra");
    result.put("YER","Jemen rial");
    result.put("ZAR","Suðurafrika rand");
    result.put("ZMW","Sambia kwacha");
    return result;
  }
}
