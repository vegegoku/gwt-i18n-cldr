...
public class CurrencyList_fr_CA extends CurrencyList_fr {
  public CurrencyData getDefault() {
    return new CurrencyDataImpl("CAD","$",2,"$","$");
  }
  ...
  protected HashMap<String, CurrencyData> loadCurrencyMap() {
    ...
    // dollar canadien
    result.put("CAD", new CurrencyDataImpl("CAD","$",2,"$","$"));
    // franc congolais
  ...
  protected HashMap<String, String> loadNamesMap() {
    ...
    result.put("AZN","manat azerbaïdjanais");
    ...
    result.put("CVE","escudo cap-verdien");
    ...
    result.put("PGK","kina papou-néo-guinéen");
    ...
    result.put("SRD","dollar du Suriname");
    ...
    result.put("TTD","dollar de Trinité-et-Tobago");
    ...
    result.put("XXX","Devise inconnue");
