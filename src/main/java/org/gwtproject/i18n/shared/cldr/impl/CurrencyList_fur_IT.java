...
public class CurrencyList_fur_IT extends CurrencyList_fur {
  ...
  protected HashMap<String, String> loadNamesMap() {
    ...
    result.put("ARS","Peso argjentin");
    result.put("ATS","Selin austriac");
    result.put("AUD","dolar australian");
    result.put("BEF","Franc de Belgjiche");
    result.put("BIF","Franc burundês");
    result.put("BND","Dolar dal Brunei");
    result.put("BRL","real brasilian");
    result.put("BYN","Rubli bielorùs");
    result.put("BYR","Rubli bielorùs (2000–2016)");
    result.put("CAD","dolar canadês");
    result.put("CHF","franc svuizar");
    result.put("CNY","yuan cinês");
    result.put("CSD","Vieri dinar serp");
    result.put("CUP","Peso cuban");
    result.put("CZK","Corone de Republiche Ceche");
    result.put("DEM","Marc todesc");
    result.put("DKK","corone danese");
    result.put("DZD","Dinar algerin");
    result.put("EUR","euro");
    result.put("FRF","Franc francês");
    result.put("GBP","sterline britaniche");
    result.put("HKD","dolar di Hong Kong");
    result.put("HRD","Dinar cravuat");
    result.put("HRK","Kuna cravuate");
    result.put("IDR","rupiah indonesiane");
    result.put("INR","rupie indiane");
    result.put("IRR","Rial iranian");
    result.put("ITL","Lire taliane");
    result.put("JPY","yen gjaponês");
    result.put("KRW","won de Coree dal Sud");
    result.put("LVL","Lats leton");
    result.put("MXN","peso messican");
    result.put("NAD","Dolar namibian");
    result.put("NIO","Córdoba oro nicaraguan");
    result.put("NOK","corone norvegjese");
    result.put("NZD","Dollar neozelandês");
    result.put("PKR","Rupie pachistane");
    result.put("PLN","zloty polac");
    result.put("RSD","Dinar serp");
    result.put("RUB","rubli rus");
    result.put("SAR","riyal de Arabie Saudite");
    result.put("SEK","corone svedese");
    result.put("SIT","Talar sloven");
    result.put("SKK","Corone slovache");
    result.put("THB","baht tailandês");
    result.put("TRL","Viere Lire turche");
    result.put("TRY","lire turche");
    result.put("TWD","gnûf dolar taiwanês");
    result.put("USD","dolar american");
    result.put("USN","Dolar american (prossime zornade)");
    result.put("USS","Dolar american (stesse zornade)");
    result.put("XAG","Arint");
    result.put("XAU","Aur");
    result.put("XBA","Unitât composite europeane");
    result.put("XBB","Unitât monetarie europeane");
    result.put("XBC","Unitât di acont europeane (XBC)");
    result.put("XBD","Unitât di acont europeane (XBD)");
    result.put("XDR","Dirits speciâi di incas");
    result.put("XFO","Franc aur francês");
    result.put("XFU","Franc UIC francês");
    result.put("XPD","Paladi");
    result.put("XPT","Platin");
    result.put("XRE","fonts RINET");
    result.put("XTS","codiç di verifiche de monede");
    result.put("XXX","Monede no valide o no cognossude");
