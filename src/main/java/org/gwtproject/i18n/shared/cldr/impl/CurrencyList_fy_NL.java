...
public class CurrencyList_fy_NL extends CurrencyList_fy {
  ...
  protected HashMap<String, CurrencyData> loadCurrencyMap() {
    ...
    // Canadese dollar
    result.put("CAD", new CurrencyDataImpl("CAD","C$",2,"C$","C$"));
    // Congolese frank
    ...
    // Salomon-dollar
    result.put("SBD", new CurrencyDataImpl("SBD","SI$",2,"SI$","SI$"));
    // Seychelse roepie
    ...
    // CFP-franc
    result.put("XPF", new CurrencyDataImpl("XPF","XPF",0,"XPF","XPF"));
    // Platina
  ...
  protected HashMap<String, String> loadNamesMap() {
    ...
    result.put("AED","Verenigde Arabyske Emiraten-dirham");
    result.put("AFA","Afghani (1927–2002)");
    result.put("AFN","Afghaanske afghani");
    result.put("ALL","Albanese lek");
    result.put("AMD","Armeense dram");
    result.put("ANG","Nederlânsk-Antilliaanske gûne");
    ...
    result.put("ARA","Argentynske austral");
    result.put("ARL","Argentynske peso ley (1970–1983)");
    result.put("ARM","Argentynske peso (1881–1970)");
    result.put("ARP","Argentynske peso (1983–1985)");
    result.put("ARS","Argentynske peso");
    result.put("ATS","Eastenrykse schilling");
    result.put("AUD","Australyske dollar");
    result.put("AWG","Arubaanske gulden");
    result.put("AZM","Azerbeidzjaanske manat (1993–2006)");
    result.put("AZN","Azerbeidzjaanske manat");
    result.put("BAD","Bosnyske dinar");
    result.put("BAM","Bosnyske convertibele mark");
    result.put("BAN","Nije Bosnyske dinar (1994–1997)");
    result.put("BBD","Barbadaanske dollar");
    result.put("BDT","Bengalese taka");
    result.put("BEC","Belgyske frank (convertibel)");
    result.put("BEF","Belgyske frank");
    result.put("BEL","Belgyske frank (finansjeel)");
    result.put("BGL","Bulgaarse harde lev");
    result.put("BGM","Bulgaarse socialistyske lev");
    ...
    result.put("BOB","Boliviaanske boliviano");
    result.put("BOL","Boliviaanske boliviano (1863–1963)");
    result.put("BOP","Boliviaanske peso");
    result.put("BOV","Boliviaanske mvdol");
    result.put("BRB","Braziliaanske cruzeiro novo (1967–1986)");
    result.put("BRC","Braziliaanske cruzado");
    result.put("BRE","Braziliaanske cruzeiro (1990–1993)");
    result.put("BRL","Braziliaanske real");
    result.put("BRN","Braziliaanske cruzado novo");
    result.put("BRR","Braziliaanske cruzeiro");
    result.put("BRZ","Braziliaanske cruzeiro (1942–1967)");
    result.put("BSD","Bahamaanske dollar");
    result.put("BTN","Bhutaanske ngultrum");
    result.put("BUK","Birmese kyat");
    result.put("BWP","Botswaanske pula");
    result.put("BYB","Wit-Russyske nieuwe roebel (1994–1999)");
    result.put("BYN","Wit-Russyske roebel");
    result.put("BYR","Wit-Russyske roebel (2000–2016)");
    result.put("BZD","Belizaanske dollar");
    ...
    result.put("CLE","Sileenske escudo");
    result.put("CLF","Sileenske unidades de fomento");
    result.put("CLP","Sileenske peso");
    result.put("CNY","Sineeske yuan renminbi");
    result.put("COP","Kolombiaanske peso");
    result.put("COU","Unidad de Valor Real");
    result.put("CRC","Costaricaanske colón");
    result.put("CSD","Alde Servyske dinar");
    result.put("CSK","Tsjechoslowaakse harde koruna");
    result.put("CUC","Kubaanske convertibele peso");
    result.put("CUP","Kubaanske peso");
    result.put("CVE","Kaapverdyske escudo");
    result.put("CYP","Cyprysk pûn");
    result.put("CZK","Tsjechyske kroon");
    result.put("DDM","East-Dútske ostmark");
    result.put("DEM","Dútske mark");
    result.put("DJF","Djiboutiaanske frank");
    result.put("DKK","Deenske kroon");
    result.put("DOP","Dominikaanske peso");
    result.put("DZD","Algerynske dinar");
    result.put("ECS","Ecuadoraanske sucre");
    result.put("ECV","Ecuadoraanske unidad de valor constante (UVC)");
    result.put("EEK","Estlânske kroon");
    result.put("EGP","Egyptysk pûn");
    result.put("ERN","Eritrese nakfa");
    result.put("ESA","Spaanske peseta (account A)");
    result.put("ESB","Spaanske peseta (convertibele account)");
    result.put("ESP","Spaanske peseta");
    result.put("ETB","Ethiopyske birr");
    result.put("EUR","Euro");
    result.put("FIM","Finse markka");
    result.put("FJD","Fiji-dollar");
    result.put("FKP","Falklâneilânske pûn");
    result.put("FRF","Franske franc");
    result.put("GBP","Brits pûn");
    result.put("GEK","Georgyske kupon larit");
    result.put("GEL","Georgyske lari");
    result.put("GHC","Ghanese cedi (1979–2007)");
    result.put("GHS","Ghanese cedi");
    result.put("GIP","Gibraltarees pûn");
    result.put("GMD","Gambiaanske dalasi");
    result.put("GNF","Guinese franc");
    result.put("GNS","Guinese syli");
    result.put("GQE","Equatoriaal-Guinese ekwele guineana");
    result.put("GRD","Grykse drachme");
    result.put("GTQ","Guatemalteekse quetzal");
    result.put("GWE","Portugees-Guinese escudo");
    result.put("GWP","Guinee-Bissause peso");
    result.put("GYD","Guyaanske dollar");
    result.put("HKD","Hongkongske dollar");
    result.put("HNL","Hondurese lempira");
    result.put("HRD","Kroatyske dinar");
    result.put("HRK","Kroatyske kuna");
    result.put("HTG","Haïtiaanske gourde");
    result.put("HUF","Hongaarse forint");
    result.put("IDR","Indonesyske roepia");
    result.put("IEP","Ierske pûn");
    result.put("ILP","Israëlysk pûn");
    result.put("ILS","Israëlyske nieuwe shekel");
    result.put("INR","Indiase roepie");
    result.put("IQD","Iraakse dinar");
    result.put("IRR","Iraanske rial");
    result.put("ISK","Yslânske kroon");
    result.put("ITL","Italiaanske lire");
    result.put("JMD","Jamaikaanske dollar");
    result.put("JOD","Jordaanske dinar");
    result.put("JPY","Japanse yen");
    result.put("KES","Keniaanske shilling");
    result.put("KGS","Kirgizyske som");
    result.put("KHR","Kambodjaanske riel");
    result.put("KMF","Komorese frank");
    result.put("KPW","Noard-Koreaanske won");
    result.put("KRH","Sûd-Koreaanske hwan (1953–1962)");
    result.put("KRO","Alde Sûd-Koreaanske won (1945–1953)");
    result.put("KRW","Sûd-Koreaanske won");
    result.put("KWD","Koeweitse dinar");
    result.put("KYD","Caymaneilânske dollar");
    result.put("KZT","Kazachstaanske tenge");
    result.put("LAK","Laotiaanske kip");
    result.put("LBP","Libaneeske pûn");
    result.put("LKR","Sri Lankaanske roepie");
    result.put("LRD","Liberiaanske dollar");
    result.put("LSL","Lesothaanske loti");
    result.put("LTL","Litouwse litas");
    result.put("LTT","Litouwse talonas");
    result.put("LUC","Lúksemboargske convertibele franc");
    result.put("LUF","Lúksemboargske frank");
    result.put("LUL","Lúksemboargske finansjele franc");
    result.put("LVL","Letse lats");
    result.put("LVR","Letse roebel");
    result.put("LYD","Libyske dinar");
    result.put("MAD","Marokkaanske dirham");
    result.put("MAF","Marokkaanske franc");
    result.put("MCF","Monegaskyske frank");
    result.put("MDC","Moldavyske cupon");
    result.put("MDL","Moldavyske leu");
    result.put("MGA","Malagassyske ariary");
    result.put("MGF","Malagassyske franc");
    result.put("MKD","Macedonyske denar");
    result.put("MKN","Macedonyske denar (1992–1993)");
    result.put("MLF","Malinese franc");
    result.put("MMK","Myanmarese kyat");
    result.put("MNT","Mongoalske tugrik");
    result.put("MOP","Macause pataca");
    result.put("MRO","Mauritaanske ouguiya (1973–2017)");
    result.put("MRU","Mauritaanske ouguiya");
    result.put("MTL","Maltese lire");
    result.put("MTP","Maltees pûn");
    result.put("MUR","Mauritiaanske roepie");
    result.put("MVR","Maldivyske rufiyaa");
    result.put("MWK","Malawyske kwacha");
    result.put("MXN","Meksikaanske peso");
    result.put("MXP","Meksikaanske sulveren peso (1861–1992)");
    result.put("MXV","Meksikaanske unidad de inversion (UDI)");
    result.put("MYR","Maleisyske ringgit");
    result.put("MZE","Mozambikaanske escudo");
    result.put("MZM","Alde Mozambikaanske metical");
    result.put("MZN","Mozambikaanske metical");
    result.put("NAD","Namibyske dollar");
    result.put("NGN","Nigeriaanske naira");
    result.put("NIC","Nicaraguaanske córdoba (1988–1991)");
    result.put("NIO","Nicaraguaanske córdoba");
    result.put("NLG","Nederlânske gûne");
    result.put("NOK","Noarske kroon");
    result.put("NPR","Nepalese roepie");
    result.put("NZD","Nij-Seelânske dollar");
    result.put("OMR","Omaanske rial");
    result.put("PAB","Panamese balboa");
    result.put("PEI","Peruaanske inti");
    result.put("PEN","Peruaanske sol");
    result.put("PES","Peruaanske sol (1863–1985)");
    result.put("PGK","Papuaanske kina");
    result.put("PHP","Filipynske peso");
    result.put("PKR","Pakistaanske roepie");
    result.put("PLN","Poalske zloty");
    result.put("PLZ","Poalske zloty (1950–1995)");
    result.put("PTE","Portugeeske escudo");
    result.put("PYG","Paraguayaanske guarani");
    result.put("QAR","Katarese rial");
    result.put("RHD","Rhodesyske dollar");
    result.put("ROL","Alde Roemeenske leu");
    result.put("RON","Roemeenske leu");
    result.put("RSD","Servyske dinar");
    result.put("RUB","Russyske roebel");
    result.put("RUR","Russyske roebel (1991–1998)");
    result.put("RWF","Rwandese frank");
    result.put("SAR","Saoedi-Arabyske riyal");
    result.put("SBD","Salomon-dollar");
    result.put("SCR","Seychelse roepie");
    result.put("SDD","Soedaneeske dinar");
    result.put("SDG","Soedaneeske pûn");
    result.put("SDP","Soedaneeske pûn (1957–1998)");
    result.put("SEK","Sweedske kroon");
    result.put("SGD","Singaporese dollar");
    result.put("SHP","Sint-Heleenske pûn");
    result.put("SIT","Sloveenske tolar");
    result.put("SKK","Slowaakse koruna");
    result.put("SLL","Sierraleoonse leone");
    result.put("SOS","Somalyske shilling");
    result.put("SRD","Surinaamske dollar");
    result.put("SRG","Surinaamske gulden");
    result.put("SSP","Sûd-Soedaneeske pûn");
    result.put("STD","Santomese dobra (1977–2017)");
    result.put("STN","Santomese dobra");
    result.put("SUR","Sovjet-roebel");
    result.put("SVC","Salvadoraanske colón");
    result.put("SYP","Syrysk pûn");
    result.put("SZL","Swazyske lilangeni");
    result.put("THB","Thaise baht");
    result.put("TJR","Tadzjikistaanske roebel");
    result.put("TJS","Tadzjikistaanske somoni");
    result.put("TMM","Turkmeense manat (1993–2009)");
    result.put("TMT","Turkmeense manat");
    result.put("TND","Tunesyske dinar");
    result.put("TOP","Tongaanske paʻanga");
    ...
    result.put("TWD","Nije Taiwanese dollar");
    result.put("TZS","Tanzaniaanske shilling");
    ...
    result.put("USD","Amerikaanske dollar");
    result.put("USN","Amerikaanske dollar (folgjende dei)");
    result.put("USS","Amerikaanske dollar (zelfde dei)");
    result.put("UYI","Uruguayaanske peso en geïndexeerde eenheden");
    result.put("UYP","Uruguayaanske peso (1975–1993)");
    result.put("UYU","Uruguayaanske peso");
    result.put("UZS","Oezbekistaanske sum");
    result.put("VEB","Fenezolaanske bolivar (1871–2008)");
    result.put("VEF","Fenezolaanske bolivar (2008–2018)");
    result.put("VES","Fenezolaanske bolivar");
    result.put("VND","Fietnameeske dong");
    result.put("VNN","Alde Fietnameeske dong (1978–1985)");
    result.put("VUV","Vanuatuaanske vatu");
    result.put("WST","Samoaanske tala");
    result.put("XAF","CFA-frank");
    result.put("XAG","Sulver");
    result.put("XAU","Goud");
    result.put("XBA","Europeeske gearfoege ienheid");
    result.put("XBB","Europeeske monetaire ienheid");
    result.put("XBC","Europeeske rekkenienheid (XBC)");
    result.put("XBD","Europeeske rekkenienheid (XBD)");
    result.put("XCD","East-Karibyske dollar");
    ...
    result.put("XUA","ADB-rekkenienheid");
    result.put("XXX","Unbekende muntienheid");
    result.put("YDD","Jemenityske dinar");
    result.put("YER","Jemenityske rial");
    result.put("YUD","Joegoslavyske harde dinar");
    result.put("YUM","Joegoslavyske noviy-dinar");
    result.put("YUN","Joegoslavyske convertibele dinar");
    result.put("YUR","Joegoslavyske herfoarme dinar (1992–1993)");
    result.put("ZAL","Sûd-Afrikaanske rand (finansjeel)");
    result.put("ZAR","Sûd-Afrikaanske rand");
    result.put("ZMK","Sambiaanske kwacha (1968–2012)");
    result.put("ZMW","Sambiaanske kwacha");
    result.put("ZRN","Saïreeske nije Saïre");
    result.put("ZRZ","Saïreeske Saïre");
    result.put("ZWD","Simbabwaanske dollar");
    result.put("ZWL","Simbabwaanske dollar (2009)");
    result.put("ZWR","Simbabwaanske dollar (2008)");
    return result;
  }
}
