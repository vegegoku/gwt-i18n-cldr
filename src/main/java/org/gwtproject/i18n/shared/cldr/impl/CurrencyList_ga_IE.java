...
public class CurrencyList_ga_IE extends CurrencyList_ga {
  ...
  protected HashMap<String, String> loadNamesMap() {
    ...
    result.put("AFN","Afghani na hAfganastáine");
    result.put("ALK","Lek na hAlbáine (1946–1965)");
    result.put("ALL","Lek na hAlbáine");
    result.put("AMD","Dram na hAirméine");
    result.put("ANG","Gildear Aintillí na hÍsiltíre");
    result.put("AOA","Kwanza Angóla");
    ...
    result.put("ARM","Peso na hAirgintíne (1881–1970)");
    result.put("ARP","Peso na hAirgintíne (1983–1985)");
    result.put("ARS","Peso na hAirgintíne");
    result.put("AUD","Dollar na hAstráile");
    result.put("AWG","Flóirín Arúba");
    result.put("AZM","Manat na hAsarbaiseáine (1993–2006)");
    result.put("AZN","Manat na hAsarbaiseáine");
    result.put("BAD","Dínear Bhoisnia-Heirseagaivéin (1992–1994)");
    result.put("BAM","Marg Inmhalartaithe na Boisnia-Heirseagaivéine");
    result.put("BBD","Dollar Bharbadós");
    result.put("BDT","Taka na Banglaidéise");
    result.put("BEF","Franc Beilgeach");
    result.put("BGL","Lev Crua na Bulgáire");
    result.put("BGN","Lev na Bulgáire");
    result.put("BGO","Lev na Bulgáire (1879–1952)");
    result.put("BHD","Dinar Bhairéin");
    ...
    result.put("BOV","Mvdol na Bolaive");
    result.put("BRB","Cruzeiro Nua na Brasaíle (1967–1986)");
    result.put("BRC","Cruzado na Brasaíle (1986–1989)");
    result.put("BRE","Cruzeiro na Brasaíle (1990–1993)");
    result.put("BRL","Real na Brasaíle");
    result.put("BRN","Cruzado Nua na Brasaíle (1989–1990)");
    result.put("BRR","Cruzeiro na Brasaíle (1993–1994)");
    result.put("BRZ","Cruzeiro na Brasaíle (1942–1967)");
    result.put("BSD","Dollar na mBahámaí");
    result.put("BTN","Ngultrum na Bútáine");
    result.put("BUK","Kyat Bhurma");
    result.put("BWP","Pula na Botsuáine");
    result.put("BYB","Rúbal Nua na Bealarúise (1994–1999)");
    result.put("BYN","Rúbal na Bealarúise");
    result.put("BYR","Rúbal na Bealarúise (2000–2016)");
    result.put("BZD","Dollar na Beilíse");
    result.put("CAD","Dollar Cheanada");
    result.put("CDF","Franc an Chongó");
    result.put("CHF","Franc na hEilvéise");
    result.put("CLE","Escudo na Sile");
    result.put("CLF","Unidades de Fomento na Sile");
    result.put("CLP","Peso na Sile");
    result.put("CNY","Yuan na Síne");
    result.put("COP","Peso na Colóime");
    result.put("CRC","Colón Chósta Ríce");
    result.put("CSD","Dinar na Seirbia (2002–2006)");
    result.put("CSK","Koruna Crua na Seicslóvaice");
    result.put("CUC","Peso Inmhalartaithe Chúba");
    result.put("CUP","Peso Chúba");
    result.put("CVE","Escudo Rinn Verde");
    ...
    result.put("DKK","Coróin na Danmhairge");
    result.put("DOP","Peso na Poblachta Doiminicí");
    result.put("DZD","Dinar na hAilgéire");
    ...
    result.put("ERN","Nakfa na hEiritré");
    result.put("ESP","Peseta na Spáinne");
    ...
    result.put("GEL","Lari na Seoirsia");
    result.put("GHC","Cedi Ghána (1979–2007)");
    result.put("GHS","Cedi Ghána");
    result.put("GIP","Punt Ghiobráltar");
    result.put("GMD","Dalasi na Gaimbia");
    result.put("GNF","Franc na Guine");
    result.put("GNS","Syli Guine");
    result.put("GQE","Ekwele Guineana na Guine Meánchiorclaí");
    result.put("GRD","Drachma Gréagach");
    result.put("GTQ","Quetzal Ghuatamala");
    ...
    result.put("HNL","Lempira Hondúras");
    result.put("HRD","Dínear na Cróite");
    result.put("HRK","Kuna na Cróite");
    result.put("HTG","Gourde Háítí");
    result.put("HUF","Forint na hUngáire");
    result.put("IDR","Rupiah na hIndinéise");
    result.put("IEP","Punt Éireannach");
    result.put("ILP","Punt Iosraelach");
    result.put("ILS","Seiceal Nua Iosrael");
    result.put("INR","Rúipí na hIndia");
    result.put("IQD","Dinar na hIaráice");
    result.put("IRR","Rial na hIaráine");
    result.put("ISK","Króna na hÍoslainne");
    result.put("ITL","Lira na hIodáile");
    result.put("JMD","Dollar na hIamáice");
    result.put("JOD","Dinar na hIordáine");
    result.put("JPY","Yen na Seapáine");
    result.put("KES","Scilling na Céinia");
    result.put("KGS","Som na Cirgeastáine");
    result.put("KHR","Riel na Cambóide");
    result.put("KMF","Franc Oileáin Chomóra");
    result.put("KPW","Won na Cóiré Thuaidh");
    result.put("KRW","Won na Cóiré Theas");
    result.put("KWD","Dinar Chuáit");
    result.put("KYD","Dollar Oileáin Cayman");
    result.put("KZT","Tenge na Casacstáine");
    result.put("LAK","Kip Laos");
    result.put("LBP","Punt na Liobáine");
    result.put("LKR","Rúipí Shrí Lanca");
    result.put("LRD","Dollar na Libéire");
    result.put("LSL","Loti Leosóta");
    result.put("LTL","Litas na Liotuáine");
    result.put("LTT","Talonas Liotuánach");
    result.put("LUF","Franc Lucsamburg");
    result.put("LVL","Lats na Laitvia");
    result.put("LYD","Dinar na Libia");
    result.put("MAD","Dirham Mharacó");
    result.put("MAF","Franc Mharacó");
    result.put("MDL","Leu na Moldóive");
    result.put("MGA","Ariary Mhadagascar");
    result.put("MGF","Franc Madagascar");
    result.put("MKD","Denar na Macadóine");
    result.put("MLF","Franc Mhailí");
    result.put("MMK","Kyat Mhaenmar");
    result.put("MNT","Tugrik na Mongóile");
    result.put("MOP","Pataca Mhacao");
    result.put("MRO","Ouguiya na Máratáine (1973–2017)");
    result.put("MRU","Ouguiya na Máratáine");
    result.put("MTL","Lira Mhálta");
    result.put("MTP","Punt Mhálta");
    result.put("MUR","Rúipí Oileán Mhuirís");
    result.put("MVP","Rúipí Oileáin Mhaildíve");
    result.put("MVR","Rufiyaa Oileáin Mhaildíve");
    result.put("MWK","Kwacha na Maláive");
    result.put("MXN","Peso Mheicsiceo");
    result.put("MXP","Peso Airgid Mheicsiceo (1861–1992)");
    result.put("MYR","Ringgit na Malaeisia");
    result.put("MZE","Escudo Mósaimbíce");
    result.put("MZM","Metical Mósaimbíce");
    result.put("MZN","Metical Mhósaimbíc");
    result.put("NAD","Dollar na Namaibe");
    result.put("NGN","Naira na Nigéire");
    result.put("NIC","Córdoba Nicearagua (1988–1991)");
    result.put("NIO","Córdoba Nicearagua");
    result.put("NLG","Guilder Ísiltíreach");
    result.put("NOK","Coróin na hIorua");
    result.put("NPR","Rúipí Neipeal");
    result.put("NZD","Dollar na Nua-Shéalainne");
    result.put("OMR","Rial Óman");
    result.put("PAB","Balboa Phanama");
    result.put("PEI","Inti Pheiriú");
    result.put("PEN","Sol Pheiriú");
    result.put("PES","Sol Pheiriú (1863–1965)");
    result.put("PGK","Kina Nua-Ghuine Phapua");
    result.put("PHP","Peso na nOileán Filipíneach");
    result.put("PKR","Rúipí na Pacastáine");
    result.put("PLN","Zloty na Polainne");
    result.put("PLZ","Zloty Polannach (1950–1995)");
    result.put("PTE","Escudo na Portaingéile");
    result.put("PYG","Guaraní Pharagua");
    result.put("QAR","Riyal Chatar");
    result.put("ROL","Leu na Rómáine (1952–2006)");
    result.put("RON","Leu na Rómáine");
    result.put("RSD","Dinar na Seirbia");
    result.put("RUB","Rúbal na Rúise");
    result.put("RUR","Rúbal na Rúise (1991–1998)");
    result.put("RWF","Franc Ruanda");
    result.put("SAR","Riyal na hAraibe Sádaí");
    result.put("SBD","Dollar Oileáin Sholomón");
    result.put("SCR","Rúipí na Séiséal");
    result.put("SDD","Dinar na Súdáine (1992–2007)");
    result.put("SDG","Punt na Súdáine");
    result.put("SDP","Punt na Súdáine (1957–1998)");
    result.put("SEK","Coróin na Sualainne");
    result.put("SGD","Dollar Shingeapór");
    result.put("SHP","Punt San Héilin");
    result.put("SIT","Tolar na Slóivéine");
    result.put("SKK","Koruna na Slóvaice");
    result.put("SLL","Leone Shiarra Leon");
    result.put("SOS","Scilling na Somáile");
    result.put("SRD","Dollar Shuranam");
    result.put("SRG","Gildear Shuranam");
    result.put("SSP","Punt na Súdáine Theas");
    result.put("STD","Dobra São Tomé agus Príncipe (1977–2017)");
    result.put("STN","Dobra São Tomé agus Príncipe");
    result.put("SUR","Rúbal an Aontais Shóivéadaigh");
    result.put("SVC","Colón na Salvadóire");
    result.put("SYP","Punt na Siria");
    ...
    result.put("TMM","Manat na Tuircméanastáine (1993–2009)");
    result.put("TMT","Manat na Tuircméanastáine");
    result.put("TND","Dinar na Túinéise");
    result.put("TOP","Paʻanga Thonga");
    result.put("TPE","Escudo Tíomóir");
    result.put("TRL","Lira na Tuirce (1922–2005)");
    result.put("TRY","Lira na Tuirce");
    result.put("TTD","Dollar Oileán na Tríonóide agus Tobága");
    result.put("TWD","Dollar Nua na Téaváine");
    result.put("TZS","Scilling na Tansáine");
    result.put("UAH","Hryvnia na hÚcráine");
    result.put("UAK","Karbovanets Úcránach");
    ...
    result.put("USS","Dollar S.A.M. (an lá céanna)");
    result.put("UYP","Peso Uragua (1975–1993)");
    result.put("UYU","Peso Uragua");
    result.put("UZS","Sum na hÚisbéiceastáine");
    result.put("VEB","Bolívar Veiniséala (1871–2008)");
    result.put("VEF","Bolívar Veiniséala (2008–2018)");
    result.put("VES","Bolívar Veiniséala");
    result.put("VND","Dong Vítneam");
    result.put("VNN","Dong Vítneam (1978–1985)");
    result.put("VUV","Vatu Vanuatú");
    result.put("WST","Tala Shamó");
    result.put("XAF","Franc CFA na hAfraice Láir");
    ...
    result.put("XCD","Dollar na Cairibe Thoir");
    ...
    result.put("XOF","Franc CFA Iarthar na hAfraice");
    result.put("XPD","Pallaidiam");
    result.put("XPF","Franc CFP");
    result.put("XPT","Platanam");
    result.put("XXX","Airgeadra Anaithnid");
    result.put("YDD","Dínear Éimin");
    result.put("YER","Rial Éimin");
    result.put("YUD","Dínear Crua Iúgslavach (1966–1990)");
    result.put("YUM","Dínear Nua Iúgslavach (1994–2002)");
    result.put("ZAL","Rand na hAfraice Theas (airgeadúil)");
    result.put("ZAR","Rand na hAfraice Theas");
    result.put("ZMK","Kwacha Saimbiach (1968–2012)");
    result.put("ZMW","Kwacha na Saimbia");
    result.put("ZRN","Zaire Nua Sáíreach");
    result.put("ZRZ","Zaire Sáíreach");
    result.put("ZWD","Dollar Siombábach (1980–2008)");
    return result;
  }
}
