...
public class CurrencyList_gl_ES extends CurrencyList_gl {
  ...
  protected HashMap<String, String> loadNamesMap() {
    ...
    result.put("BDT","Taka de Bangladés");
    ...
    result.put("BWP","Pula botsuaniano");
    ...
    result.put("CHF","Franco suízo");
    result.put("CLF","Unidades de fomento chilenas");
    result.put("CLP","Peso chileno");
    result.put("CNH","Iuán chinés (extracontinental)");
    result.put("CNY","Iuán chinés");
    result.put("COP","Peso colombiano");
    result.put("CRC","Colón costarriqueño");
    ...
    result.put("GHS","Cedi de Ghana");
    result.put("GIP","Libra xibraltareña");
    ...
    result.put("KES","Xilin kenyano");
    result.put("KGS","Som quirguicistano");
    ...
    result.put("MMK","Kyat birmano");
    result.put("MNT","Tugrik mongol");
    result.put("MOP","Pataca de Macau");
    result.put("MRO","Ouguiya mauritano (1973–2017)");
    result.put("MRU","Ouguiya mauritano");
    ...
    result.put("SZL","Lilangeni de Suacilandia");
    result.put("THB","Baht tailandés");
    result.put("TJS","Somoni taxiquistano");
    result.put("TMT","Manat turcomán");
    ...
    result.put("TZS","Xilin tanzano");
    result.put("UAH","Hrivna ucraína");
    result.put("UGX","Xilin ugandés");
    ...
    result.put("VUV","Vatu vanuatiano");
    ...
    result.put("XXX","Moeda descoñecida");
    result.put("YER","Rial iemení");
    result.put("ZAR","Rand surafricano");
