...
public class CurrencyList_gsw_LI extends CurrencyList_gsw {
  ...
  protected HashMap<String, CurrencyData> loadCurrencyMap() {
    ...
    // Europääischi Währigseinheit (XEU)
  ...
  protected HashMap<String, String> loadNamesMap() {
    ...
    result.put("BYN","Belarus Rubel");
    result.put("BYR","Belarus Rubel (2000–2016)");
    result.put("BZD","Belize-Dollar");
    result.put("CAD","Kanadische Dollar");
    result.put("CDF","Kongolesische Franc");
    ...
    result.put("IDR","Indonesischi Rupie");
    ...
    result.put("MRO","Ouguiya (1973–2017)");
    result.put("MRU","Ouguiya");
    ...
    result.put("RUB","Russische Rubel");
    ...
    result.put("SSP","Süüdsudaneesischs Pfund");
    ...
    result.put("VEB","Bolivar (1871–2008)");
    result.put("VEF","Bolivar (2008–2018)");
    result.put("VES","Bolivar");
    result.put("VND","Dong");
    result.put("VUV","Vatu");
    result.put("WST","Tala");
