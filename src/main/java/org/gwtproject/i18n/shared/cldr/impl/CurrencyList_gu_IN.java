...
public class CurrencyList_gu_IN extends CurrencyList_gu {
  ...
  protected HashMap<String, String> loadNamesMap() {
    ...
    result.put("AED","યુનાઈટેડ આરબ અમિરાત દિરહામ");
    ...
    result.put("BYN","બેલારુશિયન રૂબલ");
    result.put("BYR","બેલારુશિયન રૂબલ (2000–2016)");
    ...
    result.put("CNH","ચાઇનીઝ યુઆન (ઑફશોર)");
    ...
    result.put("GTQ","ગ્વાટેમાલા કુઇટ્ઝલ");
    ...
    result.put("IDR","ઇન્ડોનેશિયન રૂપિયા");
    result.put("ILS","ઇઝરાયેલી ન્યુ શેકલ");
    result.put("INR","ભારતીય રૂપિયા");
    result.put("IQD","ઇરાકી દિનાર");
    result.put("IRR","ઇરાનિયન રિયાલ");
    result.put("ISK","આઇસલેન્ડિક ક્રોના");
    result.put("JMD","જમૈકિયન ડોલર");
    result.put("JOD","જોર્ડનિયન દિનાર");
    ...
    result.put("MAD","મોરોક્કન દિરહામ");
    result.put("MDL","મોલડોવેન લિયુ");
    result.put("MGA","માલાગેસી અરીઆરી");
    result.put("MKD","મેસેડોનિયન દિનાર");
    result.put("MMK","મ્યાંમાર ક્યાત");
    result.put("MNT","મોંગોલિયન ટગરિક");
    result.put("MOP","માકાનિઝ પતાકા");
    result.put("MRO","મોરીશેનિયન ઓગુયા (1973–2017)");
    result.put("MRU","મોરીશેનિયન ઓગુયા");
    result.put("MUR","મોરેશીઅન રૂપી");
    ...
    result.put("MZN","મોઝામ્બિકન મેટિકલ");
    result.put("NAD","નામિબિયન ડોલર");
    ...
    result.put("PYG","પરાગ્વેયન ગુઆરાની");
    result.put("QAR","કતારી રિયાલ");
    result.put("RON","રોમાનિયન લેઉ");
    result.put("RSD","સર્બિયન દિનાર");
    result.put("RUB","રશિયન રૂબલ");
    result.put("RWF","રવાંડન ફ્રેંક");
    ...
    result.put("SSP","દક્ષિણ સુદાનિઝ પાઉન્ડ");
    result.put("STD","સાઓ ટૉમ એન્ડ પ્રિંસાઇપ ડોબ્રા (1977–2017)");
    result.put("STN","સાઓ ટૉમ એન્ડ પ્રિંસાઇપ ડોબ્રા");
    result.put("SYP","સાઇરિયન પાઉન્ડ");
    result.put("SZL","સ્વાઝી લિલાન્ગેની");
    result.put("THB","થાઇ બાહ્ત");
    result.put("TJS","તાજિકિસ્તાની સોમોની");
    result.put("TMT","તુર્કમેનિસ્તાની મનત");
    result.put("TND","ટ્યુનિશિયન દિનાર");
    result.put("TOP","ટોંગન પ’અંગા");
    result.put("TRY","તુર્કિશ લિરા");
    result.put("TTD","ત્રિનિદાદ અને ટોબેગો ડોલર");
    result.put("TWD","ન્યુ તાઇવાન ડૉલર");
    result.put("TZS","તાન્ઝાનિયન શિલિંગ");
    result.put("UAH","યુક્રેનિયન હ્રિવિનિયા");
    result.put("UGX","યુગાંડન શિલિંગ");
    result.put("USD","યુઍસ ડોલર");
    result.put("UYU","ઉરુગ્વેયન પેસો");
    result.put("UZS","ઉઝ્બેકિસ્તાન સોમ");
    result.put("VEF","વેનેઝુએલન બોલિવર (2008–2018)");
    result.put("VES","વેનેઝુએલન બોલિવર");
    result.put("VND","વિયેતનામીસ ડોંગ");
    result.put("VUV","વનૌતુ વાતુ");
    result.put("WST","સમોઅન તાલા");
    result.put("XAF","મધ્ય આફ્રિકન [CFA] ફ્રેંક");
    result.put("XCD","ઇસ્ટ કેરિબિયન ડોલર");
    result.put("XOF","પશ્ચિમી આફ્રિકન [CFA] ફ્રેંક");
    result.put("XPF","[CFP] ફ્રેંક");
    result.put("XXX","અજ્ઞાત ચલણ");
    result.put("YER","યેમેની રિઆલ");
    result.put("ZAR","દક્ષિણ આફ્રિકી રેંડ");
    result.put("ZMK","ઝામ્બિયન ક્વાચા (1968–2012)");
    result.put("ZMW","ઝામ્બિયન ક્વાચા");
    return result;
  }
}
