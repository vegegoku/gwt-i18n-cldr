...
public class CurrencyList_ha_GH extends CurrencyList_ha {
  ...
  protected HashMap<String, String> loadNamesMap() {
    ...
    result.put("AED","Kuɗin Haɗaɗɗiyar Daular Larabawa");
    result.put("AOA","Kuɗin Angola");
    result.put("AUD","Dalar Ostareliya");
    result.put("BHD","Kuɗin Baharan");
    result.put("BIF","Kuɗin Burundi");
    result.put("BWP","Kuɗin Baswana");
    result.put("CAD","Dalar Kanada");
    result.put("CDF","Kuɗin Kongo");
    result.put("CHF","Kuɗin Suwizalan");
    result.put("CNY","Kuɗin Caina/Sin");
    result.put("CVE","Kuɗin Tsibiran Kap Barde");
    result.put("DJF","Kuɗin Jibuti");
    result.put("DZD","Kuɗin Aljeriya");
    result.put("EGP","Fam kin Masar");
    result.put("ERN","Kuɗin Eritireya");
    result.put("ETB","Kuɗin Habasha");
    result.put("EUR","Yuro");
    result.put("GBP","Fam kin Ingila");
    result.put("GHC","Cedi");
    result.put("GMD","Kuɗin Gambiya");
    result.put("GNS","Kuɗin Gini");
    result.put("INR","Kuɗin Indiya");
    result.put("JPY","Kuɗin Japan");
    result.put("KES","Sulen Kenya");
    result.put("KMF","Kuɗin Kwamoras");
    result.put("LRD","Dalar Laberiya");
    result.put("LSL","Kuɗin Lesoto");
    result.put("LYD","Kuɗin Libiya");
    result.put("MAD","Kuɗin Maroko");
    result.put("MGA","Kuɗin Madagaskar");
    result.put("MRO","Kuɗin Moritaniya (1973–2017)");
    result.put("MRU","Kuɗin Moritaniya");
    result.put("MUR","Kuɗin Moritus");
    result.put("MWK","Kuɗin Malawi");
    result.put("MZM","Kuɗin Mozambik");
    result.put("NAD","Dalar Namibiya");
    result.put("NGN","Naira");
    result.put("RWF","Kuɗin Ruwanda");
    result.put("SAR","Riyal");
    result.put("SCR","Kuɗin Saishal");
    result.put("SDG","Fam kin Sudan");
    result.put("SHP","Fam kin San Helena");
    result.put("SLL","Kuɗin Salewo");
    result.put("SOS","Sulen Somaliya");
    result.put("STD","Kuɗin Sawo Tome da Paransip (1977–2017)");
    result.put("STN","Kuɗin Sawo Tome da Paransip");
    result.put("SZL","Kuɗin Lilangeni");
    result.put("TND","Kuɗin Tunisiya");
    result.put("TZS","Sulen Tanzaniya");
    result.put("UGX","Sule Yuganda");
    result.put("USD","Dalar Amurka");
    result.put("XAF","Kuɗin Sefa na Afirka Ta Tsakiya");
    result.put("XOF","Kuɗin Sefa na Afirka Ta Yamma");
    result.put("ZAR","Kuɗin Afirka Ta Kudu");
    result.put("ZMK","Kuɗin Zambiya (1968–2012)");
    result.put("ZMW","Kuɗin Zambiya");
    result.put("ZWD","Dalar zimbabuwe");
    return result;
  }
}
