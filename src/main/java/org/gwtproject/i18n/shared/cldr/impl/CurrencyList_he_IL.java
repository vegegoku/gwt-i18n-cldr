...
public class CurrencyList_he_IL extends CurrencyList_he {
  public CurrencyData getDefault() {
    return new CurrencyDataImpl("ILS","₪",2,"₪","₪");
  }
  ...
  protected HashMap<String, String> loadNamesMap() {
    ...
    result.put("ANG","גילדר של האנטילים ההולנדיים");
    ...
    result.put("AZN","מאנאט אזרבייג׳ני");
    result.put("BAD","דינר של בוסניה־הרצגובינה");
    result.put("BAM","מארק סחיר של בוסניה והרצגובינה");
    ...
    result.put("BWP","פולה בוטסואני");
    result.put("BYN","רובל בלרוסי");
    result.put("BYR","רובל בלרוסי (2000–2016)");
    result.put("BZD","דולר בליזי");
    result.put("CAD","דולר קנדי");
    result.put("CDF","פרנק קונגולזי");
    result.put("CHF","פרנק שוויצרי");
    result.put("CLP","פסו צ׳ילאני");
    result.put("CNH","יואן סיני (CNH)");
    result.put("CNY","יואן סיני");
    result.put("COP","פסו קולומביאני");
    ...
    result.put("PYG","גוארני פרגוואי");
    result.put("QAR","ריאל קטארי");
    result.put("ROL","לאו רומני ישן");
    result.put("RON","לאו רומני");
    result.put("RSD","דינר סרבי");
    result.put("RUB","רובל רוסי");
    ...
    result.put("UYU","פסו אורוגוואי");
    result.put("UZS","סום אוזבקי");
    result.put("VEB","בוליבר ונצואלי (1871–2008)");
    result.put("VEF","בוליבר ונצואלי (2008–2018)");
    result.put("VES","בוליבר ונצואלי");
    result.put("VND","דונג וייטנאמי");
    result.put("VUV","ואטו של ונואטו");
    result.put("WST","טאלה סמואי");
    result.put("XAF","פרנק CFA מרכז אפריקני");
    result.put("XAG","כסף");
    result.put("XAU","זהב");
    result.put("XCD","דולר מזרח קריבי");
    result.put("XDR","זכויות משיכה מיוחדות");
    result.put("XFO","פרנק זהב");
    result.put("XOF","פרנק CFA מערב אפריקני");
    result.put("XPD","פלדיום");
    result.put("XPF","פרנק פולינזיה הצרפתית");
    ...
    result.put("ZMK","קוואצ׳ה זמבית (1968–2012)");
    result.put("ZMW","קוואצ׳ה זמבי");
