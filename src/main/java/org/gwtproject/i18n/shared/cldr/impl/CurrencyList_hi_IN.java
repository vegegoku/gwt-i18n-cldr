...
public class CurrencyList_hi_IN extends CurrencyList_hi {
  ...
  protected HashMap<String, CurrencyData> loadCurrencyMap() {
    ...
    // जॉर्जियन लारी
    result.put("GEL", new CurrencyDataImpl("GEL","ლ",2,"ლ","ლ"));
    // GHC
  ...
  protected HashMap<String, String> loadNamesMap() {
    ...
    result.put("AED","संयुक्त अरब अमीरात दिरहाम");
    result.put("AFA","अफगानी (1927–2002)");
    result.put("AFN","अफ़गान अफ़गानी");
    result.put("ALL","अल्बानियाई लेक");
    result.put("AMD","आर्मेनियाई द्राम");
    result.put("ANG","नीदरलैंड एंटीलियन गिल्डर");
    result.put("AOA","अंगोला क्वांज़ा");
    result.put("ARS","अर्जेंटीनी पेसो");
    result.put("AUD","ऑस्ट्रेलियाई डॉलर");
    result.put("AWG","अरूबाई फ़्लोरिन");
    result.put("AZN","अज़रबैजानी मैनेट");
    result.put("BAM","बोस्निया हर्ज़ेगोविना परिवर्तनीय मार्क");
    result.put("BBD","बार्बेडियन डॉलर");
    result.put("BDT","बांग्लादेशी टका");
    result.put("BGN","बुल्गारियाई लेव");
    result.put("BHD","बहरीनी दिनार");
    result.put("BIF","बुरूंडी फ़्रैंक");
    result.put("BMD","बरमूडा डॉलर");
    result.put("BND","ब्रूनेई डॉलर");
    result.put("BOB","बोलिवियाई बोलिवियानो");
    result.put("BRL","ब्राज़ीली रियाल");
    result.put("BSD","बहामाई डॉलर");
    result.put("BTN","भूटानी नंगलट्रम");
    result.put("BWP","बोत्सवानियाई पुला");
    result.put("BYN","बेलारूसी रूबल");
    result.put("BYR","बेलारूसी रूबल (2000–2016)");
    result.put("BZD","बेलीज़ डॉलर");
    result.put("CAD","कनाडाई डॉलर");
    result.put("CDF","कोंगोली फ़्रैंक");
    result.put("CHF","स्विस फ़्रैंक");
    result.put("CLP","चिली पेसो");
    result.put("CNH","चीनी यूआन");
    result.put("CNY","चीनी युआन");
    result.put("COP","कोलंबियाई पेसो");
    result.put("CRC","कोस्टा रिका कोलोन");
    result.put("CSD","सर्बिय का ढीनार");
    result.put("CUC","क्यूबाई परिवर्तनीय पेसो");
    result.put("CUP","क्यूबाई पेसो");
    result.put("CVE","केप वर्ड एस्कूडो");
    result.put("CYP","साईप्रस पाऊंड");
    result.put("CZK","चेक गणराज्य कोरुना");
    result.put("DEM","डच मार्क");
    result.put("DJF","जिबूती फ़्रैंक");
    result.put("DKK","डैनिश क्रोन");
    result.put("DOP","डोमिनिकन पेसो");
    result.put("DZD","अल्जीरियाई दिनार");
    result.put("EEK","एस्टोनियाई क्रून्");
    result.put("EGP","मिस्र पाउंड");
    result.put("ERN","इरीट्रियन नाक्फ़ा");
    result.put("ETB","इथियोपियन बिर");
    result.put("EUR","यूरो");
    result.put("FJD","फ़िजी डॉलर");
    result.put("FKP","फ़ॉकलैंड द्वीपसमूह पाउंड");
    result.put("FRF","फ़्रांसीसी फ़्रैंक");
    result.put("GBP","ब्रिटिश पाउंड स्टर्लिंग");
    result.put("GEL","जॉर्जियन लारी");
    result.put("GHS","घानियन सेडी");
    result.put("GIP","जिब्राल्टर पाउंड");
    result.put("GMD","गैंबियन डलासी");
    result.put("GNF","गिनीयन फ़्रैंक");
    result.put("GTQ","ग्वाटेमाला क्वेटज़ल");
    result.put("GYD","गयानीज़ डॉलर");
    result.put("HKD","हाँगकाँग डॉलर");
    result.put("HNL","होंडुरन लेम्पिरा");
    result.put("HRD","क्रोएशियन दिनार");
    result.put("HRK","क्रोएशियाई कुना");
    result.put("HTG","हैतियाई गर्ड");
    result.put("HUF","हंगेरियन फ़ोरिंट");
    result.put("IDR","इंडोनेशियाई रुपिया");
    result.put("ILS","इज़राइली न्यू शेकेल");
    result.put("INR","भारतीय रुपया");
    result.put("IQD","इराकी दिनार");
    result.put("IRR","ईरानी रियाल");
    result.put("ISK","आइसलैंडिक क्रोना");
    result.put("ITL","इतली का लीरा");
    result.put("JMD","जमैकन डॉलर");
    result.put("JOD","जॉर्डनियन दिनार");
    result.put("JPY","जापानी येन");
    result.put("KES","केन्याई शिलिंग");
    result.put("KGS","किर्गिस्तानी सोम");
    result.put("KHR","कंबोडियाई रियाल");
    result.put("KMF","कोमोरियन फ़्रैंक");
    result.put("KPW","उत्तर कोरियाई वॉन");
    result.put("KRW","दक्षिण कोरियाई वॉन");
    result.put("KWD","कुवैती दिनार");
    result.put("KYD","कैमेन द्वीपसमूह डॉलर");
    result.put("KZT","कज़ाखिस्तानी टेंज़");
    result.put("LAK","लाओशियन किप");
    result.put("LBP","लेबनानी पाउंड");
    result.put("LKR","श्रीलंकाई रुपया");
    result.put("LRD","लाइबेरियाई डॉलर");
    result.put("LSL","लेसोथो लोटी");
    result.put("LTL","लिथुआनियाई लितास");
    result.put("LVL","लात्वियन लैत्स");
    result.put("LYD","लीबियाई दिनार");
    result.put("MAD","मोरक्को दिरहम");
    result.put("MAF","मोरक्को फ्रैंक");
    result.put("MDL","मोल्डोवन लियू");
    result.put("MGA","मालागासी आरियरी");
    result.put("MKD","मैसीडोनियन दिनार");
    result.put("MMK","म्यांमार क्याट");
    result.put("MNT","मंगोलियाई टगरिक");
    result.put("MOP","मेकानीज़ पाटाका");
    result.put("MRO","मॉरीटेनियन ओगुइया (1973–2017)");
    result.put("MRU","मॉरीटेनियन ओगुइया");
    result.put("MUR","मॉरिशियन रुपया");
    result.put("MVR","मालदीवी रुफ़िया");
    result.put("MWK","मालावियन क्वाचा");
    result.put("MXN","मैक्सिकन पेसो");
    result.put("MYR","मलेशियाई रिंगित");
    result.put("MZN","मोज़ाम्बिकन मेटिकल");
    result.put("NAD","नामीबियाई डॉलर");
    result.put("NGN","नाइजीरियाई नाइरा");
    result.put("NIO","निकारागुअन कोरडोबा");
    result.put("NOK","नॉर्वेजियन क्रोन");
    result.put("NPR","नेपाली रुपया");
    result.put("NZD","न्यूज़ीलैंड डॉलर");
    result.put("OMR","ओमानी रियाल");
    result.put("PAB","पनामेनियन बैल्बोआ");
    result.put("PEN","पेरूवियन सोल");
    result.put("PGK","पापुआ न्यू गिनीयन किना");
    result.put("PHP","फ़िलिपीनी पेसो");
    result.put("PKR","पाकिस्तानी रुपया");
    result.put("PLN","पोलिश ज़्लॉटी");
    result.put("PYG","पैराग्वियन गुआरानी");
    result.put("QAR","क़तरी रियाल");
    result.put("RHD","रोडेशियाई डालर");
    result.put("RON","रोमानियाई ल्यू");
    result.put("RSD","सर्बियन दिनार");
    result.put("RUB","रूसी रूबल");
    result.put("RWF","रवांडाई फ़्रैंक");
    result.put("SAR","सउदी रियाल");
    result.put("SBD","सोलोमन द्वीपसमूह डॉलर");
    result.put("SCR","सेशेल्सियाई रुपया");
    result.put("SDD","पुरानी सूडानी दिनार");
    result.put("SDG","सूडानी पाउंड");
    result.put("SDP","पुराना सूडानी पाउंड");
    result.put("SEK","स्वीडीश क्रोना");
    result.put("SGD","सिंगापुर डॉलर");
    result.put("SHP","सेंट हेलेना पाउंड");
    result.put("SIT","स्लोवेनियाई तोलार");
    result.put("SKK","स्लोवाक कोरुना");
    result.put("SLL","सिएरा लियोनियन लियोन");
    result.put("SOS","सोमाली शिलिंग");
    result.put("SRD","सूरीनामी डॉलर");
    result.put("SRG","सूरीनामी गिल्डर");
    result.put("SSP","दक्षिण सूडानी पाउंड");
    result.put("STD","साओ तोम और प्रिंसिपे डोबरा (1977–2017)");
    result.put("STN","साओ टोम और प्रिंसिपे डोबरा");
    result.put("SUR","सोवियत रूबल");
    result.put("SYP","सीरियाई पाउंड");
    result.put("SZL","स्वाज़ी लिलांजेनी");
    result.put("THB","थाई बहत");
    result.put("TJR","तजाखी रूबल");
    result.put("TJS","ताजिकिस्तानी सोमोनी");
    result.put("TMT","तुर्कमेनिस्तानी मैनत");
    result.put("TND","ट्यूनीशियाई दिनार");
    result.put("TOP","टोंगन पांगा");
    result.put("TRL","पुरानी तुर्की लीरा");
    result.put("TRY","तुर्की लीरा");
    result.put("TTD","त्रिनिदाद और टोबैगो डॉलर");
    result.put("TWD","नया ताईवानी डॉलर");
    result.put("TZS","तंज़ानियाई शिलिंग");
    result.put("UAH","यूक्रेनियन रिव्निया");
    result.put("UGX","युगांडाई शिलिंग");
    result.put("USD","यूएस डॉलर");
    result.put("USN","अमेरीकी डालर (कल)");
    result.put("USS","अमेरीकी डालर (आज)");
    result.put("UYU","उरुग्वियन पेसो");
    result.put("UZS","उज़्बेकिस्तान सोम");
    result.put("VEB","वेनेज़ुएला बोलिवर (1871–2008)");
    result.put("VEF","वेनेज़ुएला बोलिवर (2008–2018)");
    result.put("VES","वेनेज़ुएला बोलिवर");
    result.put("VND","वियतनामी डोंग");
    result.put("VUV","वनुआतू वातू");
    result.put("WST","समोआई ताला");
    result.put("XAF","केंद्रीय अफ़्रीकी CFA फ़्रैंक");
    result.put("XCD","पूर्वी कैरिबियाई डॉलर");
    result.put("XOF","पश्चिमी अफ़्रीकी CFA फ़्रैंक");
    result.put("XPF","[CFP] फ़्रैंक");
    result.put("XXX","अज्ञात मुद्रा");
    result.put("YER","यमनी रियाल");
    result.put("ZAR","दक्षिण अफ़्रीकी रैंड");
    result.put("ZMK","ज़ाम्बियन क्वाचा (1968–2012)");
    result.put("ZMW","ज़ाम्बियन क्वाचा");
    return result;
  }
}
