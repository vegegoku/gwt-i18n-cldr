...
public class CurrencyList_hr_HR extends CurrencyList_hr {
  public CurrencyData getDefault() {
    return new CurrencyDataImpl("HRK","HRK",2,"HRK","HRK");
  }
  ...
  protected HashMap<String, String> loadNamesMap() {
    ...
    result.put("ALK","stari albanski lek");
    ...
    result.put("ARL","argentinski pezo lej (1970.–1983.)");
    result.put("ARM","argentinski pezo (1881.–1970.)");
    ...
    result.put("CNH","kineski juan (offshore)");
    ...
    result.put("MRO","mauritanijska ouguja (1973. – 2017.)");
    result.put("MRU","mauritanijska ouguja");
    result.put("MTL","malteška lira");
    result.put("MTP","malteška funta");
    result.put("MUR","mauricijska rupija");
    result.put("MVP","maldivijska rupija");
    ...
    result.put("STD","dobra Svetog Tome i Principa (1977–2017)");
    result.put("STN","dobra Svetog Tome i Principa");
    ...
    result.put("VEF","venezuelanski bolivar (2008. – 2018.)");
    result.put("VES","venezuelanski bolivar");
    ...
    result.put("XSU","sukre");
    result.put("XTS","ispitni kod valute");
    result.put("XUA","obračunska jedinica ADB");
    ...
    result.put("YUR","jugoslavenski reformirani dinar");
