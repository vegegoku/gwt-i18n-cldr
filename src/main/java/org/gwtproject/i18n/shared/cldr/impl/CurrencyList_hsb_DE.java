...
public class CurrencyList_hsb_DE extends CurrencyList_hsb {
  ...
  protected HashMap<String, String> loadNamesMap() {
    ...
    result.put("AFN","afghaniski afghani");
    ...
    result.put("ATS","awstriski šiling");
    result.put("AUD","awstralski dolar");
    result.put("AWG","aruba-florin");
    result.put("AZM","azerbajdźanski manat (1993–2006)");
    result.put("AZN","azerbajdźanski manat");
    result.put("BAD","bosniski dinar");
    result.put("BAM","bosniska konwertibelna hriwna");
    ...
    result.put("BEL","belgiski finančny frank");
    result.put("BGL","bołharski lew (1962–1999)");
    result.put("BGN","bołharski lew");
    ...
    result.put("BTN","bhutanski ngultrum");
    result.put("BUK","burmaski kyat");
    result.put("BWP","botswanska pula");
    ...
    result.put("CRC","kosta-rikaski colón");
    result.put("CUC","kubaski konwertibelny peso");
    result.put("CUP","kubaski peso");
    result.put("CVE","kapverdski escudo");
    result.put("CZK","čěska króna");
    result.put("DJF","dźibutiski frank");
    result.put("DKK","danska króna");
    result.put("DOP","dominikanski peso");
    result.put("DZD","algeriski dinar");
    result.put("EGP","egyptowski punt");
    ...
    result.put("GIP","gibraltarski punt");
    result.put("GMD","gambiski dalasi");
    result.put("GNF","ginejski frank");
    result.put("GTQ","guatemalski quetzal");
    result.put("GWP","ginejsko-bissauski peso");
    result.put("GYD","guyanski dolar");
    ...
    result.put("LBP","libanonski punt");
    ...
    result.put("MOP","macaoska pataka");
    result.put("MRO","mawretanska ouguiya (1973–2017)");
    result.put("MRU","mawretanska ouguiya");
    result.put("MUR","mauritiuska rupija");
    ...
    result.put("MZE","mosambikski escudo");
    result.put("MZM","mosambikski metical (1980–2006)");
    result.put("MZN","mosambikski metical");
    result.put("NAD","namibiski dolar");
    result.put("NGN","nigeriski naira");
    result.put("NIO","nikaraguaski cordoba");
    result.put("NOK","norwegska króna");
    ...
    result.put("PGK","papua-nowoginejski kina");
    ...
    result.put("SAR","saudi-arabski rial");
    result.put("SBD","salomonski dolar");
    result.put("SCR","seychellska rupija");
    result.put("SDG","sudanski punt");
    result.put("SEK","šwedska króna");
    result.put("SGD","singapurski dolar");
    result.put("SHP","St. Helenski punt");
    result.put("SLL","sierra-leoneski leone");
    result.put("SOS","somaliski šiling");
    result.put("SRD","surinamski dolar");
    result.put("SSP","južnosudanski punt");
    result.put("STD","são tomeski dobra (1977–2017)");
    result.put("STN","são tomeski dobra");
