...
public class CurrencyList_hu_HU extends CurrencyList_hu {
  public CurrencyData getDefault() {
    return new CurrencyDataImpl("HUF","Ft",2,"Ft","Ft");
  }
  ...
  protected HashMap<String, CurrencyData> loadCurrencyMap() {
    ...
    // ausztrál dollár
    result.put("AUD", new CurrencyDataImpl("AUD","AUD",2,"AUD","AUD"));
    // arubai florin
    ...
    // brazil real
    result.put("BRL", new CurrencyDataImpl("BRL","BRL",2,"BRL","BRL"));
    ...
    // kanadai dollár
    result.put("CAD", new CurrencyDataImpl("CAD","CAD",2,"CAD","CAD"));
    // kongói frank
    ...
    // euró
    result.put("EUR", new CurrencyDataImpl("EUR","EUR",2,"EUR","EUR"));
    // Finn markka
    ...
    // angol font
    result.put("GBP", new CurrencyDataImpl("GBP","GBP",2,"GBP","GBP"));
    // Grúz kupon larit
    ...
    // magyar forint
    result.put("HUF", new CurrencyDataImpl("HUF","Ft",2,"Ft","Ft"));
    // indonéz rúpia
    ...
    // izraeli új sékel
    result.put("ILS", new CurrencyDataImpl("ILS","ILS",2,"ILS","ILS"));
    // indiai rúpia
    result.put("INR", new CurrencyDataImpl("INR","INR",2,"INR","INR"));
    // iraki dínár
    ...
    // dél-koreai won
    result.put("KRW", new CurrencyDataImpl("KRW","KRW",0,"KRW","KRW"));
    // kuvaiti dínár
    ...
    // mexikói peso
    result.put("MXN", new CurrencyDataImpl("MXN","MXN",2,"MXN","MXN"));
    ...
    // új-zélandi dollár
    result.put("NZD", new CurrencyDataImpl("NZD","NZD",2,"NZD","NZD"));
    // ománi rial
    ...
    // USA-dollár
    result.put("USD", new CurrencyDataImpl("USD","USD",2,"USD","USD"));
    ...
    // vietnami dong
    result.put("VND", new CurrencyDataImpl("VND","VND",0,"VND","VND"));
    // VNN
  ...
  protected HashMap<String, String> loadNamesMap() {
    ...
    result.put("ADP","Andorrai peseta");
    result.put("AED","EAE-dirham");
    result.put("AFA","afgán afghani (1927–2002)");
    result.put("AFN","afgán afghani");
    result.put("ALL","albán lek");
    result.put("AMD","örmény dram");
    result.put("ANG","holland antilláki forint");
    result.put("AOA","angolai kwanza");
    result.put("AOK","Angolai kwanza (1977–1990)");
    result.put("AON","Angolai új kwanza (1990–2000)");
    result.put("AOR","Angolai kwanza reajustado (1995–1999)");
    result.put("ARA","Argentín austral");
    result.put("ARP","Argentín peso (1983–1985)");
    result.put("ARS","argentin peso");
    result.put("ATS","Osztrák schilling");
    result.put("AUD","ausztrál dollár");
    result.put("AWG","arubai florin");
    result.put("AZM","azerbajdzsáni manat (1993–2006)");
    result.put("AZN","azerbajdzsáni manat");
    result.put("BAD","Bosznia-hercegovinai dínár (1992–1994)");
    result.put("BAM","bosznia-hercegovinai konvertibilis márka");
    result.put("BBD","barbadosi dollár");
    result.put("BDT","bangladesi taka");
    result.put("BEC","Belga frank (konvertibilis)");
    result.put("BEF","Belga frank");
    result.put("BEL","Belga frank (pénzügyi)");
    result.put("BGL","Bolgár kemény leva");
    result.put("BGN","bolgár új leva");
    result.put("BHD","bahreini dinár");
    result.put("BIF","burundi frank");
    result.put("BMD","bermudai dollár");
    result.put("BND","brunei dollár");
    result.put("BOB","bolíviai boliviano");
    result.put("BOP","Bolíviai peso");
    result.put("BOV","Bolíviai mvdol");
    result.put("BRB","Brazi cruzeiro novo (1967–1986)");
    result.put("BRC","Brazi cruzado (1986–1989)");
    result.put("BRE","Brazil cruzeiro (1990–1993)");
    result.put("BRL","brazil real");
    result.put("BRN","Brazil cruzado novo (1989–1990)");
    result.put("BRR","Brazil cruzeiro (1993–1994)");
    result.put("BSD","bahamai dollár");
    result.put("BTN","bhutáni ngultrum");
    result.put("BUK","Burmai kyat");
    result.put("BWP","botswanai pula");
    result.put("BYB","Fehérorosz új rubel (1994–1999)");
    result.put("BYN","fehérorosz rubel");
    result.put("BYR","fehérorosz rubel (2000–2016)");
    result.put("BZD","belize-i dollár");
    result.put("CAD","kanadai dollár");
    result.put("CDF","kongói frank");
    result.put("CHE","WIR euro");
    result.put("CHF","svájci frank");
    result.put("CHW","WIR frank");
    result.put("CLF","Chilei unidades de fomento");
    result.put("CLP","chilei peso");
    result.put("CNH","kínai jüan (offshore)");
    result.put("CNY","kínai jüan");
    result.put("COP","kolumbiai peso");
    result.put("COU","Unidad de Valor Real");
    result.put("CRC","Costa Rica-i colon");
    result.put("CSD","szerb dinár");
    result.put("CSK","Csehszlovák kemény korona");
    result.put("CUC","kubai konvertibilis peso");
    result.put("CUP","kubai peso");
    result.put("CVE","Cape Verde-i escudo");
    result.put("CYP","Ciprusi font");
    result.put("CZK","cseh korona");
    result.put("DDM","Kelet-Német márka");
    result.put("DEM","Német márka");
    result.put("DJF","dzsibuti frank");
    result.put("DKK","dán korona");
    result.put("DOP","dominikai peso");
    result.put("DZD","algériai dínár");
    result.put("ECS","Ecuadori sucre");
    result.put("ECV","Ecuadori Unidad de Valor Constante (UVC)");
    result.put("EEK","Észt korona");
    result.put("EGP","egyiptomi font");
    result.put("ERN","eritreai nakfa");
    result.put("ESA","spanyol peseta (A–kontó)");
    result.put("ESB","spanyol peseta (konvertibilis kontó)");
    result.put("ESP","Spanyol peseta");
    result.put("ETB","etiópiai birr");
    result.put("EUR","euró");
    result.put("FIM","Finn markka");
    result.put("FJD","fidzsi dollár");
    result.put("FKP","falkland-szigeteki font");
    result.put("FRF","Francia frank");
    result.put("GBP","angol font");
    result.put("GEK","Grúz kupon larit");
    result.put("GEL","grúz lari");
    result.put("GHC","Ghánai cedi (1979–2007)");
    result.put("GHS","ghánai cedi");
    result.put("GIP","gibraltári font");
    result.put("GMD","gambiai dalasi");
    result.put("GNF","guineai frank");
    result.put("GNS","Guineai syli");
    result.put("GQE","Egyenlítői-guineai ekwele guineana");
    result.put("GRD","Görög drachma");
    result.put("GTQ","guatemalai quetzal");
    result.put("GWE","Portugál guinea escudo");
    result.put("GWP","Guinea-Bissaui peso");
    result.put("GYD","guyanai dollár");
    result.put("HKD","hongkongi dollár");
    result.put("HNL","hodurasi lempira");
    result.put("HRD","Horvát dínár");
    result.put("HRK","horvát kuna");
    result.put("HTG","haiti gourde");
    result.put("HUF","magyar forint");
    result.put("IDR","indonéz rúpia");
    result.put("IEP","Ír font");
    result.put("ILP","Izraeli font");
    result.put("ILS","izraeli új sékel");
    result.put("INR","indiai rúpia");
    result.put("IQD","iraki dínár");
    result.put("IRR","iráni rial");
    result.put("ISK","izlandi korona");
    result.put("ITL","Olasz líra");
    result.put("JMD","jamaicai dollár");
    result.put("JOD","jordániai dínár");
    result.put("JPY","japán jen");
    result.put("KES","kenyai shilling");
    result.put("KGS","kirgizisztáni szom");
    result.put("KHR","kambodzsai riel");
    result.put("KMF","comorei frank");
    result.put("KPW","észak-koreai won");
    result.put("KRW","dél-koreai won");
    result.put("KWD","kuvaiti dínár");
    result.put("KYD","kajmán-szigeteki dollár");
    result.put("KZT","kazahsztáni tenge");
    result.put("LAK","laoszi kip");
    result.put("LBP","libanoni font");
    result.put("LKR","Srí Lanka-i rúpia");
    result.put("LRD","libériai dollár");
    result.put("LSL","Lesothoi loti");
    result.put("LTL","litvániai litas");
    result.put("LTT","Litvániai talonas");
    result.put("LUC","luxemburgi konvertibilis frank");
    result.put("LUF","Luxemburgi frank");
    result.put("LUL","luxemburgi pénzügyi frank");
    result.put("LVL","lett lats");
    result.put("LVR","Lett rubel");
    result.put("LYD","líbiai dínár");
    result.put("MAD","marokkói dirham");
    result.put("MAF","Marokkói frank");
    result.put("MDL","moldován lei");
    result.put("MGA","madagaszkári ariary");
    result.put("MGF","Madagaszkári frank");
    result.put("MKD","macedon dínár");
    result.put("MLF","Mali frank");
    result.put("MMK","mianmari kyat");
    result.put("MNT","mongóliai tugrik");
    result.put("MOP","makaói pataca");
    result.put("MRO","mauritániai ouguiya (1973–2017)");
    result.put("MRU","mauritániai ouguiya");
    result.put("MTL","Máltai líra");
    result.put("MTP","Máltai font");
    result.put("MUR","mauritiusi rúpia");
    result.put("MVR","maldív-szigeteki rufiyaa");
    result.put("MWK","malawi kwacha");
    result.put("MXN","mexikói peso");
    result.put("MXP","Mexikói ezüst peso (1861–1992)");
    result.put("MXV","Mexikói Unidad de Inversion (UDI)");
    result.put("MYR","malajziai ringgit");
    result.put("MZE","Mozambik escudo");
    result.put("MZM","Mozambik metical");
    result.put("MZN","mozambiki metikális");
    result.put("NAD","namíbiai dollár");
    result.put("NGN","nigériai naira");
    result.put("NIC","Nikaraguai cordoba");
    result.put("NIO","nicaraguai córdoba");
    result.put("NLG","Holland forint");
    result.put("NOK","norvég korona");
    result.put("NPR","nepáli rúpia");
    result.put("NZD","új-zélandi dollár");
    result.put("OMR","ománi rial");
    result.put("PAB","panamai balboa");
    result.put("PEI","perui inti");
    result.put("PEN","perui sol");
    result.put("PES","perui sol (1863–1965)");
    result.put("PGK","pápua új-guineai kina");
    result.put("PHP","fülöp-szigeteki peso");
    result.put("PKR","pakisztáni rúpia");
    result.put("PLN","lengyel zloty");
    result.put("PLZ","Lengyel zloty (1950–1995)");
    result.put("PTE","Portugál escudo");
    result.put("PYG","paraguayi guarani");
    result.put("QAR","katari rial");
    result.put("RHD","rhodéziai dollár");
    result.put("ROL","román lej (1952–2006)");
    result.put("RON","román lej");
    result.put("RSD","szerb dínár");
    result.put("RUB","orosz rubel");
    result.put("RUR","orosz rubel (1991–1998)");
    result.put("RWF","ruandai frank");
    result.put("SAR","szaúdi riyal");
    result.put("SBD","salamon-szigeteki dollár");
    result.put("SCR","seychelle-szigeteki rúpia");
    result.put("SDD","Szudáni dínár (1992–2007)");
    result.put("SDG","szudáni font");
    result.put("SDP","Szudáni font (1957–1998)");
    result.put("SEK","svéd korona");
    result.put("SGD","szingapúri dollár");
    result.put("SHP","Szent Ilona-i font");
    result.put("SIT","Szlovén tolar");
    result.put("SKK","Szlovák korona");
    result.put("SLL","Sierra Leone-i leone");
    result.put("SOS","szomáli shilling");
    result.put("SRD","suriname-i dollár");
    result.put("SRG","Suriname-i gulden");
    result.put("SSP","dél-szudáni font");
    result.put("STD","São Tomé és Príncipe-i dobra (1977–2017)");
    result.put("STN","São Tomé és Príncipe-i dobra");
    result.put("SUR","Szovjet rubel");
    result.put("SVC","Salvadori colón");
    result.put("SYP","szíriai font");
    result.put("SZL","szváziföldi lilangeni");
    result.put("THB","thai baht");
    result.put("TJR","Tádzsikisztáni rubel");
    result.put("TJS","tádzsikisztáni somoni");
    result.put("TMM","türkmenisztáni manat (1993–2009)");
    result.put("TMT","türkmenisztáni manat");
    result.put("TND","tunéziai dínár");
    result.put("TOP","tongai paanga");
    result.put("TPE","Timori escudo");
    result.put("TRL","török líra (1922–2005)");
    result.put("TRY","török líra");
    result.put("TTD","Trinidad és Tobago-i dollár");
    result.put("TWD","tajvani új dollár");
    result.put("TZS","tanzániai shilling");
    result.put("UAH","ukrán hrivnya");
    result.put("UAK","Ukrán karbovanec");
    result.put("UGS","Ugandai shilling (1966–1987)");
    result.put("UGX","ugandai shilling");
    result.put("USD","USA-dollár");
    result.put("USN","USA dollár (következő napi)");
    result.put("USS","USA dollár (aznapi)");
    result.put("UYI","Uruguayi peso en unidades indexadas");
    result.put("UYP","Uruguay-i peso (1975–1993)");
    result.put("UYU","uruguay-i peso");
    result.put("UZS","üzbegisztáni szum");
    result.put("VEB","Venezuelai bolivar (1871–2008)");
    result.put("VEF","venezuelai bolivar (2008–2018)");
    result.put("VES","venezuelai bolivar");
    result.put("VND","vietnami dong");
    result.put("VUV","vanuatui vatu");
    result.put("WST","nyugat-szamoai tala");
    result.put("XAF","CFA frank BEAC");
    result.put("XAG","Ezüst");
    result.put("XAU","Arany");
    result.put("XBA","Európai kompozit egység");
    result.put("XBB","Európai monetáris egység");
    result.put("XBC","Európai kontó egység (XBC)");
    result.put("XBD","Európai kontó egység (XBD)");
    result.put("XCD","kelet-karibi dollár");
    result.put("XDR","Special Drawing Rights");
    result.put("XEU","európai pénznemegység");
    result.put("XFO","Francia arany frank");
    result.put("XFU","Francia UIC-frank");
    result.put("XOF","CFA frank BCEAO");
    result.put("XPD","palládium");
    result.put("XPF","csendes-óceáni valutaközösségi frank");
    result.put("XPT","platina");
    result.put("XRE","RINET tőke");
    result.put("XTS","Tesztelési pénznemkód");
    result.put("XXX","ismeretlen pénznem");
    result.put("YDD","Jemeni dínár");
    result.put("YER","jemeni rial");
    result.put("YUD","Jugoszláv kemény dínár");
    result.put("YUM","Jugoszláv új dínár");
    result.put("YUN","Jugoszláv konvertibilis dínár");
    result.put("ZAL","Dél-afrikai rand (pénzügyi)");
    result.put("ZAR","dél-afrikai rand");
    result.put("ZMK","Zambiai kwacha (1968–2012)");
    result.put("ZMW","zambiai kwacha");
    result.put("ZRN","Zairei új zaire");
    result.put("ZRZ","Zairei zaire");
    result.put("ZWD","Zimbabwei dollár (1980–2008)");
    result.put("ZWL","Zimbabwei dollár (2009)");
    result.put("ZWR","Zimbabwei dollár (2008)");
    return result;
  }
}
