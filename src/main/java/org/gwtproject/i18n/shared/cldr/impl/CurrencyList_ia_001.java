...
public class CurrencyList_ia_001 extends CurrencyList_ia {
  public CurrencyData getDefault() {
    return new CurrencyDataImpl("IDR","IDR",2,"IDR","IDR");
  }
  ...
  protected HashMap<String, CurrencyData> loadCurrencyMap() {
    ...
    result.put("NLG", new CurrencyDataImpl("NLG","ƒ",130,"ƒ","ƒ"));
    // corona norvegian
  ...
  protected HashMap<String, String> loadNamesMap() {
    ...
    result.put("ANG","florino antillan");
    result.put("AOA","kwanza angolan");
    result.put("ARS","peso argentin");
    result.put("AUD","dollar australian");
    result.put("AWG","florino aruban");
    result.put("BAM","marco convertibile de Bosnia-Herzegovina");
    result.put("BBD","dollar barbadian");
    result.put("BGN","lev bulgare");
    result.put("BIF","franco burundese");
    result.put("BMD","dollar bermudan");
    result.put("BOB","boliviano bolivian");
    result.put("BRL","real brasilian");
    result.put("BSD","dollar bahamian");
    result.put("BWP","pula botswanese");
    result.put("BYN","rublo bielorusse");
    result.put("BZD","dollar belizan");
    result.put("CAD","dollar canadian");
    result.put("CDF","franco congolese");
    result.put("CHF","franco suisse");
    result.put("CLP","peso chilen");
    result.put("CNY","yuan chinese");
    result.put("COP","peso colombian");
    result.put("CRC","colon costarican");
    result.put("CUC","peso cuban convertibile");
    result.put("CUP","peso cuban");
    result.put("CVE","escudo capoverdian");
    result.put("CZK","corona chec");
    result.put("DEM","Marco geman");
    result.put("DJF","franco djibutian");
    result.put("DKK","corona danese");
    result.put("DOP","peso dominican");
    result.put("DZD","dinar algerin");
    result.put("EEK","Corona estonian");
    result.put("EGP","libra egyptie");
    result.put("ERN","nakfa eritree");
    result.put("ETB","birr ethiope");
    result.put("EUR","euro");
    result.put("FIM","Marco finnese");
    result.put("FJD","dollar fijian");
    result.put("FKP","libra falklandese");
    result.put("FRF","Franco francese");
    result.put("GBP","libra sterling");
    result.put("GHS","cedi ghanese");
    result.put("GIP","libra de Gibraltar");
    result.put("GMD","dalasi gambian");
    result.put("GNF","franco guinean");
    result.put("GTQ","quetzal guatemaltec");
    result.put("GYD","dollar guyanese");
    result.put("HNL","lempira hondurese");
    result.put("HRK","kuna croate");
    result.put("HTG","gourde haitian");
    result.put("HUF","forint hungare");
    result.put("IEP","Libra irlandese");
    result.put("INR","rupia indian");
    result.put("ISK","corona islandese");
    result.put("JMD","dollar jamaican");
    result.put("JPY","yen japonese");
    result.put("KES","shilling kenyan");
    result.put("KMF","franco comorian");
    result.put("KYD","dollar del Insulas Caiman");
    result.put("LRD","dollar liberian");
    result.put("LYD","dinar libyc");
    result.put("MAD","dirham marocchin");
    result.put("MDL","leu moldave");
    result.put("MGA","ariary malgache");
    result.put("MKD","denar macedonie");
    result.put("MRO","ouguiya mauritan (1973–2017)");
    result.put("MRU","ouguiya mauritan");
    result.put("MUR","rupia mauritian");
    result.put("MWK","kwacha malawian");
    result.put("MXN","peso mexican");
    result.put("MZN","metical mozambican");
    result.put("NAD","dollar namibian");
    result.put("NGN","naira nigerian");
    result.put("NIO","cordoba nicaraguan");
    result.put("NLG","Florino nederlandese");
    result.put("NOK","corona norvegian");
    result.put("NZD","dollar neozelandese");
    result.put("PAB","balboa panamen");
    result.put("PEN","sol peruvian");
    result.put("PGK","kina papuan");
    result.put("PLN","zloty polonese");
    result.put("PYG","guarani paraguayan");
    result.put("RON","leu romanian");
    result.put("RSD","dinar serbe");
    result.put("RUB","rublo russe");
    result.put("RWF","franco ruandese");
    result.put("SBD","dollar del insulas Salomon");
    result.put("SCR","rupia seychellese");
    result.put("SDG","libra sudanese");
    result.put("SEK","corona svedese");
    result.put("SHP","libra de St. Helena");
    result.put("SLL","leone sierraleonese");
    result.put("SOS","shilling somali");
    result.put("SRD","dollar surinamese");
    result.put("SSP","libra sud-sudanese");
    result.put("STN","dobra de São Tomé e Príncipe");
    result.put("SZL","lilangeni swazilandese");
    result.put("TND","dinar tunisian");
    result.put("TOP","paʻanga tongan");
    result.put("TTD","dollar de Trinidad e Tobago");
    result.put("TZS","shilling tanzanian");
    result.put("UAH","hryvnia ukrainian");
    result.put("UGX","shilling ugandese");
    result.put("USD","dollar statounitese");
    result.put("UYU","peso uruguayan");
    result.put("VEF","bolivar venezuelan (2008–2018)");
    result.put("VES","bolivar venezuelan");
    result.put("VUV","vatu vanuatuan");
    result.put("WST","tala samoan");
    result.put("XAF","franco CFA de Africa Central");
    result.put("XCD","dollar del Caribes Oriental");
    result.put("XOF","franco CFA de Africa Occidental");
    result.put("XPF","franco CFP");
    result.put("XXX","moneta incognite");
    result.put("ZAR","rand sudafrican");
