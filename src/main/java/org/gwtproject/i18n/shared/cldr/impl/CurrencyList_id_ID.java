...
public class CurrencyList_id_ID extends CurrencyList_id {
  public CurrencyData getDefault() {
    return new CurrencyDataImpl("IDR","Rp",2,"Rp","Rp");
  }
  ...
  protected HashMap<String, CurrencyData> loadCurrencyMap() {
    ...
    // Rupiah Indonesia
    result.put("IDR", new CurrencyDataImpl("IDR","Rp",2,"Rp","Rp"));
    // Pound Irlandia
    ...
    // Rupee India
    result.put("INR", new CurrencyDataImpl("INR","Rs",2,"Rs","Rs"));
    // Dinar Irak
  ...
  protected HashMap<String, String> loadNamesMap() {
    ...
    result.put("ADP","Peseta Andorra");
    result.put("AED","Dirham Uni Emirat Arab");
    result.put("AFA","Afgani Afganistan (1927–2002)");
    result.put("AFN","Afgani Afganistan");
    result.put("ALL","Lek Albania");
    result.put("AMD","Dram Armenia");
    result.put("ANG","Guilder Antilla Belanda");
    result.put("AOA","Kwanza Angola");
    result.put("AOK","Kwanza Angola (1977–1991)");
    result.put("AON","Kwanza Baru Angola (1990–2000)");
    result.put("AOR","Kwanza Angola yang Disesuaikan Lagi (1995–1999)");
    result.put("ARA","Austral Argentina");
    result.put("ARL","Peso Ley Argentina (1970–1983)");
    result.put("ARM","Peso Argentina (1881–1970)");
    result.put("ARP","Peso Argentina (1983–1985)");
    result.put("ARS","Peso Argentina");
    result.put("ATS","Schilling Austria");
    result.put("AUD","Dolar Australia");
    result.put("AWG","Florin Aruba");
    result.put("AZM","Manat Azerbaijan (1993–2006)");
    result.put("AZN","Manat Azerbaijan");
    result.put("BAD","Dinar Bosnia-Herzegovina (1992–1994)");
    result.put("BAM","Mark Konvertibel Bosnia-Herzegovina");
    result.put("BAN","Dinar Baru Bosnia-Herzegovina (1994–1997)");
    result.put("BBD","Dolar Barbados");
    result.put("BDT","Taka Bangladesh");
    result.put("BEC","Franc Belgia (konvertibel)");
    result.put("BEF","Franc Belgia");
    result.put("BEL","Franc Belgia (keuangan)");
    result.put("BGL","Hard Lev Bulgaria");
    result.put("BGM","Socialist Lev Bulgaria");
    result.put("BGN","Lev Bulgaria");
    result.put("BGO","Lev Bulgaria (1879–1952)");
    ...
    result.put("BOL","Boliviano Bolivia (1863–1963)");
    result.put("BOP","Peso Bolivia");
    result.put("BOV","Mvdol Bolivia");
    result.put("BRB","Cruzeiro Baru Brasil (1967–1986)");
    result.put("BRC","Cruzado Brasil (1986–1989)");
    result.put("BRE","Cruzeiro Brasil (1990–1993)");
    result.put("BRL","Real Brasil");
    result.put("BRN","Cruzado Baru Brasil (1989–1990)");
    result.put("BRR","Cruzeiro Brasil (1993–1994)");
    result.put("BRZ","Cruzeiro Brasil (1942–1967)");
    result.put("BSD","Dolar Bahama");
    result.put("BTN","Ngultrum Bhutan");
    result.put("BUK","Kyat Burma");
    result.put("BWP","Pula Botswana");
    result.put("BYB","Rubel Baru Belarus (1994–1999)");
    result.put("BYN","Rubel Belarusia");
    result.put("BYR","Rubel Belarusia (2000–2016)");
    result.put("BZD","Dolar Belize");
    result.put("CAD","Dolar Kanada");
    result.put("CDF","Franc Kongo");
    result.put("CHE","Euro WIR");
    result.put("CHF","Franc Swiss");
    result.put("CHW","Franc WIR");
    result.put("CLE","Escudo Cile");
    result.put("CLF","Satuan Hitung (UF) Cile");
    result.put("CLP","Peso Cile");
    result.put("CNH","Yuan Tiongkok (luar negeri)");
    result.put("CNY","Yuan Tiongkok");
    result.put("COP","Peso Kolombia");
    result.put("COU","Unit Nilai Nyata Kolombia");
    result.put("CRC","Colon Kosta Rika");
    result.put("CSD","Dinar Serbia (2002–2006)");
    result.put("CSK","Hard Koruna Cheska");
    result.put("CUC","Peso Konvertibel Kuba");
    result.put("CUP","Peso Kuba");
    result.put("CVE","Escudo Tanjung Verde");
    result.put("CYP","Pound Siprus");
    result.put("CZK","Koruna Cheska");
    result.put("DDM","Mark Jerman Timur");
    result.put("DEM","Mark Jerman");
    result.put("DJF","Franc Jibuti");
    result.put("DKK","Krone Denmark");
    result.put("DOP","Peso Dominika");
    result.put("DZD","Dinar Algeria");
    result.put("ECS","Sucre Ekuador");
    result.put("ECV","Satuan Nilai Tetap Ekuador");
    result.put("EEK","Kroon Estonia");
    result.put("EGP","Pound Mesir");
    result.put("ERN","Nakfa Eritrea");
    result.put("ESA","Peseta Spanyol (akun)");
    result.put("ESB","Peseta Spanyol (konvertibel)");
    result.put("ESP","Peseta Spanyol");
    result.put("ETB","Birr Etiopia");
    result.put("EUR","Euro");
    result.put("FIM","Markka Finlandia");
    result.put("FJD","Dolar Fiji");
    result.put("FKP","Pound Kepulauan Falkland");
    result.put("FRF","Franc Prancis");
    result.put("GBP","Pound Inggris");
    result.put("GEK","Kupon Larit Georgia");
    result.put("GEL","Lari Georgia");
    result.put("GHC","Cedi Ghana (1979–2007)");
    result.put("GHS","Cedi Ghana");
    result.put("GIP","Pound Gibraltar");
    result.put("GMD","Dalasi Gambia");
    result.put("GNF","Franc Guinea");
    result.put("GNS","Syli Guinea");
    result.put("GQE","Ekuele Guinea Ekuatorial");
    result.put("GRD","Drachma Yunani");
    result.put("GTQ","Quetzal Guatemala");
    result.put("GWE","Escudo Guinea Portugal");
    ...
    result.put("HRD","Dinar Kroasia");
    result.put("HRK","Kuna Kroasia");
    result.put("HTG","Gourde Haiti");
    result.put("HUF","Forint Hungaria");
    result.put("IDR","Rupiah Indonesia");
    result.put("IEP","Pound Irlandia");
    result.put("ILP","Pound Israel");
    result.put("ILR","Shekel Israel");
    result.put("ILS","Shekel Baru Israel");
    result.put("INR","Rupee India");
    result.put("IQD","Dinar Irak");
    result.put("IRR","Rial Iran");
    result.put("ISJ","Krona Islandia (1918–1981)");
    result.put("ISK","Krona Islandia");
    result.put("ITL","Lira Italia");
    result.put("JMD","Dolar Jamaika");
    result.put("JOD","Dinar Yordania");
    result.put("JPY","Yen Jepang");
    result.put("KES","Shilling Kenya");
    result.put("KGS","Som Kirgistan");
    result.put("KHR","Riel Kamboja");
    result.put("KMF","Franc Komoro");
    result.put("KPW","Won Korea Utara");
    result.put("KRH","Hwan Korea Selatan (1953–1962)");
    result.put("KRO","Won Korea Selatan (1945–1953)");
    ...
    result.put("LBP","Pound Lebanon");
    result.put("LKR","Rupee Sri Lanka");
    result.put("LRD","Dolar Liberia");
    result.put("LSL","Loti Lesotho");
    result.put("LTL","Litas Lituania");
    result.put("LTT","Talonas Lituania");
    result.put("LUC","Franc Konvertibel Luksemburg");
    result.put("LUF","Franc Luksemburg");
    result.put("LUL","Financial Franc Luksemburg");
    result.put("LVL","Lats Latvia");
    result.put("LVR","Rubel Latvia");
    result.put("LYD","Dinar Libya");
    result.put("MAD","Dirham Maroko");
    result.put("MAF","Franc Maroko");
    result.put("MCF","Franc Monegasque");
    result.put("MDC","Cupon Moldova");
    result.put("MDL","Leu Moldova");
    result.put("MGA","Ariary Madagaskar");
    result.put("MGF","Franc Malagasi");
    result.put("MKD","Denar Makedonia");
    result.put("MKN","Denar Makedonia (1992–1993)");
    result.put("MLF","Franc Mali");
    result.put("MMK","Kyat Myanmar");
    result.put("MNT","Tugrik Mongolia");
    result.put("MOP","Pataca Makau");
    result.put("MRO","Ouguiya Mauritania (1973–2017)");
    result.put("MRU","Ouguiya Mauritania");
    result.put("MTL","Lira Malta");
    result.put("MTP","Pound Malta");
    result.put("MUR","Rupee Mauritius");
    result.put("MVP","Rufiyaa Maladewa (1947–1981)");
    result.put("MVR","Rufiyaa Maladewa");
    result.put("MWK","Kwacha Malawi");
    result.put("MXN","Peso Meksiko");
    result.put("MXP","Peso Silver Meksiko (1861–1992)");
    result.put("MXV","Unit Investasi Meksiko");
    result.put("MYR","Ringgit Malaysia");
    result.put("MZE","Escudo Mozambik");
    result.put("MZM","Metical Mozambik (1980–2006)");
    result.put("MZN","Metical Mozambik");
    result.put("NAD","Dolar Namibia");
    result.put("NGN","Naira Nigeria");
    result.put("NIC","Cordoba Nikaragua (1988–1991)");
    result.put("NIO","Cordoba Nikaragua");
    result.put("NLG","Guilder Belanda");
    result.put("NOK","Krone Norwegia");
    result.put("NPR","Rupee Nepal");
    result.put("NZD","Dolar Selandia Baru");
    result.put("OMR","Rial Oman");
    result.put("PAB","Balboa Panama");
    result.put("PEI","Inti Peru");
    result.put("PEN","Sol Peru");
    result.put("PES","Sol Peru (1863–1965)");
    result.put("PGK","Kina Papua Nugini");
    result.put("PHP","Peso Filipina");
    result.put("PKR","Rupee Pakistan");
    result.put("PLN","Polandia Zloty");
    result.put("PLZ","Zloty Polandia (1950–1995)");
    result.put("PTE","Escudo Portugal");
    result.put("PYG","Guarani Paraguay");
    result.put("QAR","Rial Qatar");
    result.put("RHD","Dolar Rhodesia");
    result.put("ROL","Leu Rumania (1952–2006)");
    result.put("RON","Leu Rumania");
    result.put("RSD","Dinar Serbia");
    result.put("RUB","Rubel Rusia");
    result.put("RUR","Rubel Rusia (1991–1998)");
    result.put("RWF","Franc Rwanda");
    result.put("SAR","Riyal Arab Saudi");
    result.put("SBD","Dolar Kepulauan Solomon");
    result.put("SCR","Rupee Seychelles");
    result.put("SDD","Dinar Sudan (1992–2007)");
    result.put("SDG","Pound Sudan");
    result.put("SDP","Pound Sudan (1957–1998)");
    result.put("SEK","Krona Swedia");
    result.put("SGD","Dolar Singapura");
    result.put("SHP","Pound Saint Helena");
    result.put("SIT","Tolar Slovenia");
    result.put("SKK","Koruna Slovakia");
    result.put("SLL","Leone Sierra Leone");
    result.put("SOS","Shilling Somalia");
    result.put("SRD","Dolar Suriname");
    result.put("SRG","Guilder Suriname");
    result.put("SSP","Pound Sudan Selatan");
    result.put("STD","Dobra Sao Tome dan Principe (1977–2017)");
    result.put("STN","Dobra Sao Tome dan Principe");
    result.put("SUR","Rubel Soviet");
    result.put("SVC","Colon El Savador");
    result.put("SYP","Pound Suriah");
    result.put("SZL","Lilangeni Swaziland");
    result.put("THB","Baht Thailand");
    result.put("TJR","Rubel Tajikistan");
    result.put("TJS","Somoni Tajikistan");
    result.put("TMM","Manat Turkmenistan (1993–2009)");
    result.put("TMT","Manat Turkimenistan");
    result.put("TND","Dinar Tunisia");
    result.put("TOP","Paʻanga Tonga");
    result.put("TPE","Escudo Timor");
    result.put("TRL","Lira Turki (1922–2005)");
    result.put("TRY","Lira Turki");
    result.put("TTD","Dolar Trinidad dan Tobago");
    result.put("TWD","Dolar Baru Taiwan");
    result.put("TZS","Shilling Tanzania");
    result.put("UAH","Hryvnia Ukraina");
    result.put("UAK","Karbovanet Ukraina");
    result.put("UGS","Shilling Uganda (1966–1987)");
    result.put("UGX","Shilling Uganda");
    result.put("USD","Dolar Amerika Serikat");
    result.put("USN","Dolar AS (Hari berikutnya)");
    result.put("USS","Dolar AS (Hari yang sama)");
    result.put("UYI","Peso Uruguay (Unit Diindeks)");
    result.put("UYP","Peso Uruguay (1975–1993)");
    result.put("UYU","Peso Uruguay");
    result.put("UZS","Som Uzbekistan");
    result.put("VEB","Bolivar Venezuela (1871–2008)");
    result.put("VEF","Bolivar Venezuela (2008–2018)");
    result.put("VES","Bolivar Venezuela");
    result.put("VND","Dong Vietnam");
    result.put("VNN","Dong Vietnam (1978–1985)");
    result.put("VUV","Vatu Vanuatu");
    result.put("WST","Tala Samoa");
    result.put("XAF","Franc CFA BEAC");
    result.put("XAG","Silver");
    result.put("XAU","Emas");
    result.put("XBA","Unit Gabungan Eropa");
    result.put("XBB","Unit Keuangan Eropa");
    result.put("XBC","Satuan Hitung Eropa (XBC)");
    result.put("XBD","Satuan Hitung Eropa (XBD)");
    result.put("XCD","Dolar Karibia Timur");
    result.put("XDR","Hak Khusus Menggambar");
    result.put("XEU","Satuan Mata Uang Eropa");
    result.put("XFO","Franc Gold Perancis");
    result.put("XFU","Franc UIC Perancis");
    result.put("XOF","Franc CFA BCEAO");
    result.put("XPD","Palladium");
    result.put("XPF","Franc CFP");
    result.put("XPT","Platinum");
    result.put("XRE","Dana RINET");
    result.put("XTS","Kode Mata Uang Pengujian");
    result.put("XXX","Mata Uang Tidak Dikenal");
    result.put("YDD","Dinar Yaman");
    result.put("YER","Rial Yaman");
    result.put("YUD","Hard Dinar Yugoslavia (1966–1990)");
    result.put("YUM","Dinar Baru Yugoslavia (1994–2002)");
    result.put("YUN","Dinar Konvertibel Yugoslavia (1990–1992)");
    result.put("YUR","Dinar Reformasi Yugoslavia (1992–1993)");
    result.put("ZAL","Rand Afrika Selatan (Keuangan)");
    result.put("ZAR","Rand Afrika Selatan");
    result.put("ZMK","Kwacha Zambia (1968–2012)");
    result.put("ZMW","Kwacha Zambia");
    result.put("ZRN","Zaire Baru Zaire (1993–1998)");
    result.put("ZRZ","Zaire Zaire (1971–1993)");
    result.put("ZWD","Dolar Zimbabwe (1980–2008)");
    result.put("ZWL","Dolar Zimbabwe (2009)");
    result.put("ZWR","Dolar Zimbabwe (2008)");
    return result;
  }
}
