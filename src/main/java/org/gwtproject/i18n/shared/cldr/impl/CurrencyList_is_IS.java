...
public class CurrencyList_is_IS extends CurrencyList_is {
  public CurrencyData getDefault() {
    return new CurrencyDataImpl("ISK","ISK",0,"ISK","ISK");
  }
  ...
  protected HashMap<String, String> loadNamesMap() {
    ...
    result.put("ALL","albanskt lek");
    result.put("AMD","armenskt dramm");
    result.put("ANG","hollenskt Antillugyllini");
    result.put("AOA","angólsk kvansa");
    result.put("ARA","Argentine Austral");
    result.put("ARP","Argentískur pesi (1983–1985)");
    result.put("ARS","argentínskur pesi");
    result.put("ATS","Austurrískur skildingur");
    result.put("AUD","ástralskur dalur");
    result.put("AWG","arúbönsk flórína");
    result.put("AZN","aserskt manat");
    result.put("BAM","skiptanlegt Bosníu og Hersegóvínu-mark");
    result.put("BBD","barbadoskur dalur");
    result.put("BDT","bangladessk taka");
    result.put("BEF","Belgískur franki");
    result.put("BGL","Lef");
    result.put("BGN","búlgarskt lef");
    result.put("BHD","bareinskur denari");
    result.put("BIF","búrúndískur franki");
    result.put("BMD","Bermúdadalur");
    result.put("BND","brúneiskur dalur");
    result.put("BOB","bólivíani");
    result.put("BOP","Bólivískur pesi");
    result.put("BOV","Bolivian Mvdol");
    result.put("BRL","brasilískt ríal");
    result.put("BSD","Bahamadalur");
    result.put("BTN","bútanskt núltrum");
    result.put("BUK","Búrmverskt kjat");
    result.put("BWP","botsvönsk púla");
    result.put("BYN","hvítrússnesk rúbla");
    result.put("BYR","hvítrússnesk rúbla (2000–2016)");
    result.put("BZD","belískur dalur");
    result.put("CAD","Kanadadalur");
    result.put("CDF","kongóskur franki");
    result.put("CHF","svissneskur franki");
    result.put("CLF","Chilean Unidades de Fomento");
    result.put("CLP","síleskur pesi");
    result.put("CNH","kínverskt júan (utan heimalands)");
    result.put("CNY","kínverskt júan");
    result.put("COP","kólumbískur pesi");
    result.put("CRC","kostarískt kólon");
    result.put("CSK","Tékknesk króna, eldri");
    result.put("CUC","kúbverskur skiptanlegur pesi");
    ...
    result.put("JOD","jórdanskur denari");
    result.put("JPY","japanskt jen");
    result.put("KES","kenískur skildingur");
    result.put("KGS","kirgiskt som");
    result.put("KHR","kambódískt ríal");
    ...
    result.put("MDL","moldavískt lei");
    result.put("MGA","Madagaskararjari");
    ...
    result.put("MNT","mongólskur túríkur");
    result.put("MOP","makaósk pataka");
    result.put("MRO","márítönsk úgía (1973–2017)");
    result.put("MRU","márítönsk úgía");
    result.put("MTL","Meltnesk líra");
    result.put("MTP","Maltneskt pund");
    result.put("MUR","máritísk rúpía");
    result.put("MVR","maldíveysk rúpía");
    result.put("MWK","malavísk kvaka");
    result.put("MXN","mexíkóskur pesi");
    result.put("MXP","Mexíkóskur silfurpesi (1861–1992)");
    result.put("MXV","Mexíkóskur pesi, UDI");
    result.put("MYR","malasískt ringit");
    result.put("MZE","Mósambískur skúti");
    result.put("MZN","mósambískt metikal");
    result.put("NAD","namibískur dalur");
    result.put("NGN","nígerísk næra");
    result.put("NIC","Níkarögsk kordóva (1988–1991)");
    result.put("NIO","níkaraögsk kordóva");
    ...
    result.put("PEN","perúskt sól");
    result.put("PGK","papúsk kína");
    result.put("PHP","filippseyskur pesi");
    result.put("PKR","pakistönsk rúpía");
    result.put("PLN","pólskt slot");
    result.put("PLZ","Slot");
    result.put("PTE","Portúgalskur skúti");
    result.put("PYG","paragvæskt gvaraní");
    result.put("QAR","katarskt ríal");
    result.put("ROL","Rúmenskt lei (1952–2006)");
    result.put("RON","rúmenskt lei");
    result.put("RSD","serbneskur denari");
    result.put("RUB","rússnesk rúbla");
    result.put("RUR","Rússnesk rúbla (1991–1998)");
    result.put("RWF","rúandskur franki");
    result.put("SAR","sádíarabískt ríal");
    result.put("SBD","salómonseyskur dalur");
    result.put("SCR","Seychellesrúpía");
    ...
    result.put("SLL","síerraleónsk ljóna");
    result.put("SOS","sómalískur skildingur");
    result.put("SRD","Súrínamdalur");
    result.put("SRG","Suriname Guilder");
    result.put("SSP","suðursúdanskt pund");
    result.put("STD","Saó Tóme og Prinsípe-dóbra (1977–2017)");
    result.put("STN","Saó Tóme og Prinsípe-dóbra");
    ...
    result.put("THB","taílenskt bat");
    result.put("TJR","Tadsjiksk rúbla");
    result.put("TJS","tadsjikskur sómóni");
    result.put("TMM","Túrkmenskt manat (1993–2009)");
    result.put("TMT","túrkmenskt manat");
    result.put("TND","túnískur denari");
    result.put("TOP","Tongapanga");
    result.put("TPE","Tímorskur skúti");
    result.put("TRL","Tyrknesk líra (1922–2005)");
    result.put("TRY","tyrknesk líra");
    result.put("TTD","Trínidad og Tóbagó-dalur");
    result.put("TWD","taívanskur dalur");
    result.put("TZS","tansanískur skildingur");
    result.put("UAH","úkraínsk hrinja");
    ...
    result.put("UYU","úrúgvæskur pesi");
    result.put("UZS","úsbekskt súm");
    result.put("VEB","Bolívar í Venesúela (1871–2008)");
    result.put("VEF","venesúelskur bólívari (2008–2018)");
    result.put("VES","venesúelskur bólívari");
    result.put("VND","víetnamskt dong");
    result.put("VUV","vanúatúskt vatú");
    result.put("WST","Samóatala");
    result.put("XAF","miðafrískur franki");
    result.put("XAG","unse silfur");
    result.put("XAU","unse gull");
    result.put("XCD","austurkarabískur dalur");
    result.put("XDR","Sérstök dráttarréttindi");
    result.put("XFO","Franskur gullfranki");
    result.put("XFU","Franskur franki, UIC");
    result.put("XOF","vesturafrískur franki");
    result.put("XPD","unse palladín");
    result.put("XPF","pólinesískur franki");
    result.put("XPT","unse platína");
    result.put("XXX","óþekktur gjaldmiðill");
