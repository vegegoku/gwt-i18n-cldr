...
public class CurrencyList_jv_ID extends CurrencyList_jv {
  ...
  protected HashMap<String, String> loadNamesMap() {
    ...
    result.put("AFN","Afghani Afganistan");
    result.put("ALL","Lek Albania");
    result.put("AMD","Dram Armenia");
    result.put("ANG","Guilder Antilla Walanda");
    ...
    result.put("BBD","Dolar Barbadian");
    ...
    result.put("FKP","Pound Kepuloan Falkland");
    ...
    result.put("ILS","Shekel Anyar Israel");
    ...
    result.put("KPW","Won Korea Lor");
    result.put("KRW","Won Korea Kidul");
    result.put("KWD","Dinar Kuwait");
    result.put("KYD","Dolar Kepuloan Caiman");
    result.put("KZT","Tenge Kasakhstan");
    result.put("LAK","Kip Laos");
    result.put("LBP","Pound Libanon");
    ...
    result.put("MGA","Ariary Malagasi");
    result.put("MKD","Denar Masedonia");
    ...
    result.put("MZN","Metical Mosambik");
    ...
    result.put("SBD","Dolar Kepuloan Solomon");
    result.put("SCR","Rupee Seichelles");
    result.put("SDG","Pound Sudan");
    result.put("SEK","Krona Swedia");
    result.put("SGD","Dolar Singapura");
    result.put("SHP","Pound Santa Helena");
    result.put("SLL","Leone Sierra Leone");
    result.put("SOS","Shilling Somalia");
    result.put("SRD","Dolar Suriname");
    result.put("SSP","Pound Sudan Kidul");
    result.put("STN","Dobra Sao Tome lan Principe");
    result.put("SYP","Pound Siria");
    result.put("SZL","Lilangeni Swasi");
    result.put("THB","Baht Thai");
    result.put("TJS","Somoni Tajikistan");
    result.put("TMT","Manat Turmenistan");
    result.put("TND","Dinar Tunisia");
    result.put("TOP","Paʻanga Tonga");
    result.put("TRY","Lira Turki");
    result.put("TTD","Dolar Trinidad lan Tobago");
    result.put("TWD","Dolar Anyar Taiwan");
    result.put("TZS","Shilling Tansania");
    result.put("UAH","Hryvnia Ukrania");
    result.put("UGX","Shilling Uganda");
    result.put("USD","Dolar Amerika Serikat");
    result.put("UYU","Peso Uruguay");
    result.put("UZS","Som Usbekistan");
    ...
    result.put("XAF","CFA Franc Afrika Tengah");
    result.put("XCD","Dolar Karibia Wetan");
    result.put("XOF","CFA Franc Afrika Kulon");
    result.put("XPF","Franc CFP");
    result.put("XXX","Dhuwit Ora Dikenali");
    result.put("YER","Rial Yaman");
    result.put("ZAR","Rand Afrika Kidul");
    result.put("ZMW","Kwacha Sambia");
    return result;
  }
}
