...
public class CurrencyList_ka_GE extends CurrencyList_ka {
  public CurrencyData getDefault() {
    return new CurrencyDataImpl("GEL","₾",2,"₾","₾");
  }
  ...
  protected HashMap<String, String> loadNamesMap() {
    ...
    result.put("AED","არაბთა გაერთიანებული საამიროების დირჰამი");
    result.put("AFA","ავღანი (1927–2002)");
    result.put("AFN","ავღანური ავღანი");
    result.put("ALL","ალბანური ლეკი");
    result.put("AMD","სომხური დრამი");
    result.put("ANG","ნიდერლანდების ანტილების გულდენი");
    ...
    result.put("BAM","ბოსნია და ჰერცოგოვინას კონვერტირებადი მარკა");
    ...
    result.put("BGN","ბულგარული ლევი");
    result.put("BHD","ბაჰრეინული დინარი");
    result.put("BIF","ბურუნდიული ფრანკი");
    result.put("BMD","ბერმუდული დოლარი");
    result.put("BND","ბრუნეული დოლარი");
    result.put("BOB","ბოლივიური ბოლივიანო");
    ...
    result.put("BTN","ბუტანური ნგულტრუმი");
    result.put("BWP","ბოცვანური პულა");
    result.put("BYB","ახალი ბელარუსიული რუბლი (1994–1999)");
    result.put("BYN","ბელორუსული რუბლი");
    result.put("BYR","ბელორუსული რუბლი (2000–2016)");
    result.put("BZD","ბელიზის დოლარი");
    result.put("CAD","კანადური დოლარი");
    result.put("CDF","კონგოს ფრანკი");
    result.put("CHF","შვეიცარიული ფრანკი");
    result.put("CLP","ჩილეს პესო");
    result.put("CNH","ჩინური იუანი (ოფშორი)");
    result.put("CNY","ჩინური იუანი");
    result.put("COP","კოლუმბიური პესო");
    result.put("CRC","კოსტა-რიკული კოლონი");
    result.put("CSD","ძველი სერბიული დინარი");
    result.put("CSK","ჩეხოსლოვაკიის მყარი კრონა");
    result.put("CUC","კუბური კონვერტირებადი პესო");
    ...
    result.put("DZD","ალჟირული დინარი");
    result.put("EEK","ესტონური კრუნა");
    result.put("EGP","ეგვიპტური გირვანქა");
    result.put("ERN","ერიტრეის ნაკფა");
    result.put("ESP","ესპანური პესეტა");
    result.put("ETB","ეთიოპიური ბირი");
    result.put("EUR","ევრო");
    result.put("FIM","ფინური მარკა");
    result.put("FJD","ფიჯის დოლარი");
    result.put("FKP","ფოლკლენდის კუნძულების ფუნტი");
    result.put("FRF","ფრანგული ფრანკი");
    result.put("GBP","ბრიტანული გირვანქა სტერლინგი");
    result.put("GEK","ქართული კუპონი ლარით");
    result.put("GEL","ქართული ლარი");
    result.put("GHS","განური სედი");
    result.put("GIP","გიბრალტარული ფუნტი");
    result.put("GMD","გამბიური დალასი");
    result.put("GNF","გვინეური ფრანკი");
    result.put("GRD","ბერძნული დრაჰმა");
    result.put("GTQ","გვატემალური კეტსალი");
    result.put("GWE","პორტუგალიური გინეა ესკუდო");
    result.put("GYD","გაიანური დოლარი");
    result.put("HKD","ჰონკონგის დოლარი");
    result.put("HNL","ჰონდურასული ლემპირა");
    result.put("HRD","ხორვატიული დინარი");
    result.put("HRK","ხორვატული კუნა");
    result.put("HTG","ჰაიტური გურდი");
    result.put("HUF","უნგრული ფორინტი");
    result.put("IDR","ინდონეზიური რუპია");
    result.put("IEP","ირლანდიური გირვანქა");
    result.put("ILS","ისრაელის ახალი შეკელი");
    result.put("INR","ინდური რუპია");
    result.put("IQD","ერაყული დინარი");
    result.put("IRR","ირანული რიალი");
    ...
    result.put("KGS","ყირგიზული სომი");
    result.put("KHR","კამბოჯური რიელი");
    result.put("KMF","კომორული ფრანკი");
    result.put("KPW","ჩრდილოეთ კორეული ვონი");
    result.put("KRW","სამხრეთ კორეული ვონი");
    result.put("KWD","ქუვეითური დინარი");
    result.put("KYD","კაიმანის კუნძულების დოლარი");
    result.put("KZT","ყაზახური ტენგე");
    result.put("LAK","ლაოსური კიპი");
    result.put("LBP","ლიბანური ფუნტი");
    result.put("LKR","შრი-ლანკური რუპია");
    ...
    result.put("NIO","ნიკარაგუული კორდობა");
    ...
    result.put("OMR","ომანის რიალი");
    result.put("PAB","პანამური ბალბოა");
    result.put("PEI","პერუს ინტი");
    result.put("PEN","პერუს სოლი");
    result.put("PES","პერუს სოლი (1863–1965)");
    result.put("PGK","პაპუა-ახალი გვინეის კინა");
    ...
    result.put("PYG","პარაგვაული გუარანი");
    result.put("QAR","კატარის რიალი");
    result.put("RHD","როდეზიული დოლარი");
    result.put("ROL","ძველი რუმინული ლეუ");
    result.put("RON","რუმინული ლეუ");
    result.put("RSD","სერბული დინარი");
    result.put("RUB","რუსული რუბლი");
    result.put("RUR","რუსული რუბლი (1991–1998)");
    result.put("RWF","რუანდული ფრანკი");
    result.put("SAR","საუდის არაბეთის რიალი");
    result.put("SBD","სოლომონის კუნძულების დოლარი");
    result.put("SCR","სეიშელური რუპია");
    result.put("SDD","სუდანის დინარი");
    result.put("SDG","სუდანური ფუნტი");
    result.put("SDP","სუდანის გირვანქა");
    result.put("SEK","შვედური კრონა");
    result.put("SGD","სინგაპურის დოლარი");
    result.put("SHP","წმ. ელენეს კუნძულის ფუნტი");
    result.put("SLL","სიერა-ლეონეს ლეონე");
    result.put("SOS","სომალური შილინგი");
    result.put("SRD","სურინამული დოლარი");
    result.put("SRG","სურინამის გულდენი");
    result.put("SSP","სამხრეთ სუდანური ფუნტი");
    result.put("STD","სან-ტომე და პრინსიპის დობრა (1977–2017)");
    result.put("STN","სან-ტომე და პრინსიპის დობრა");
    result.put("SUR","საბჭოთა რუბლი");
    result.put("SYP","სირიული ფუნტი");
    result.put("SZL","სვაზილენდის ლილანგენი");
    result.put("THB","ტაილანდური ბატი");
    result.put("TJR","ტაჯიკური რუბლი");
    result.put("TJS","ტაჯიკური სომონი");
    result.put("TMM","თურქმენული მანათი");
    result.put("TMT","თურქმენეთის მანათი");
    result.put("TND","ტუნისური დინარი");
    result.put("TOP","ტონგანური პაანგა");
    ...
    result.put("UYU","ურუგვაის პესო");
    result.put("UZS","უზბეკური სუმი");
    result.put("VEB","ვენესუელის ბოლივარი (1871–2008)");
    result.put("VEF","ვენესუელის ბოლივარი (2008–2018)");
    result.put("VES","ვენესუელის ბოლივარი");
    result.put("VND","ვიეტნამური დონგი");
    result.put("VUV","ვანუატუს ვატუ");
    result.put("WST","სამოური ტალა");
    result.put("XAF","ცენტრალურ აფრიკული CFA ფრანკი");
    ...
    result.put("XOF","დასავლეთ აფრიკული CFA ფრანკი");
    result.put("XPF","CFP ფრანკი");
    result.put("XXX","უცნობი ვალუტა");
    ...
    result.put("ZAR","სამხრეთ აფრიკული რანდი");
    result.put("ZMK","ზამბიური კვაჭა (1968–2012)");
    result.put("ZMW","ზამბიური კვაჭა");
