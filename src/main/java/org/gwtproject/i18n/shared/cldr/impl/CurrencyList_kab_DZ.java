...
public class CurrencyList_kab_DZ extends CurrencyList_kab {
  public CurrencyData getDefault() {
    return new CurrencyDataImpl("DZD","DA",2,"DA","DA");
  }
  ...
  protected HashMap<String, CurrencyData> loadCurrencyMap() {
    ...
    // Apisu n Arjuntin
    result.put("ARS", new CurrencyDataImpl("ARS","$AR",2,"$AR","$AR"));
    // Aciling n Ustriya
    ...
    // Adulaṛ n Birmud
    result.put("BMD", new CurrencyDataImpl("BMD","$BM",2,"$BM","$BM"));
    // adular n Brunay
    result.put("BND", new CurrencyDataImpl("BND","$BN",2,"$BN","$BN"));
    // Abulivyanu n Bulivi
    ...
    // Adular n Bahamas
    result.put("BSD", new CurrencyDataImpl("BSD","$BS",2,"$BS","$BS"));
    // Angultrum n Butan
    ...
    // Adular n Biliz
    result.put("BZD", new CurrencyDataImpl("BZD","$BZ",2,"$BZ","$BZ"));
    // Adular Akanadi
    ...
    // Apisu n Cili
    result.put("CLP", new CurrencyDataImpl("CLP","$CL",0,"$CL","$CL"));
    // CNH
    result.put("CNH", new CurrencyDataImpl("CNH","CNH",130,"CNH","CNH"));
    // Adular n Lbanka Taɣerfant n Tacinwit
    result.put("CNX", new CurrencyDataImpl("CNX","CNX",130,"CNX","CNX"));
    // Ayuwan Renminbi Acinwa
    result.put("CNY", new CurrencyDataImpl("CNY","CNY",2,"CNY","CNY"));
    // Apisu n Kulumbi
    result.put("COP", new CurrencyDataImpl("COP","$CO",2,"$CO","$CO"));
    ...
    // Adinar Azzayri
    result.put("DZD", new CurrencyDataImpl("DZD","DA",2,"DA","DA"));
    // Asukr n Ikwaṭur
    ...
    // Adular n Fiǧi
    result.put("FJD", new CurrencyDataImpl("FJD","$FJ",2,"$FJ","$FJ"));
    // Apawnd n tegzrin n Malwin
    result.put("FKP", new CurrencyDataImpl("FKP","£FK",2,"£FK","£FK"));
    // Afrank n Fṛansa
    result.put("FRF", new CurrencyDataImpl("FRF","F",130,"F","F"));
    // Apund Aglizi
    result.put("GBP", new CurrencyDataImpl("GBP","£GB",2,"£GB","£GB"));
    // Akupun n Larin Jyujya
    ...
    // Apawnd n Jibraltar
    result.put("GIP", new CurrencyDataImpl("GIP","£GI",2,"£GI","£GI"));
    // Adalasi Agambi
    ...
    // Adular n Hung Kung
    result.put("HKD", new CurrencyDataImpl("HKD","HKD",2,"HKD","HKD"));
    // Alampir n Hunduras
    ...
    // Ayen Ajappuni
    result.put("JPY", new CurrencyDataImpl("JPY","JPY",0,"JPY","JPY"));
    // Aciling Akini
    ...
    // Afrank n Meṛṛuk
    result.put("MAF", new CurrencyDataImpl("MAF","fMA",130,"fMA","fMA"));
    // MCF
    ...
    // Afrank n Madakaskaṛ
    result.put("MGF", new CurrencyDataImpl("MGF","Fmg",128,"Fmg","Fmg"));
    // Adenar n Masidunya
    ...
    // Adular Anamibi
    result.put("NAD", new CurrencyDataImpl("NAD","$NA",2,"$NA","$NA"));
    // Anayra Anijiri
    ...
    // Adular n tegzirin Salumun
    result.put("SBD", new CurrencyDataImpl("SBD","$SB",2,"$SB","$SB"));
    // Arupi Aseycili
    ...
    // Adular n Sangapur
    result.put("SGD", new CurrencyDataImpl("SGD","$SG",2,"$SG","$SG"));
    // Apund Asant Ilini
    ...
    // Adular n Surinam
    result.put("SRD", new CurrencyDataImpl("SRD","$SR",2,"$SR","$SR"));
    // Aflurin n Surinam
    result.put("SRG", new CurrencyDataImpl("SRG","SRG",130,"SRG","SRG"));
    // Apawnd n Sudan n Unẓul
    ...
    // Apawnd n Ṭurk (1844–2005)
    result.put("TRL", new CurrencyDataImpl("TRL","TRL",128,"TRL","TRL"));
    // Apawnd n Ṭurk
    result.put("TRY", new CurrencyDataImpl("TRY","LT",2,"LT","LT"));
    // Adular n Triniti-d-Ṭubagu
    result.put("TTD", new CurrencyDataImpl("TTD","$TT",2,"$TT","$TT"));
    // Adular amaynut n Taywan
    result.put("TWD", new CurrencyDataImpl("TWD","TWD",2,"TWD","TWD"));
    // Aciling Aṭanẓani
    ...
    // Apisu n Urugway
    result.put("UYU", new CurrencyDataImpl("UYU","$UY",2,"$UY","$UY"));
    // UYW
    ...
    // Abulivaṛ n Vinizwila (2008–2018)
    ...
    // Atala n Samwa
    result.put("WST", new CurrencyDataImpl("WST","WS$",2,"WS$","WS$"));
    // Afrank BCEA CFA
    ...
    // Aferdis n tufut uddis (URKU)
    result.put("XBA", new CurrencyDataImpl("XBA","XBA",130,"XBA","XBA"));
    // Aferdis n tedrimt n tufurt (UME–6)
    result.put("XBB", new CurrencyDataImpl("XBB","XBB",130,"XBB","XBB"));
    // Aferdis n umiḍan n turfut (UEC–9)
    result.put("XBC", new CurrencyDataImpl("XBC","XBC",130,"XBC","XBC"));
    // Aferdis n umiḍan 17 n turfut (UEC–17)
    result.put("XBD", new CurrencyDataImpl("XBD","XBD",130,"XBD","XBD"));
    // Adular n Karayib n usammar
    result.put("XCD", new CurrencyDataImpl("XCD","XCD",2,"XCD","XCD"));
    // droit de tirage spécial
    result.put("XDR", new CurrencyDataImpl("XDR","DTS",130,"DTS","DTS"));
    // Aferdis n umiḍan n turfut (ACU)
  ...
  protected HashMap<String, String> loadNamesMap() {
    ...
    result.put("AFN","Afɣani Afɣan");
    result.put("ALK","Alek Albani (1947–1961)");
    result.put("ALL","Alek Albani");
    result.put("AMD","Adram Armini");
    result.put("ANG","Afluran n Antilles");
    result.put("AOA","Akwanza n Ungula");
    result.put("AOK","Akwanza n Angula (1977–1990)");
    result.put("AON","Akwanza amaynut n Angula (1990–2000)");
    result.put("AOR","Akwanza n Angula yettwaseggmen (1995–1999)");
    result.put("ARA","Ustral n Arjuntin");
    result.put("ARL","Apisu aẓayan n Arjuntin (1970–1983)");
    result.put("ARM","Apisu n Arjuntin (1881–1970)");
    result.put("ARP","Apisu n Arjuntin (1983–1985)");
    result.put("ARS","Apisu n Arjuntin");
    result.put("ATS","Aciling n Ustriya");
    result.put("AUD","Adular n Lusṭrali");
    result.put("AWG","Afluran n Aruba");
    result.put("AZM","Amanat Aziri (1993–2006)");
    result.put("AZN","Amanat Aziri");
    result.put("BAD","Adinar Abusni");
    result.put("BAM","Amark yettwaseklaten n Busni");
    result.put("BBD","Adulaṛ n Barbuda");
    result.put("BDT","Ataka n Bingladic");
    result.put("BEC","Afrank n Biljik (yettwaselkaten)");
    result.put("BEF","Afrank n Biljik");
    result.put("BEL","Afrank n Biljik (adriman)");
    result.put("BGL","Alev n Bulgar (1962–1999)");
    result.put("BGN","Alev n Bulgar");
    result.put("BHD","Adinar Abaḥrini");
    result.put("BIF","Afrank Aburandi");
    result.put("BMD","Adulaṛ n Birmud");
    result.put("BND","adular n Brunay");
    result.put("BOB","Abulivyanu n Bulivi");
    result.put("BOL","Abulivyanu n Bulivi (1863–1963)");
    result.put("BOP","Apisu n Bulivi");
    result.put("BOV","Amevdul n Bulivi");
    result.put("BRB","Akruziru amaynut n Brizil (1967–1986)");
    result.put("BRC","Akruzadu n Brizil (1986–1989)");
    result.put("BRE","Akruziru n Brizil (1990–1993)");
    result.put("BRL","Ariyal n Brizil");
    result.put("BRN","Akruzadu amaynut n Brizil");
    result.put("BRR","Akruziru");
    result.put("BRZ","Akruziru n Brizil (1942–1967)");
    result.put("BSD","Adular n Bahamas");
    result.put("BTN","Angultrum n Butan");
    result.put("BUK","Akyat n Burma");
    result.put("BWP","Apula Abusṭwanan");
    result.put("BYB","Arubl amaynut n Bilarus (1994–1999)");
    result.put("BYN","Arubl n Bilarus");
    result.put("BYR","Arubl n Bilarus (2000–2016)");
    result.put("BZD","Adular n Biliz");
    result.put("CAD","Adular Akanadi");
    result.put("CDF","Afrank Akunguli");
    result.put("CHE","Uru WIR");
    result.put("CHF","Afrank Aswis");
    result.put("CHW","Afrank WIR");
    result.put("CLE","Askudu n Cili");
    result.put("CLF","Aferdis n Usefti n Cili");
    result.put("CLP","Apisu n Cili");
    result.put("CNX","Adular n Lbanka Taɣerfant n Tacinwit");
    result.put("CNY","Ayuwan Renminbi Acinwa");
    result.put("COP","Apisu n Kulumbi");
    result.put("COU","Aferdis n wazal ilaw n Kulumbi");
    result.put("CRC","Akulun n Kustarika");
    result.put("CSD","Adinar n Ṣirbya-Muntinigru");
    result.put("CSK","Akurun iǧehden Ačikusluvak");
    result.put("CUC","Apisu n Kuba yettwaselkaten");
    result.put("CUP","Apisu n Kuba");
    result.put("CVE","Akabuviradinu Askudi");
    result.put("CYP","Apawnd n Cipr");
    result.put("CZK","Akurun n Čik");
    result.put("DDM","Amark n Walman n usammar");
    result.put("DEM","Amark n Walman");
    result.put("DJF","Afrank Ajibuti");
    result.put("DKK","Akurun n Danmark");
    result.put("DOP","Apisu n Duminik");
    result.put("DZD","Adinar Azzayri");
    result.put("ECS","Asukr n Ikwaṭur");
    result.put("ECV","Aferdis n wazal ameɣlal n Ikwaṭur (UVC)");
    result.put("EEK","Akurun n Isṭunya");
    result.put("EGP","Apund Amaṣri");
    result.put("ERN","Anakfa Iritiri");
    result.put("ESA","Apisetas n Spanya (amiḍan A)");
    result.put("ESB","Apisetas n Spanya (amiḍan yettwaselkaten)");
    result.put("ESP","Apisetas n Spanya");
    result.put("ETB","Abir Utyupi");
    result.put("EUR","Uru");
    result.put("FIM","Amark n Finland");
    result.put("FJD","Adular n Fiǧi");
    result.put("FKP","Apawnd n tegzrin n Malwin");
    result.put("FRF","Afrank n Fṛansa");
    result.put("GBP","Apund Aglizi");
    result.put("GEK","Akupun n Larin Jyujya");
    result.put("GEL","Alari n Jyurjya");
    result.put("GHC","Asidi Aɣani");
    result.put("GHS","Asidi n Ɣana");
    result.put("GIP","Apawnd n Jibraltar");
    result.put("GMD","Adalasi Agambi");
    result.put("GNF","Afrank n Ɣinya");
    result.put("GNS","Afrank Aɣini");
    result.put("GQE","Akwili n Ɣinya Tasebgast");
    result.put("GRD","Adrakmi n Grik");
    result.put("GTQ","Aketzal n Gwatimala");
    result.put("GWE","Askudu n Ɣinya tapurtugit");
    result.put("GWP","Apisu n Ɣinya-Bisaw");
    result.put("GYD","Adular n Guyana");
    result.put("HKD","Adular n Hung Kung");
    result.put("HNL","Alampir n Hunduras");
    result.put("HRD","Adinar n Kaṛwasya");
    result.put("HRK","Akuna n Kaṛwasya");
    result.put("HTG","Agurd n Hayti");
    result.put("HUF","Afurint n Hungaṛya");
    result.put("IDR","Arupi n Indunisya");
    result.put("IEP","Apawnd n Irland");
    result.put("ILP","Apawnd n Izrayil");
    result.put("ILR","Acikil n Izrayil(1980–1985)");
    result.put("ILS","Acikil amaynut n Izrayil");
    result.put("INR","Arupi Ahendi");
    result.put("IQD","Adinar n Ɛiṛaq");
    result.put("IRR","Ariyal n Iran");
    result.put("ISK","Akurun n Island");
    result.put("ITL","Alir n Ṭelyan");
    result.put("JMD","Adular n Jamayik");
    result.put("JOD","Adinar Jurdan");
    result.put("JPY","Ayen Ajappuni");
    result.put("KES","Aciling Akini");
    result.put("KGS","Asum n Kirigistan");
    result.put("KHR","Ariyil n Kambuj");
    result.put("KMF","Afrank Akamiruni");
    result.put("KPW","Awun n Tkurit n ugafa");
    result.put("KRH","Ahwan n Tkirit n unẓul (1953–1962)");
    result.put("KRO","Ahwan n Tkirit n unẓul (1945–1953)");
    result.put("KRW","Ahwan n Tkirit n unẓul");
    result.put("KWD","Adinarn Kuwayt");
    result.put("KYD","Adular n tegzirin Kayman");
    result.put("KZT","Atunj n Kazaxistan");
    result.put("LAK","Akip n Laws");
    result.put("LBP","Apawnd n Liban");
    result.put("LKR","Arupi n Srilanka");
    result.put("LRD","Adular Alibiri");
    result.put("LSL","Aluṭi Alizuṭi");
    result.put("LTL","Alitas n Litwanya");
    result.put("LTT","Atalonas n Litwanya");
    result.put("LUC","Afrank yettwaseklaten n Luksumburg");
    result.put("LUF","Afrank n Luksumburg");
    result.put("LUL","Afrank adriman n Luksumburg");
    result.put("LVL","Alats n Letunya");
    result.put("LVR","Arubl n Litunya");
    result.put("LYD","Adinar Alibi");
    result.put("MAD","Adirham Amerruki");
    result.put("MAF","Afrank n Meṛṛuk");
    result.put("MDL","Alu n Muldavya");
    result.put("MGA","Aryari Amalgac");
    result.put("MGF","Afrank n Madakaskaṛ");
    result.put("MKD","Adenar n Masidunya");
    result.put("MLF","Afrank n Mali");
    result.put("MMK","Akyat n Myanmar");
    result.put("MNT","Atugrik n Mungulya");
    result.put("MOP","Apataka n Makaw");
    result.put("MRO","Agiya Amuriṭani (1973–2017)");
    result.put("MRU","Agiya Amuriṭani");
    result.put("MTL","Alir n Malt");
    result.put("MTP","Apawnd n Malt");
    result.put("MUR","Arupi Amurisi");
    result.put("MVP","Arupi n Maldiv");
    result.put("MVR","Arufiya n Maldiv");
    result.put("MWK","Akwaca Amalawi");
    result.put("MXN","Apisu Miksik");
    result.put("MXP","Apisu n lfeṭṭa n Miksik (1861–1992)");
    result.put("MXV","Aferdis n uselket n Miksi (UDI)");
    result.put("MYR","Aringgit n Malizya");
    result.put("MZE","Askudu n Muzumbik");
    result.put("MZM","Amitikal Amuzembiqi");
    result.put("MZN","Amitikal n Muzumbik");
    result.put("NAD","Adular Anamibi");
    result.put("NGN","Anayra Anijiri");
    result.put("NIC","Akurduba n Nikaragwa (1912–1988)");
    result.put("NIO","Akurduba n Nikaragwa");
    result.put("NLG","Aflurin n Huland");
    result.put("NOK","Akurun n Nurvij");
    result.put("NPR","Arupi n Nipal");
    result.put("NZD","Adular n Ziland Tamaynut");
    result.put("OMR","Ariyal n Ɛuman");
    result.put("PAB","Abalbwa n Panama");
    result.put("PEI","Inti n Piru");
    result.put("PEN","Asul amaynut n Piru");
    result.put("PES","Asul n Piru (1863–1985)");
    result.put("PGK","Akina n Papwazi n Ɣinya Tamaynut");
    result.put("PHP","Apisu n Filipin");
    result.put("PKR","Arupi n Pakistan");
    result.put("PLN","Azluti n Puland");
    result.put("PLZ","Azluti n Pulund (1950–1995)");
    result.put("PTE","Askudu n Purtugal");
    result.put("PYG","Agarani n Paragway");
    result.put("QAR","Ariyal n Qatar");
    result.put("RHD","Adular Arudizyan");
    result.put("ROL","Alu aqbuṛ n Rumanya (1952–2005)");
    result.put("RON","Alu n Rumanya");
    result.put("RSD","Adinar n Ṣirbya");
    result.put("RUB","Arubl n Rrus");
    result.put("RUR","Arubl n Rrus (1991–1998)");
    result.put("RWF","Afrank Aruwandi");
    result.put("SAR","Aryal Asuɛudi");
    result.put("SBD","Adular n tegzirin Salumun");
    result.put("SCR","Arupi Aseycili");
    result.put("SDD","Adinar n Sudan (1992–2007)");
    result.put("SDG","Apund Asudani");
    result.put("SDP","Apawnd n Sudan (1956–2007)");
    result.put("SEK","Akurun n Swid");
    result.put("SGD","Adular n Sangapur");
    result.put("SHP","Apund Asant Ilini");
    result.put("SIT","Atular n Sluvinya");
    result.put("SKK","Akurun n Sluvakya");
    result.put("SLL","Alyun");
    result.put("SOS","Aciling Aṣumali");
    result.put("SRD","Adular n Surinam");
    result.put("SRG","Aflurin n Surinam");
    result.put("SSP","Apawnd n Sudan n Unẓul");
    result.put("STD","Asw Ṭum d Udubra Amenzay (1977–2017)");
    result.put("STN","Asw Ṭum d Udubra Amenzay");
    result.put("SUR","Arubl n Suvyat");
    result.put("SVC","Akulun n Salvadur");
    result.put("SYP","Apawnd n Surya");
    result.put("SZL","Alilangini");
    result.put("THB","Abaht n Tayland");
    result.put("TJR","Arubl n Ṭajikistan");
    result.put("TJS","Asumuni n Ṭajikistan");
    result.put("TMM","Amanat n Ṭurkmanistan");
    result.put("TMT","Amanat amaynut n Ṭurkmanistan");
    result.put("TND","Adinar Atunsi");
    result.put("TOP","Apanga n Ṭunga");
    result.put("TPE","Askudu n Timur");
    result.put("TRL","Apawnd n Ṭurk (1844–2005)");
    result.put("TRY","Apawnd n Ṭurk");
    result.put("TTD","Adular n Triniti-d-Ṭubagu");
    result.put("TWD","Adular amaynut n Taywan");
    result.put("TZS","Aciling Aṭanẓani");
    result.put("UAH","Ahrivnya n Ukrin");
    result.put("UAK","Akarbuvanit n Ukrin (1992–1996)");
    result.put("UGS","Aciling n Uganda (1966–1987)");
    result.put("UGX","Aciling Awgandi");
    result.put("USD","Adular WD");
    result.put("USN","Adular n Marikan (azekka–yen)");
    result.put("USS","Adular n Marikan (ass–en)");
    result.put("UYI","Apisu n Urugway (iferdisen s umatar)");
    result.put("UYP","Apisu n Urugway (1975–1993)");
    result.put("UYU","Apisu n Urugway");
    result.put("UZS","Asum n Uzbikistan");
    result.put("VEB","Abulivaṛ n Vinizwila (1871–2008)");
    result.put("VEF","Abulivaṛ n Vinizwila (2008–2018)");
    result.put("VES","Abulivaṛ n Vinizwila");
    result.put("VND","Adung n Vyitnam");
    result.put("VNN","Adung n Vyitnam (1978–1985)");
    result.put("VUV","Avatu n Vanuyatu");
    result.put("WST","Atala n Samwa");
    result.put("XAF","Afrank BCEA CFA");
    result.put("XAG","lfeṭṭa");
    result.put("XAU","Awraɣ");
    result.put("XBA","Aferdis n tufut uddis (URKU)");
    result.put("XBB","Aferdis n tedrimt n tufurt (UME–6)");
    result.put("XBC","Aferdis n umiḍan n turfut (UEC–9)");
    result.put("XBD","Aferdis n umiḍan 17 n turfut (UEC–17)");
    result.put("XCD","Adular n Karayib n usammar");
    result.put("XDR","droit de tirage spécial");
    result.put("XEU","Aferdis n umiḍan n turfut (ACU)");
    result.put("XFO","Afrank awraɣ");
    result.put("XFU","Afrank UIC");
    result.put("XOF","Afrank BCEAO CFA");
    result.put("XPD","Palladium");
    result.put("XPF","Afrank CFP");
    result.put("XPT","Platin");
    result.put("XRE","Anaw n idran RINET");
    result.put("XSU","Asukr");
    result.put("XTS","(tadrimt n usefkyed)");
    result.put("XUA","Aferdis n umiḍan ADB");
    result.put("XXX","Tadrimt tarussint neɣ tarameɣtut");
    result.put("YDD","Adinar n Yaman");
    result.put("YER","Ariyal n Yaman");
    result.put("YUD","Adinar n Yuguslavya amaynut (1966–1989)");
    result.put("YUM","Adinar n Yuguslavya amaynut (1994–2003)");
    result.put("YUN","Adinar n Yuguslavya yettwaselkaten (1990–1992)");
    result.put("ZAL","Arand n Tefriqt n unzul (adriman)");
    result.put("ZAR","Arand Afriqi n Wadda");
    result.put("ZMK","Akwaca Azambi (1968–2012)");
    result.put("ZMW","Akwaca Azambi");
    result.put("ZRN","Azayir amaynut n Zayir");
    result.put("ZRZ","Azayir n Zayir");
    result.put("ZWD","Adular Azimbabwi");
    result.put("ZWL","Adular n zimbabwi (2009)");
    result.put("ZWR","Adular n zimbabwi (2008)");
    return result;
  }
}
