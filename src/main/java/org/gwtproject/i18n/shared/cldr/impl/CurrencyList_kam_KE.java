...
public class CurrencyList_kam_KE extends CurrencyList_kam {
  ...
  protected HashMap<String, String> loadNamesMap() {
    ...
    result.put("EGP","Vaundi ya Misili");
    ...
    result.put("GMD","Ndalasi ya Gambia");
    ...
    result.put("NAD","Ndola ya Namibia");
    ...
    result.put("SDG","Vaũndi ya Sudani");
    result.put("SHP","Vaũndi ya Santahelena");
    result.put("SLL","Leoni");
    result.put("SOS","Silingi ya Somalia");
    ...
    result.put("TND","Ndinari ya Tunisia");
    result.put("TZS","Silingi ya Tanzania");
    result.put("UGX","Silingi ya Uganda");
    result.put("USD","Ndola ya Marekani");
    ...
    result.put("ZWD","Ndola ya Zimbabwe");
    return result;
  }
}
