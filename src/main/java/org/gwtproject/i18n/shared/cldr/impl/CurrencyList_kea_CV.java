...
public class CurrencyList_kea_CV extends CurrencyList_kea {
  public CurrencyData getDefault() {
    return new CurrencyDataImpl("CVE","​",2,"​","​");
  }
  ...
  protected HashMap<String, CurrencyData> loadCurrencyMap() {
    ...
    // Skudu Kabuverdianu
    result.put("CVE", new CurrencyDataImpl("CVE","​",2,"​","​"));
    // CYP
  ...
  protected HashMap<String, String> loadNamesMap() {
    ...
    result.put("BHD","Dinar di Barain");
    result.put("BIF","Franku borundes");
    result.put("BRL","Rial brazileru");
    result.put("BWP","Pula di Botsuana");
    result.put("CAD","Dola kanadianu");
    result.put("CDF","Franku kongoles");
    result.put("CHF","Franku suisu");
    result.put("CNY","Iuan xines");
    result.put("CVE","Skudu Kabuverdianu");
    result.put("DJF","Franku di Djibuti");
    result.put("DKK","Kuroa dinamarkeza");
    result.put("DZD","Dinar arjelinu");
    result.put("EGP","Libra ejipsiu");
    result.put("ERN","Nafka di Eritreia");
    result.put("ETB","Bir etiopi");
    result.put("EUR","Euro");
    result.put("GBP","Libra britaniku");
    result.put("GHC","Sedi di Gana (1979–2007)");
    result.put("GMD","Dalasi");
    result.put("GNS","Sili");
    result.put("HKD","Dola di Ong Kong");
    result.put("IDR","Rupia indoneziu");
    result.put("INR","Rupia indianu");
    result.put("JPY","Ieni japones");
    result.put("KES","Xelin kenianu");
    result.put("KMF","Franku di Komoris");
    result.put("KRW","Won sul-koreanu");
    result.put("LRD","Dola liberianu");
    result.put("LSL","Loti di Lezotu");
    result.put("LYD","Dinar libiu");
    result.put("MAD","Diren marokinu");
    result.put("MGA","Ariari di Madagaskar");
    result.put("MRO","Ougia (1973–2017)");
    result.put("MRU","Ougia");
    result.put("MUR","Rupia di Maurisias");
    result.put("MWK","Kuaxa di Malaui");
    result.put("MXN","Pezu mexikanu");
    result.put("MZM","Metikal");
    result.put("NAD","Dola namibianu");
    result.put("NGN","Naira");
    result.put("NOK","Kuroa norueges");
    result.put("PLN","Zloty polaku");
    result.put("RUB","Rublu rusu");
    result.put("RWF","Franku ruandes");
    result.put("SAR","Rial saudita");
    result.put("SCR","Rupia di Seixelis");
    result.put("SDG","Libra sudanes");
    result.put("SDP","Libra sudanes antigu (1957–1998)");
    result.put("SEK","Kuroa sueku");
    result.put("SHP","Libra di Santa Ilena");
    result.put("SLL","Leone di Sera Leoa");
    result.put("SOS","Xelin somalianu");
    result.put("STD","Dobra di Sãu Tume i Prínsipi (1977–2017)");
    result.put("STN","Dobra di Sãu Tume i Prínsipi");
    result.put("SZL","Lilanjeni");
    result.put("THB","Baht tailandes");
    result.put("TND","Dinar tunizianu");
    result.put("TRY","Lira turku");
    result.put("TWD","Dola Novu di Taiwan");
    result.put("TZS","Xelin di Tanzania");
    result.put("UGX","Xelin ugandensi");
    result.put("USD","Dola merkanu");
    result.put("XAF","Franku CFA (BEAC)");
    result.put("XOF","Franku CFA (BCEAO)");
    result.put("XXX","Mueda diskonxedu");
    result.put("ZAR","Rand sulafrikanu");
    result.put("ZMK","Kuaxa zambianu (1968–2012)");
    result.put("ZMW","Kuaxa zambianu");
    result.put("ZWD","Dola di Zimbabue (1980–2008)");
    return result;
  }
}
