...
public class CurrencyList_ki_KE extends CurrencyList_ki {
  ...
  protected HashMap<String, String> loadNamesMap() {
    ...
    result.put("CAD","Ndora ya Kananda");
    ...
    result.put("SDG","Pauni ya Sudani");
    result.put("SHP","Pauni ya Santahelena");
    result.put("SLL","Leoni");
    result.put("SOS","ciringi cia cumarĩ");
    ...
    result.put("TZS","ciringi cia Tanizania");
    result.put("UGX","ciringi cia Ũganda");
    result.put("USD","Ndora cia Amerika");
