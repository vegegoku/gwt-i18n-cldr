...
public class CurrencyList_kln_KE extends CurrencyList_kln {
  ...
  protected HashMap<String, String> loadNamesMap() {
    ...
    result.put("AED","Rabisiekab Kibagegeitab arabuk");
    result.put("AOA","Rabisiekab Angolan");
    result.put("AUD","Dolaitab Australian");
    result.put("BHD","Rabisiekab Bahrain");
    result.put("BIF","Rabisiekab Burundi");
    result.put("BWP","Rabisiekab Botswana");
    result.put("CAD","Dolaitab Kanada");
    result.put("CDF","Rabisiekab Congo");
    result.put("CHF","Rabisiekab Swiss");
    result.put("CNY","Rabisiekab China");
    result.put("CVE","Rabisiekab Kepuvede");
    result.put("DJF","Rabisiekab Jibuti");
    result.put("DZD","Rabisiekab Algerian");
    result.put("EGP","Pauditab Misri");
    result.put("ERN","Rabisiekab Eritrea");
    result.put("ETB","Rabisiekab Ethiopia");
    result.put("EUR","Yuroit");
    result.put("GBP","pounditab Uingereza");
    result.put("GHC","Rabisiekab Ghana");
    result.put("GMD","Rabisiekab Gambia");
    result.put("GNS","Rabisiekab Guinea");
    result.put("INR","Rabisiekab India");
    result.put("JPY","Rabisiekab Japan");
    result.put("KES","Silingitab ya Kenya");
    result.put("KMF","Rabisiekab Komoro");
    result.put("LRD","Dolaitab Liberia");
    result.put("LSL","Rabisiekab Lesoto");
    result.put("LYD","Rabisiekab Libya");
    result.put("MAD","Rabisiekab Moroccan");
    result.put("MGA","Rabisiekab Malagasy");
    result.put("MRO","Rabisiekab Mauritania (1973–2017)");
    result.put("MRU","Rabisiekab Mauritania");
    result.put("MUR","Rabisiekab Mauritius");
    result.put("MWK","Rabisiekaby Malawi");
    result.put("MZM","Rabisiekab Msumbiji");
    result.put("NAD","Dolaitab Namibia");
    result.put("NGN","Rabisiekab Nigeria");
    result.put("RWF","Rabisiekab Rwanda");
    result.put("SAR","Rabisiekab Saudia");
    result.put("SCR","Rabisiekab Shelisheli");
    result.put("SDG","Pouditab Sudan");
    result.put("SHP","Pouditab helena ne tilil");
    result.put("SLL","Leonit");
    result.put("SOS","siligitab Somalia");
    result.put("STD","Rabisiekab Sao Tome ak Principe (1977–2017)");
    result.put("STN","Rabisiekab Sao Tome ak Principe");
    result.put("SZL","Lilangenit");
    result.put("TND","RabisiekabTunisia");
    result.put("TZS","silingitab Tanzania");
    result.put("UGX","Silingitab Uganda");
    result.put("USD","Dolaitab ya Amareka");
    result.put("XAF","Rabisiekab CFA BEAC");
    result.put("XOF","Rabisiekab CFA BCEAO");
    result.put("ZAR","Randitab Afrika nebo murot tai");
    result.put("ZMK","Kwachaitab Zambia (1968–2012)");
    result.put("ZMW","Kwachaitab Zambia");
    result.put("ZWD","Dolaitab ya Zimbabwe");
    return result;
  }
}
