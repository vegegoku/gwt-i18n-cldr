...
public class CurrencyList_km_KH extends CurrencyList_km {
  public CurrencyData getDefault() {
    return new CurrencyDataImpl("KHR","៛",2,"៛","៛");
  }
  ...
  protected HashMap<String, CurrencyData> loadCurrencyMap() {
    ...
    // រៀល​កម្ពុជា
    result.put("KHR", new CurrencyDataImpl("KHR","៛",2,"៛","៛"));
    // ហ្វ្រង់​កូម័រ
  ...
  protected HashMap<String, String> loadNamesMap() {
    ...
    result.put("AMD","ដ្រាំ​អាមេនី");
    result.put("ANG","ហ្គីឌិន​ហុល្លង់​អង់ទីលៀន");
    result.put("AOA","ក្វាន់ហ្សា​អង់ហ្គោឡា");
    result.put("ARS","ប៉េសួអាហ្សង់ទីន");
    result.put("AUD","ដុល្លារ​អូស្ត្រាលី");
    result.put("AWG","ហ្វ្រ័ររិញ​អារ៉ូបា");
    result.put("AZN","ម៉ាណាត​អាស៊ែបៃហ្សង់");
    result.put("BAM","ម៉ាក​អាច​បម្លែង​បាន​បូស្នី");
    result.put("BBD","ដុល្លារ​បាបាដុស");
    result.put("BDT","តាកា​បង់ក្លាដែស");
    result.put("BGN","លីវ​ប៊ុលហ្គារី");
    result.put("BHD","ឌីណា​បារ៉ែន");
    result.put("BIF","ហ្វ្រង់​ប៊ូរុនឌី");
    result.put("BMD","ដុល្លារ​ប៊ឺមុយដា");
    result.put("BND","ដុល្លារ​ប្រុយណេ");
    result.put("BOB","បូលីវីណូ​បូលីវី");
    result.put("BRL","រៀល​ប្រេស៊ីល");
    result.put("BSD","ដុល្លារ​បាហាម៉ា");
    result.put("BTN","ញូលត្រឹម​ប៊ូតាន");
    result.put("BWP","ពូឡា​បុតស្វាណា");
    result.put("BYN","រ៉ូបល​បេឡារុស");
    result.put("BYR","រ៉ូបល​បេឡារុស (2000–2016)");
    result.put("BZD","ដុល្លារ​បេលី");
    result.put("CAD","ដុល្លារ​កាណាដា");
    result.put("CDF","ហ្វ្រង់​កុងហ្គោ");
    result.put("CHF","ហ្វ្រង់ស្វីស");
    result.put("CLP","ប៉េសូឈីលី");
    result.put("CNH","យ៉ន់ចិន (ក្រៅប្រទេស)");
    result.put("CNY","យ៉ន់​ចិន");
    result.put("COP","ប៉េសូកូឡុំប៊ី");
    result.put("CRC","កូឡុង​កូស្តារីកា");
    result.put("CUC","ប៉េសូ​គុយបាអាច​បម្លែង​បាន");
    result.put("CUP","ប៉េសូគុយបា");
    result.put("CVE","អ៊ីស្កូឌូ​កាប់វែរ");
    result.put("CZK","កូរុណា​សាធារណៈ​ឆេក");
    result.put("DJF","ហ្វ្រង់​ជីប៊ូទី");
    result.put("DKK","ក្រូណេ​ដាណាម៉ាក់");
    result.put("DOP","ប៉េសូដូមីនីក");
    result.put("DZD","ឌីណា​អាល់ស៊េរី");
    result.put("EGP","ផោនអេហ្ស៊ីប");
    result.put("ERN","ណាក់ហ្វាអេរីទ្រា");
    result.put("ETB","ប៊័រ​អេត្យូពី");
    result.put("EUR","អឺរ៉ូ");
    result.put("FJD","ដុល្លារ​ហ្វីជី");
    result.put("FKP","ផោន​កោះ​ហ្វក់ឡែន");
    result.put("GBP","ផោនចក្រភពអង់គ្លេស");
    result.put("GEL","ឡារី​​ហ្សកហ្ស៊ី");
    result.put("GHS","ស៊ីឌី​ហ្គាណា");
    result.put("GIP","ផោន​ហ្ស៊ីប្រាល់តា");
    result.put("GMD","ដាឡាស៊ី​ហ្គាំប៊ី");
    result.put("GNF","ហ្វ្រង់​ហ្គីណេ");
    result.put("GTQ","ហ្គីស្សាល​ក្វាតេម៉ាឡា");
    result.put("GYD","ដុល្លារ​ហ្គីយ៉ាន");
    result.put("HKD","ដុល្លារ​ហុងកុង");
    result.put("HNL","លិមពីរ៉ា​ហុងឌូរ៉ាស");
    result.put("HRK","គូណា​ក្រូអាត");
    result.put("HTG","គោឌី​ហៃទី");
    result.put("HUF","ហ្វូរីន​ហុងគ្រី");
    result.put("IDR","រូពីឥណ្ឌូណេស៊ី");
    result.put("ILS","ស៊ីគែលថ្មីអ៊ីស្រាអែល");
    result.put("INR","រូពីឥណ្ឌា");
    result.put("IQD","ឌីណា​អ៊ីរ៉ាក់");
    result.put("IRR","រៀល​អ៊ីរ៉ង់");
    result.put("ISK","ក្រូណា​អ៊ីស្លង់");
    result.put("JMD","ដុល្លារ​ហ្សាម៉ាអ៊ីក");
    result.put("JOD","ឌីណា​ហ្ស៊កដានី");
    result.put("JPY","យេន​ជប៉ុន");
    result.put("KES","ស៊ីលិញ​កេនយ៉ា");
    result.put("KGS","សុម​កៀហ្ស៊ីស៊ីស្ថាន");
    result.put("KHR","រៀល​កម្ពុជា");
    result.put("KMF","ហ្វ្រង់​កូម័រ");
    result.put("KPW","វ៉ុនកូរ៉េខាងជើង");
    result.put("KRW","វ៉ុនកូរ៉េខាងត្បូង");
    result.put("KWD","ឌីណា​គុយវ៉ែត");
    result.put("KYD","ដុល្លារ​កោះ​កៃម៉ែន");
    result.put("KZT","តង់ហ្គី​កាហ្សាក់ស្ថាន");
    result.put("LAK","គីប​ឡាវ");
    result.put("LBP","ផោន​លីបង់");
    result.put("LKR","រូពីស្រីលង្កា");
    result.put("LRD","ដុល្លារ​លីប៊ី");
    result.put("LTL","លីតា​លីទុយអានី");
    result.put("LVL","ឡាត់​ឡេតូនី");
    result.put("LYD","ឌីណា​លីប៊ី");
    result.put("MAD","ឌៀរហាំ​ម៉ារ៉ុក");
    result.put("MDL","លូ​ម៉ុលដាវី");
    result.put("MGA","អារៀរី​ម៉ាឡាហ្គាស៊ី");
    result.put("MKD","ឌីណាម៉ាសេដូនី");
    result.put("MMK","គីយ៉ាត​ភូមា");
    result.put("MNT","ទូរីក​ម៉ុងហ្គោលី");
    result.put("MOP","ប៉ាតាកា​ម៉ាកាវ");
    result.put("MRO","អ៊ូហ្គីយ៉ា​ម៉ូរីតានី (1973–2017)");
    result.put("MRU","អ៊ូហ្គីយ៉ា​ម៉ូរីតានី");
    result.put("MUR","រូពីម៉ូរីតានី");
    result.put("MVR","រ៉ូហ្វីយ៉ា​ម៉ាល់ឌីវ");
    result.put("MWK","ក្វាចា​ម៉ាឡាវី");
    result.put("MXN","ប៉េសូម៉ិកសិក");
    result.put("MYR","រីងហ្គីត​ម៉ាឡេស៊ី");
    result.put("MZN","មីទីខល​ម៉ូសំប៊ិក");
    result.put("NAD","ដុល្លារ​ណាមីប៊ី");
    result.put("NGN","ណៃរ៉ា​នីហ្សេរីយ៉ា");
    result.put("NIO","ខឌូបា​នីការ៉ាហ្គា");
    result.put("NOK","ក្រូណេ​ន័រវ៉េ");
    result.put("NPR","រូពីនេប៉ាល់");
    result.put("NZD","ដុល្លារ​នូវែលសេឡង់");
    result.put("OMR","រៀល​រូម៉ានី");
    result.put("PAB","បាល់ប៉ៅ​ប៉ាណាម៉ា");
    result.put("PEN","ញូវ៉ូសូល​ប៉េរូ");
    result.put("PGK","គីណាប៉ាពួញូហ្គីណេ");
    result.put("PHP","ប៉េសូហ្វីលីពីន");
    result.put("PKR","រូពីប៉ាគីស្ថាន");
    result.put("PLN","ហ្សូទី​ប៉ូឡូញ");
    result.put("PYG","ហ្គូរីនី​ប៉ារ៉ាហ្គាយ");
    result.put("QAR","រៀល​កាតា");
    result.put("RON","លូ​រូម៉ានី");
    result.put("RSD","ឌីណាស៊ែប");
    result.put("RUB","រ៉ូបល​រុស្ស៊ី");
    result.put("RWF","ហ្វ្រង់​រវ៉ាន់ដា");
    result.put("SAR","រីយ៉ាល​អារ៉ាប៊ីសាអូឌីត");
    result.put("SBD","ដុល្លារ​កោះ​សូឡូម៉ុង");
    result.put("SCR","រូពី​សីស្ហែល");
    result.put("SDG","ផោន​ស៊ូដង់");
    result.put("SEK","ក្រូណា​ស៊ុយអែត");
    result.put("SGD","ដុល្លារ​​សិង្ហបូរី");
    result.put("SHP","ផោន​សាំងហេឡេណា");
    result.put("SLL","លីអ៊ុន​សៀរ៉ាឡេអូន");
    result.put("SOS","ស៊ីលិញ​សូម៉ាលី");
    result.put("SRD","ដុល្លារ​សូរីណាម");
    result.put("SSP","ផោន​ស៊ូដង់​ខាង​ត្បូង");
    result.put("STD","ឌូប្រា​សៅតូម៉េ និងប្រាំងស៊ីប (1977–2017)");
    result.put("STN","ឌូប្រា​សៅតូម៉េ និងប្រាំងស៊ីប");
    result.put("SYP","ផោន​ស៊ីរី");
    result.put("SZL","លីឡាងហ្គីនី​ស្វាស៊ីឡង់");
    result.put("THB","បាត​ថៃ");
    result.put("TJS","សូមុនី​តាហ្ស៊ីគីស្ថាន");
    result.put("TMT","ម៉ាណាត​តួកម៉េនីស្ថាន");
    result.put("TND","ឌីណាទុយនេស៊ី");
    result.put("TOP","ប៉ាអង់កា​តុងហ្គា");
    result.put("TRY","លីរ៉ាទួរគី");
    result.put("TTD","ដុល្លារ​ទ្រីនីដាដ និងតូបាហ្គោ");
    result.put("TWD","ដុល្លារ​តៃវ៉ាន់");
    result.put("TZS","ស៊ីលិញ​តង់សានី");
    result.put("UAH","ហ៊ូនីយ៉ា​អ៊ុយក្រែន");
    result.put("UGX","ស៊ីលិញ​អ៊ូហ្គង់ដា");
    result.put("USD","ដុល្លារ​អាមេរិក");
    result.put("UYU","ប៉េសូអ៊ុយរូហ្គាយ");
    result.put("UZS","សុមអ៊ូបេគីស្ថាន");
    result.put("VEF","ប៊ូលីវ៉ា​វ៉េណេស៊ុយអេឡា (2008–2018)");
    result.put("VES","ប៊ូលីវ៉ា​វ៉េណេស៊ុយអេឡា");
    result.put("VND","ដុង​វៀតណាម");
    result.put("VUV","វ៉ាទូវ៉ានូអាទូ");
    result.put("WST","តាឡា​សាម័រ");
    result.put("XAF","ហ្វ្រង់ CFA អាហ្វ្រិកកណ្តាល");
    result.put("XCD","ដុល្លារ​ការ៉ាប៊ីន​ខាង​កើត");
    result.put("XOF","ហ្វ្រង់ CFA អាហ្វ្រិកខាងលិច");
    result.put("XPF","ហ្វ្រង់ CFP");
    result.put("XXX","រូបិយប័ណ្ណ​មិនស្គាល់");
    result.put("YER","រៀល​យេម៉ែន");
    result.put("ZAR","រ៉ង់អាហ្វ្រិកខាងត្បូង");
    result.put("ZMK","ក្វាចា សំប៊ី (1968–2012)");
    result.put("ZMW","ក្វាចាហ្សំប៊ី");
    return result;
  }
}
