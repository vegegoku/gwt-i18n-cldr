...
public class CurrencyList_kn_IN extends CurrencyList_kn {
  ...
  protected HashMap<String, String> loadNamesMap() {
    ...
    result.put("AED","ಸಂಯುಕ್ತ ಅರಬ್‌ ಎಮಿರೇಟ್‌‌ಗಳ ದಿರಾಮ್‌‌");
    result.put("AFN","ಅಫ್‌ಘನ್ ಅಫಘಾನಿ");
    result.put("ALL","ಅಲ್‌ಬೇನಿಯನ್ ಲೆಕ್");
    result.put("AMD","ಅರ್ಮೆನಿಯನ್ ಡ್ರಾಮ್");
    result.put("ANG","ನೆದರ್ಲೆಂಡ್ಸ್ ಆಂಟಿಲಿಯನ್ ಗಿಲ್ಡರ್");
    result.put("AOA","ಅಂಗೋಲಾದ ಕ್ವಾನ್ಝಾ");
    result.put("ARS","ಅರ್ಜೆಂಟಿನಾ ಪೆಸೊ");
    result.put("AUD","ಆಸ್ಟ್ರೇಲಿಯನ್ ಡಾಲರ್‌");
    result.put("AWG","ಅರುಬನ್ ಫ್ಲೊರೀನ್‌‌");
    result.put("AZN","ಅಝರ್‌ಬೈಜಾನಿ ಮನಾತ್");
    result.put("BAM","ಬೋಸ್ನಿಯಾ-ಹರ್ಜ್‌ಗೋವಿನ ಪರಿವರ್ತನೀಯ ಗುರುತು");
    result.put("BBD","ಬರ್ಬಾಡಿಯನ್ ಡಾಲರ್");
    result.put("BDT","ಬಾಂಗ್ಲಾದೇಶದ ಟಾಕಾ");
    result.put("BGN","ಬಲ್ಗೇರಿಯನ್ ಲೆವ್");
    result.put("BHD","ಬಹ್‌‌ರೈನಿ ದಿನಾರ್");
    result.put("BIF","ಬುರುಂದಿಯನ್ ಫ್ರಾಂಕ್");
    result.put("BMD","ಬರ್ಮುಡನ್ ಡಾಲರ್");
    result.put("BND","ಬ್ರೂನಿ ಡಾಲರ್");
    result.put("BOB","ಬೊಲಿವಿಯಾದ ಬೊಲಿವಿಯಾನೊ");
    result.put("BRL","ಬ್ರೆಜಿಲಿಯನ್‌ ರಿಯಲ್");
    result.put("BSD","ಬಹಾಮಿಯನ್ ಡಾಲರ್");
    result.put("BTN","ಭೂತಾನೀಸ್ ನುಲ್ತರಮ್");
    result.put("BWP","ಬೋಟ್ಸ್‌ವಾನನ್ ಪುಲಾ");
    result.put("BYN","ಬೆಲಾರುಸಿಯನ್ ರೂಬಲ್");
    result.put("BYR","ಬೆಲಾರುಸಿಯನ್ ರೂಬಲ್ (2000–2016)");
    result.put("BZD","ಬೆಲೀಜ್ ಡಾಲರ್");
    result.put("CAD","ಕೆನಡಾದ ಡಾಲರ್");
    result.put("CDF","ಕಾಂಗೋಲೀಸ್ ಫ್ರಾಂಕ್");
    result.put("CHF","ಸ್ವಿಸ್ ಫ್ರಾಂಕ್");
    result.put("CLP","ಚಿಲಿಯ ಪೆಸೊ");
    result.put("CNY","ಚೈನೀಸ್ ಯುವಾನ್");
    result.put("COP","ಕೊಲೊಂಬಿಯೋದ ಪೆಸೊ");
    result.put("CRC","ಕೋಸ್ಟ ರಿಕನ್ ಕೊಲನ್");
    result.put("CUC","ಕ್ಯುಬಾದ ಪರಿವರ್ತನೀಯ ಪೆಸೊ");
    result.put("CUP","ಕ್ಯೂಬಾದ ಪೆಸೊ");
    result.put("CVE","ಕೇಪ್ ವರ್ಡಿನ್ ಎಸ್‌ಕೂಡೊ");
    result.put("CZK","ಝೆಕ್ ಗಣರಾಜ್ಯ ಕೊರೂನ");
    result.put("DJF","ಜಿಬೊಟಿಯನ್ ಫ್ರಾಂಕ್");
    result.put("DKK","ಡ್ಯಾನಿಶ್ ಕ್ರೋನ್");
    result.put("DOP","ಡೊಮಿನಿಕನ್ ಪೆಸೊ");
    result.put("DZD","ಅಲ್ಗೇರಿಯನ್ ದಿನಾರ್");
    result.put("EGP","ಈಜಿಪ್ಷಿಯನ್ ಪೌಂಡ್‍");
    result.put("ERN","ಎರಿತ್ರಿಯನ್ ನಕ್ಫಾ");
    result.put("ETB","ಇಥಿಯೋಪಿಯನ್ ಬಿರ್");
    result.put("EUR","ಯೂರೊ");
    result.put("FJD","ಫಿಜಿಯನ್ ಡಾಲರ್");
    result.put("FKP","ಫಾಲ್ಕ್‌ಲ್ಯಾಂಡ್ ದ್ವೀಪಗಳ ಪೌಂಡ್");
    result.put("GBP","ಬ್ರಿಟೀಷ್ ಪೌಂಡ್");
    result.put("GEL","ಜಾರ್ಜಿಯಾದ ಲಾರಿ");
    result.put("GHS","ಘಾನಾದ ಸೆದಿ");
    result.put("GIP","ಗಿಬ್ರಾಲ್ಟರ್ ಪೌಂಡ್");
    result.put("GMD","ಗ್ಯಾಂಬಿಯಾದ ದಲಾಸಿ");
    result.put("GNF","ಗಿನಿಯನ್ ಫ್ರಾಂಕ್");
    result.put("GTQ","ಗ್ವಾಟೆಮಾಲಾದ ಕುಯಿಟ್ಸಲ್‌‌");
    result.put("GYD","ಗುಯಾನೀಸ್‌ ಡಾಲರ್‌");
    result.put("HKD","ಹಾಂಗ್ ಕಾಂಗ್ ಡಾಲರ್");
    result.put("HNL","ಹೊಂಡುರಾನ್‌ ಲೆಂಪಿರಾ");
    result.put("HRK","ಕ್ರೊಯೆಷ್ಯಾದ ಕೂನಾ");
    result.put("HTG","ಹೈಟಿಯ ಗೋರ್ದೆ");
    result.put("HUF","ಹಂಗೇರಿಯನ್ ಫೋರಿಂಟ್");
    result.put("IDR","ಇಂಡೊನೇಷ್ಯಾ ರುಪೈ");
    result.put("ILS","ಇಸ್ರೇಲಿ ನ್ಯೂ ಶೇಖಲ್");
    result.put("INR","ಭಾರತೀಯ ರೂಪಾಯಿ");
    result.put("IQD","ಇರಾಕಿಯನ್ ದಿನಾರ್‌");
    result.put("IRR","ಇರಾನಿಯನ್ ರಿಯಲ್");
    result.put("ISK","ಐಸ್‌ಲ್ಯಾಂಡಿಕ್ ಕ್ರೋನಾ");
    result.put("JMD","ಜಮೈಕನ್ ಡಾಲರ್");
    result.put("JOD","ಜೋರ್ಡಾನಿಯನ್ ದಿನಾರ್");
    result.put("JPY","ಜಪಾನೀಸ್ ಯೆನ್");
    result.put("KES","ಕೀನ್ಯಾದ ಶಿಲ್ಲಿಂಗ್‌");
    result.put("KGS","ಕಿರ್ಗಿಸ್ತಾನಿ ಸೋಮ್");
    result.put("KHR","ಕಾಂಬೋಡಿಯನ್ ರಿಯಲ್");
    result.put("KMF","ಕೊಮೊರಿಯನ್ ಫ್ರಾಂಕ್");
    result.put("KPW","ಉತ್ತರ ಕೊರಿಯನ್ ವೋನ್");
    result.put("KRW","ದಕ್ಷಿಣ ಕೊರಿಯನ್ ವೊನ್");
    result.put("KWD","ಕುವೈತೀ ದಿನಾರ್");
    result.put("KYD","ಕೆಮ್ಯಾನ್‌ ಐಲ್ಯಾಂಡ್‌ನ ಡಾಲರ್‌");
    result.put("KZT","ಕಜಾಕಿಸ್ತಾನಿ ತೆಂಗೆ");
    result.put("LAK","ಲೋಟಿಯನ್ ಕಿಪ್");
    result.put("LBP","ಲೆಬೆನೀಸ್ ಪೌಂಡ್");
    result.put("LKR","ಶ್ರೀಲಂಕಾದ ರುಪೀ");
    result.put("LRD","ಲಿಬೇರಿಯನ್ ಡಾಲರ್");
    result.put("LSL","ಲೆಸೊತೊ ಲೊತಿ");
    result.put("LTL","ಲಿಥುನಿಯನ್‌ ಲಿತಾಸ್‌");
    result.put("LVL","ಲ್ಯಾಟ್ವಿಯನ್ ಲ್ಯಾಟ್ಸ್");
    result.put("LYD","ಲಿಬಿಯಾದ ದಿನಾರ್‌");
    result.put("MAD","ಮೊರೊಕನ್ ದಿರ್‌ಹಮ್");
    result.put("MDL","ಮಲ್ದೋವಾದ ಲೆವೂ");
    result.put("MGA","ಮಲಗಾಸಿ ಅರಿಯಾರಿ");
    result.put("MKD","ಮೆಸಡೋನಿಯನ್ ದಿನಾರ್");
    result.put("MMK","ಮ್ಯಾನ್ಮಾರ್ ಕ್ಯಾಟ್");
    result.put("MNT","ಮಂಗೋಲಿಯಾದ ತುಗ್ರಿಕ್‌‌");
    result.put("MOP","ಮಕ್ಯೂದ ಪಟಕಾ");
    result.put("MRO","ಮೌರೀಶಿಯನಿಯನ್ ಒಗಿಯ (1973–2017)");
    result.put("MRU","ಮೌರೀಶಿಯನಿಯನ್ ಒಗಿಯ");
    result.put("MUR","ಮಾರಿಷಿಯನ್ ರುಪಿ");
    result.put("MVR","ಮಾಲ್ಡೀವಿಯನ್ ರುಫಿಯಾ");
    result.put("MWK","ಮಲಾವಿಯ ಕ್ವಾಚ");
    result.put("MXN","ಮೆಕ್ಸಿಕೊದ ಪೆಸೊ");
    result.put("MYR","ಮಲೇಶಿಯನ್ ರಿಂಗಿಟ್ಟ್");
    result.put("MZN","ಮೊಝಾಂಬಿಕನ್ ಮೆಟಿಕಲ್");
    result.put("NAD","ನಮೀಬಿಯನ್ ಡಾಲರ್");
    result.put("NGN","ನೈಜೀರಿಯಾದ ನೇರಾ");
    result.put("NIO","ನಿಕಾರಗ್ವಾದ ಕರ್ದೊಬಾ");
    result.put("NOK","ನಾರ್ವೇಯ ಕ್ರೋನ್");
    result.put("NPR","ನೇಪಾಳದ ರುಪೀ");
    result.put("NZD","ನ್ಯೂಜಿಲ್ಯಾಂಡ್ ಡಾಲರ್");
    result.put("OMR","ಒಮಾನಿ ರಿಯಲ್");
    result.put("PAB","ಪನಾಮಾನಿಯನ್ ಬಲ್ಬೋವಾ");
    result.put("PEN","ಪೆರುವಿಯನ್ ಸೊಲ್");
    result.put("PGK","ಪಪುವಾ ನ್ಯೂ ಗಿನಿಯನ್ ಕಿನಾ");
    result.put("PHP","ಫಿಲಿಪ್ಪೈನ್ ಪೆಸೊ");
    result.put("PKR","ಪಾಕಿಸ್ತಾನದ ರುಪೀ");
    result.put("PLN","ಪೊಲಿಶ್ ಝ್ಲೋಟಿ");
    result.put("PYG","ಪೆರುಗ್ವೇಯ ಗ್ವಾರನೀ");
    result.put("QAR","ಖತಾರಿ ರಿಯಲ್");
    result.put("RON","ರೊಮೇನಿಯನ್ ಲೆವು");
    result.put("RSD","ಸೆರ್ಬಿಯನ್ ದಿನಾರ್");
    result.put("RUB","ರಶಿಯನ್ ರೂಬಲ್");
    result.put("RWF","ರುವಾಂಡನ್ ಫ್ರಾಂಕ್");
    result.put("SAR","ಸೌದಿ ರಿಯಾಲ್");
    result.put("SBD","ಸೊಲೊಮನ್ ದ್ವೀಪಗಳ ಡಾಲರ್");
    result.put("SCR","ಸೆಚೊಲಿಯೊಸ್ ರುಪಿ");
    result.put("SDG","ಸುಡಾನೀಸ್ ಪೌಂಡ್");
    result.put("SEK","ಸ್ವೀಡಿಷ್ ಕ್ರೋನಾ");
    result.put("SGD","ಸಿಂಗಾಪುರ್ ಡಾಲರ್‌");
    result.put("SHP","ಸೇಂಟ್ ಹೆಲೇನಾ ಪೌಂಡ್");
    result.put("SLL","ಸಿಯೆರಾ ಲಿಯೋನಿಯನ್ ಲಿಯೋನ್");
    result.put("SOS","ಸೊಮಾಲಿ ಶಿಲ್ಲಿಂಗ್");
    result.put("SRD","ಸುರಿನಾಮೀಸ್ ಡಾಲರ್");
    result.put("SSP","ದಕ್ಷಿಣ ಸೂಡಾನೀಸ್ ಪೌಂಡ್‍");
    result.put("STD","ಸಾವೊ ಟೋಮ್ ಮತ್ತು ಪ್ರಿನ್ಸಿಪ್ ದೊಬ್ರಾ (1977–2017)");
    result.put("STN","ಸಾವೊ ಟೋಮ್ ಮತ್ತು ಪ್ರಿನ್ಸಿಪ್ ದೊಬ್ರಾ");
    result.put("SYP","ಸಿರಿಯನ್ ಪೌಂಡ್");
    result.put("SZL","ಸ್ವಾಜಿ ಲಿಲಂಗೆನಿ");
    result.put("THB","ಥಾಯ್ ಬಹ್ತ್");
    result.put("TJS","ತಜಕಿಸ್ತಾನಿ ಸೊಮೋನಿ");
    result.put("TMT","ಟರ್ಕ್‍ಮೆನಿಸ್ತಾನ್ ಮನಾತ್");
    result.put("TND","ಟ್ಯುನೀಷಿಯನ್‌ ದಿನಾರ್");
    result.put("TOP","ಟೊಂಗಾ ಪಾಂಗ");
    result.put("TRY","ಟರ್ಕಿಶ್ ಲಿರಾ");
    result.put("TTD","ಟ್ರಿನಿಡಾಡ್ ಮತ್ತು ಟೊಬಾಗೊ ಡಾಲರ್");
    result.put("TWD","ನ್ಯೂ ತೈವಾನ್ ಡಾಲರ್");
    result.put("TZS","ತಾನ್‌ಜೇನಿಯನ್ ಶಿಲ್ಲಿಂಗ್");
    result.put("UAH","ಉಕ್ರೇನಿಯನ್ ಹ್ರಿವ್ನೀಯ");
    result.put("UGX","ಉಗಾಂಡನ್ ಶಿಲ್ಲಿಂಗ್");
    result.put("USD","ಅಮೆರಿಕದ ಡಾಲರ್‌");
    result.put("UYU","ಉರುಗ್ವೆಯ ಪೆಸೊ");
    result.put("UZS","ಉಜ್ಬೇಕಿಸ್ತಾನ್ ಸೊಮ್");
    result.put("VEF","ವೆನಿಜುಲಿಯನ್ ಬೊಲಿವರ್ (2008–2018)");
    result.put("VES","ವೆನಿಜುಲಿಯನ್ ಬೊಲಿವರ್");
    result.put("VND","ವಿಯೆಟ್ನಾಮೀಸ್ ಡಾಂಗ್");
    result.put("VUV","ವನೂತು ವತು");
    result.put("WST","ಸಮೋನ್ ತಲಾ");
    result.put("XAF","ಮಧ್ಯ ಆಫ್ರಿಕನ್ CFA ಫ್ರಾಂಕ್");
    result.put("XCD","ಪೂರ್ವ ಕೆರೀಬಿಯನ್ ಡಾಲರ್");
    result.put("XOF","ಪಶ್ಚಿಮ ಆಫ್ರಿಕಾದ [CFA] ಫ್ರಾಂಕ್");
    result.put("XPF","[CFP] ಫ್ರಾಂಕ್");
    result.put("XXX","ಅಪರಿಚಿತ ಕರೆನ್ಸಿ");
    result.put("YER","ಯೆಮೆನಿ ರಿಯಲ್");
    result.put("ZAR","ದಕ್ಷಿಣ ಆಫ್ರಿಕನ್ ರಾಂಡ್");
    result.put("ZMK","ಜಾಂಬಿಯಾ ಕ್ವಾಚ (1968–2012)");
    result.put("ZMW","ಜಾಂಬಿಯಾ ಕ್ವಾಚ");
    return result;
  }
}
