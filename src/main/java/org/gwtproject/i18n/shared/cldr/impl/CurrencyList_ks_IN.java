...
public class CurrencyList_ks_IN extends CurrencyList_ks {
  ...
  protected HashMap<String, CurrencyData> loadCurrencyMap() {
    ...
    // نایدَرلینٛڑ اٮ۪نٹٕلیٖیَن گِلڑَر
    ...
    // مٮ۪کسِکَن سِلوَر پٮ۪سو (۱۸۶۱–۱۹۹۲)
  ...
  protected HashMap<String, String> loadNamesMap() {
    ...
    result.put("ADP","اٮ۪ڑورَن پیسِٹا");
    result.put("AED","مُتحدہ عرب اِمارات دِرہم");
    result.put("AFN","افغان افغٲنی");
    result.put("ALL","اٮ۪لبینِیَن لِک");
    result.put("AMD","اَرمانٮ۪ن ڈرٛٮ۪م");
    result.put("ANG","نایدَرلینٛڑ اٮ۪نٹٕلیٖیَن گِلڑَر");
    result.put("AOA","اٮ۪نگولَن کوانزا");
    result.put("AOR","اٮ۪نگولَن کوانٛزا رٮ۪جِسٹاڑو");
    result.put("ARA","أرجَنٹیٖن اَسٹرل");
    result.put("ARS","أرجَنٹیٖن پِسو");
    result.put("ATS","آسٹریَن شِلِنٛگ");
    result.put("AUD","آسٹریلِیَن ڈالَر");
    result.put("AWG","اَروبَن فِلورِن");
    result.put("AZN","آزَرباجانی مَنَٹ");
    result.put("BAD","بوزنِیاہَرزِگووِنا دیٖنار");
    result.put("BAM","بوزنِیاہَرزِگووِنا کَنوٲٹیبٕل مارٕک");
    result.put("BBD","بابیڑِیَن ڈالَر");
    result.put("BDT","بَنگلادیٖشی ٹَکا");
    result.put("BEF","بَلجِیَن فرینٛک");
    result.put("BGN","بیلگیرِیَن ہاڑ لِو");
    result.put("BHD","بحریٖنی دیٖنار");
    result.put("BIF","بُرُنڑِین فرینٛک");
    result.put("BMD","بٔرمیوٗڑَن ڈالَر");
    result.put("BND","برٛونی ڈالَر");
    result.put("BOB","بولِوِیَن بولوینو");
    result.put("BOP","بولویَن پِسو");
    result.put("BOV","بولوِیَن مَوڈال");
    result.put("BRB","برٛازیٖلین کرٛوزِرو نووو");
    result.put("BRC","برٛازیٖلین کرٛوزیڑو");
    result.put("BRE","برٛازیٖلین کرٛوزِرو");
    result.put("BRL","برٛازیٖلین رِیَل");
    result.put("BRN","برٛازیٖلین کرٛوزیڑو نووو");
    result.put("BRR","برٛازیٖلین کرٛوزیرو");
    result.put("BSD","بہامِیَن ڈالر");
    result.put("BTN","بوٗٹینیٖز نگُلٹرٛم");
    result.put("BUK","بٔرمیٖز کیٹ");
    result.put("BWP","بوٹٕسوانَن پُلا");
    result.put("BYB","بِلیروشِیَن نِو رِبٕل");
    result.put("BYN","بِلیروشِیَن رِبٕل");
    result.put("BYR","بِلیروشِیَن رِبٕل (۲۰۰۰–۲۰۱۶)");
    result.put("BZD","بِلِزی ڈالر");
    result.put("CAD","کینَڑِیَن ڈالر");
    result.put("CDF","کونٛگولیٖز فرٛیک");
    result.put("CHE","وِر یوٗرو");
    result.put("CHF","سُوِز فریک");
    result.put("CHW","وِر فرٛیک");
    result.put("CLF","چِلِن یوٗنِڑیدیٖز ڑِ فومیٹو");
    result.put("CLP","چِلِن پِسو");
    result.put("CNY","چینیٖز یَن رِنمِنبی");
    result.put("COP","کولَمبِین پِسو");
    result.put("COU","ِٖیوٗنِڑیڑ ڑِ ویلور رِیل");
    result.put("CRC","کوسٹا رِکَن کولَن");
    result.put("CSD","پرٛون سٔربِین ڈالر");
    result.put("CSK","چِکوسولوواک ہاڑ کوروٗنا");
    result.put("CUP","کیوٗبَن پِسو");
    result.put("CYP","کیپروٹ پَوُڑ");
    result.put("CZK","چیک کوریٖنا");
    result.put("DDM","مٔشرِقی جٔرمَن مارٕک");
    result.put("DEM","جٔرمَن مارٕک");
    result.put("DKK","ڈٔنِش کرٛون");
    result.put("DOP","ڈومِنِکَن پِسو");
    result.put("DZD","اٮ۪لجیرِیَن ڈیٖنار");
    result.put("EEK","اٮ۪سٹونِیَن کرٛون");
    result.put("EGP","اِجِپٹِیَن پَوُنڑ");
    result.put("ERN","رِٹریٖن نَفکا");
    result.put("ESP","سِپینِش پیسِٹا");
    result.put("ETB","اِتھوپِیَن بِر");
    result.put("EUR","یوٗرو");
    result.put("FIM","فِنِش مارکا");
    result.put("FJD","فِجین ڈالر");
    result.put("FKP","فیکلینٛڑِس آیلینٛڑ پونٛڑ");
    result.put("FRF","فرٛانسِسی فرٛیک");
    result.put("GBP","برطٲنوی پاونٛڑ سٹٔرلِنٛگ");
    result.put("GEK","جارجِیَن کیوٗپَن لَرِٹ");
    result.put("GEL","جارجِیَن لاری");
    result.put("GHC","گَنیٚیَن سٮ۪ڑی(۱۹۷۹–۲٠٠۷)");
    result.put("GHS","گَنیٚیَن سٮ۪ڑی");
    result.put("GIP","گِبریلٹَر پَاونٛڑ");
    result.put("GMD","گیمبِیاہُک دلاسی");
    result.put("GNF","گِنِیَن فرٛینٛک");
    result.put("GNS","گِنِیَن سِلی");
    result.put("GQE","اِکویٹورِیَل گِنِیَن اٮ۪کویٖل");
    result.put("GRD","گریٖسُک ڑرٛٮ۪کما");
    result.put("GTQ","گواٹَمالَن قیوٗٹزَل");
    result.put("GWE","پورتگیٖزُک گِنی اٮ۪سکیوٗڑو");
    result.put("GWP","گِنی بِساوُک پٮ۪سو");
    result.put("GYD","گَیَنیٖزُک ڑالَر");
    result.put("HKD","حانٛگ کانٛگُک ڑالَر");
    result.put("HNL","حونڑورنُک لٮ۪مپیٖرا");
    result.put("HRD","کروایشنُک دیٖنار");
    result.put("HRK","کروایشنُک کوٗنا");
    result.put("HTG","حیشَنُک گوڑ");
    result.put("HUF","حَنگیرِیَن فورِنٛٹ");
    result.put("IDR","اِنڑونیشیاہُک رُپِیاہ");
    result.put("IEP","اَیرلینڑُک پاونٛڑ");
    result.put("ILP","اِزرٲیِلی پاونٛڑ");
    result.put("ILS","اِزرٲیِلی نٔوۍ شٮ۪قٕل");
    result.put("INR","ہِندُستٲنۍ رۄپَے");
    result.put("IQD","ایٖراقُک دیٖنار");
    result.put("IRR","ایٖرانُک رِیال");
    result.put("ISK","اَیسلینٛڑُک کرٛونا");
    result.put("ITL","اِٹلیٖ یُک لیٖرا");
    result.put("JMD","جَمَیکاہُک ڑالَر");
    result.put("JOD","جَرڑینیاہُک دیٖنار");
    result.put("JPY","جاپانُک یَن");
    result.put("KES","کٮ۪نیَن شِلِنٛگ");
    result.put("KGS","کِرگِستانُک سوم");
    result.put("KHR","کَمبوڑِیاہُک رِیال");
    result.put("KMF","کومورِیَن فرٛینٛک");
    result.put("KPW","جنوٗبی کورِیَن وَن");
    result.put("KRW","ساوتھ کورِیَن وَن");
    result.put("KWD","قُویتُک دیٖنار");
    result.put("KYD","کیمین ججیٖرُک ڑالَر");
    result.put("KZT","کزاکِستان ٹینٛج");
    result.put("LAK","لَوٹِیَن کِپ");
    result.put("LBP","لیبنیٖزُک پاونٛڑ");
    result.put("LKR","سری لَنکاہٕچ رۄپَے");
    result.put("LRD","لَیبیرِیَن ڑالَر");
    result.put("LSL","لِسوتھو لوٹی");
    result.put("LTL","لِتھوینِیَن لِٹاس");
    result.put("LTT","لِتھوینِیَن ٹٮ۪لوناس");
    result.put("LUC","لَکزٕمبورگِیَن کَنؤرٹِبٕل فرٛینٛک");
    result.put("LUF","لَکزٕمبورگِیَن فرٛینٛک");
    result.put("LUL","لَکزٕمبوگ فَینانشَل فرٛینٛک");
    result.put("LVL","لَتوِیَن لیٹس");
    result.put("LVR","لَتوِیَن رَبٕل");
    result.put("LYD","لِبیَن دیٖنار");
    result.put("MAD","موروکَن دِرہَم");
    result.put("MAF","موروکَن فرٛینٛک");
    result.put("MDL","مولڑووین لیوٗ");
    result.put("MGA","مٮ۪لٮ۪گیسی اٮ۪ریَری");
    result.put("MGF","مٮ۪لٮ۪گیسی فرٛینٛک");
    result.put("MKD","مٮ۪کَڑونِیَن دیٖنار");
    result.put("MLF","میلِیَن فرٛینٛک");
    result.put("MMK","مِیانما کیاٹ");
    result.put("MNT","مۄنگولِیَن ٹُگرِک");
    result.put("MOP","مٮ۪کانیٖز پَٹاکا");
    result.put("MRO","مورِٹینِیَن عوگیوٗیا (1973–2017)");
    result.put("MRU","مورِٹینِیَن عوگیوٗیا");
    result.put("MTL","مالٹیٖزُک لیٖرا");
    result.put("MTP","مالٹیٖزُک پاونٛڑ");
    result.put("MUR","مورٮ۪شِیاہٕچ رۄپَے");
    result.put("MVR","مالدِیٖوِیَن رُفِیا");
    result.put("MWK","مٮ۪لیوِیَن کواچا");
    result.put("MXN","مٮ۪کسِکَن پٮ۪سو");
    result.put("MXP","مٮ۪کسِکَن سِلوَر پٮ۪سو (۱۸۶۱–۱۹۹۲)");
    result.put("MYR","مَلیشِیَن رِنٛگِٹ");
    result.put("MZE","موزیمبِکَن سکیوٗڑو");
    result.put("MZM","پرٛون موزیمبِکَن مٮ۪ٹِکَل");
    result.put("MZN","موزیمبِکَن مٮ۪ٹِکَل");
    result.put("NAD","نامِبِیَن ڑالَر");
    result.put("NGN","نَیجیرِیَن ڑالَر");
    result.put("NIC","نِکٮ۪راگُوٮ۪ن کورڑوبا");
    result.put("NIO","نِکٮ۪راگُوٮ۪ن کورڑوبا اورو");
    result.put("NLG","ڈَچ گِلڑَر");
    result.put("NOK","نورویٚیِنُک کرٛون");
    result.put("NPR","نیپالٕچ رۄپَے");
    result.put("NZD","نِوزیٖلینٛڑُک ڑالَر");
    result.put("OMR","اومِنی رِیال");
    result.put("PAB","پانامانِیَن بالبوز");
    result.put("PEI","پٔریوٗوِیَن اِنٛٹی");
    result.put("PEN","پٔریوٗوِیَن سولٕز");
    result.put("PES","پٔریوٗوِیَن سول (۱۸۶۳–۱۹۶۵)");
    result.put("PGK","نیوٗ پیپُعا گِنِیَن کیٖنا");
    result.put("PHP","پھِلِپایِٔن پٮ۪سو");
    result.put("PKR","پاکِستٲنۍ رۄپَے");
    result.put("PLN","پولِش زلوٹی");
    result.put("PLZ","پولِش زلوٹی(۱۹۵٠–۱۹۹۵)");
    result.put("PTE","پورتُگیٖز اٮ۪سکیوٗڑو");
    result.put("PYG","پٮ۪رٮ۪گیوٗوَیَن گُعارانی");
    result.put("QAR","قطاری رِیال");
    result.put("RHD","رھوڑیشِیَن ڑالَر");
    result.put("ROL","اولڑ رومانِیَن لٮ۪یوٗ");
    result.put("RON","رومانِیَن لٮ۪یوٗ");
    result.put("RSD","سٔربِیَن دیٖنار");
    result.put("RUB","رٔشیَن رَبٕل");
    result.put("RUR","رٔشیَن رَبٕل(۱۹۹۱–۱۹۹۸)");
    result.put("RWF","روانٛڑَن فرانٛک");
    result.put("SAR","سودیٖیُک رِیال");
    result.put("SBD","سولَمَن جٔزیٖرُک ڈالَر");
    result.put("SDD","پرون سوٗڈانُک دیٖنار");
    result.put("SDG","سوٗڈانُک پونٛڈ");
    result.put("SDP","پرون سوٗڈانُک پونٛڈ");
    result.put("SEK","سویٖڈِش کَرونا");
    result.put("SGD","سِنگاپورُک ڈالَر");
    result.put("SHP","سینٹ ہیلِنا پونٛڈ");
    result.put("SIT","سلووینُک ٹولَر");
    result.put("SKK","سلووَک کَرونا");
    result.put("SOS","سومالی شِلِنٛگ");
    result.put("SRD","سُریٖنامُک ڈالَر");
    result.put("SRG","سُریٖنام گِلدَر");
    result.put("SUR","سوویت روبٕل");
    result.put("SVC","سَلویدَرُک کولَن");
    result.put("SYP","سیٖریاہُک پونٛڈ");
    result.put("SZL","سوازی لِلَنگیٚنی");
    result.put("THB","تھایھک بات");
    result.put("TJR","تاجکِستانُک رَبٕل");
    result.put("TJS","تاجِکتانُک سَمونی");
    result.put("TMM","تُکَمَنِستانُک مَنَت");
    result.put("TND","ٹُنیشیاہُک دیٖنار");
    result.put("TOP","ٹونگَن پانٛگا");
    result.put("TPE","ٹیموریٚسو ایٚکیٖڈو");
    result.put("TRL","پرون تُرکِش لیرا");
    result.put("TRY","تُرکیہُک لیرا");
    result.put("TTD","ٹرِنہِ ڈیڈ تہٕ ٹوبیگو ڈالَر");
    result.put("TWD","نوٚو تیوانُک ڈالَر");
    result.put("TZS","تَنزانیاہُک شِلِنٛگ");
    result.put("UAH","یوٗکرینیاہُک ہرِوِنیا");
    result.put("UAK","یوٗکرینیاہُک کاربووَنیٹس");
    result.put("UGS","اُگاداہُک شِلِنٛگ(۱۹۶۶–۱۹۸۷)");
    result.put("UGX","اُگاداہُک شِلِنٛگ");
    result.put("USD","یوٗ ایٚس ڈالَر");
    result.put("USN","یوٗ ایٚس ڈالَر(پَگاہ)");
    result.put("USS","یوٗ ایٚس ڈالَر(تَمی دًۄہ)");
    result.put("UYI","اُرگایَن پیٚسو یوٗنِڈیڈَس اِنڈیٚکسَس");
    result.put("UYP","اُرگایَن پیٚسو(۱۹۷۵–۱۹۹۳)");
    result.put("UYU","اُروٗگایَن پیٚسو");
    result.put("UZS","اُبیکِستان سوم");
    result.put("VEB","وینٕزوٗلیُک بولِوَر (۱۸۷۱–۲۰۰۸)");
    result.put("VEF","وینٕزوٗلیُک بولِوَر (2008–2018)");
    result.put("VES","وینٕزوٗلیُک بولِوَر");
    result.put("VND","وِیَنَمُک ڈانٛگ");
    result.put("VUV","وَنوٗاَتوٗ وَتوٗ");
    result.put("WST","سَمون تَلا");
    result.put("XAF","سی ایٚف اے فرینک بی ایٖ اے سی");
    result.put("XAG","رۄپھ");
    result.put("XAU","سۄن");
    result.put("XBA","یوٗرپی کَمپوسِٹ یوٗنِٹ");
    result.put("XBB","یوٗرپی مونِٹَری یوٗنِٹ");
    result.put("XBC","یوٗرپی یوٗنِٹ آف ایٚکاوُنٛٹ (ایکس بی سی)");
    result.put("XBD","یوٗرپی یوٗنِٹ آف ایٚکاوُنٛٹ (ایکس بی ڈی)");
    result.put("XCD","مَشرِقی کیرِبِیَن ڈالَر");
    result.put("XDR","خاص ڈرایِنٛگ رایٹس");
    result.put("XEU","یوٗرپی کَرَنسی یوٗنِٹ");
    result.put("XFO","فریٚنچ گولڈ فرینک");
    result.put("XFU","فریٛنچ یوٗ اے سی فرینک");
    result.put("XOF","سی ایٚف اے فرینک بی سی ایٖ اے او");
    result.put("XPD","پُلیڈیَم");
    result.put("XPF","سی ایٚف پی فرینک");
    result.put("XPT","پلیٹِنَم");
    result.put("XRE","آر آے ایٚن ایٖ ٹی فَنٛڈ");
    result.put("XTS","ٹیٚسٹِنٛگ کَرَنسی کوڈ");
    result.put("XXX","اَنزٲنۍ یا نالَگہٕ ہار سِکہٕ");
    result.put("YDD","یَمنُک دیٖنار");
    result.put("YER","یَمنُک رِیال");
    result.put("YUD","یوگوسلاوِیَن ہاڑ دیٖنار");
    result.put("YUM","یوگوسلاوِیَن نووِے دیٖنار");
    result.put("YUN","یوگوسلاوِیَن کَنؤٹِبٕل دیٖنار");
    result.put("ZAR","ساوُتھ افریٖکاہُک رینڈ");
    result.put("ZMK","زِمبابیُک کواچا (1968–2012)");
    result.put("ZMW","زِمبابیُک کواچا");
    result.put("ZRN","زایرِیَن نِو زایِر");
    result.put("ZRZ","زَیرُک ڈالَر");
    result.put("ZWD","زِمبابِیُک ڈالَر");
    return result;
  }
}
