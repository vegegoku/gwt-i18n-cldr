...
public class CurrencyList_ksb_TZ extends CurrencyList_ksb {
  ...
  protected HashMap<String, String> loadNamesMap() {
    ...
    result.put("BHD","dinali ya Bahaleni");
    result.put("BIF","falanga ya Bulundi");
    result.put("BWP","pula ya Botswana");
    result.put("CAD","dola ya Kanada");
    result.put("CDF","falanga ya Kongo");
    result.put("CHF","falanga ya Uswisi");
    result.put("CNY","yaun lenminbi ya China");
    result.put("CVE","eskudo ya Kepuvede");
    result.put("DJF","falanga ya Jibuti");
    result.put("DZD","dinali ya Aljelia");
    result.put("EGP","pauni ya Misli");
    result.put("ERN","nakfa ya Elitlea");
    result.put("ETB","bil ya Uhabeshi");
    result.put("EUR","yulo");
    result.put("GBP","pauni ya Uingeeza");
    result.put("GHC","sedi ya Ghana");
    result.put("GMD","dalasi ya Gambia");
    result.put("GNS","falanga ya Gine");
    result.put("INR","lupia ya India");
    result.put("JPY","salafu ya Kijapani");
    result.put("KES","shilingi ya Kenya");
    result.put("KMF","falanga ya Komolo");
    result.put("LRD","dola ya Libelia");
    result.put("LSL","loti ya Lesoto");
    result.put("LYD","dinali ya Libya");
    result.put("MAD","dilham ya Moloko");
    result.put("MGA","falanga ya Bukini");
    result.put("MRO","ugwiya ya Molitania (1973–2017)");
    result.put("MRU","ugwiya ya Molitania");
    result.put("MUR","lupia ya Molisi");
    result.put("MWK","kwacha ya Malawi");
    result.put("MZM","metikali ya Msumbiji");
    result.put("NAD","dola ya Namibia");
    result.put("NGN","naila ya Naijelia");
    result.put("RWF","falanga ya Lwanda");
    result.put("SAR","liyal ya Saudia");
    result.put("SCR","lupia ya Shelisheli");
    result.put("SDG","dinali ya Sudani");
    result.put("SDP","pauni ya Sudani");
    result.put("SHP","pauni ya Santahelena");
    result.put("SLL","leoni");
    result.put("SOS","shilingi ya Somalia");
    result.put("STD","dobla ya Sao Tome na Plincipe (1977–2017)");
    result.put("STN","dobla ya Sao Tome na Plincipe");
    result.put("SZL","lilangeni");
    result.put("TND","dinali ya Tunisia");
    result.put("TZS","shilingi ya Tanzania");
    result.put("UGX","shilingi ya Uganda");
    result.put("USD","dola ya Malekani");
    result.put("XAF","falanga CFA BEAC");
    result.put("XOF","falanga CFA BCEAO");
    result.put("ZAR","landi ya Aflika Kusini");
