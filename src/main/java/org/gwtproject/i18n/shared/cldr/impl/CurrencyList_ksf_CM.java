...
public class CurrencyList_ksf_CM extends CurrencyList_ksf {
  ...
  protected HashMap<String, String> loadNamesMap() {
    ...
    result.put("BHD","mɔni mǝ á barǝ́n");
    result.put("BIF","mɔni mǝ á burundí");
    result.put("BWP","mɔni mǝ á botswana");
    result.put("CAD","mɔni mǝ á kanada");
    result.put("CDF","mɔni mǝ á kɔngó");
    result.put("CHF","mɔni mǝ á swís");
    result.put("CNY","mɔni mǝ á cín");
    result.put("CVE","mɔni mǝ á kapvɛr");
    result.put("DJF","mɔni mǝ á dyibutí");
    result.put("DZD","mɔni mǝ á aljɛrí");
    result.put("EGP","mɔni mǝ á ɛjípt");
    result.put("ERN","mɔni mǝ á ɛritrɛ́");
    result.put("ETB","mɔni mǝ á ɛtyɔpí");
    result.put("EUR","mɔni mǝ á pɛrɛsǝ́");
    result.put("GBP","mɔni mǝ á ingɛrís");
    result.put("GHC","mɔni mǝ á gána");
    result.put("GMD","mɔni mǝ á gambí");
    result.put("GNS","mɔni mǝ á ginɛ́");
    result.put("INR","mɔni mǝ á indí");
    result.put("JPY","mɔni mǝ á japɔ́ŋ");
    result.put("KES","mɔni mǝ á kɛnya");
    result.put("KMF","mɔni mǝ á komɔr");
    result.put("LRD","mɔni mǝ á libɛrya");
    result.put("LSL","mɔni mǝ á lǝsóto");
    result.put("LYD","mɔni mǝ á libí");
    result.put("MAD","mɔni mǝ á marɔk");
    result.put("MGA","mɔni mǝ á madagaska");
    result.put("MRO","mɔni mǝ á mwaritaní (1973–2017)");
    result.put("MRU","mɔni mǝ á mwaritaní");
    result.put("MUR","mɔni mǝ á mwarís");
    result.put("MWK","mɔni mǝ á malawi");
    result.put("MZM","mɔni mǝ á mosambík");
    result.put("NAD","mɔni mǝ á namibí");
    result.put("NGN","mɔni mǝ á nijɛ́rya");
    result.put("RWF","mɔni mǝ á rwanda");
    result.put("SAR","mɔni mǝ á arabí saodí");
    result.put("SCR","mɔni mǝ á sɛcɛl");
    result.put("SDG","mɔni mǝ á sudan");
    result.put("SHP","mɔni mǝ á sɛntɛ́len");
    result.put("SLL","mɔni mǝ á syɛraleon");
    result.put("SOS","mɔni mǝ á somalí");
    result.put("STD","mɔni mǝ á saotomɛ́ ri priŋsib (1977–2017)");
    result.put("STN","mɔni mǝ á saotomɛ́ ri priŋsib");
    result.put("SZL","mɔni mǝ á swazilan");
    result.put("TND","mɔni mǝ á tunɛsí");
    result.put("TZS","mɔni mǝ á tanzaní");
    result.put("UGX","mɔni mǝ á uganda");
    result.put("USD","mɔni mǝ á amɛrika");
    result.put("XAF","fráŋ");
    result.put("XOF","mɔni mǝ á afríka aná wɛs");
    result.put("ZAR","mɔni mǝ á afrik anǝ a sud");
    result.put("ZMK","mɔni mǝ á zambí (1968–2012)");
    result.put("ZMW","mɔni mǝ á zambí");
    result.put("ZWD","mɔni mǝ á zimbabwɛ́");
    return result;
  }
}
