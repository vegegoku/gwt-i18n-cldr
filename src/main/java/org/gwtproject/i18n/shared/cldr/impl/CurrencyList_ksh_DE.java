...
public class CurrencyList_ksh_DE extends CurrencyList_ksh {
  ...
  protected HashMap<String, CurrencyData> loadCurrencyMap() {
    ...
    // venezuelaanesche Bolívar (2008–2018)
  ...
  protected HashMap<String, String> loadNamesMap() {
    ...
    result.put("AMD","armeenesche Dram");
    result.put("ANG","neederlängsch antillesche Jullde");
    result.put("AOA","angjolaanesche Kwansa");
    result.put("ARS","ajentiinesche Peeso");
    result.put("AUD","austraalesche Dollaa");
    result.put("AWG","arubesche Florin");
    result.put("AZM","Asserbaidschaani Manat (1993–2006)");
    result.put("AZN","Asserbaidschaani Manat");
    result.put("BAM","ömtuuschbaa Mark us Boßnije un dä Hächejovvina");
    result.put("BBD","Barbados-Dollaa");
    result.put("BDT","Taka us Bangladäsch");
    result.put("BGN","buljaaresche Lev");
    result.put("BHD","Bachrainesche Denaa");
    result.put("BIF","burundesche Frang");
    result.put("BMD","Bermuuda-Dollaa");
    result.put("BND","Brunei-Dollaa");
    result.put("BOB","Bollivijano");
    result.put("BRL","brasilljaanesche Real");
    result.put("BSD","bahama’sche Dollaa");
    result.put("BTN","bhutanesesche Ngultrum");
    result.put("BWP","Pula us Bozwaana");
    result.put("BYN","wiißrußesche Rubel");
    result.put("BYR","wiißrußesche Rubel (2000–2016)");
    result.put("BZD","belizjaanesche Dollaa");
    result.put("CAD","kannaadesche Dollaa");
    result.put("CDF","kongjoleesesche Frang");
    result.put("CHF","schweijzer Fränkli");
    result.put("CLP","schileenesche Peeso");
    result.put("CNY","schineesesche Yuan Renminbi");
    result.put("COP","kolumbesche Peso");
    result.put("CRC","koßtarikaanesche Colón");
    result.put("CUC","ömtuuschbaa kubaanesche Pesos");
    result.put("CUP","kubaanesche Peesos");
    result.put("CVE","kapverdesche Eskuudos");
    result.put("CZK","tschäschesche Kruhne");
    result.put("DJF","Frang uß Dschibuti");
    result.put("DKK","dänesche Kruhne");
    result.put("DOP","dommenikaanesche Peesos");
    result.put("DZD","aljeresche Denaa");
    result.put("EEK","Äßnesche Kruhne");
    result.put("EGP","äjiptesche Pongk");
    result.put("ERN","Nafka uß Erritreja");
    result.put("ETB","ätejoopesche Birr");
    result.put("EUR","Euro");
    result.put("FJD","Fidschi-Dollaa");
    result.put("FKP","Pongk vun de Falkland-Enselle");
    result.put("GBP","brittesche £");
    result.put("GEL","jeorjesche Lari");
    result.put("GHS","janaaesche Cedi");
    result.put("GIP","jibraltaa’sche Pongk");
    result.put("GMD","jambesche Dalasi");
    result.put("GNF","Jineea-Frang");
    result.put("GTQ","juatemalesche Quetzal");
    result.put("GYD","Juaana-Dollaa");
    result.put("HKD","Hongkong-Dollaa");
    result.put("HNL","hondureanesche Lempira");
    result.put("HRK","krowaatesche Kuna");
    result.put("HTG","haiitesche Gourde");
    result.put("HUF","unjarresche Forint");
    result.put("IDR","indoneesesche Ruupije");
    result.put("ILS","ißraeelesche Schekel");
    result.put("INR","indesche Ruupije");
    result.put("IQD","iraakesche Denaa");
    result.put("IRR","persesche Rial");
    result.put("ISK","ißländesche Kruhne");
    result.put("JMD","jamaikaanesche Dollaa");
    result.put("JOD","Jordaanesche Dollaa");
    result.put("JPY","japaanesche Jen");
    result.put("KES","Kenjaanesche Schillinge");
    result.put("KGS","kirjiisesche Som");
    result.put("KHR","kambodschaanesche Riel");
    result.put("KMF","kommooresche Frang");
    result.put("KPW","noodkorejaansche Won");
    result.put("KRW","söödkorejaansche Won");
    result.put("KWD","kuwaitesche Denaa");
    result.put("KYD","Kaimann-Dollaa");
    result.put("KZT","kasakesche Tenge");
    result.put("LAK","loaatesche Kip");
    result.put("LBP","libaneesesche Pongk");
    result.put("LKR","schrilankesche Ruupije");
    result.put("LRD","liberijaanesche Dollaa");
    result.put("LSL","lesoothesche Loti");
    result.put("LTL","littouesche Litas");
    result.put("LVL","lättesche Lats");
    result.put("LYD","libesche Denaa");
    result.put("MAD","marrokaanesche Dirhamm");
    result.put("MDL","moldaavesche Leu");
    result.put("MGA","madajaskesche Ariary");
    result.put("MKD","mazedoonesche Denaa");
    result.put("MMK","burmeesesche Kyat");
    result.put("MNT","mongjoolesche Tugrik");
    result.put("MOP","makaneesesche Pataca");
    result.put("MRO","mauretanesche Ouguiya (1973–2017)");
    result.put("MRU","mauretanesche Ouguiya");
    result.put("MUR","maurizjahnesche Ruupije");
    result.put("MVR","mallediivesche Rufiyaa");
    result.put("MWK","malaawesche Kwache");
    result.put("MXN","mexekaanesche Peeso");
    result.put("MYR","malaisesche Ringgit");
    result.put("MZM","mosambikaanesche Metical (1980–2006)");
    result.put("MZN","mossambikaanesche Metical");
    result.put("NAD","namiibesche Dollaa");
    result.put("NGN","nijerijaanesche Naira");
    result.put("NIO","nikarajaanesche Córdoba");
    result.put("NOK","norrweejesche Kruhne");
    result.put("NPR","nepaleesesche Ruupije");
    result.put("NZD","neuseeländesche Dollaa");
    result.put("OMR","ommaanesche Rijal");
    result.put("PAB","pannameesesche Balboa");
    result.put("PEN","perruaanesche Sol");
    result.put("PGK","papua neujinejaanesche Kina");
    result.put("PHP","fillipiinesche Pesos");
    result.put("PKR","pakestaanesche Ruupije");
    result.put("PLN","polnesche Złoty");
    result.put("PYG","parajuaanesche Juarani");
    result.put("QAR","kataaresche Rijal");
    result.put("ROL","romäänesche Leu (1952–2006)");
    result.put("RON","romäänesche Leu");
    result.put("RSD","särbesche Denaare");
    result.put("RUB","russesche Ruubel");
    result.put("RWF","ruandesche Frang");
    result.put("SAR","saudesche Rijal");
    result.put("SBD","solomonesche Dollaa");
    result.put("SCR","seischellesche Ruupije");
    result.put("SDG","sudaneesesche Pongk");
    result.put("SEK","schweedesche Kruhne");
    result.put("SGD","singjapurejaanesche Dollaa");
    result.put("SHP","Zint-Hellena-Pongk");
    result.put("SKK","ßlovaakesche Kruhne");
    result.put("SLL","ẞjärra-lejoneesesche Leone");
    result.put("SOS","somaalesche Schillenge");
    result.put("SRD","sürinameesesche Dollaa");
    result.put("SSP","södsudaneesesche Pongk");
    result.put("STD","Dobra vun São Tomé un Príncipe (1977–2017)");
    result.put("STN","Dobra vun São Tomé un Príncipe");
    result.put("SVC","asalvadorejaanesche Cosan");
    result.put("SYP","süüresche Pund");
    result.put("SZL","swasiländesche Lilangeni");
    result.put("THB","tailändesche Baht");
    result.put("TJS","tadschikißtaanesche Somoni");
    result.put("TMM","turkmeneßtaanesche Manat (1993–2009)");
    result.put("TMT","turkmeneßtaanesche Manat");
    result.put("TND","tuneesesche Denaa");
    result.put("TOP","tongjanes Paʻangache");
    result.put("TRY","törkesche Liire");
    result.put("TTD","Dollaa uß Trinidad un Tobääjo");
    result.put("TWD","neu taiwaneesesche Dollaa");
    result.put("TZS","tansaanesche Schillenge");
    result.put("UAH","ukraijnesche Hryvnia");
    result.put("UGX","ujandesche Schillenge");
    result.put("USD","ammärrikaanesche Dollaa");
    result.put("UYU","urrujuwaische Peeso");
    result.put("UZS","ußbeekesche Som");
    result.put("VEF","venezuelaanesche Bolívar (2008–2018)");
    result.put("VES","venezuelaanesche Bolívar");
    result.put("VND","vijätnammeesesche Dong");
    result.put("VUV","vanuatesche Vatu");
    result.put("WST","samowaanesche Tala");
    result.put("XAF","Kmmeruhner Frang");
    result.put("XAG","Sellver");
    result.put("XAU","Jold");
    result.put("XCD","oß-karribbesche Dollaa");
    result.put("XFO","franzüüsesche Joldfranke");
    result.put("XOF","Frang uß de Älfebeinköß");
    result.put("XPD","Palladijum");
    result.put("XPF","polineesesche Frang");
    result.put("XPT","Plaatin");
    result.put("XTS","Währong zum Prööfe");
    result.put("XXX","onbikannte Währong");
    result.put("YER","jemenitesche Rijal");
    result.put("ZAR","södaffrekaanesche Rand");
    result.put("ZMK","sambesche Kwacha (1968–2012)");
    result.put("ZMW","sambesche Kwacha");
    result.put("ZWD","simbabwesche Dollaa (1980–2008)");
    result.put("ZWL","simbabwesche Dollaa (2009)");
    return result;
  }
}
