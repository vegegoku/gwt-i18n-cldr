...
public class CurrencyList_ky_KG extends CurrencyList_ky {
  public CurrencyData getDefault() {
    return new CurrencyDataImpl("KGS","сом",2,"сом","сом");
  }
  ...
  protected HashMap<String, CurrencyData> loadCurrencyMap() {
    ...
    // Кыргызстан сому
    result.put("KGS", new CurrencyDataImpl("KGS","сом",2,"сом","сом"));
    // Камбожа риели
  ...
  protected HashMap<String, String> loadNamesMap() {
    ...
    result.put("AMD","Армения драмы");
    result.put("ANG","нидерланд-антил гулдени");
    result.put("AOA","Ангола кванзасы");
    result.put("ARS","аргентина песосу");
    result.put("AUD","Австралия доллары");
    result.put("AWG","аруба флорини");
    result.put("AZN","Азербайжан манаты");
    result.put("BAM","босния-герцоговина конвертациялануучу маркасы");
    result.put("BBD","барбадос доллары");
    result.put("BDT","Бангладеш такасы");
    result.put("BGN","болгар левиси");
    result.put("BHD","Бахрейн динары");
    result.put("BIF","Бурунди франкы");
    result.put("BMD","бермуд доллары");
    result.put("BND","Бруней доллары");
    result.put("BOB","боливия боливианосу");
    result.put("BRL","бразилия реалы");
    result.put("BSD","багама доллары");
    result.put("BTN","Бутан нгултруму");
    result.put("BWP","Ботсвана пуласы");
    result.put("BYN","беларусь рублу");
    result.put("BYR","беларусь рублу (2000–2016)");
    result.put("BZD","белиз доллары");
    result.put("CAD","канада доллары");
    result.put("CDF","Конго франкы");
    result.put("CHF","швейцария франкы");
    result.put("CLP","чили песосу");
    result.put("CNY","Кытай юаны");
    result.put("COP","колумбия песосу");
    result.put("CRC","коста-рика колону");
    result.put("CUC","кубанын конвертациялануучу песосу");
    result.put("CUP","куба песосу");
    result.put("CVE","Кабо-Верде эскудосу");
    result.put("CZK","чех кронасы");
    result.put("DJF","Жибути франкы");
    result.put("DKK","дания крону");
    result.put("DOP","доминикан песосу");
    result.put("DZD","алжир динары");
    result.put("EGP","египет фунту");
    result.put("ERN","Эритреа накфасы");
    result.put("ETB","Эфиопия бирри");
    result.put("EUR","Евро");
    result.put("FJD","Фижи доллары");
    result.put("FKP","фолкленд аралдарынын фунту");
    result.put("GBP","британия фунт стерлинги");
    result.put("GEL","Грузия лариси");
    result.put("GHS","Гана седиси");
    result.put("GIP","гибралтар фунту");
    result.put("GMD","Гамбия даласиси");
    result.put("GNF","Гине франкы");
    result.put("GTQ","гватемала кетсалы");
    result.put("GYD","гуйана доллары");
    result.put("HKD","Гонконг доллары");
    result.put("HNL","гондурас лемпирасы");
    result.put("HRK","хорват кунасы");
    result.put("HTG","гаити гурдусу");
    result.put("HUF","венгр форинти");
    result.put("IDR","Индонезия рупийасы");
    result.put("ILS","Израилдин жаңы шекели");
    result.put("INR","Индия руписи");
    result.put("IQD","Ирак динары");
    result.put("IRR","Иран риалы");
    result.put("ISK","исландия крону");
    result.put("JMD","ямайка доллары");
    result.put("JOD","Йордания динары");
    result.put("JPY","Жапан йени");
    result.put("KES","Кения шиллинги");
    result.put("KGS","Кыргызстан сому");
    result.put("KHR","Камбожа риели");
    result.put("KMF","Коморос франкы");
    result.put("KPW","Түндүк Корея уону");
    result.put("KRW","Түштүк Корея уону");
    result.put("KWD","Кувейт динары");
    result.put("KYD","кайман доллары");
    result.put("KZT","Казакстан теңгеси");
    result.put("LAK","Лаос киби");
    result.put("LBP","Ливан фунту");
    result.put("LKR","Шри Ланка руписи");
    result.put("LRD","Либерия доллары");
    result.put("LTL","литва литасы");
    result.put("LVL","латвия латы");
    result.put("LYD","ливия динары");
    result.put("MAD","марокко дирхамы");
    result.put("MDL","молдован лейи");
    result.put("MGA","Мадагаскар ариариси");
    result.put("MKD","македон денары");
    result.put("MMK","Мйанмар кйаты");
    result.put("MNT","Монгол тугриги");
    result.put("MOP","Макау патакасы");
    result.put("MRO","Мавритания угиясы (1973–2017)");
    result.put("MRU","Мавритания угиясы");
    result.put("MUR","Мавританий руписи");
    result.put("MVR","Малдив руфийасы");
    result.put("MWK","Малави квачасы");
    result.put("MXN","мексика песосу");
    result.put("MYR","Малайзия ринггити");
    result.put("MZN","Мозамбик метикалы");
    result.put("NAD","Намибия доллары");
    result.put("NGN","Нигерия найрасы");
    result.put("NIO","никарагуа кордобасы");
    result.put("NOK","норвегия крону");
    result.put("NPR","Непал руписи");
    result.put("NZD","Жаңы Зеландия доллары");
    result.put("OMR","Оман риалы");
    result.put("PAB","панама балбоасы");
    result.put("PEN","перу солу");
    result.put("PGK","Папуа Жаңы Гвинея кинасы");
    result.put("PHP","Филиппин песосу");
    result.put("PKR","Пакистан руписи");
    result.put("PLN","польша злотыйы");
    result.put("PYG","парагвай гуараниси");
    result.put("QAR","Катар риалы");
    result.put("RON","румын лейи");
    result.put("RSD","серб динары");
    result.put("RUB","орус рублу");
    result.put("RWF","Руанда франкы");
    result.put("SAR","Сауд риалы");
    result.put("SBD","Соломон аралдарынын доллары");
    result.put("SCR","Сейшел руписи");
    result.put("SDG","судан фунту");
    result.put("SEK","швеция крону");
    result.put("SGD","Сингапур доллары");
    result.put("SHP","Ыйык Елена аралынын фунту");
    result.put("SLL","Сиерра-Леоне леонеси");
    result.put("SOS","Сомали шиллинги");
    result.put("SRD","суринам доллары");
    result.put("SSP","Түштүк Судан фунту");
    result.put("STD","Сао Томе жана Принсипе добрасы (1977–2017)");
    result.put("STN","Сао Томе жана Принсипе добрасы");
    result.put("SYP","Сирия фунту");
    result.put("SZL","Свази лилангени");
    result.put("THB","Тай баты");
    result.put("TJS","Тажикстан сомониси");
    result.put("TMT","Түркмөнстан манаты");
    result.put("TND","тунис динары");
    result.put("TOP","Тонга паангасы");
    result.put("TRY","Түркия лирасы");
    result.put("TTD","тринидад жана тобаго доллары");
    result.put("TWD","Тайвань жаңы доллары");
    result.put("TZS","Танзания шиллинги");
    result.put("UAH","украин гривени");
    result.put("UGX","Уганда шиллинги");
    result.put("USD","АКШ доллары");
    result.put("UYU","уругвай песосу");
    result.put("UZS","Өзбекстан суму");
    result.put("VEF","венесуэла боливары (2008–2018)");
    result.put("VND","Вьетнам доңу");
    result.put("VUV","Вануату ватусу");
    result.put("WST","Самоа таласы");
    result.put("XAF","Борбордук Африка КФА франкы");
    result.put("XCD","чыгыш кариб доллары");
    result.put("XOF","КФА франкы");
    result.put("XPF","КФП франкы");
    result.put("XXX","Белгисиз акча");
    result.put("YER","Йемен риалы");
    result.put("ZAR","Түштүк Африка ранды");
    result.put("ZMW","Замбия квачасы");
    return result;
  }
}
