...
public class CurrencyList_lag_TZ extends CurrencyList_lag {
  ...
  protected HashMap<String, String> loadNamesMap() {
    ...
    result.put("BHD","Dináari ya Baharéeni");
    result.put("BIF","Faráanga ya Burúundi");
    result.put("BWP","Púula ya Botiswáana");
    result.put("CAD","Dóola ya Kánada");
    result.put("CDF","Faráanga ya Kóongo");
    result.put("CHF","Faráaka ya Uswíisi");
    result.put("CNY","Yúani Renimínibi ya Chíina");
    result.put("CVE","Esikúudo ya Kepuvéede");
    result.put("DJF","Faráanga ya Jibóuti");
    result.put("DZD","Dináairi ya Alijéria");
    result.put("EGP","Páundi ya Mísiri");
    result.put("ERN","Nákɨfa ya Eriterea");
    result.put("ETB","Bíiri ya Ʉhabéeshi");
    result.put("EUR","Yúuro");
    result.put("GBP","Páundi ya Ʉɨngɨréesa");
    result.put("GHC","Séedi ya Gáana");
    result.put("GMD","Daláasi ya Gámbia");
    result.put("GNS","Faráanga ya Gíine");
    result.put("INR","Rupía ya Índia");
    result.put("JPY","Yéeni ya Japáani");
    result.put("KES","Shilíingi ya Kéenya");
    result.put("KMF","Faráanga ya Komóoro");
    result.put("LRD","Dóola ya Libéria");
    result.put("LSL","Lóoti ya Lesóoto");
    result.put("LYD","Dináari ya Líbia");
    result.put("MAD","Diriháamu ya Moróoko");
    result.put("MGA","Mpía ya bukini");
    result.put("MRO","Ungwíiya ya Moritánia (1973–2017)");
    result.put("MRU","Ungwíiya ya Moritánia");
    result.put("MUR","Rupía ya Moríisi");
    result.put("MWK","Kwáacha ya Maláawi");
    result.put("MZM","Metikáali ya Musumbíiji");
    result.put("NAD","Dóola ya Namíbia");
    result.put("NGN","Naíira ya Niijéria");
    result.put("RWF","Faráanga ya Rwáanda");
    result.put("SAR","Riyáali ya Saudía");
    result.put("SCR","Rupía ya Shelishéeli");
    result.put("SDG","Páundi ya Sudáani");
    result.put("SHP","Páundi ya Mʉtakatíifu Heléena");
    result.put("SLL","Leóoni");
    result.put("SOS","Shilíingi ya Somália");
    result.put("STD","Dóbura ya SaoTóome na Pirínsipe (1977–2017)");
    result.put("STN","Dóbura ya SaoTóome na Pirínsipe");
    result.put("SZL","Lilengéeni");
    result.put("TND","Dináari ya Tunísia");
    result.put("TZS","Shilíingi ya Taansanía");
    result.put("UGX","Shilíingi ya Ugáanda");
    result.put("USD","Dóola ya Amerɨ́ka");
    result.put("XAF","Faráanga ya CFA BEAC");
    result.put("XOF","Faráanga ya CFA BCEAO");
    result.put("ZAR","Ráandi ya Afɨrɨka ya Saame");
    result.put("ZMK","Kwácha ya Sámbia (1968–2012)");
    result.put("ZMW","Kwácha ya Sámbia");
    result.put("ZWD","Dóola ya Simbáabwe");
    return result;
  }
}
