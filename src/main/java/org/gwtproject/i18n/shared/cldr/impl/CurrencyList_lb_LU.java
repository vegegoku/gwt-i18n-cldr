...
public class CurrencyList_lb_LU extends CurrencyList_lb {
  ...
  protected HashMap<String, String> loadNamesMap() {
    ...
    result.put("ADP","Andorranesch Peseta");
    result.put("AED","VAE-Dirham");
    result.put("AFA","Afghanesch Afghani (1927–2002)");
    result.put("AFN","Afghanesch Afghani");
    result.put("ALL","Albanesche Lek");
    result.put("AMD","Armeneschen Dram");
    result.put("ANG","Antillen-Gulden");
    result.put("AOA","Angolanesche Kwanza");
    result.put("AOK","Angolanesche Kwanza (1977–1990)");
    result.put("AON","Angolaneschen Neie Kwanza (1990–2000)");
    result.put("AOR","Angolanesche Kwanza Reajustado (1995–1999)");
    result.put("ARA","Argentineschen Austral");
    result.put("ARP","Argentinesche Peso (1983–1985)");
    result.put("ARS","Argentinesche Peso");
    result.put("ATS","Éisträichesche Schilling");
    result.put("AUD","Australeschen Dollar");
    result.put("AWG","Aruba-Florin");
    result.put("AZM","Aserbaidschan-Manat (1993–2006)");
    result.put("AZN","Aserbaidschan-Manat");
    result.put("BAD","Bosnien an Herzegowina Dinar (1992–1994)");
    result.put("BAM","Bosnien an Herzegowina Konvertéierbar Mark");
    result.put("BBD","Barbados-Dollar");
    result.put("BDT","Bangladesch-Taka");
    result.put("BEC","Belsche Frang (konvertibel)");
    result.put("BEF","Belsche Frang");
    result.put("BEL","Belsche Finanz-Frang");
    result.put("BGL","Bulgaresch Lew (1962–1999)");
    result.put("BGN","Bulgaresch Lew");
    result.put("BHD","Bahrain-Dinar");
    result.put("BIF","Burundi-Frang");
    result.put("BMD","Bermuda-Dollar");
    result.put("BND","Brunei-Dollar");
    result.put("BOB","Bolivianesche Boliviano");
    result.put("BOP","Bolivianesche Peso");
    result.put("BOV","Bolivianseche Mvdol");
    result.put("BRB","Brasilianesche Cruzeiro Novo (1967–1986)");
    result.put("BRC","Brasilianesche Cruzado (1986–1989)");
    result.put("BRE","Brasilianesche Cruzeiro (1990–1993)");
    result.put("BRL","Brasilianesche Real");
    result.put("BRN","Brasilianesche Cruzado Novo (1989–1990)");
    result.put("BRR","Brasilianesche Cruzeiro (1993–1994)");
    result.put("BRZ","Brasilianesche Cruzeiro (1942–1967)");
    result.put("BSD","Bahama-Dollar");
    result.put("BTN","Bhutan-Ngultrum");
    result.put("BUK","Birmanesche Kyat");
    result.put("BWP","Botswanesch Pula");
    result.put("BYB","Wäissrussesche Rubel (1994–1999)");
    result.put("BYN","Wäissrussesche Rubel");
    result.put("BYR","Wäissrussesche Rubel (2000–2016)");
    result.put("BZD","Belize-Dollar");
    result.put("CAD","Kanadeschen Dollar");
    result.put("CDF","Kongo-Frang");
    result.put("CHE","WIR-Euro");
    result.put("CHF","Schwäizer Frang");
    result.put("CHW","WIR-Frang");
    result.put("CLF","Chileneschen Unidad de Fomento");
    result.put("CLP","Chilenesche Peso");
    result.put("CNY","Renminbi Yuan");
    result.put("COP","Kolumbianesche Peso");
    result.put("CRC","Costa-Rica-Colón");
    result.put("CSD","Serbeschen Dinar (2002–2006)");
    result.put("CSK","Tschechoslowakesch Kroun");
    result.put("CUC","Kubanesche Peso (konvertibel)");
    result.put("CUP","Kubanesche Peso");
    result.put("CVE","Kap-Verde-Escudo");
    result.put("CYP","Zypern-Pond");
    result.put("CZK","Tschechesch Kroun");
    result.put("DDM","DDR-Mark");
    result.put("DEM","Däitsch Mark");
    result.put("DJF","Dschibuti-Frang");
    result.put("DKK","Dänesch Kroun");
    result.put("DOP","Dominikanesche Peso");
    result.put("DZD","Algereschen Dinar");
    result.put("ECS","Ecuadorianesche Sucre");
    result.put("ECV","Verrechnungseenheete fir Ecuador");
    result.put("EEK","Estnesch Kroun");
    result.put("EGP","Egyptescht Pond");
    result.put("ERN","Eritréieschen Nakfa");
    result.put("ESA","Spuenesch Peseta (A–Konten)");
    result.put("ESB","Spuenesch Peseta (konvertibel)");
    result.put("ESP","Spuenesch Peseta");
    result.put("ETB","Ethiopescht Birr");
    result.put("EUR","Euro");
    result.put("FIM","Finnesch Mark");
    result.put("FJD","Fidschi-Dollar");
    result.put("FKP","Falkland-Pond");
    result.put("FRF","Franséische Frang");
    result.put("GBP","Britescht Pond");
    result.put("GEK","Georgesche Kupon Larit");
    result.put("GEL","Georgesche Lari");
    result.put("GHC","Ghanaeschen Cedi (1979–2007)");
    result.put("GHS","Ghanaeschen Cedi");
    result.put("GIP","Gibraltar-Pond");
    result.put("GMD","Gambia-Dalasi");
    result.put("GNF","Guinea-Frang");
    result.put("GNS","Guinéiesche Syli");
    result.put("GQE","Equatorialguinea-Ekwele");
    result.put("GRD","Griichesch Drachme");
    result.put("GTQ","Guatemaltekesche Quetzal");
    result.put("GWE","Portugisesch-Guinea Escudo");
    ...
    result.put("HRD","Kroateschen Dinar");
    result.put("HRK","Kroatesche Kuna");
    result.put("HTG","Haitianesch Gourde");
    result.put("HUF","Ungaresche Forint");
    result.put("IDR","Indonesesch Rupiah");
    result.put("IEP","Irescht Pond");
    result.put("ILP","Israelescht Pond");
    result.put("ILS","Israeleschen Neie Schekel");
    result.put("INR","Indesch Rupie");
    result.put("IQD","Irakeschen Dinar");
    result.put("IRR","Iranesch Rial");
    result.put("ISK","Islännesch Kroun");
    result.put("ITL","Italienesch Lira");
    result.put("JMD","Jamaika-Dollar");
    result.put("JOD","Jordaneschen Dinar");
    result.put("JPY","Japanesche Yen");
    result.put("KES","Kenia-Schilling");
    result.put("KGS","Kirgisesche Som");
    result.put("KHR","Kambodschanesche Riel");
    result.put("KMF","Komore-Frang");
    result.put("KPW","Nordkoreanesche Won");
    result.put("KRW","Südkoreanesche Won");
    result.put("KWD","Kuwait-Dinar");
    result.put("KYD","Kaiman-Dollar");
    result.put("KZT","Kasacheschen Tenge");
    result.put("LAK","Laoteschen Kip");
    result.put("LBP","Libanesescht Pond");
    result.put("LKR","Sri-Lanka-Rupie");
    result.put("LRD","Liberianeschen Dollar");
    result.put("LSL","Loti");
    result.put("LTL","Litauesche Litas");
    result.put("LTT","Litaueschen Talonas");
    result.put("LUC","Lëtzebuerger Frang (konvertibel)");
    result.put("LUF","Lëtzebuerger Frang");
    result.put("LUL","Lëtzebuerger Finanz-Frang");
    result.put("LVL","Lettesche Lats");
    result.put("LVR","Lettesche Rubel");
    result.put("LYD","Libeschen Dinar");
    result.put("MAD","Marokkaneschen Dirham");
    result.put("MAF","Marokkanesche Frang");
    result.put("MDL","Moldawesche Leu");
    result.put("MGA","Madagaskar-Ariary");
    result.put("MGF","Madagaskar-Frang");
    result.put("MKD","Mazedoneschen Denar");
    result.put("MLF","Malesche Frang");
    result.put("MMK","Myanmaresche Kyat");
    result.put("MNT","Mongoleschen Tögrög");
    result.put("MOP","Macau-Pataca");
    result.put("MRO","Mauretaneschen Ouguiya (1973–2017)");
    result.put("MRU","Mauretaneschen Ouguiya");
    result.put("MTL","Maltesesch Lira");
    result.put("MTP","Maltesescht Pond");
    result.put("MUR","Mauritius-Rupie");
    result.put("MVR","Maldiven-Rupie");
    result.put("MWK","Malawi-Kwacha");
    result.put("MXN","Mexikanesche Peso");
    result.put("MXP","Mexikanesche Sëlwer-Peso (1861–1992)");
    result.put("MXV","Mexikaneschen Unidad de Inversion (UDI)");
    result.put("MYR","Malayseschen Ringgit");
    result.put("MZE","Mosambikaneschen Escudo");
    result.put("MZM","Mosambikanesche Metical (1980–2006)");
    result.put("MZN","Mosambikanesche Metical");
    result.put("NAD","Namibia-Dollar");
    result.put("NGN","Nigerianeschen Naira");
    result.put("NIC","Nicaraguanesche Córdoba (1988–1991)");
    result.put("NIO","Nicaraguanesche Córdoba");
    result.put("NLG","Hollännesche Gulden");
    result.put("NOK","Norwegesch Kroun");
    result.put("NPR","Nepalesesch Rupie");
    result.put("NZD","Neiséiland-Dollar");
    result.put("OMR","Omanesche Rial");
    result.put("PAB","Panamaesche Balboa");
    result.put("PEI","Peruaneschen Inti");
    result.put("PEN","Peruaneschen Sol");
    result.put("PES","Peruaneschen Sol (1863–1965)");
    result.put("PGK","Papua-Neiguinéiesche Kina");
    result.put("PHP","Philippinnesche Peso");
    result.put("PKR","Pakistanesch Rupie");
    result.put("PLN","Polneschen Zloty");
    result.put("PLZ","Polneschen Zloty (1950–1995)");
    result.put("PTE","Portugiseschen Escudo");
    result.put("PYG","Paraguayeschen Guaraní");
    result.put("QAR","Katar-Riyal");
    result.put("RHD","Rhodeseschen Dollar");
    result.put("ROL","Rumänesche Leu (1952–2006)");
    result.put("RON","Rumänesche Leu");
    result.put("RSD","Serbeschen Dinar");
    result.put("RUB","Russesche Rubel");
    result.put("RUR","Russesche Rubel (1991–1998)");
    result.put("RWF","Ruanda-Frang");
    result.put("SAR","Saudi-Rial");
    result.put("SBD","Salomonen-Dollar");
    result.put("SCR","Seychellen-Rupie");
    result.put("SDD","Sudaneseschen Dinar (1992–2007)");
    result.put("SDG","Sudanesescht Pond");
    result.put("SDP","Sudanesescht Pond (1957–1998)");
    result.put("SEK","Schwedesch Kroun");
    result.put("SGD","Singapur-Dollar");
    result.put("SHP","St. Helena-Pond");
    result.put("SIT","Sloweneschen Tolar");
    result.put("SKK","Slowakesch Kroun");
    result.put("SLL","Sierra-leonesche Leone");
    result.put("SOS","Somalia-Schilling");
    result.put("SRD","Surinameschen Dollar");
    result.put("SRG","Surinamesche Gulden");
    result.put("SSP","Südsudanesescht Pond");
    result.put("STD","São-toméeschen Dobra (1977–2017)");
    result.put("STN","São-toméeschen Dobra");
    result.put("SUR","Sowjetesche Rubel");
    result.put("SVC","El-Salvador-Colón");
    result.put("SYP","Syrescht Pond");
    result.put("SZL","Swasilännesche Lilangeni");
    result.put("THB","Thailännesche Baht");
    ...
    result.put("TND","Tuneseschen Dinar");
    result.put("TOP","Tongaeschen Paʻanga");
    result.put("TPE","Timor-Escudo");
    result.put("TRL","Tierkesch Lira (1922–2005)");
    result.put("TRY","Tierkesch Lira");
    result.put("TTD","Trinidad-an-Tobago-Dollar");
    result.put("TWD","Neien Taiwan-Dollar");
    result.put("TZS","Tansania-Schilling");
    result.put("UAH","Ukraineschen Hrywnja");
    result.put("UAK","Ukrainesche Karbovanetz");
    result.put("UGS","Uganda-Schilling (1966–1987)");
    result.put("UGX","Uganda-Schilling");
    result.put("USD","US-Dollar");
    result.put("USN","US Dollar (Nächsten Dag)");
    result.put("USS","US Dollar (Selwechten Dag)");
    result.put("UYP","Uruguayesche Peso (1975–1993)");
    result.put("UYU","Uruguayesche Peso");
    result.put("UZS","Usbekistan-Sum");
    result.put("VEB","Venezolanesche Bolívar (1871–2008)");
    result.put("VEF","Venezolanesche Bolívar (2008–2018)");
    result.put("VES","Venezolanesche Bolívar");
    result.put("VND","Vietnameseschen Dong");
    result.put("VUV","Vanuatu-Vatu");
    result.put("WST","Samoaneschen Tala");
    result.put("XAF","CFA-Frang (BEAC)");
    result.put("XAG","Onze Sëlwer");
    result.put("XAU","Onze Gold");
    result.put("XBA","Europäesch Rechnungseenheet");
    result.put("XBB","Europäesch Währungseenheet (XBB)");
    result.put("XBC","Europäesch Rechnungseenheet (XBC)");
    result.put("XBD","Europäesch Rechnungseenheet (XBD)");
    result.put("XCD","Ostkaribeschen Dollar");
    result.put("XDR","Sonnerzéiungsrecht");
    result.put("XEU","Europäesch Währungseenheet (XEU)");
    result.put("XFO","Franséische Gold-Frang");
    result.put("XFU","Franséischen UIC-Frang");
    result.put("XOF","CFA-Frang (BCEAO)");
    result.put("XPD","Onz Palladium");
    result.put("XPF","CFP-Frang");
    result.put("XPT","Onz Platin");
    result.put("XRE","RINET Funds");
    result.put("XTS","Testwährung");
    result.put("XXX","Onbekannt Währung");
    result.put("YDD","Jemen-Dinar");
    result.put("YER","Jemen-Rial");
    result.put("YUD","Jugoslaweschen Dinar (1966–1990)");
    result.put("YUM","Jugoslaweschen Neien Dinar (1994–2002)");
    result.put("YUN","Jugoslaweschen Dinar (konvertibel)");
    result.put("ZAL","Südafrikanesche Rand (Finanz)");
    result.put("ZAR","Südafrikanesche Rand");
    result.put("ZMK","Kwacha (1968–2012)");
    result.put("ZMW","Kwacha");
    result.put("ZRN","Zaire-Neien Zaïre (1993–1998)");
