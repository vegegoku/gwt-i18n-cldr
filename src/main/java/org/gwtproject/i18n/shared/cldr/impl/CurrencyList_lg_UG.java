...
public class CurrencyList_lg_UG extends CurrencyList_lg {
  ...
  protected HashMap<String, String> loadNamesMap() {
    ...
    result.put("AED","Diraamu eya Emireeti");
    result.put("AOA","Kwanza ey’Angola");
    result.put("AUD","Doola ey’Awusiturelya");
    result.put("BHD","Dinaali ey’eBaareeni");
    result.put("BIF","Faranga ey’eburundi");
    result.put("BWP","Pula ey’eBotiswana");
    result.put("CAD","Doola ey’eKanada");
    result.put("CDF","Faranga ey’eKongo");
    result.put("CHF","Faranga ey’eSwitizirandi");
    result.put("CNY","Yuwani Reniminibi ey’eCayina");
    result.put("CVE","Esikudo ey’Keepu Veredi");
    result.put("DJF","Faranga ey’eJjibuti");
    result.put("DZD","Dinaali ey’Aligerya");
    result.put("EGP","Pawundi ey’eMisiri");
    result.put("ERN","Nakifa ey’Eritureya");
    result.put("ETB","Biiru ey’Esyopya");
    result.put("EUR","Yuro");
    result.put("GBP","Pawundi ey’eBungereza");
    result.put("GHC","Sedi ey’eGana");
    result.put("GMD","Dalasi ey’eGambya");
    result.put("GNS","Faranga ey’eGini");
    result.put("INR","Rupiya ey’eBuyindi");
    result.put("JPY","Yeni ey’eJapani");
    result.put("KES","Silingi ey’eKenya");
    result.put("KMF","Faranga ey’eKomoro");
    result.put("LRD","Doola ey’eLiberya");
    result.put("LSL","Loti ey’eLesoso");
    result.put("LYD","Dinaali ey’eLibya");
    result.put("MAD","Diraamu ey’eMoroko");
    result.put("MGA","Faranga ey’eMalagase");
    result.put("MRO","Wugwiya ey’eMawritenya (1973–2017)");
    result.put("MRU","Wugwiya ey’eMawritenya");
    result.put("MUR","Rupiya ey’eMawurisyasi");
    result.put("MWK","Kwaca ey’eMalawi");
    result.put("MZM","Metikaali ey’eMozambiiki");
    result.put("NAD","Doola ey’eNamibiya");
    result.put("NGN","Nayira ey’eNayijerya");
    result.put("RWF","Faranga ey’eRwanda");
    result.put("SAR","Riyaali ey’eBuwarabu");
    result.put("SCR","Rupiya ey’eSesere");
    result.put("SDG","Dinaali ey’eSudaani");
    result.put("SDP","Pawundi ey’eSudaani");
    result.put("SHP","Pawundi ey’eSenti Herena");
    result.put("SLL","Lewone");
    result.put("SOS","Silingi ey’eSomaliya");
    result.put("STD","Dobura ey’eSantome ne Purincipe (1977–2017)");
    result.put("STN","Dobura ey’eSantome ne Purincipe");
    result.put("SZL","Lilangeni");
    result.put("TND","Dinaali ey’eTunizya");
    result.put("TZS","Silingi ey’eTanzaniya");
    result.put("UGX","Silingi eya Yuganda");
    result.put("USD","Doola ey’Amerika");
    result.put("XAF","Faranga ey’omu Afirika eya wakati");
    result.put("XOF","Faranga ey’omu Afirika ey’ebugwanjuba");
    result.put("ZAR","Randi ey’eSawusafirika");
    result.put("ZMK","Kwaca ey’eZambya (1968–2012)");
    result.put("ZMW","Kwaca ey’eZambya");
    result.put("ZWD","Doola ey’eZimbabwe");
    return result;
  }
}
