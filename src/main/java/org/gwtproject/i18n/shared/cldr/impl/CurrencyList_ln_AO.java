...
public class CurrencyList_ln_AO extends CurrencyList_ln {
  public CurrencyData getDefault() {
    return new CurrencyDataImpl("AOA","Kz",2,"Kz","Kz");
  }
  ...
  protected HashMap<String, CurrencyData> loadCurrencyMap() {
    ...
    // Falánga ya Swisɛ
    result.put("CHF", new CurrencyDataImpl("CHF","Fr.",2,"Fr.","Fr."));
    // CHW
    ...
    // Falánga CFP
    result.put("XPF", new CurrencyDataImpl("XPF","F CFP",0,"F CFP","F CFP"));
    // XPT
  ...
  protected HashMap<String, String> loadNamesMap() {
    ...
    result.put("AED","Dirihamɛ ya Lémila alabo");
    result.put("ALL","Lek");
    result.put("AOA","Kwanza ya Angóla");
    result.put("ARS","Peso y’Argentina");
    result.put("AUD","Dolarɛ ya Ositali");
    result.put("AWG","Guldeni y’ Aruba");
    result.put("BAM","Mark ya kobóngwama");
    result.put("BBD","Dolále ya Barbados");
    result.put("BGN","Lev ya Bulgaria");
    result.put("BHD","Dinarɛ ya Bahrɛnɛ");
    result.put("BIF","Falánga ya Burundi");
    result.put("BOB","Boliviano");
    result.put("BRL","Real ya Brazil");
    result.put("BSD","Dolále ya Bahamas");
    result.put("BWP","Pula ya Botswana");
    result.put("BYN","Rubelé ya Bielorusí");
    result.put("BYR","Rubelé ya Bielorusí (2000–2016)");
    result.put("BZD","Dolále ya Belíze");
    result.put("CAD","Dolarɛ ya Kanadá");
    result.put("CDF","Falánga ya Kongó");
    result.put("CHF","Falánga ya Swisɛ");
    result.put("CLP","Peso ya Shili");
    result.put("CNY","Yuanɛ Renminbi ya Sinɛ");
    result.put("COP","Peso ya Kolombi");
    result.put("CRC","Colon ya Kosta Rika");
    result.put("CUP","Peso ya Kuba");
    result.put("CVE","Esikudo ya Kapevɛrɛ");
    result.put("CZK","Motolé Sheki");
    result.put("DJF","Falánga ya Dzibuti");
    result.put("DKK","Motolé ya Danemark");
    result.put("DOP","Peso Dominikani");
    result.put("DZD","Dinarɛ ya Alizeri");
    result.put("EGP","Paunɛ ya Ezípitɛ");
    result.put("ERN","Nakfa ya Elitlɛ");
    result.put("ETB","Birɛ ya Etsiópi");
    result.put("EUR","Ɛlɔ́");
    result.put("FJD","Dolále ya Fiji");
    result.put("GBP","Paunɛ ya Angɛlɛtɛ́lɛ");
    result.put("GHC","Sedi ya Gana");
    result.put("GHS","Cedi");
    result.put("GIP","Bojito ya Gibraltar");
    result.put("GMD","Dalasi ya Gambi");
    result.put("GNF","Falánga ya Gine");
    result.put("GNS","Falánga ya Ginɛ");
    result.put("GTQ","Quetzal");
    result.put("HNL","Lempira");
    result.put("HRK","Kuna ya Kroasia");
    result.put("HTG","Gurde");
    result.put("HUF","Folinte");
    result.put("INR","Rupi ya Índɛ");
    result.put("ISK","Motolé ya Islandi");
    result.put("JMD","Dolále ya Jamaïke");
    result.put("JPY","Yeni ya Zapɔ");
    result.put("KES","Shilingɛ ya Kenya");
    result.put("KMF","Falánga ya Komoro");
    result.put("KYD","Dolále ya Bisanga bya Kayman");
    result.put("LRD","Dolarɛ ya Liberya");
    result.put("LSL","Loti ya Lesóto");
    result.put("LTL","Litas ya Litwani");
    result.put("LVL","Lats ya Letoni");
    result.put("LYD","Dinarɛ ya Libí");
    result.put("MAD","Dirihame ya Marokɛ");
    result.put("MGA","Falánga ya Madagasikarɛ");
    result.put("MKD","Denalé");
    result.put("MRO","Ugwiya ya Moritani (1973–2017)");
    result.put("MRU","Ugwiya ya Moritani");
    result.put("MUR","Rupi ya Morisi");
    result.put("MWK","Kwasha ya Malawi");
    result.put("MXN","Peso ya Mexiko");
    result.put("MZM","Metikali ya Mozambiki");
    result.put("MZN","Métikal");
    result.put("NAD","Dolarɛ ya Namibi");
    result.put("NGN","Naira ya Nizerya");
    result.put("NOK","Motolé ya Norvej");
    result.put("NZD","Dolále ya Zeland ya Sika");
    result.put("PAB","Balboa");
    result.put("PEN","Sol Sika");
    result.put("PGK","Kina");
    result.put("PLN","Sloty");
    result.put("PYG","Guarani");
    result.put("RON","Leu Sika");
    result.put("RSD","Dinalé ya Serbia");
    result.put("RUB","Rubelé ya Rusí");
    result.put("RWF","Falánga ya Rwanda");
    result.put("SAR","Riyalɛ ya Alabi Sawuditɛ");
    result.put("SBD","Dolále ya Bisanga Solomoni");
    result.put("SCR","Rupi ya Sɛshɛlɛ");
    result.put("SDG","Dinarɛ ya Sudá");
    result.put("SDP","Paunɛ ya Sudá");
    result.put("SEK","Motolé ya Swédi");
    result.put("SHP","Paunɛ ya Sántu elena");
    result.put("SLL","Leonɛ");
    result.put("SOS","Shilingɛ ya Somali");
    result.put("SSP","Bojito ya Sudaní ya Súdi");
    result.put("STD","Dobra ya Sao Tomé mpé Presipe (1977–2017)");
    result.put("STN","Dobra ya Sao Tomé mpé Presipe");
    result.put("SZL","Lilangeni");
    result.put("TND","Dinarɛ ya Tinizi");
    result.put("TOP","Pa’Anga");
    result.put("TTD","Dolále ya Trinidad mpé Tobago");
    result.put("TZS","Shilingɛ ya Tanzani");
    result.put("UAH","Griwná");
    result.put("UGX","Shilingɛ ya Uganda");
    result.put("USD","Dolarɛ ya Ameriki");
    result.put("VUV","Vatu");
    result.put("WST","Tala");
    result.put("XAF","Falánga CFA BEAC");
    result.put("XCD","Dolále ya Kalibí Monyɛlɛ");
    result.put("XOF","Falánga CFA BCEAO");
    result.put("XPF","Falánga CFP");
    result.put("ZAR","Randɛ ya Afríka Súdi");
    result.put("ZMK","Kwasha ya Zambi (1968–2012)");
    result.put("ZMW","Kwasha ya Zambi");
    result.put("ZWD","Dolarɛ ya Zimbabwɛ");
    return result;
  }
}
