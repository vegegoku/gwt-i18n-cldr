...
public class CurrencyList_lo_LA extends CurrencyList_lo {
  public CurrencyData getDefault() {
    return new CurrencyDataImpl("LAK","₭",0,"₭","₭");
  }
  ...
  protected HashMap<String, CurrencyData> loadCurrencyMap() {
    ...
    // ຈໍ​ຈຽນ ລາ​ຣິ
    result.put("GEL", new CurrencyDataImpl("GEL","ລາຣີ",2,"ລາຣີ","ລາຣີ"));
    // ເຊດີ ການາ (1979–2007)
  ...
  protected HashMap<String, String> loadNamesMap() {
    ...
    result.put("AFN","ອັຟ​ກັນ ອັຟ​ກາ​ນິ");
    result.put("ALL","ອັລ​ບາ​ນຽນ ເລກ");
    result.put("AMD","ອາ​ເມ​ນຽນ ແດຣມ");
    result.put("ANG","ເນ​ເທີ​ແລນ ແອນ​ຕິ​ລຽນ ກິວ​ເດີ");
    result.put("AOA","ແອງ​ໂກ​ລັນ ຄວນ​ຊາ");
    result.put("AOK","ກວານຊາ ແອງໂກລາ (1977–1991)");
    result.put("AON","ກວານຊາ ແອງໂກລາ ໃໝ່ (1995–1999)");
    result.put("AOR","ກວານຊາກທີ່ແກ້ໄຂໃໝ່ ແອງກູລາ (1995–1999)");
    result.put("ARA","ອອສຕຣານ ອາກຊັງຕິນ");
    result.put("ARL","ເປໂຊເລ ອາກຊັງຕິນ (1970–1983)");
    result.put("ARM","ເປໂຊ ອາກຊັງຕິນ (1881–1970)");
    result.put("ARP","ເປໂຊ ອາກຊັງຕິນ (1983–1985)");
    result.put("ARS","ອາ​ເຈນ​ທິ​ນາ ເປ​ໂຊ");
    result.put("ATS","ຊິລລິງ ອົດສະຕາລີ");
    result.put("AUD","ອອສ​ເຕຣ​ລຽນ ໂດ​ລ່າ");
    result.put("AWG","ອະຣູແບນ ຟລໍຣິນ");
    result.put("AZM","ມານັດ ອາແຊກບາຍຊານ (1993–2006)");
    result.put("AZN","ອາ​ເຊີ​ໄບ​ຈາ​ນິ ມາ​ນັດ");
    result.put("BAD","ດີນາ ບອສເນຍ ເຮີເຊໂບວາເນຍ (1992–1994)");
    result.put("BAM","ບອ​ສ​ເນຍ-ເຮີ​ເຊ​ໂກວິ​ນາ ຄອນ​ເວີດ​ຕິ​ໂບ ມາກ");
    result.put("BAN","ດີນາໃໝ່ ບອສເນຍ ເຮີເຊໂບວີນາ(1994–1997)");
    result.put("BBD","ໂດລ່າ ບາບາດຽນ");
    result.put("BDT","ບັງ​ຄລາ​ເທດ ຕາ​ກາ");
    result.put("BEC","ຟຣັງ ບູນກາລີ (ປ່ຽນແປງໄດ້)");
    result.put("BEF","ຟຣັງ ບູນກາລີ");
    result.put("BEL","ຟຣັງ ບູນກາລີ (ການເງິນ)");
    result.put("BGL","ຮາດເລບ ບູນກາລີ");
    result.put("BGM","ເລບ ສັງຄົມບູນກາລີ");
    result.put("BGN","ບັງ​ກາ​ຣຽນ ເລບ");
    result.put("BGO","ເລບ ບູນກາລີ (1879–1952)");
    result.put("BHD","ບາ​ໄຣ​ນິ ດິ​ນາ");
    result.put("BIF","ບຸ​ຣັນ​ດຽນ ຟຣັງ");
    result.put("BMD","ໂດ​ລ່າ​ເບີ​ມິວ​ດາ");
    result.put("BND","ບຣູ​ໄນ ໂດ​ລ່າ");
    result.put("BOB","ໂບ​ລິ​ວຽນ ໂບ​ລິ​ເວຍ​ໂນ");
    result.put("BOL","ໂລລິເວຍໂນ ໂລລິເວຍ (1863–1963)");
    result.put("BOP","ເປໂຊໂລລິເວຍ");
    result.put("BOV","ມະດອນ ໂລລິເວຍ");
    result.put("BRB","ກຣູເຊໂດບາຊິ ໃໝ່ (1967–1986)");
    result.put("BRC","ກຣູຊາໂດບາຊິວ (1986–1989)");
    result.put("BRE","ກຣູເຊໂຣ ບາຊິ ກຣູໂຊ ບາຊິວ (1993–1994)");
    result.put("BRL","ບຣາ​ຊິ​ລຽນ ຣຽວ");
    result.put("BRN","ກຣູຊາໂດ ບາຊິວ ໃໝ່ (1989–1990)");
    result.put("BRR","ກຣູເຊໂຣ ບາຊິວ (1993–1994)");
    result.put("BRZ","ກຣູເຊໂຣ ບາຊິວ (1942–1967)");
    result.put("BSD","ໂດລ່າ ບາຮາມຽນ");
    result.put("BTN","ພູ​ຖານ ງຸນດຣັມ");
    result.put("BUK","ຈາດ ພະມ້າ");
    result.put("BWP","ບອດ​ສະ​ວາ​ນານ ພູ​ລາ");
    result.put("BYB","ຣູໂບ ເບຣາຣຸສ ໃໝ່(1994–1999)");
    result.put("BYN","ເບ​ລາ​ຣຸ​ສ​ຊຽນ ຣູ​ເບິນ");
    result.put("BYR","ເບ​ລາ​ຣຸ​ສ​ຊຽນ ຣູ​ເບິນ (2000–2016)");
    result.put("BZD","ໂດ​ລ່າ​ເບ​ລິ​ຊ");
    result.put("CAD","ໂດລ່າຄານາດາ");
    result.put("CDF","ຄອງ​ໂກ​ລີສ ຟຣັງ");
    result.put("CHE","ເອີໂຣ WIR");
    result.put("CHF","ສະ​ວິ​ສ ຟ​ຣັງ");
    result.put("CHW","ຟຣັງ WIR");
    result.put("CLE","ເອສກູໂດ ຊິລີ");
    result.put("CLF","ຫົວໜ່ວຍບັນຊີ (UF) ຊິລີ");
    result.put("CLP","ຊິ​ລຽນ ເປ​ໂຊ");
    result.put("CNH","ຢວນຈີນ (ນອກປະເທດ)");
    result.put("CNY","ຈີນ ຢວນ");
    result.put("COP","ໂຄ​ລົມ​ບຽນ ເປ​ໂຊ");
    result.put("COU","ຫົວໜ່ວຍຄ່າຈິງ ໂຄລັມເບຍ");
    result.put("CRC","ໂຄສຕາ ຣິກັນ ໂຄລອນ");
    result.put("CSD","ດີນາ ເຊີເບຍ (2002–2006)");
    result.put("CSK","ຮາດໂກຣູນາ ເຊັກໂກສະໂລວັກ");
    result.put("CUC","ຄິວແບນ ຄອນເວີດຕິໂບ ເປໂຊ");
    result.put("CUP","ຄິວແບນ ເປໂຊ");
    result.put("CVE","ເຄບ ເວີດ​ດີນ ເອ​ສ​ຄູ​ໂດ");
    result.put("CYP","ປອນ ໄຊປຣັດ");
    result.put("CZK","ໂຄ​ຣູ​ນາ ເຊກ");
    result.put("DDM","ມາກ ເຢຍລະມັນ ຕາເວັນອອກ");
    result.put("DEM","ມາກ ເຢຍລະມັນ");
    result.put("DJF","​ດິ​ບູ​ຈຽນ ຟຣັງ");
    result.put("DKK","ແດນ​ນິ​ຊ ໂຄຣນ");
    result.put("DOP","ໂດ​ມິ​ນິ​ກັນ ເປ​ໂຊ");
    result.put("DZD","ອັລ​ເຈີ​ຣຽນ ດິ​ນາ");
    result.put("ECS","ຊູເກ ເອກາວາດໍ");
    result.put("ECV","ຫົວໜ່ວຍຄ່າຄົງທີ່ຂອງເອກາວາດໍ");
    result.put("EEK","ຄຣູນເອສ ໂຕເນຍ");
    result.put("EGP","ອີ​ຢິບ​ທຽນ ພາວດ໌");
    result.put("ERN","ອິ​ຣິ​ທຣຽນ ແນກ​ຟ​າ");
    result.put("ESA","ເປເຊຕາສະເປັນ (ບັນຊີ)");
    result.put("ESB","ເປເຊຕາສະເປນ (ປ່ຽນແປງໄດ້)");
    result.put("ESP","ເປເຊຕາ ສະເປນ");
    result.put("ETB","ເອ​ທິ​ໂອ​ປຽນ ເບີ​ຣ໌");
    result.put("EUR","ຢູ​ໂຣ");
    result.put("FIM","ມາກກາ ຟິນແລນ");
    result.put("FJD","ຟິ​ຈຽນ ໂດ​ລ່າ");
    result.put("FKP","ຟອ​ລ໌ກ​ແລນ ໄອ​ແລນ​ສ໌ ພາວ​ດ໌");
    result.put("FRF","ຟຣັງ ຝຣັ່ງ");
    result.put("GBP","ປອນ ສະ​ເຕີ​ຣິງ (ອັງ​ກິດ)");
    result.put("GEK","ກູປອນ ລາຣິທ ຈໍເຈຍ");
    result.put("GEL","ຈໍ​ຈຽນ ລາ​ຣິ");
    result.put("GHC","ເຊດີ ການາ (1979–2007)");
    result.put("GHS","ເຊ​ດິ ກາ​ນາ​ອຽນ");
    result.put("GIP","ກິບ​ຣາ​ທາ ພາ​ວດ໌");
    result.put("GMD","​ແກມ​ບຽນ ດາ​ລາ​ຊິ");
    result.put("GNF","ກິ​ນຽນ ຟຣັງ");
    result.put("GNS","ໄຊລິ ກີນີ");
    result.put("GQE","ເອັກເວເລ ອີຄວາຕິຣຽວ ກິນີ");
    result.put("GRD","ດາກຊະມາ ເກຣັກ");
    result.put("GTQ","ກົວເຕມາລານ ເຄັດຊອນ");
    result.put("GWE","ເອສກູໂດ ກີນີໂປຕູເກດ");
    result.put("GWP","ເປໂຊກິນີ-ບິສເຊົາ");
    result.put("GYD","ກາຍ​ຢາ​ນີ​ສ ໂດ​ລ່າ");
    result.put("HKD","ຮອງ​ກົງ ໂດ​ລ່າ");
    result.put("HNL","ຮອນດູແຣນ ເລມພິຣາ");
    result.put("HRD","ດີນາ ໂຄຣເອເຊຍ");
    result.put("HRK","ໂຄຣ​ເອ​ທຽນ ຄູ​ນາ");
    result.put("HTG","ໄຮ​ຕຽນ ກົວ​ເດ");
    result.put("HUF","ຮັງ​ກາ​ຣຽນ ຟໍ​ຣິນ");
    result.put("IDR","ອິນ​ໂດ​ເນ​ຊຽນ ໂດ​ລ່າ");
    result.put("IEP","ປອນ ໄອຣິຊ");
    result.put("ILP","ປອນ ອີສະລາເອວ");
    result.put("ILS","ອິສ​ຣາ​ເອວ​ລິ ນິວ ເຊ​ເກວ");
    result.put("INR","ອິນ​ເດຍ ຣູ​ປີ");
    result.put("IQD","ອິ​ຣັກ​ກິ ດິ​ນາ");
    result.put("IRR","ອິ​ຣາ​ນິ ຣຽວ");
    result.put("ISK","ໄອ​ສ໌​ແລນ​ດິກ ໂຄຣ​ນາ");
    result.put("ITL","ລິຣາ ອີຕາລີ");
    result.put("JMD","​ຈາ​ໄມ​ກັນ ໂດ​ລ່າ");
    result.put("JOD","ຈໍ​ແດ​ນຽນ ດິ​ນາ");
    result.put("JPY","ຍີ່​ປຸ່ນ ເຢນ");
    result.put("KES","ເຄນ​ຢັນ ຊິວ​ລິງ");
    result.put("KGS","ຄ​ຣີ​ກິສ​​ຖາ​ນິ ໂຊມ");
    result.put("KHR","ກຳ​ປູ​ເຈຍ ຣຽວ");
    result.put("KMF","ໂຄ​ໂມ​ຣຽນ ຟຣັງ");
    result.put("KPW","ເກົາ​ຫລີ​ເໜືອ ວອນ");
    result.put("KRH","ຮາວານ ເກົາຫຼີເນື້");
    result.put("KRO","ວອນ ເກົາຫຼີໃຕ້ (1945–1953)");
    result.put("KRW","ເກົາ​ຫລີໃຕ້ ວອນ");
    result.put("KWD","ຄູ​ເວ​ຕິ ດິ​ນາ");
    result.put("KYD","ເຄ​ແມນ ໄອ​ແລນ ໂດ​ລ່າ");
    result.put("KZT","ຄາ​ຊັກ​ສະ​ຖາ​ນິ ເຕັງ​ເຈ");
    result.put("LAK","ລາວ ກີບ");
    result.put("LBP","ເລ​ບາ​ນີ​ສ ພາວດ໌");
    result.put("LKR","ສີ​ລັງ​ກາ ຣູ​ປີ");
    result.put("LRD","ລິ​ເບີ​ຣຽນ ໂດ​ລ່າ");
    result.put("LSL","ໂລຕິ ເລໂຊໂຕ");
    result.put("LTL","ລິ​ທົວ​ນຽນ ລິ​ທັ​ສ");
    result.put("LTT","ທາໂລນັສ ລິທົວເນຍ");
    result.put("LUC","ຟຣັງ ລຸກຊຳບວກ ທີ່ປ່ຽນແປງ");
    result.put("LUF","ຟຣັງ ລຸກຊຳບວກ");
    result.put("LUL","ຟຣັງ ລຸກຊຳບວກ ການເງິນ");
    result.put("LVL","ລັດ​ວຽນ ລັດ​ສ໌");
    result.put("LVR","ຣູໂບ ລາວຽນ");
    result.put("LYD","ລິບ​ບຽນ ດິ​ນາ");
    result.put("MAD","ມໍ​ຣັອກ​ແຄນ​ ເດີ​ແຮມ");
    result.put("MAF","ຟຣັງ ໂມຣອກໂກ");
    result.put("MCF","ຟຣັງ ໂມດາໂກ");
    result.put("MDC","ບັດປັນສ່ວນ ມອງໂດວາ");
    result.put("MDL","ມອນ​ໂດ​ແວນ ເລ​ອູ");
    result.put("MGA","ມາ​ລາ​ກາ​ຊີ ອາ​ເຣຍ​ຣີ");
    result.put("MGF","ຟຣັງ ມາດາກັດສະກາ");
    result.put("MKD","ແມັກ​ເຊ​ໂດ​ນຽນ ເດ​ນາ");
    result.put("MKN","ດີນາ ມາຊີໂດເນຍ (1992–1993)");
    result.put("MLF","ຟຣັງ ມາລີ");
    result.put("MMK","ມຽນ​ມາ ຈ໊າດ");
    result.put("MNT","ມອງ​ໂກ​ລຽນ ຕູກຣິກ");
    result.put("MOP","ມາ​ເກົ້າ ປາ​​ຕາ​ກາ");
    result.put("MRO","ມົວ​ຣິ​ທາ​ນຽນ ອູ​ກິວ​ຢາ (1973–2017)");
    result.put("MRU","ມົວ​ຣິ​ທາ​ນຽນ ອູ​ກິວ​ຢາ");
    result.put("MTL","ລິຣາ ມອນຕາ");
    result.put("MTP","ປອນ ມອນຕາ");
    result.put("MUR","ເມົາ​ຣິ​ທຽນ ຣູ​ປີ");
    result.put("MVR","ມັ​ລ​ດິ​ວຽນ ຣູ​ຟິ​ຢາ");
    result.put("MWK","ມາ​ລາ​ວຽນ ຄວາ​ຊາ");
    result.put("MXN","ເມັກຊິກັນ ເປໂຊ");
    result.put("MXP","ຫົວໜ່ວຍເງິນ ເປໂຊ ແມັກຊິໂກ(1861–1992)");
    result.put("MXV","ຫົວໜ່ວຍການລົງທຶນ ແມັກຊິໂກ");
    result.put("MYR","ມາ​ເລ​ເຊຍ ຣິງ​ກິດ");
    result.put("MZE","ເອສກູໂດ ໂມຊຳບິກ");
    result.put("MZM","ເມຕິຄໍ ໂມຊຳບິກ (1980–2006)");
    result.put("MZN","ໂມ​ແຊມ​ບິ​ກັນ ເມ​ທິ​ຄອນ");
    result.put("NAD","ນາ​ມິ​ບຽນ ໂດ​ລ່າ");
    result.put("NGN","ໄນ​ຣາ ​ໄນເຈີ​ຣຽນ");
    result.put("NIC","ຄໍໂດບາ ນິກາຣາກົວ (1988–1991)");
    result.put("NIO","ນິກາຣາກວນ ໂຄໂດບາ");
    result.put("NLG","ກິລເດີ ເນເທີແລນ");
    result.put("NOK","ນໍ​ເວ​ກຽນ ​ໂຄຣນ");
    result.put("NPR","ເນ​ປານ ຣູ​ປີ");
    result.put("NZD","ນິວ​ຊີ​ແລນ ໂດ​ລ່າ");
    result.put("OMR","ໂອ​ມາ​ນິ ຣຽວ");
    result.put("PAB","ພານາມານຽນ ບອນບົວ");
    result.put("PEI","ອິນຕິ ເປຣູ");
    result.put("PEN","ເປ​ຣູ​ວຽນ ໂຊ​ລ໌");
    result.put("PES","ໂຊນ ເປຣູ (1863–1965)");
    result.put("PGK","ປາ​ປົວ ນິວ ກິ​ນຽນ ກິ​ນາ");
    result.put("PHP","ຟິ​ລິບ​ປິນ ເປ​ໂຊ");
    result.put("PKR","ປາ​ກິ​ສຖານ ຣູ​ປີ");
    result.put("PLN","ໂປ​ລິ​ຊ ຊະ​ລໍ​ຕີ");
    result.put("PLZ","ຊະລອສຕີ ໂປແລນ (1950–1995)");
    result.put("PTE","ເອສກູໂດ ໂປຕູເກສ");
    result.put("PYG","ກວາຣານີ ປາຣາກວາຍ");
    result.put("QAR","ຄາ​ຕາ​ຣິ ຣຽວ");
    result.put("RHD","ດອນລາ ໂຣດີເຊຍ");
    result.put("ROL","ລິວ ໂຣມາເນຍເກົ່າ");
    result.put("RON","ໂຣ​ມາ​ນຽນ ເລ​ອູ");
    result.put("RSD","ເຊີ​ບຽນ ດິ​ນາ");
    result.put("RUB","ຣັສ​ຊຽນ ຣູ​ເບິນ");
    result.put("RUR","ຣູໂບ ຣັດເຊຍ (1991–1998)");
    result.put("RWF","ຣະ​ວັນ​ດັນ ຟຣັງ");
    result.put("SAR","ຊາ​ອູ​ດິ ຣິ​ຢອນ");
    result.put("SBD","ໂຊ​ໂລມອນ ໄອ​ແລນ ໂດ​ລ່າ");
    result.put("SCR","ເຊ​ເຊວ​ລອຍ​ສ໌ ຣູ​ປີ");
    result.put("SDD","ດີນາ ຊູດານເກົ່າ");
    result.put("SDG","ຊູ​ດານ​ນີ​ສ ພາວດ໌");
    result.put("SDP","ປອນ ຊູດານເກົ່າ");
    result.put("SEK","ສະ​ວີ​ດິ​ຊ ໂຄຣ​ນາ");
    result.put("SGD","ສິງ​ກະ​ໂປ ໂດ​ລ່າ");
    result.put("SHP","ເຊນ ເຮ​ເລ​ນາ ພາວດ໌");
    result.put("SIT","ໂຕລາ ສະໂລວິເນຍ");
    result.put("SKK","ຄູໂຣນາ ສະໂລວັກ");
    result.put("SLL","ເຊຍ​ນາ ​ເລໂອ​ນຽນ ເລ​ໂອນ");
    result.put("SOS","ໂຊ​ມາ​ລິ ຊິວ​ລິງ");
    result.put("SRD","ຊູ​ຣິ​ນາ​ມີ​ສ ໂດ​ລ່າ");
    result.put("SRG","ກິລເດີ ຊູຣິນາເມ");
    result.put("SSP","ເຊົາ​ທ໌ ຊູ​ດານ​ນີ​ສ ພາວດ໌");
    result.put("STD","ເຊົາ ໂທ​ເມ ແອນ ພ​ຣິນ​ຊິ​ປີ ໂດບຣາ (1977–2017)");
    result.put("STN","ເຊົາ ໂທ​ເມ ແອນ ພ​ຣິນ​ຊິ​ປີ ໂດບຣາ");
    result.put("SUR","ຣູໂບ ໂຊວຽດ");
    result.put("SVC","ໂກລອງ ເອກາວາດໍ");
    result.put("SYP","ຊີ​ຣຽນ ພາວດ໌");
    result.put("SZL","ສະ​ວາ​ຊິ ລິ​ລັນ​ກິ​ນີ");
    result.put("THB","ໄທ ບາດ");
    result.put("TJR","ຣູໂບ ຕັຈີກິສຖານ");
    result.put("TJS","ທາ​ຈິ​ກິ​​ຖາ​ນິ ໂຊ​ໂມ​ນິ");
    result.put("TMM","ມານັດ ຕວກເມນິສຖານ (1966–1987)");
    result.put("TMT","ເຕີກ​ເມ​ນິ​ສ​ຖາ​ນິ ມາ​ນັດ");
    result.put("TND","ຕູ​ນິ​ຊຽນ ດິ​ນາ");
    result.put("TOP","ຕອງ​ກັນ ປາ​ອັງ​ກາ");
    result.put("TPE","ເອສກູໂດ ຕີມໍ");
    result.put("TRL","ລີຕາ ຕູຣາກີເກົ່າ");
    result.put("TRY","ເຕີ​ກິ​ຊ ລິ​ຣາ");
    result.put("TTD","ທ​ຣິ​ນິ​ແດດ ແອນ ໂທ​ບາ​ໂກ ໂດ​ລ່າ");
    result.put("TWD","ນິວ ໄຕ້​ຫວັນ ໂດ​ລ່າ");
    result.put("TZS","ທານ​ຊາ​ນຽນ ຊິວ​ລິງ");
    result.put("UAH","ຢູ​ເຄຣ​ນຽນ ຮະ​ຣີບ​ເນຍ");
    result.put("UAK","ຄາໂບວາເນດ ອູແກຣນ");
    result.put("UGS","ຊິນລິງ ອູກັນດາ (1966–1987)");
    result.put("UGX","ອູ​ກັນ​ດັນ ຊິວ​ລິງ");
    result.put("USD","​ໂດ​ລ່າ​ສະ​ຫະ​ລັດຯ");
    result.put("USN","ດອນລາສະຫະລັດ (ມື້ຖັດໄປ)");
    result.put("USS","ດອນລາສະຫະລັດ (ມື້ດຽວກັນ)");
    result.put("UYI","ເປໂຊອູຣຸກວຍ (ຫົວໜ່ວຍອິນເດັກ)");
    result.put("UYP","ເປໂຊ ອູຣຸກວຍ (1975–1993)");
    result.put("UYU","ອູ​ຣຸ​ກົວ​ຢານ ເປ​ໂຊ");
    result.put("UZS","ອຸສເບກິສຖານິ ໂຊມ");
    result.put("VEB","ໂບລີວາ ເວເນຊູເອລາ (1871–2008)");
    result.put("VEF","ເວ​ເນ​ຊູ​ເອ​ລັນ ໂບ​ລິ​ວາ (2008–2018)");
    result.put("VES","ເວ​ເນ​ຊູ​ເອ​ລັນ ໂບ​ລິ​ວາ");
    result.put("VND","ຫວຽດ​ນາມ ດົງ");
    result.put("VNN","ດົງ ຫວຽດນາມ (1978–1985)");
    result.put("VUV","​ວາ​ນົວ​ຕູ ວາ​ຕູ");
    result.put("WST","ຊາ​ໂມນ ທາ​ລາ");
    result.put("XAF","ສາທາລະນະລັດອາຟຣິກາກາງ");
    result.put("XAG","ເງິນ");
    result.put("XAU","ຄຳ");
    result.put("XBA","ຫົວໜ່ວຍຄອມໂປຊິດ ເອີຣົບ");
    result.put("XBB","ຫົວໜ່ວຍໂມນີແທຣີ ເອີຣົບ");
    result.put("XBC","ຫົວໜ່ວຍບັນຊີເອີຣົບ (XBC)");
    result.put("XBD","ຫົວໜ່ວຍບັນຊີເອີຣົບ (XBD)");
    result.put("XCD","ອີ​ສ ຄາ​ຣິ​ບຽນ ໂດ​ລ່າ");
    result.put("XDR","ສິດທິຖອນເງິນພິເສດ");
    result.put("XEU","ຫົວໜ່ວຍສະກຸນເງິນ ເອີຣົບ");
    result.put("XFO","ຟຣັງ ຄຳຝຣັ່ງ");
    result.put("XFU","ຟຣັງ ຢູໄອຊີ ຝຣັ່ງ");
    result.put("XOF","ຟັງເຊຟານ ອາຟຣິກາຕາເວັນຕົກ");
    result.put("XPD","ແພເລດຽມ");
    result.put("XPF","ຊີ​ເອັບ​ພີ ຟຣັງ");
    result.put("XPT","ແພລັດຕິນຳ");
    result.put("XRE","ກອງທຶນໄຣເນັດ");
    result.put("XTS","ລະຫັດທົດສອບສະກຸນເງິນ");
    result.put("XXX","ສະກຸນເງິນທີ່ບໍ່ຮູ້ຈັກ");
    result.put("YDD","ດີນາ ເຢເມນ");
    result.put("YER","ເຢ​ເມ​ນິ ຣຽວ");
    result.put("YUD","ຮາດດີນາ ຢູໂກສະລາວີ");
    result.put("YUM","ດີນາໃໝ່ ຢູໂກສະລາວີ (1994–2002)");
    result.put("YUN","ດີນາ ທີ່ປ່ຽນສະພາບ ຢູໂກສະລາວີ (1990–1992)");
    result.put("YUR","ດີນາ ປະຕິຮູບ ຢູໂກສະລາວີ (1992–1993)");
    result.put("ZAL","ແຣນ ອາຟຣິກາໃຕ້ (ການເງິນ)");
    result.put("ZAR","ເຊົາທ໌ ອາ​ຟຣິ​ກັນ ແຣນດ໌");
    result.put("ZMK","ຄວາຊາ ຊັມເບຍ (1968–2012)");
    result.put("ZMW","ແຊມ​ບຽນ ຄວາ​ຊາ");
    result.put("ZRN","ແຊ ຄອງໂກໃໝ່");
    result.put("ZRZ","ແຊຄອງໂກ");
    result.put("ZWD","ດອນລາ ຊິມບັບເວ (1980–2008)");
    result.put("ZWL","ດອນລາ ຊິມບັບເວ (2009)");
    result.put("ZWR","ດອນລາ ຊິມບັບເວ (2008)");
    return result;
  }
}
