...
public class CurrencyList_lrc_IQ extends CurrencyList_lrc {
  ...
  protected HashMap<String, String> loadNamesMap() {
    ...
    result.put("EUR","یورو");
    result.put("GBP","پوند بئریتانیا");
    result.put("INR","روٙپیه هئن");
    result.put("JPY","یئن جاپوٙن");
    result.put("RUB","روٙبل روٙسیه");
    result.put("XXX","پیل نادیار");
    return result;
  }
}
