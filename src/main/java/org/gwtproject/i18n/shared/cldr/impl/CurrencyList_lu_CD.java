...
public class CurrencyList_lu_CD extends CurrencyList_lu {
  ...
  protected HashMap<String, String> loadNamesMap() {
    ...
    result.put("AED","Ndiriha wa Lemila alabu");
    result.put("AOA","Kwanza wa Angola");
    result.put("AUD","Ndola wa Ositali");
    result.put("BHD","Ndina wa Bahrene");
    result.put("BIF","Nfalanga wa Bulundi");
    result.put("BWP","Pula wa Botswana");
    result.put("CAD","Ndola wa Kanada");
    result.put("CDF","Nfalanga wa Kongu");
    result.put("CHF","Nfalanga wa Swise");
    result.put("CNY","Yuani Renminbi wa Shine");
    result.put("CVE","Esikuludo wa Kapevere");
    result.put("DJF","Nfalanga wa Dzibuti");
    result.put("DZD","Ndina wa Alijeri");
    result.put("EGP","Pauni wa Mushidi");
    result.put("ERN","Nakfa wa Elitle");
    result.put("ETB","Bira wa Etshiopi");
    result.put("EUR","Iro");
    result.put("GBP","Pauni wa Angeletele");
    result.put("GHC","Sedi wa Ngana");
    result.put("GMD","Ndalasi wa Ngambi");
    result.put("GNS","Nfalanga wa Ngina");
    result.put("INR","Rupi wa Inde");
    result.put("JPY","Yeni wa Zapɔ");
    result.put("KES","Nshili wa Kenya");
    result.put("KMF","Nfalanga wa Komoru");
    result.put("LRD","Ndola wa Liberya");
    result.put("LSL","Loti wa Lesoto");
    result.put("LYD","Ndina wa Libi");
    result.put("MAD","Ndiriha wa Maroke");
    result.put("MGA","Nfalanga wa Madagasikare");
    result.put("MRO","Ugwiya wa Moritani (1973–2017)");
    result.put("MRU","Ugwiya wa Moritani");
    result.put("MUR","Rupia wa Morisi");
    result.put("MWK","Kwasha wa Malawi");
    result.put("MZM","Metikali wa Mozambiki");
    result.put("NAD","Ndola wa Namibi");
    result.put("NGN","Naira wa Nizerya");
    result.put("RWF","Nfalanga wa Rwanda");
    result.put("SAR","Riyale wa Alabu Nsawu");
    result.put("SCR","Rupya wa Seshele");
    result.put("SDG","Ndina wa Suda");
    result.put("SDP","Pauni wa Suda");
    result.put("SHP","Pauni wa Santu Elena");
    result.put("SLL","Leone");
    result.put("SOS","Nshili wa Somali");
    result.put("STD","Dobra wa Sao Tome ne Presipe (1977–2017)");
    result.put("STN","Dobra wa Sao Tome ne Presipe");
    result.put("SZL","Lilangeni");
    result.put("TND","Ndina wa Tinizi");
    result.put("TZS","Nshili wa Tanzani");
    result.put("UGX","Nshili wa Uganda");
    result.put("USD","Ndola wa Ameriki");
    result.put("XAF","Nfalanga CFA BEAC");
    result.put("XOF","Nfalanga CFA BCEAO");
    result.put("ZAR","Rande wa Afrika wa Mwinshi");
    result.put("ZMK","Kwasha wa Zambi (1968–2012)");
    result.put("ZMW","Kwasha wa Zambi");
    result.put("ZWD","Ndola wa Zimbabwe");
    return result;
  }
}
