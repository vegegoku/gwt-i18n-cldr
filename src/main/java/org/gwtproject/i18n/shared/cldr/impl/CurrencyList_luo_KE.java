...
public class CurrencyList_luo_KE extends CurrencyList_luo {
  ...
  protected HashMap<String, String> loadNamesMap() {
    ...
    result.put("BWP","Pula mar Botswana");
    result.put("CAD","Dola mar Kanada");
    ...
    result.put("EGP","Paund mar Misri");
    result.put("ERN","Nakfa ya Eritrea");
    result.put("ETB","Birr mar Ethiopia");
    result.put("EUR","Yuro");
    result.put("GBP","Pauni mar Uingereza");
    result.put("GHC","Sedi mar Ghana");
    result.put("GMD","Dalasi ya Gambia");
    result.put("GNS","Faranga ya Gine");
    result.put("INR","Rupia ya India");
    result.put("JPY","Yen mar Japan");
    result.put("KES","Siling mar Kenya");
    result.put("KMF","Faranga ya Komoro");
    result.put("LRD","Dola mar Liberia");
