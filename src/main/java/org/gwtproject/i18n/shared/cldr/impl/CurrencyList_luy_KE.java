...
public class CurrencyList_luy_KE extends CurrencyList_luy {
  ...
  protected HashMap<String, String> loadNamesMap() {
    ...
    result.put("KES","Sirinji ya Kenya");
    ...
    result.put("TZS","Sirinji ya Tanzania");
    result.put("UGX","Sirinji ya Uganda");
