...
public class CurrencyList_lv_LV extends CurrencyList_lv {
  ...
  protected HashMap<String, CurrencyData> loadCurrencyMap() {
    ...
    // Latvijas lats
    result.put("LVL", new CurrencyDataImpl("LVL","Ls",130,"Ls","Ls"));
    // Latvijas rublis
  ...
  protected HashMap<String, String> loadNamesMap() {
    ...
    result.put("BAM","Bosnijas un Hercogovinas konvertējamā marka");
    ...
    result.put("BWP","Botsvanas pula");
    result.put("BYN","Baltkrievijas rubelis");
    result.put("BYR","Baltkrievijas rubelis (2000–2016)");
    ...
    result.put("CNH","Ķīnas juaņa (ofšors)");
    result.put("CNY","Ķīnas juaņs");
    ...
    result.put("GBP","Lielbritānijas mārciņa");
    ...
    result.put("MRO","Mauritānijas ugija (1973–2017)");
    result.put("MRU","Mauritānijas ugija");
    ...
    result.put("NIO","Nikaragvas kordoba");
    ...
    result.put("SAR","Saūda Arābijas riāls");
    ...
    result.put("SSP","Dienvidsudānas mārciņa");
    result.put("STD","Santome un Prinsipi dobra (1977–2017)");
    result.put("STN","Santome un Prinsipi dobra");
    ...
    result.put("TMM","Turkmenistānas manats (1993–2009)");
    result.put("TMT","Turkmenistānas manats");
    result.put("TND","Tunisijas dinārs");
    result.put("TOP","Tongas paanga");
    result.put("TRL","Turcijas lira (1922–2005)");
    result.put("TRY","Turcijas lira");
    ...
    result.put("VEB","Venecuēlas bolivārs (1871–2008)");
    result.put("VEF","Venecuēlas bolivārs (2008–2018)");
    result.put("VES","Venecuēlas bolivārs");
    ...
    result.put("ZAR","Dienvidāfrikas rends");
    result.put("ZMK","Zambijas kvača (1968–2012)");
    result.put("ZMW","Zambijas kvača");
