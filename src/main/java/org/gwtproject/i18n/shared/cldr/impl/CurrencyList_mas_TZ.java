...
public class CurrencyList_mas_TZ extends CurrencyList_mas {
  ...
  protected HashMap<String, String> loadNamesMap() {
    ...
    result.put("MRO","Iropiyianí e Moritania (1973–2017)");
    result.put("MRU","Iropiyianí e Moritania");
    ...
    result.put("STD","Iropiyianí e Saotome (1977–2017)");
    result.put("STN","Iropiyianí e Saotome");
    ...
    result.put("ZMK","Iropiyianí e Sambia (1968–2012)");
    result.put("ZMW","Iropiyianí e Sambia");
