...
public class CurrencyList_mer_KE extends CurrencyList_mer {
  ...
  protected HashMap<String, String> loadNamesMap() {
    ...
    result.put("AED","Dirham ya Falme cia Kiarabu");
    result.put("AOA","Kwanza ya Angola");
    result.put("AUD","Dola ya Austrĩlia");
    result.put("BHD","Dinari ya Baharini");
    ...
    result.put("MGA","Ariarĩ ya Bukini");
    result.put("MRO","Ugwiya ya Mauritania (1973–2017)");
    result.put("MRU","Ugwiya ya Mauritania");
    result.put("MUR","Rupia ya Maurĩtiasi");
    result.put("MWK","Kwacha ya Malawi");
    result.put("MZM","Metikali ya Mozambĩkĩ");
    result.put("NAD","Dola ya Namibia");
    result.put("NGN","Naira ya Nijeria");
    result.put("RWF","Faranga ya Rwanda");
    result.put("SAR","Riyal ya Saudi Arĩbia");
    result.put("SCR","Rupia ya Shelisheli");
    result.put("SDG","Paũndi ya Sudani");
    result.put("SHP","Paũndi ya Santahelena");
    ...
    result.put("USD","Dola ya Amerika");
    result.put("XAF","Faranga CFA BEAC");
    result.put("XOF","Faranga CFA BCEAO");
    result.put("ZAR","Randi ya Afrika ya Sauthi");
