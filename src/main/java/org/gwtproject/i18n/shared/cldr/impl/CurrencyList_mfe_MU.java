...
public class CurrencyList_mfe_MU extends CurrencyList_mfe {
  ...
  protected HashMap<String, String> loadNamesMap() {
    ...
    result.put("BHD","dinar bahreïn");
    result.put("BIF","fran burunde");
    result.put("BWP","pula ya botswane");
    result.put("CAD","dolar kanadien");
    result.put("CDF","fran kongole");
    result.put("CHF","fran swis");
    result.put("CNY","yuan renminbi sinwa");
    result.put("CVE","eskudo kapverdien");
    result.put("DJF","fran djiboutien");
    result.put("DZD","dinar alzerien");
    result.put("EGP","liv ezipsien");
    result.put("ERN","nafka erythreen");
    result.put("ETB","birr etiopien");
    result.put("EUR","euro");
    result.put("GBP","liv sterlin");
    result.put("GHC","sedi ganeen");
    result.put("GMD","dalasi gambien");
    result.put("GNS","fran gineen");
    result.put("INR","roupi");
    result.put("JPY","yen zapone");
    result.put("KES","shiling kenyan");
    result.put("KMF","fran komorien");
    result.put("LRD","dolar liberien");
    result.put("LSL","loti lezoto");
    result.put("LYD","dinar libien");
    result.put("MAD","dirham marokin");
    result.put("MGA","fran malgas");
    result.put("MRO","ouguiya moritanien (1973–2017)");
    result.put("MRU","ouguiya moritanien");
    result.put("MUR","roupi morisien");
    result.put("MWK","kwacha malawit");
    result.put("MZM","metikal mozanbikin");
    result.put("NAD","dolar namibien");
    result.put("NGN","naira nizerian");
    result.put("RWF","fran rwande");
    result.put("SAR","rial saoudien");
    result.put("SCR","roupi seselwa");
    result.put("SDG","dinar soudane");
    result.put("SDP","liv soudane");
    result.put("SHP","liv Sainte-Hélène");
    result.put("SLL","leonn Sierra-Leone");
    result.put("SOS","shilingi somalien");
    result.put("STD","dobra santomeen (1977–2017)");
    result.put("STN","dobra santomeen");
    result.put("SZL","lilangeni swazi");
    result.put("TND","dinar tinizien");
    result.put("TZS","shiling tanzanien");
    result.put("UGX","shiling ougande");
    result.put("USD","dolar amerikin");
    result.put("XAF","fran CFA (BEAC)");
    result.put("XOF","fran CFA (BCEAO)");
    result.put("ZAR","rand sid-afrikin");
    result.put("ZMK","kwacha zanbien (1968–2012)");
    result.put("ZMW","kwacha zanbien");
    result.put("ZWD","dolar zimbawe");
    return result;
  }
}
