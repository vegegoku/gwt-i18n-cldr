...
public class CurrencyList_mg_MG extends CurrencyList_mg {
  ...
  protected HashMap<String, String> loadNamesMap() {
    ...
    result.put("AED","Dirham");
    result.put("AOA","kwanza angoley");
    result.put("AUD","Dolara aostralianina");
    result.put("BHD","dinar bahreïni");
    result.put("BIF","Farantsa Borondi");
    result.put("BWP","Pola botsoaney");
    result.put("CAD","Dôlara Kanadianina");
    result.put("CDF","Farantsa kôngôley");
    result.put("CHF","Farantsa soisa");
    result.put("CNY","Yoan sinoa Renminbi");
    result.put("CVE","Escudo");
    result.put("DJF","Farantsa Djibotianina");
    result.put("DZD","Dinara alzerianina");
    result.put("EGP","vola venty ejipsiana");
    result.put("ERN","Nakfà Eritreanina");
    result.put("ETB","Bir etiopianina");
    result.put("EUR","Eoro");
    result.put("GBP","livre sterling");
    result.put("GHC","cédi");
    result.put("GMD","Dalasi gambianina");
    result.put("GNS","Farantsa Gineanina");
    result.put("INR","Ropia Indianina");
    result.put("JPY","Yen Japoney");
    result.put("KES","Shilling kenianina");
    result.put("KMF","Farantsa Komorianina");
    result.put("LRD","Dôlara Liberianina");
    result.put("LSL","Loti");
    result.put("LYD","Dinara Libyanina");
    result.put("MAD","Dirham marokianina");
    result.put("MGA","Ariary");
    result.put("MRO","Ouguiya moritanianina (1973–2017)");
    result.put("MRU","Ouguiya moritanianina");
    result.put("MUR","Ropia maorisianina");
    result.put("MWK","kwacha malawite");
    result.put("MZM","Metikaly");
    result.put("NAD","Dolara namibianina");
    result.put("NGN","Naira nigerianina");
    result.put("RWF","Farantsa Roande");
    result.put("SAR","Rial saodianina");
    result.put("SCR","Ropia Seysheloà");
    result.put("SDG","Dinara Sodaney");
    result.put("SDP","livre soudanaise (1956–2007)");
    result.put("SHP","livre de Sainte-Hélène");
    result.put("SLL","Leone");
    result.put("SOS","Shilling somalianina");
    result.put("STD","Dobra (1977–2017)");
    result.put("STN","Dobra");
    result.put("SZL","Lilangeni");
    result.put("TND","Dinar tonizianina");
    result.put("TZS","Shilling tanzanianina");
    result.put("UGX","Shilling ogandianina");
    result.put("USD","Dolara amerikanina");
    result.put("XAF","Farantsa CFA (BEAC)");
    result.put("XOF","Farantsa CFA (BCEAO)");
    result.put("ZAR","Rand afrikanina tatsimo");
    result.put("ZMK","Kwacha zambianina (1968–2012)");
    result.put("ZMW","Kwacha zambianina");
    result.put("ZWD","Dôlara Zimbaboeanina");
    return result;
  }
}
