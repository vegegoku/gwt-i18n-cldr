...
public class CurrencyList_mi_NZ extends CurrencyList_mi {
  ...
  protected HashMap<String, String> loadNamesMap() {
    ...
    result.put("BRL","Real Parahi");
    result.put("CNY","Yuan Haina");
    result.put("EUR","Euro");
    result.put("GBP","Pāuna Piritene");
    result.put("INR","Rupee Iniana");
    result.put("JPY","Yen Hapanihi");
    result.put("NZD","Tāra o Aotearoa");
    result.put("RUB","Rūpera Ruhiana");
    result.put("USD","Tāra US");
    result.put("XXX","Moni Tē Mōhiotia");
    return result;
  }
}
