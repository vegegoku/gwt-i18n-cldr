...
public class CurrencyList_ml_IN extends CurrencyList_ml {
  ...
  protected HashMap<String, String> loadNamesMap() {
    ...
    result.put("ADP","അൻഡോറൻ പെസെയ്റ്റ");
    result.put("AED","യുണൈറ്റഡ് അറബ് എമിറേറ്റ്സ് ദിർഹം");
    result.put("AFA","അഫ്ഘാനി (1927–2002)");
    result.put("AFN","അഫ്‌ഗാൻ അഫ്‌‌ഗാനി");
    result.put("ALL","അൽബേനിയൻ ലെക്");
    result.put("AMD","അർമേനിയൻ ഡ്രാം");
    result.put("ANG","നെതർലാൻഡ്‌സ് ആന്റിലൻ ഗിൽഡർ");
    result.put("AOA","അംഗോളൻ ‍ക്വാൻസ");
    result.put("AOK","അംഗോളൻ ‍ക്വാൻസ (1977–1990)");
    result.put("AON","അംഗോളൻ ‍ന്യൂ ക്വാൻസ (1990–2000)");
    result.put("AOR","അംഗോളൻ ‍ക്വാൻസ റിയാജസ്റ്റാഡോ (1995–1999)");
    result.put("ARA","അർജൻറീൻ ഓസ്ട്രൽ");
    result.put("ARP","അർജൻറീൻ പെയ്സോ (1983–1985)");
    result.put("ARS","അർജൻറീൻ പെസോ");
    result.put("ATS","ഓസ്ട്രേലിയൻ ഷില്ലിംഗ്");
    result.put("AUD","ഓസ്ട്രേലിയൻ ഡോളർ");
    result.put("AWG","അറൂബൻ ഫ്ലോറിൻ");
    result.put("AZM","അസർബയ്ജാനിയൻ മനത് (1993–2006)");
    result.put("AZN","അസർബൈജാനി മനത്");
    result.put("BAD","ബോസ്നിയ-ഹെർസഗോവിന ദിനാർ");
    result.put("BAM","ബോസ്‌നിയ-ഹെർസഗോവിന കൺവേർട്ടബിൾ മാർക്ക്");
    result.put("BBD","ബാർബേഡിയൻ ഡോളർ");
    result.put("BDT","ബംഗ്ലാദേശി ടാക്ക");
    result.put("BEC","ബെൽജിയൻ ഫ്രാങ്ക് (കൈമാറ്റം ചെയ്യാവുന്നത്)");
    result.put("BEF","ബെൽജിയൻ ഫ്രാങ്ക്");
    result.put("BEL","ബൽജിയൻ ഫ്രാങ്ക്");
    result.put("BGL","ബൾഗേറിയൻ ഹാർഡ് ലെവ്");
    result.put("BGN","ബൾഗേറിയൻ ലെവ്");
    result.put("BHD","ബഹ്റൈനി ദിനാർ");
    result.put("BIF","ബറുണ്ടിയൻ ഫ്രാങ്ക്");
    result.put("BMD","ബെർമുഡൻ ഡോളർ");
    result.put("BND","ബ്രൂണൈ ഡോളർ");
    result.put("BOB","ബൊളീവിയൻ ബൊളിവിയാനോ");
    result.put("BOP","ബൊളീവിയൻ പെയ്സോ");
    result.put("BOV","ബൊളീവിയൻ എംവിഡോൾ");
    result.put("BRB","ബ്രസീലിയൻ ക്രുസെയ്റോ നോവോ (1967–1986)");
    result.put("BRC","ബ്രസീലിയൻ ക്രുസാഡോ");
    result.put("BRE","ബ്രസീലിയൻ ക്രുസെയ്റോ (1990–1993)");
    result.put("BRL","ബ്രസീലിയൻ റിയാൽ");
    result.put("BRN","ബ്രസീലിയൻ ക്രുസാഡോ നോവോ");
    result.put("BRR","ബ്രസീലിയൻ ക്രുസെയ്റോ");
    result.put("BSD","ബഹാമിയൻ ഡോളർ");
    result.put("BTN","ഭൂട്ടാനീസ് ഗൾട്രം");
    result.put("BUK","ബർമീസ് ചാറ്റ്");
    result.put("BWP","ബോട്‌സ്വാനൻ പ്യുല");
    result.put("BYB","ബെലാറഷ്യൻ ന്യൂ റൂബിൾ (1994–1999)");
    result.put("BYN","ബെലാറുഷ്യൻ റൂബിൾ");
    result.put("BYR","ബെലാറുഷ്യൻ റൂബിൾ (2000–2016)");
    result.put("BZD","ബെലീസ് ഡോളർ");
    result.put("CAD","കനേഡിയൻ ഡോളർ");
    result.put("CDF","കോങ്കളീസ് ഫ്രാങ്ക്");
    result.put("CHE","WIR യൂറോ");
    result.put("CHF","സ്വിസ് ഫ്രാങ്ക്");
    result.put("CHW","WIR ഫ്രാങ്ക്");
    result.put("CLF","ചിലിയൻ യൂണിഡാഡ്സ് ഡി ഫോമെൻറോ");
    result.put("CLP","ചിലിയൻ പെസോ");
    result.put("CNH","ചൈനീസ് യുവാൻ (ഓഫ്‌ഷോർ)");
    result.put("CNY","ചൈനീസ് യുവാൻ");
    result.put("COP","കൊളംബിയൻ പെസോ");
    result.put("COU","യൂണിഡാഡ് ഡി വാലർ റിയൽ");
    result.put("CRC","കോസ്റ്റാ റിക്കൻ കോളൻ");
    result.put("CSD","പ്രാചീന സെർബിയൻ ദിനാർ");
    result.put("CSK","ചെക്കോസ്ലൊവാക്ക് ഹാർഡ് കൊരൂന");
    result.put("CUC","ക്യൂബൻ കൺവേർട്ടബിൾ പെസോ");
    result.put("CUP","ക്യൂബൻ പെസോ");
    result.put("CVE","കേപ് വെർദിയൻ എസ്‌ക്യുഡോ");
    result.put("CYP","സൈപ്രസ് പൌണ്ട്");
    result.put("CZK","ചെക്ക് റിപ്പബ്ലിക് കൊരുണ");
    result.put("DDM","കിഴക്കൻ ജർമൻ ഓസ്റ്റ്മാർക്ക്");
    result.put("DEM","ജർമൻ മാർക്ക്");
    result.put("DJF","ദിജിബൗട്ടിയൻ ഫ്രാങ്ക്");
    result.put("DKK","ഡാനിഷ് ക്രോണെ");
    result.put("DOP","ഡൊമിനിക്കൻ പെസോ");
    result.put("DZD","അൾജീരിയൻ ദിനാർ");
    result.put("ECS","ഇക്വഡോർ സൂക്രേ");
    result.put("ECV","ഇക്വഡോർ യൂണിഡാഡ് വാലർ കോൺസ്റ്റൻറെ (UVC)");
    result.put("EEK","എസ്റ്റൌനിയൻ ക്രൂൺ");
    result.put("EGP","ഈജിപ്‌ഷ്യൻ പൗണ്ട്");
    result.put("ERN","എറിത്രിയൻ നക്ഫ");
    ...
    result.put("ETB","എത്യോപ്യൻ ബിർ");
    result.put("EUR","യൂറോ");
    result.put("FIM","ഫിന്നിഷ് മാർക്ക");
    result.put("FJD","ഫിജിയൻ ഡോളർ");
    result.put("FKP","ഫാക്ക്‌ലാന്റ് ദ്വീപുകളുടെ പൗണ്ട്");
    result.put("FRF","ഫ്രാങ്ക്");
    result.put("GBP","ബ്രിട്ടീഷ് പൗണ്ട്");
    result.put("GEK","ജോർ‍ജ്ജിയൻ ക്യൂപോൺ ലാരിറ്റ്");
    result.put("GEL","ജോർജ്ജിയൻ ലാറി");
    result.put("GHC","ഘാന കെഡി (1979–2007)");
    result.put("GHS","ഘാനയൻ കെഡി");
    result.put("GIP","ജിബ്രാൾട്ടർ പൗണ്ട്");
    result.put("GMD","ഗാംബിയൻ ദലാസി");
    result.put("GNF","ഗിനിയൻ ഫ്രാങ്ക്");
    result.put("GNS","ഗിനിയ സൈലി");
    result.put("GQE","ഇക്വിറ്റോറിയൽ ഗിനിയ എക്വീലെ ഗിനിയാന");
    result.put("GRD","ഗ്രീക്ക് ഡ്രാക്ക്മ");
    result.put("GTQ","ഗ്വാട്ടിമാലൻ ക്വെറ്റ്‌സൽ");
    result.put("GWE","പോർച്ചുഗീസ് ഗിനി എസ്ക്യൂഡോ");
    result.put("GWP","ഗിനിയ-ബിസാവു പെയ്സോ");
    result.put("GYD","ഗയാനീസ് ഡോളർ");
    result.put("HKD","ഹോങ്കോങ്ങ് ഡോളർ");
    result.put("HNL","ഹോണ്ടുറൻ ലെംപിറ");
    result.put("HRD","ക്രൊയേഷ്യൻ ദിനാർ");
    result.put("HRK","ക്രൊയേഷൻ ക്യുന");
    result.put("HTG","ഹെയ്‌തിയൻ ഗൂർഡ്");
    result.put("HUF","ഹംഗേറിയൻ ഫോറിന്റ്");
    result.put("IDR","ഇന്തോനേഷ്യൻ റുപിയ");
    result.put("IEP","ഐറിഷ് പൌണ്ട്");
    result.put("ILP","ഇസ്രയേലി പൌണ്ട്");
    result.put("ILS","ഇസ്രായേലി ന്യൂ ഷെക്കെൽ");
    result.put("INR","ഇന്ത്യൻ രൂപ");
    result.put("IQD","ഇറാഖി ദിനാർ");
    result.put("IRR","ഇറാനിയൻ റിയാൽ");
    result.put("ISK","ഐസ്‌ലാൻഡിക് ക്രോണ");
    result.put("ITL","ഇറ്റാലിയൻ ലിറ");
    result.put("JMD","ജമൈക്കൻ ഡോളർ");
    result.put("JOD","ജോർദ്ദാനിയൻ ദിനാർ");
    result.put("JPY","ജാപ്പനീസ് യെൻ");
    result.put("KES","കെനിയൻ ഷില്ലിംഗ്");
    result.put("KGS","കിർഗിസ്ഥാനി സോം");
    result.put("KHR","കംബോഡിയൻ റീൽ");
    result.put("KMF","കൊമോറിയൻ ഫ്രാങ്ക്");
    result.put("KPW","ഉത്തര കൊറിയൻ വോൺ");
    result.put("KRW","ദക്ഷിണ കൊറിയൻ വോൺ");
    result.put("KWD","കുവൈറ്റി ദിനാർ");
    result.put("KYD","കേമാൻ ഐലൻഡ്‌സ് ഡോളർ");
    result.put("KZT","കസാക്കിസ്ഥാനി ടെംഗെ");
    result.put("LAK","ലാവോഷിയൻ കിപ്");
    result.put("LBP","ലെബനീസ് പൗണ്ട്");
    result.put("LKR","ശ്രീലങ്കൻ റുപ്പീ");
    result.put("LRD","ലൈബീരിയൻ ഡോളർ");
    result.put("LSL","ലെസോതോ ലോത്തി");
    result.put("LTL","ലിത്വാനിയൻ ലിറ്റാസ്");
    result.put("LTT","ലിത്വാനിയൻ തലോനാസ്");
    result.put("LUC","ലക്സംബർഗ് കൺവേർട്ടിബിൾ ഫ്രാങ്ക്");
    result.put("LUF","ലക്സംബർഗ് ഫ്രാങ്ക്");
    result.put("LUL","ലക്സംബർഗ് ഫിനാൻഷ്യൽ ഫ്രാങ്ക്");
    result.put("LVL","ലാറ്റ്വിയൻ ലാറ്റ്സ്");
    result.put("LVR","ലാറ്റ്വിയൻ റൂബിൾ");
    result.put("LYD","ലിബിയൻ ദിനാർ");
    result.put("MAD","മൊറോക്കൻ ദിർഹം");
    result.put("MAF","മൊറോക്കൻ ഫ്രാങ്ക്");
    result.put("MDL","മൊൾഡോവൻ ലിയു");
    result.put("MGA","മഡഗാസി ഏരിയറി");
    result.put("MGF","മഡഗാസ്കർ ഫ്രാങ്ക്");
    result.put("MKD","മാസിഡോണിയൻ ദിനാർ");
    result.put("MLF","മാലി ഫ്രാങ്ക്");
    result.put("MMK","മ്യാൻമാർ ക്യാട്");
    result.put("MNT","മംഗോളിയൻ തുഗ്രിക്");
    result.put("MOP","മകാനീസ് പതാക്ക");
    result.put("MRO","മൗറിറ്റേനിയൻ ഔഗിയ (1973–2017)");
    result.put("MRU","മൗറിറ്റേനിയൻ ഔഗിയ");
    result.put("MTL","മൽത്തീസ് ലിറ");
    result.put("MTP","മൽത്തീസ് പൌണ്ട്");
    result.put("MUR","മൗറീഷ്യൻ റുപ്പീ");
    result.put("MVR","മാൽദീവിയൻ റുഫിയ");
    result.put("MWK","മലാവിയൻ ക്വച്ചാ");
    result.put("MXN","മെക്സിക്കൻ പെസോ");
    result.put("MXP","മെക്സിക്കൻ സിൽവർ പെയ്സോ (1861–1992)");
    result.put("MXV","മെക്സിക്കൻ യൂണിഡാഡ് ഡി ഇൻവെർഷൻ (UDI)");
    result.put("MYR","മലേഷ്യൻ റിംഗിറ്റ്");
    result.put("MZE","മൊസാന്പിക്ക് എസ്ക്യുഡോ");
    result.put("MZM","ഓൾഡ് മൊസാന്പിക്ക് മെറ്റിക്കൽ");
    result.put("MZN","മൊസാംബിക്കൻ മെറ്റിക്കൽ");
    result.put("NAD","നമീബിയൻ ഡോളർ");
    result.put("NGN","നൈജീരിയൻ നൈറ");
    result.put("NIC","നികരാഗ്വൻ കൊർഡോബ");
    result.put("NIO","നിക്കരാഗ്വൻ കോർഡോബ");
    result.put("NLG","നെതർലൻഡ്സ് ഗിൽഡർ");
    result.put("NOK","നോർവീജിയൻ ക്രോണെ");
    result.put("NPR","നേപ്പാളീസ് റുപ്പീ");
    result.put("NZD","ന്യൂസിലാന്റ് ഡോളർ");
    result.put("OMR","ഒമാനി റിയാൽ");
    result.put("PAB","പനാമനിയൻ ബാൽബോവ");
    result.put("PEI","പെറൂവിയൻ ഇൻറി");
    result.put("PEN","പെറുവിയൻ സോൾ");
    result.put("PES","പെറൂവിയൻ സോൾ (1863–1965)");
    result.put("PGK","പാപ്പുവ ന്യൂ ഗിനിയൻ കിന");
    result.put("PHP","ഫിലിപ്പീനി പെസോ");
    result.put("PKR","പാക്കിസ്ഥാനി റുപ്പീ");
    result.put("PLN","പോളിഷ് സ്ലോട്ടി");
    result.put("PLZ","പോളിഷ് സ്ലോട്ടി (1950–1995)");
    result.put("PTE","പോർച്ചുഗീസ് എസ്ക്യുഡോ");
    result.put("PYG","പരാഗ്വേയൻ ഗ്വരനീ");
    result.put("QAR","ഖത്തർ റിയാൽ");
    result.put("RHD","റൊഡേഷ്യൻ ഡോളർ");
    result.put("ROL","പ്രാചീന റൊമേനിയൻ ലിയു");
    result.put("RON","റൊമാനിയൻ ലെയു");
    result.put("RSD","സെർബിയൻ ദിനാർ");
    result.put("RUB","റഷ്യൻ റൂബിൾ");
    result.put("RUR","റഷ്യൻ റൂബിൾ (1991–1998)");
    result.put("RWF","റുവാണ്ടൻ ഫ്രാങ്ക്");
    result.put("SAR","സൗദി റിയാൽ");
    result.put("SBD","സോളമൻ ദ്വീപുകളുടെ ഡോളർ");
    result.put("SCR","സീഷെലോയിസ് റുപ്പീ");
    result.put("SDD","പ്രാചീന സുഡാനീസ് ദിനാർ");
    result.put("SDG","സുഡാനീസ് പൗണ്ട്");
    result.put("SDP","പ്രാചീന സുഡാനീസ് പൌണ്ട്");
    result.put("SEK","സ്വീഡിഷ് ക്രോണ");
    result.put("SGD","സിംഗപ്പൂർ ഡോളർ");
    result.put("SHP","സെന്റ് ഹെലീന പൗണ്ട്");
    result.put("SIT","സ്ലൊവേനിയ റ്റോളർ");
    result.put("SKK","സ്ലോവാക് കൊരൂന");
    result.put("SLL","സിയെറ ലിയോണിയൻ ലിയോൺ");
    result.put("SOS","സോമാലി ഷില്ലിംഗ്");
    result.put("SRD","സുരിനെയിമിസ് ഡോളർ");
    result.put("SRG","സൂരിനാം ഗിൽഡർ");
    result.put("SSP","ദക്ഷിണ സുഡാനീസ് പൗണ്ട്");
    result.put("STD","സാവോ ടോമി ആൻഡ് പ്രിൻസിപെ ഡോബ്ര (1977–2017)");
    result.put("STN","സാവോ ടോമി ആൻഡ് പ്രിൻസിപെ ഡോബ്ര");
    result.put("SUR","സോവിയറ്റ് റൂബിൾ");
    result.put("SVC","എൽ സാൽവഡോർ കോളൻ");
    result.put("SYP","സിറിയൻ പൗണ്ട്");
    result.put("SZL","സ്വാസി ലിലാംഗനി");
    result.put("THB","തായ് ബട്ട്");
    result.put("TJR","താജിക്കിസ്ഥാൻ റൂബിൾ");
    result.put("TJS","താജിക്കിസ്ഥാനി സോംനി");
    result.put("TMM","തുർക്മെനിസ്ഥാൻ മനത്");
    result.put("TMT","തുർക്ക്‌മെനിസ്ഥാനി മനത്");
    result.put("TND","ടുണീഷ്യൻ ദിനാർ");
    result.put("TOP","ടോംഗൻ പാംഗ");
    result.put("TPE","തിമോർ എസ്ക്യൂഡോ");
    result.put("TRL","പ്രാചീന തുർക്കിഷ് ലിറ");
    result.put("TRY","ടർക്കിഷ് ലിറ");
    result.put("TTD","ട്രിനിഡാഡ് അന്റ് ടുബാഗോ ഡോളർ");
    result.put("TWD","ന്യൂ തായ്‌വാൻ ഡോളർ");
    result.put("TZS","ടാൻസാനിയൻ ഷില്ലിംഗ്");
    result.put("UAH","ഉക്രേനിയൻ ഹ്രിവ്‌നിയ");
    result.put("UAK","യുക്രേനിയൻ കാർബോവാനെസ്");
    result.put("UGS","ഉഗാണ്ടൻ ഷില്ലിംഗ് (1966–1987)");
    result.put("UGX","ഉഗാണ്ടൻ ഷില്ലിംഗ്");
    result.put("USD","യു.എസ്. ഡോളർ");
    result.put("USN","യുഎസ് ഡോളർ (അടുത്ത ദിവസം)");
    result.put("USS","യുഎസ് ഡോളർ (അതേ ദിവസം)");
    result.put("UYI","ഉറുഗ്വേ പെയ്സോ എൻ യൂണിഡാഡ്സ്");
    result.put("UYP","ഉറുഗ്വേ പെയ്സോ (1975–1993)");
    result.put("UYU","ഉറുഗ്വേയൻ പെസോ");
    result.put("UZS","ഉസ്‌ബെക്കിസ്ഥാനി സോം");
    result.put("VEB","വെനസ്വേലൻ ബോലിവർ (1871–2008)");
    result.put("VEF","വെനിസ്വേലൻ ബൊളീവർ (2008–2018)");
    result.put("VES","വെനിസ്വേലൻ ബൊളീവർ");
    result.put("VND","വിയറ്റ്നാമീസ് ഡോങ്");
    result.put("VUV","വന്വാതു വാതു");
    result.put("WST","സമോവൻ താല");
    result.put("XAF","മദ്ധ്യ ആഫ്രിക്കൻ [CFA] ഫ്രാങ്ക്");
    result.put("XAG","വെള്ളി");
    result.put("XAU","സ്വർണ്ണം");
    result.put("XBA","യൂറോപ്യൻ കോന്പസിറ്റ് യൂണിറ്റ്");
    result.put("XBB","യൂറോപ്യൻ മോണിറ്ററി യൂണിറ്റ്");
    result.put("XBC","യൂറോപ്യൻ യൂണിറ്റ് ഓഫ് അക്കൌണ്ട് (XBC)");
    result.put("XBD","യൂറോപ്യൻ യൂണിറ്റ് ഓഫ് അക്കൌണ്ട് (XBD)");
    result.put("XCD","കിഴക്കൻ കരീബിയൻ ഡോളർ");
    result.put("XDR","സ്പെഷ്യൽ ഡ്രോയിംഗ് റൈറ്റ്സ്");
    result.put("XEU","യൂറോപ്യൻ നാണയ യൂണിറ്റ്");
    result.put("XFO","ഫ്രെഞ്ച് ഗോൾഡ് ഫ്രാങ്ക്");
    result.put("XFU","ഫ്രെഞ്ച് UIC-ഫ്രാങ്ക്");
    result.put("XOF","പശ്ചിമ ആഫ്രിക്കൻ [CFA] ഫ്രാങ്ക്");
    result.put("XPD","പലാഡിയം");
    result.put("XPF","CFP ഫ്രാങ്ക്");
    result.put("XPT","പ്ലാറ്റിനം");
    result.put("XRE","RINET ഫണ്ട്സ്");
    result.put("XTS","ടെസ്റ്റിംഗിനുള്ള കറൻസി കോഡ്");
    result.put("XXX","അജ്ഞാത നാണയം");
    result.put("YDD","യമനി ദിനാർ");
    result.put("YER","യെമനി റിയാൽ");
    result.put("YUD","യൂഗോസ്ലേവിയൻ ഹാർഡ് ദിനാർ");
    result.put("YUM","യൂഗോസ്ലേവിയൻ നോവി ദിനാർ");
    result.put("YUN","യൂഗോസ്ലേവിയൻ കൺവേർട്ടിബിൾ ദിനാർ");
    result.put("ZAL","ദക്ഷിണാഫ്രിക്കൻ റാൻഡ് (ഫിനാൻഷ്യൽ)");
    result.put("ZAR","ദക്ഷിണാഫ്രിക്കൻ റാൻഡ്");
    result.put("ZMK","സാംബിയൻ ക്വാച (1968–2012)");
    result.put("ZMW","സാംബിയൻ ക്വാച്ച");
    result.put("ZRN","സൈറിയൻ ന്യൂ സൈർ");
    result.put("ZRZ","സൈറിയൻ സൈർ");
    result.put("ZWD","സിംബാബ്‌വെ ഡോളർ");
    return result;
  }
}
