...
public class CurrencyList_mr_IN extends CurrencyList_mr {
  ...
  protected HashMap<String, String> loadNamesMap() {
    ...
    result.put("AED","संयुक्त अरब अमीरात दिरहॅम");
    result.put("AFN","अफगाण अफगाणी");
    result.put("ALL","अल्बानियन लेक");
    result.put("AMD","आर्मेनियन द्रॅम");
    result.put("ANG","नेदरलँडचा अँटिलीन गिल्डर");
    result.put("AOA","अँगोलन क्वॅन्झा");
    result.put("ARS","अर्जेंटाइन पेसो");
    result.put("AUD","ऑस्ट्रेलियन डॉलर");
    result.put("AWG","अरुबा फ्लोरिन");
    result.put("AZN","अझरबैझानी मानाट");
    result.put("BAM","बोस्निया-हर्जेगोविना विनिमय मार्क");
    result.put("BBD","बार्बाडियन डॉलर");
    result.put("BDT","बांगलादेशी टका");
    result.put("BGN","बल्गेरियन लेव");
    result.put("BHD","बाहरिनी दिनार");
    result.put("BIF","बुरुंडियन फ्रँक");
    result.put("BMD","बर्मुडा डॉलर");
    result.put("BND","ब्रुनेई डॉलर");
    result.put("BOB","बोलिव्हियन बोलिव्हियानो");
    result.put("BRL","ब्राझिलियन रियाल");
    result.put("BSD","बहामी डॉलर");
    result.put("BTN","भूतानी एंगल्ट्रम");
    result.put("BWP","बोट्सवानन पुला");
    result.put("BYN","बेलारुशियन रुबल");
    result.put("BYR","बेलारुशियन रुबल (2000–2016)");
    result.put("BZD","बेलीझ डॉलर");
    result.put("CAD","कॅनडियन डॉलर");
    result.put("CDF","काँगोलीज फ्रँक");
    result.put("CHF","स्विस फ्रँक");
    result.put("CLP","चिली पेसो");
    result.put("CNH","चिनी युआन (ऑफशोर)");
    result.put("CNY","चीनी युआन");
    result.put("COP","कोलंबियन पेसो");
    result.put("CRC","कोस्टा रिका कोलोन");
    result.put("CUC","क्यूबन विनिमय पेसो");
    result.put("CUP","क्यूबन पेसो");
    result.put("CVE","केप व्हर्डेयन एस्कुडो");
    result.put("CZK","झेक प्रजासत्ताक कोरुना");
    result.put("DJF","जिबौटियन फ्रँक");
    result.put("DKK","डॅनिश क्रोन");
    result.put("DOP","डोमिनिकन पेसो");
    result.put("DZD","अल्जेरियन दिनार");
    result.put("EGP","इजिप्शियन पाउंड");
    result.put("ERN","इरिट्रियन नाक्फा");
    result.put("ETB","इथिओपियन बिर");
    result.put("EUR","युरो");
    result.put("FJD","फिजियन डॉलर");
    result.put("FKP","फॉकलंड आयलंड पाउंड");
    result.put("GBP","ब्रिटिश पाऊंड");
    result.put("GEL","जॉर्जियन लारी");
    result.put("GHS","घानीयन सेडी");
    result.put("GIP","जिब्राल्टर पाउंड");
    result.put("GMD","गाम्बियन डालासी");
    result.put("GNF","गिनी फ्रँक");
    result.put("GTQ","ग्वाटेमालाचे क्वेत्झाल");
    result.put("GYD","गयाना डॉलर");
    result.put("HKD","हाँगकाँग डॉलर");
    result.put("HNL","होन्डुरन लेंपिरा");
    result.put("HRK","क्रोएशियन कूना");
    result.put("HTG","हैती गोअर्ड");
    result.put("HUF","हंगेरियन फॉरिन्ट");
    result.put("IDR","इंडोनेशियन रुपिया");
    result.put("ILS","ईस्त्रायली न्यू शेकेल");
    result.put("INR","भारतीय रुपया");
    result.put("IQD","इराकी दिनार");
    result.put("IRR","इराणी रियाल");
    result.put("ISK","आइसलँडिक क्रोना");
    result.put("JMD","जमैकन डॉलर");
    result.put("JOD","जॉर्डनियन दिनार");
    result.put("JPY","जपानी येन");
    result.put("KES","केनियन शिलिंग");
    result.put("KGS","किरगिस्तानी सॉम");
    result.put("KHR","कंबोडियन रियेल");
    result.put("KMF","कोमोरियन फ्रँक");
    result.put("KPW","उत्तर कोरियन वॉन");
    result.put("KRW","दक्षिण कोरियन वॉन");
    result.put("KWD","कुवैती दिनार");
    result.put("KYD","केमेन आयलॅंड डॉलर");
    result.put("KZT","कझाकिस्तानी तेंगे");
    result.put("LAK","लाओशियन किप");
    result.put("LBP","लेबनीज पाउंड");
    result.put("LKR","श्रीलंकन रुपया");
    result.put("LRD","लाइबेरियन डॉलर");
    result.put("LSL","लेसोटो लोटी");
    result.put("LTL","लिथुआनियन लिटास");
    result.put("LVL","लाट्व्हियन लाट्झ");
    result.put("LYD","लिबियाचा दिनार");
    result.put("MAD","मोरोक्को दिरहॅम");
    result.put("MDL","मोल्डोवन लेउ");
    result.put("MGA","मालागासी एरियारी");
    result.put("MKD","मॅसेडोनियन देनार");
    result.put("MMK","म्यानमार क्याट");
    result.put("MNT","मंगोलियन टुग्रिक");
    result.put("MOP","मॅकॅनीज् पटाका");
    result.put("MRO","मॉरिटानियन ओगिया (1973–2017)");
    result.put("MRU","मॉरिटानियन ओगिया");
    result.put("MUR","मॉरिशियन रुपी");
    result.put("MVR","मालदीवियन रुफिया");
    result.put("MWK","मालावियन क्वाचा");
    result.put("MXN","मेक्सिको पेसो");
    result.put("MYR","मलेशियन रिंगिट");
    result.put("MZN","मोझांबिकन मेटिकल");
    result.put("NAD","नमिबियन डॉलर");
    result.put("NGN","नायजेरियन नायरा");
    result.put("NIO","निकाराग्वेचा कोर्डोबा");
    result.put("NOK","नॉर्वेजियन क्रोन");
    result.put("NPR","नेपाळी रुपया");
    result.put("NZD","न्यूझीलँड डॉलर");
    result.put("OMR","ओमानी रियाल");
    result.put("PAB","पनामा बाल्बोआ");
    result.put("PEN","पेरुवियन सोल");
    result.put("PGK","पापुआ न्यू गिनीयन किना");
    result.put("PHP","फिलिपिनी पेसो");
    result.put("PKR","पाकिस्तानी रुपया");
    result.put("PLN","पोलिश झ्लॉटी");
    result.put("PYG","पराग्वे ग्वारानी");
    result.put("QAR","कतारी रियाल");
    result.put("RON","रोमानियन लेऊ");
    result.put("RSD","सर्बियन दिनार");
    result.put("RUB","रशियन रुबल");
    result.put("RWF","रवांडा फ्रँक");
    result.put("SAR","सौदी रियाल");
    result.put("SBD","सोलोमन आयलँड्स डॉलर");
    result.put("SCR","सेशेलोईस रुपी");
    result.put("SDG","सुदानी पाउंड");
    result.put("SEK","स्वीडिश क्रोना");
    result.put("SGD","सिंगापूर डॉलर");
    result.put("SHP","सेंट हेलेना पाउंड");
    result.put("SLL","सिएरा लिऑनचा लिऑन");
    result.put("SOS","सोमाली शिलिंग");
    result.put("SRD","सुरिनामी डॉलर");
    result.put("SSP","दक्षिण सुदानी पाउंड");
    result.put("STD","साओ टोम आणि प्रिन्सिपे डोबरा (1977–2017)");
    result.put("STN","साओ टोम आणि प्रिन्सिपे डोबरा");
    result.put("SYP","सीरियन पाउंड");
    result.put("SZL","स्वाझी लीलांगेनी");
    result.put("THB","थाई बाहत");
    result.put("TJS","ताजकीस्तानी सोमोनी");
    result.put("TMT","तुर्कमेनिस्तानी मानाट");
    result.put("TND","ट्यूनिशियन दिनार");
    result.put("TOP","टोंगन पाआंगा");
    result.put("TRY","तुर्की लिरा");
    result.put("TTD","त्रिनिदाद आणि टोबॅगो डॉलर");
    result.put("TWD","न्यू तैवान डॉलर");
    result.put("TZS","टांझानियन शिलिंग");
    result.put("UAH","युक्रेनियन रिवनिया");
    result.put("UGX","युगांडा शिलिंग");
    result.put("USD","यूएस डॉलर");
    result.put("UYU","उरुग्वेचा पेसो");
    result.put("UZS","उझबेकिस्तानी सोम");
    result.put("VEF","व्हेनेझुएला बोलिव्हार (2008–2018)");
    result.put("VES","व्हेनेझुएला बोलिव्हार");
    result.put("VND","व्हिएतनामी डोंग");
    result.put("VUV","वानुआतु वाटु");
    result.put("WST","सामोअन टाला");
    result.put("XAF","मध्य आफ्रिकन [CFA] फ्रँक");
    result.put("XCD","पूर्व कॅरीबियन डॉलर");
    result.put("XOF","पश्चिम आफ्रिकन [CFA] फ्रँक");
    result.put("XPF","[CFP] फ्रँक");
    result.put("XXX","अज्ञात चलन");
    result.put("YER","येमेनी रियाल");
    result.put("ZAR","दक्षिण आफ्रिकी रँड");
    result.put("ZMK","झांबियन क्वाचा (1968–2012)");
    result.put("ZMW","झांबियन क्वाचा");
    return result;
  }
}
