...
public class CurrencyList_mua_CM extends CurrencyList_mua {
  ...
  protected HashMap<String, String> loadNamesMap() {
    ...
    result.put("AED","Solai Arabiya");
    result.put("AOA","solai Angola");
    result.put("AUD","solai Australya");
    result.put("BHD","solai Barenya");
    result.put("BIF","solai Burundi");
    result.put("BWP","solai Botswana");
    result.put("CAD","solai Kanada");
    result.put("CDF","solai Kongo");
    result.put("CHF","Solai Swiss");
    result.put("CNY","solai Syiŋ");
    result.put("CVE","solai Kapverdiya");
    result.put("DJF","solai Djibouti");
    result.put("DZD","solai Algerya");
    result.put("EGP","solai Egypt");
    result.put("ERN","solai Eritre");
    result.put("ETB","solai Etiopia");
    result.put("EUR","solai Euro");
    result.put("GBP","solai Britaniya");
    result.put("GHC","solai Gana");
    result.put("GMD","solai Gambiya");
    result.put("GNS","solai Guine");
    result.put("INR","solai India");
    result.put("JPY","solai Japoŋ");
    result.put("KES","solai Kenia");
    result.put("KMF","solai Komorya");
    result.put("LRD","solai Liberiya");
    result.put("LSL","solai Lesotho");
    result.put("LYD","solai Libya");
    result.put("MAD","Solai Marok");
    result.put("MGA","Solai Malagasya");
    result.put("MRO","Solai Mauritaniya (1973–2017)");
    result.put("MRU","Solai Mauritaniya");
    result.put("MUR","Solai Mauricǝ");
    result.put("MWK","Solai Malawi");
    result.put("MZM","Solai Mozambika");
    result.put("NAD","Solai Namibiya");
    result.put("NGN","Solai Nigeriya");
    result.put("RWF","Solai Rwanda");
    result.put("SAR","Solai Saudiya");
    result.put("SCR","Solai Saichel");
    result.put("SDG","Solai Sudaŋ ma dii ne dinar");
    result.put("SDP","Solai Sudaŋ ma dii ne livre");
    result.put("SHP","Solai Helena");
    result.put("SLL","solai Sierra leonǝ");
    result.put("SOS","Solai Somaliya");
    result.put("STD","Solai Sao Tome (1977–2017)");
    result.put("STN","Solai Sao Tome");
    result.put("SZL","solai Swaziland");
    result.put("TND","Solai Tunisiya");
    result.put("TZS","Solai Tanzaniya");
    result.put("UGX","Solai Uganda");
    result.put("USD","Solai Amerika");
    result.put("XAF","solai BEAC");
    result.put("XOF","solai BCEAO");
    result.put("ZAR","Solai Africa nekǝsǝŋ");
    result.put("ZMK","Solai Zambiya (1968–2012)");
    result.put("ZMW","Solai Zambiya");
    result.put("ZWD","Solai Zimbabwe");
    return result;
  }
}
