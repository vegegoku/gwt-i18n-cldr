...
public class CurrencyList_my_MM extends CurrencyList_my {
  ...
  protected HashMap<String, CurrencyData> loadCurrencyMap() {
    ...
    // ဟေတီဂူးအော်ဒ်
    result.put("HTG", new CurrencyDataImpl("HTG","G",2,"G","G"));
  ...
  protected HashMap<String, String> loadNamesMap() {
    ...
    result.put("AED","အာရပ်စော်ဘွားများ ပြည်ထောင်စု ဒါဟမ်း");
    result.put("AFN","အာဖဂန် အာဖဂါနီ");
    result.put("ALL","အယ်ဘေးနီးယား လီခ်");
    result.put("AMD","အာမေးနီးယား ဒရမ်");
    result.put("ANG","နယ်သာလန် အန်တီလန် ဂင်းဒါး");
    result.put("AOA","အန်ဂိုလာ ကွမ်ဇာ");
    result.put("ARP","အာဂျင်တီးနား ပီဆို (၁၉၈၃–၁၉၈၅)");
    result.put("ARS","အာဂျင်တီးနား ပီဆို");
    result.put("AUD","ဩစတြေးလျ ဒေါ်လာ");
    result.put("AWG","အရူးဗာ ဖလိုရင်း");
    result.put("AZN","အဇာဘိုင်ဂျန် မာနတ်");
    result.put("BAM","ဘော့စနီးယားနှင့် ဟာဇီဂိုဘီးနား ငွေလဲနိုင်သော မတ်က်");
    result.put("BBD","ဘာဘေးဒီယန်း ဒေါ်လာ");
    result.put("BDT","ဘင်္ဂလားဒေ့ရှ် တာကာ");
    result.put("BEF","ဘယ်လ်ဂျီယမ် ဖရန့်");
    result.put("BGN","ဘူလ်ဂေးရီးယား လက်ဖ်");
    result.put("BHD","ဘာရိန်း ဒီနား");
    result.put("BIF","ဘူရွန်ဒီ ဖရန့်");
    result.put("BMD","ဘာမြူဒါ ဒေါ်လာ");
    result.put("BND","ဘရူနိုင်း ဒေါ်လာ");
    result.put("BOB","ဘိုလီးဗီးယား ဘိုလီးဗီယားနို");
    result.put("BOP","ဘိုလီးဘီးယား ပီဆို");
    result.put("BRL","ဘရာဇီး ရီးယဲ");
    result.put("BSD","ဘဟားမား ဒေါ်လာ");
    result.put("BTN","ဘူတန် အံဂါလ်ထရန်");
    result.put("BUK","ဗမာ ကျပ်");
    result.put("BWP","ဘော့ဆွာနာ ပုလ");
    result.put("BYB","ဘီလာရုစ် ရူဘယ်အသစ် (၁၉၉၄–၁၉၉၉)");
    result.put("BYN","ဘီလာရုစ် ရူဘယ်");
    result.put("BYR","ဘီလာရုဇ် ရူဘယ် (၂၀၀၀–၂၀၁၆)");
    result.put("BZD","ဘလိဇ် ဒေါ်လာ");
    result.put("CAD","ကနေဒါ ဒေါ်လာ");
    result.put("CDF","ကွန်ဂို ဖရန့်");
    result.put("CHF","ဆွစ် ဖရန့်");
    result.put("CLP","ချီလီ ပီဆို");
    result.put("CNH","တရုတ် ယွမ် (ဟောင်ကောင်)");
    result.put("CNY","တရုတ် ယွမ်");
    result.put("COP","ကိုလံဘီယာ ပီဆို");
    result.put("CRC","ကို့စတာရီကာ ကိုလွန်");
    result.put("CUC","နိုင်ငံခြားငွေလဲလှယ်နိုင်သော ကျူးဘားပီဆို");
    result.put("CUP","ကျူးဘား ပီဆို");
    result.put("CVE","ကိတ်ပ်ဗာဒီ အက်စ်ခူဒို");
    result.put("CYP","ဆိုက်ပရက်စ် ပေါင်");
    result.put("CZK","ချက် ခိုရိုနာ");
    result.put("DEM","ဂျာမဏီ မတ်");
    result.put("DJF","ဂျီဘူတီ ဖရန့်");
    result.put("DKK","ဒိန်းမတ် ခရိုဏာ");
    result.put("DOP","ဒိုမီနီကန် ပီဆို");
    result.put("DZD","အယ်လ်ဂျီးရီးယား ဒီနာ");
    result.put("EGP","အီဂျစ် ပေါင်");
    result.put("ERN","အီရီထရီးယား နာ့ခ်ဖာ");
    result.put("ESP","စပိန် ပယ်စေးတာ");
    result.put("ETB","အီသီယိုးပီးယား ဘီးယာ");
    result.put("EUR","ယူရို");
    result.put("FJD","ဖီဂျီ ဒေါ်လာ");
    result.put("FKP","ဖော့ကလန်ကျွန်းစု ပေါင်");
    result.put("FRF","ပြင်သစ် ဖရန့်");
    result.put("GBP","ဗြိတိသျှ ပေါင်");
    result.put("GEL","ဂျော်ဂျီယာ လားရီ");
    result.put("GHS","ဂါနာ ဆဲဒီ");
    result.put("GIP","ဂျီဘရော်လ်တာ ပေါင်");
    result.put("GMD","ဂမ်ဘီယာ ဒါလာစီ");
    result.put("GNF","ဂီနီရာ ဖရန့်");
    result.put("GTQ","ဂွါတီမာလာ ခက်ဇော်လ်");
    result.put("GYD","ဂိုင်ယာနာ ဒေါ်လာ");
    result.put("HKD","ဟောင်ကောင် ဒေါ်လာ");
    result.put("HNL","ဟွန်ဒူးရပ်စ် လမ်းပီရာ");
    result.put("HRK","ခရိုအေးရှား ခူးနာ");
    result.put("HTG","ဟေတီဂူးအော်ဒ်");
    result.put("HUF","ဟန်ဂေရီယံ ဖော်ရင့်တ်");
    result.put("IDR","အင်ဒိုနီးရှား ရူပီးယား");
    result.put("ILP","အစ္စရေး ပေါင်");
    result.put("ILS","အစ္စရေး ရှဲကလ်အသစ်");
    result.put("INR","အိန္ဒိယ ရူပီး");
    result.put("IQD","အီရတ် ဒီနာ");
    result.put("IRR","အီရန် ရီအော်လ်");
    result.put("ISK","အိုက်စလန် ခရိုဏာ");
    result.put("JMD","ဂျမေကာ ဒေါ်လာ");
    result.put("JOD","ဂျော်ဒန် ဒီနာ");
    result.put("JPY","ဂျပန် ယန်း");
    result.put("KES","ကင်ညာ သျှီလင်");
    result.put("KGS","ကာဂျစ္စတန် ဆော်မ်");
    result.put("KHR","ကမ္ဘောဒီးယား ရီးယဲ");
    result.put("KMF","ကိုမိုရိုစ် ဖရန့်");
    result.put("KPW","မြောက်ကိုရီးယား ဝမ်");
    result.put("KRW","တောင်ကိုရီးယား ဝမ်");
    result.put("KWD","ကူဝိတ် ဒီနာ");
    result.put("KYD","ကေမန် ကျွန်းစု ဒေါ်လာ");
    result.put("KZT","ကာဇက်စတန် ထိန်ဂျီ");
    result.put("LAK","လာအို ကစ်");
    result.put("LBP","လက်ဘနွန် ပေါင်");
    result.put("LKR","သီရိလင်္ကာ ရူပီး");
    result.put("LRD","လိုက်ဘေးရီးယား ဒေါ်လာ");
    result.put("LTL","လစ်သူယေးနီးယားလီတားစ်");
    result.put("LVL","လတ်ဗီးယားလတ်");
    result.put("LYD","လစ်ဗျား ဒိုင်နာ");
    result.put("MAD","မိုရိုကို ဒရမ်");
    result.put("MDL","မောလ်ဒိုဗာ လယ်အို");
    result.put("MGA","မာလာဂါစီ အရီရရီ");
    result.put("MKD","မက်ဆီဒိုးနီးယား ဒီနာ");
    result.put("MMK","မြန်မာ ကျပ်");
    result.put("MNT","မွန်ဂိုးလီးယား ထူးဂရခ်");
    result.put("MOP","မကာအို ပါတားကား");
    result.put("MRO","မော်ရီတေးနီးယား အူဂီးယာ (၁၉၇၃–၂၀၁၇)");
    result.put("MRU","မော်ရီတေးနီးယန်း အူဂီးယာ");
    result.put("MUR","မောရစ်ရှ ရူပီး");
    result.put("MVR","မော်လ်ဒိုက် ရူးဖီရာ");
    result.put("MWK","မာလာဝီ ခွါးချာ");
    result.put("MXN","မက်ကဆီကို ပီဆို");
    result.put("MYR","မလေးရှား ရင်းဂစ်");
    result.put("MZN","မိုဇမ်ဘစ် မက်တီခယ်လ်");
    result.put("NAD","နမီးဘီးယား ဒေါ်လာ");
    result.put("NGN","နိုင်ဂျီးရီးယား နိုင်းရာ");
    result.put("NIO","နီကာရာဂွါ ခိုးဒိုဘာ");
    result.put("NOK","နော်ဝေ ခရိုဏာ");
    result.put("NPR","နီပေါ ရူပီး");
    result.put("NZD","နယူးဇီလန် ဒေါ်လာ");
    result.put("OMR","အိုမန်နီ ရီရယ်");
    result.put("PAB","ပနားမား ဘလျဘိုးအာ");
    result.put("PEN","ပီရူး ဆိုးလ်");
    result.put("PGK","ပါပူအာ နယူးဂီနီ ခီးနာ");
    result.put("PHP","ဖိလစ်ပိုင် ပီဆို");
    result.put("PKR","ပါကစ္စတန် ရူပီး");
    result.put("PLN","ပိုလန် ဇလော့တီ");
    result.put("PYG","ပါရာဂွေး ဂွါးအ်နီး");
    result.put("QAR","ကာတာရီ ရီရယ်");
    result.put("RON","ရိုမေးနီးယား လယ်အို");
    result.put("RSD","ဆားဘီးယား ဒယ်နား");
    result.put("RUB","ရုရှ ရူဘယ်");
    result.put("RUR","ရုရှ ရူဘယ် (၁၉၉၁–၁၉၉၈)");
    result.put("RWF","ရဝန်ဒါ ဖရန့်");
    result.put("SAR","ဆော်ဒီအာရေးဗီးယား ရီယော်လ်");
    result.put("SBD","ဆော်လမွန်ကျွန်းစု ဒေါ်လာ");
    result.put("SCR","ဆေးရှဲ ရူပီး");
    result.put("SDG","ဆူဒန် ပေါင်");
    result.put("SDP","ဆူဒန် ပေါင်အဟောင်း");
    result.put("SEK","ဆွီဒင် ခရိုဏာ");
    result.put("SGD","စင်္ကာပူ ဒေါ်လာ");
    result.put("SHP","စိန့်ဟယ်လယ်နာ ပေါင်");
    result.put("SLL","ဆီယာရာလီယွန်း လီအိုနီ");
    result.put("SOS","ဆိုမာလီ သျှီလင်");
    result.put("SRD","ဆူရီနမ်း ဒေါ်လာ");
    result.put("SSP","တောင်ဆူဒန် ပေါင်");
    result.put("STD","ဆောင်တူမေးနှင့် ပရင်စီပီ ဒိုဘရာ");
    result.put("STN","ဆောင်တူမေးနှင့် ပရင်စီပီ ဒိုဘရာ (၂၀၁၈)");
    result.put("SUR","ဆိုဗီယက် ရူဗယ်");
    result.put("SYP","ဆီးရီးယား ပေါင်");
    result.put("SZL","ဆွာဇီလန် လီလန်းဂီနီ");
    result.put("THB","ထိုင်း ဘတ်");
    result.put("TJS","တာဂျစ်ကစ္စတန် ဆိုမိုနီ");
    result.put("TMT","တာ့ခ်မင်နစ္စတန် မာနတ်");
    result.put("TND","တူနီးရှား ဒိုင်နာ");
    result.put("TOP","တွန်ဂါ ဗန်ဂါ");
    result.put("TRL","ရှေးဟောင်းတူရကီ လိုင်ရာ");
    result.put("TRY","တူရကီ လိုင်ရာ");
    result.put("TTD","ထရီနီဒတ်နှင့် တိုဘက်ဂို ဒေါ်လာ");
    result.put("TWD","ထိုင်ဝမ် ဒေါ်လာအသစ်");
    result.put("TZS","တန်ဇန်းနီးယား သျှီလင်");
    result.put("UAH","ယူကရိန်း ဟီရီဗင်းညား");
    result.put("UGX","ယူဂန္ဒာ သျှီလင်");
    result.put("USD","အမေရိကန် ဒေါ်လာ");
    result.put("USN","အမေရိကန် ဒေါ်လာ (နောက်နေ့)");
    result.put("USS","အမေရိကန် ဒေါ်လာ (တနေ့တည်း)");
    result.put("UYU","ဥရုဂွေး ပီဆို");
    result.put("UZS","ဥဇဘက်ကစ္စတန် ဆော်မ်");
    result.put("VEF","ဗင်နီဇွဲလား ဘိုလီဗာ (၂၀၀၈–၂၀၁၈)");
    result.put("VES","ဗင်နီဇွဲလန်း ဘိုလီဗာ");
    result.put("VND","ဗီယက်နမ် ဒေါင်");
    result.put("VUV","ဗနွားတူ ဗားထူ");
    result.put("WST","ဆမိုအား ထားလာ");
    result.put("XAF","ကင်မရွန်း ဖရန့်");
    result.put("XAG","ငွေ");
    result.put("XAU","ရွှေ");
    result.put("XBB","ဥရောပငွေကြေးစံနစ်");
    result.put("XCD","အရှေ့ကာရစ်ဘီယံ ဒေါ်လာ");
    result.put("XDR","အထူးထုတ်ယူခွင့်");
    result.put("XOF","အနောက် အာဖရိက CFA ဖရန့်");
    result.put("XPF","CFP ဖရန့်");
    result.put("XPT","ပလက်တီနမ်");
    result.put("XTS","စမ်းသပ် ငွေကြေး ကုဒ်");
    result.put("XXX","မသိသို့မဟုတ်မရှိသောငွေကြေး");
    result.put("YER","ယီမင်နီ ရီရယ်");
    result.put("ZAR","တောင်အာဖရိက ရန်း");
    result.put("ZMW","ဇင်ဘာဘွေ ခွါးချာ");
