...
public class CurrencyList_mzn_IR extends CurrencyList_mzn {
  public CurrencyData getDefault() {
    return new CurrencyDataImpl("IRR","IRR",0,"IRR","IRR");
  }
  ...
  protected HashMap<String, CurrencyData> loadCurrencyMap() {
    ...
    // بوسنی و هرزگوین ِتبدیل‌بَیی مارک
  ...
  protected HashMap<String, String> loadNamesMap() {
    ...
    result.put("AMD","ارمنستون درهم");
    result.put("ANG","هلند ِآنتیل ِجزایر ِگویلدر");
    result.put("AOA","آنگولای ِکوانزا");
    result.put("ARS","آرژانتین ِپزو");
    result.put("AWG","آروبای ِفلورن");
    result.put("AZN","آذربایجون ِمنات");
    result.put("BAM","بوسنی و هرزگوین ِتبدیل‌بَیی مارک");
    result.put("BBD","باربادوس ِدولار");
    result.put("BDT","بنگلادش ِتاکا");
    result.put("BGN","بلغارستون ِلیوا");
    result.put("BHD","بحرین ِدینار");
    result.put("BIF","بوروندی ِفرانک");
    result.put("BMD","برمودای ِدولار");
    result.put("BND","برونئی ِدولار");
    result.put("BOB","بولیوی ِبولیویانو");
    result.put("BRL","برزیل ِرئال");
    result.put("BSD","باهامای ِدولار");
    result.put("BTN","بوتان ِنگولتروم");
    result.put("BWP","بوتساوانای ِپولا");
    result.put("BYN","بلاروس ِروبل");
    result.put("BYR","بلاروس ِروبل (۲۰۰۰–۲۰۱۶)");
    result.put("BZD","بلیز ِدولار");
    result.put("CAD","کانادای ِدولار");
    result.put("CDF","کنگوی ِفرانک");
    result.put("CHF","سوییس ِفرانک");
    result.put("CLP","شیلی ِپزو");
    result.put("CNY","چین ِیوآن");
    result.put("COP","کلمبیای ِپزو");
    result.put("CRC","کاستاریکای ِکولون");
    result.put("CUC","کوبای ِتبدیل‌بَیی پزو");
    result.put("CUP","کوبای ِپزو");
    result.put("CVE","عاج ِساحل ِایسکودو");
    result.put("CZK","چک ِکرون");
    result.put("DJF","جیبوتی ِفرانک");
    result.put("DKK","دانمارک ِکورن");
    result.put("DOP","دومینیکن ِپزو");
    result.put("DZD","الجزیره‌ی ِدینار");
    result.put("EGP","مصر ِپوند");
    result.put("ERN","اریتره‌ی ِناکفا");
    result.put("ETB","اتیوپی ِبیر");
    result.put("EUR","یورو");
    result.put("FKP","فالکلند ِجزایر ِپوند");
    result.put("GBP","بریتانیای ِپوند");
    result.put("GEL","گرجستون ِلاری");
    result.put("GHS","غنای ِسدی");
    result.put("GIP","جبل‌طارق ِپوند");
    result.put("GMD","گامبیای ِدالاسی");
    result.put("GNF","گینه‌ی ِفرانک");
    result.put("GTQ","گواتمالا کتزال");
    result.put("GYD","گویان ِدولار");
    result.put("HKD","هونگ کونگ ِدولار");
    result.put("HNL","هندوراس ِلمپیرا");
    result.put("HRK","کرواسی ِکونا");
    result.put("HTG","هائیتی ِگورد");
    result.put("HUF","مجارستون ِفروینت");
    result.put("IDR","اندونزی ِروپیه");
    result.put("ILS","اسراییل ِنو شِکِل");
    result.put("INR","هند ِروپیه");
    result.put("IQD","عراق ِدینار");
    result.put("IRR","ایران ریال");
    result.put("ISK","ایسلند کرونا");
    result.put("JMD","جاماییکای ِدولار");
    result.put("JOD","اردن ِدینار");
    result.put("JPY","جاپون ِین");
    result.put("KES","کنیای ِشیلینگ");
    result.put("KGS","قرقیزستون ِسام");
    result.put("KHR","کامبوج ِریل");
    result.put("KMF","کامرون ِفرانک");
    result.put("KPW","شمالی کره‌ی ِوون");
    result.put("KRW","جنوبی کُره‌ی ِوون");
    result.put("KWD","کویت ِدینار");
    result.put("KYD","کایمن جزیره‌ی ِدولار");
    result.put("KZT","قراقستون ِتنگ");
    result.put("LAK","لائوس ِکیپ");
    result.put("LBP","لبنان ِپوند");
    result.put("LKR","سریلانکا روپیه");
    result.put("LRD","لیبریای ِدولار");
    result.put("LYD","لیبی ِدینار");
    result.put("MAD","مراکش ِدرهم");
    result.put("MDL","مولداوی ِلئو");
    result.put("MGA","ماداگاسکار ِآریاری");
    result.put("MKD","مقدونیه‌ی ِدینار");
    result.put("MMK","میانمار ِکیات");
    result.put("MNT","مغلستون ِتوگریک");
    result.put("MOP","ماکائو ِپاتاجا");
    result.put("MRO","موریتانی ِاوگوئیا (1973–2017)");
    result.put("MRU","موریتانی ِاوگوئیا");
    result.put("MUR","موریتیان ِروپیه");
    result.put("MVR","مالدیو ِروفیا");
    result.put("MWK","مالاوی ِکواچا");
    result.put("MXN","مکزیک ِپزو");
    result.put("MYR","مالزی ِرینگیت");
    result.put("MZN","موزامبیک متیکال");
    result.put("NAD","نامبیای ِدولار");
    result.put("NGN","نیجریه‌ی ِنیارا");
    result.put("NIO","نیکاراگوئه‌ی ِکوردوبا");
    result.put("NOK","نروژ ِکرون");
    result.put("NPR","نپال ِروپیه");
    result.put("OMR","عمان ِریال");
    result.put("PAB","پانامای ِبالبوا");
    result.put("PEN","پروی ِسول");
    result.put("PHP","فیلیپین ِپزو");
    result.put("PKR","پاکستون روپیه");
    result.put("PLN","لهستون ِزلوتی");
    result.put("PYG","پاراگوئه‌ی ِگوارانی");
    result.put("QAR","قطر ِریال");
    result.put("RON","رومانی ِلئو");
    result.put("RSD","صربستون ِدینار");
    result.put("RUB","روسیه‌ی ِروبل");
    result.put("RWF","روآندای ِفرانک");
    result.put("SAR","عربستون ِریال");
    result.put("SCR","سیشل ِروپیه");
    result.put("SDG","سودان ِپوند");
    result.put("SEK","سوئد ِکرون");
    result.put("SGD","سنگاپور ِدلار");
    result.put("SHP","سنت هلنای ِپوند");
    result.put("SLL","سیرالئون ِلئون");
    result.put("SOS","سومالی ِشیلینگ");
    result.put("SRD","سورینام ِدولار");
    result.put("SSP","جنوبی سودان ِپوند");
    result.put("STD","سائوتومه و پرینسیپ ِدوبرا (1977–2017)");
    result.put("STN","سائوتومه و پرینسیپ ِدوبرا");
    result.put("SYP","سوریه‌ی ِپوند");
    result.put("SZL","سوازیلند ِلیلانجنی");
    result.put("THB","تایلند ِبات");
    result.put("TJS","تاجیکستون ِسامانی");
    result.put("TMT","ترکمنستون ِمنات");
    result.put("TND","تونس ِدینار");
    result.put("TRY","ترکیه‌ی ِلیره");
    result.put("TTD","ترینیداد و توباگوی ِدولار");
    result.put("TWD","جدید ِتایوان ِدولار");
    result.put("TZS","تانزانیای ِشیلینگ");
    result.put("UAH","اکراین ِگریونا");
    result.put("UGX","اوگاندای ِشیلینگ");
    result.put("USD","آمریکای ِدولار");
    result.put("UYU","اروگوئه‌ی ِپزو");
    result.put("UZS","ازبکستون ِسام");
    result.put("VEF","ونزوئلایِ بولیوار (2008–2018)");
    result.put("VES","ونزوئلایِ بولیوار");
    result.put("VND","ویتنام ِدنگ");
    result.put("XAF","میونی آفریقای ِسی‌اف‌ای فرانک");
    result.put("XCD","شرقی کاراییب ِدولار");
    result.put("XOF","غربی آفریقای ِسی‌اف‌ای فرانک");
    result.put("YER","یمن ِریال");
    result.put("ZAR","جنوبی آفریقای ِراند");
    result.put("ZMW","زامبیای ِکواچا");
    return result;
  }
}
