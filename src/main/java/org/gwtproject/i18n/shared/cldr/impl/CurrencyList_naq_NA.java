...
public class CurrencyList_naq_NA extends CurrencyList_naq {
  ...
  protected HashMap<String, String> loadNamesMap() {
    ...
    result.put("BWP","Botswanan Pulab");
    result.put("CAD","Canadian Dollari");
    result.put("CDF","Congolese Franc");
    result.put("CHF","Swiss Franci");
    ...
    result.put("EGP","Egytian Ponds");
    result.put("ERN","Eritreian Nakfa");
    result.put("ETB","Ethiopian Birr");
    result.put("EUR","Eurob");
    result.put("GBP","British Ponds");
    result.put("GHC","Ghana Cedi");
    result.put("GMD","Gambia Dalasi");
    result.put("GNS","Guinea Franc");
    result.put("INR","Indian Rupee");
    result.put("JPY","Japanese Yenni");
    ...
    result.put("MGA","Malagasy Franc");
    result.put("MRO","Mauritania Ouguiya (1973–2017)");
    result.put("MRU","Mauritania Ouguiya");
    result.put("MUR","Mauritius Rupeeb");
    result.put("MWK","Malawian Kwachab");
    result.put("MZM","Mozambique Metical");
    result.put("NAD","Namibia Dollari");
    result.put("NGN","Nigerian Naira");
    result.put("RWF","Rwanda Franci");
    result.put("SAR","Saudi Riyal");
    result.put("SCR","Seychelles Rupee");
    result.put("SDG","Sudanese Dinar");
    result.put("SDP","Sudanese Ponds");
    result.put("SHP","St Helena Ponds");
    result.put("SLL","Leone");
    result.put("SOS","Somali Shillings");
    result.put("STD","Sao Tome and Principe Dobra (1977–2017)");
    result.put("STN","Sao Tome and Principe Dobra");
    result.put("SZL","Lilangeni");
    result.put("TND","Tunisian Dinar");
    result.put("TZS","Tanzanian Shillings");
    result.put("UGX","Ugandan Shillings");
    result.put("USD","US Dollari");
    result.put("XAF","CFA Franc BEAC");
    result.put("XOF","CFA Franc BCEAO");
    result.put("ZAR","South African Randi");
    result.put("ZMK","Zambian Kwachab (1968–2012)");
    result.put("ZMW","Zambian Kwachab");
    result.put("ZWD","Zimbabwe Dollari");
    return result;
  }
}
