...
public class CurrencyList_nd_ZW extends CurrencyList_nd {
  ...
  protected HashMap<String, String> loadNamesMap() {
    ...
    result.put("AED","Dola laseArab");
    result.put("AOA","Kwanza yase Angola");
    result.put("AUD","Dola yase Australia");
    result.put("BHD","Dinari yase Bhahareni");
    result.put("BIF","Fulenki yase Bhurundi");
    result.put("BWP","Phula yase Botswana");
    result.put("CAD","Dola yase Khanada");
    result.put("CDF","Fulenki yase Khongo");
    result.put("CHF","Fulenki yase Swisi");
    result.put("CNY","Yuan Renminbi yase China");
    result.put("CVE","Escudo Caboverdiano");
    result.put("DJF","Fulenki yase Jibhuthi");
    result.put("DZD","Dinali yase Aljeriya");
    result.put("EGP","Phawundi laseGibhide");
    result.put("ERN","Nakfa yase Eritrea");
    result.put("ETB","Dola laseEthiopia");
    result.put("EUR","Yuro");
    result.put("GBP","Phawundi yase Ngilandi");
    result.put("GHC","Sedi yase Ghana");
    result.put("GMD","Dalasi yase Gambia");
    result.put("GNS","Fulenki yase Gine");
    result.put("INR","Rupi yase Indiya");
    result.put("JPY","Yeni yase Japhani");
    result.put("KES","Shilingi yase Kenya");
    result.put("KMF","Fulenki yase Khomoro");
    result.put("LRD","Dola yase Libheriya");
    result.put("LSL","Lothi yase Lesotho");
    result.put("LYD","Dinari yase Libya");
    result.put("MAD","Dirham yase Morokho");
    result.put("MGA","Fulenki yase Malagasi");
    result.put("MRO","Ugwiya yase Moritaniya (1973–2017)");
    result.put("MRU","Ugwiya yase Moritaniya");
    result.put("MUR","Rupi yase Morishasi");
    result.put("MWK","Kwacha yase Malawi");
    result.put("MZM","Metikali yase Mozambiki");
    result.put("NAD","Dola yase Namibiya");
    result.put("NGN","Nayira yase Nijeriya");
    result.put("RWF","Fulenki yase Ruwanda");
    result.put("SAR","Riyal yase Saudi");
    result.put("SCR","Rupi yase Seyisheli");
    result.put("SDG","Dinari yase Sudani");
    result.put("SDP","Phawundi yase Sudani");
    result.put("SHP","Phawundindi laseSt Helena");
    result.put("SLL","Leyoni");
    result.put("SOS","Shilingi yase Somaliya");
    result.put("STD","Dobra yase Sao Tome lo Principe (1977–2017)");
    result.put("STN","Dobra yase Sao Tome lo Principe");
    result.put("SZL","Lilangeni");
    result.put("TND","Dinari yase Tunisiya");
    result.put("TZS","Shilingi yase Tanzaniya");
    result.put("UGX","Shilingi yase Uganda");
    result.put("USD","Dola yase Amelika");
    result.put("XAF","Fulenki CFA BEAC");
    result.put("XOF","Fulenki CFA BCEAO");
    result.put("ZAR","Randi yase Afrika ye Zanzi");
    result.put("ZMK","Kwacha yase Zambiya (1968–2012)");
    result.put("ZMW","Kwacha yase Zambiya");
    result.put("ZWD","Dola yase Zimbabwe");
    return result;
  }
}
