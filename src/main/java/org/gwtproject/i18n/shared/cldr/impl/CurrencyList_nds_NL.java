...
public class CurrencyList_nds_NL extends CurrencyList_nds {
  ...
  protected HashMap<String, String> loadNamesMap() {
    ...
    result.put("CHF","Swiezer Franken");
    result.put("CNY","Chineesch Yuan");
    result.put("DKK","Däänsch Kroon");
    result.put("EUR","Euro");
    result.put("GBP","Britsch Pund Sterling");
    result.put("HKD","Hongkong-Dollar");
    result.put("IDR","Indoneesch Rupje");
    result.put("INR","Indsch Rupje");
    result.put("JPY","Japaansch Yen");
    result.put("KRW","Söödkoreansch Won");
    result.put("MXN","Mexikaansch Peso");
    result.put("NOK","Norweegsch Kroon");
    result.put("PLN","Poolsch Zloty");
    result.put("RUB","Russ’sch Ruvel");
    result.put("SAR","Saudsch Rial");
    result.put("SEK","Sweedsch Kroon");
    result.put("THB","Thailannsch Baht");
    result.put("TRY","Törksch Lira");
    result.put("TWD","Nieg Taiwan-Dollar");
    result.put("USD","US-Dollar");
    result.put("XXX","Nich begäng Geldsoort");
    result.put("ZAR","Söödafrikaansch Rand");
    return result;
  }
}
