...
public class CurrencyList_ne_NP extends CurrencyList_ne {
  public CurrencyData getDefault() {
    return new CurrencyDataImpl("NPR","Rs",2,"Rs","Rs");
  }
  ...
  protected HashMap<String, CurrencyData> loadCurrencyMap() {
    ...
    // नेपाली रूपैयाँ
    result.put("NPR", new CurrencyDataImpl("NPR","Rs",2,"Rs","Rs"));
    // न्यूजिल्याण्ड डलर
  ...
  protected HashMap<String, String> loadNamesMap() {
    ...
    result.put("AMD","आर्मेनियाली ड्राम");
    result.put("ANG","नेदरल्याण्ड्स एन्टिलियन गिल्डर");
    result.put("AOA","एङ्गोलान क्वान्जा");
    result.put("ARS","अर्जेन्टिनी पेसो");
    result.put("AUD","अष्ट्रेलियन डलर");
    result.put("AWG","आरूबन फ्लोरिन");
    result.put("AZN","अजरबैजानी मानात");
    result.put("BAM","बोस्निया-हर्जगोभिनिया रूपान्तरयोग्य मार्क");
    result.put("BBD","बर्बाडियन डलर");
    result.put("BDT","बङ्गलादेशी टाका");
    result.put("BGN","बुल्गारियाली लेभ");
    result.put("BHD","बाहारैनी डिनार");
    result.put("BIF","बुरूण्डियाली फ्रान्क");
    result.put("BMD","बर्मुडन डलर");
    result.put("BND","ब्रुनाई डलर");
    result.put("BOB","बोलिभियन बोलिभियानो");
    result.put("BRL","ब्राजिलियन रियल");
    result.put("BSD","बहामियाली डलर");
    result.put("BTN","भुटानी एन्‌गुल्ट्रुम");
    result.put("BWP","बोट्सवानान पुला");
    result.put("BYN","बेलारूसी रूबल");
    result.put("BYR","बेलारूसी रूबल (2000–2016)");
    result.put("BZD","वेलिज डलर");
    result.put("CAD","क्यानाडियाली डलर");
    result.put("CDF","कङ्गोली फ्रान्क");
    result.put("CHF","स्विस् फ्रैङ्क");
    result.put("CLP","चिलियन पेसो");
    result.put("CNH","चिनियाँ युआन(तटवर्ती)");
    result.put("CNY","चिनिँया युआन");
    result.put("COP","कोलम्वियन पेसो");
    result.put("CRC","कोष्टारिकन कोलोन");
    result.put("CUC","क्यूवाली रूपान्तरणयोग्य पेसो");
    result.put("CUP","क्यूवाली पेसो");
    result.put("CVE","केप भर्डियन एस्कुडो");
    result.put("CZK","चेख गणतञ्त्र कोरूना");
    result.put("DJF","जिबौंटियाली फ्रान्क");
    result.put("DKK","ड्यानिश क्रोन");
    result.put("DOP","डोमिनिकन पेसो");
    result.put("DZD","अल्जेरियाली डिनार");
    result.put("EGP","इजिप्सियन पाउन्ड");
    result.put("ERN","एरिट्रियन नाक्फा");
    result.put("ETB","इथियोपियाली बिर");
    result.put("EUR","युरो");
    result.put("FJD","फिजीयाली डलर");
    result.put("FKP","फक्‌ल्याण्ड टापुहरूका पाउन्ड");
    result.put("GBP","बेलायती पाउण्ड स्टर्लिङ");
    result.put("GEL","जर्जियाली लारी");
    result.put("GHS","घानाली सेडी");
    result.put("GIP","जिब्राल्टर पाउण्ड");
    result.put("GMD","गाम्वियाली डालासी");
    result.put("GNF","गिनियाली फ्रान्क");
    result.put("GTQ","ग्वाटेमाला क्वेट्जाल");
    result.put("GYD","गाइनिज डलर");
    result.put("HKD","हङकङ डलर");
    result.put("HNL","होन्डुरान लेम्पिरा");
    result.put("HRK","क्रोएशियाली कुना");
    result.put("HTG","हैटियाली गुर्ड");
    result.put("HUF","हङ्गेरियन फोरिन्ट");
    result.put("IDR","इण्डोनेशियाली रूपियाँ");
    result.put("ILS","इजरायली नयाँ शेकेल");
    result.put("INR","भारतीय रूपिँया");
    result.put("IQD","इराकी डिनार");
    result.put("IRR","इरानियाली रियाल");
    result.put("ISK","आइसल्याण्डिक क्रोना");
    result.put("JMD","जमाइकाली डलर");
    result.put("JOD","जोर्डानियाली डलर");
    result.put("JPY","जापानी येन");
    result.put("KES","केन्याली शिलिङ");
    result.put("KGS","किर्गिस्तानी सोम");
    result.put("KHR","कम्बोडिनेयाली रियल");
    result.put("KMF","कोमोरियन फ्रान्क");
    result.put("KPW","उत्तर कोरियाली वन");
    result.put("KRW","दक्षिण कोरियाली वन");
    result.put("KWD","कुवेती डिनार");
    result.put("KYD","केम्यान टापुहरूका डलर");
    result.put("KZT","काजाखस्तानी टेन्ज");
    result.put("LAK","लाओशियन किप");
    result.put("LBP","लेबनाली पाउन्ड");
    result.put("LKR","श्रीलङ्काली रूपिया");
    result.put("LRD","लिबेरियाली डलर");
    result.put("LTL","लिथुनियाली लिटास");
    result.put("LVL","लाट्भियाली लाट्स");
    result.put("LYD","लिवियाली डिनार");
    result.put("MAD","मोरोक्काली डिर्‌हाम");
    result.put("MDL","माल्डोभन लेउ");
    result.put("MGA","मालागासी एरिआरी");
    result.put("MKD","म्यासेडोनियाली डेनार");
    result.put("MMK","म्यान्मार क्याट");
    result.put("MNT","मङ्गोलियाली टुग्रिक");
    result.put("MOP","माकानिज पटाका");
    result.put("MRO","माउरिटानियानली औगुइया (१९७३–२०१७)");
    result.put("MRU","माउरिटानियानली औगुइया");
    result.put("MUR","माउरिटियन रूपी");
    result.put("MVR","मालडिभियाली रूफियाँ");
    result.put("MWK","मलाविअन क्वाचा");
    result.put("MXN","मेक्सिकन पेसो");
    result.put("MYR","मलेशियाली रिङ्गेट");
    result.put("MZN","मोजाम्विकन मेटिकल");
    result.put("NAD","नामिबियन डलर");
    result.put("NGN","नाइजेरियन नाइरा");
    result.put("NIO","निकारागुवान कोर्डोवा");
    result.put("NOK","नर्वेजियाली क्रोन");
    result.put("NPR","नेपाली रूपैयाँ");
    result.put("NZD","न्यूजिल्याण्ड डलर");
    result.put("OMR","ओमनी रियल");
    result.put("PAB","पानामानियाली बाल्बोआ");
    result.put("PEN","पेरूभियाली सोल");
    result.put("PGK","पपुआ न्यू गिनियाली किना");
    result.put("PHP","फिलिपिनी पेसो");
    result.put("PKR","पाकिस्तानी रूपियाँ");
    result.put("PLN","पोलिश ज्लोटाई");
    result.put("PYG","पारागुयाली गुरानी");
    result.put("QAR","कतारी रियल");
    result.put("RON","रोमानियाली लेऊ");
    result.put("RSD","सर्बियाली डिनार");
    result.put("RUB","रूसी रूबल");
    result.put("RWF","र्‌वाण्डाली फ्रान्क");
    result.put("SAR","साउदी रियालहरू");
    result.put("SBD","सोलोमन टापुहरूका डलर");
    result.put("SCR","सेचेलोइस रूपी");
    result.put("SDG","सुडानी पाउन्ड");
    result.put("SEK","स्विडिश क्रोना");
    result.put("SGD","सिङ्गापुर डलर");
    result.put("SHP","सेन्ट हेलेना पाउन्ड");
    result.put("SLL","सियरा लियोनेन लियोन");
    result.put("SOS","सोमाली शिलिङ");
    result.put("SRD","सुरिनामिज डलर");
    result.put("SSP","दक्षिण सुडानी पाउन्ड");
    result.put("STD","साओ टोम र प्रिन्सिप डोब्रा (१९७७–२०१७)");
    result.put("STN","साओ टोम र प्रिन्सिप डोब्रा");
    result.put("SYP","सिरियाली पाउन्ड");
    result.put("SZL","स्वाजी लिलान्गेनी");
    result.put("THB","थाई भाट");
    result.put("TJS","ताजिक्स्तानी सोमोनी");
    result.put("TMT","टुर्क्मेनिस्तानी मानात");
    result.put("TND","टुनिसियाली डिनार");
    result.put("TOP","टङ्गन पाङ्गा");
    result.put("TRY","टर्किश लिरा");
    result.put("TTD","त्रिनिडाड र टोबागो डलर");
    result.put("TWD","नयाँ ताइवान डलर");
    result.put("TZS","ताञ्जानियाली शिलिङ");
    result.put("UAH","युक्रेनी हिर्भिनिया");
    result.put("UGX","युगाण्डाली शिलिङ");
    result.put("USD","अमेरिकी डलर");
    result.put("UYU","उरूगुवायाली पेसो");
    result.put("UZS","उज्बेकिस्तान सोम");
    result.put("VEF","भेनेजुएलन बोलिभर (२००८–२०१८)");
    result.put("VES","भेनेजुएलन बोलिभर-2");
    result.put("VND","भियतनामी डङ्");
    result.put("VUV","भानुआतू भातु");
    result.put("WST","सामोआन ताला");
    result.put("XAF","सीएफ्‌ए फ्रान्क बीइएसी");
    result.put("XCD","पूर्वी क्यारिबियन डलर");
    result.put("XOF","सीएफ्‌ए फ्रान्क बीसीइएओ");
    result.put("XPF","सीएफ्‌पी फ्रान्क");
    result.put("XXX","अज्ञात मुद्रा");
    result.put("YER","येमेनी रियाल");
    result.put("ZAR","दक्षिण अफ्रिकी र्‍यान्ड");
    result.put("ZMK","जाम्बियाली क्वाचा (१९६८–२०१२)");
    result.put("ZMW","जाम्बियाली क्वाचा");
    return result;
  }
}
