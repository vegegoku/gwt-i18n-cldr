...
public class CurrencyList_nmg_CM extends CurrencyList_nmg {
  ...
  protected HashMap<String, String> loadNamesMap() {
    ...
    result.put("AED","Mɔn B ´Arabe");
    result.put("AOA","Mɔn Angola");
    result.put("AUD","Dɔ́llɔ Ɔstralia");
    result.put("BHD","Mɔn Bahrein");
    result.put("BIF","Fraŋ Burundi");
    result.put("BWP","Mɔn Botswana");
    result.put("CAD","Dɔ́llɔ Kanada");
    result.put("CDF","Fraŋ bó Kongolɛ̌");
    result.put("CHF","Fraŋ Suisse");
    result.put("CNY","Mɔn bó Chinois");
    result.put("CVE","Mɔn Kapvɛrt");
    result.put("DJF","Fraŋ Jibuti");
    result.put("DZD","Mɔn Algeria");
    result.put("EGP","Mɔn Ägyptɛn");
    result.put("ERN","Mɔn Erytré");
    result.put("ETB","Mɔn Ethiopia");
    result.put("EUR","Euro");
    result.put("GBP","Mɔn Ngɛ̄lɛ̄n");
    result.put("GHC","Mɔn Gana");
    result.put("GMD","Mɔn Gambia");
    result.put("GNS","Fraŋ Guiné");
    result.put("INR","Mɔn India");
    result.put("JPY","Mɔn Japɔn");
    result.put("KES","Mɔn Kɛnya");
    result.put("KMF","Fraŋ bó Kɔmɔr");
    result.put("LRD","Dɔ́llɔ Liberia");
    result.put("LSL","Mɔn Lesoto");
    result.put("LYD","Mɔn Libya");
    result.put("MAD","Mɔn Marɔk");
    result.put("MGA","Mɔn Madagaskar");
    result.put("MRO","Mɔn Moritania (1973–2017)");
    result.put("MRU","Mɔn Moritania");
    result.put("MUR","Mɔn Moriss");
    result.put("MWK","Mɔn Malawi");
    result.put("MZM","Mɔn Mozambik");
    result.put("NAD","Dɔ́llɔ Namibia");
    result.put("NGN","Naïra Nigeria");
    result.put("RWF","Fraŋ Rwanda");
    result.put("SAR","Mɔn Saudi Arabia");
    result.put("SCR","Mɔn Seychɛlle");
    result.put("SDG","Mɔn Sudan");
    result.put("SDP","Mɔn Sudan (1957–1998)");
    result.put("SHP","Mɔn má Saint Lina");
    result.put("SLL","Mɔn Leɔne");
    result.put("SOS","Mɔn Somalía");
    result.put("STD","Mɔn Sao tomé na prinship (1977–2017)");
    result.put("STN","Mɔn Sao tomé na prinship");
    result.put("SZL","Mɔn Ligangeni");
    result.put("TND","Mɔn Tunisia");
    result.put("TZS","Mɔn Tanzania");
    result.put("UGX","Mɔn Uganda");
    result.put("USD","Dɔ́llɔ Amɛŕka");
    result.put("XAF","Fraŋ CFA BEAC");
    result.put("XOF","Fraŋ CFA BCEAO");
    result.put("ZAR","Mɔn Afrik yí sí");
    result.put("ZMK","Mɔn Zambia (1968–2012)");
    result.put("ZMW","Mɔn Zambia");
    result.put("ZWD","Dɔ́llɔ Zimbabwǝ (1980–2008)");
    return result;
  }
}
