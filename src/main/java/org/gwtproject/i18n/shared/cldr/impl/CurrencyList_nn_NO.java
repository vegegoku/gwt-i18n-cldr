...
public class CurrencyList_nn_NO extends CurrencyList_nn {
  public CurrencyData getDefault() {
    return new CurrencyDataImpl("NOK","kr",2,"kr","kr");
  }
  ...
  protected HashMap<String, CurrencyData> loadCurrencyMap() {
    ...
    // norske kroner
    result.put("NOK", new CurrencyDataImpl("NOK","kr",2,"kr","kr"));
    // nepalske rupiar
    ...
    result.put("XAF", new CurrencyDataImpl("XAF","XAF",0,"XAF","XAF"));
    // sølv
  ...
  protected HashMap<String, String> loadNamesMap() {
    ...
    result.put("AOK","angolske kwanza (1977–1990)");
    result.put("AON","angolske nye kwanza (1990–2000)");
    result.put("AOR","angolske kwanza reajustado (1995–1999)");
    result.put("ARA","argentiske austral");
    result.put("ARP","argentinske peso (1983–1985)");
    result.put("ARS","argentinske pesos");
    result.put("ATS","austerrikske schilling");
    result.put("AUD","australske dollar");
    result.put("AWG","arubiske floriner");
    result.put("AZM","aserbaijanske manat");
    result.put("AZN","aserbajdsjanske manat");
    result.put("BAD","bosnisk-hercegovinske dinarar");
    result.put("BAM","bosnisk-hercegovinske konvertible mark");
    result.put("BBD","barbadiske dollar");
    result.put("BDT","bangladeshiske taka");
    result.put("BEC","belgiske franc (konvertibel)");
    result.put("BEF","belgiske franc");
    result.put("BEL","belgiske franc (finansiell)");
    result.put("BGL","bulgarsk hard lev");
    result.put("BGN","bulgarske lev");
    result.put("BHD","bahrainske dinarar");
    ...
    result.put("BOP","boliviske peso");
    result.put("BOV","boliviske mvdol");
    ...
    result.put("CNY","kinesiske yuan");
    result.put("COP","kolombianske pesos");
    result.put("COU","unidad de valor real");
    result.put("CRC","kostarikanske colón");
    result.put("CSD","gamle serbiske dinarer");
    result.put("CSK","tsjekkoslovakiske koruna (hard)");
    result.put("CUC","kubanske konvertible pesos");
    ...
    result.put("GBP","britiske pund");
    result.put("GEK","georgiske kupon larit");
    result.put("GEL","georgiske lari");
    result.put("GHC","ghanesiske cedi (1979–2007)");
    result.put("GHS","ghanesiske cedi");
    ...
    result.put("HNL","honduranske lempira");
    result.put("HRD","kroatiske dinar");
    result.put("HRK","kroatiske kuna");
    result.put("HTG","haitiske gourde");
    result.put("HUF","ungarske forintar");
    result.put("IDR","indonesiske rupiar");
    result.put("IEP","irske pund");
    result.put("ILP","israelske pund");
    result.put("ILS","israelske nye sheklar");
    result.put("INR","indiske rupiar");
    result.put("IQD","irakiske dinarar");
    result.put("IRR","iranske rial");
    result.put("ISK","islandske kroner");
    result.put("ITL","italienske lire");
    result.put("JMD","jamaikanske dollar");
    result.put("JOD","jordanske dinarar");
    ...
    result.put("KWD","kuwaitiske dinarar");
    ...
    result.put("NIO","nicaraguanske córdoba");
    result.put("NLG","nederlandske gylden");
    result.put("NOK","norske kroner");
    result.put("NPR","nepalske rupiar");
    result.put("NZD","nyzealandske dollar");
    result.put("OMR","omanske rial");
    result.put("PAB","panamanske balboa");
    result.put("PEI","peruanske inti");
    result.put("PEN","peruanske sol");
    result.put("PES","peruanske sol (1863–1965)");
    result.put("PGK","papuanske kina");
    result.put("PHP","filippinske pesos");
    result.put("PKR","pakistanske rupiar");
    result.put("PLN","polske zloty");
    result.put("PLZ","polske zloty (1950–1995)");
    result.put("PTE","portugisiske escudo");
    result.put("PYG","paraguayanske guaraní");
    result.put("QAR","qatarske rial");
    result.put("RHD","rhodesiske dollar");
    result.put("ROL","gamle rumenske leu");
    result.put("RON","rumenske leuar");
    result.put("RSD","serbiske dinarar");
    result.put("RUB","russiske rublar");
    result.put("RUR","russiske rublar (1991–1998)");
    result.put("RWF","rwandiske franc");
    result.put("SAR","saudiarabiske rial");
    result.put("SBD","salomonske dollar");
    result.put("SCR","seychelliske rupiar");
    result.put("SDD","gamle sudanske dinarer");
    result.put("SDG","sudanske pund");
    result.put("SDP","gamle sudanske pund");
    ...
    result.put("SSP","sørsudanske pund");
    result.put("STD","saotomesiske dobra (1977–2017)");
    result.put("STN","saotomesiske dobra");
    result.put("SUR","sovjetiske rublar");
    ...
    result.put("TJR","tadsjikiske rublar");
    result.put("TJS","tadsjikiske somoni");
    result.put("TMM","turkmensk manat (1993–2009)");
    result.put("TMT","turkmenske manat");
    result.put("TND","tunisiske dinarar");
    result.put("TOP","tonganske paʻanga");
    result.put("TPE","timoresiske escudo");
    result.put("TRL","gamle tyrkiske lire");
    result.put("TRY","tyrkiske lire");
    result.put("TTD","trinidadiske dollar");
    result.put("TWD","nye taiwanske dollar");
    ...
    result.put("USS","amerikanske dollar (same dag)");
    result.put("UYI","uruguayanske peso en unidades indexadas");
    result.put("UYP","uruguayanske peso (1975–1993)");
    result.put("UYU","uruguayanske pesos");
    result.put("UZS","usbekiske sum");
    result.put("VEB","venezuelanske bolivar (1871–2008)");
    result.put("VEF","venezuelanske bolivar (2008–2018)");
    result.put("VES","venezuelanske bolivar");
    result.put("VND","vietnamesiske dong");
    result.put("VUV","vanuatuiske vatu");
    result.put("WST","samoanske tala");
    result.put("XAF","sentralafrikanske CFA-franc");
    result.put("XAG","sølv");
    result.put("XAU","gull");
    result.put("XBA","europeiske samansette einingar");
    result.put("XBB","europeiske monetære einingar");
    result.put("XBC","europeiske kontoeiningar (XBC)");
    result.put("XBD","europeiske kontoeiningar (XBD)");
    result.put("XCD","austkaribiske dollar");
    result.put("XDR","spesielle trekkrettar");
    result.put("XEU","europeiske valutaeiningar");
    result.put("XFO","franske gullfranc");
    result.put("XFU","franske UIC-franc");
    result.put("XOF","vestafrikanske CFA-franc");
    ...
    result.put("YDD","jemenittiske dinarar");
    result.put("YER","jemenittiske rial");
    result.put("YUD","jugoslaviske dinarar (hard)");
    result.put("YUM","jugoslaviske noviy-dinarar");
    result.put("YUN","jugoslaviske konvertibel dinarar");
    result.put("ZAL","sørafrikanske rand (finansiell)");
    result.put("ZAR","sørafrikanske rand");
    result.put("ZMK","zambiske kwacha (1968–2012)");
    result.put("ZMW","zambiske kwacha");
