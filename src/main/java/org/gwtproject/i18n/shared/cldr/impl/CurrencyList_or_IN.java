...
public class CurrencyList_or_IN extends CurrencyList_or {
  ...
  protected HashMap<String, String> loadNamesMap() {
    ...
    result.put("AMD","ଅର୍ମେନୀୟ ଡ୍ରାମ୍");
    result.put("ANG","ନେଦରଲ୍ୟାଣ୍ଡ୍ ଆଣ୍ଟିଲିୟ ଗିଲଡର୍");
    result.put("AOA","ଅଙ୍ଗୋଲୀୟ କୱାନଜା");
    result.put("ARS","ଆର୍ଜେଣ୍ଟାଇନ୍‍ ପେସୋ");
    result.put("AUD","ଅଷ୍ଟ୍ରେଲିୟ ଡଲାର୍");
    result.put("AWG","ଆରୁବୀୟ ଫ୍ଲୋରିନ୍");
    result.put("AZN","ଆଜେରବାଇଜାନି ମନତ୍");
    result.put("BAM","ବୋସନିଆ-ହର୍ଜଗୋଭିନା କନଭର୍ଟିବଲ୍ ମାର୍କ୍");
    result.put("BBD","ବାର୍ବାଡୀୟ ଡଲାର୍");
    result.put("BDT","ବଙ୍ଗଳାଦେଶୀ ଟାକା");
    result.put("BGN","ବୁଲଗେରୀୟ ଲେଭ୍");
    result.put("BHD","ବାଃରେନି ଦିନାର୍");
    result.put("BIF","ବୁରୁଣ୍ଡିୟ ଫ୍ରାଙ୍କ୍");
    result.put("BMD","ବର୍ମ୍ୟୁଡା ଡଲାର୍");
    result.put("BND","ବ୍ରୁନେଇ ଡଲାର୍");
    result.put("BOB","ବୋଲିଭୀୟ ବୋଲିଭିଆନୋ");
    result.put("BRL","ବ୍ରାଜିଲୀୟ ରିଏଲ୍");
    result.put("BSD","ବାହାମୀୟ ଡଲାର୍");
    result.put("BTN","ଭୁଟାନୀ ଗଲଟ୍ରୁମ୍");
    result.put("BWP","ବୋତ୍ସୱାନା ପୁଲା");
    result.put("BYN","ବେଲାରୁସି ରୁବଲ୍");
    result.put("BZD","ବେଲିଜ୍ ଡଲାର୍");
    result.put("CAD","କାନେଡିୟ ଡଲାର୍");
    result.put("CDF","କଙ୍ଗୋଲିଜ୍ ଫ୍ରାଙ୍କ୍");
    result.put("CHF","ସୁଇସ୍ ଫ୍ରାଙ୍କ୍");
    result.put("CLP","ଚିଲି ପେସୋ");
    result.put("CNH","ଚିନୀ ୟୁଆନ୍ (ଅଫସୋର୍)");
    result.put("CNY","ଚିନୀ ୟୁଆନ୍");
    result.put("COP","କଲୋମ୍ବୀୟ ପେସୋ");
    result.put("CRC","କୋଷ୍ଟା ରିକୀୟ କୋଲୋନ୍");
    result.put("CUC","କ୍ୟୁବାନ୍ କନଭର୍ଟିବଲ୍ ପେସୋ");
    result.put("CUP","କ୍ୟୁବାନ୍ ପେସୋ");
    result.put("CVE","କେପ୍ ଭେର୍ଦେୟ ଏସ୍କୁଡୋ");
    result.put("CZK","ଚେକ୍ କୋରୁନା");
    result.put("DJF","ଜିବୌଟିୟ ଫ୍ରାଙ୍କ୍");
    result.put("DKK","ଡାନିସ୍ କ୍ରୋନ୍");
    result.put("DOP","ଡୋମିନିକୀୟ ପେସୋ");
    result.put("DZD","ଆଲଜେରୀୟ ଦିନାର୍");
    result.put("EGP","ଇଜିପ୍ଟିୟ ପାଉଣ୍ଡ୍");
    result.put("ERN","ଏରିଟ୍ରେୟ ନାକଫା");
    result.put("ETB","ଇଥିଓପିୟ ବିର୍");
    result.put("EUR","ୟୁରୋ");
    result.put("FJD","ଫିଜି ଡଲାର୍");
    result.put("FKP","ଫକଲ୍ୟାଣ୍ଡ୍ ଦ୍ଵୀପପୁଞ୍ଜ ପାଉଣ୍ଡ୍");
    result.put("GBP","ବ୍ରିଟିଶ୍ ପାଉଣ୍ଡ୍");
    result.put("GEL","ଜର୍ଜିୟ ଲାରି");
    result.put("GHS","ଘାନିୟ ସେଡି");
    result.put("GIP","ଗିବ୍ରାଲଟର୍ ପାଉଣ୍ଡ୍");
    result.put("GMD","ଗାମ୍ବିୟ ଡାଲାସି");
    result.put("GNF","ଗୁଇନେୟ ଫ୍ରାଙ୍କ୍");
    result.put("GTQ","ଗୁଏଟମାଲୀୟ କ୍ଵେତଜାଲ୍");
    result.put("GYD","ଗାୟାନିସ୍ ଡଲାର୍");
    result.put("HKD","ହଂ କଂ ଡଲାର୍");
    result.put("HNL","ହୋଣ୍ଡୁରୀୟ ଲେମପିରା");
    result.put("HRK","କ୍ରୋଏସୀୟ କୁନା");
    result.put("HTG","ହାଇତୀୟ ଗୋରଡ୍");
    result.put("HUF","ହଙ୍ଗେରିୟ ଫୋରିଣ୍ଟ୍");
    result.put("IDR","ଇଣ୍ଡୋନେସିୟ ରୁପିଆ");
    result.put("ILS","ଇସ୍ରାଇଲି ନ୍ୟୁ ଶେକେଲ୍");
    result.put("INR","ଭାରତୀୟ ଟଙ୍କା");
    result.put("IQD","ଇରାକି ଦିନାର୍");
    result.put("IRR","ଇରାନୀ ରିଆଲ୍");
    result.put("ISK","ଆଇସଲ୍ୟାଣ୍ଡିକ୍‍ କ୍ରୋନା");
    result.put("JMD","ଜାମାଇକୀୟ ଡଲାର୍");
    result.put("JOD","ଜର୍ଡାନିୟ ଦିନାର୍");
    result.put("JPY","ଜାପାନୀ ୟେନ୍");
    result.put("KES","କେନିୟ ଶିଲିଂ");
    result.put("KGS","କିର୍ଗିସ୍ତାନୀ ସୋମ୍");
    result.put("KHR","କାମ୍ଵୋଡିୟ ରିଏଲ୍");
    result.put("KMF","କୋମୋରୀୟ ଫ୍ରାଙ୍କ୍");
    result.put("KPW","ଉତ୍ତର କୋରିଆଇ ୱୋନ୍");
    result.put("KRW","ଦକ୍ଷିଣ କୋରିଆଇ ୱୋନ୍");
    result.put("KWD","କୁୱେତି ଦିନାର୍");
    result.put("KYD","କେମେନ୍ ଦ୍ଵୀପପୁଞ୍ଜ ଡଲାର୍");
    result.put("KZT","କାଜାକସ୍ତାନୀ ତେଙ୍ଗେ");
    result.put("LAK","ଲାଓଟିୟ କିପ୍");
    result.put("LBP","ଲେବାନିଜ୍ ପାଉଣ୍ଡ୍");
    result.put("LKR","ଶ୍ରୀଲଙ୍କିୟ ରୁପି");
    result.put("LRD","ଲିବେରୀୟ ଡଲାର୍");
    result.put("LYD","ଲିବ୍ୟ ଦିନାର୍");
    result.put("MAD","ମୋରୋକୀୟ ଦିର୍ହାମ୍");
    result.put("MDL","ମୋଲଡୋଭାନ୍ ଲେୟୁ");
    result.put("MGA","ମାଲାଗାସି ଏରିଆରୀ");
    result.put("MKD","ମାସେଡୋନୀୟ ଡିନର୍");
    result.put("MMK","ମ୍ୟାନମାର୍ କ୍ୟାତ୍‌");
    result.put("MNT","ମଙ୍ଗୋଲିୟ ତୁଗ୍ରିକ୍");
    result.put("MOP","ମାକାନେଜ୍ ପାଟାକା");
    result.put("MRO","ମର୍ଟିନିୟ ଆଗୁଇଅ (1973–2017)");
    result.put("MRU","ମର୍ଟିନିୟ ଆଗୁଇଅ");
    result.put("MUR","ମୌରିସୀୟ ରୁପି");
    result.put("MVR","ମାଲଡିଭିୟ ରୁଫିୟା");
    result.put("MWK","ମଲାୱି କ୍ୱାଚା");
    result.put("MXN","ମେକ୍ସିକୀୟ ପେସୋ");
    result.put("MYR","ମାଲେସିୟ ରିଙ୍ଗିଟ୍");
    result.put("MZN","ମୋଜାମ୍ବିକୀୟ ମେଟିକାଲ୍");
    result.put("NAD","ନାମିବିୟ ଡଲାର୍");
    result.put("NGN","ନାଇଜେରିଆଇ ନାଇରା");
    result.put("NIO","ନିକାରାଗୁଆ କୋର୍ଡୋବା");
    result.put("NOK","ନରୱେୟୀୟ କ୍ରୋନ୍");
    result.put("NPR","ନେପାଳି ରୁପି");
    result.put("NZD","ନ୍ୟୁଜିଲ୍ୟାଣ୍ଡ୍ ଡଲାର୍");
    result.put("OMR","ଓମାନି ରିଆଲ୍");
    result.put("PAB","ପାନାମାନିୟ ବାଲବୋଆ");
    result.put("PEN","ପେରୁଭୀୟ ସୋଲ୍");
    result.put("PGK","ପପୁଆ ନ୍ୟୁ ଗୁଇନିୟ କିନା");
    result.put("PHP","ଫିଲିପିନି ପେସୋ");
    result.put("PKR","ପାକିସ୍ତାନୀ ରୁପି");
    result.put("PLN","ପୋଲିଶ୍ ଜ୍ଲଟୀ");
    result.put("PYG","ପାରାଗୁଆୟାନ୍ ଗୁଆରାନି");
    result.put("QAR","କ୍ଵାତାରି ରିଆଲ୍");
    result.put("RON","ରୋମାନିୟ ଲେଉ");
    result.put("RSD","ସର୍ବିଆଇ ଦିନାର");
    result.put("RUB","ରୁଷି ରୁବଲ୍");
    result.put("RWF","ରୁୱାଣ୍ଡା ଫ୍ରାଙ୍କ୍");
    result.put("SAR","ସୌଦି ରିୟାଲ୍");
    result.put("SBD","ସୋଲୋମୋନ୍ ଦ୍ଵୀପପୁଞ୍ଜ ଡଲାର୍");
    result.put("SCR","ସେୟଚେଲୋଇସ୍ ରୁପି");
    result.put("SDG","ସୁଦାନୀଜ ପାଉଣ୍ଡ୍");
    result.put("SEK","ସ୍ୱେଡିଶ୍ କ୍ରୋନା");
    result.put("SGD","ସିଙ୍ଗାପୁର୍ ଡଲାର୍");
    result.put("SHP","ସେଣ୍ଟ୍. ହେଲେନା ପାଉଣ୍ଡ୍");
    result.put("SLL","ସିଏରା ଲିଓନୀୟ ଲେଓନ୍");
    result.put("SOS","ସୋମାଲି ସିଲିଂ");
    result.put("SRD","ସୁରିନାମିଜ୍ ଡଲାର୍");
    result.put("SSP","ଦକ୍ଷିଣ ସୁଡାନିଜ୍‍ ପାଉଣ୍ଡ୍");
    result.put("STD","ସାଓ ତୋମେ & ପ୍ରିସିପ୍ ଡୋବ୍ରା (1977–2017)");
    result.put("STN","ସାଓ ତୋମେ & ପ୍ରିସିପ୍ ଡୋବ୍ରା");
    result.put("SYP","ସିରିୟ ପାଉଣ୍ଡ୍");
    result.put("SZL","ସ୍ଵାଜି ଲିଲାଞ୍ଜେନି");
    result.put("THB","ଥାଇ ଭାଟ୍");
    result.put("TJS","ତାଜିକିସ୍ତାନୀ ସୋମୋନି");
    result.put("TMT","ତୁର୍କମେନିସ୍ତାନୀ ମନତ୍‌");
    result.put("TND","ଟୁନେସିଆଇ ଦିନାର୍");
    result.put("TOP","ତୋଙ୍ଗିୟ ପାଙ୍ଗା");
    result.put("TRY","ତୁର୍କିୟ ଲିରା");
    result.put("TTD","ତ୍ରିନିଦାଦ୍ ଏବଂ ଟୋବାଗୋ ଡଲାର୍");
    result.put("TWD","ନ୍ୟୁ ତାଇୱାନ୍ ଡଲାର୍");
    result.put("TZS","ତାନଜାନୀୟ ଶିଲିଂ");
    result.put("UAH","ୟୁକ୍ରେନୀୟ ହ୍ରାଇଭନିଆ");
    result.put("UGX","ଉଗାଣ୍ଡିୟ ଶିଲିଂ");
    result.put("USD","ଯୁକ୍ତରାଷ୍ଟ୍ର ଡଲାର୍");
    result.put("UYU","ଉରୁଗୁଇୟାନ୍ ପେସୋ");
    result.put("UZS","ଉଜବେକିସ୍ତାନୀ ସୋମ୍");
    result.put("VEF","ଭେନେଜୁଏଲାନ୍ ବୋଲିଭାର୍ (2008–2018)");
    result.put("VES","ଭେନେଜୁଏଲାନ୍ ବୋଲିଭାର୍");
    result.put("VND","ଭୀଏତନାମୀୟ ଡଙ୍ଗ");
    result.put("VUV","ଭାନୁଆଟୁ ଭାଟୁ");
    result.put("WST","ସାମୋୟିୟ ତାଲା");
    result.put("XAF","ମଧ୍ୟ ଆଫ୍ରିକୀ CFA ଫ୍ରାଙ୍କ୍");
    result.put("XCD","ପୂର୍ବ କାରିବୀୟ ଡଲାର୍");
    result.put("XOF","ପଶ୍ଚିମ ଆଫ୍ରିକିୟ CFA ଫ୍ରାଙ୍କ୍");
    result.put("XPF","CFP ଫ୍ରାଙ୍କ୍");
    result.put("XXX","ଅଜଣା ମୁଦ୍ରା");
    result.put("YER","ୟେମେନି ରିଆଲ୍");
    result.put("ZAR","ଦକ୍ଷିଣ ଆଫ୍ରିକିୟ ରାଣ୍ଡ୍");
    result.put("ZMW","ଜାମ୍ବୀୟ କ୍ୱାଚା");
    return result;
  }
}
