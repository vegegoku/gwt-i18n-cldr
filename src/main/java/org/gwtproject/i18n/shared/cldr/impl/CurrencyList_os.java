...
public class CurrencyList_os extends CurrencyList_ {
  public CurrencyData getDefault() {
    return new CurrencyDataImpl("RUB","RUB",2,"RUB","RUB");
  }
  ...
  protected HashMap<String, String> loadNamesMap() {
    ...
    result.put("BRL","Бразилиаг реал");
    result.put("EUR","Евро");
    result.put("GBP","Бритайнаг Фунт");
    result.put("GEL","Лар");
    result.put("RUB","Сом");
    result.put("USD","АИШ-ы Доллар");
    result.put("XXX","Нӕзонгӕ валютӕ");
    return result;
  }
}
