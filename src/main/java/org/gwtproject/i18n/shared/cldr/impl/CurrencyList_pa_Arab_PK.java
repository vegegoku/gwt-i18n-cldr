...
public class CurrencyList_pa_Arab_PK extends CurrencyList_pa_Arab {
  public CurrencyData getDefault() {
    return new CurrencyDataImpl("PKR","ر",2,"ر","ر");
  }
  ...
  protected HashMap<String, CurrencyData> loadCurrencyMap() {
    ...
    // روپئیہ
    result.put("PKR", new CurrencyDataImpl("PKR","ر",2,"ر","ر"));
    // PLN
