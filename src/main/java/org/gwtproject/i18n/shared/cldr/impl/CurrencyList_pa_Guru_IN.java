...
public class CurrencyList_pa_Guru_IN extends CurrencyList_pa_Guru {
  ...
  protected HashMap<String, String> loadNamesMap() {
    ...
    result.put("AMD","ਅਰਮੀਨੀਆਈ ਦਰਮ");
    result.put("ANG","ਨੀਦਰਲੈਂਡਸ ਐਂਟੀਲੀਅਨ ਗਿਲਡਰ");
    result.put("AOA","ਅੰਗੋਲਾ ਕਵਾਂਜਾ");
    result.put("ARA","ਅਰਜਨਟੀਨੀ ਅਸਟਰਾਲ");
    result.put("ARL","ਅਰਜਨਟੀਨੀ ਪੇਸੋ ਲੇ (1970–1983)");
    result.put("ARM","ਅਰਜਨਟੀਨੀ ਪੇਸੋ (1881–1970)");
    result.put("ARP","ਅਰਜਨਟੀਨੀ ਪੇਸੋ (1983–1985)");
    result.put("ARS","ਅਰਜਨਟੀਨੀ ਪੇਸੋ");
    result.put("AUD","ਆਸਟ੍ਰੇਲੀਆਈ ਡਾਲਰ");
    result.put("AWG","ਅਰੂਬਨ ਫਲੋਰਿਨ");
    result.put("AZN","ਅਜ਼ਰਬਾਈਜਾਨ ਮਾਨਤ");
    result.put("BAM","ਬੋਸਨੀਆ-ਹਰਜ਼ੇਗੋਵੀਨਾ ਬਦਲਣਯੋਗ ਮਾਰਕ");
    result.put("BBD","ਬਾਰਬਾਡੀਅਨ ਡਾਲਰ");
    result.put("BDT","ਬੰਗਲਾਦੇਸ਼ੀ ਟਕਾ");
    result.put("BGN","ਬੁਲਗਾਰੀਆਈ ਲੇਵ");
    result.put("BHD","ਬਹਿਰੀਨੀ ਦਿਨਾਰ");
    result.put("BIF","ਬੁਰੁੰਡੀਆਈ ਫ੍ਰੈਂਕ");
    result.put("BMD","ਬਰਮੂਡਾ ਡਾਲਰ");
    result.put("BND","ਬਰੂਨੇਈ ਡਾਲਰ");
    result.put("BOB","ਬੋਲੀਵੀਅਨ ਬੋਲੀਵੀਅਨੋ");
    result.put("BOL","ਬੋਲੀਵੀਆਈ ਬੋਲੀਵੀਅਨੋ (1863–1963)");
    result.put("BOP","ਬੋਲੀਵੀਆਈ ਪੇਸੋ");
    result.put("BOV","ਬੋਲੀਵੀਆਈ ਮਵਡੋਲ");
    result.put("BRB","ਬ੍ਰਾਜ਼ੀਲੀਆਈ ਨਿਊ ਕਰੁਜ਼ਿਰੋਸ (1967–1986)");
    result.put("BRC","ਬ੍ਰਾਜ਼ੀਲੀਆਈ ਕਰੁਜ਼ਾਡੂ (1986–1989)");
    result.put("BRE","ਬ੍ਰਾਜ਼ੀਲੀਆਈ ਕਰੁਜ਼ਿਰੋਸ (1990–1993)");
    result.put("BRL","ਬ੍ਰਾਜ਼ੀਲੀਆਈ ਰੀਅਲ");
    result.put("BRN","ਬ੍ਰਾਜ਼ੀਲੀਆਈ ਨਿਊ ਕਰੁਜ਼ਾਡੂ (1989–1990)");
    result.put("BRR","ਬ੍ਰਾਜ਼ੀਲੀਆਈ ਕਰੁਜ਼ਿਰੋਸ (1993–1994)");
    result.put("BRZ","ਬ੍ਰਾਜ਼ੀਲੀਆਈ ਕਰੁਜ਼ਿਰੋਸ (1942–1967)");
    result.put("BSD","ਬਾਹਾਮੀਅਨ ਡਾਲਰ");
    result.put("BTN","ਭੂਟਾਨੀ ਐਂਗਲਟ੍ਰਮ");
    result.put("BWP","ਬੋਟਸਵਾਨਾ ਪੁਲਾ");
    result.put("BYN","ਬੇਲਾਰੂਸੀ ਰੂਬਲ");
    result.put("BYR","ਬੇਲਾਰੂਸੀ ਰੂਬਲ (2000–2016)");
    result.put("BZD","ਬੇਲੀਜ਼ ਡਾਲਰ");
    result.put("CAD","ਕੇਨੇਡਿਆਈ ਡਾਲਰ");
    result.put("CDF","ਕਾਂਗੋਲੀਜ਼ ਫ੍ਰੈਂਕ");
    result.put("CHF","ਸਵਿਸ ਫ੍ਰੈਂਕ");
    result.put("CLP","ਚਿਲੀ ਪੇਸੋ");
    result.put("CNH","ਚੀਨੀ ਯੁਆਨ (ਔਫ਼ਸ਼ੋਰ)");
    result.put("CNY","ਚੀਨੀ ਯੁਆਨ");
    result.put("COP","ਕੋਲੰਬਿਆਈ ਪੇਸੋ");
    result.put("CRC","ਕੋਸਟਾ ਰੀਕਨ ਕੋਲਨ");
    result.put("CUC","ਕਿਊਬਨ ਬਦਲਣਯੋਗ ਪੇਸੋ");
    result.put("CUP","ਕਿਊਬਨ ਪੇਸੋ");
    result.put("CVE","ਕੇਪ ਵਰਡੀਅਨ ਸਕੂਡੋ");
    result.put("CZK","ਚੈਕ ਗਣਰਾਜ ਕੋਰੁਨਾ");
    result.put("DEM","ਜਰਮਨ ਮਾਰਕ");
    result.put("DJF","ਜ਼ੀਬੂਤੀਅਨ ਫ੍ਰੈਂਕ");
    result.put("DKK","ਡੈਨਿਸ਼ ਕਰੌਨ");
    result.put("DOP","ਡੌਮਿਨਿਕਨ ਪੇਸੋ");
    result.put("DZD","ਅਲਜੀਰਿਆਈ ਦਿਨਾਰ");
    result.put("EGP","ਮਿਸਰੀ ਪੌਂਡ");
    result.put("ERN","ਇਰੀਟ੍ਰਿਆਈ ਨਾਫ਼ਾ");
    result.put("ETB","ਇਥੋਪੀਆਈ ਬਿਰ");
    result.put("EUR","ਯੂਰੋ");
    result.put("FJD","ਫ਼ਿਜ਼ੀ ਡਾਲਰ");
    result.put("FKP","ਫ਼ਾਕਲੈਂਡ ਆਈਲੈਂਡਸ ਪੌਂਡ");
    result.put("GBP","ਬ੍ਰਿਟਿਸ਼ ਪੌਂਡ");
    result.put("GEL","ਜਾਰਜੀਆਈ ਲਾਰੀ");
    result.put("GHS","ਘਾਨਾਈ ਸੇਡੀ");
    result.put("GIP","ਜਿਬਰਾਲਟਰ ਪੌਂਡ");
    result.put("GMD","ਗੈਂਬੀਆਈ ਦਲਾਸੀ");
    result.put("GNF","ਗਿਨੀ ਫ੍ਰੈਂਕ");
    result.put("GTQ","ਗੁਆਟੇਮਾਲਾ ਕੁਏਟਜ਼ਲ");
    result.put("GYD","ਗੁਆਨਾਆਈ ਡਾਲਰ");
    result.put("HKD","ਹਾਂਗ ਕਾਂਗ ਡਾਲਰ");
    result.put("HNL","ਹਾਨਡੂਰਨ ਲੇਮਪਿਰਾ");
    result.put("HRK","ਕਰੋਏਸ਼ੀਆਈ ਕੁਨਾ");
    result.put("HTG","ਹੈਤੀ ਗੌਰਡੇ");
    result.put("HUF","ਹੰਗਰੀ ਫੋਰਿੰਟ");
    result.put("IDR","ਇੰਡੋਨੇਸ਼ੀਆਈ ਰੁਪਿਆਹ");
    result.put("IEP","ਆਇਰਿਸ਼ ਪੌਂਡ");
    result.put("ILP","ਇਜ਼ਰਾਈਲੀ ਪੌਂਡ");
    result.put("ILS","ਇਜ਼ਰਾਈਲੀ ਨਵੀਂ ਸ਼ੇਕੇਲ");
    result.put("INR","ਭਾਰਤੀ ਰੁਪਇਆ");
    result.put("IQD","ਇਰਾਕੀ ਦਿਨਾਰ");
    result.put("IRR","ਈਰਾਨੀ ਰਿਆਲ");
    result.put("ISK","ਆਈਸਲੈਂਡਿਕ ਕਰੌਨ");
    result.put("JMD","ਜਮਾਇਕਨ ਡਾਲਰ");
    result.put("JOD","ਜਾਰਡਨ ਦਿਨਾਰ");
    result.put("JPY","ਜਪਾਨੀ ਯੇਨ");
    result.put("KES","ਕੀਨੀਆਈ ਸ਼ਿਲਿੰਗ");
    result.put("KGS","ਕਿਰਗਿਸਤਾਨੀ ਸੋਮ");
    result.put("KHR","ਕੰਬੋਡੀਆਈ ਰੀਅਲ");
    result.put("KMF","ਕੋਮੋਰੀਅਨ ਫ੍ਰੈਂਕ");
    result.put("KPW","ਉੱਤਰੀ ਕੋਰੀਆਈ ਵੋਨ");
    result.put("KRW","ਦੱਖਣੀ ਕੋਰੀਆਈ ਵੋਨ");
    result.put("KWD","ਕੁਵੈਤੀ ਦਿਨਾਰ");
    result.put("KYD","ਕੇਮੈਨ ਆਈਲੈਂਡਸ ਡਾਲਰ");
    result.put("KZT","ਕਜ਼ਾਖਸਤਾਨੀ ਤੇਂਗੇ");
    result.put("LAK","ਲਾਓਟਿਆਈ ਕਿਪ");
    result.put("LBP","ਲੈਬਨਾਨੀ ਪੌਂਡ");
    result.put("LKR","ਸ੍ਰੀਲੰਕਾਈ ਰੁਪਇਆ");
    result.put("LRD","ਲਾਈਬੀਰੀਆਈ ਡਾਲਰ");
    result.put("LTL","ਲਿਥੁਆਨੀਆਈ ਲਿਤਾਸ");
    result.put("LVL","ਲਾਟਵਿਆਈ ਲਾਟਸ");
    result.put("LYD","ਲੀਬੀਅਨ ਦਿਨਾਰ");
    result.put("MAD","ਮੋਰੱਕਨ ਦਿਰਹਾਮ");
    result.put("MDL","ਮੋਲਡੋਵਨ ਲੇਉ");
    result.put("MGA","ਮਾਲਾਗਾਸੀ ਅਰਾਇਰੀ");
    result.put("MKD","ਮੈਕਡੋਨੀਆਈ ਡੇਨਾਰ");
    result.put("MMK","ਮਿਆਂਮਾਰ ਕਿਆਤ");
    result.put("MNT","ਮੰਗੋਲੀਆਈ ਤੁਗਰਿਕ");
    result.put("MOP","ਮੇਕਾਨੀ ਪਟਾਕਾ");
    result.put("MRO","ਮੋਰਿਟਾਨੀਆਈ ਊਗੀਆ (1973–2017)");
    result.put("MRU","ਮੋਰਿਟਾਨੀਆਈ ਊਗੀਆ");
    result.put("MUR","ਮੌਰਿਸ਼ੀਆਈ ਰੁਪਇਆ");
    result.put("MVR","ਮਾਲਦੀਵੀ ਰੁਫੀਆ");
    result.put("MWK","ਮਾਲਾਵੀਆਈ ਕਵਾਚਾ");
    result.put("MXN","ਮੈਕਸੀਕਨ ਪੇਸੋ");
    result.put("MYR","ਮਲੇਸ਼ੀਆਈ ਰਿੰਗਿਟ");
    result.put("MZN","ਮੋਜ਼ਾਮਬੀਕਨ ਮੈਟੀਕਲ");
    result.put("NAD","ਨਾਮੀਬੀਆਈ ਡਾਲਰ");
    result.put("NGN","ਨਾਇਜੀਰੀਆਈ ਨਾਇਰਾ");
    result.put("NIO","ਨਿਕਾਰਾਗੁਆਈ ਕੋਰਡੋਬਾ");
    result.put("NOK","ਨਾਰਵੇਜੀਆਈ ਕਰੌਨ");
    result.put("NPR","ਨੇਪਾਲੀ ਰੁਪਇਆ");
    result.put("NZD","ਨਿਊਜ਼ੀਲੈਂਡ ਡਾਲਰ");
    result.put("OMR","ਓਮਾਨੀ ਰਿਆਲ");
    result.put("PAB","ਪਨਾਮੇਨੀਅਨ ਬਾਲਬੋਆ");
    result.put("PEN","ਪੇਰੂਵੀਅਨ ਸੋਲ");
    result.put("PGK","ਪਾਪੂਆ ਨਿਊ ਗਿਨੀਆਈ ਕੀਨਾ");
    result.put("PHP","ਫਿਲਿਪੀਨੀ ਪੇਸੋ");
    result.put("PKR","ਪਾਕਿਸਤਾਨੀ ਰੁਪਇਆ");
    result.put("PLN","ਪੋਲੈਂਡੀ ਜ਼ਲੌਟੀ");
    result.put("PYG","ਪੈਰਾਗੁਵਾਇਨ ਗੁਆਰਾਨੀ");
    result.put("QAR","ਕਤਰੀ ਰਿਆਲ");
    result.put("RON","ਰੋਮਾਨੀਆਈ ਲੇਉ");
    result.put("RSD","ਸਰਬੀਆਈ ਦਿਨਾਰ");
    result.put("RUB","ਰੂਸੀ ਰੂਬਲ");
    result.put("RWF","ਰਵਾਂਡਨ ਫ੍ਰੈਂਕ");
    result.put("SAR","ਸਾਊਦੀ ਰਿਆਲ");
    result.put("SBD","ਸੋਲੋਮਨ ਆਈਲੈਂਡਸ ਡਾਲਰ");
    result.put("SCR","ਸੇਸ਼ਲਸ ਰੁਪਇਆ");
    result.put("SDG","ਸੂਡਾਨੀ ਪੌਂਡ");
    result.put("SEK","ਸਵੀਡਿਸ਼ ਕਰੋਨਾ");
    result.put("SGD","ਸਿੰਗਾਪੁਰ ਡਾਲਰ");
    result.put("SHP","ਸੇਂਟ ਹੇਲੇਨਾ ਪੌਂਡ");
    result.put("SLL","ਸਿਏਰਾ ਲਿਓਨੀਅਨ ਲਿਓਨ");
    result.put("SOS","ਸੋਮਾਲੀ ਸ਼ਿਲਿੰਗ");
    result.put("SRD","ਸੂਰੀਨਾਮੀ ਡਾਲਰ");
    result.put("SSP","ਦੱਖਣੀ ਸੂਡਾਨੀ ਪੌਂਡ");
    result.put("STD","ਸਾਉ ਟੋਮੀ ਐਂਡ ਪ੍ਰਿੰਸਪੀ ਡੋਬਰਾ (1977–2017)");
    result.put("STN","ਸਾਉ ਟੋਮੀ ਐਂਡ ਪ੍ਰਿੰਸਪੀ ਡੋਬਰਾ");
    result.put("SUR","ਸੋਵੀਅਤ ਰੂਬਲ");
    result.put("SYP","ਸੀਰੀਆਈ ਪੌਂਡ");
    result.put("SZL","ਸਵਾਜ਼ੀ ਲਾਇਲੈਂਗਨੀ");
    result.put("THB","ਥਾਈ ਬਾਹਤ");
    result.put("TJS","ਤਾਜਿਕਿਸਤਾਨੀ ਸੋਮੋਨੀ");
    result.put("TMT","ਤੁਰਕਮੇਨਿਸਤਾਨੀ ਮਾਨਤ");
    result.put("TND","ਟਿਉਨੀਸ਼ੀਆਈ ਦਿਨਾਰ");
    result.put("TOP","ਟੌਂਗਨ ਪੈਂਗਾ");
    result.put("TRY","ਤੁਰਕੀ ਲੀਰਾ");
    result.put("TTD","ਟ੍ਰਿਨੀਡਾਡ ਅਤੇ ਟੋਬਾਗੋ ਡਾਲਰ");
    result.put("TWD","ਨਵਾਂ ਤਾਇਵਾਨ ਡਾਲਰ");
    result.put("TZS","ਤਨਜ਼ਾਨੀਆਈ ਸ਼ਿਲਿੰਗ");
    result.put("UAH","ਯੂਕਰੇਨੀਆਈ ਰਿਵਨਿਆ");
    result.put("UGX","ਯੂਗਾਂਡੀਆਈ ਸ਼ਿਲਿੰਗ");
    result.put("USD","ਯੂ.ਐਸ. ਡਾਲਰ");
    result.put("UYP","ਉਰੂਗੁਵਾਇਨ ਪੇਸੋ (1975–1993)");
    result.put("UYU","ਉਰੂਗੁਵਾਇਨ ਪੇਸੋ");
    result.put("UZS","ਉਜ਼ਬੇਕਿਸਤਾਨ ਸੋਮ");
    result.put("VEB","ਵੇਨੇਜ਼ੂਏਲਨ ਬੋਲੀਵਰ (1871–2008)");
    result.put("VEF","ਵੇਨੇਜ਼ੂਏਲਨ ਬੋਲੀਵਰ (2008–2018)");
    result.put("VES","ਵੇਨੇਜ਼ੂਏਲਨ ਬੋਲੀਵਰ");
    result.put("VND","ਵੀਅਤਨਾਮੀ ਡੋਂਗ");
    result.put("VNN","ਵੀਅਤਨਾਮੀ ਡੋਂਗ (1978–1985)");
    result.put("VUV","ਵਾਨੂਆਟੂ ਵਾਟੂ");
    result.put("WST","ਸਾਮੋਆਈ ਤਾਲਾ");
    result.put("XAF","ਕੇਂਦਰੀ ਅਫ਼ਰੀਕੀ [CFA] ਫ੍ਰੈਂਕ");
    result.put("XAG","ਚਾਂਦੀ");
    result.put("XAU","ਸੋਨਾ");
    result.put("XBB","ਯੂਰਪੀ ਵਿੱਤੀ ਇਕਾਈ");
    result.put("XCD","ਪੂਰਬੀ ਕੈਰੇਬੀਅਨ ਡਾਲਰ");
    result.put("XEU","ਯੂਰਪੀ ਮੁਦਰਾ ਇਕਾਈ");
    result.put("XOF","ਪੱਛਮੀ ਅਫ਼ਰੀਕੀ (CFA) ਫ੍ਰੈਂਕ");
    result.put("XPF","ਫ੍ਰੈਂਕ (CFP)");
    result.put("XXX","ਅਗਿਆਤ ਮੁਦਰਾ");
    result.put("YER","ਯਮਨੀ ਰਿਆਲ");
    result.put("ZAR","ਦੱਖਣੀ ਅਫਰੀਕੀ ਰੈਂਡ");
    result.put("ZMW","ਜ਼ਾਮਬੀਆਈ ਕਵਾਚਾ");
    return result;
  }
}
