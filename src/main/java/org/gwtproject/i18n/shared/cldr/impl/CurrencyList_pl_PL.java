...
public class CurrencyList_pl_PL extends CurrencyList_pl {
  ...
  protected HashMap<String, String> loadNamesMap() {
    ...
    result.put("ANG","gulden antylski");
    ...
    result.put("BGM","lew bułgarski socjalistyczny");
    result.put("BGN","lew bułgarski");
    result.put("BGO","lew bułgarski (1879–1952)");
    ...
    result.put("BTN","ngultrum bhutański");
    result.put("BUK","kyat birmański");
    result.put("BWP","pula botswańska");
    result.put("BYB","rubel białoruski (1994–1999)");
    result.put("BYN","rubel białoruski");
    result.put("BYR","rubel białoruski (2000–2016)");
    ...
    result.put("CNH","juan chiński (rynek zewnętrzny)");
    result.put("CNY","juan chiński");
    ...
    result.put("CVE","escudo zielonoprzylądkowe");
    ...
    result.put("DJF","frank dżibutyjski");
    ...
    result.put("FJD","dolar fidżyjski");
    result.put("FKP","funt falklandzki");
    ...
    result.put("HNL","lempira honduraska");
    ...
    result.put("MGA","ariary malgaski");
    result.put("MGF","frank malgaski");
    result.put("MKD","denar macedoński");
    result.put("MLF","frank malijski");
    result.put("MMK","kiat birmański");
    result.put("MNT","tugrik mongolski");
    result.put("MOP","pataca Makau");
    result.put("MRO","ouguiya mauretańska (1973–2017)");
    result.put("MRU","ouguiya mauretańska");
    result.put("MTL","lira maltańska");
    result.put("MTP","funt maltański");
    result.put("MUR","rupia maurytyjska");
    result.put("MVR","rupia malediwska");
    result.put("MWK","kwacha malawijska");
    ...
    result.put("OMR","rial omański");
    result.put("PAB","balboa panamski");
    result.put("PEI","inti peruwiański");
    result.put("PEN","sol peruwiański");
    result.put("PES","sol peruwiański (1863–1965)");
    ...
    result.put("SDP","funt sudański (1957–1998)");
    ...
    result.put("SLL","leone sierraleoński");
    result.put("SOS","szyling somalijski");
    result.put("SRD","dolar surinamski");
    result.put("SRG","gulden surinamski");
    result.put("SSP","funt południowosudański");
    result.put("STD","dobra Wysp Świętego Tomasza i Książęcej (1977–2017)");
    result.put("STN","dobra Wysp Świętego Tomasza i Książęcej");
    ...
    result.put("TMM","manat turkmeński (1993–2009)");
    result.put("TMT","manat turkmeński");
    result.put("TND","dinar tunezyjski");
    result.put("TOP","pa’anga tongijska");
    result.put("TPE","escudo timorskie");
    result.put("TRL","lira turecka (1922–2005)");
    result.put("TRY","lira turecka");
    ...
    result.put("VEF","boliwar wenezuelski (2008–2018)");
    result.put("VES","boliwar wenezuelski");
    result.put("VND","dong wietnamski");
    result.put("VUV","vatu wanuackie");
    result.put("WST","tala samoańskie");
    ...
    result.put("XXX","nieznana waluta");
    ...
    result.put("ZMK","kwacha zambijska (1968–2012)");
    result.put("ZMW","kwacha zambijska");
