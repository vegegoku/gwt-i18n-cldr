...
public class CurrencyList_prg_001 extends CurrencyList_prg {
  ...
  protected HashMap<String, String> loadNamesMap() {
    ...
    result.put("EUR","eurō");
    result.put("GBP","punds sterlings");
    result.put("INR","Īndijas rūpija");
    result.put("JPY","Japānijas jāns");
    result.put("RUB","Russis rūbels");
    result.put("USD","APW dālars");
    result.put("XXX","niwaistā walūta");
    return result;
  }
}
