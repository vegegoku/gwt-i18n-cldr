...
public class CurrencyList_ps extends CurrencyList_ {
  public CurrencyData getDefault() {
    return new CurrencyDataImpl("PKR","PKR",2,"PKR","PKR");
  }
  ...
  protected HashMap<String, String> loadNamesMap() {
    ...
    result.put("AFA","افغانۍ (1927–2002)");
    result.put("AFN","افغانۍ");
    result.put("NPR","نيپالي روپيه");
    result.put("PKR","پاکستانۍ کلداره");
    result.put("VEF","VEF (2008–2018)");
    result.put("XXX","نامعلومه مروجه پېسې");
    return result;
  }
}
