...
public class CurrencyList_pt_MZ extends CurrencyList_pt {
  public CurrencyData getDefault() {
    return new CurrencyDataImpl("MZN","MTn",2,"MTn","MTn");
  }
  ...
  protected HashMap<String, CurrencyData> loadCurrencyMap() {
    ...
    // metical moçambicano
    result.put("MZN", new CurrencyDataImpl("MZN","MTn",2,"MTn","MTn"));
    // Dólar da Namíbia
    ...
    // Escudo português
    result.put("PTE", new CurrencyDataImpl("PTE","​",130,"​","​"));
    // guarani paraguaio
  ...
  protected HashMap<String, String> loadNamesMap() {
    ...
    result.put("AFN","Afegani do Afeganistão");
    result.put("ALK","Lek Albanês (1946–1965)");
    result.put("ALL","lek albanês");
    result.put("AMD","Dram arménio");
    ...
    result.put("BZD","dólar belizense");
    ...
    result.put("DJF","franco jibutiano");
    ...
    result.put("FKP","libra das Ilhas Falkland");
    ...
    result.put("KGS","Som do Quirguistão");
    ...
    result.put("LTL","Litas da Lituânia");
    ...
    result.put("LVL","Lats da Letónia");
    ...
    result.put("MNT","Tugrik da Mongólia");
    ...
    result.put("MVR","Rupia das Ilhas Maldivas");
    result.put("MWK","kwacha malauiano");
    ...
    result.put("NIC","Córdoba nicaraguano (1988–1991)");
    result.put("NIO","córdoba nicaraguano");
    ...
    result.put("PAB","balboa do Panamá");
    ...
    result.put("SHP","libra santa-helenense");
    ...
    result.put("TJS","Somoni do Tajaquistão");
    result.put("TMM","Manat do Turcomenistão (1993–2009)");
    result.put("TMT","Manat do Turquemenistão");
    result.put("TND","dinar tunisino");
    ...
    result.put("TTD","Dólar de Trindade e Tobago");
    ...
    result.put("UZS","Som do Uzbequistão");
    result.put("VEB","Bolívar venezuelano (1871–2008)");
    result.put("VEF","bolívar (2008–2018)");
    result.put("VES","bolívar");
    ...
    result.put("XCD","Dólar das Caraíbas Orientais");
