...
public class CurrencyList_rm_CH extends CurrencyList_rm {
  ...
  protected HashMap<String, String> loadNamesMap() {
    ...
    result.put("BYN","rubel bieloruss");
    result.put("BYR","rubel bieloruss (2000–2016)");
    ...
    result.put("MRO","ouguiya da la Mauretania (1973–2017)");
    result.put("MRU","ouguiya da la Mauretania");
    ...
    result.put("PEN","sol peruan");
    result.put("PES","sol peruan (1863–1965)");
    ...
    result.put("STD","dobra da São Tomé e Principe (1977–2017)");
    result.put("STN","dobra da São Tomé e Principe");
    ...
    result.put("VEB","bolivar venezuelan (1871–2008)");
    ...
    result.put("XEU","unitad monetara europeica");
    ...
    result.put("ZMK","kwacha da la sambia (1968–2012)");
    result.put("ZMW","kwacha da la sambia");
