...
public class CurrencyList_rn_BI extends CurrencyList_rn {
  ...
  protected HashMap<String, String> loadNamesMap() {
    ...
    result.put("BHD","Idinari ry’iribahireyini");
    result.put("BIF","Ifaranga ry’Uburundi");
    result.put("BWP","Ipula ryo muri Botswana");
    result.put("CAD","Idolari rya Kanada");
    result.put("CDF","Ifaranga rya Kongo");
    result.put("CHF","Ifaranga ry’Ubusuwisi");
    result.put("CNY","Iyuwani ryo mu Bushinwa");
    result.put("CVE","Irikaboveridiyano ryo muri Esikudo");
    result.put("DJF","Ifaranga ryo muri Jibuti");
    result.put("DZD","Idinari ryo muri Alijeriya");
    result.put("EGP","Ipawundi rya Misiri");
    result.put("ERN","Irinakufa ryo muri Eritereya");
    result.put("ETB","Ibiri ryo muri Etiyopiya");
    result.put("EUR","Iyero");
    result.put("GBP","Ipawundi ryo mu Bwongereza");
    result.put("GHC","Icedi ryo muri Gana");
    result.put("GMD","Idalasi ryo muri Gambiya");
    result.put("GNS","Ifaranga ryo muri Gineya");
    result.put("INR","Irupiya ryo mu Buhindi");
    result.put("JPY","Iyeni ry’Ubuyapani");
    result.put("KES","Ishilingi rya Kenya");
    result.put("KMF","Ifaranga rya Komore");
    result.put("LRD","Idolari rya Liberiya");
    result.put("LSL","Iloti ryo muro Lesoto");
    result.put("LYD","Idinari rya Libiya");
    result.put("MAD","Idiramu ryo muri Maroke");
    result.put("MGA","Iriyari ryo muri Madagasikari");
    result.put("MRO","Ugwiya ryo muri Moritaniya (1973–2017)");
    result.put("MRU","Ugwiya ryo muri Moritaniya");
    result.put("MUR","Irupiya ryo mu birwa bya Morise");
    result.put("MWK","Ikwaca ryo muri Malawi");
    result.put("MZM","Irimetikali ryo muri Mozambike");
    result.put("NAD","Idolari rya Namibiya");
    result.put("NGN","Inayira ryo muri Nijeriya");
    result.put("RWF","Ifaranga ry’u Rwanda");
    result.put("SAR","Iriyari ryo muri Arabiya Sawudite");
    result.put("SCR","Irupiya ryo mu birwa bya Sayisheli");
    result.put("SDG","Ipawundi rya Sudani");
    result.put("SHP","Ipawundi rya Sente Helena");
    result.put("SLL","Ilewone");
    result.put("SOS","Ishilingi ryo muri Somaliya");
    result.put("STD","Idobura ryo muri Sawotome na Perensipe (1977–2017)");
    result.put("STN","Idobura ryo muri Sawotome na Perensipe");
    result.put("SZL","Ililangeni");
    result.put("TND","Idinari ryo muri Tuniziya");
    result.put("TZS","Ishilingi rya Tanzaniya");
    result.put("UGX","Ishilingi ry’Ubugande");
    result.put("USD","Idolari ry’abanyamerika");
    result.put("ZAR","Irandi ryo muri Afurika y’Epfo");
    result.put("ZMK","Ikwaca ryo muri Zambiya (1968–2012)");
    result.put("ZMW","Ikwaca ryo muri Zambiya");
    result.put("ZWD","Idolari ryo muri Zimbabwe");
    return result;
  }
}
