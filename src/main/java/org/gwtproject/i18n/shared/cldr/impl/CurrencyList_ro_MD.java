...
public class CurrencyList_ro_MD extends CurrencyList_ro {
  public CurrencyData getDefault() {
    return new CurrencyDataImpl("MDL","L",2,"L","L");
  }
  ...
  protected HashMap<String, CurrencyData> loadCurrencyMap() {
    ...
    // leu moldovenesc
    result.put("MDL", new CurrencyDataImpl("MDL","L",2,"L","L"));
    // ariary malgaș
  ...
  protected HashMap<String, String> loadNamesMap() {
    ...
    result.put("AED","dirham din Emiratele Arabe Unite");
    result.put("AFN","afgani afgan");
    result.put("ALL","leka albaneză");
    result.put("AMD","dram armenesc");
    result.put("ANG","gulden din Antilele Olandeze");
    ...
    result.put("AWG","florin aruban");
    result.put("AZM","manat azer (1993–2006)");
    result.put("AZN","manat azer");
    result.put("BAD","dinar Bosnia-Herțegovina (1992–1994)");
    result.put("BAM","marcă convertibilă din Bosnia și Herțegovina");
    result.put("BBD","dolar din Barbados");
    result.put("BDT","taka din Bangladesh");
    result.put("BEC","franc belgian (convertibil)");
    result.put("BEF","franc belgian");
    result.put("BEL","franc belgian (financiar)");
    result.put("BGN","leva bulgărească");
    result.put("BHD","dinar din Bahrain");
    result.put("BIF","franc burundez");
    result.put("BMD","dolar din Bermuda");
    result.put("BND","dolar din Brunei");
    result.put("BOB","boliviano bolivian");
    ...
    result.put("BSD","dolar din Bahamas");
    result.put("BTN","ngultrum din Bhutan");
    result.put("BUK","kyat birman");
    result.put("BWP","pula Botswana");
    result.put("BYN","rublă belarusă");
    result.put("BYR","rublă belarusă (2000–2016)");
    result.put("BZD","dolar din Belize");
    result.put("CAD","dolar canadian");
    result.put("CDF","franc congolez");
    result.put("CHF","franc elvețian");
    result.put("CLP","peso chilian");
    result.put("CNH","yuan chinezesc (offshore)");
    result.put("CNY","yuan chinezesc");
    ...
    result.put("ETB","birr etiopian");
    result.put("EUR","euro");
    result.put("FIM","marcă finlandeză");
    result.put("FJD","dolar fijian");
    result.put("FKP","liră din Insulele Falkland");
    ...
    result.put("GIP","liră din Gibraltar");
    result.put("GMD","dalasi din Gambia");
    ...
    result.put("KYD","dolar din Insulele Cayman");
    result.put("KZT","tenge kazahă");
    result.put("LAK","kip laoțian");
    result.put("LBP","liră libaneză");
    result.put("LKR","rupie srilankeză");
    ...
    result.put("MGA","ariary malgaș");
    result.put("MGF","franc Madagascar");
    result.put("MKD","dinar macedonean");
    result.put("MLF","franc Mali");
    result.put("MMK","kyat din Myanmar");
    result.put("MNT","tugrik mongol");
    result.put("MOP","pataca din Macao");
    result.put("MRO","ouguiya mauritană (1973–2017)");
    result.put("MRU","ouguiya mauritană");
    ...
    result.put("MZN","metical mozambican");
    result.put("NAD","dolar namibian");
    result.put("NGN","naira nigeriană");
    result.put("NIC","cordoba nicaraguană (1988–1991)");
    result.put("NIO","cordoba nicaraguană");
    ...
    result.put("OMR","rial omanez");
    result.put("PAB","balboa panameză");
    result.put("PEI","inti peruvian");
    result.put("PEN","sol peruvian");
    result.put("PES","sol peruvian (1863–1965)");
    result.put("PGK","kina din Papua-Noua Guinee");
    result.put("PHP","peso filipinez");
    result.put("PKR","rupie pakistaneză");
    result.put("PLN","zlot polonez");
    result.put("PLZ","zlot polonez (1950–1995)");
    result.put("PYG","guarani paraguayan");
    result.put("QAR","rial qatarian");
    result.put("RHD","dolar rhodesian");
    result.put("ROL","leu românesc (1952–2006)");
    result.put("RON","leu românesc");
    result.put("RSD","dinar sârbesc");
    result.put("RUB","rublă rusească");
    result.put("RWF","franc rwandez");
    result.put("SAR","rial saudit");
    result.put("SBD","dolar din Insulele Solomon");
    result.put("SCR","rupie din Seychelles");
    ...
    result.put("SGD","dolar singaporez");
    result.put("SHP","liră Insula Sf. Elena");
    result.put("SIT","tolar sloven");
    result.put("SKK","coroană slovacă");
    result.put("SLL","leone din Sierra Leone");
    result.put("SOS","șiling somalez");
    result.put("SRD","dolar surinamez");
    result.put("SRG","gulden Surinam");
    result.put("SSP","liră din Sudanul de Sud");
    result.put("STD","dobra Sao Tome și Principe (1977–2017)");
    result.put("STN","dobra Sao Tome și Principe");
    result.put("SUR","rublă sovietică");
    result.put("SVC","colon El Salvador");
    result.put("SYP","liră siriană");
    result.put("SZL","lilangeni din Swaziland");
    ...
    result.put("TRL","liră turcească (1922–2005)");
    result.put("TRY","liră turcească");
    result.put("TTD","dolar din Trinidad-Tobago");
    result.put("TWD","dolar nou din Taiwan");
    ...
    result.put("UYU","peso uruguayan");
    result.put("UZS","sum Uzbekistan");
    result.put("VEB","bolivar Venezuela (1871–2008)");
    result.put("VEF","bolivar venezuelean (2008–2018)");
    result.put("VES","bolivar venezuelean");
    ...
    result.put("XCD","dolar din Caraibele de Est");
    ...
    result.put("ZMK","kwacha zambian (1968–2012)");
    result.put("ZMW","kwacha zambian");
