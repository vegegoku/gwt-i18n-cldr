...
public class CurrencyList_rof_TZ extends CurrencyList_rof {
  ...
  protected HashMap<String, String> loadNamesMap() {
    ...
    result.put("BHD","heleri sa Bahareni");
    result.put("BIF","heleri sa Burundi");
    result.put("BWP","heleri sa Botswana");
    result.put("CAD","heleri sa Kanada");
    result.put("CDF","heleri sa Kongo");
    result.put("CHF","heleri sa Uswisi");
    result.put("CNY","heleri sa China");
    result.put("CVE","heleri sa Kepuvede");
    result.put("DJF","heleri sa Jibuti");
    result.put("DZD","heleri sa Aljeria");
    result.put("EGP","heleri sa Misri");
    result.put("ERN","heleri sa Eritrea");
    result.put("ETB","heleri sa Uhabeshi");
    result.put("EUR","yuro");
    result.put("GBP","heleri sa Uingereza");
    result.put("GHC","heleri sa Ghana");
    result.put("GMD","heleri sa Gambia");
    result.put("GNS","heleri sa Gine");
    result.put("INR","heleri sa India");
    result.put("JPY","heleri sa Japani");
    result.put("KES","heleri sa Kenya");
    result.put("KMF","heleri sa Komoro");
    result.put("LRD","heleri sa Liberia");
    result.put("LSL","heleri sa Lesoto");
    result.put("LYD","heleri sa Libya");
    result.put("MAD","heleri sa Moroko");
    result.put("MGA","heleri sa Bukini");
    result.put("MRO","heleri sa Moritania (1973–2017)");
    result.put("MRU","heleri sa Moritania");
    result.put("MUR","heleri sa Morisi");
    result.put("MWK","heleri sa Malawi");
    result.put("MZM","heleri sa Msumbiji");
    result.put("NAD","heleri sa Namibia");
    result.put("NGN","heleri sa Nijeria");
    result.put("RWF","heleri sa Rwanda");
    result.put("SAR","heleri sa Saudia");
    result.put("SCR","heleri sa Shelisheli");
    result.put("SDG","heleri sa Sudani");
    result.put("SHP","heleri sa Santahelena");
    result.put("SLL","leoni");
    result.put("SOS","heleri sa Somalia");
    result.put("STD","heleri sa Sao Tome na Principe (1977–2017)");
    result.put("STN","heleri sa Sao Tome na Principe");
    result.put("SZL","lilangeni");
    result.put("TND","heleri sa Tunisia");
    result.put("TZS","heleri sa Tanzania");
    result.put("UGX","heleri sa Uganda");
    result.put("USD","heleri sa Marekani");
    result.put("XAF","heleri sa CFA BEAC");
    result.put("XOF","heleri sa CFA BCEAO");
    result.put("ZAR","heleri sa Afrika Kusini");
    result.put("ZMK","heleri sa Zambia (1968–2012)");
    result.put("ZMW","heleri sa Zambia");
    result.put("ZWD","heleri sa Zimbabwe");
    return result;
  }
}
