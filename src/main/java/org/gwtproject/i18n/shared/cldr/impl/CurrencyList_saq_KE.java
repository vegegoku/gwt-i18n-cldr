...
public class CurrencyList_saq_KE extends CurrencyList_saq {
  ...
  protected HashMap<String, String> loadNamesMap() {
    ...
    result.put("MRO","Njilingi eel Moritania (1973–2017)");
    result.put("MRU","Njilingi eel Moritania");
    ...
    result.put("STD","Njilingi eel Sao Tome na Principe (1977–2017)");
    result.put("STN","Njilingi eel Sao Tome na Principe");
    ...
    result.put("ZMK","Njilingi eel Zambia (1968–2012)");
    result.put("ZMW","Njilingi eel Zambia");
