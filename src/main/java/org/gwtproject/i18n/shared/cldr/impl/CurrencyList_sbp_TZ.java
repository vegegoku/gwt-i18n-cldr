...
public class CurrencyList_sbp_TZ extends CurrencyList_sbp {
  ...
  protected HashMap<String, String> loadNamesMap() {
    ...
    result.put("BHD","Ihela ya Bahaleni");
    result.put("BIF","Ihela ya Bulundi");
    result.put("BWP","Ihela ya Botiswana");
    result.put("CAD","Ihela ya Kanada");
    result.put("CDF","Ihela ya Kongo");
    result.put("CHF","Ihela ya Uswisi");
    result.put("CNY","Ihela ya Shina");
    result.put("CVE","Ihela ya Kepuvede");
    result.put("DJF","Ihela ya Jibuti");
    result.put("DZD","Ihela ya Alijeliya");
    result.put("EGP","Ihela ya Misili");
    result.put("ERN","Ihela ya Elitileya");
    result.put("ETB","Ihela ya Uhabeshi");
    result.put("EUR","Ihela ya Ulaya");
    result.put("GBP","Ihela ya Uwingelesa");
    result.put("GHC","Ihela ya Ghana");
    result.put("GMD","Ihela ya Gambiya");
    result.put("GNS","Ihela ya Gine");
    result.put("INR","Ihela ya Indiya");
    result.put("JPY","Ihela ya Japani");
    result.put("KES","Ihela ya Kenya");
    result.put("KMF","Ihela ya Komolo");
    result.put("LRD","Ihela ya Libeliya");
    result.put("LSL","Ihela ya Lesoto");
    result.put("LYD","Ihela ya Libiya");
    result.put("MAD","Ihela ya Moloko");
    result.put("MGA","Ihela ya Bukini");
    result.put("MRO","Ihela ya Molitaniya (1973–2017)");
    result.put("MRU","Ihela ya Molitaniya");
    result.put("MUR","Ihela ya Molisi");
    result.put("MWK","Ihela ya Malawi");
    result.put("MZM","Ihela ya Musumbiji");
    result.put("NAD","Ihela ya Namibiya");
    result.put("NGN","Ihela ya Nijeliya");
    result.put("RWF","Ihela ya Lwanda");
    result.put("SAR","Ihela ya Sawudiya");
    result.put("SCR","Ihela ya Shelisheli");
    result.put("SDG","Ihela ya Sudani");
    result.put("SHP","Ihela ya Santahelena");
    result.put("SLL","Ihela ya Siela Liyoni");
    result.put("SOS","Ihela ya Somaliya");
    result.put("STD","Ihela ya Sao Tome ni Pilinsipe (1977–2017)");
    result.put("STN","Ihela ya Sao Tome ni Pilinsipe");
    result.put("SZL","Ihela ya Uswasi");
    result.put("TND","Ihela ya Tunisiya");
    result.put("TZS","Ihela ya Tansaniya");
    result.put("UGX","Ihela ya Uganda");
    result.put("USD","Ihela ya Malekani");
    result.put("XAF","Ihela ya CFA BEAC");
    result.put("XOF","Ihela ya CFA BCEAO");
    result.put("ZAR","Ihela ya Afilika Kusini");
    result.put("ZMK","Ihela ya Sambiya (1968–2012)");
    result.put("ZMW","Ihela ya Sambiya");
    result.put("ZWD","Ihela ya Simbabwe");
    return result;
  }
}
