...
public class CurrencyList_sd_PK extends CurrencyList_sd {
  public CurrencyData getDefault() {
    return new CurrencyDataImpl("PKR","Rs",2,"Rs","Rs");
  }
  ...
  protected HashMap<String, CurrencyData> loadCurrencyMap() {
    ...
    // پاڪستاني رپي
    result.put("PKR", new CurrencyDataImpl("PKR","Rs",2,"Rs","Rs"));
    // پولش زلاٽي
  ...
  protected HashMap<String, String> loadNamesMap() {
    ...
    result.put("AED","گڏيل عرب امارات درهم");
    result.put("AFN","افغاني افغاني");
    result.put("ALL","الباني ليڪ");
    result.put("AMD","ارماني ڊرم");
    result.put("ANG","نيڌرلينڊ انٽليئن گلڊر");
    result.put("AOA","انگوليائي ڪوانزا");
    result.put("ARS","ارجنٽائن پيسو");
    result.put("AUD","آسٽريلوي ڊالر");
    result.put("AWG","اروبن فلورن");
    result.put("AZN","آذربائيجاني منت");
    result.put("BAM","بوسنيا هرزگوينا ڪنورٽبل مارڪ");
    result.put("BBD","باربيڊين ڊالر");
    result.put("BDT","بنگلاديشي ٽڪا");
    result.put("BGN","بلغارین لیو");
    result.put("BHD","بحريني دينار");
    result.put("BIF","برونڊي فرينڪ");
    result.put("BMD","برمودي ڊالر");
    result.put("BND","برونائي ڊالر");
    result.put("BOB","بولیوین بولیویانو");
    result.put("BRL","برازيلي ريل");
    result.put("BSD","بهاماني ڊادلر");
    result.put("BTN","ڀوٽاني گلٽرم");
    result.put("BWP","بوستواني پولا");
    result.put("BYN","بیلاروسی ربل");
    result.put("BZD","بيليز ڊالر");
    result.put("CAD","ڪئينڊيائي ڊالر");
    result.put("CDF","ڪانگو فرينڪ");
    result.put("CHF","سوئس فرينڪ");
    result.put("CLP","چلي پيسو");
    result.put("CNH","چيني يوآن (غير ملڪي)");
    result.put("CNY","چيني يوآن");
    result.put("COP","ڪولمبيائي پيسو");
    result.put("CRC","ڪوسٽا ريڪا ڪولن");
    result.put("CUC","ڪيوبن ڪنورٽيبل پيسو");
    result.put("CUP","ڪيوبن پيسو");
    result.put("CVE","ڪيپ وردي ايسڪوڊو");
    result.put("CZK","چيڪ ڪرونا");
    result.put("DJF","جبوتي فرينڪ");
    result.put("DKK","دانش ڪرون");
    result.put("DOP","ڊومينيڪن پيسو");
    result.put("DZD","الجيريائي دينار");
    result.put("EGP","مصري پائونڊ");
    result.put("ERN","ايريٽيريائي ناڪفا");
    result.put("ETB","ايٿوپيائي بر");
    result.put("EUR","يورو");
    result.put("FJD","فجي ڊالر");
    result.put("FKP","فاڪلينڊ ٻيٽ پائونڊ");
    result.put("GBP","برطانوي پائونڊ");
    result.put("GEL","جارجيائي لاري");
    result.put("GHS","گهانين سيدي");
    result.put("GIP","جبرالٽر پائونڊ");
    result.put("GMD","گيمبيا دلاسائي");
    result.put("GNF","گني فرينڪ");
    result.put("GTQ","گوئٽي مالا ڪٽزل");
    result.put("GYD","گيانا ڊالر");
    result.put("HKD","هانگ ڪانگ ڊالر");
    result.put("HNL","هونڊوراس ليمپرا");
    result.put("HRK","ڪروشيائي ڪونا");
    result.put("HTG","هيٽي گورڊي");
    result.put("HUF","هنگيرين فورنٽ");
    result.put("IDR","انڊونيشيائي رپيه");
    result.put("ILS","اسرائيلي نيو شيڪل");
    result.put("INR","انڊين رپي");
    result.put("IQD","عراقي دينار");
    result.put("IRR","ايراني ريال");
    result.put("ISK","آئيس لينڊي ڪرونا");
    result.put("JMD","جميڪائي ڊالر");
    result.put("JOD","اردني دينار");
    result.put("JPY","جاپاني يين");
    result.put("KES","ڪينيائي سلنگ");
    result.put("KGS","ڪرغزستاني سوم");
    result.put("KHR","ڪمبوڊيائي ريال");
    result.put("KMF","ڪوموريائي فرينڪ");
    result.put("KPW","اتر ڪوريائي ون");
    result.put("KRW","ڏکڻ ڪوريائي ون");
    result.put("KWD","ڪويتي دينار");
    result.put("KYD","ڪيمين ٻيٽ ڊالر");
    result.put("KZT","قازقستان ٽينگا");
    result.put("LAK","لائوشيائي ڪپ");
    result.put("LBP","لبناني پائونڊ");
    result.put("LKR","سري لنڪن رپي");
    result.put("LRD","لائبیریائی ڊالر");
    result.put("LYD","لبيائي دينار");
    result.put("MAD","موروڪيائي درهم");
    result.put("MDL","مالديپ ليو");
    result.put("MGA","ملاگاسي اریاری");
    result.put("MKD","ميسي ڊوني دينار");
    result.put("MMK","ميانمار ڪياٽ");
    result.put("MNT","منگولي تجرڪ");
    result.put("MOP","ميڪانيز پٽاڪا");
    result.put("MRO","موريشيائي اوگوئیا (1973–2017)");
    result.put("MRU","موريشيائي اوگوئیا");
    result.put("MUR","ماريشيائي رپي");
    result.put("MVR","مالديپ روفيا");
    result.put("MWK","ملاوي ڪواچا");
    result.put("MXN","ميڪسيڪو پيسو");
    result.put("MYR","ملائيشيائي رنگٽ");
    result.put("MZN","موزمبيق ميٽيڪل");
    result.put("NAD","نميبائي ڊالر");
    result.put("NGN","نائجريائي نائرا");
    result.put("NIO","نڪارا گوا ڪارڊوبا");
    result.put("NOK","نارويائي ڪرون");
    result.put("NPR","نيپالي رپي");
    result.put("NZD","نيوزي لينڊي ڊالر");
    result.put("OMR","عماني ريال");
    result.put("PAB","پاناما پالبوا");
    result.put("PEN","پيرو سول");
    result.put("PGK","پاپوا نيو گني ڪنا");
    result.put("PHP","فلپائني پيسو");
    result.put("PKR","پاڪستاني رپي");
    result.put("PLN","پولش زلاٽي");
    result.put("PYG","پيراگوئي گاراني");
    result.put("QAR","قطري ريال");
    result.put("RON","رومانیائي لیو");
    result.put("RSD","سربيا دينار");
    result.put("RUB","روسي ربل");
    result.put("RWF","روانڊا فرينڪ");
    result.put("SAR","سعودي ريال");
    result.put("SBD","سولومان ٻيٽ ڊالر");
    result.put("SCR","سشلي رپي");
    result.put("SDG","سوڊاني پائونڊ");
    result.put("SEK","سويڊني ڪرونا");
    result.put("SGD","سنگاپوري ڊالر");
    result.put("SHP","سينٽ هيلنا پائونڊ");
    result.put("SLL","سیرا لیونيائي لیون");
    result.put("SOS","سومالي شلنگ");
    result.put("SRD","سرينامي ڊالر");
    result.put("SSP","ڏکڻ سوڊاني پائونڊ");
    result.put("STD","سائو ٽوم ۽ پرنسپي دوبرا (1977–2017)");
    result.put("STN","سائو ٽوم ۽ پرنسپي دوبرا");
    result.put("SYP","سيريائي پائونڊ");
    result.put("SZL","سوازي للانگيني");
    result.put("THB","ٿائي باهت");
    result.put("TJS","تاجڪستاني سوموني");
    result.put("TMT","ترڪمانستان منت");
    result.put("TND","تیونس دینار");
    result.put("TOP","تونگن پانگا");
    result.put("TRY","ترڪي لرا");
    result.put("TTD","ٽرينڊيڊ ۽ ٽوباگو ڊالر");
    result.put("TWD","نيو تائيوان ڊالر");
    result.put("TZS","تنزانيائي شلنگ");
    result.put("UAH","یوڪرائن هریونیا");
    result.put("UGX","يگانڊا شلنگ");
    result.put("USD","آمريڪي ڊالر");
    result.put("UYU","يوروگوئي پيسو");
    result.put("UZS","ازبڪستاني سوم");
    result.put("VEF","Venezuelan Bolívar (2008–2018)");
    result.put("VES","وینزویلا بولیور");
    result.put("VND","ويٽنامي ڊونگ");
    result.put("VUV","وانواتو واتو");
    result.put("WST","ساموآن ٽالا");
    result.put("XAF","وچ آفريڪا فرينڪ");
    result.put("XCD","اوڀر ڪيريبين ڊالر");
    result.put("XOF","اولهه آفريڪا فرينڪ");
    result.put("XPF","CFP فرينڪ");
    result.put("XXX","اڻڄاتل سڪو");
    result.put("YER","يمني ريال");
    result.put("ZAR","ڏکڻ آفريقي رانڊ");
    result.put("ZMW","زمبائي ڪواچا");
    return result;
  }
}
