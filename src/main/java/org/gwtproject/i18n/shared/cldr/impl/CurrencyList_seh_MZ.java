...
public class CurrencyList_seh_MZ extends CurrencyList_seh {
  ...
  protected HashMap<String, String> loadNamesMap() {
    ...
    result.put("ERN","Nakfa da Eritréia");
    result.put("ETB","Birr etíope");
    result.put("EUR","Euro");
    result.put("GBP","Libra britânica");
    ...
    result.put("MGA","Franco de Madagascar");
    result.put("MRO","Ouguiya da Mauritânia (1973–2017)");
    result.put("MRU","Ouguiya da Mauritânia");
    result.put("MUR","Rupia de Maurício");
    result.put("MWK","Cuacha do Maláui");
    result.put("MZM","Metical antigo de Moçambique");
    result.put("MZN","Metical de Moçambique");
    ...
    result.put("UGX","Xelim ugandense (1966–1987)");
    ...
    result.put("ZMW","Cuacha zambiano");
