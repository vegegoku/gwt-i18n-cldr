...
public class CurrencyList_sg_CF extends CurrencyList_sg {
  ...
  protected HashMap<String, String> loadNamesMap() {
    ...
    result.put("MRO","ugîya tî Moritanïi (1973–2017)");
    result.put("MRU","ugîya tî Moritanïi");
    ...
    result.put("STD","dôbra tî Sâô Tomë na Prinsîpe (1977–2017)");
    result.put("STN","dôbra tî Sâô Tomë na Prinsîpe");
    ...
    result.put("ZMK","kwâtia tî Zambïi (1968–2012)");
    result.put("ZMW","kwâtia tî Zambïi");
