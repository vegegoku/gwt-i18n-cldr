...
public class CurrencyList_shi_Latn_MA extends CurrencyList_shi_Latn {
  ...
  protected HashMap<String, String> loadNamesMap() {
    ...
    result.put("BHD","adinar n bḥrayn");
    result.put("BIF","frank n burundi");
    result.put("BWP","abula n butswana");
    result.put("CAD","adular n kanada");
    result.put("CDF","frank n kungu");
    result.put("CHF","afrank n swisra");
    result.put("CNY","ayan n ccinwa");
    result.put("CVE","iskudu n kabbirdi");
    result.put("DJF","frank n djibuti");
    result.put("DZD","adinar n dzayr");
    result.put("EGP","ajnih n miṣṛ");
    result.put("ERN","nafka n iritirya");
    result.put("ETB","bir n ityubya");
    result.put("EUR","uru");
    result.put("GBP","ajnih astrlini n nngliz");
    result.put("GHC","sidi n ɣana");
    result.put("GMD","dalasi n gambya");
    result.put("GNS","frank n ɣinya");
    result.put("INR","arubi n lhind");
    result.put("JPY","ayan n lyaban");
    result.put("KES","acilin n kinya");
    result.put("KMF","frank n qumuṛ");
    result.put("LRD","adular n libirya");
    result.put("LSL","luti n liṣuṭu");
    result.put("LYD","adinar n libya");
    result.put("MAD","adrim n lmɣrib");
    result.put("MGA","frank n madaɣacqar");
    result.put("MRO","uqiyya n muṛiṭanya (1973–2017)");
    result.put("MRU","uqiyya n muṛiṭanya");
    result.put("MUR","arubi n muris");
    result.put("MWK","kwaca n malawi");
    result.put("MZM","amitikl n muznbiq");
    result.put("NAD","adular n namibya");
    result.put("NGN","nayra n nijirya");
    result.put("RWF","afrank n rwanda");
    result.put("SAR","aryal n ssaɛudiya");
    result.put("SCR","arubi n ssicil");
    result.put("SDG","adinar n ssudan");
    result.put("SDP","ajnih n ssudan");
    result.put("SHP","ajnih n santilin");
    result.put("SLL","liyun");
    result.put("SOS","acilin n ṣṣumal");
    result.put("STD","adubra n sanṭumi (1977–2017)");
    result.put("STN","adubra n sanṭumi");
    result.put("SZL","lilanjini");
    result.put("TND","adinar n tuns");
    result.put("TZS","acilin n ṭanẓanya");
    result.put("UGX","acilin n uɣanda");
    result.put("USD","adular n iwunak imunn");
    result.put("XAF","frank ṣifa");
    result.put("XOF","frank ṣifa bisaw");
    result.put("ZAR","arand n afriqya n iffus");
    result.put("ZMK","akwaca n zambya (1968–2012)");
    result.put("ZMW","akwaca n zambya");
    result.put("ZWD","adular n zimbabwi");
    return result;
  }
}
