...
public class CurrencyList_shi_Tfng_MA extends CurrencyList_shi_Tfng {
  ...
  protected HashMap<String, String> loadNamesMap() {
    ...
    result.put("GHC","ⵙⵉⴷⵉ ⵏ ⵖⴰⵏⴰ");
    result.put("GMD","ⴷⴰⵍⴰⵙⵉ ⵏ ⴳⴰⵎⴱⵢⴰ");
    result.put("GNS","ⴼⵔⴰⵏⴽ ⵏ ⵖⵉⵏⵢⴰ");
    ...
    result.put("MZM","ⴰⵎⵉⵜⵉⴽⵍ ⵏ ⵎⵓⵣⵏⴱⵉⵇ");
    ...
    result.put("ZWD","ⴰⴷⵓⵍⴰⵔ ⵏ ⵣⵉⵎⴱⴰⴱⵡⵉ");
    return result;
  }
}
