...
public class CurrencyList_si_LK extends CurrencyList_si {
  public CurrencyData getDefault() {
    return new CurrencyDataImpl("LKR","රු.",2,"රු.","රු.");
  }
  ...
  protected HashMap<String, CurrencyData> loadCurrencyMap() {
    ...
    // ශ්‍රී ලංකා රුපියල
    result.put("LKR", new CurrencyDataImpl("LKR","රු.",2,"රු.","රු."));
    // ලයිබේරියානු ඩොලර්
    ...
    result.put("XOF", new CurrencyDataImpl("XOF","සිෆ්එ",0,"සිෆ්එ","සිෆ්එ"));
    // XPD
  ...
  protected HashMap<String, String> loadNamesMap() {
    ...
    result.put("AFN","ඇෆ්ගනිථාන ඇෆ්ගනි");
    result.put("ALL","ඇල්බේනියානු ලෙක්");
    result.put("AMD","ආර්මේනියානු ඩ්‍රෑම්");
    result.put("ANG","නෙදර්ලන්ත ඇන්ටිලියන් ගිල්ඩර්");
    result.put("AOA","ඇන්ගෝලානු ක්වන්සා");
    result.put("ARS","ආර්ජන්ටිනා පෙසෝ");
    result.put("AUD","ඔස්ට්‍රේලියානු ඩොලර්");
    result.put("AWG","අරූබානු ෆ්ලෝරින්");
    result.put("AZN","අසර්බයිජානු මනාට්");
    result.put("BAM","බොස්නියා හර්සගොවීනා පරිවර්ත්‍ය මාර්ක්");
    result.put("BBD","බාබේඩියානු ඩොලර්");
    result.put("BDT","බංග්ලාදේශ් ටකා");
    result.put("BGN","බල්ගේරියානු ලිව්");
    result.put("BHD","බහරේන් ඩිනාර්");
    result.put("BIF","බුරුන්දි ෆ්‍රෑන්ක්");
    result.put("BMD","බර්මියුඩානු ඩොලර්");
    result.put("BND","බෘනායි ඩොලර්");
    result.put("BOB","බොලිවියානු බොලිවියානෝ");
    result.put("BRL","බ්‍රසීල රියල්");
    result.put("BSD","බහමානු ඩොලර්");
    result.put("BTN","භූතාන නගුල්ට්‍රම්");
    result.put("BWP","බොට්ස්වානා පුලා");
    result.put("BYN","බෙලරූස් රූබල්");
    result.put("BYR","බෙලරූස් රූබල් (2000–2016)");
    result.put("BZD","බෙලීස් ඩොලර්");
    result.put("CAD","කැනේඩියානු ඩොලර්");
    result.put("CDF","කොංගෝ ෆ්‍රෑන්ක්");
    result.put("CHF","ස්විස් ෆ්‍රෑන්ක්");
    result.put("CLP","චිලි පැසෝ");
    result.put("CNH","චීන යුආන් (එතෙර)");
    result.put("CNY","චීන යුආන්");
    result.put("COP","කොලොම්බියානු පෙසෝ");
    result.put("CRC","කොස්ට රිකා කොලෝන්");
    result.put("CUC","මාරුකළ හැකි කියුබානු පැසෝ");
    result.put("CUP","කියුබානු පැසෝ");
    result.put("CVE","කේප් වර්ඩ් එස්කියුඩෝ");
    result.put("CZK","චෙක් රිපබ්ලික් කොරූනා");
    result.put("DJF","ජිබූති ෆ්‍රෑන්ක්");
    result.put("DKK","ඩැනිෂ් ක්‍රෝන්");
    result.put("DOP","ඩොමිනිකානු පෙසෝ");
    result.put("DZD","ඇල්ගේරියානු ඩිනාර්");
    result.put("EGP","ඊජිප්තු පවුම්");
    result.put("ERN","එරිත්‍රියානු නැක්ෆා");
    result.put("ETB","ඉතියෝපියානු බීර්");
    result.put("EUR","යුරෝ");
    result.put("FJD","ෆිජියන් ඩොලර්");
    result.put("FKP","ෆෝක්ලන්ඩ් දූපත් පවුම්");
    result.put("GBP","බ්‍රිතාන්‍ය ස්ටර්ලින් පවුම්");
    result.put("GEL","ජෝජියානු ලැරී");
    result.put("GHS","ඝානා සෙඩි");
    result.put("GIP","ජිබ්‍රෝල්ටා පවුම්");
    result.put("GMD","ගැම්බියානු දලාසි");
    result.put("GNF","ගිනියානු ෆ්රෑන්ක්");
    result.put("GTQ","ගෝතමාලානු ක්වෙට්සල්");
    result.put("GYD","ගයනා ඩොලර්");
    result.put("HKD","හොංකොං ඩොලර්");
    result.put("HNL","හොන්ඩුරානු ලෙම්පිරා");
    result.put("HRK","ක්‍රොඒෂියානු කූනා");
    result.put("HTG","හයිටි ගෝර්ඩ්");
    result.put("HUF","හංගේරියානු ෆරින්ට්");
    result.put("IDR","ඉන්දුනීසියානු රුපියා");
    result.put("ILS","ඊශ්‍රායල නව ශෙකල්");
    result.put("INR","ඉන්දියානු රුපියල්");
    result.put("IQD","ඉරාක ඩිනාර්");
    result.put("IRR","ඉරාන රියාල්");
    result.put("ISK","අයිස්ලන්තික ක්‍රෝනා");
    result.put("JMD","ජැමෙයිකානු ඩොලර්");
    result.put("JOD","ජෝර්දාන් ඩිනාර්");
    result.put("JPY","ජපන් යෙන්");
    result.put("KES","කෙන්යානු ශිලිං");
    result.put("KGS","කිරිගිස්ථාන සම්");
    result.put("KHR","කාම්බෝජ රියේල්");
    result.put("KMF","කොමොරියානු ෆ්‍රෑන්ක්");
    result.put("KPW","උතුරු කොරියානු වොන්");
    result.put("KRW","දකුණු කොරියානු වොන්");
    result.put("KWD","කුවේට් ඩිනාර්");
    result.put("KYD","කේමන් දූපත් ඩොලර්");
    result.put("KZT","කසකස්ථාන ටෙන්ග");
    result.put("LAK","ලාඕස් කිප්");
    result.put("LBP","ලෙබනන පවුම්");
    result.put("LKR","ශ්‍රී ලංකා රුපියල");
    result.put("LRD","ලයිබේරියානු ඩොලර්");
    result.put("LTL","ලිතුවේනියානු");
    result.put("LVL","ලැට්වියානු ලැට්ස්");
    result.put("LYD","ලිබියානු ඩිනාර්");
    result.put("MAD","මොරොක්කෝ ඩිර්හැම්");
    result.put("MDL","මෝල්ඩෝවානු ලෙව්");
    result.put("MGA","මලගාසි අරියාරි");
    result.put("MKD","මැසඩෝනියානු ඩිනාර්");
    result.put("MMK","බුරුම ක්යාට්");
    result.put("MNT","මොන්ගෝලියානු ටග්‍රික්");
    result.put("MOP","මැකනීස් පටකා");
    result.put("MRO","මුරුසි ඔයිගුයියා (1973–2017)");
    result.put("MRU","මුරුසි ඔයිගුයියා");
    result.put("MUR","මුරිසියානු රුපියල්");
    result.put("MVR","මාලදිවයින් රුෆියා");
    result.put("MWK","මලාවි ක්වාචා");
    result.put("MXN","මෙක්සිකානු ඩොලර්");
    result.put("MYR","මැලේසියානු රින්ගිට්");
    result.put("MZN","මොසැම්බිකන් මෙටිකල්");
    result.put("NAD","නැමීබියානු ඩොලර්");
    result.put("NGN","නයිජීරියානු නයිරා");
    result.put("NIO","නිකරගුවානු කොඩෝබා");
    result.put("NOK","නොර්වීජියන් ක්‍රෝන්");
    result.put("NPR","නේපාල රුපියල්");
    result.put("NZD","නවසීලන්ත ඩොලර්");
    result.put("OMR","ඕමාන් රියාල්");
    result.put("PAB","පැනමා බැල්බෝ");
    result.put("PEN","පේරු සොල්");
    result.put("PGK","පැපුවා නිව් ගිනියානු කිනා");
    result.put("PHP","පිලිපීන පෙසෝ");
    result.put("PKR","පාකිස්ථාන රුපියල්");
    result.put("PLN","පොලිෂ් ස්ලොටි");
    result.put("PYG","පැරගුවේ ගුවරානි");
    result.put("QAR","කටාර් රියාල්");
    result.put("RON","රොමේනියානු ලෙව්");
    result.put("RSD","සර්බියානු ඩිනාර්");
    result.put("RUB","රුසියන් රූබල්");
    result.put("RWF","රුවන්ඩා ෆ්‍රෑන්ක්");
    result.put("SAR","සවුදි රියාල්");
    result.put("SBD","සොලමන් දූපත් ඩොලර්");
    result.put("SCR","සීෂෙලියානු රුපියල");
    result.put("SDG","සුඩාන පවුම්");
    result.put("SEK","ස්වෙඩිෂ් ක්‍රෝනා");
    result.put("SGD","සිංගප්පූරු ඩොලර්");
    result.put("SHP","ශාන්ත හෙලේනා පවුම්");
    result.put("SLL","සියරා ලියොන් ලියොන්");
    result.put("SOS","සෝමාලියානු ශිලිං");
    result.put("SRD","සුරිනාම් ඩොලර්");
    result.put("SSP","දකුණු සුඩාන පවුම්");
    result.put("STD","සාඕ තෝම් සහ ප්‍රින්සිප් දොබ්‍රා (1977–2017)");
    result.put("STN","සාඕ තෝම් සහ ප්‍රින්සිප් දොබ්‍රා");
    result.put("SYP","සිරියානු පවුම්");
    result.put("SZL","ස්වාසි ලිලන්ජනි");
    result.put("THB","තායි බාත්");
    result.put("TJS","තජිකිස්ථාන සමොනි");
    result.put("TMT","තක්මෙනිස්ථාන මනාට්");
    result.put("TND","ටියුනීසියානු ඩිනාර්");
    result.put("TOP","ටොංගානු පාන්ගා");
    result.put("TRY","තුර්කි ලිරා");
    result.put("TTD","ට්‍රිනිඩෑඩ් සහ ටොබෑගෝ ඩොලර්");
    result.put("TWD","නව තායිවාන ඩොලර්");
    result.put("TZS","ටැන්සානියානු ශිලිං");
    result.put("UAH","යුක්රේන හ්‍රිව්නියා");
    result.put("UGX","උගන්ඩා ශිලිං");
    result.put("USD","ඇමරිකානු ඩොලර්");
    result.put("UYU","උරුගුවේ පෙසෝ");
    result.put("UZS","උස්බෙකිස්ථාන සම්");
    result.put("VEF","වෙනිසියුලානු බොලිවර් (2008–2018)");
    result.put("VES","වෙනිසියුලානු බොලිවර්");
    result.put("VND","වියට්නාම ඩොන්");
    result.put("VUV","වනුවාටු වාටු");
    result.put("WST","සැමෝවා ටාලා");
    result.put("XAF","සිෆ්එ ෆ්රෑන්ක් බිඊඑසි");
    result.put("XCD","නැගෙනහිර කැරිබියානු ඩොලර්");
    result.put("XOF","සිෆ්එ ෆ්රෑන්ක් බිසීඊඑඔ");
    result.put("XPF","ප්‍රංශ පොලිනීසියානු ෆ්‍රෑන්ක්");
    result.put("XXX","නොදත් මුදල්");
    result.put("YER","යේමන රියාල්");
    result.put("ZAR","දකුණු අප්‍රිකානු රැන්ඩ්");
    result.put("ZMK","සැම්බියානු ක්වාචා (1968–2012)");
    result.put("ZMW","සැම්බියානු ක්වාචා");
    return result;
  }
}
