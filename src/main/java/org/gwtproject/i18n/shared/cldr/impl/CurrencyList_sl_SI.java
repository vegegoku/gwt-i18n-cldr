...
public class CurrencyList_sl_SI extends CurrencyList_sl {
  ...
  protected HashMap<String, String> loadNamesMap() {
    ...
    result.put("BYN","beloruski rubelj");
    result.put("BYR","beloruski rubelj (2000–2016)");
    ...
    result.put("CNH","kitajski juan (offshore)");
    result.put("CNY","kitajski juan");
    ...
    result.put("MRO","mavretanska uguija (1973–2017)");
    result.put("MRU","mavretanska uguija");
    ...
    result.put("PEN","perujski sol");
    result.put("PES","perujski sol (1863–1965)");
    ...
    result.put("SSP","južnosudanski funt");
    result.put("STD","saotomejska dobra (1977–2017)");
    result.put("STN","saotomejska dobra");
    ...
    result.put("VEB","venezuelski bolivar (1871–2008)");
    result.put("VEF","venezuelski bolivar (2008–2018)");
    result.put("VES","venezuelski bolivar");
