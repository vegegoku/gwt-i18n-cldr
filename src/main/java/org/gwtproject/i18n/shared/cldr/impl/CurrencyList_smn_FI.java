...
public class CurrencyList_smn_FI extends CurrencyList_smn {
  ...
  protected HashMap<String, String> loadNamesMap() {
    ...
    result.put("EUR","euro");
    result.put("FIM","Suomâ märkki");
    result.put("ISK","Island ruvnâ");
    result.put("LVR","Latvia ruble");
    result.put("NOK","Taažâ ruvnâ");
    result.put("SEK","Ruotâ ruvnâ");
    return result;
  }
}
