...
public class CurrencyList_sn_ZW extends CurrencyList_sn {
  ...
  protected HashMap<String, String> loadNamesMap() {
    ...
    result.put("AED","Diramu re United Arab Emirates");
    result.put("AOA","Kwanza ye Angola");
    result.put("AUD","Dora re Australia");
    result.put("BHD","Dhinari re Bhahareni");
    result.put("BIF","Furenki re Bhurundi");
    result.put("BWP","Pura re Botswana");
    result.put("CAD","Dora re Kanada");
    result.put("CDF","Furenki re Kongo");
    result.put("CHF","Furenki re Swisi");
    result.put("CNY","Yuan Renminbi ye China");
    result.put("CVE","Dhora re Escudo");
    result.put("DJF","Furenki re Jibhuti");
    result.put("DZD","Dhinari re Aljeria");
    result.put("EGP","Paundi re Ijipita");
    result.put("ERN","Nakfa re Eritrea");
    result.put("ETB","Dhora re Etiopia");
    result.put("EUR","Yuro");
    result.put("GBP","Paundi ye Bhiriteni");
    result.put("GHC","Sedi ye Ghana");
    result.put("GMD","Dalasi ye Gambia");
    result.put("GNS","Furenki re Gine");
    result.put("INR","Rupe re India");
    result.put("JPY","Yeni ye Japani");
    result.put("KES","Shiringi ye Kenya");
    result.put("KMF","Furenki re Komoro");
    result.put("LRD","Dora re Liberia");
    result.put("LSL","Loti ye Lesoto");
    result.put("LYD","Dinari re Libya");
    result.put("MAD","Dirham ye Moroko");
    result.put("MGA","Furenki re Malagasi");
    result.put("MRO","Ugwiya ye Moritania (1973–2017)");
    result.put("MRU","Ugwiya ye Moritania");
    result.put("MUR","Rupi ye Morishasi");
    result.put("MWK","Kwacha ye Malawi");
    result.put("MZM","Metika ye Mozambiki");
    result.put("NAD","Dora re Namibia");
    result.put("NGN","Naira ye Nijeria");
    result.put("RWF","Furenki re Ruwanda");
    result.put("SAR","Riyali re Saudi");
    result.put("SCR","Rupi re Seyisheri");
    result.put("SDG","Dinari re Sudani");
    result.put("SDP","Paundi re Sudani");
    result.put("SHP","Paundi re Senti Helena");
    result.put("SLL","Leoni");
    result.put("SOS","Shiringi re Somalia");
    result.put("STD","Dobra re Sao Tome ne Principe (1977–2017)");
    result.put("STN","Dobra re Sao Tome ne Principe");
    result.put("SZL","Lilangeni");
    result.put("TND","Dinari re Tunisia");
    result.put("TZS","Shiringi re Tanzania");
    result.put("UGX","Shiringi re Uganda");
    result.put("USD","Dora re Amerika");
    result.put("XAF","Furenki CFA BEAC");
    result.put("XOF","Furenki CFA BCEAO");
    result.put("ZAR","Randi");
    result.put("ZMK","Kwacha ye Zambia (1968–2012)");
    result.put("ZMW","Kwacha ye Zambia");
    result.put("ZWD","Dora re Zimbabwe");
    return result;
  }
}
