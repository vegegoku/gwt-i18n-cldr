...
public class CurrencyList_so_ET extends CurrencyList_so {
  public CurrencyData getDefault() {
    return new CurrencyDataImpl("ETB","Br",2,"Br","Br");
  }
  ...
  protected HashMap<String, CurrencyData> loadCurrencyMap() {
    ...
    // Doolarka Bahamaas
    result.put("BSD", new CurrencyDataImpl("BSD","DBS",2,"DBS","DBS"));
    // Ngultaram Butan
    ...
    // Birta Itoobbiya
    result.put("ETB", new CurrencyDataImpl("ETB","Br",2,"Br","Br"));
    // Yuuroo
    ...
    // Lembira Hondura
    result.put("HNL", new CurrencyDataImpl("HNL","LHN",2,"LHN","LHN"));
    // HRD
    ...
    // Doolarka Tirinad iyo Tobago
    result.put("TTD", new CurrencyDataImpl("TTD","TTD",2,"TTD","TTD"));
    // Doollarka Taywaanta Cusubta
    ...
    // Farank CFA ee Bartamaha Afrika
  ...
  protected HashMap<String, String> loadNamesMap() {
    ...
    result.put("AED","Dirhamka Isutaga Imaaraatka Carabta");
    result.put("AFN","Afgan Afgan");
    result.put("ALL","Lek Albaniya");
    result.put("AMD","Daraamka Armeniya");
    result.put("ANG","Galdar Nadarland Antilean");
    result.put("AOA","Kawansada Angola");
    result.put("ARS","Beeso Arjentina");
    result.put("AUD","Doolarka Awstaraaliya");
    result.put("AWG","Foloorin Aruban");
    result.put("AZN","Manaatada Asarbeyjan");
    result.put("BAM","Konfatibal Maak Bosnia-Hersogofina");
    result.put("BBD","Doolarka Barbaadiyaanka");
    result.put("BDT","Taka Bangledesh");
    result.put("BGN","Lef Bulgariya");
    result.put("BHD","Dinaarka Baxreyn");
    result.put("BIF","Farank Burundi");
    result.put("BMD","Doolarka Barmuuda");
    result.put("BND","Doollarka Burunel");
    result.put("BOB","Bolifiano Bolifiya");
    result.put("BRL","Real Barasil");
    result.put("BSD","Doolarka Bahamaas");
    result.put("BTN","Ngultaram Butan");
    result.put("BWP","Buulada Botswana");
    result.put("BYN","Rubalka Belarus");
    result.put("BZD","Doolarka Beelisa");
    result.put("CAD","Doolarka Kanada");
    result.put("CDF","Farank Kongo");
    result.put("CHF","Farank Iswis");
    result.put("CLP","Beeso Jili");
    result.put("CNH","Yuanta Shiinaha (Offshore)");
    result.put("CNY","Yuanta Shiinaha");
    result.put("COP","Beeso Kolombiya");
    result.put("CRC","Kolon Kosta Rika");
    result.put("CUC","Beeso Kuuba Konfatibal");
    result.put("CUP","Beeso Kuuba");
    result.put("CVE","Eskudo Keyb Farde");
    result.put("CZK","Korunada Jeek");
    result.put("DJF","Faran Jabbuuti");
    result.put("DKK","Koranka Danishka");
    result.put("DOP","Beeso Dominika");
    result.put("DZD","Dinaarka Aljeriya");
    result.put("EGP","Bowndka Masar");
    result.put("ERN","Nafkada Eritriya");
    result.put("ETB","Birta Itoobbiya");
    result.put("EUR","Yuuroo");
    result.put("FJD","Doolarka Fiji");
    result.put("FKP","Bowndka Faalkland Island");
    result.put("GBP","Bowndka Biritishka");
    result.put("GEL","Laariga Joorjiya");
    result.put("GHS","Sedi Gana");
    result.put("GIP","Bowndka Gibraltar");
    result.put("GMD","Dalasi Gambiya");
    result.put("GNF","Faranka Gini");
    result.put("GTQ","Quetsal Guatemala");
    result.put("GYD","Doolarka Guyanes");
    result.put("HKD","Doollarka Hong Kong");
    result.put("HNL","Lembira Hondura");
    result.put("HRK","Kuna Korooshiya");
    result.put("HTG","Goorde Haiti");
    result.put("HUF","Forintiska Hangari");
    result.put("IDR","Rubiah Indonesiya");
    result.put("ILS","Niyuu Shekelka Israaiil");
    result.put("INR","Rubiga Hindiya");
    result.put("IQD","Dinaarka Ciraaq");
    result.put("IRR","Riyaalka Iran");
    result.put("ISK","Korona Eysland");
    result.put("JMD","Doolarka Jamaaika");
    result.put("JOD","Dinaarka Joordan");
    result.put("JPY","Yenta Jaban");
    result.put("KES","Shilingka Kenya");
    result.put("KGS","Soom Kiyrgiystan");
    result.put("KHR","Riyf Cambodiya");
    result.put("KMF","Farank Komora");
    result.put("KPW","Wonka Waqooyi Kuuriya");
    result.put("KRW","Wonka Koonfur Kuuriya");
    result.put("KWD","Dinaarka Kuweyt");
    result.put("KYD","Doolarka jasiiradaha Kayman");
    result.put("KZT","Tenge Kasakhstan");
    result.put("LAK","Kib Laoti");
    result.put("LBP","Bowndka Lebanon");
    result.put("LKR","Rubiga Siri lanka");
    result.put("LRD","Doollarka Liberiya");
    result.put("LYD","Dinaarka Libya");
    result.put("MAD","Dirhamka Moroko");
    result.put("MDL","Leeyuu Moldofa");
    result.put("MGA","Ariari Malagasy");
    result.put("MKD","Denaarka Masedoniya");
    result.put("MMK","Kayat Mayanmaar");
    result.put("MNT","Tugrik Mongoliya");
    result.put("MOP","Bataka Makana");
    result.put("MRO","Oogiya Mawritaniya (1973–2017)");
    result.put("MUR","Rubiga Mowrishiya");
    result.put("MVR","Rufiya Maldifiya");
    result.put("MWK","Kawajada Malawi");
    result.put("MXN","Beeso Meksikaan");
    result.put("MYR","Ringit Malayshiya");
    result.put("MZN","Metikalka Mosambik");
    result.put("NAD","Doollarka Namibiya");
    result.put("NGN","Nairada Neyjeeriya");
    result.put("NIO","Nikaragua Kordoba");
    result.put("NOK","Koronka Norway");
    result.put("NPR","Rubiga Nebal");
    result.put("NZD","Doolarka Niyuu Siyalaan");
    result.put("OMR","Riyaalka Comaan");
    result.put("PAB","Balboa Panama");
    result.put("PEN","Sol Beeru");
    result.put("PGK","Kinada Babua Niyuu Gini");
    result.put("PHP","Biso Filibin");
    result.put("PKR","Rubiga Bakistan");
    result.put("PLN","Solotida Boland");
    result.put("PYG","Guarani Baraguay");
    result.put("QAR","Riyaalka Qatar");
    result.put("RON","Liyuu ROmaniya");
    result.put("RSD","Dinaarka Serbiya");
    result.put("RUB","Rubalka Ruush");
    result.put("RWF","Farank Ruwanda");
    result.put("SAR","Riyaalka Sacuudiga");
    result.put("SBD","Doolarka Jasiiradaha Solomon");
    result.put("SCR","Rubiga Siisalis");
    result.put("SDG","Bowndka Suudaan");
    result.put("SEK","Koronka Isweden");
    result.put("SGD","Doollarka Singabuur");
    result.put("SHP","Bowndka St Helen");
    result.put("SLL","Leonka Sira Leon");
    result.put("SOS","Shilingka Soomaaliya");
    result.put("SRD","Doolarka Surinamees");
    result.put("SSP","Boownka Koonfurta Suudaan");
    result.put("STN","Dobra Sao Tome & Birinsibal");
    result.put("SYP","Bowndka Suuriya");
    result.put("SZL","Lilangeenida iswasi");
    result.put("THB","Baatka Tayland");
    result.put("TJS","Somoon Tajikistan");
    result.put("TMT","Manaat Turkmenistan");
    result.put("TND","Dinaarka Tunisiya");
    result.put("TOP","Ba’anga Tonga");
    result.put("TRY","Liirada Turkiga");
    result.put("TTD","Doolarka Tirinad iyo Tobago");
    result.put("TWD","Doollarka Taywaanta Cusubta");
    result.put("TZS","Shilingka Tansaaniya");
    result.put("UAH","Hirfiniyada Yukreeyn");
    result.put("UGX","Shilingka Uganda");
    result.put("UYU","Beeso Uruguay");
    result.put("UZS","Soom Usbekistan");
    result.put("VEF","Bolifar Fenesuala (2008–2018)");
    result.put("VES","Bolifar Fenezuela");
    result.put("VND","Dong Fitnaam");
    result.put("VUV","Fatu Fanuatu");
    result.put("WST","Tala Samao");
    result.put("XAF","Farank CFA ee Bartamaha Afrika");
    result.put("XCD","Doolaraka Bariga Kaaribyan");
    result.put("XOF","Faranka CFA Galbeedka Afrika");
    result.put("XPF","Farank CFP");
    result.put("XXX","Lacag aan la qoon ama aan saxnayn");
    result.put("YER","Riyaalka Yemen");
    result.put("ZAR","Randka Koonfur Afrika");
    result.put("ZMW","Kawajada Sambiya");
    return result;
  }
}
