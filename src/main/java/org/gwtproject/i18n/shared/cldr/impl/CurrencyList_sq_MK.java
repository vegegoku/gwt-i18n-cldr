...
public class CurrencyList_sq_MK extends CurrencyList_sq {
  public CurrencyData getDefault() {
    return new CurrencyDataImpl("MKD","den",2,"den","den");
  }
  ...
  protected HashMap<String, CurrencyData> loadCurrencyMap() {
    ...
    // Leku shqiptar
    result.put("ALL", new CurrencyDataImpl("ALL","Lekë",0,"Lekë","Lekë"));
    // Dramia armene
    ...
    // Denari maqedonas
    result.put("MKD", new CurrencyDataImpl("MKD","den",2,"den","den"));
    // MKN
  ...
  protected HashMap<String, String> loadNamesMap() {
    ...
    result.put("AED","Dirhami i Emirateve të Bashkuara Arabe");
    result.put("AFN","Afgani afgan");
    result.put("ALL","Leku shqiptar");
    result.put("AMD","Dramia armene");
    result.put("ANG","Gilderi antilian holandez");
    result.put("AOA","Kuanza e Angolës");
    result.put("ARS","Pesoja argjentinase");
    result.put("AUD","Dollari australian");
    result.put("AWG","Florini aruban");
    result.put("AZN","Manata azerbajxhanase");
    result.put("BAM","Marka e Bosnjë-Hercegovinës [e shkëmbyeshme]");
    result.put("BBD","Dollari barbadian");
    result.put("BDT","Taka e Bangladeshit");
    result.put("BGN","Leva bullgare");
    result.put("BHD","Dinari i Bahreinit");
    result.put("BIF","Franga burundiane");
    result.put("BMD","Dollari i Bermudeve");
    result.put("BND","Dollari i Bruneit");
    result.put("BOB","Boliviani i Bolivisë");
    result.put("BRL","Reali brazilian");
    result.put("BSD","Dollari i Bahamasit");
    result.put("BTN","Ngultrumi butanez");
    result.put("BWP","Pula botsuane");
    result.put("BYN","Rubla bjelloruse");
    result.put("BYR","Rubla bjelloruse (2000–2016)");
    result.put("BZD","Dollari i Ishujve Belize");
    result.put("CAD","Dollari kanadez");
    result.put("CDF","Franga kongole");
    result.put("CHF","Franga zvicerane");
    result.put("CLP","Pesoja kiliane");
    result.put("CNH","Juani kinez (për treg të jashtëm)");
    result.put("CNY","Juani kinez");
    result.put("COP","Pesoja kolumbiane");
    result.put("CRC","Koloni kostarikan");
    result.put("CUC","Pesoja kubaneze e shkëmbyeshme");
    result.put("CUP","Pesoja kubaneze");
    result.put("CVE","Eskudoja e Kepit të Gjelbër");
    result.put("CZK","Koruna e Çekisë");
    result.put("DJF","Franga xhibutiane");
    result.put("DKK","Korona daneze");
    result.put("DOP","Pesoja dominikane");
    result.put("DZD","Dinari algjerian");
    result.put("EGP","Sterlina egjiptiane");
    result.put("ERN","Nakfa e Eritresë");
    result.put("ETB","Bira etiopiane");
    result.put("EUR","Euroja");
    result.put("FJD","Dollari i Fixhit");
    result.put("FKP","Stërlina e Ishujve Falkland");
    result.put("GBP","Sterlina britanike");
    result.put("GEL","Laria gjeorgjiane");
    result.put("GHS","Sejda ganeze");
    result.put("GIP","Sterlina e Gjibraltarit");
    result.put("GMD","Dalasi gambian");
    result.put("GNF","Franga guinease");
    result.put("GTQ","Kuecali i Guatemalës");
    result.put("GYD","Dollari guajanez");
    result.put("HKD","Dollari i Hong-Kongut");
    result.put("HNL","Lempira hondurase");
    result.put("HRK","Kuna kroate");
    result.put("HTG","Gurdi haitian");
    result.put("HUF","Forinta hungareze");
    result.put("IDR","Rupia indoneziane");
    result.put("ILS","Shekeli izrealit");
    result.put("INR","Rupia indiane");
    result.put("IQD","Dinari irakian");
    result.put("IRR","Riali iranian");
    result.put("ISK","Korona islandeze");
    result.put("JMD","Dollari xhamajkan");
    result.put("JOD","Dinari jordanez");
    result.put("JPY","Jeni japonez");
    result.put("KES","Shilinga keniane");
    result.put("KGS","Soma kirgize");
    result.put("KHR","Riali kamboxhian");
    result.put("KMF","Franga komore");
    result.put("KPW","Uoni koreano-verior");
    result.put("KRW","Uoni koreano-jugor");
    result.put("KWD","Dinari kuvajtian");
    result.put("KYD","Dollari i Ishujve Kajman");
    result.put("KZT","Tenga kazake");
    result.put("LAK","Kipa e Laosit");
    result.put("LBP","Sterlina libaneze");
    result.put("LKR","Rupia e Sri-Lankës");
    result.put("LRD","Dollari liberian");
    result.put("LTL","Lita lituaneze");
    result.put("LVL","Lata letoneze");
    result.put("LYD","Dinari libian");
    result.put("MAD","Dirhami maroken");
    result.put("MDL","Leuja moldave");
    result.put("MGA","Arieri malagez");
    result.put("MKD","Denari maqedonas");
    result.put("MMK","Kiata e Mianmarit");
    result.put("MNT","Tugrika mongole");
    result.put("MOP","Pataka e Makaos");
    result.put("MRO","Ugija mauritane (1973–2017)");
    result.put("MRU","Ugija mauritane");
    result.put("MUR","Rupia mauritiane");
    result.put("MVR","Rufiu i Maldivit");
    result.put("MWK","Kuaça malaviane");
    result.put("MXN","Pesoja meksikane");
    result.put("MYR","Ringiti malajzian");
    result.put("MZN","Metikali i Mozambikut");
    result.put("NAD","Dollari i Namibisë");
    result.put("NGN","Naira nigeriane");
    result.put("NIO","Kordoba nikaraguane");
    result.put("NOK","Korona norvegjeze");
    result.put("NPR","Rupia nepaleze");
    result.put("NZD","Dollari i Zelandës së Re");
    result.put("OMR","Riali i Omanit");
    result.put("PAB","Balboa panameze");
    result.put("PEN","Sola peruane");
    result.put("PGK","Kina e Guinesë së Re-Papua");
    result.put("PHP","Pesoja filipinase");
    result.put("PKR","Rupia pakistaneze");
    result.put("PLN","Zllota polake");
    result.put("PYG","Guarani paraguaian");
    result.put("QAR","Riali i Katarit");
    result.put("RON","Leuja rumune");
    result.put("RSD","Dinari serb");
    result.put("RUB","Rubla ruse");
    result.put("RWF","Franga ruandeze");
    result.put("SAR","Riali saudit");
    result.put("SBD","Dollari i Ishujve Solomonë");
    result.put("SCR","Rupia e Ishujve Sishelë");
    result.put("SDG","Sterlina sudaneze");
    result.put("SEK","Korona suedeze");
    result.put("SGD","Dollari i Singaporit");
    result.put("SHP","Sterlina e Ishullit të Shën-Helenës");
    result.put("SLL","Leoni i Sierra-Leones");
    result.put("SOS","Shilinga somaleze");
    result.put("SRD","Dollari surinamez");
    result.put("SSP","Sterlina sudanezo-jugore");
    result.put("STD","Dobra e Sao-Tomes dhe Prinsipes (1977–2017)");
    result.put("STN","Dobra e Sao-Tomes dhe Prinsipes");
    result.put("SYP","Sterlina siriane");
    result.put("SZL","Lilangeni i Suazilandës");
    result.put("THB","Bata tajlandeze");
    result.put("TJS","Somona taxhike");
    result.put("TMT","Manata turkmene");
    result.put("TND","Dinari tunizian");
    result.put("TOP","Panga tongane");
    result.put("TRY","Lira turke");
    result.put("TTD","Dollari i Trinidadit dhe Tobagos");
    result.put("TWD","Dollari tajvanez");
    result.put("TZS","Shilinga e Tanzanisë");
    result.put("UAH","Rivnia ukrainase");
    result.put("UGX","Shilinga ugandeze");
    result.put("USD","Dollari amerikan");
    result.put("UYU","Pesoja uruguaiane");
    result.put("UZS","Soma uzbeke");
    result.put("VEF","Bolivari venezuelian (2008–2018)");
    result.put("VES","Bolivari venezuelas");
    result.put("VND","Donga vietnameze");
    result.put("VUV","Vatuja e Vanuatusë");
    result.put("WST","Tala samoane");
    result.put("XAF","Franga kamerunase");
    result.put("XCD","Dollari i Karaibeve Lindore");
    result.put("XOF","Franga e Bregut të Fildishtë");
    result.put("XPF","Franga franceze e Polinezisë");
    result.put("XXX","Valutë e panjohur");
    result.put("YER","Riali i Jemenit");
    result.put("ZAR","Randi afrikano-jugor");
    result.put("ZMW","Kuaça e Zambikut");
    return result;
  }
}
