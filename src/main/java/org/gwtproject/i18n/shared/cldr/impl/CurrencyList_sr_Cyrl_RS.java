...
public class CurrencyList_sr_Cyrl_RS extends CurrencyList_sr_Cyrl {
  ...
  protected HashMap<String, CurrencyData> loadCurrencyMap() {
    ...
    result.put("BAM", new CurrencyDataImpl("BAM","КМ",2,"КМ","КМ"));
  ...
  protected HashMap<String, String> loadNamesMap() {
    ...
    result.put("AED","УАЕ дирхам");
    result.put("AFA","Авганистански авгани (1927–2002)");
    result.put("AFN","Авганистански авгани");
    result.put("ALL","Албански лек");
    result.put("AMD","Јерменски драм");
    result.put("ANG","Холандскоантилски гулден");
    result.put("AOA","Анголска кванза");
    result.put("AOK","Анголијска кванза (1977–1990)");
    result.put("AON","Анголијска нова кванза (1990–2000)");
    result.put("AOR","Анголијска кванза реађустадо (1995–1999)");
    result.put("ARA","Аргентински аустрал");
    result.put("ARL","Аргентински пезос леј");
    result.put("ARM","Аргентински пезос монедо национал");
    ...
    result.put("BAM","Босанско-херцеговачка конвертибилна марка");
    result.put("BAN","Босанско-херцеговачки нови динар");
    ...
    result.put("BGM","Бугарски социјалистички лев");
    result.put("BGN","Бугарски лев");
    result.put("BGO","Стари бугарски лев");
    ...
    result.put("BOB","Боливијски боливијано");
    result.put("BOL","Стари боливијски боливијано");
    ...
    result.put("BRZ","Стари бразилски крузеиро");
    ...
    result.put("BYN","Белоруска рубља");
    result.put("BYR","Белоруска рубља (2000–2016)");
    result.put("BZD","Белиски долар");
    result.put("CAD","Канадски долар");
    result.put("CDF","Конгоански франак");
    result.put("CHE","WIR евро");
    result.put("CHF","Швајцарски франак");
    result.put("CHW","WIR франак");
    result.put("CLE","Чилеански ескудо");
    result.put("CLF","Чилеовски унидадес се фоменто");
    result.put("CLP","Чилеански пезос");
    result.put("CNH","Кинески јуан (острвски)");
    result.put("CNX","Долар кинеске народне банке");
    result.put("CNY","Кинески јуан");
    result.put("COP","Колумбијски пезос");
    ...
    result.put("CUC","Кубански конвертибилни пезос");
    ...
    result.put("ERN","Eритрејска накфa");
    ...
    result.put("FJD","Фиџијски долар");
    result.put("FKP","Фокландска фунта");
    ...
    result.put("IDR","Индонежанска рупија");
    ...
    result.put("MCF","Монегаскански франак");
    result.put("MDC","Молдовански купон");
    result.put("MDL","Молдавски леј");
    result.put("MGA","Мадагаскарски ариари");
    result.put("MGF","Малагасијски франак");
    result.put("MKD","Македонски денар");
    result.put("MKN","Стари македонски денар");
    result.put("MLF","Малијански франак");
    result.put("MMK","Мјанмарски кјат");
    result.put("MNT","Монголски тугрик");
    result.put("MOP","Макаоска патака");
    result.put("MRO","Мауританијска oгија (1973–2017)");
    result.put("MRU","Мауританијска oгија");
    result.put("MTL","Малтешка лира");
    result.put("MTP","Малтешка фунта");
    result.put("MUR","Маурицијска рупија");
    result.put("MVR","Малдивска руфија");
    result.put("MWK","Малавијска квача");
    result.put("MXN","Мексички пезос");
    result.put("MXP","Мексички сребрни пезо (1861–1992)");
    result.put("MXV","Мексички унидад де инверсион (UDI)");
    result.put("MYR","Малезијски рингит");
    result.put("MZE","Мозамбијски ескудо");
    result.put("MZM","Стари мозамбијски метикал");
    result.put("MZN","Мозамбички метикал");
    result.put("NAD","Намибијски долар");
    ...
    result.put("NPR","Непалскa рупиja");
    ...
    result.put("SLL","Сијералеонски леоне");
    result.put("SOS","Сомалијски шилинг");
    result.put("SRD","Суринамски долар");
    result.put("SRG","Суринамски гилдер");
    result.put("SSP","Јужносуданска фунта");
    result.put("STD","Саотомска добра (1977–2017)");
    result.put("STN","Саотомска добра");
    ...
    result.put("THB","Тајландски бат");
    result.put("TJR","Таџихистанска рубља");
    result.put("TJS","Таџикистански сомон");
    result.put("TMM","Туркменистански манат (1993–2009)");
    result.put("TMT","Туркменистански манат");
    result.put("TND","Туниски динар");
    result.put("TOP","Тонганска панга");
    ...
    result.put("VEB","Венецуелански боливар (1871–2008)");
    result.put("VEF","Венецуелански боливар (2008–2018)");
    result.put("VES","Венецуелански боливар");
    result.put("VND","Вијетнамски донг");
    result.put("VNN","Вијетнамски донг (1978–1985)");
    ...
    result.put("XCD","Источнокарипски долар");
    ...
    result.put("XOF","ЦФА франак БЦЕАО");
    ...
    result.put("YUR","Југословенски реформирани динар");
    result.put("ZAL","Јужно-афрички ранд (финансијски)");
    result.put("ZAR","Јужноафрички ранд");
    result.put("ZMK","Замбијска квача (1968–2012)");
    result.put("ZMW","Замбијска квача");
    result.put("ZRN","Заирски нови заир");
    result.put("ZRZ","Заирски заир");
    result.put("ZWD","Зимбабвеански долар (1980–2008)");
