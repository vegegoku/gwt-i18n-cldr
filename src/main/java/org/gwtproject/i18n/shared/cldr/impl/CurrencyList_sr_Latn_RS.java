...
public class CurrencyList_sr_Latn_RS extends CurrencyList_sr_Latn {
  public CurrencyData getDefault() {
    return new CurrencyDataImpl("RSD","RSD",0,"RSD","RSD");
  }
  ...
  protected HashMap<String, String> loadNamesMap() {
    ...
    result.put("AFN","Avganistanski avgani");
    ...
    result.put("AOK","Angolijska kvanza (1977–1990)");
    result.put("AON","Angolijska nova kvanza (1990–2000)");
    result.put("AOR","Angolijska kvanza reađustado (1995–1999)");
    result.put("ARA","Argentinski austral");
    result.put("ARL","Argentinski pezos lej");
    result.put("ARM","Argentinski pezos monedo nacional");
    ...
    result.put("BEC","Belgijski franak (konvertibilni)");
    result.put("BEF","Belgijski franak");
    result.put("BEL","Belgijski franak (finansijski)");
    ...
    result.put("BOB","Bolivijski bolivijano");
    ...
    result.put("BRC","Brazilijski kruzado");
    result.put("BRE","Brazilski kruzeiro (1990–1993)");
    result.put("BRL","Brazilski real");
    result.put("BRN","Brazilijski novi kruzado");
    ...
    result.put("BYN","Beloruska rublja");
    result.put("BYR","Beloruska rublja (2000–2016)");
    result.put("BZD","Beliski dolar");
    ...
    result.put("GQE","Ekvatorijalno-gvinejski ekvele");
    ...
    result.put("MCF","Monegaskanski franak");
    result.put("MDC","Moldovanski kupon");
    result.put("MDL","Moldavski lej");
    result.put("MGA","Madagaskarski ariari");
    ...
    result.put("MOP","Makaoska pataka");
    result.put("MRO","Mauritanijska ogija (1973–2017)");
    result.put("MRU","Mauritanijska ogija");
    ...
    result.put("MZN","Mozambički metikal");
    ...
    result.put("PES","Peruanski sol (1863–1965)");
    result.put("PGK","Papuanska kina");
    ...
    result.put("RHD","Rodejskidolar");
    result.put("ROL","Rumunski lej (1952–2006)");
    ...
    result.put("SHP","Sv. jelenska funta");
    result.put("SIT","Slovenački tolar");
    ...
    result.put("STD","Saotomska dobra (1977–2017)");
    result.put("STN","Saotomska dobra");
    ...
    result.put("TJR","Tadžihistanska rublja");
    result.put("TJS","Tadžikistanski somon");
    ...
    result.put("TTD","Trinidad-tobagoški dolar");
    ...
    result.put("UYI","Urugvajski pezo en unidades indeksadas");
    ...
    result.put("ZAL","Južno-afrički rand (finansijski)");
