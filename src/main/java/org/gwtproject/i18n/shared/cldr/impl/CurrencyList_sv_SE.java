...
public class CurrencyList_sv_SE extends CurrencyList_sv {
  ...
  protected HashMap<String, CurrencyData> loadCurrencyMap() {
    ...
    // Barbados-dollar
    result.put("BBD", new CurrencyDataImpl("BBD","Bds$",2,"Bds$","Bds$"));
    // bangladeshisk taka
    ...
    // brasiliansk real
    result.put("BRL", new CurrencyDataImpl("BRL","BR$",2,"BR$","BR$"));
    ...
    // dansk krona
    result.put("DKK", new CurrencyDataImpl("DKK","Dkr",2,"Dkr","Dkr"));
    // dominikansk peso
    ...
    // egyptiskt pund
    result.put("EGP", new CurrencyDataImpl("EGP","EG£",2,"EG£","EG£"));
    // eritreansk nakfa
    ...
    // isländsk krona
    result.put("ISK", new CurrencyDataImpl("ISK","Ikr",0,"Ikr","Ikr"));
    // italiensk lire
    result.put("ITL", new CurrencyDataImpl("ITL","ITL",128,"ITL","ITL"));
    // Jamaica-dollar
    result.put("JMD", new CurrencyDataImpl("JMD","JM$",2,"JM$","JM$"));
    // jordansk dinar
    ...
    // norsk krona
    result.put("NOK", new CurrencyDataImpl("NOK","Nkr",2,"Nkr","Nkr"));
    // nepalesisk rupie
