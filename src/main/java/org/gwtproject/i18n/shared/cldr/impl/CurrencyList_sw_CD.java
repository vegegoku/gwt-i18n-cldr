...
public class CurrencyList_sw_CD extends CurrencyList_sw {
  public CurrencyData getDefault() {
    return new CurrencyDataImpl("CDF","FC",2,"FC","FC");
  }
  ...
  protected HashMap<String, CurrencyData> loadCurrencyMap() {
    ...
    // Faranga ya Kongo
    result.put("CDF", new CurrencyDataImpl("CDF","FC",2,"FC","FC"));
    // CHE
  ...
  protected HashMap<String, String> loadNamesMap() {
    ...
    result.put("CNY","Yuan Renminbi ya China");
    ...
    result.put("ETB","Bir ya Uhabeshi");
    result.put("EUR","Yuro");
    ...
    result.put("JPY","Sarafu ya Kijapani");
    ...
    result.put("MGA","Ariary ya Bukini");
    ...
    result.put("MRO","Ugwiya ya Moritania (1973–2017)");
    result.put("MRU","Ugwiya ya Moritania");
    ...
    result.put("SCR","Rupia ya Shelisheli");
    ...
    result.put("XAF","Faranga CFA BEAC");
    result.put("XCD","Dola ya Caribbean Mashariki");
    result.put("XOF","Faranga CFA BCEAO");
