...
public class CurrencyList_sw_UG extends CurrencyList_sw {
  public CurrencyData getDefault() {
    return new CurrencyDataImpl("UGX","USh",0,"USh","USh");
  }
  ...
  protected HashMap<String, CurrencyData> loadCurrencyMap() {
    ...
    result.put("TZS", new CurrencyDataImpl("TZS","TSh",2,"TSh","TSh"));
    // Hryvnia ya Ukraine
    ...
    // Shilingi ya Uganda
    result.put("UGX", new CurrencyDataImpl("UGX","USh",0,"USh","USh"));
    // Dola ya Marekani
  ...
  protected HashMap<String, String> loadNamesMap() {
    ...
    result.put("AED","Dirham ya Falme za Kiarabu");
    result.put("AFN","Afghani ya Afghanistan");
    result.put("ALL","Lek ya Albania");
    result.put("AMD","Dram ya Armenia");
    result.put("ANG","Guilder ya Antili za Kiholanzi");
    result.put("AOA","Kwanza ya Angola");
    result.put("ARS","Peso ya Argentina");
    result.put("AUD","Dola ya Australia");
    result.put("AWG","Florin ya Aruba");
    result.put("AZN","Manat ya Azerbaijan");
    result.put("BAM","Convertible Mark ya Bosnia na Hezegovina");
    result.put("BBD","Dola ya Barbados");
    result.put("BDT","Taka ya Bangladesh");
    result.put("BGN","Lev ya Bulgaria");
    result.put("BHD","Dinar ya Bahrain");
    result.put("BIF","Faranga ya Burundi");
    result.put("BMD","Dola ya Bermuda");
    result.put("BND","Dola ya Brunei");
    result.put("BOB","Boliviano ya Bolivia");
    result.put("BRL","Real ya Brazil");
    result.put("BSD","Dola ya Bahamas");
    result.put("BTN","Ngultrum ya Bhutan");
    result.put("BWP","Pula ya Botswana");
    result.put("BYN","Ruble ya Belarus");
    result.put("BYR","Ruble ya Belarusi (2000–2016)");
    result.put("BZD","Dola ya Belize");
    result.put("CAD","Dola ya Canada");
    result.put("CDF","Faranga ya Kongo");
    result.put("CHF","Faranga ya Uswisi");
    result.put("CLP","Peso ya Chile");
    result.put("CNH","Yuan ya Uchina (huru)");
    result.put("CNY","Yuan ya Uchina");
    result.put("COP","Peso ya Colombia");
    result.put("CRC","Colon ya Costa Rica");
    result.put("CUC","Peso ya Cuba Inayoweza Kubadilishwa");
    result.put("CUP","Peso ya Cuba");
    result.put("CVE","Eskudo ya Cape Verde");
    result.put("DJF","Faranga ya Djibouti");
    result.put("DKK","Krone ya Denmark");
    result.put("DOP","Peso ya Dominica");
    result.put("DZD","Dinar ya Aljeria");
    result.put("EGP","Pauni ya Misri");
    result.put("ERN","Nakfa ya Eritrea");
    result.put("ETB","Birr ya Uhabeshi");
    result.put("EUR","Yuro");
    result.put("FJD","Dola ya Fiji");
    result.put("FKP","Pauni ya Visiwa vya Falkland");
    result.put("GBP","Pauni ya Uingereza");
    result.put("GEL","Lari ya Georgia");
    result.put("GHC","Sedi ya Ghana");
    result.put("GHS","Cedi ya Ghana");
    result.put("GIP","Pauni ya Gibraltar");
    result.put("GMD","Dalasi ya Gambia");
    result.put("GNF","Faranga ya Guinea");
    result.put("GNS","Faranga ya Gine");
    result.put("GTQ","Quetzal ya Guatemala");
    result.put("GYD","Dola ya Guyana");
    result.put("HKD","Dola ya Hong Kong");
    result.put("HNL","Lempira ya Hondurasi");
    result.put("HRK","Kuna ya Croatia");
    result.put("HTG","Gourde ya Haiti");
    result.put("HUF","Forint ya Hungaria");
    result.put("IDR","Rupiah ya Indonesia");
    result.put("ILS","Shekeli Mpya ya Israel");
    result.put("INR","Rupia ya India");
    result.put("IQD","Dinar ya Iraq");
    result.put("IRR","Rial ya Iran");
    result.put("ISK","Krona ya Aisilandi");
    result.put("JMD","Dola ya Jamaica");
    result.put("JOD","Dinar ya Jordan");
    result.put("JPY","Yen ya Ujapani");
    result.put("KES","Shilingi ya Kenya");
    result.put("KGS","Som ya Kyrgystan");
    result.put("KHR","Riel ya Cambodia");
    result.put("KMF","Faranga ya Comoros");
    result.put("KPW","Won ya Korea Kaskazini");
    result.put("KRW","Won ya Korea Kusini");
    result.put("KWD","Dinar ya Kuwait");
    result.put("KYD","Dola ya Visiwa vya Cayman");
    result.put("KZT","Tenge ya Kazakhstan");
    result.put("LAK","Kip ya Laosi");
    result.put("LBP","Pauni ya Lebanon");
    result.put("LKR","Rupia ya Sri Lanka");
    result.put("LRD","Dola ya Liberia");
    result.put("LSL","Loti ya Lesoto");
    result.put("LTL","Litas ya Lithuania");
    result.put("LVL","Lats ya Lativia");
    result.put("LYD","Dinari ya Libya");
    result.put("MAD","Dirham ya Morocco");
    result.put("MDL","Leu ya Moldova");
    result.put("MGA","Ariari ya Madagascar");
    result.put("MKD","Denar ya Macedonia");
    result.put("MMK","Kyat ya Myanmar");
    result.put("MNT","Tugrik ya Mongolia");
    result.put("MOP","Pataca ya Macau");
    result.put("MRO","Ouguiya ya Mauritania (1973–2017)");
    result.put("MRU","Ouguiya ya Mauritania");
    result.put("MUR","Rupia ya Mauritius");
    result.put("MVR","Rufiyaa ya Maldives");
    result.put("MWK","Kwacha ya Malawi");
    result.put("MXN","Peso ya Mexico");
    result.put("MYR","Ringgit ya Malaysia");
    result.put("MZM","Metikali ya Msumbiji (1980–2006)");
    result.put("MZN","Metikali ya Msumbiji");
    result.put("NAD","Dola ya Namibia");
    result.put("NGN","Naira ya Nigeria");
    result.put("NIO","Cordoba ya Nicaragua");
    result.put("NOK","Krone ya Norway");
    result.put("NPR","Rupia ya Nepal");
    result.put("NZD","Dola ya New Zealand");
    result.put("OMR","Rial ya Omani");
    result.put("PAB","Balboa ya Panama");
    result.put("PEN","Sol ya Peru");
    result.put("PGK","Kina ya Papua New Guinea");
    result.put("PHP","Peso ya Ufilipino");
    result.put("PKR","Rupia ya Pakistan");
    result.put("PLN","Zloty ya Poland");
    result.put("PYG","Guarani ya Paraguay");
    result.put("QAR","Rial ya Qatar");
    result.put("RON","Leu ya Romania");
    result.put("RSD","Dinar ya Serbia");
    result.put("RUB","Ruble ya Urusi");
    result.put("RWF","Faranga ya Rwanda");
    result.put("SAR","Riyal ya Saudia");
    result.put("SBD","Dola ya Visiwa vya Solomon");
    result.put("SCR","Rupia ya Ushelisheli");
    result.put("SDG","Pauni ya Sudan");
    result.put("SDP","Pauni ya Sudani (1957–1998)");
    result.put("SEK","Krona ya Uswidi");
    result.put("SGD","Dola ya Singapore");
    result.put("SHP","Pauni ya St. Helena");
    result.put("SLL","Leone");
    result.put("SOS","Shilingi ya Somalia");
    result.put("SRD","Dola ya Suriname");
    result.put("SSP","Pauni ya Sudan Kusini");
    result.put("STD","Dobra ya Sao Tome na Principe (1977–2017)");
    result.put("STN","Dobra ya Sao Tome na Principe");
    result.put("SYP","Pauni ya Syria");
    result.put("SZL","Lilangeni");
    result.put("THB","Baht ya Tailandi");
    result.put("TJS","Somoni ya Tajikistan");
    result.put("TMT","Manat ya Turkmenistan");
    result.put("TND","Dinari ya Tunisia");
    result.put("TOP","Paʻanga ya Tonga");
    result.put("TRY","Lira ya Uturuki");
    result.put("TTD","Dola ya Trinidad na Tobago");
    result.put("TWD","Dola ya Taiwan");
    result.put("TZS","Shilingi ya Tanzania");
    result.put("UAH","Hryvnia ya Ukraine");
    result.put("UGX","Shilingi ya Uganda");
    result.put("USD","Dola ya Marekani");
    result.put("UYU","Peso ya Uruguay");
    result.put("UZS","Som ya Uzbekistan");
    result.put("VEF","Bolivar ya Venezuela (2008–2018)");
    result.put("VES","Bolivar ya Venezuela");
    result.put("VND","Dong ya Vietnam");
    result.put("VUV","Vatu ya Vanuatu");
    result.put("WST","Tala ya Samoa");
    result.put("XAF","Faranga ya Afrika ya Kati CFA");
    result.put("XCD","Dola ya Caribbean Mashariki");
    result.put("XOF","Faranga ya Afrika Magharibi CFA");
    result.put("XPF","Faranga ya CFP");
    result.put("XXX","Sarafu isiyojulikana");
    result.put("YER","Rial ya Yemen");
    result.put("ZAR","Randi ya Afrika Kusini");
    result.put("ZMK","Kwacha ya Zambia (1968–2012)");
    result.put("ZMW","Kwacha ya Zambia");
    result.put("ZWD","Dola ya Zimbabwe");
    return result;
  }
}
