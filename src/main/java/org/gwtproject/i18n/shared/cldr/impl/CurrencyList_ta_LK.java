...
public class CurrencyList_ta_LK extends CurrencyList_ta {
  public CurrencyData getDefault() {
    return new CurrencyDataImpl("LKR","Rs.",2,"Rs.","Rs.");
  }
  ...
  protected HashMap<String, CurrencyData> loadCurrencyMap() {
    ...
    // இலங்கை ரூபாய்
    result.put("LKR", new CurrencyDataImpl("LKR","Rs.",2,"Rs.","Rs."));
    // லைபீரியன் டாலர்
  ...
  protected HashMap<String, String> loadNamesMap() {
    ...
    result.put("AMD","ஆர்மேனியன் ட்ராம்");
    result.put("ANG","நெதர்லேண்ட்ஸ் அன்டிலியன் கில்டர்");
    result.put("AOA","அங்கோலன் க்வான்ஸா");
    result.put("ARS","அர்ஜென்டைன் பெசோ");
    result.put("AUD","ஆஸ்திரேலிய டாலர்");
    result.put("AWG","அருபன் ஃப்ளோரின்");
    result.put("AZN","அசர்பைஜானி மனத்");
    result.put("BAM","போஸ்னியா-ஹெர்ஸேகோவினா கன்வெர்டிபில் மார்க்");
    result.put("BBD","பார்பேடியன் டாலர்");
    result.put("BDT","பங்களாதேஷி டாகா");
    result.put("BGN","பல்கேரியன் லேவ்");
    result.put("BHD","பஹ்ரைனி தினார்");
    result.put("BIF","புருண்டியன் ஃப்ராங்க்");
    result.put("BMD","பெர்முடன் டாலர்");
    result.put("BND","புரூனே டாலர்");
    result.put("BOB","பொலிவியன் பொலிவியானோ");
    result.put("BRL","பிரேசிலியன் ரியால்");
    result.put("BSD","பஹாமியன் டாலர்");
    result.put("BTN","பூட்டானீஸ் குல்ட்ரம்");
    result.put("BWP","போட்ஸ்வானன் புலா");
    result.put("BYN","பெலருசியன் ரூபிள்");
    result.put("BYR","பெலருசியன் ரூபிள் (2000–2016)");
    result.put("BZD","பெலீஸ் டாலர்");
    result.put("CAD","கனடியன் டாலர்");
    result.put("CDF","காங்கோலீஸ் ஃப்ராங்க்");
    ...
    result.put("CUC","கியூபன் கன்வெர்டிபில் பெசோ");
    ...
    result.put("DKK","டேனிஷ் க்ரோன்");
    result.put("DOP","டொமினிக்கன் பெசோ");
    result.put("DZD","அல்ஜீரியன் தினார்");
    result.put("EGP","எகிப்திய பவுண்டு");
    result.put("ERN","எரித்ரியன் நக்ஃபா");
    result.put("ETB","எத்தியோப்பியன் பிர்");
    result.put("EUR","யூரோ");
    result.put("FJD","ஃபிஜியன் டாலர்");
    result.put("FKP","ஃபாக்லாந்து தீவுகள் பவுண்டு");
    result.put("GBP","பிரிட்டிஷ் பவுண்டு");
    result.put("GEL","ஜார்ஜியன் லாரி");
    result.put("GHS","கானயன் சேடி");
    result.put("GIP","ஜிப்ரால்டர் பவுண்டு");
    result.put("GMD","கேம்பியன் தலாசி");
    result.put("GNF","கினியன் ஃப்ராங்க்");
    result.put("GTQ","குவாதெமாலன் க்யுட்ஸல்");
    result.put("GYD","கயானீஸ் டாலர்");
    result.put("HKD","ஹாங்காங் டாலர்");
    result.put("HNL","ஹோன்டூரன் லெம்பீரா");
    result.put("HRK","குரோஷியன் குனா");
    result.put("HTG","ஹைட்டியன் கோர்டே");
    result.put("HUF","ஹங்கேரியன் ஃபோரின்ட்");
    result.put("IDR","இந்தோனேஷியன் ருபியா");
    result.put("ILS","இஸ்ரேலி நியூ ஷிகேல்");
    result.put("INR","இந்திய ரூபாய்");
    result.put("IQD","ஈராக்கி தினார்");
    result.put("IRR","ஈரானியன் ரியால்");
    result.put("ISK","ஐஸ்லாண்டிக் க்ரோனா");
    result.put("JMD","ஜமைக்கன் டாலர்");
    result.put("JOD","ஜோர்டானிய தினார்");
    result.put("JPY","ஜப்பானிய யென்");
    result.put("KES","கென்யன் ஷில்லிங்");
    result.put("KGS","கிர்கிஸ்தானி சோம்");
    ...
    result.put("LAK","லவோஷியன் கிப்");
    result.put("LBP","லெபனீஸ் பவுண்டு");
    result.put("LKR","இலங்கை ரூபாய்");
    result.put("LRD","லைபீரியன் டாலர்");
    result.put("LSL","லெசோதோ லோட்டி");
    result.put("LTL","லிதுவேனியன் லிடஸ்");
    result.put("LVL","லத்வியன் லாட்ஸ்");
    result.put("LYD","லிபியன் தினார்");
    result.put("MAD","மொராக்கன் திர்ஹாம்");
    result.put("MDL","மால்டோவன் லியூ");
    result.put("MGA","மலகாசி ஏரியரி");
    result.put("MKD","மாசிடோனியன் டேனார்");
    result.put("MMK","மியான்மர் கியாத்");
    result.put("MNT","மங்கோலியன் டுக்ரிக்");
    result.put("MOP","மெகனீஸ் படாகா");
    result.put("MRO","மொரிஷானியன் ஒகுயா (1973–2017)");
    result.put("MRU","மொரிஷானியன் ஒகுயா");
    result.put("MUR","மொரீஷியன் ருபீ");
    result.put("MVR","மாலத்தீவு ருஃபியா");
    result.put("MWK","மலாவியன் குவாச்சா");
    result.put("MXN","மெக்ஸிகன் பெசோ");
    result.put("MYR","மலேஷியன் ரிங்கிட்");
    result.put("MZN","மொசாம்பிகன் மெடிகல்");
    result.put("NAD","நமீபியன் டாலர்");
    result.put("NGN","நைஜீரியன் நைரா");
    result.put("NIO","நிகரகுவன் கோர்டோபா");
    result.put("NOK","நார்வேஜியன் க்ரோன்");
    result.put("NPR","நேபாளீஸ் ரூபாய்");
    result.put("NZD","நியூசிலாந்து டாலர்");
    result.put("OMR","ஓமானி ரியால்");
    result.put("PAB","பனாமானியன் பால்போவா");
    result.put("PEN","பெரூவியன் சோல்");
    result.put("PGK","பபுவா நியூ கினியன் கினா");
    result.put("PHP","பிலிப்பைன் பெசோ");
    result.put("PKR","பாகிஸ்தானி ரூபாய்");
    result.put("PLN","போலிஷ் ஸ்லாட்டி");
    result.put("PYG","பராகுவன் குவாரானி");
    result.put("QAR","கத்தாரி ரியால்");
    result.put("RON","ரோமானியன் லியூ");
    result.put("RSD","செர்பியன் தினார்");
    result.put("RUB","ரஷியன் ரூபிள்");
    result.put("RWF","ருவாண்டன் ஃப்ராங்க்");
    result.put("SAR","சவுதி ரியால்");
    result.put("SBD","சாலமன் தீவுகள் டாலர்");
    result.put("SCR","சிசீலோயிஸ் ருபீ");
    result.put("SDG","சூடானீஸ் பவுண்டு");
    result.put("SEK","ஸ்வீடிஷ் க்ரோனா");
    result.put("SGD","சிங்கப்பூர் டாலர்");
    result.put("SHP","செயின்ட் ஹெலேனா பவுண்டு");
    result.put("SLL","சியாரா லியோனியன் லியோன்");
    result.put("SOS","சோமாலி ஷில்லிங்");
    result.put("SRD","சுரினாமீஸ் டாலர்");
    result.put("SSP","தெற்கு சூடானீஸ் பவுண்டு");
    result.put("STD","சாவ் டோமி மற்றும் பிரின்ஸ்பி டோப்ரா (1977–2017)");
    result.put("STN","சாவ் டோமி மற்றும் பிரின்ஸ்பி டோப்ரா");
    result.put("SYP","சிரியன் பவுண்டு");
    result.put("SZL","சுவாஸி லிலாங்கனி");
    result.put("THB","தாய் பாட்");
    result.put("TJS","தஜிகிஸ்தானி சோமோனி");
    result.put("TMT","துர்க்மெனிஸ்தானி மனத்");
    result.put("TND","துனிஷியன் தினார்");
    result.put("TOP","தொங்கான் பங்கா");
    result.put("TRY","துருக்கிஷ் லீரா");
    result.put("TTD","டிரினிடாட் மற்றும் டோபாகோ டாலர்");
    result.put("TWD","புதிய தைவான் டாலர்");
    result.put("TZS","தான்சானியன் ஷில்லிங்");
    result.put("UAH","உக்ரைனியன் ஹிரைவ்னியா");
    result.put("UGX","உகாண்டன் ஷில்லிங்");
    result.put("USD","அமெரிக்க டாலர்");
    result.put("UYU","உருகுவேயன் பெசோ");
    result.put("UZS","உஸ்பெக்கிஸ்தானி சோம்");
    result.put("VEF","வெனிசுலன் போலிவர் (2008–2018)");
    result.put("VES","வெனிசுலன் போலிவர்");
    result.put("VND","வியட்நாமீஸ் டாங்");
    result.put("VUV","வனுவாட்டு வாட்டு");
    result.put("WST","சமோவான் தாலா");
    result.put("XAF","மத்திய ஆப்பிரிக்க CFA ஃப்ராங்க்");
    result.put("XCD","கிழக்கு கரீபியன் டாலர்");
    result.put("XOF","மேற்கு ஆப்பிரிக்க CFA ஃப்ராங்க்");
    result.put("XPF","ஃப்ராங்க் (CFP)");
    result.put("XXX","தெரியாத நாணயம்");
    result.put("YER","ஏமனி ரியால்");
    result.put("ZAR","தென் ஆப்ரிக்க ராண்ட்");
    result.put("ZMK","ஸாம்பியன் குவாசா (1968–2012)");
    result.put("ZMW","ஸாம்பியன் குவாச்சா");
    return result;
  }
}
