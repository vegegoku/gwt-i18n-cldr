...
public class CurrencyList_te_IN extends CurrencyList_te {
  ...
  protected HashMap<String, String> loadNamesMap() {
    ...
    result.put("ANG","నెదర్లాండ్స్ యాంటిల్లియన్ గిల్‌డర్");
    ...
    result.put("BAM","బోస్నియా-హెర్జగోవినా మార్పిడి చెయ్యగలిగే మార్క్");
    result.put("BBD","బర్బాడియన్ డాలర్");
    result.put("BDT","బాంగ్లాదేశ్ టాకా");
    result.put("BGN","బల్గేరియన్ లేవ్");
    result.put("BHD","బహ్రెయిన్ దినార్");
    ...
    result.put("BRL","బ్రెజిలియన్ రియల్");
    result.put("BSD","బహామియన్ డాలర్");
    result.put("BTN","భూటానీయుల గుల్‌ట్రుమ్");
    result.put("BWP","బోట్స్‌వానా పులా");
    result.put("BYN","బెలరూసియన్ రూబల్");
    result.put("BYR","బెలరూసియన్ రూబల్ (2000–2016)");
    ...
    result.put("CNH","చైనీస్ యూవాన్ (ఆఫ్‌షోర్)");
    result.put("CNY","చైనా దేశ యువాన్");
    result.put("COP","కొలంబియన్ పెసో");
    result.put("CRC","కోస్టా రికన్ కోలోన్");
    result.put("CUC","క్యూబన్ కన్వర్టబుల్ పెసో");
    ...
    result.put("MKD","మెసిడోనియన్ దినార్");
    result.put("MMK","మయన్మార్ క్యాట్");
    result.put("MNT","మంగోలియన్ టుగ్రిక్");
    result.put("MOP","మకనీస్ పటాక");
    result.put("MRO","మౌరిటానియన్ ఒగ్యియా (1973–2017)");
    result.put("MRU","మౌరిటానియన్ ఒగ్యియా");
    result.put("MUR","మారిషన్ రూపాయి");
    result.put("MVP","మాల్దీవుల రూపాయి");
    ...
    result.put("MZN","మొజాంబికన్ మెటికల్");
    result.put("NAD","నమిబియన్ డాలర్");
    result.put("NGN","నైజీరియన్ నైరా");
    ...
    result.put("PAB","పనామనియన్ బల్బోవ");
    result.put("PEN","పెరువియన్ సోల్");
    ...
    result.put("RON","రోమానియాన్ లెయు");
    result.put("RSD","సెర్బియన్ దీనార్");
    result.put("RUB","రష్యన్ రూబల్");
    result.put("RWF","ర్వానడాన్ ఫ్రాంక్");
    result.put("SAR","సౌది రియల్");
    result.put("SBD","సోలోమన్ దీవుల డాలర్");
    ...
    result.put("SSP","దక్షిణ సుడానీస్ పౌండ్");
    result.put("STD","సావో టోమ్ మరియు ప్రిన్సిపి డోబ్రా (1977–2017)");
    result.put("STN","సావో టోమ్ మరియు ప్రిన్సిపి డోబ్రా");
    result.put("SYP","సిరీయన్ పౌండ్");
    result.put("SZL","స్వాజి లిలాన్గేని");
    result.put("THB","థాయ్ బాట్");
    result.put("TJS","తజికిస్థాన్ సమోని");
    result.put("TMT","తుర్క్‌మెనిస్థాని మనాట్");
    ...
    result.put("UGX","ఉగాండన్ షిల్లింగ్");
    result.put("USD","అమెరికా డాలర్");
    result.put("UYU","ఉరుగ్వెయన్ పెసో");
    result.put("UZS","ఉజ్‌బెకిస్తాన్ సౌమ్");
    result.put("VEF","వెనుజులా బోలివర్ (2008–2018)");
    result.put("VES","వెనుజులా బోలివర్");
    result.put("VND","వియత్నామీయుల డాంగ్");
    result.put("VUV","వనాటు వటు");
    result.put("WST","సమోయన్ తాలా");
    result.put("XAF","సెంట్రల్ ఆఫ్రికన్ సిఎఫ్‌ఎ ఫ్రాంక్");
    result.put("XAG","వెండి");
    result.put("XAU","బంగారం");
    result.put("XCD","తూర్పు కరీబియన్ డాలర్");
    result.put("XOF","పశ్చిమ ఆఫ్రికన్ సిఏఫ్ఏ ఫ్రాంక్");
    ...
    result.put("ZMK","జాంబియన్ క్వాచా (1968–2012)");
    result.put("ZMW","జాంబియన్ క్వాచా");
    return result;
  }
}
