...
public class CurrencyList_teo_UG extends CurrencyList_teo {
  ...
  protected HashMap<String, String> loadNamesMap() {
    ...
    result.put("BHD","Ango’otol lok’ Bahareni");
    result.put("BIF","Ango’otol lok’ Burundi");
    result.put("BWP","Ango’otol lok’ Botswana");
    result.put("CAD","Edola lok’Kanada");
    result.put("CDF","Ango’otol lok’ Kongo");
    result.put("CHF","Ango’otol lok’ Uswisi");
    result.put("CNY","Ango’otol lok’ China");
    result.put("CVE","Ango’otol lok’ Kepuvede");
    result.put("DJF","Ango’otol lok’ Jibuti");
    result.put("DZD","Ango’otol lok’ Aljeria");
    result.put("EGP","Epaunt lok’ Misri");
    result.put("ERN","Ango’otol lok’ Eritrea");
    result.put("ETB","Ango’otol lok’ Uhabeshi");
    result.put("EUR","Yuro");
    result.put("GBP","Epaunt lok’ Uingereza");
    result.put("GHC","Sedi ya Ghana");
    result.put("GMD","Dalasi ya Gambia");
    result.put("GNS","Ango’otol lok’ Gine");
    result.put("INR","Ango’otol lok’ India");
    result.put("JPY","Ango’otol lok’ Kijapani");
    result.put("KES","Ango’otol lok’ Kenya");
    result.put("KMF","Ango’otol lok’ Komoro");
    result.put("LRD","edola lok’ Liberia");
    result.put("LSL","Ango’otol lok’ Lesoto");
    result.put("LYD","Ango’otol lok’ Libya");
    result.put("MAD","Ango’otol lok’ Moroko");
    result.put("MGA","Ango’otol lok’ Bukini");
    result.put("MRO","Ango’otol lok’ Moritania (1973–2017)");
    result.put("MRU","Ango’otol lok’ Moritania");
    result.put("MUR","Ango’otol lok’ Morisi");
    result.put("MWK","Ango’otol lok’ Malawi");
    result.put("MZM","Ango’otol lok’ Msumbiji");
    result.put("NAD","Ango’otol lok’ Namibia");
    result.put("NGN","Ango’otol lok’ Nijeria");
    result.put("RWF","Ango’otol lok’ Rwanda");
    result.put("SAR","Ango’otol lok’ Saudia");
    result.put("SCR","Ango’otol lok’ Shelisheli");
    result.put("SDG","Epaunt Lok’ Sudan");
    result.put("SHP","Ango’otol lok’ Santahelena");
    result.put("SLL","Leoni");
    result.put("SOS","Ango’otol lok’ Somalia");
    result.put("STD","Ango’otol lok’ Sao Tome na Principe (1977–2017)");
    result.put("STN","Ango’otol lok’ Sao Tome na Principe");
    result.put("SZL","Lilangeni");
    result.put("TND","Ango’otol lok’ Tunisia");
    result.put("TZS","Ango’otol lok’ Tanzania");
    result.put("UGX","Ango’otol lok’ Uganda");
    result.put("USD","edola lok’ Amareka");
    result.put("XAF","Ango’otol lok’ CFA BEAC");
    result.put("XOF","Ango’otol lok’ CFA BCEAO");
    result.put("ZAR","Ango’otol lok’ Afrika Kusini");
    result.put("ZMK","Ango’otol lok’ Zambia (1968–2012)");
    result.put("ZMW","Ango’otol lok’ Zambia");
    result.put("ZWD","Edola lok’Zimbabwe");
    return result;
  }
}
