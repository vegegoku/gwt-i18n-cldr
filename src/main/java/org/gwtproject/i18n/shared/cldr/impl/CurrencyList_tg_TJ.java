...
public class CurrencyList_tg_TJ extends CurrencyList_tg {
  public CurrencyData getDefault() {
    return new CurrencyDataImpl("TJS","сом.",2,"сом.","сом.");
  }
  ...
  protected HashMap<String, CurrencyData> loadCurrencyMap() {
    ...
    // Сомонӣ
    result.put("TJS", new CurrencyDataImpl("TJS","сом.",2,"сом.","сом."));
    // TMM
  ...
  protected HashMap<String, String> loadNamesMap() {
    ...
    result.put("EUR","Евро");
    result.put("GBP","Фунт стерлинги британӣ");
    result.put("INR","Рупияи ҳиндустонӣ");
    result.put("JPY","Иенаи японӣ");
    result.put("RUB","Рубли русӣ");
    result.put("TJS","Сомонӣ");
    result.put("USD","Доллари ИМА");
    result.put("XXX","Асъори номаълум");
    return result;
  }
}
