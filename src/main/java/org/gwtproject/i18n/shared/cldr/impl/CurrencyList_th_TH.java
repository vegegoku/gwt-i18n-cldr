...
public class CurrencyList_th_TH extends CurrencyList_th {
  public CurrencyData getDefault() {
    return new CurrencyDataImpl("THB","฿",2,"฿","฿");
  }
  ...
  protected HashMap<String, String> loadNamesMap() {
    ...
    result.put("AFN","อัฟกานิอัฟกานิสถาน");
    ...
    result.put("ARL","เปโซเลย์อาร์เจนตินา (1970–1983)");
    result.put("ARM","เปโซอาร์เจนตินา (1881–1970)");
    ...
    result.put("BAM","มาร์กบอสเนีย-เฮอร์เซโกวีนา");
    result.put("BAN","ดีนาร์ใหม่บอสเนีย-เฮอร์เซโกวีนา (1994–1997)");
    ...
    result.put("BGM","โซเชียลลิสต์เลฟบัลแกเรีย");
    result.put("BGN","เลฟบัลแกเรีย");
    result.put("BGO","เลฟบัลเกเรีย (1879–1952)");
    ...
    result.put("BOL","โบลิเวียโนโบลิเวีย (1863–1963)");
    ...
    result.put("BRZ","ครูเซโรบราซิล (1942–1967)");
    ...
    result.put("BYN","รูเบิลเบลารุส");
    result.put("BYR","รูเบิลเบลารุส (2000–2016)");
    ...
    result.put("HNL","เลมปิราฮอนดูรัส");
    ...
    result.put("MCF","ฟรังก์โมนาโก");
    result.put("MDC","บัตรปันส่วนมอลโดวา");
    result.put("MDL","ลิวมอลโดวา");
    result.put("MGA","อาเรียรีมาลากาซี");
    result.put("MGF","ฟรังก์มาดากัสการ์");
    result.put("MKD","ดีนาร์มาซิโดเนีย");
    result.put("MKN","ดีนาร์มาซิโดเนีย (1992–1993)");
    result.put("MLF","ฟรังก์มาลี");
    result.put("MMK","จ๊าตพม่า");
    result.put("MNT","ทูกริกมองโกเลีย");
    result.put("MOP","ปาตากามาเก๊า");
    result.put("MRO","อูกียามอริเตเนีย (1973–2017)");
    result.put("MRU","อูกียามอริเตเนีย");
    ...
    result.put("NIO","กอร์โดบานิการากัว");
    ...
    result.put("PEN","ซอลเปรู");
    result.put("PES","ซอลเปรู (1863–1965)");
    result.put("PGK","กีนาปาปัวนิวกินี");
    ...
    result.put("SSP","ปอนด์ซูดานใต้");
    result.put("STD","ดอบราเซาตูเมและปรินซิปี (1977–2017)");
    result.put("STN","ดอบราเซาตูเมและปรินซิปี");
    result.put("SUR","รูเบิลโซเวียต");
    result.put("SVC","โคลอนเอลซัลวาดอร์");
    result.put("SYP","ปอนด์ซีเรีย");
    result.put("SZL","ลิลันเจนีสวาซิ");
    result.put("THB","บาท");
    result.put("TJR","รูเบิลทาจิกิสถาน");
    result.put("TJS","โซโมนิทาจิกิสถาน");
    ...
    result.put("VEB","โบลิวาร์เวเนซุเอลา (1871–2008)");
    result.put("VEF","โบลิวาร์เวเนซุเอลา");
    result.put("VES","โบลีวาร์เวเนซุเอลา");
    result.put("VND","ดองเวียดนาม");
    result.put("VNN","ดองเวียดนาม (1978–1985)");
    ...
    result.put("XSU","ซูเกร");
    result.put("XTS","รหัสทดสอบสกุลเงิน");
    result.put("XUA","หน่วยบัญชี เอดีบี");
    result.put("XXX","ไม่ทราบชื่อสกุลเงิน");
    ...
    result.put("YUR","ดีนาร์ปฏิรูปยูโกสลาเวีย (1992–1993)");
    result.put("ZAL","แรนด์แอฟริกาใต้ (การเงิน)");
    result.put("ZAR","แรนด์แอฟริกาใต้");
    result.put("ZMK","ควาชาแซมเบีย (1968–2012)");
    result.put("ZMW","ควาชาแซมเบีย");
    result.put("ZRN","นิวแซร์คองโก");
    result.put("ZRZ","แซร์คองโก");
    result.put("ZWD","ดอลลาร์ซิมบับเว");
    result.put("ZWL","ดอลลาร์ซิมบับเว (2009)");
    result.put("ZWR","ดอลลาร์ซิมบับเว (2008)");
    return result;
  }
}
