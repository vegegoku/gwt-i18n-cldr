...
public class CurrencyList_tk_TM extends CurrencyList_tk {
  public CurrencyData getDefault() {
    return new CurrencyDataImpl("TMT","TMT",2,"TMT","TMT");
  }
  ...
  protected HashMap<String, String> loadNamesMap() {
    ...
    result.put("AMD","Ermeni dramy");
    result.put("ANG","Niderland antil guldeni");
    result.put("AOA","Angola kwanzasy");
    result.put("ARS","Argentin pesosy");
    result.put("AUD","Awstraliýa dollary");
    result.put("AWG","Aruba florini");
    result.put("AZN","Azerbaýjan manady");
    result.put("BAM","Konwertirlenýän Bosniýa we Gersegowina markasy");
    result.put("BBD","Barbados dollary");
    result.put("BDT","Bangladeş takasy");
    result.put("BGN","Bolgar lewi");
    result.put("BHD","Bahreýn dinary");
    result.put("BIF","Burundi franky");
    result.put("BMD","Bermuda dollary");
    result.put("BND","Bruneý dollary");
    result.put("BOB","Boliwiýa boliwianosy");
    result.put("BRL","Brazil realy");
    result.put("BSD","Bagama dollary");
    result.put("BTN","Butan ngultrumy");
    result.put("BWP","Botswana pulasy");
    result.put("BYN","Belarus rubly");
    result.put("BYR","Belorus rubly (2000–2016)");
    result.put("BZD","Beliz dollary");
    result.put("CAD","Kanada dollary");
    result.put("CDF","Kongo franky");
    result.put("CHF","Şweýsar franky");
    result.put("CLP","Çili pesosy");
    result.put("CNH","Hytaý ýuany (ofşor)");
    result.put("CNY","Hytaý ýuany");
    result.put("COP","Kolumbiýa pesosy");
    result.put("CRC","Kosta-Rika kolony");
    result.put("CUC","Konwertirlenýän kuba pesosy");
    result.put("CUP","Kuba pesosy");
    result.put("CVE","Kabo-Werde eskudosy");
    result.put("CZK","Çeh kronasy");
    result.put("DJF","Jibuti franky");
    result.put("DKK","Daniýa kronasy");
    result.put("DOP","Dominikan pesosy");
    result.put("DZD","Alžir dinary");
    result.put("EGP","Müsür funty");
    result.put("ERN","Eritreýa nakfasy");
    result.put("ETB","Efiopiýa byry");
    result.put("EUR","Ýewro");
    result.put("FJD","Fiji dollary");
    result.put("FKP","Folklend adalarynyň funty");
    result.put("GBP","Britan funt sterlingi");
    result.put("GEL","Gruzin larisi");
    result.put("GHS","Gano sedisi");
    result.put("GIP","Gibraltar funty");
    result.put("GMD","Gambiýa dalasisi");
    result.put("GNF","Gwineý franky");
    result.put("GTQ","Gwatemala ketsaly");
    result.put("GYD","Gaýana dollary");
    result.put("HKD","Gonkong dollary");
    result.put("HNL","Gonduras lempirasy");
    result.put("HRK","Horwat kunasy");
    result.put("HTG","Gaiti gurdy");
    result.put("HUF","Wenger forinti");
    result.put("IDR","Indoneziýa rupiýasy");
    result.put("ILS","Täze Ysraýyl şekeli");
    result.put("INR","Hindi rupiýasy");
    result.put("IQD","Yrak dinary");
    result.put("IRR","Eýran rialy");
    result.put("ISK","Islandiýa kronasy");
    result.put("JMD","Ýamaýka dollary");
    result.put("JOD","Iordan dinary");
    result.put("JPY","Ýapon ýeni");
    result.put("KES","Keniýa şillingi");
    result.put("KGS","Gyrgyz somy");
    result.put("KHR","Kamboja riýeli");
    result.put("KMF","Komor adalarynyň franky");
    result.put("KPW","Demirgazyk Koreý wony");
    result.put("KRW","Günorta Koreý wony");
    result.put("KWD","Kuweýt dinary");
    result.put("KYD","Kaýman adalarynyň dollary");
    result.put("KZT","Gazak teňňesi");
    result.put("LAK","Laos kipi");
    result.put("LBP","Liwan funty");
    result.put("LKR","Şri-Lanka rupiýasy");
    result.put("LRD","Liberiýa dollary");
    result.put("LYD","Liwiýa dinary");
    result.put("MAD","Marokko dirhamy");
    result.put("MDL","Moldaw leýi");
    result.put("MGA","Malagasiý ariarisi");
    result.put("MKD","Makedon dinary");
    result.put("MMK","Mýanma kýaty");
    result.put("MNT","Mongol tugrigi");
    result.put("MOP","Makao patakasy");
    result.put("MRO","Mawritan ugiýasy (1973–2017)");
    result.put("MRU","Mawritan ugiýasy");
    result.put("MUR","Mawrikiý rupiýasy");
    result.put("MVR","Maldiw rufiýasy");
    result.put("MWK","Malawi kwaçasy");
    result.put("MXN","Meksikan pesosy");
    result.put("MYR","Malaýziýa ringgiti");
    result.put("MZN","Mozambik metikaly");
    result.put("NAD","Namibiýa dollary");
    result.put("NGN","Nigeriýa naýrasy");
    result.put("NIO","Nikaragua kordobasy");
    result.put("NOK","Norwegiýa kronasy");
    result.put("NPR","Nepal rupiýasy");
    result.put("NZD","Täze Zelandiýa dollary");
    result.put("OMR","Oman rialy");
    result.put("PAB","Panama balboasy");
    result.put("PEN","Peru soly");
    result.put("PGK","Papua - Täze Gwineýa kinasy");
    result.put("PHP","Filippin pesosy");
    result.put("PKR","Päkistan rupiýasy");
    result.put("PLN","Polýak zlotysy");
    result.put("PYG","Paragwaý guaranisi");
    result.put("QAR","Katar rialy");
    result.put("RON","Rumyn leýi");
    result.put("RSD","Serb dinary");
    result.put("RUB","Rus rubly");
    result.put("RWF","Ruanda franky");
    result.put("SAR","Saud rialy");
    result.put("SBD","Solomon adalarynyň dollary");
    result.put("SCR","Seýşel rupiýasy");
    result.put("SDG","Sudan funty");
    result.put("SEK","Şwed kronasy");
    result.put("SGD","Singapur dollary");
    result.put("SHP","Keramatly Ýelena adasynyň funty");
    result.put("SLL","Sýerra-Leone leony");
    result.put("SOS","Somali şillingi");
    result.put("SRD","Surinam dollary");
    result.put("SSP","Günorta Sudan funty");
    result.put("STD","San-Tome we Prinsipi dobrasy (1977–2017)");
    result.put("STN","San-Tome we Prinsipi dobrasy");
    result.put("SYP","Siriýa funty");
    result.put("SZL","Swazi lilangeni");
    result.put("THB","Taýland baty");
    result.put("TJS","Täjik somonisi");
    result.put("TMT","Türkmen manady");
    result.put("TND","Tunis dinary");
    result.put("TOP","Tonga paangasy");
    result.put("TRY","Türk lirasy");
    result.put("TTD","Trininad we Tobago dollary");
    result.put("TWD","Täze Taýwan dollary");
    result.put("TZS","Tanzaniýa şillingi");
    result.put("UAH","Ukrain griwnasy");
    result.put("UGX","Uganda şillingi");
    result.put("USD","ABŞ dollary");
    result.put("UYU","Urugwaý pesosy");
    result.put("UZS","Özbek somy");
    result.put("VEF","Wenesuela boliwary (2008–2018)");
    result.put("VES","Wenesuela boliwary");
    result.put("VND","Wýetnam dongy");
    result.put("VUV","Wanuatu watusy");
    result.put("WST","Samoa talasy");
    result.put("XAF","KFA BEAC franky");
    result.put("XCD","Gündogar karib dollary");
    result.put("XOF","KFA BCEAO franky");
    result.put("XPF","Fransuz ýuwaş umman franky");
    result.put("XXX","Näbelli pul birligi");
    result.put("YER","Ýemen rialy");
    result.put("ZAR","Günorta Afrika rendi");
    result.put("ZMW","Zambiýa kwaçasy");
    return result;
  }
}
