...
public class CurrencyList_to_TO extends CurrencyList_to {
  public CurrencyData getDefault() {
    return new CurrencyDataImpl("TOP","T$",2,"T$","T$");
  }
  ...
  protected HashMap<String, CurrencyData> loadCurrencyMap() {
    ...
    // Paʻanga fakatonga
    result.put("TOP", new CurrencyDataImpl("TOP","T$",2,"T$","T$"));
    // TPE
  ...
  protected HashMap<String, String> loadNamesMap() {
    ...
    result.put("TOP","Paʻanga fakatonga");
    result.put("WST","Tala fakahaʻamoa");
    result.put("XXX","Pa’anga Ta’e’ilo");
    return result;
  }
}
