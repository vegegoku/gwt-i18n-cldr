...
public class CurrencyList_tr_TR extends CurrencyList_tr {
  public CurrencyData getDefault() {
    return new CurrencyDataImpl("TRY","TL",2,"TL","TL");
  }
  ...
  protected HashMap<String, String> loadNamesMap() {
    ...
    result.put("ALK","Arnavutluk Leki (1946–1965)");
    ...
    result.put("ARL","Arjantin Peso Leyi (1970–1983)");
    result.put("ARM","Arjantin Pesosu (1881–1970)");
    result.put("ARP","Arjantin Pezosu (1983–1985)");
    result.put("ARS","Arjantin Pesosu");
    ...
    result.put("BAN","Yeni Bosna Hersek Dinarı (1994–1997)");
    ...
    result.put("BGM","Sosyalist Bulgaristan Levası");
    result.put("BGN","Bulgar Levası");
    result.put("BGO","Bulgar Levası (1879–1952)");
    ...
    result.put("BOL","Bolivya Bolivyanosu (1863–1963)");
    ...
    result.put("BRZ","Brezilya Kruzeirosu (1942–1967)");
    ...
    result.put("BYN","Belarus Rublesi");
    result.put("BYR","Beyaz Rusya Rublesi (2000–2016)");
    ...
    result.put("CLE","Şili Esküdosu");
    result.put("CLF","Şili Unidades de Fomento");
    result.put("CLP","Şili Pesosu");
    result.put("CNH","Çin Yuanı (offshore)");
    result.put("CNX","Çin Halk Cumhuriyeti Merkez Bankası Doları");
    ...
    result.put("CUC","Konvertibl Küba Pesosu");
    result.put("CUP","Küba Pesosu");
    ...
    result.put("GTQ","Guatemala Quetzalı");
    ...
    result.put("ISJ","İzlanda Kronu (1918–1981)");
    ...
    result.put("KGS","Kırgızistan Somu");
    result.put("KHR","Kamboçya Rieli");
    result.put("KMF","Komorlar Frangı");
    result.put("KPW","Kuzey Kore Wonu");
    result.put("KRH","Güney Kore Hwanı (1953–1962)");
    result.put("KRO","Güney Kore Wonu (1945–1953)");
    ...
    result.put("MCF","Monako Frangı");
    result.put("MDC","Moldova Kuponu");
    ...
    result.put("MKN","Makedonya Dinarı (1992–1993)");
    result.put("MLF","Mali Frangı");
    result.put("MMK","Myanmar Kyatı");
    result.put("MNT","Moğolistan Tugriki");
    result.put("MOP","Makao Patakası");
    result.put("MRO","Moritanya Ugiyası (1973–2017)");
    result.put("MRU","Moritanya Ugiyası");
    result.put("MTL","Malta Lirası");
    result.put("MTP","Malta Sterlini");
    result.put("MUR","Mauritius Rupisi");
    result.put("MVP","Maldiv Rupisi");
    result.put("MVR","Maldiv Rufiyaası");
    ...
    result.put("MYR","Malezya Ringgiti");
    ...
    result.put("NIC","Nikaragua Kordobası (1988–1991)");
    result.put("NIO","Nikaragua Kordobası");
    ...
    result.put("PEN","Peru Solü");
    result.put("PES","Peru Solü (1863–1965)");
    result.put("PGK","Papua Yeni Gine Kinası");
    result.put("PHP","Filipinler Pesosu");
    ...
    result.put("SCR","Seyşeller Rupisi");
    ...
    result.put("SSP","Güney Sudan Lirası");
    result.put("STD","São Tomé ve Príncipe Dobrası (1977–2017)");
    result.put("STN","São Tomé ve Príncipe Dobrası");
    ...
    result.put("TMM","Türkmenistan Manatı (1993–2009)");
    result.put("TMT","Türkmenistan Manatı");
    ...
    result.put("UYU","Uruguay Pesosu");
    result.put("UZS","Özbekistan Somu");
    result.put("VEB","Venezuela Bolivarı (1871–2008)");
    result.put("VEF","Venezuela Bolivarı (2008–2018)");
    result.put("VES","Venezuela Bolivarı");
    result.put("VND","Vietnam Dongu");
    result.put("VNN","Vietnam Dongu (1978–1985)");
    ...
    result.put("XUA","ADB Hesap Birimi");
    ...
    result.put("YUR","İyileştirilmiş Yugoslav Dinarı (1992–1993)");
    ...
    result.put("ZWR","Zimbabve Doları (2008)");
    return result;
  }
}
