...
public class CurrencyList_tt_RU extends CurrencyList_tt {
  ...
  protected HashMap<String, String> loadNamesMap() {
    ...
    result.put("CNY","Кытай юане");
    result.put("EUR","евро");
    result.put("GBP","фунт стерлинг");
    result.put("INR","Индия рупиясе");
    result.put("JPY","Япония иенасы");
    result.put("RUB","Россия сумы");
    result.put("USD","АКШ доллары");
    result.put("XXX","билгесез валюта");
    return result;
  }
}
