...
public class CurrencyList_tzm_MA extends CurrencyList_tzm {
  ...
  protected HashMap<String, String> loadNamesMap() {
    ...
    result.put("BHD","Ḍinar Ubaḥrayni");
    result.put("BIF","Frank Uburundi");
    result.put("BWP","Pula Ubutswani");
    result.put("CAD","Ḍular Ukanadi");
    result.put("CDF","Frank Ukunguli");
    result.put("CHF","Frank Uswisri");
    result.put("CNY","Ywan Renminbi Ucinwi");
    result.put("CVE","Iskudu Ukabuvirdyani");
    result.put("DJF","Frank Uğibuti");
    result.put("DZD","Ḍinar Udzayri");
    result.put("EGP","Junih Umiṣṛi");
    result.put("ERN","Nakfa Uyritri");
    result.put("ETB","Birr Uyityuppi");
    result.put("EUR","Uṛu");
    result.put("GBP","Junih Ubriṭani");
    result.put("GHC","Sidi Uɣani");
    result.put("GMD","Dalasi Agambi");
    result.put("GNS","Frank Uɣini");
    result.put("INR","Rupi Uḥindi");
    result.put("JPY","Yann Ujappuni");
    result.put("KES","Cillin Ukini");
    result.put("KMF","Frank Uqumuri");
    result.put("LRD","Ḍular Ulibiri");
    result.put("LSL","Luti Ulusuṭi");
    result.put("LYD","Ḍinar Ulibi");
    result.put("MAD","Derhem Umeṛṛuki");
    result.put("MGA","Aryari Umalɣaci");
    result.put("MRO","Uqiyya Umuritani (1973–2017)");
    result.put("MRU","Uqiyya Umuritani");
    result.put("MUR","Rupi Umurisi");
    result.put("MWK","Kwača Umalawi");
    result.put("MZM","Mitikal Umuzambiqi");
    result.put("NAD","Ḍular Unamibi");
    result.put("NGN","Nayra Unijiri");
    result.put("RWF","Frank Urwandi");
    result.put("SAR","Ryal Usaεudi");
    result.put("SCR","Rupi Usicili");
    result.put("SDG","Junih Usudani");
    result.put("SDP","Junih Usudani (1956–2007)");
    result.put("SHP","Junih Usantehilini");
    result.put("SLL","Lyun Usirralyuni");
    result.put("SOS","Cilin Uṣumali");
    result.put("STD","Dubra Usawṭumi (1977–2017)");
    result.put("STN","Dubra Usawṭumi");
    result.put("SZL","Lilanjini Uswazi");
    result.put("TND","Ḍinar Utunsi");
    result.put("TZS","Cilin Uṭanzani");
    result.put("UGX","Cilin Uɣandi (1966–1987)");
    result.put("USD","Ḍular Umirikani");
    result.put("XAF","Frank CFA (BEAC)");
    result.put("XOF","Frank CFA (BCEAO)");
    result.put("ZAR","Rand Ufriki Unzul");
    result.put("ZMK","Kwača Uzambi (1968–2012)");
    result.put("ZMW","Kwača Uzambi");
    result.put("ZWD","Ḍular Uzimbabwi");
    return result;
  }
}
