...
public class CurrencyList_uk_UA extends CurrencyList_uk {
  ...
  protected HashMap<String, String> loadNamesMap() {
    ...
    result.put("AED","дирхам ОАЕ");
    result.put("AFA","афгані (1927–2002)");
    result.put("AFN","афганський афгані");
    result.put("ALL","албанський лек");
    result.put("AMD","вірменський драм");
    result.put("ANG","нідерландський антильський гульден");
    ...
    result.put("AWG","арубський флорин");
    ...
    result.put("BAM","конвертована марка Боснії і Герцеговини");
    ...
    result.put("BGN","болгарський лев");
    ...
    result.put("BOB","болівійський болівіано");
    ...
    result.put("BYN","білоруський рубль");
    result.put("BYR","білоруський рубль (2000–2016)");
    ...
    result.put("CLP","чилійський песо");
    result.put("CNH","китайський офшорний юань");
    ...
    result.put("ETB","ефіопський бир");
    result.put("EUR","євро");
    result.put("FIM","фінляндська марка");
    result.put("FJD","фіджійський долар");
    result.put("FKP","фунт Фолклендських островів");
    result.put("FRF","французький франк");
    result.put("GBP","англійський фунт");
    ...
    result.put("GMD","гамбійський даласі");
    result.put("GNF","гвінейський франк");
    ...
    result.put("GYD","гаянський долар");
    result.put("HKD","гонконгський долар");
    ...
    result.put("KPW","північнокорейський вон");
    result.put("KRW","південнокорейський вон");
    ...
    result.put("MWK","малавійська квача");
    result.put("MXN","мексиканський песо");
    ...
    result.put("NIC","нікарагуанська кордоба (1988–1991)");
    result.put("NIO","нікарагуанська кордоба");
    ...
    result.put("PAB","панамське бальбоа");
    result.put("PEI","перуанський інті");
    result.put("PEN","перуанський новий сол");
    result.put("PES","перуанський сол (1863–1965)");
    result.put("PGK","кіна Папуа-Нової Ґвінеї");
    result.put("PHP","філіппінський песо");
    ...
    result.put("SHP","фунт острова Святої Єлени");
    ...
    result.put("SSP","південносуданський фунт");
    result.put("STD","добра Сан-Томе і Прінсіпі (1977–2017)");
    result.put("STN","добра Сан-Томе і Прінсіпі");
    result.put("SUR","радянський рубль");
    result.put("SVC","сальвадорський колон");
    result.put("SYP","сирійський фунт");
    result.put("SZL","свазілендський лілангені");
    ...
    result.put("TOP","тонґанська паанга");
    result.put("TPE","тіморський ескудо");
    result.put("TRL","турецька ліра (1922–2005)");
    result.put("TRY","турецька ліра");
    result.put("TTD","долар Трінідаду і Тобаґо");
    ...
    result.put("UYU","уругвайський песо");
    result.put("UZS","узбецький сум");
    result.put("VEB","венесуельський болівар (1871–2008)");
    result.put("VEF","венесуельський болівар (2008–2018)");
    result.put("VES","венесуельський болівар");
    result.put("VND","вʼєтнамський донг");
    result.put("VUV","вануатський вату");
    result.put("WST","самоанська тала");
    result.put("XAF","центральноафриканський франк");
    ...
    result.put("XOF","західноафриканський франк");
    ...
    result.put("ZMK","замбійська квача (1968–2012)");
    result.put("ZMW","замбійська квача");
