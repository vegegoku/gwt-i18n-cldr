...
public class CurrencyList_ur_IN extends CurrencyList_ur {
  ...
  protected HashMap<String, String> loadNamesMap() {
    ...
    result.put("BIF","برونڈیئن فرانک");
    result.put("BMD","برموڈا ڈالر");
    ...
    result.put("BYN","بیلاروسی روبل");
    result.put("BYR","بیلاروسی روبل (۲۰۰۰–۲۰۱۶)");
    result.put("BZD","بیلیز ڈالر");
    result.put("CAD","کنیڈین ڈالر");
    result.put("CDF","کانگولیز فرانک");
    result.put("CHF","سوئس فرانکس");
    result.put("CLP","چلّین پیسہ");
    result.put("CNH","چینی یوآن (آف شور)");
    result.put("CNY","چینی یوآن");
    result.put("COP","کولمبین پیسہ");
    result.put("CRC","کوسٹا ریکا کولون");
    result.put("CUC","قابل منتقلی کیوبائی پیسو");
    result.put("CUP","کیوبائی پیسو");
    result.put("CVE","کیپ ورڈی اسکیوڈو");
    result.put("CZK","جمہوریہ چیک کرونا");
    result.put("DEM","ڈچ مارکس");
    result.put("DJF","جبوتی فرانک");
    result.put("DKK","ڈنمارک کرون");
    result.put("DOP","ڈومنیکن پیسو");
    result.put("DZD","الجیریائی دینار");
    result.put("EEK","ایسٹونین کرون");
    result.put("EGP","مصری پاؤنڈ");
    result.put("ERN","اریٹیریائی ناکفا");
    result.put("ETB","ایتھوپیائی بِرّ");
    result.put("EUR","یورو");
    result.put("FJD","فجی کا ڈالر");
    result.put("FKP","فاکلینڈ آئلینڈز پونڈ");
    result.put("FRF","فرانسیسی فرانک");
    result.put("GBP","برطانوی پاونڈ سٹرلنگ");
    result.put("GEL","جارجیائی لاری");
    result.put("GHS","گھانی سیڈی");
    result.put("GIP","جبل الطارق پونڈ");
    result.put("GMD","گامبیا کا ڈلاسی");
    result.put("GNF","گنی فرانک");
    ...
    result.put("ILS","اسرائیلی نیا شیکل");
    result.put("INR","بھارتی روپیہ");
    result.put("IQD","عراقی دینار");
    result.put("IRR","ایرانی ریال");
    result.put("ISK","آئس لينڈی کرونا");
    ...
    result.put("SSP","جنوبی سوڈانی پاؤنڈ");
    result.put("STD","ساؤ ٹوم اور پرنسپے ڈوبرا (1977–2017)");
    result.put("STN","ساؤ ٹوم اور پرنسپے ڈوبرا");
    ...
    result.put("VEB","وینزویلا بولیور (1871–2008)");
    result.put("VEF","وینزویلا بولیور (2008–2018)");
    result.put("VES","وینزویلا بولیور");
    result.put("VND","ویتنامی ڈانگ");
    result.put("VUV","وینوواتو واتو");
    result.put("WST","ساموآئی ٹالا");
    result.put("XAF","وسطی افریقی [CFA] فرانک");
    result.put("XCD","مشرقی کریبیا کا ڈالر");
    result.put("XOF","مغربی افریقی [CFA] فرانک");
    result.put("XPF","CFP فرانک");
    result.put("XXX","نامعلوم کرنسی");
    result.put("YER","یمنی ریال");
    result.put("ZAR","جنوبی افریقی رانڈ");
    result.put("ZMK","زامبیائی کواچا (1968–2012)");
    result.put("ZMW","زامبیائی کواچا");
    return result;
  }
}
