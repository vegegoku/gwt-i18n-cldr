...
public class CurrencyList_uz_Cyrl_UZ extends CurrencyList_uz_Cyrl {
  public CurrencyData getDefault() {
    return new CurrencyDataImpl("UZS","сўм",2,"сўм","сўм");
  }
  ...
  protected HashMap<String, CurrencyData> loadCurrencyMap() {
    ...
    // Ўзбекистон сўм
    result.put("UZS", new CurrencyDataImpl("UZS","сўм",2,"сўм","сўм"));
    // VEB
  ...
  protected HashMap<String, String> loadNamesMap() {
    ...
    result.put("BBD","Барбадос доллари");
    result.put("BMD","Бермуда доллари");
    result.put("BOB","Боливия болвиани");
    result.put("BRL","Бразил реали");
    result.put("BSD","Багама доллари");
    result.put("BZD","Белиз доллари");
    result.put("CAD","Канада доллари");
    result.put("CLP","Чили песоси");
    result.put("CNY","Хитой юани");
    result.put("COP","Колумбия песоси");
    result.put("CRC","Коста-Рика колони");
    result.put("CUC","Куба Айирбошлаш песоси");
    result.put("CUP","Куба песоси");
    result.put("DOP","Доминикан песоси");
    result.put("DZD","Жазоир динори");
    result.put("EGP","Миср фунти");
    result.put("EUR","Евро");
    result.put("FKP","Фолькленд ороли фунти");
    result.put("GBP","Инглиз фунт");
    result.put("GTQ","Гватемала кветзали");
    result.put("GYD","Гаяна доллари");
    result.put("HNL","Гондурас лемпираси");
    result.put("HTG","Гаити гурдаси");
    result.put("INR","Ҳинд рупияси");
    result.put("JMD","Ямайка доллари");
    result.put("JPY","Япон йенаси");
    result.put("KYD","Кайман ороли Доллари");
    result.put("LYD","Ливия динори");
    result.put("MAD","Марокаш дирҳами");
    result.put("MXN","Мексика песоси");
    result.put("NIO","Никарагуа кордобаси");
    result.put("PAB","Панама бальбоаси");
    result.put("PEN","Перу сол");
    result.put("PYG","Парагвай гуарани");
    result.put("RUB","Рус рубли");
    result.put("SRD","Суринам доллари");
    result.put("TTD","Тринидад ва Тобаго доллари");
    result.put("USD","АҚШ доллари");
    result.put("UYU","Уругвай песоси");
    result.put("UZS","Ўзбекистон сўм");
    result.put("VEF","Венесуэла боливари (2008–2018)");
    result.put("VES","Венесуэла боливари");
    result.put("XCD","Шарқий Кариб доллари");
    return result;
  }
}
