...
public class CurrencyList_uz_Latn_UZ extends CurrencyList_uz_Latn {
  public CurrencyData getDefault() {
    return new CurrencyDataImpl("UZS","soʻm",2,"soʻm","soʻm");
  }
  ...
  protected HashMap<String, CurrencyData> loadCurrencyMap() {
    ...
    // O‘zbekiston so‘mi
    result.put("UZS", new CurrencyDataImpl("UZS","soʻm",2,"soʻm","soʻm"));
    // VEB
  ...
  protected HashMap<String, String> loadNamesMap() {
    ...
    result.put("AMD","Armaniston drami");
    result.put("ANG","Niderlandiya antil guldeni");
    result.put("AOA","Angola kvanzasi");
    result.put("ARS","Argentina pesosi");
    result.put("AUD","Avstraliya dollari");
    result.put("AWG","Aruba florini");
    result.put("AZN","Ozarbayjon manati");
    result.put("BAM","Bosniya va Gertsegovina ayirboshlash markasi");
    result.put("BBD","Barbados dollari");
    result.put("BDT","Bangladesh takasi");
    result.put("BGN","Bolgariya levi");
    result.put("BHD","Bahrayn dinori");
    result.put("BIF","Burundi franki");
    result.put("BMD","Bermuda dollari");
    result.put("BND","Bruney dollari");
    result.put("BOB","Boliviya bolivianosi");
    result.put("BRL","Braziliya reali");
    result.put("BSD","Bagama dollari");
    result.put("BTN","Butan ngultrumi");
    result.put("BWP","Botsvana pulasi");
    result.put("BYN","Belarus rubli");
    result.put("BYR","Belarus rubli (2000–2016)");
    result.put("BZD","Beliz dollari");
    result.put("CAD","Kanada dollari");
    result.put("CDF","Kongo franki");
    result.put("CHF","Shveytsariya franki");
    result.put("CLP","Chili pesosi");
    result.put("CNY","Xitoy yuani");
    result.put("COP","Kolumbiya pesosi");
    result.put("CRC","Kosta-Rika koloni");
    result.put("CUC","Kuba ayirboshlash pesosi");
    result.put("CUP","Kuba pesosi");
    result.put("CVE","Kabo-Verde eskudosi");
    result.put("CZK","Chexiya kronasi");
    result.put("DJF","Jibuti franki");
    result.put("DKK","Daniya kronasi");
    result.put("DOP","Dominikana pesosi");
    result.put("DZD","Jazoir dinori");
    result.put("EGP","Misr funti");
    result.put("ERN","Eritreya nakfasi");
    result.put("ETB","Efiopiya biri");
    result.put("EUR","Yevro");
    result.put("FJD","Fiji dollari");
    result.put("FKP","Folklend orollari funti");
    result.put("GBP","Angliya funt sterlingi");
    result.put("GEL","Gruziya larisi");
    result.put("GHS","Gana sedisi");
    result.put("GIP","Gibraltar funti");
    result.put("GMD","Gambiya dalasisi");
    result.put("GNF","Gvineya franki");
    result.put("GTQ","Gvatemala ketsali");
    result.put("GYD","Gayana dollari");
    result.put("HKD","Gonkong dollari");
    result.put("HNL","Gonduras lempirasi");
    result.put("HRK","Xorvatiya kunasi");
    result.put("HTG","Gaiti gurdi");
    result.put("HUF","Vengriya forinti");
    result.put("IDR","Indoneziya rupiyasi");
    result.put("ILS","Isroil yangi shekeli");
    result.put("INR","Hindiston rupiyasi");
    result.put("IQD","Iroq dinori");
    result.put("IRR","Eron riyoli");
    result.put("ISK","Islandiya kronasi");
    result.put("JMD","Yamayka dollari");
    result.put("JOD","Iordaniya dinori");
    result.put("JPY","Yaponiya iyenasi");
    result.put("KES","Keniya shillingi");
    result.put("KGS","Qirg‘iziston somi");
    result.put("KHR","Kambodja rieli");
    result.put("KMF","Komor orollari franki");
    result.put("KPW","Shimoliy Koreya voni");
    result.put("KRW","Janubiy Koreya voni");
    result.put("KWD","Kuvayt dinori");
    result.put("KYD","Kayman orollari dollari");
    result.put("KZT","Qozog‘iston tengesi");
    result.put("LAK","Laos kipi");
    result.put("LBP","Livan funti");
    result.put("LKR","Shri-Lanka rupiyasi");
    result.put("LRD","Liberiya dollari");
    result.put("LTL","Litva liti");
    result.put("LVL","Latviya lati");
    result.put("LYD","Liviya dinori");
    result.put("MAD","Marokash dirhami");
    result.put("MDL","Moldova leyi");
    result.put("MGA","Malagasi ariarisi");
    result.put("MKD","Makedoniya dinori");
    result.put("MMK","Myanma kyati");
    result.put("MNT","Mongoliya tugriki");
    result.put("MOP","Makao patakasi");
    result.put("MRO","Mavritaniya uqiyasi (1973–2017)");
    result.put("MRU","Mavritaniya uqiyasi");
    result.put("MUR","Mavritaniya rupiyasi");
    result.put("MVR","Maldiv rupiyasi");
    result.put("MWK","Malavi kvachasi");
    result.put("MXN","Meksika pesosi");
    result.put("MYR","Malayziya ringgiti");
    result.put("MZN","Mozambik metikali");
    result.put("NAD","Namibiya dollari");
    result.put("NGN","Nigeriya nayrasi");
    result.put("NIO","Nikaragua kordobasi");
    result.put("NOK","Norvegiya kronasi");
    result.put("NPR","Nepal rupiyasi");
    result.put("NZD","Yangi Zelandiya dollari");
    result.put("OMR","Ummon riyoli");
    result.put("PAB","Panama balboasi");
    result.put("PEN","Peru soli");
    result.put("PGK","Papua – Yangi Gvineya kinasi");
    result.put("PHP","Filippin pesosi");
    result.put("PKR","Pokiston rupiyasi");
    result.put("PLN","Polsha zlotiyi");
    result.put("PYG","Paragvay guaranisi");
    result.put("QAR","Qatar riyoli");
    result.put("RON","Ruminiya leyi");
    result.put("RSD","Serbiya dinori");
    result.put("RUB","Rossiya rubli");
    result.put("RWF","Ruanda franki");
    result.put("SAR","Saudiya Arabistoni riyoli");
    result.put("SBD","Solomon orollari dollari");
    result.put("SCR","Seyshel rupiyasi");
    result.put("SDG","Sudan funti");
    result.put("SEK","Shvetsiya kronasi");
    result.put("SGD","Singapur dollari");
    result.put("SHP","Muqaddas Yelena oroli funti");
    result.put("SLL","Syerra-Leone leonesi");
    result.put("SOS","Somali shillingi");
    result.put("SRD","Surinam dollari");
    result.put("SSP","Janubiy Sudan funti");
    result.put("STD","San-Tome va Prinsipi dobrasi (1977–2017)");
    result.put("STN","San-Tome va Prinsipi dobrasi");
    result.put("SYP","Suriya funti");
    result.put("SZL","Svazilend lilangenisi");
    result.put("THB","Tailand bati");
    result.put("TJS","Tojikiston somoniysi");
    result.put("TMT","Turkmaniston manati");
    result.put("TND","Tunis dinori");
    result.put("TOP","Tonga paangasi");
    result.put("TRY","Turk lirasi");
    result.put("TTD","Trinidad va Tobago dollari");
    result.put("TWD","Yangi Tayvan dollari");
    result.put("TZS","Tanzaniya shillingi");
    result.put("UAH","Ukraina grivnasi");
    result.put("UGX","Uganda shillingi");
    result.put("USD","AQSH dollari");
    result.put("UYU","Urugvay pesosi");
    result.put("UZS","O‘zbekiston so‘mi");
    result.put("VEF","Venesuela bolivari (2008–2018)");
    result.put("VES","Venesuela bolivari");
    result.put("VND","Vyetnam dongi");
    result.put("VUV","Vanuatu vatusi");
    result.put("WST","Samoa talasi");
    result.put("XAF","Markaziy Afrika CFA franki");
    result.put("XCD","Sharqiy Karib dollari");
    result.put("XOF","G‘arbiy Afrika CFA franki");
    result.put("XPF","Fransuz Polineziyasi franki");
    result.put("XXX","Noma’lum valyuta");
    result.put("YER","Yaman riyoli");
    result.put("ZAR","Janubiy Afrika rendi");
    result.put("ZMW","Zambiya kvachasi");
    return result;
  }
}
