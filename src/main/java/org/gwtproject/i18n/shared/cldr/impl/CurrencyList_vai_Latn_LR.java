...
public class CurrencyList_vai_Latn_LR extends CurrencyList_vai_Latn {
  public CurrencyData getDefault() {
    return new CurrencyDataImpl("LRD","$",2,"$","$");
  }
  ...
  protected HashMap<String, CurrencyData> loadCurrencyMap() {
    ...
    // Laibhiya Dala
    result.put("LRD", new CurrencyDataImpl("LRD","$",2,"$","$"));
    // Lisóto Loti
  ...
  protected HashMap<String, String> loadNamesMap() {
    ...
    result.put("AED","Yunaitɛ Arabhi Ɛmire Dihami");
    result.put("AOA","Angola Kuwaŋza");
    result.put("AUD","Ɔ́situwa Dala");
    result.put("BHD","Bharɛŋ Dina");
    result.put("BIF","Bhurundi Furaŋki");
    result.put("BWP","Bhosuwana Pula");
    result.put("CAD","Kanada Dala");
    result.put("CDF","Kóngo Furaŋki");
    result.put("CHF","Suwesi Furaŋki");
    result.put("CNY","Chaníĩ Yuwaŋ Rɛŋmimbi");
    result.put("CVE","Ɛsikudo Cabovɛdiyano");
    result.put("DJF","Jibhuti Furaŋki");
    result.put("DZD","Agiriya Dina");
    result.put("EGP","Míséla Pɔɔ̃");
    result.put("ERN","Ɛritera Nakifa");
    result.put("ETB","Ítiyopiya Bhii");
    result.put("EUR","Yuro");
    result.put("GBP","Jengési Pɔɔ̃");
    result.put("GHC","Gana Sidi");
    result.put("GMD","Gambiya Dalasi");
    result.put("GNS","Gini Furaŋki");
    result.put("INR","Índiya Rupi");
    result.put("JPY","Japaniĩ Yɛŋ");
    result.put("KES","Kénya Siyeŋ");
    result.put("KMF","Komoro Furaŋki");
    result.put("LRD","Laibhiya Dala");
    result.put("LSL","Lisóto Loti");
    result.put("LYD","Libhiya Dina");
    result.put("MAD","Mɔroko Dihami");
    result.put("MGA","Malagasi Ariyari");
    result.put("MRO","Mɔretani Yugiya (1973–2017)");
    result.put("MRU","Mɔretani Yugiya");
    result.put("MUR","Mɔreshɔ Rupi");
    result.put("MWK","Malawi Kuwacha");
    result.put("MZM","Mozambiki Mɛtikali");
    result.put("NAD","Namibiya Dala");
    result.put("NGN","Naĩjiriya Naĩra");
    result.put("RWF","Rawunda Furaŋki");
    result.put("SAR","Lahabu Sawodi Riya");
    result.put("SDG","Sudaniĩ Pɔɔ̃");
    result.put("SHP","Siŋ Hɛlina Pɔɔ̃");
    result.put("SLL","Liyɔɔ̀");
    result.put("SOS","Somaliya Siyeŋ");
    result.put("STD","Sawo Tombe ɓɛ a Gbawo Dobura (1977–2017)");
    result.put("STN","Sawo Tombe ɓɛ a Gbawo Dobura");
    result.put("SZL","Lilangeni");
    result.put("TND","Tunisiya Dina");
    result.put("TZS","Taŋzaniya Siyeŋ");
    result.put("UGX","Yuganda Siyeŋ");
    result.put("USD","Poo Dala");
    result.put("XAF","Áfíríka Tɛ Sifa");
    result.put("XOF","Áfíríka Tele Jíí Sifa");
    result.put("ZAR","Afirika Kɔi Leŋŋɛ lɔ Randi");
    result.put("ZMK","Zambiya Kuwacha (1968–2012)");
    result.put("ZMW","Zambiya Kuwacha");
    result.put("ZWD","Zimbhabhuwe Dala");
    return result;
  }
}
