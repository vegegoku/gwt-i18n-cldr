...
public class CurrencyList_vai_Vaii_LR extends CurrencyList_vai_Vaii {
  ...
  protected HashMap<String, String> loadNamesMap() {
    ...
    result.put("BHD","ꕑꗸꘋ");
    result.put("BIF","ꖜꖩꔺ ꖢꕟꘋꕃ");
    result.put("BWP","ꕷꖬꕎꕯ ꖛꕞ");
    result.put("CAD","ꕪꕯꕜ ꕜꕞꕌ");
    result.put("CDF","ꖏꖐꕱ ꖢꕟꘋꕃ");
    result.put("CHF","ꖬꔃꕤ ꖨꕮꕊ ꖢꕟꘋꕃ");
    result.put("CNY","ꕦꕇꔧ ꖳꕎꘋ ꔓꕆꘋꔬ");
    result.put("CVE","ꗡꔻꖴꖁ ꕪꕷꗲꗡꔵꕩꖆ");
    result.put("DJF","ꕀꖜꔳ ꖢꕟꘋꕃ");
    result.put("DZD","ꕉꔷꕀꔸꕩ ꔵꕯ");
    result.put("EGP","ꕆꔻꕞ ꗁꖻꘋ");
    result.put("ERN","ꔀꔸꔳꕟ ꗁꖻꘋ");
    result.put("ETB","ꔤꕿꖎꔪꕩ ꔫꔤ");
    result.put("EUR","ꖳꖄ");
    result.put("GBP","ꔛꔟꔻ ꗁꖻꘋ ꔻꗳꔷꘋ");
    result.put("GHC","ꕭꕌꕯ ꔻꔵ");
    result.put("GMD","ꕭꔭꕩ ꕜꕞꔻ");
    result.put("GNS","ꕅꔤꕇ ꖢꕟꘋꕃ");
    result.put("INR","ꔤꔺꕩ ꖩꔪ");
    result.put("JPY","ꕧꕐꕇꔧ ꘂꘋ");
    result.put("KES","ꔞꕰ ꔻꔝꘋ");
    result.put("KMF","ꖏꖒꖄ ꖢꕟꘋꕃ");
    result.put("LRD","ꕞꔤꔫꕩ ꕜꕞꕌ");
    result.put("LSL","ꔷꖇꕿ ꖃꔳ");
    result.put("LYD","ꔷꔫꕩ ꔵꕯ");
    result.put("MAD","ꗞꕟꖏ ꔵꕌꕆ");
    result.put("MGA","ꕮꕞꕭꕌꔻ ꕉꔸꕩꔸ");
    result.put("MRO","ꗞꔸꕚꕇꕰ ꖳꕅꕩ (1973–2017)");
    result.put("MRU","ꗞꔸꕚꕇꕰ ꖳꕅꕩ");
    result.put("MUR","ꗞꔓꗔ ꖩꔪ");
    result.put("MWK","ꕮꕞꕌꔨ ꖴꕎꕦ");
    result.put("MZM","ꗞꕤꔭꕃ ꕆꔳꕪ");
    result.put("NAD","ꕯꕆꔫꕩ ꕜꕞꕌ");
    result.put("NGN","ꕯꔤꕀꔸꕩ ꕯꔤꕟ");
    result.put("RWF","ꕟꖙꕡ ꖢꕟꘋꕃ");
    result.put("SAR","ꕢꖙꔵ ꔸꕩꔷ");
    result.put("SCR","ꔖꗼꔷ ꖩꔪ");
    result.put("SDG","ꖬꗵꘋ ꗁꖻꘋ");
    result.put("SHP","ꔻꘋ ꗥꔷꕯ ꗁꖻꘋ");
    result.put("SLL","ꔷꗚꘋ");
    result.put("SOS","ꖇꕮꔷ ꔻꔝꘋ");
    result.put("STD","ꕢꕴ ꕿꔈ ꗪ ꕉ ꕗꕴ ꖁꖜꕟ (1977–2017)");
    result.put("STN","ꕢꕴ ꕿꔈ ꗪ ꕉ ꕗꕴ ꖁꖜꕟ");
    result.put("SZL","ꔷꕞꔟꕇ");
    result.put("TND","ꖤꕇꔻꕩ ꔵꕯ");
    result.put("TZS","ꕚꘋꕤꕇꕰ ꔻꔝꘋ");
    result.put("UGX","ꖳꕭꕡ ꔻꔝꘋ");
    result.put("USD","ꕶꕱ ꕜꕞ");
    result.put("ZAR","ꕉꔱꔸꕪ ꗛꔤ ꔒꘋꗣ ꗏ ꕟꘋꔵ");
    result.put("ZMK","ꕤꔭꕩ ꖴꕎꕦ (1968–2012)");
    result.put("ZMW","ꕤꔭꕩ ꖴꕎꕦ");
    result.put("ZWD","ꔽꕓꖜꔃ ꕜꕞ");
    return result;
  }
}
