...
public class CurrencyList_vi_VN extends CurrencyList_vi {
  public CurrencyData getDefault() {
    return new CurrencyDataImpl("VND","₫",0,"₫","₫");
  }
  ...
  protected HashMap<String, String> loadNamesMap() {
    ...
    result.put("ANG","Guilder Antille Hà Lan");
    result.put("AOA","Kwanza Angola");
    result.put("AOK","Đồng Kwanza của Angola (1977–1991)");
    result.put("AON","Đồng Kwanza Mới của Angola (1990–2000)");
    result.put("AOR","Đồng Kwanza Điều chỉnh lại của Angola (1995–1999)");
    result.put("ARA","Đồng Austral của Argentina");
    result.put("ARL","Đồng Peso Ley của Argentina (1970–1983)");
    result.put("ARM","Đồng Peso Argentina (1881–1970)");
    result.put("ARP","Đồng Peso Argentina (1983–1985)");
    result.put("ARS","Peso Argentina");
    result.put("ATS","Đồng Schiling Áo");
    result.put("AUD","Đô la Australia");
    result.put("AWG","Florin Aruba");
    result.put("AZM","Đồng Manat của Azerbaijan (1993–2006)");
    result.put("AZN","Manat Azerbaijan");
    result.put("BAD","Đồng Dinar của Bosnia-Herzegovina (1992–1994)");
    result.put("BAM","Mark Bosnia-Herzegovina có thể chuyển đổi");
    result.put("BAN","Đồng Dinar Mới của Bosnia-Herzegovina (1994–1997)");
    result.put("BBD","Đô la Barbados");
    result.put("BDT","Taka Bangladesh");
    result.put("BEC","Đồng Franc Bỉ (có thể chuyển đổi)");
    result.put("BEF","Đồng Franc Bỉ");
    result.put("BEL","Đồng Franc Bỉ (tài chính)");
    result.put("BGL","Đồng Lev Xu của Bun-ga-ri");
    result.put("BGM","Đồng Lev Xã hội chủ nghĩa của Bun-ga-ri");
    result.put("BGN","Lev Bulgaria");
    result.put("BGO","Đồng Lev của Bun-ga-ri (1879–1952)");
    result.put("BHD","Dinar Bahrain");
    result.put("BIF","Franc Burundi");
    result.put("BMD","Đô la Bermuda");
    result.put("BND","Đô la Brunei");
    result.put("BOB","Boliviano Bolivia");
    result.put("BOL","Đồng Boliviano của Bolivia (1863–1963)");
    result.put("BOP","Đồng Peso Bolivia");
    result.put("BOV","Đồng Mvdol Bolivia");
    result.put("BRB","Đồng Cruzerio Mới của Braxin (1967–1986)");
    result.put("BRC","Đồng Cruzado của Braxin (1986–1989)");
    result.put("BRE","Đồng Cruzerio của Braxin (1990–1993)");
    result.put("BRL","Real Braxin");
    result.put("BRN","Đồng Cruzado Mới của Braxin (1989–1990)");
    result.put("BRR","Đồng Cruzeiro của Braxin (1993–1994)");
    result.put("BRZ","Đồng Cruzeiro của Braxin (1942–1967)");
    result.put("BSD","Đô la Bahamas");
    result.put("BTN","Ngultrum Bhutan");
    result.put("BUK","Đồng Kyat Miến Điện");
    result.put("BWP","Pula Botswana");
    result.put("BYB","Đồng Rúp Mới của Belarus (1994–1999)");
    result.put("BYN","Rúp Belarus");
    result.put("BYR","Rúp Belarus (2000–2016)");
    result.put("BZD","Đô la Belize");
    result.put("CAD","Đô la Canada");
    result.put("CDF","Franc Congo");
    result.put("CHE","Đồng Euro WIR");
    result.put("CHF","Franc Thụy sĩ");
    result.put("CHW","Đồng France WIR");
    result.put("CLE","Đồng Escudo của Chile");
    result.put("CLF","Đơn vị Kế toán của Chile (UF)");
    result.put("CLP","Peso Chile");
    result.put("CNH","Nhân dân tệ (hải ngoại)");
    result.put("CNY","Nhân dân tệ");
    result.put("COP","Peso Colombia");
    result.put("COU","Đơn vị Giá trị Thực của Colombia");
    result.put("CRC","Colón Costa Rica");
    result.put("CSD","Đồng Dinar của Serbia (2002–2006)");
    result.put("CSK","Đồng Koruna Xu của Czechoslovakia");
    result.put("CUC","Peso Cuba có thể chuyển đổi");
    result.put("CUP","Peso Cuba");
    result.put("CVE","Escudo Cape Verde");
    result.put("CYP","Đồng Bảng Síp");
    result.put("CZK","Koruna Cộng hòa Séc");
    result.put("DDM","Đồng Mark Đông Đức");
    result.put("DEM","Đồng Mark Đức");
    result.put("DJF","Franc Djibouti");
    result.put("DKK","Krone Đan Mạch");
    result.put("DOP","Peso Dominica");
    result.put("DZD","Dinar Algeria");
    result.put("ECS","Đồng Scure Ecuador");
    result.put("ECV","Đơn vị Giá trị Không đổi của Ecuador");
    result.put("EEK","Crun Extônia");
    result.put("EGP","Bảng Ai Cập");
    result.put("ERN","Nakfa Eritrea");
    result.put("ESA","Đồng Peseta Tây Ban Nha (Tài khoản)");
    result.put("ESB","Đồng Peseta Tây Ban Nha (tài khoản có thể chuyển đổi)");
    result.put("ESP","Đồng Peseta Tây Ban Nha");
    result.put("ETB","Birr Ethiopia");
    result.put("EUR","Euro");
    result.put("FIM","Đồng Markka Phần Lan");
    result.put("FJD","Đô la Fiji");
    result.put("FKP","Bảng Quần đảo Falkland");
    result.put("FRF","Franc Pháp");
    result.put("GBP","Bảng Anh");
    result.put("GEK","Đồng Kupon Larit của Georgia");
    result.put("GEL","Lari Gruzia");
    result.put("GHC","Cedi Ghana (1979–2007)");
    result.put("GHS","Cedi Ghana");
    result.put("GIP","Bảng Gibraltar");
    result.put("GMD","Dalasi Gambia");
    result.put("GNF","Franc Guinea");
    result.put("GNS","Syli Guinea");
    result.put("GQE","Đồng Ekwele của Guinea Xích Đạo");
    result.put("GRD","Drachma Hy Lạp");
    result.put("GTQ","Quetzal Guatemala");
    result.put("GWE","Đồng Guinea Escudo Bồ Đào Nha");
    result.put("GWP","Peso Guinea-Bissau");
    result.put("GYD","Đô la Guyana");
    result.put("HKD","Đô la Hồng Kông");
    result.put("HNL","Lempira Honduras");
    result.put("HRD","Đồng Dinar Croatia");
    result.put("HRK","Kuna Croatia");
    result.put("HTG","Gourde Haiti");
    result.put("HUF","Forint Hungary");
    result.put("IDR","Rupiah Indonesia");
    result.put("IEP","Pao Ai-len");
    result.put("ILP","Pao Ixraen");
    result.put("ILS","Sheqel Israel mới");
    result.put("INR","Rupee Ấn Độ");
    result.put("IQD","Dinar I-rắc");
    result.put("IRR","Rial Iran");
    result.put("ISK","Króna Iceland");
    result.put("ITL","Lia Ý");
    result.put("JMD","Đô la Jamaica");
    result.put("JOD","Dinar Jordan");
    result.put("JPY","Yên Nhật");
    result.put("KES","Shilling Kenya");
    result.put("KGS","Som Kyrgyzstan");
    result.put("KHR","Riel Campuchia");
    result.put("KMF","Franc Comoros");
    result.put("KPW","Won Triều Tiên");
    result.put("KRH","Đồng Hwan Hàn Quốc (1953–1962)");
    result.put("KRO","Đồng Won Hàn Quốc (1945–1953)");
    result.put("KRW","Won Hàn Quốc");
    result.put("KWD","Dinar Kuwait");
    result.put("KYD","Đô la Quần đảo Cayman");
    result.put("KZT","Tenge Kazakhstan");
    result.put("LAK","Kip Lào");
    result.put("LBP","Bảng Li-băng");
    result.put("LKR","Rupee Sri Lanka");
    result.put("LRD","Đô la Liberia");
    result.put("LSL","Ioti Lesotho");
    result.put("LTL","Litas Lít-va");
    result.put("LTT","Đồng Talonas Litva");
    result.put("LUC","Đồng Franc Luxembourg có thể chuyển đổi");
    result.put("LUF","Đồng Franc Luxembourg");
    result.put("LUL","Đồng Franc Luxembourg tài chính");
    result.put("LVL","Lats Latvia");
    result.put("LVR","Đồng Rúp Latvia");
    result.put("LYD","Dinar Libi");
    result.put("MAD","Dirham Ma-rốc");
    result.put("MAF","Đồng Franc Ma-rốc");
    result.put("MCF","Đồng Franc Monegasque");
    result.put("MDC","Đồng Cupon Moldova");
    result.put("MDL","Leu Moldova");
    result.put("MGA","Ariary Malagasy");
    result.put("MGF","Đồng Franc Magalasy");
    result.put("MKD","Denar Macedonia");
    result.put("MKN","Đồng Denar Macedonia (1992–1993)");
    result.put("MLF","Đồng Franc Mali");
    result.put("MMK","Kyat Myanma");
    result.put("MNT","Tugrik Mông Cổ");
    result.put("MOP","Pataca Ma Cao");
    result.put("MRO","Ouguiya Mauritania (1973–2017)");
    result.put("MRU","Ouguiya Mauritania");
    result.put("MTL","Lia xứ Man-tơ");
    result.put("MTP","Đồng Bảng Malta");
    result.put("MUR","Rupee Mauritius");
    result.put("MVR","Rufiyaa Maldives");
    result.put("MWK","Kwacha Malawi");
    result.put("MXN","Peso Mexico");
    result.put("MXP","Đồng Peso Bạc Mê-hi-cô (1861–1992)");
    result.put("MXV","Đơn vị Đầu tư Mê-hi-cô");
    result.put("MYR","Ringgit Malaysia");
    result.put("MZE","Escudo Mozambique");
    result.put("MZM","Đồng Metical Mozambique (1980–2006)");
    result.put("MZN","Metical Mozambique");
    result.put("NAD","Đô la Namibia");
    result.put("NGN","Naira Nigeria");
    result.put("NIC","Đồng Córdoba Nicaragua (1988–1991)");
    result.put("NIO","Córdoba Nicaragua");
    result.put("NLG","Đồng Guilder Hà Lan");
    result.put("NOK","Krone Na Uy");
    result.put("NPR","Rupee Nepal");
    result.put("NZD","Đô la New Zealand");
    result.put("OMR","Rial Oman");
    result.put("PAB","Balboa Panama");
    result.put("PEI","Đồng Inti Peru");
    result.put("PEN","Sol Peru");
    result.put("PES","Đồng Sol Peru (1863–1965)");
    result.put("PGK","Kina Papua New Guinean");
    result.put("PHP","Peso Philipin");
    result.put("PKR","Rupee Pakistan");
    result.put("PLN","Zloty Ba Lan");
    result.put("PLZ","Đồng Zloty Ba Lan (1950–1995)");
    result.put("PTE","Đồng Escudo Bồ Đào Nha");
    result.put("PYG","Guarani Paraguay");
    result.put("QAR","Rial Qatar");
    result.put("RHD","Đồng Đô la Rhode");
    result.put("ROL","Đồng Leu Rumani (1952–2006)");
    result.put("RON","Leu Romania");
    result.put("RSD","Dinar Serbia");
    result.put("RUB","Rúp Nga");
    result.put("RUR","Đồng Rúp Nga (1991–1998)");
    result.put("RWF","Franc Rwanda");
    result.put("SAR","Riyal Ả Rập Xê-út");
    result.put("SBD","Đô la quần đảo Solomon");
    result.put("SCR","Rupee Seychelles");
    result.put("SDD","Đồng Dinar Sudan (1992–2007)");
    result.put("SDG","Bảng Sudan");
    result.put("SDP","Đồng Bảng Sudan (1957–1998)");
    result.put("SEK","Krona Thụy Điển");
    result.put("SGD","Đô la Singapore");
    result.put("SHP","Bảng St. Helena");
    result.put("SIT","Tôla Xlôvênia");
    result.put("SKK","Cuaron Xlôvác");
    result.put("SLL","Leone Sierra Leone");
    result.put("SOS","Schilling Somali");
    result.put("SRD","Đô la Suriname");
    result.put("SRG","Đồng Guilder Surinam");
    result.put("SSP","Bảng Nam Sudan");
    result.put("STD","Dobra São Tomé và Príncipe (1977–2017)");
    result.put("STN","Dobra São Tomé và Príncipe");
    result.put("SUR","Đồng Rúp Sô viết");
    result.put("SVC","Colón El Salvador");
    result.put("SYP","Bảng Syria");
    result.put("SZL","Lilangeni Swaziland");
    result.put("THB","Bạt Thái Lan");
    result.put("TJR","Đồng Rúp Tajikistan");
    result.put("TJS","Somoni Tajikistan");
    result.put("TMM","Đồng Manat Turkmenistan (1993–2009)");
    result.put("TMT","Manat Turkmenistan");
    result.put("TND","Dinar Tunisia");
    result.put("TOP","Paʻanga Tonga");
    result.put("TPE","Đồng Escudo Timor");
    result.put("TRL","Lia Thổ Nhĩ Kỳ (1922–2005)");
    result.put("TRY","Lia Thổ Nhĩ Kỳ");
    result.put("TTD","Đô la Trinidad và Tobago");
    result.put("TWD","Đô la Đài Loan mới");
    result.put("TZS","Shilling Tanzania");
    result.put("UAH","Hryvnia Ucraina");
    result.put("UAK","Đồng Karbovanets Ucraina");
    result.put("UGS","Đồng Shilling Uganda (1966–1987)");
    result.put("UGX","Shilling Uganda");
    result.put("USD","Đô la Mỹ");
    result.put("USN","Đô la Mỹ (Ngày tiếp theo)");
    result.put("USS","Đô la Mỹ (Cùng ngày)");
    result.put("UYI","Đồng Peso Uruguay (Đơn vị Theo chỉ số)");
    result.put("UYP","Đồng Peso Uruguay (1975–1993)");
    result.put("UYU","Peso Uruguay");
    result.put("UZS","Som Uzbekistan");
    result.put("VEB","Đồng bolívar của Venezuela (1871–2008)");
    result.put("VEF","Bolívar Venezuela (2008–2018)");
    result.put("VES","Bolívar Venezuela");
    result.put("VND","Đồng Việt Nam");
    result.put("VNN","Đồng Việt Nam (1978–1985)");
    result.put("VUV","Vatu Vanuatu");
    result.put("WST","Tala Samoa");
    result.put("XAF","Franc CFA Trung Phi");
    result.put("XAG","Bạc");
    result.put("XAU","Vàng");
    result.put("XBA","Đơn vị Tổng hợp Châu Âu");
    result.put("XBB","Đơn vị Tiền tệ Châu Âu");
    result.put("XBC","Đơn vị Kế toán Châu Âu (XBC)");
    result.put("XBD","Đơn vị Kế toán Châu Âu (XBD)");
    result.put("XCD","Đô la Đông Caribê");
    result.put("XDR","Quyền Rút vốn Đặc biệt");
    result.put("XEU","Đơn vị Tiền Châu Âu");
    result.put("XFO","Đồng France Pháp Vàng");
    result.put("XFU","Đồng UIC-Franc Pháp");
    result.put("XOF","Franc CFA Tây Phi");
    result.put("XPD","Paladi");
    result.put("XPF","Franc CFP");
    result.put("XPT","Bạch kim");
    result.put("XRE","Quỹ RINET");
    result.put("XTS","Mã Tiền tệ Kiểm tra");
    result.put("XXX","Tiền tệ chưa biết");
    result.put("YDD","Đồng Dinar Yemen");
    result.put("YER","Rial Yemen");
    result.put("YUD","Đồng Dinar Nam Tư Xu (1966–1990)");
    result.put("YUM","Đồng Dinar Nam Tư Mới (1994–2002)");
    result.put("YUN","Đồng Dinar Nam Tư Có thể chuyển đổi (1990–1992)");
    result.put("YUR","Đồng Dinar Nam Tư Tái cơ cấu (1992–1993)");
    result.put("ZAL","Đồng Rand Nam Phi (tài chính)");
    result.put("ZAR","Rand Nam Phi");
    result.put("ZMK","Đồng kwacha của Zambia (1968–2012)");
    result.put("ZMW","Kwacha Zambia");
    result.put("ZRN","Đồng Zaire Mới (1993–1998)");
    result.put("ZRZ","Đồng Zaire (1971–1993)");
    result.put("ZWD","Đồng Đô la Zimbabwe (1980–2008)");
    result.put("ZWL","Đồng Đô la Zimbabwe (2009)");
    result.put("ZWR","Đồng Đô la Zimbabwe (2008)");
    return result;
  }
}
