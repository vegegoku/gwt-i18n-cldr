...
public class CurrencyList_wae_CH extends CurrencyList_wae {
  ...
  protected HashMap<String, String> loadNamesMap() {
    ...
    result.put("BRL","Brasilianiši Real");
    result.put("CNY","Chinesiši Yuan");
    result.put("EUR","Euro");
    result.put("GBP","Pfund");
    result.put("INR","Indiši Rupie");
    result.put("JPY","Yen");
    result.put("RUB","Rubel");
    result.put("USD","Dollar");
    result.put("XXX","Unbekannti Wãrig");
    return result;
  }
}
