...
public class CurrencyList_wo_SN extends CurrencyList_wo {
  ...
  protected HashMap<String, String> loadNamesMap() {
    ...
    result.put("BRL","Real bu Bresil");
    result.put("CNY","Yuan bu Siin");
    result.put("EUR","Euro");
    result.put("GBP","Pound bu Grànd Brëtaañ");
    result.put("INR","Rupee bu End");
    result.put("JPY","Yen bu Sapoŋ");
    result.put("RUB","Ruble bi Rsis");
    result.put("USD","Dolaaru US");
    result.put("XOF","Franc CFA bu Afrik Sowwu-jant");
    result.put("XXX","Xaalis buñ Xamul");
    return result;
  }
}
