...
public class CurrencyList_xog_UG extends CurrencyList_xog {
  ...
  protected HashMap<String, String> loadNamesMap() {
    ...
    result.put("AOA","Kwanza y’Angola");
    result.put("AUD","Doola y’Awusiturelya");
    result.put("BHD","Dinaali ya Baareeni");
    result.put("BIF","Faranga ya burundi");
    result.put("BWP","Pula ya Botiswana");
    result.put("CAD","Doola ya Kanada");
    result.put("CDF","Faranga ya Kongo");
    result.put("CHF","Faranga ey’eSwitizirandi");
    result.put("CNY","Yuwani Reniminibi ya Cayina");
    result.put("CVE","Esikudo ya Keepu Veredi");
    result.put("DJF","Faranga ya Jjibuti");
    result.put("DZD","Dinaali y’Aligerya");
    result.put("EGP","Pawunda ya Misiri");
    result.put("ERN","Nakifa ya Eritureya");
    result.put("ETB","Biiru ya Esyopya");
    result.put("EUR","Yuro");
    result.put("GBP","Pawunda ya Bungereza");
    result.put("GHC","Sedi ya Gana");
    result.put("GMD","Dalasi ya Gambya");
    result.put("GNS","Faranga ya Gini");
    result.put("INR","Rupiya ya Buyindi");
    result.put("JPY","Yeni ya Japani");
    result.put("KES","Silingi ya Kenya");
    result.put("KMF","Faranga ya Komoro");
    result.put("LRD","Doola ya Liberya");
    result.put("LSL","Loti ya Lesoso");
    result.put("LYD","Dinaali ya Libya");
    ...
    result.put("SDP","Pawunda ey’eSudaani");
    result.put("SHP","Pawunda ey’eSenti Herena");
    ...
    result.put("XAF","Faranga yamu Afirika ya wakati");
    result.put("XOF","Faranga yamu Afirika ya bugwanjuba");
