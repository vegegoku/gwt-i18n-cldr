...
public class CurrencyList_yi_001 extends CurrencyList_yi {
  public CurrencyData getDefault() {
    return new CurrencyDataImpl("NGN","NGN",2,"NGN","NGN");
  }
  ...
  protected HashMap<String, String> loadNamesMap() {
    ...
    result.put("BRL","בראזיל רעאל");
    result.put("BZD","בעליז דאלאַר");
    result.put("CHF","שווייצער פֿראַנק");
    result.put("CNY","כינעזישער יואן");
    result.put("EUR","איירא");
    result.put("GBP","פֿונט שטערלינג");
    result.put("INR","אינדישער רופי");
    result.put("JPY","יאפאנעזישער יען");
    result.put("RUB","רוסישער רובל");
    result.put("SEK","שוועדישע קראנע");
    result.put("USD","אמעריקאנער דאלאר");
    result.put("XAG","זילבער");
    result.put("XAU","גאלד");
    result.put("XXX","אומבאַוואוסטע וואַלוטע");
    return result;
  }
}
