...
public class CurrencyList_yo_BJ extends CurrencyList_yo {
  ...
  protected HashMap<String, String> loadNamesMap() {
    ...
    result.put("AED","Diami ti Awon Orílɛ́ède Arabu");
    result.put("AOA","Wansa ti Orílɛ́ède Àngólà");
    result.put("AUD","Dɔla ti Orílɛ́ède Ástràlìá");
    result.put("BHD","Dina ti Orílɛ́ède Báránì");
    result.put("BIF","Faransi ti Orílɛ́ède Bùùrúndì");
    result.put("BWP","Pula ti Orílɛ́ède Bɔ̀tìsúwánà");
    result.put("CAD","Dɔla ti Orílɛ́ède Kánádà");
    result.put("CDF","Faransi ti Orílɛ́ède Kóngò");
    result.put("CHF","Faransi ti Orílɛ́ède Siwisi");
    result.put("CNY","Reminibi ti Orílɛ́ède sháínà");
    result.put("CVE","Kabofediano ti Orílɛ́ède Esuodo");
    result.put("DJF","Faransi ti Orílɛ́ède Dibouti");
    result.put("DZD","Dina ti Orílɛ́ède Àlùgèríánì");
    result.put("EGP","pɔɔn ti Orílɛ́ède Egipiti");
    result.put("ERN","Nakifa ti Orílɛ́ède Eriteriani");
    result.put("ETB","Biri ti Orílɛ́ède Eutopia");
    result.put("EUR","Uro");
    result.put("GBP","Pɔɔn ti Orílɛ́ède Bírítísì");
    result.put("GHC","shidi ti Orílɛ́ède Gana");
    result.put("GMD","Dalasi ti Orílɛ́ède Gamibia");
    result.put("GNS","Faransi ti Orílɛ́ède Gini");
    result.put("INR","Rupi ti Orílɛ́ède Indina");
    result.put("JPY","Yeni ti Orílɛ́ède Japani");
    result.put("KES","shiili ti Orílɛ́ède Kenya");
    result.put("KMF","Faransi ti Orílɛ́ède shomoriani");
    result.put("LRD","Dɔla ti Orílɛ́ède Liberia");
    result.put("LSL","Loti ti Orílɛ́ède Lesoto");
    result.put("LYD","Dina ti Orílɛ́ède Libiya");
    result.put("MAD","Dirami ti Orílɛ́ède Moroko");
    result.put("MGA","Faransi ti Orílɛ́ède Malagasi");
    result.put("MRO","Ouguiya ti Orílɛ́ède Maritania (1973–2017)");
    result.put("MRU","Ouguiya ti Orílɛ́ède Maritania");
    result.put("MUR","Rupi ti Orílɛ́ède Maritiusi");
    result.put("MWK","Kasha ti Orílɛ́ède Malawi");
    result.put("MZM","Metika ti Orílɛ́ède Mosamibiki");
    result.put("NAD","Dɔla ti Orílɛ́ède Namibia");
    result.put("NGN","Naira ti Orílɛ́ède Nàìjíríà");
    result.put("RWF","Faransi ti Orílɛ́ède Ruwanda");
    result.put("SAR","Riya ti Orílɛ́ède Saudi");
    result.put("SCR","Rupi ti Orílɛ́ède Sayiselesi");
    result.put("SDG","Dina ti Orílɛ́ède Sudani");
    result.put("SDP","Pɔɔun ti Orílɛ́ède Sudani");
    result.put("SHP","Pɔɔun ti Orílɛ́ède ̣Elena");
    result.put("SLL","Lioni");
    result.put("SOS","Sile ti Orílɛ́ède Somali");
    result.put("STD","Dobira ti Orílɛ́ède Sao tome Ati Pirisipe (1977–2017)");
    result.put("STN","Dobira ti Orílɛ́ède Sao tome Ati Pirisipe");
    result.put("SZL","Lilangeni");
    result.put("TND","Dina ti Orílɛ́ède Tunisia");
    result.put("TZS","Sile ti Orílɛ́ède Tansania");
    result.put("UGX","Siile ti Orílɛ́ède Uganda");
    result.put("USD","Dɔla ti Orílɛ́ède Amerika");
    result.put("XAF","Faransi ti Orílɛ́ède BEKA");
    result.put("XOF","Faransi ti Orílɛ́ède BIKEAO");
    result.put("ZAR","Randi ti Orílɛ́ède Ariwa Afirika");
    result.put("ZMK","Kawasha ti Orílɛ́ède Saabia (1968–2012)");
    result.put("ZMW","Kawasha ti Orílɛ́ède Saabia");
    result.put("ZWD","Dɔla ti Orílɛ́ède Siibabuwe");
    return result;
  }
}
