...
public class CurrencyList_yo_NG extends CurrencyList_yo {
  ...
  protected HashMap<String, String> loadNamesMap() {
    ...
    result.put("AED","Diami ti Awon Orílẹ́ède Arabu");
    result.put("AOA","Wansa ti Orílẹ́ède Àngólà");
    result.put("AUD","Dọla ti Orílẹ́ède Ástràlìá");
    result.put("BHD","Dina ti Orílẹ́ède Báránì");
    result.put("BIF","Faransi ti Orílẹ́ède Bùùrúndì");
    result.put("BWP","Pula ti Orílẹ́ède Bọ̀tìsúwánà");
    result.put("CAD","Dọla ti Orílẹ́ède Kánádà");
    result.put("CDF","Faransi ti Orílẹ́ède Kóngò");
    result.put("CHF","Faransi ti Orílẹ́ède Siwisi");
    result.put("CNY","Reminibi ti Orílẹ́ède ṣáínà");
    result.put("CVE","Kabofediano ti Orílẹ́ède Esuodo");
    result.put("DJF","Faransi ti Orílẹ́ède Dibouti");
    result.put("DZD","Dina ti Orílẹ́ède Àlùgèríánì");
    result.put("EGP","pọọn ti Orílẹ́ède Egipiti");
    result.put("ERN","Nakifa ti Orílẹ́ède Eriteriani");
    result.put("ETB","Biri ti Orílẹ́ède Eutopia");
    result.put("EUR","Uro");
    result.put("GBP","Pọọn ti Orílẹ́ède Bírítísì");
    result.put("GHC","ṣidi ti Orílẹ́ède Gana");
    result.put("GMD","Dalasi ti Orílẹ́ède Gamibia");
    result.put("GNS","Faransi ti Orílẹ́ède Gini");
    result.put("INR","Rupi ti Orílẹ́ède Indina");
    result.put("JPY","Yeni ti Orílẹ́ède Japani");
    result.put("KES","ṣiili ti Orílẹ́ède Kenya");
    result.put("KMF","Faransi ti Orílẹ́ède ṣomoriani");
    result.put("LRD","Dọla ti Orílẹ́ède Liberia");
    result.put("LSL","Loti ti Orílẹ́ède Lesoto");
    result.put("LYD","Dina ti Orílẹ́ède Libiya");
    result.put("MAD","Dirami ti Orílẹ́ède Moroko");
    result.put("MGA","Faransi ti Orílẹ́ède Malagasi");
    result.put("MRO","Ouguiya ti Orílẹ́ède Maritania (1973–2017)");
    result.put("MRU","Ouguiya ti Orílẹ́ède Maritania");
    result.put("MUR","Rupi ti Orílẹ́ède Maritiusi");
    result.put("MWK","Kaṣa ti Orílẹ́ède Malawi");
    result.put("MZM","Metika ti Orílẹ́ède Mosamibiki");
    result.put("NAD","Dọla ti Orílẹ́ède Namibia");
    result.put("NGN","Naira ti Orílẹ́ède Nàìjíríà");
    result.put("RWF","Faransi ti Orílẹ́ède Ruwanda");
    result.put("SAR","Riya ti Orílẹ́ède Saudi");
    result.put("SCR","Rupi ti Orílẹ́ède Sayiselesi");
    result.put("SDG","Dina ti Orílẹ́ède Sudani");
    result.put("SDP","Pọọun ti Orílẹ́ède Sudani");
    result.put("SHP","Pọọun ti Orílẹ́ède ̣Elena");
    result.put("SLL","Lioni");
    result.put("SOS","Sile ti Orílẹ́ède Somali");
    result.put("STD","Dobira ti Orílẹ́ède Sao tome Ati Pirisipe (1977–2017)");
    result.put("STN","Dobira ti Orílẹ́ède Sao tome Ati Pirisipe");
    result.put("SZL","Lilangeni");
    result.put("TND","Dina ti Orílẹ́ède Tunisia");
    result.put("TZS","Sile ti Orílẹ́ède Tansania");
    result.put("UGX","Siile ti Orílẹ́ède Uganda");
    result.put("USD","Dọla ti Orílẹ́ède Amerika");
    result.put("XAF","Faransi ti Orílẹ́ède BEKA");
    result.put("XOF","Faransi ti Orílẹ́ède BIKEAO");
    result.put("ZAR","Randi ti Orílẹ́ède Ariwa Afirika");
    result.put("ZMK","Kawaṣa ti Orílẹ́ède Saabia (1968–2012)");
    result.put("ZMW","Kawaṣa ti Orílẹ́ède Saabia");
    result.put("ZWD","Dọla ti Orílẹ́ède Siibabuwe");
    return result;
  }
}
