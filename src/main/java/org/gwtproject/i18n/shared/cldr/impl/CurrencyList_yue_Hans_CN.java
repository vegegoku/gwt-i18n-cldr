...
public class CurrencyList_yue_Hans_CN extends CurrencyList_yue_Hans {
  ...
  protected HashMap<String, String> loadNamesMap() {
    ...
    result.put("AUD","澳币");
    result.put("AWG","阿路巴盾");
    result.put("AZM","亚塞拜然马纳特 (1993–2006)");
    result.put("AZN","亚塞拜然马纳特");
    result.put("BAD","波士尼亚-赫塞哥维纳第纳尔");
    result.put("BAM","波士尼亚-赫塞哥维纳可转换马克");
    result.put("BAN","波士尼亚-赫塞哥维纳新第纳尔");
    result.put("BBD","巴贝多元");
    result.put("BDT","孟加拉塔卡");
    result.put("BEC","比利时法郎（可转换）");
    ...
    result.put("BOL","玻利维亚玻利维亚诺 (1863–1963)");
    result.put("BOP","玻利维亚披索");
    result.put("BOV","玻利维亚幕多");
    result.put("BRB","巴西克鲁萨多农瓦 (1967–1986)");
    result.put("BRC","巴西克鲁赛罗 (1986–1989)");
    result.put("BRE","巴西克鲁赛罗 (1990–1993)");
    result.put("BRL","巴西里拉");
    result.put("BRN","巴西克如尔达农瓦");
    result.put("BRR","巴西克鲁赛罗 (1993–1994)");
    result.put("BRZ","巴西克鲁赛罗 (1942 –1967)");
    result.put("BSD","巴哈马元");
    result.put("BTN","不丹那特伦");
    result.put("BUK","缅甸基雅特");
    ...
    result.put("CLF","卡林油达佛曼跎");
    result.put("CLP","智利披索");
    result.put("CNH","人民币 (离岸)");
    result.put("CNY","人民币");
    result.put("COP","哥伦比亚披索");
    result.put("COU","哥伦比亚币 (COU)");
    result.put("CRC","哥斯大黎加科朗");
    result.put("CSD","旧塞尔维亚第纳尔");
    result.put("CSK","捷克斯洛伐克硬克朗");
    result.put("CUC","古巴可转换披索");
    result.put("CUP","古巴披索");
    result.put("CVE","维德角埃斯库多");
    result.put("CYP","赛普勒斯镑");
    result.put("CZK","捷克克朗");
    ...
    result.put("ECS","厄瓜多苏克雷");
    result.put("ECV","厄瓜多尔由里达瓦康斯坦 (UVC)");
    result.put("EEK","爱沙尼亚克朗");
    result.put("EGP","埃及镑");
    result.put("ERN","厄立特里亚纳克法");
    result.put("ESA","西班牙比塞塔（会计单位）");
    result.put("ESB","西班牙比塞塔（可转换会计单位）");
    result.put("ESP","西班牙陪士特");
    result.put("ETB","衣索比亚比尔");
    result.put("EUR","欧元");
    result.put("FIM","芬兰马克");
    result.put("FJD","斐济元");
    ...
    result.put("FRF","法国法郎");
    result.put("GBP","英镑");
    result.put("GEK","乔治亚库旁拉里");
    result.put("GEL","乔治亚拉里");
    result.put("GHC","迦纳赛地 (1979–2007)");
    result.put("GHS","迦纳塞地");
    result.put("GIP","直布罗陀镑");
    result.put("GMD","甘比亚达拉西");
    result.put("GNF","几内亚法郎");
    result.put("GNS","几内亚西里");
    result.put("GQE","赤道几内亚埃奎勒");
    result.put("GRD","希腊德拉克马");
    result.put("GTQ","瓜地马拉格查尔");
    result.put("GWE","葡属几内亚埃斯库多");
    result.put("GWP","几内亚比索披索");
    result.put("GYD","圭亚那元");
    result.put("HKD","港币");
    result.put("HNL","洪都拉斯伦皮拉");
    result.put("HRD","克罗埃西亚第纳尔");
    result.put("HRK","克罗埃西亚库纳");
    result.put("HTG","海地古德");
    ...
    result.put("ISK","冰岛克朗");
    result.put("ITL","义大利里拉");
    result.put("JMD","牙买加元");
    result.put("JOD","约旦第纳尔");
    result.put("JPY","日圆");
    result.put("KES","肯尼亚先令");
    result.put("KGS","吉尔吉斯索姆");
    ...
    result.put("MOP","澳门元");
    result.put("MRO","茅利塔尼亚乌吉亚 (1973–2017)");
    result.put("MRU","茅利塔尼亚乌吉亚");
    result.put("MTL","马尔他里拉");
    result.put("MTP","马尔他镑");
    result.put("MUR","模里西斯卢比");
    result.put("MVP","马尔地夫卢比");
    result.put("MVR","马尔地夫卢非亚");
    result.put("MWK","马拉维克瓦查");
    result.put("MXN","墨西哥披索");
    result.put("MXP","墨西哥银披索 (1861–1992)");
    result.put("MXV","墨西哥转换单位 (UDI)");
    result.put("MYR","马来西亚令吉");
    result.put("MZE","莫三比克埃斯库多");
    result.put("MZM","莫三比克梅蒂卡尔 (1980–2006)");
    result.put("MZN","莫三比克梅蒂卡尔");
    result.put("NAD","纳米比亚元");
    result.put("NGN","奈及利亚奈拉");
    ...
    result.put("PEI","秘鲁因蒂");
    result.put("PEN","秘鲁太阳币");
    result.put("PES","秘鲁索尔 (1863–1965)");
    result.put("PGK","巴布亚纽几内亚基那");
    result.put("PHP","菲律宾披索");
    result.put("PKR","巴基斯坦卢比");
    result.put("PLN","波兰兹罗提");
    result.put("PLZ","波兰兹罗提 (1950–1995)");
    result.put("PTE","葡萄牙埃斯库多");
    result.put("PYG","巴拉圭瓜拉尼");
    result.put("QAR","卡达里亚尔");
    result.put("RHD","罗德西亚元");
    result.put("ROL","旧罗马尼亚列伊");
    result.put("RON","罗马尼亚列伊");
    result.put("RSD","塞尔维亚戴纳");
    result.put("RUB","俄罗斯卢布");
    result.put("RUR","俄罗斯卢布 (1991–1998)");
    result.put("RWF","卢安达法郎");
    result.put("SAR","沙乌地里亚尔");
    result.put("SBD","索罗门群岛元");
    result.put("SCR","塞席尔卢比");
    result.put("SDD","苏丹第纳尔");
    result.put("SDG","苏丹镑");
    result.put("SDP","旧苏丹镑");
    result.put("SEK","瑞典克朗");
    result.put("SGD","新加坡币");
    result.put("SHP","圣赫勒拿镑");
    result.put("SIT","斯洛维尼亚托勒");
    result.put("SKK","斯洛伐克克朗");
    result.put("SLL","狮子山利昂");
    result.put("SOS","索马利亚先令");
    result.put("SRD","苏利南元");
    result.put("SRG","苏利南基尔");
    result.put("SSP","南苏丹镑");
    result.put("STD","圣多美岛和普林西比岛多布拉 (1977–2017)");
    result.put("STN","圣多美岛和普林西比岛多布拉");
    result.put("SUR","苏联卢布");
    result.put("SVC","萨尔瓦多科郎");
    result.put("SYP","叙利亚镑");
    result.put("SZL","史瓦济兰里朗吉尼");
    result.put("THB","泰铢");
    result.put("TJR","塔吉克卢布");
    result.put("TJS","塔吉克索莫尼");
    result.put("TMM","土库曼马纳特 (1993–2009)");
    result.put("TMT","土库曼马纳特");
    result.put("TND","突尼西亚第纳尔");
    result.put("TOP","东加潘加");
    result.put("TPE","帝汶埃斯库多");
    result.put("TRL","土耳其里拉");
    result.put("TRY","新土耳其里拉");
    result.put("TTD","千里达及托巴哥元");
    result.put("TWD","新台币");
    result.put("TZS","坦尚尼亚先令");
    result.put("UAH","乌克兰格里夫纳");
    result.put("UAK","乌克兰卡本瓦那兹");
    result.put("UGS","乌干达先令 (1966–1987)");
    result.put("UGX","乌干达先令");
    result.put("USD","美元");
    result.put("USN","美元（次日）");
    result.put("USS","美元（当日）");
    result.put("UYI","乌拉圭披索（指数单位）");
    result.put("UYP","乌拉圭披索 (1975–1993)");
    result.put("UYU","乌拉圭披索");
    result.put("UZS","乌兹别克索姆");
    result.put("VEB","委内瑞拉玻利瓦 (1871–2008)");
    result.put("VEF","委内瑞拉玻利瓦 (2008–2018)");
    result.put("VES","委内瑞拉玻利瓦");
    result.put("VND","越南盾");
    result.put("VNN","越南盾 (1978–1985)");
    result.put("VUV","万那杜瓦图");
    result.put("WST","西萨摩亚塔拉");
    result.put("XAF","法郎 (CFA–BEAC)");
    result.put("XAG","白银");
    result.put("XAU","黄金");
    result.put("XBA","欧洲综合单位");
    result.put("XBB","欧洲货币单位 (XBB)");
    result.put("XBC","欧洲会计单位 (XBC)");
    result.put("XBD","欧洲会计单位 (XBD)");
    result.put("XCD","格瑞那达元");
    result.put("XDR","特殊提款权");
    result.put("XEU","欧洲货币单位 (XEU)");
    ...
    result.put("XSU","苏克雷货币");
    result.put("XTS","测试用货币代码");
    result.put("XUA","亚洲开发银行计价单位");
    result.put("XXX","未知货币");
    result.put("YDD","叶门第纳尔");
    result.put("YER","叶门里亚尔");
    result.put("YUD","南斯拉夫第纳尔硬币");
    result.put("YUM","南斯拉夫挪威亚第纳尔");
    result.put("YUN","南斯拉夫可转换第纳尔");
    result.put("YUR","南斯拉夫改革第纳尔 (1992–1993)");
    result.put("ZAL","南非兰特（金融）");
    result.put("ZAR","南非兰特");
    result.put("ZMK","尚比亚克瓦查 (1968–2012)");
    result.put("ZMW","尚比亚克瓦查");
    result.put("ZRN","萨伊新扎伊尔");
    result.put("ZRZ","萨伊扎伊尔");
