...
public class CurrencyList_zgh_MA extends CurrencyList_zgh {
  ...
  protected HashMap<String, String> loadNamesMap() {
    ...
    result.put("AED","ⴰⴷⵔⵉⵎ ⵏ ⵍⵉⵎⴰⵔⴰⵜ");
    result.put("AOA","ⴽⵡⴰⵏⵣⴰ ⵏ ⴰⵏⴳⵓⵍⴰ");
    result.put("AUD","ⴰⴷⵓⵍⴰⵔ ⵏ ⵓⵙⵜⵔⴰⵍⵢⴰ");
    result.put("BHD","ⴰⴷⵉⵏⴰⵔ ⵏ ⴱⵃⵔⴰⵢⵏ");
    result.put("BIF","ⴼⵔⴰⵏⴽ ⵏ ⴱⵓⵔⵓⵏⴷⵉ");
    result.put("BWP","ⴰⴱⵓⵍⴰ ⵏ ⴱⵓⵜⵙⵡⴰⵏⴰ");
    result.put("CAD","ⴰⴷⵓⵍⴰⵔ ⵏ ⴽⴰⵏⴰⴷⴰ");
    result.put("CDF","ⴼⵔⴰⵏⴽ ⵏ ⴽⵓⵏⴳⵓ");
    result.put("CHF","ⴰⴼⵔⴰⵏⴽ ⵏ ⵙⵡⵉⵙⵔⴰ");
    result.put("CNY","ⴰⵢⴰⵏ ⵏ ⵛⵛⵉⵏⵡⴰ");
    result.put("CVE","ⵉⵙⴽⵓⴷⵓ ⵏ ⴽⴰⴱⴱⵉⵔⴷⵉ");
    result.put("DJF","ⴼⵔⴰⵏⴽ ⵏ ⴷⵊⵉⴱⵓⵜⵉ");
    result.put("DZD","ⴰⴷⵉⵏⴰⵔ ⵏ ⴷⵣⴰⵢⵔ");
    result.put("EGP","ⴰⵊⵏⵉⵀ ⵏ ⵎⵉⵚⵕ");
    result.put("ERN","ⵏⴰⴼⴽⴰ ⵏ ⵉⵔⵉⵜⵉⵔⵢⴰ");
    result.put("ETB","ⴱⵉⵔ ⵏ ⵉⵜⵢⵓⴱⵢⴰ");
    result.put("EUR","ⵓⵔⵓ");
    result.put("GBP","ⴰⵊⵏⵉⵀ ⴰⵙⵜⵔⵍⵉⵏⵉ ⵏ ⵏⵏⴳⵍⵉⵣ");
    result.put("GHS","ⵙⵉⴷⵉ ⵏ ⵖⴰⵏⴰ");
    result.put("GMD","ⴷⴰⵍⴰⵙⵉ ⵏ ⴳⴰⵎⴱⵢⴰ");
    result.put("INR","ⴰⵔⵓⴱⵉ ⵏ ⵍⵀⵉⵏⴷ");
    result.put("JPY","ⴰⵢⴰⵏ ⵏ ⵍⵢⴰⴱⴰⵏ");
    result.put("KES","ⴰⵛⵉⵍⵉⵏ ⵏ ⴽⵉⵏⵢⴰ");
    result.put("KMF","ⴼⵔⴰⵏⴽ ⵏ ⵇⵓⵎⵓⵕ");
    result.put("LRD","ⴰⴷⵓⵍⴰⵔ ⵏ ⵍⵉⴱⵉⵔⵢⴰ");
    result.put("LSL","ⵍⵓⵜⵉ ⵏ ⵍⵉⵚⵓⵟⵓ");
    result.put("LYD","ⴰⴷⵉⵏⴰⵔ ⵏ ⵍⵉⴱⵢⴰ");
    result.put("MAD","ⴰⴷⵔⵉⵎ ⵏ ⵍⵎⵖⵔⵉⴱ");
    result.put("MGA","ⴼⵔⴰⵏⴽ ⵏ ⵎⴰⴷⴰⵖⴰⵛⵇⴰⵔ");
    result.put("MRO","ⵓⵇⵉⵢⵢⴰ ⵏ ⵎⵓⵕⵉⵟⴰⵏⵢⴰ (1973–2017)");
    result.put("MRU","ⵓⵇⵉⵢⵢⴰ ⵏ ⵎⵓⵕⵉⵟⴰⵏⵢⴰ");
    result.put("MUR","ⴰⵔⵓⴱⵉ ⵏ ⵎⵓⵔⵉⵙ");
    result.put("MWK","ⴽⵡⴰⵛⴰ ⵏ ⵎⴰⵍⴰⵡⵉ");
    result.put("MZN","ⴰⵎⵉⵜⵉⴽⵍ ⵏ ⵎⵓⵣⵏⴱⵉⵇ");
    result.put("NAD","ⴰⴷⵓⵍⴰⵔ ⵏ ⵏⴰⵎⵉⴱⵢⴰ");
    result.put("NGN","ⵏⴰⵢⵔⴰ ⵏ ⵏⵉⵊⵉⵔⵢⴰ");
    result.put("RWF","ⴰⴼⵔⴰⵏⴽ ⵏ ⵔⵡⴰⵏⴷⴰ");
    result.put("SAR","ⴰⵔⵢⴰⵍ ⵏ ⵙⵙⴰⵄⵓⴷⵉⵢⴰ");
    result.put("SCR","ⴰⵔⵓⴱⵉ ⵏ ⵙⵙⵉⵛⵉⵍ");
    result.put("SDG","ⴰⴷⵉⵏⴰⵔ ⵏ ⵙⵙⵓⴷⴰⵏ");
    result.put("SDP","ⴰⵊⵏⵉⵀ ⵏ ⵙⵙⵓⴷⴰⵏ");
    result.put("SHP","ⴰⵊⵏⵉⵀ ⵏ ⵙⴰⵏⵜⵉⵍⵉⵏ");
    result.put("SLL","ⵍⵉⵢⵓⵏ");
    result.put("SOS","ⴰⵛⵉⵍⵉⵏ ⵏ ⵚⵚⵓⵎⴰⵍ");
    result.put("STD","ⴰⴷⵓⴱⵔⴰ ⵏ ⵙⴰⵏⵟⵓⵎⵉ (1977–2017)");
    result.put("STN","ⴰⴷⵓⴱⵔⴰ ⵏ ⵙⴰⵏⵟⵓⵎⵉ");
    result.put("SZL","ⵍⵉⵍⴰⵏⵊⵉⵏⵉ");
    result.put("TND","ⴰⴷⵉⵏⴰⵔ ⵏ ⵜⵓⵏⵙ");
    result.put("TZS","ⴰⵛⵉⵍⵉⵏ ⵏ ⵟⴰⵏⵥⴰⵏⵢⴰ");
    result.put("UGX","ⴰⵛⵉⵍⵉⵏ ⵏ ⵓⵖⴰⵏⴷⴰ");
    result.put("USD","ⴰⴷⵓⵍⴰⵔ ⵏ ⵉⵡⵓⵏⴰⴽ ⵉⵎⵓⵏⵏ");
    result.put("XAF","ⴼⵔⴰⵏⴽ ⵚⵉⴼⴰ");
    result.put("XOF","ⴼⵔⴰⵏⴽ ⵚⵉⴼⴰ ⴱⵉⵙⴰⵡ");
    result.put("ZAR","ⴰⵔⴰⵏⴷ ⵏ ⴰⴼⵔⵉⵇⵢⴰ ⵏ ⵉⴼⴼⵓⵙ");
    result.put("ZMK","ⴰⴽⵡⴰⵛⴰ ⵏ ⵣⴰⵎⴱⵢⴰ (1968–2012)");
    result.put("ZMW","ⴰⴽⵡⴰⵛⴰ ⵏ ⵣⴰⵎⴱⵢⴰ");
    result.put("ZWD","ⴰⴷⵓⵍⴰⵔ ⵏ ⵣⵉⵎⴱⴰⴱⵡⵉ (1980–2008)");
    result.put("ZWL","ⴰⴷⵓⵍⴰⵔ ⵏ ⵣⵉⵎⴱⴰⴱⵡⵉ (2009)");
    result.put("ZWR","ⴰⴷⵓⵍⴰⵔ ⵏ ⵣⵉⵎⴱⴰⴱⵡⵉ (2008)");
    return result;
  }
}
