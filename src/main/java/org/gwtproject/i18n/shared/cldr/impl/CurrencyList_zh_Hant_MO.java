...
public class CurrencyList_zh_Hant_MO extends CurrencyList_zh_Hant {
  ...
  protected HashMap<String, String> loadNamesMap() {
    ...
    result.put("AZN","亞塞拜疆馬納特");
    result.put("BAD","波斯尼亞-赫塞哥維納第納爾");
    result.put("BAM","波斯尼亞-赫塞哥維納可轉換馬克");
    result.put("BAN","波士尼亞-赫塞哥維納新第納爾");
    result.put("BBD","巴巴多斯元");
    result.put("BDT","孟加拉塔卡");
    result.put("BEC","比利時法郎（可兌換）");
    ...
    result.put("KZT","哈薩克坦吉");
    result.put("LAK","老撾基普");
    result.put("LBP","黎巴嫩鎊");
    result.put("LKR","斯里蘭卡盧比");
    result.put("LRD","利比利亞元");
    ...
    result.put("MOP","澳門元");
    result.put("MRO","毛里塔尼亞烏吉亞 (1973–2017)");
    result.put("MRU","毛里塔尼亞烏吉亞");
    result.put("MTL","馬爾他里拉");
    result.put("MTP","馬爾他鎊");
    result.put("MUR","毛里裘斯盧布");
    result.put("MVP","馬爾地夫盧比");
    result.put("MVR","馬爾代夫盧非亞");
    ...
    result.put("MZN","莫桑比克梅蒂卡爾");
    result.put("NAD","納米比亞元");
    result.put("NGN","尼日利亞奈拉");
    ...
    result.put("RWF","盧旺達法郎");
    result.put("SAR","沙特阿拉伯里亞爾");
    result.put("SBD","所羅門群島元");
    result.put("SCR","塞舌爾盧比");
    ...
    result.put("SOS","索馬里先令");
    result.put("SRD","蘇里南元");
    result.put("SRG","蘇利南基爾");
    result.put("SSP","南蘇丹鎊");
    result.put("STD","聖多美和普林西比多布拉 (1977–2017)");
    result.put("STN","聖多美和普林西比多布拉");
    result.put("SUR","蘇聯盧布");
    result.put("SVC","薩爾瓦多科郎");
    result.put("SYP","敍利亞鎊");
    result.put("SZL","斯威士蘭里朗吉尼");
    result.put("THB","泰銖");
    ...
    result.put("TTD","千里達和多巴哥元");
    result.put("TWD","新台幣");
    result.put("TZS","坦桑尼亞先令");
