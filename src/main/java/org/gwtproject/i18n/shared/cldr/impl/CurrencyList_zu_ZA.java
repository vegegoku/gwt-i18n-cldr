...
public class CurrencyList_zu_ZA extends CurrencyList_zu {
  public CurrencyData getDefault() {
    return new CurrencyDataImpl("ZAR","R",2,"R","R");
  }
  ...
  protected HashMap<String, CurrencyData> loadCurrencyMap() {
    ...
    result.put("ZAR", new CurrencyDataImpl("ZAR","R",2,"R","R"));
  ...
  protected HashMap<String, String> loadNamesMap() {
    ...
    result.put("AED","i-Dirham yase-United Arab Emirates");
    result.put("AFN","i-Afghan Afghani");
    result.put("ALL","i-Albanian Lek");
    result.put("AMD","i-Armenian Dram");
    result.put("ANG","i-Netherlands Antillean Guilder");
    result.put("AOA","i-Angolan Kwanza");
    result.put("ARS","i-Argentina Peso");
    result.put("AUD","i-Austrilian Dollar");
    result.put("AWG","i-Aruban Florin");
    result.put("AZN","i-Azerbaijani Manat");
    result.put("BAM","i-Bosnia-Herzegovina Convertible Mark");
    result.put("BBD","i-Barbadian Dollar");
    result.put("BDT","i-Bangladeshi Taka");
    result.put("BGN","i-Bulgarian Lev");
    result.put("BHD","i-Bahraini Dinar");
    result.put("BIF","i-Burundian Franc");
    result.put("BMD","i-Bermudan Dollar");
    result.put("BND","i-Brunei Dollar");
    result.put("BOB","i-Bolivian Boliviano");
    result.put("BRL","i-Brazilian Real");
    result.put("BSD","i-Bahamian Dollar");
    result.put("BTN","i-Bhutanese Ngultrum");
    result.put("BWP","i-Botswana Pula");
    result.put("BYN","i-Belarusian Ruble");
    result.put("BYR","i-Belarusian Ruble (2000–2016)");
    result.put("BZD","i-Belize Dollar");
    result.put("CAD","i-Candian Dollar");
    result.put("CDF","i-Congolese Franc");
    result.put("CHF","i-Swiss Franc");
    result.put("CLP","i-Chilean Peso");
    result.put("CNY","i-Chinese Yuan");
    result.put("COP","i-Colombian Peso");
    result.put("CRC","i-Costa Rican Colón");
    result.put("CUC","i-Cuban Convertable Peso");
    result.put("CUP","i-Cuban Peso");
    result.put("CVE","i-Cape Verdean Escudo");
    result.put("CZK","i-Czech Republic Koruna");
    result.put("DJF","i-Djiboutian Franc");
    result.put("DKK","i-Danish Krone");
    result.put("DOP","i-Dominican Peso");
    result.put("DZD","i-Algerian Dinar");
    result.put("EGP","i-Egyptian Pound");
    result.put("ERN","i-Eritrean Nakfa");
    result.put("ETB","i-Ethopian Birr");
    result.put("EUR","i-Euro");
    result.put("FJD","i-Fijian Dollar");
    result.put("FKP","i-Falkland Islands Pound");
    result.put("GBP","i-British Pound");
    result.put("GEL","i-Georgian Lari");
    result.put("GHS","i-Ghanaian Cedi");
    result.put("GIP","i-Gibraltar Pound");
    result.put("GMD","i-Gambian Dalasi");
    result.put("GNF","i-Gunean Franc");
    result.put("GTQ","i-Guatemalan Quetzal");
    result.put("GYD","i-Guyanaese Dollar");
    result.put("HKD","i-Hong Kong Dollar");
    result.put("HNL","i-Honduran Lempira");
    result.put("HRK","i-Croatian Kuna");
    result.put("HTG","i-Haitian Gourde");
    result.put("HUF","i-Hungarian Forint");
    result.put("IDR","i-Indonesian Rupiah");
    result.put("ILS","i-Israeli New Sheqel");
    result.put("INR","i-Indian Rupee");
    result.put("IQD","i-Iraqi Dinar");
    result.put("IRR","i-Iranian Rial");
    result.put("ISK","i-Icelandic Króna");
    result.put("JMD","i-Jamaican Dollar");
    result.put("JOD","i-Jordanian Dinar");
    result.put("JPY","i-Japanese Yen");
    result.put("KES","i-Kenyan Shilling");
    result.put("KGS","i-Kyrgystani Som");
    result.put("KHR","i-Cambodian Riel");
    result.put("KMF","i-Comorian Franc");
    result.put("KPW","i-North Korean Won");
    result.put("KRW","i-South Korean Won");
    result.put("KWD","i-Kuwaiti Dinar");
    result.put("KYD","i-Cayman Islands Dollar");
    result.put("KZT","i-Kazakhstani Tenge");
    result.put("LAK","i-Laotian Kip");
    result.put("LBP","i-Lebanese Pound");
    result.put("LKR","i-Sri Lankan Rupee");
    result.put("LRD","i-Liberian Dollar");
    result.put("LSL","i-Lesotho Loti");
    result.put("LTL","i-Lithuanian Litas");
    result.put("LVL","i-Latvian Lats");
    result.put("LYD","i-Libyan Dinar");
    result.put("MAD","i-Moroccan Dirham");
    result.put("MDL","i-Moldovan Leu");
    result.put("MGA","i-Malagasy Ariary");
    result.put("MKD","i-Macedonian Denar");
    result.put("MMK","i-Myanma Kyat");
    result.put("MNT","i-Mongolian Tugrik");
    result.put("MOP","i-Macanese Pataca");
    result.put("MRO","i-Mauritanian Ouguiya (1973–2017)");
    result.put("MRU","i-Mauritanian Ouguiya");
    result.put("MUR","i-Mauritian Rupee");
    result.put("MVR","i-Maldivian Rufiyana");
    result.put("MWK","i-Malawian Kwacha");
    result.put("MXN","i-Mexican Peso");
    result.put("MYR","i-Malaysian Ringgit");
    result.put("MZN","i-Mozambican Metical");
    result.put("NAD","i-Namibian Dollar");
    result.put("NGN","i-Nigerian Naira");
    result.put("NIO","i-Nicaraguan Córdoba");
    result.put("NOK","i-Norwegian Krone");
    result.put("NPR","i-Nepalese Rupee");
    result.put("NZD","i-New Zealand Dollar");
    result.put("OMR","i-Omani Rial");
    result.put("PAB","i-Panamanian Balboa");
    result.put("PEN","i-Peruvian Nuevo Sol");
    result.put("PGK","i-Papua New Guinean Kina");
    result.put("PHP","i-Philippine Peso");
    result.put("PKR","i-Pakistani Rupee");
    result.put("PLN","i-Polish Zloty");
    result.put("PYG","i-Paraguayan Guarani");
    result.put("QAR","i-Qatari Rial");
    result.put("RON","i-Romanian Leu");
    result.put("RSD","i-Serbian Dinar");
    result.put("RUB","i-Russian Ruble");
    result.put("RWF","i-Rwandan Franc");
    result.put("SAR","i-Saudi Riyal");
    result.put("SBD","i-Solomon Islands Dollar");
    result.put("SCR","i-Seychellois Rupee");
    result.put("SDG","i-Sudanese Pound");
    result.put("SEK","i-Swedish Krona");
    result.put("SGD","i-Singapore Dollar");
    result.put("SHP","i-Saint Helena Pound");
    result.put("SLL","i-Sierra Leonean Leone");
    result.put("SOS","i-Somali Shilling");
    result.put("SRD","i-Surinamese Dollar");
    result.put("SSP","i-South Sudanese Pound");
    result.put("STD","i-São Tomé kanye ne-Príncipe Dobra (1977–2017)");
    result.put("STN","i-São Tomé kanye ne-Príncipe Dobra");
    result.put("SYP","i-Syrian Pound");
    result.put("SZL","i-Swazi Lilangeni");
    result.put("THB","i-Thai Baht");
    result.put("TJS","i-Tajikistani Somoni");
    result.put("TMT","i-Turkmenistani Manat");
    result.put("TND","i-Tunisian Dinar");
    result.put("TOP","i-Tongan Paʻanga");
    result.put("TRY","i-Turkish Lira");
    result.put("TTD","i-Trinidad and Tobago Dollar");
    result.put("TWD","i-New Taiwan Dollar");
    result.put("TZS","i-Tanzanian Shilling");
    result.put("UAH","i-Ukrainian Hryvnia");
    result.put("UGX","i-Ugandan Shilling");
    result.put("USD","i-US Dollar");
    result.put("UYU","i-Uruguayan Peso");
    result.put("UZS","i-Uzbekistan Som");
    result.put("VEF","i-Venezuelan Bolívar (2008–2018)");
    result.put("VES","i-Venezuelan Bolívar");
    result.put("VND","i-Vietnamese Dong");
    result.put("VUV","i-Vanuatu Vatu");
    result.put("WST","i-Samoan Tala");
    result.put("XAF","i-Central African CFA Franc");
    result.put("XCD","i-East Caribbean Dollar");
    result.put("XOF","i-West African CFA Franc");
    result.put("XPF","i-CFP Franc");
    result.put("XXX","imali engaziwa");
    result.put("YER","i-Yemeni Rial");
    result.put("ZAR","i-South African Rand");
    result.put("ZMK","i-Zambian Kwacha (1968–2012)");
    result.put("ZMW","i-Zambian Kwacha");
    return result;
  }
}
